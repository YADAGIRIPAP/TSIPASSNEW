<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpassFeedBackFormNew.aspx.cs" Inherits="IpassFeedBackFormNew" %>
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ApprovalId" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblApprovalId" Text='<%# Eval("ApprovalName") %>' runat="server" Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Dept_Id" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDept_Id" Text='<%# Eval("DepartmentName") %>' runat="server" Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
