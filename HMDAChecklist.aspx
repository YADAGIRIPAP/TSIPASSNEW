<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HMDAChecklist.aspx.cs" Inherits="Gallery" %>
...
<body>
    <div class="mid_wrap">
        ...
        <div style="width: 95%; margin: auto;">
            <h2 style="padding-bottom: 4px; border-bottom: 1px solid #ddd;">Checklist for BUILDING PLAN Approval</h2>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>If the height of the building exceeds 15 mts structural drawings and designs certified by licensed Structural Engineer along with Soil Test report, Ground Water Analysis Certificate issued by qualified Geologist.
                    </td>
                    <td>
                       <%-- <a style="color: Blue;" target="_blank" href="#">View</a>--%>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;">3
                    </td>
                    <td>In case of expansion the existing approved plan.
                    </td>
                    <td>
                       <%-- <a style="color: Blue;" target="_blank" href="docs/NoC from Gram Panchayat.docx">View</a>--%>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;">4
                    </td>
                    <td>If the site is located within 100 mts boundary of water body & 50 mts from nala then NOC from Executive Engineer, Irrigation Dept and NOC from Joint Collector showing the distance from FTL boundary.
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <a style="color: Blue;" target="_blank" href="docs/NOC-COLLECTOR.pdf">View</a>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;">6
                    </td>
                    <td>If the plot is in  IE/IDA/SEZ developed by TSIIC, copy of approved Industrial Layout (Not mandatory).
                    </td>
                    <td>
                        <%--<a style="color: Blue;" target="_blank" href="docs/Mutation Document.pdf">View</a>--%>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;">7
                    </td>
                    <td>If the site is less than 4,000 Sq Mts, latest market value certificate issued by concerned Sub-Registrar (Not mandatory).
                    </td>
                    <td>
                        <a style="color: Blue;" target="_blank" href="docs/Marketvaluetemplate.pdf">View</a>
                    </td>
                </tr>
            </table>
            <br />
