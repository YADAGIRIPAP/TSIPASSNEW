...
/// <summary>
/// Summary description for cls_nswsfilepullparmeters
/// </summary>
public class cls_nswsfilepullparmeters
{
    ////public cls_nswsfilepullparmeters()
    ////{
    ////    //
    ...
    public class Responseofpullfileapi
    {
