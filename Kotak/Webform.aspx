<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Webform.aspx.cs" Inherits="Kotak_Webform" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerNew.aspx">
        ...
        <table width="40%" height="100" border='1' align="center">
            ...
            <tr>
                <td>Merchant Id</td>
                <td>
                    <input type="text" name="merchant_id" id="merchant_id" value="185458" /></td>
            </tr>
            <tr>
                <td>Order Id</td>
                <td>
            ...
            <tr>
                <td>Amount</td>
                <td>
                    <input type="text" name="amount" value="1.00" /></td>
            </tr>
            <tr>
                <td>Currency</td>
                <td>
            ...
            <tr>
                <td>Redirect URL</td>
                <td>
                    <input type="text" name="redirect_url" value="http://192.168.0.89/MCPG.ASP.net.2.0.kit/ccavResponseHandler.aspx" /></td>
            </tr>
            <tr>
                <td>Cancel URL</td>
                <td>
                    <input type="text" name="cancel_url" value="http://192.168.0.96/mcpg_new/iframe/ccavResponseHandler.php" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Billing Tel:</td>
                <td>
                    <input type="text" name="billing_tel" value="9899622605" /></td>
            </tr>
            <tr>
                <td>Billing Email:</td>
                <td>
                    <input type="text" name="billing_email" value="test@gmail.com" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Shipping Tel:</td>
                <td>
                    <input type="text" name="delivery_tel" value="9896426054" /></td>
            </tr>
            <tr>
