...
<div class="well-box">
<img src="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/Masterfiles/images/logo.jpg" class="img-responsive">
<hr>
<form runat="server">
    <div>
...
<div class="form-group"><%--<button name="submit" class="btn btn-primary btn-lg">Forgot Password</button>--%>
    ...
    <asp:Button OnClick="BtnPassword_Click" ValidationGroup="group" class="btn btn-primary btn-lg"
                            ID="Button1" runat="server" Text="Forgot Password"></asp:Button>
