<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmBridgeAccLogin.aspx.cs" Inherits="frmBridgeAccLogin" %>
                        ...
                        <div class="finder-form-transparent">
                            <div class="well-box">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtuname" runat="server" placeholder="User name - Already Registered" class="form-control input-md"
                                ...
                                <br>
                                <a href="frmBridgforgotpwd.aspx">Forgot your password?</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%--<a
                                    href="TSHome.aspx"><img height="40px" width="40px" src="images/Homeimage.png" /></a>--%>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="UI/TSiPASS/frmBridgeLoanRegForm.aspx"  style="background-color: #be8c2f;color: white;padding: 15px 25px;
  text-align: center;
  text-decoration: none;
  display: inline-block;">New
                                    User Registration<img alt="" width="40px" height="20px" src="../../images/animated-hand-image-0117.gif" /></a>
                                </form>
                            </div>
                        </div>
                    </div>
