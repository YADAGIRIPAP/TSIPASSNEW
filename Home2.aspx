...
<body>
    <div class="mid_wrap">
            ...
            <div class="vip">
                <ul>
                    <li>
                        ...
                        <div class="v-right">
                            <%--<img style="padding-left: 35%;" src="images/F3_06.png" id="imgcm" runat="server" />--%>
                            <img style="padding-left: 35%;"  id="imgcm" runat="server" />
                    ...
                    <li>
                        <div class="v-right">
                          <%--  <img style="padding-left: 35%;" src="images/F3_08.png" id="imgitm" runat="server"/>--%>
                            <img style="padding-left: 35%;" id="imgitm" runat="server"/>
        ...
        <div class="flexslider" id="ulslides"  runat="server">
         <%-- <ul class="slides">
            <li>
            ...
            <div class="apply">
                <div class="apply_in">
                    <p>
                        Get Industrial Project Approvals by a Single Click
                    </p>
                    <ul>
                        <li style="padding-left: 26%; padding-top: 10px;"><a target="_blank" href="UI/TSiPASS/AddnewuserRegistration.aspx">
                            <input type="submit" class="register" value="REGISTER" style="width: 150px; padding: 10px;" /></a> </li>
                        <li style="padding-left: 26%; padding-top: 10px;">
                            <input onclick="document.getElementById('id01').style.display = 'block'" style="width: 150px; padding: 10px;"
        ...
        <div>
            ...
            <div class="news">
                ...
                <div class="marque" id="divNews" runat="server">
                    <%--<marquee>
    <a href="#">Telangana State Hon'ble Chief Minister Sri.K. Chandrasekar Rao has launched Telangana Industrial Policies</a>
    <a href="#">Hon'ble Chief Minister Sri.K. Chandrasekar Rao has launched TS-iPASS</a>
            ...
            <div class="copyright">
                <p>
                    ...
                    <%--<img style="float:right; padding-right:2%;" src="http://www.reliablecounter.com/count.php?page=https://ipass.telangana.gov.in/&digit=style/plain/6/&reloads=1"
                            alt="ipass.telangana.gov.in" title="ipass.telangana.gov.in" border="0">--%>
                </p>
            </div>
