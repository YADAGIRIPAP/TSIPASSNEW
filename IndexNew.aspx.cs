...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ds1 = Gen.GetDepartmentIncentiveDashboard("%");

            lblIncentives.Text = ds1.Tables[0].Rows[0]["No of Applications Received"].ToString();

            lblApplications.Text = ds.Tables[0].Rows[0]["No of Application"].ToString();
            lblApprovals.Text = ds.Tables[0].Rows[0]["No of Approvals Applied for"].ToString();
            lblInvestment.Text = ds.Tables[1].Rows[0][0].ToString().Trim();
