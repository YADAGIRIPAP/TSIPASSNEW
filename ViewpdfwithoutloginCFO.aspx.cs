...
public partial class ViewpdfwithoutloginCFO : System.Web.UI.Page
{
    General clsGeneral = new General();
    DB.DB con = new DB.DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        string Filepathnew =Request.QueryString["filepathnew"].ToString();// "https://ipass.telangana.gov.in/TS-iPASSAttachments/CFOAttachments/268671/ErectionPermissionAttachment/56/heatex engg.pdf";
        //Request.QueryString["filepathnew"].ToString();
        string Decrypt = "";
        // string Decrypt = clsGeneral.Encrypt(Filepathnew, "SYSTIME");
        DataSet ds = GetDepartmentViewNew("", "CFO", Filepathnew);
