...
public partial class Home2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(ds.Tables[0].Rows[i]["Image"].ToString()))
                    {
                        ...
                        line.Append("<li><img src=" + UrlSrc + "></li>");
                    }
                }
                line.Append("</ul>");
            ...
            //btnSignIn.Enabled = false;
            //lblmsg.Text = "<font color=red>  Our site is under maintenance due to district bifurcation ,Site will up on 05-10-2016 at 10 AM</font>";
        }
    }
