                ...
                <div class="container">
                            ...
                            <aside class="widget widget_categories">
                                ...
                                <ul class="dt-sc-fancy-list caret">
                                   ...
                                   <%-- <li><a target="_blank" href="docs/CombinedApplicationForm.PDF">Common Application Form</a></li>
                                    ...
                                    <li><a target="_blank" href="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/CentralInspectionSystem.PDF">Central Inspection System Constitution</a></li>

                                    <li runat="server" visible="false"><a target="_blank" href="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/Final.pdf">How to Apply </a></li>
                                    ...
                                    <li runat="server" visible="false"><a target="_blank" href="Gallery.aspx">Videos Manuals Online Applications </a></li>
                                </ul>
                            </aside>
                        </section>
                    <section id="secondary" class="type2" runat="server" visible="false">
                            <aside class="widget widget_categories">
                                <h3 class="widgettitle"><span class="fa fa-download"></span>Policies</h3>
                                <ul class="dt-sc-fancy-list caret">
                                    <li><a href="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/IndustrialPolicyTelangana.pdf" target="_blank">Industrial Policy</a></li>
                                </ul>
                            </aside>
                        </section>
                    <section id="secondary" class="type2">
                            <aside class="widget widget_categories">
                                <h3 class="widgettitle"><span class="fa fa-download"></span>RTI</h3>
                                <ul class="dt-sc-fancy-list caret">
                                    <li><a href="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/TSIPASSActs/RTI-Act.pdf" target="_blank">Right to Information Act</a></li>
                                    <li><a href="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/TSIPASSActs/RTI.pdf" target="_blank">Industries Department Right to Information Act</a></li>
                                </ul>
                            </aside>
                        </section>
                    ...
                    <div class="col-md-6" style="width: 100%">
                        ...
                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            Width="100%" ShowFooter="false" OnRowDataBound="grdDetails_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="GOno" HeaderText="GO No and Date">
                                    <ItemStyle Width="200px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Subject">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFileName" runat="server" Text='<%#Eval("Subject") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--  <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" HeaderText="Subject" DataTextField="Subject"
                                    DataNavigateUrlFields="Filepath" DataNavigateUrlFormatString="{0}" Target="_blank" ID="hprlink" >
                                    <ItemStyle Font-Underline="false"  HorizontalAlign="Left" />
                                </asp:HyperLinkField>--%>
                                <asp:TemplateField HeaderText="GO Copy">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hprlink" Target="_blank" runat="server" Text="View" NavigateUrl='<%#Eval("Filepath") %>'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--<asp:TemplateField HeaderText="Attachment" Visible="false">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hprlink" runat="server" Text="View" NavigateUrl='<%#Eval("Filepath") %>'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="col-md-6" style="width: 100%">
                        <!--    Context Classes  -->
                        <asp:GridView ID="GovGos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="GOno" HeaderText="GO No/Memo and Date">
                                    <ItemStyle Width="200px" />
                                </asp:BoundField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" HeaderText="Subject" DataTextField="Subject"
