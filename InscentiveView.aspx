<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="InscentiveView.aspx.cs" Inherits="InscentiveView" Title="Incentive View" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
       ...
       function Popup(intVal) {
           ...
           win = window.open("InscentiveView_Attachments.aspx?EntrpId=" + intVal, "List", "scrollbars=yes,resizable=yes,width=780,height=400,left=" + ((window.screen.width / 2) - 320) + ",top=" + ((window.screen.height / 2) - 200) + ";display : block;position:absolute");
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Incentives">
                            <ItemTemplate>                                
                                ...
                                <asp:Label ID="lblEntrpId" runat="server" Visible="false" Text='<%# Eval("IncentiveId") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
