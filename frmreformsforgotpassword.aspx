<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmreformsforgotpassword.aspx.cs" Inherits="UI_TSiPASS_frmreformsforgotpassword" %>
...
<div class="form-group">
    ...
    <%--<input id="name" name="name" placeholder="User name" class="form-control input-md" required="" type="text">--%>
     ...
     <div class="form-group">
    <%--<input id="name" name="name" placeholder="User name" class="form-control input-md" required="" type="text">--%>
     <asp:TextBox runat="server" placeholder="User Name" class="form-control input-md" required="" ID="txtuserid" Visible="false" />
</div><br>
