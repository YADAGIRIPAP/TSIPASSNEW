...
public partial class UI_TSiPASS_Advertisement_renewal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dsnew = Gen.getdataofidentityRENAPPROVALID(Request.QueryString[0].ToString(), "138");
            ...
            else
            {
                if (Request.QueryString[1].ToString() == "N")
                {
                    ...
                    Response.Redirect("frm_Renewalcelltower.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&next=" + "N");
                }
                else
                {
                    Response.Redirect("frmDrugRenewal.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&Previous=" + "P");
                }
            }
        }
    }
    public void BindDistricts()
    {
        try
        {
            ...
            DataSet dsd = new DataSet();
            dsd = obj_newdistrictwargnal.GetallDistrictswithoutWarangal(Convert.ToString(Session["uid"]), "REN");
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        if (BtnSave.Text == "Save")
        {
            ...
            //{
                ...
                objResp = InsertupdateAdevertisment_renewal();
    ...
    public Response InsertupdateAdevertisment_renewal()
    {
        AdvertismentDetailsobj_renewal obj = new AdvertismentDetailsobj_renewal();
        ...
        Response result = obj_adv.InsertAdvertisementSOA_renewal(obj, out advertisementid);
    ...
    void FillDetails()
    {
        ...
        try
        {
            ds = obj_adv.RetriveAdvertisement_renewal(Convert.ToString(Session["uid"]));
    ...
    {
        Response.Redirect("frmDrugRenewal.aspx?intApplicationId=" + hdfFlagID0.Value + "&Previous=" + "P");
    }
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            if (objResp.ResponseVal == true)
            {
                hdfFlagID0.Value = advertisementid.ToString();
                Response.Write("Submitted Successfully.....");
                Response.Redirect("frm_Renewalcelltower.aspx?intApplicationId=" + Request.QueryString[0].ToString().Trim() + "&next=" + "N");
                // BtnSave.Enabled = false;
                BtnClear.Enabled = false;
                btnNext.Enabled = true;
                btnNext.Visible = true;
            ...
            //{
            //    Response.Redirect("frmDraftQuestionnaireAdvertisement_renewal.aspx");
            //}
            //else
            //{
