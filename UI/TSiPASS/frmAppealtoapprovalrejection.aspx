<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmAppealtoapprovalrejection.aspx.cs" Inherits="TSTBDCReg1" %>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">Rejection Details</h3>
                            </div>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True" 
                                                Width="210px">Appeal for Rejection</asp:Label>
                                        </td>
                                    </tr>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                ...
                                                <tr id="trdescription" runat="server">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                       <asp:TextBox ID="txtdiscription" runat="server" class="form-control txtbox" 
                                                            Height="40px" TextMode="MultiLine" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RegularExpressionValidator4" runat="server" 
                                                                        ControlToValidate="txtdiscription" ErrorMessage="Enter Description" 
