<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmPlotAbstractDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmPlotAbstractDrillDown" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Popup(intval) {
            win = window.open("UserFormViewPage.aspx?AppId=" + intval, "List", "scrollbars=yes,resizable=yes,width=780,height=400,left=" + ((window.screen.width / 2) - 320) + ",top=" + ((window.screen.height / 2) - 200) + ";display : block;position:absolute");
        }
    </script>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                <tr>
                    <td colspan="4">
                        <div class="panel-heading" align="center">
                            <h2 class="panel-title" style="font-weight: bold;">R5: TSIIC Plot Allotment Abstract Report 
                ...
                <tr>
                    <td style="text-align: left">
                     ...
                     <td class="col-xs-5" style="padding: 5px; text-align: right; margin: 5px" colspan="1">
                                            <b>
                 ...
                 <tr align="center">
                            <td style="padding: 5px; margin: 5px" valign="top" align="center">
                                <table width="80%" runat="server" visible="false">
                                    <tr align="center">
                                        <td style="padding: 5px; margin: 5px" align="center" runat="server" visible="false">
                        ...
                        <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="View" Visible="true"> 
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnk_grdview" runat="server" Text='<%# Eval("ApplicationId") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                <asp:BoundField DataField="NameOftheFirm_Applicant" HeaderText="Name Of the Firm_Applicant"></asp:BoundField>
                                <asp:BoundField DataField="UIDNO" HeaderText="UIDNO"></asp:BoundField>
                                <asp:BoundField DataField="Statuss" HeaderText="Status"></asp:BoundField>
                                
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Type of venture"
                                    DataTextField="Typeofventure">
                                ...
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Project Category"
                                    DataTextField="typeofprojectscategory">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Project Status"
                                    DataTextField="typeofprojectstatus">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Product"
                                    DataTextField="Product">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 1 Cost in Crores"
                                    DataTextField="Phase1CostinCrores">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 2 Cost in Crores"
                                    DataTextField="Phase2CostinCrores">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 3 Cost in Crores"
                                    DataTextField="Phase3CostinCrores">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 1 Employment"
                                    DataTextField="Phase1Employment">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 2 Employment"
                                    DataTextField="Phase2Employment">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Phase 3 Employment"
                                    DataTextField="Phase3Employment">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:BoundField DataField="REJECTEDREASON" HeaderText="Rejected Reason" Visible="false"></asp:BoundField>
                                 <asp:BoundField DataField="DistrictName" HeaderText="District" Visible="true"></asp:BoundField>
                                <asp:BoundField DataField="ApplicationDate" HeaderText="Application Date" Visible="true"></asp:BoundField>
