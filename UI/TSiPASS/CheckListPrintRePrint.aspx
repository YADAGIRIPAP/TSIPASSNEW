<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="CheckListPrintRePrint.aspx.cs" Inherits="UI_TSiPASS_CheckListPrintRePrint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <div class="row" align="left">
            <div class="col-lg-12" id="divprintnew" runat="server">
                        ...
                        <td>
                            ...
                            <div class="panel-heading" style="text-align: center">
                                ...
                                <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Reprint Working Status Updated List </asp:Label>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2" align="center">
                                            <table width="90%">
                                                <tr>
                                                    <td style="vertical-align: middle; font-weight: bold; width:300px" align="left">
                                                         Cheque List Printed Date :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width:150px;  text-align: left; font-weight: bold">
                                                        <asp:Label runat="server" ID="txtsvcdate" Height="28px" TabIndex="1"></asp:Label>
                                                    </td>
                                                    <td style="vertical-align: middle; font-weight: bold; width:300px" align="left">
                                                        Release Proceeding No :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; font-weight: bold">
                                                        <asp:Label runat="server" ID="lblRlsProceedNo" Height="28px" TabIndex="1"></asp:Label>
                                                    </td>
                                                    <td style="vertical-align: middle; font-weight: bold; width: 150px" align="left">
                                                        UC Status :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px;  text-align: left;width:350px; font-weight: bold">
                                                        <asp:Label runat="server" ID="Label2" Height="28px" TabIndex="1"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="vertical-align: middle; font-weight: bold; " align="left">
                                                        From Date :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; font-weight: bold">
                                                        <asp:Label runat="server" ID="lblfromdate" Height="28px" TabIndex="1"></asp:Label>
                                                    </td>
                                                    <td style="vertical-align: middle; font-weight: bold; " align="left">
                                                        To Date :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px;  text-align: left; font-weight: bold">
                                                        <asp:Label runat="server" ID="lbltodate" Height="28px"  TabIndex="1"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="grdDetails_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RecommendedAmount" ItemStyle-HorizontalAlign="Center"
                                                            Visible="false" HeaderText="Recommended Amount">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Working Status Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblworkingstatus" Text='<%#Eval("WorkingStatusUpdtaedDate") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="LAPSEDDATA" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Rollbacked Status(Lapsed Cheque)">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="Letter from Banker">
                                                         ...
                                                         <asp:TemplateField runat="server" Visible="false" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFileName" Visible="false" runat="server" Text='<%#Eval("LINKNEW") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Release Doc">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="lnkFile" Target="_blank" NavigateUrl='<%# Eval("ReleaseLINKNEW") %>'
                                ...
                                <table id="Table1" runat="server" align="center">
                                    <tr>
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7"
                                            ...
                                            <%--<asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Reprint"
                                OnClick="Button1_Click" />--%>
                                            <%-- <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Reprint"
                                                OnClientClick="javascript:CallPrint('divprint')" />--%>
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="RePrint"
                                                OnClientClick="javascript:Panel1()" />
