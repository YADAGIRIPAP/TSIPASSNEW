<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UpdateCheckNumberDeatailFinalALL.aspx.cs" Inherits="UI_TSiPASS_UpdateCheckNumberDeatailFinalALL" %>
                                                   ...
                                                   <%--     <asp:TemplateField>
                                                      ...
                                                      <%--  <asp:BoundField DataField="SLCDate" ItemStyle-HorizontalAlign="Center" HeaderText="SLCDate">
                                                        ...
                                                        <asp:TemplateField HeaderText="Remarks">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblRemarks" Text='<%#Eval("BankAccountRemarks") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                           <asp:TemplateField HeaderText="Cheque PrintedDate" Visible="false">
                                                            <ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="Cheque NO">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCheckNO" Text='<%#Eval("CheckNO") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>    
                                                           <asp:TemplateField HeaderText="Cheque Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCheckDate" Text='<%#Eval("CheckDate") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>                                                        
                                                    </Columns>
