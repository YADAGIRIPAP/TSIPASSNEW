...
public partial class UI_TSiPASS_frmBankReportDistrictWiseCOIDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    public DataSet GetBankerApplicationsDrill(string fromdate, string todate, string district, string typeofaccount, string bankname)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_BANKERREPORT_DISTRICT_DRILLDOWN_COI", pp);
        return Dsnew;
    }
}