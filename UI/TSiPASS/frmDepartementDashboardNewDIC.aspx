<%@ Page Title=":: TSiPASS : Works wise Report " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartementDashboardNewDIC.aspx.cs" Inherits="Dashboard" %>
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny Stage </b>
                                              ...
                                              <a href="frmCFEDepartmentsViewAppl.aspx?Stg=1" class="list-group-item">
                                        <span class="badge">
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> No of Application Received
                                              ...
                                              <a class="list-group-item" href="#"><i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny-Completed</b> </a>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=2"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label12" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Within 3 Days</a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=3"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="Label18" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Beyond 3 Days </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=4"><span class="badge">
                                             ...
                                             <i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny-Pending</b> </a>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=5"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label21" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Within 3 Days</a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=6"><span class="badge" style=" background-color:#d9534f;">
                                               ...
                                               <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=7"><span class="badge" >
                                                <asp:Label ID="Label6" runat="server"></asp:Label>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=8">
                                                ...
                                                <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=12"><span class="badge" style=" background-color:#87D37C;">
                                        ...
                                        <td valign="top" style="width: 395px">
                                          ...
                                          <div class="list-group">
                                              ...
                                              <a class="list-group-item" href="#"><b><i class="fa fa-fw fa-check"></i>Approval Stages</b></a>
                                                ...
                                                <a class="list-group-item" href="frmCFEDepartmentsApprovalProcess.aspx?stg=1"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label1" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Within Time Limits </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsApprovalProcess.aspx?stg=2"><span class="badge" style=" background-color:#d9534f;">
                                               ...
                                               <a class="list-group-item" href="#"><i class="fa fa-fw fa-check"></i><b> Approval Issued</b></a>
                                                ...
                                                <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=13"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label7" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Within Time Limits </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=14"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="Label9" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Beyond Time Limits</a>
                                                
                                                   <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=15"><span class="badge">
                                                <asp:Label ID="Label10" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Total</a>
                                               
                                                <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=16"><span class="badge">
                                                <asp:Label ID="Label17" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> No of Applications Rejected </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewAppl.aspx?Stg=17"><span class="badge">
