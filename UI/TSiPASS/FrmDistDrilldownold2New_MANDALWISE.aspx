<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="FrmDistDrilldownold2New_MANDALWISE.aspx.cs" Inherits="UI_TSiPASS_FrmDistDrilldownold2New_MANDALWISE" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeader" runat="server">R6.1: TSiPASS- District Wise Report </asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlType" runat="server" class="form-control txtbox" Height="33px" Enabled="false"
                                                ...
                                                <td style="padding: 5px; margin: 5px" align="center" runat="server" id="tdFromDate">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="txtFromDate" runat="server" class="form-control txtbox" Height="28px" Enabled="false" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group" Width="125px"></asp:TextBox>
                                                ...
                                                <td style="padding: 5px; margin: 5px" runat="server" id="tdToDate">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="txtTodate" runat="server" Enabled="false" class="form-control txtbox" Height="28px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group" Width="125px"></asp:TextBox>
                                                ...
                                                <td style="padding: 5px; margin: 5px" align="right">
                                                    <asp:Button ID="Button3" runat="server" CssClass="btn btn-default" TabIndex="10"
                                                        Text="Submit" OnClick="BtnSave1_Click" Visible="false" />
                                                </td>
                                            </tr>
