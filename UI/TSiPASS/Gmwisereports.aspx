<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Gmwisereports.aspx.cs" Inherits="UI_TSiPASS_Gmwisereports" %>
    ...
    <table id="divPrint" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td style="text-align: left">
                <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/GMreports.aspx"
                    Text="<< Back">
                </asp:HyperLink>
            </td>
        </tr>
                    ...
                    <h3 class="panel-title" style="font-weight: bold;">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="Button1" Text="Submit" OnClick="btnLogin_Click" cssstyle="padding-left:120px" />


                            </div>
                            <div class="form-group" runat="server" style="text-align:right;">
                            <b>
                                    ...
                                    <td align="left" colspan="6" style="padding: 5px; margin: 5px">
                                        <asp:GridView ID="gvdetailsnew" CssClass="" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GmAssigndate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="GM Assigned to Inspecting Officier">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>


                                                <asp:BoundField DataField="ipoinspeciondate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Inspecting officier Assigned Inspection Date">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="Ipoinspectionreportsubmitdate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Inspection Report Submitdate">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>


                                                <asp:BoundField DataField="gmrecommendadtodipc" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="GM Recommended to DIPC">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="DIPCAppovedDate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Applications Received By JD">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="DIPCAppovedDate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="GM Recommended to SSCL">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="JDrecommendeddate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Applications Received By Addl Director">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="AddlRecommendedDate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Addl Director Recommended to SSCL">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="AddlRecommendedDate" DataFormatString="{0:dd-MM-yyyy}" ItemStyle-HorizontalAlign="Center" HeaderText="Approved Applications by the COI">
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:BoundField>
