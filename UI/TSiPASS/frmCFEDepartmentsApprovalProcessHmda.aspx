<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmCFEDepartmentsApprovalProcessHmda.aspx.cs" Inherits="TSTBDCReg1" %>
            ...
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">
                        <asp:Label ID="lblHeaderlink" runat="server"></asp:Label></a>
                    </li>
                </ol>
            </div>
            <div align="left">
                <div class="row" align="left">
                                ...
                                <ContentTemplate>
                                    <div class="panel-body">
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            ...
                                            <tr>
                                                <td style="padding: 5px; margin: 5px" valign="top" align="left" class="style8"></td>
                                                <td class="style9"></td>
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False"
                                                        CellPadding="5" ForeColor="#333333" OnRowDataBound="grdDetails_RowDataBound"
                                                        ShowFooter="false" Width="100%" OnRowCommand="grdDetails_RowCommand">
                    ...
                    DataNavigateUrlFormatString="KeywordSrchSumDtl.aspx?Keyword={0}&State={1}&City={2}"/>--%>
                                                            ...
                                                            <asp:TemplateField HeaderText="MA & UD">
                                                                <ItemTemplate>
                                                                    <table>
                                                                        <tr>
                                                                            <td>

                                                                                <asp:Label ID="lblMAUDSts" Visible="false" runat="server" Text="Sent to MA & UD for Approval"></asp:Label>
                                                                                <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" OnClientClick="return confirmMAUD()" runat="server" Text="Send to MA & UD" Width="200px" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <asp:HyperLinkField HeaderText="Reject" Text="Reject" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Created_by" Visible="false">
                                                                <ItemTemplate>
