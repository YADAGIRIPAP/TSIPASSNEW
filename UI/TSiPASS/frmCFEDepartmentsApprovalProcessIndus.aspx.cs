...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void fillGrid()
    {
        ...
        dsn = Gen.GetCompletedbyApprovalIndus("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (txtFromDate.Text == "" || txtToDate.Text == "")
            {
                ...
                Todate = "%";
                h1.Text = "Approve";
                h1.NavigateUrl = "frmApproveDetailsbyqueryIndus.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
            }
            ...
            else
            {
                ...
                h1.NavigateUrl = "frmApproveDetailsbyqueryIndus.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim() + "&FromDate=" + fromdate + "&ToDate=" + Todate;
            }
        }
