...
public partial class UI_TSiPASS_frmCFEDepartmentsApprovalProcessREN : System.Web.UI.Page
{
    int delete = 0;
    ...
    void fillGrid()
    {
        ...
        {
            dsn = Gen.GetCompletedbyApprovalREN2A("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
        else if (Request.QueryString[0].ToString().Trim() == "2")
        {
            dsn = Gen.GetCompletedbyApprovalREN3A("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
        else
        {
            dsn = Gen.GetCompletedbyApprovalREN("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (txtFromDate.Text == "" || txtToDate.Text == "")
            {
                ...
                Todate = "%";
                h1.Text = "Approve";
                h1.NavigateUrl = "frmApproveDetailsbyqueryREN.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim();
            }
            ...
            else
            {
                ...
                h1.NavigateUrl = "frmApproveDetailsbyqueryREN.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim() + "&FromDate=" + fromdate + "&ToDate=" + Todate;
            }
        }
