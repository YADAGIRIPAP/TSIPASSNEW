...
public partial class UI_TSiPASS_frmBankReportUserDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    void FillDetails()
    {
        ...
        ds = GetBankerApplicationsDrill(FromdateforDB, TodateforDB, "79163", typeofaccount);
    ...
    public DataSet GetBankerApplicationsDrill(string fromdate, string todate, string createdby,string typeofaccount)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_BANKERREPORT_USER_DRILLDOWN", pp);
        return Dsnew;
    }
}