<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmshowcausedetails.aspx.cs" Inherits="UI_TSiPASS_frmshowcausedetails" %>
                                                        ...
                                                        <tr style="display: none">
                                                            <td valign="middle" align="center" colspan="3" style="text-align: center">
                                                                ...
                                                                <asp:Button ID="BtnClear" runat="server" CausesValidation="False" CssClass="btn btn-warning"
                                                                    ...
                                                                    Width="90px" />
                                                                &nbsp;<asp:Button ID="BtnSearch0" runat="server" CssClass="btn btn-info"
                                                                    Height="32px" OnClick="BtnSearch0_Click" TabIndex="10" Text="Export"
                                                                    Width="90px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                     ...
                                     <tr>
                                        ...
                                        <div style="margin-bottom: 17px; text-align: left; margin-left:0px;">
                                           ...
                                           <asp:GridView ID="gvdetailsnew" CssClass="floatingTable" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                                            ...
                                                                            PageSize="20" Width="80%" Font-Names="Verdana" Font-Size="12px" GridLines="Both" OnRowDataBound="gvdetailsnew_RowDataBound">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                      <%--  <a id="View" target="_blank" href="ApplicantIncentiveDtls.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">View</a>--%>
                                                                                       <%-- <asp:HyperLink ID="anchortaglink" runat="server" Text="Process" Font-Bold="true" ForeColor="Green" Target="_blank" />--%>
                                                                                        <asp:Button ID="anchortaglink" runat="server" Text="Reply to Showcause Issued" CssClass="btn btn-primary" OnClick="anchortaglink_Click"></asp:Button>
                                                                                        
                                                                                    </ItemTemplate>
                                                                                     <ItemStyle HorizontalAlign="Center" />
                                                                                         </asp:TemplateField>
                                                                                      <asp:BoundField DataField="SHOWCAUSEREPLIED" ItemStyle-HorizontalAlign="Center" HeaderText="Showcause replied">
                                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                                </asp:BoundField>
                                                                                    <asp:BoundField DataField="SHOWCAUSEREPLIEDDATE" ItemStyle-HorizontalAlign="Center" HeaderText="Sowcause reply submit date" DataFormatString="{0:dd-M-yyyy}" >
