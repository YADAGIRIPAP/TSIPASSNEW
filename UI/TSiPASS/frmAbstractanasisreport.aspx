<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmAbstractanasisreport.aspx.cs" Inherits="UI_TSiPASS_frmAbstractanasisreport" %>
        ...
        <div class="panel panel-default">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr style="height: 30px" align="right">
                    <td>
                        <asp:Button ID="btnKeyhilights" runat="server" CssClass="btn btn-primary" Height="32px" TabIndex="10" Text="Key Highlights" OnClick="btnKeyhilights_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr style="height: 30px">
                    <td>
                        <h2 class="panel-title" style="font-weight: bold;">1). TSIPASS APPROVAL ANALYSIS : </h2>
                    </td>
                </tr>
                <tr style="height: 10px" align="right">
                    <td style="font-weight:bold">
                        Report Generated On : <asp:Label ID="lbldate"  runat="server" Text=""></asp:Label> &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint" runat="server">
                        <asp:GridView ID="grdDetails" CssClass="floatingTable1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            OnRowDataBound="grdDetails_RowDataBound" Width="100%" AllowSorting="false"
                            ShowFooter="false" OnRowCreated="grdDetails_RowCreated">
                            <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" VerticalAlign="Top" CssClass="GridviewScrollC1HeaderWrap" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderStyle-Width="200px" DataField="DEPARTMENTNAMEShow" HeaderText="Department Name"></asp:BoundField>
