...
using System.Data;
public partial class UI_TSiPASS_frmViewAppl_groundwaterDepartmentuser : System.Web.UI.Page
{
    string rstages = "0";
    ...
    public void GetDetails()
    {
        if (Request.QueryString.Count > 0)
        {
            ...
            dsn = obj_dashboard.GetShowDepartmentFiles_grounwaterDept(Session["User_Code"].ToString().Trim(), rstages.ToString().Trim());
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (StageId == "4")
            {
                ...
                if (rstages == "2" || rstages == "3")
                {
                    ...
                    //hyp_approveapplication.NavigateUrl = "frmApproveDetailsbyquery_DWGOgroundwater.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
                    hyp_approveapplication.NavigateUrl = "frmApproveDetailsbyquery_DWGOgroundwater.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
                }
            }
            if (StageId == "9")
