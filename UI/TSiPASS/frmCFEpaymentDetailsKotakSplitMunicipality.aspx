<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmCFEpaymentDetailsKotakSplitMunicipality.aspx.cs" Inherits="UI_TSiPASS_frmCFEpaymentDetailsKotakSplitMunicipality" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 80%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlDepartment" runat="server" class="form-control txtbox" Height="28px"
                                                            Width="180px" TabIndex="1" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged"
                                                            AutoPostBack="true">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddldistrict" runat="server" AutoPostBack="True" class="form-control txtbox"
                                                            Height="33px" Width="180px" OnSelectedIndexChanged="ddldistrict_SelectedIndexChanged">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlMandal" runat="server" AutoPostBack="True" class="form-control txtbox" Height="33px" OnSelectedIndexChanged="ddlMandal_SelectedIndexChanged" TabIndex="1" Width="180px">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlpaymentType"
                                                            ErrorMessage="Please Select Payment Type" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlvillage" runat="server" class="form-control txtbox" Height="33px" TabIndex="1" Width="180px">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="lblSector9" runat="server" CssClass="LBLBLACK" Height="16px" Text="Payment Type" Width="110px"></asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlpaymentType" runat="server" AutoPostBack="True" class="form-control txtbox" Height="28px" OnSelectedIndexChanged="ddlpaymentType_SelectedIndexChanged" TabIndex="1" Width="180px">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                            <asp:ListItem Selected="True" Value="O">Online</asp:ListItem>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="lblSector7" runat="server" CssClass="LBLBLACK" Height="16px" Text="Bank"
                                                            Width="110px"></asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlBank" runat="server" class="form-control txtbox" Height="28px"
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="lblSector8" runat="server" CssClass="LBLBLACK" Height="16px" Text="Module"
                                                            Width="110px"></asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlmodule" runat="server" class="form-control txtbox" Height="28px"
                                                            TabIndex="1" Width="180px">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                            <asp:ListItem Value="CFE" Selected="True">CFE</asp:ListItem>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px" colspan="3">
                                                        <asp:TextBox ID="txtNameOfUnit" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="300" TabIndex="1" ValidationGroup="group" Width="380px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">&nbsp;
                                    ...
                                    <tr>
                                        <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                                            <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                                TabIndex="10" Text="Search" Width="90px" OnClick="BtnSave1_Click" ValidationGroup="group" />
                                            &nbsp;
                                    ...
                                    <tr>
                                        <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                                ShowFooter="True" Width="100%" OnRowDataBound="grdDetails_RowDataBound" OnPageIndexChanging="grdDetails_PageIndexChanging"
                                                AllowPaging="false" PageSize="20" OnSelectedIndexChanged="grdDetails_SelectedIndexChanged"
                                    ...
                                    <tr>
                                        <td align="center" style="padding: 5px; margin: 5px">
                                            <asp:Button ID="btntransfer" runat="server" CssClass="btn btn-primary" Height="32px"
                                                TabIndex="10" Text="Transfer Amount" ValidationGroup="group" Width="150px" OnClick="btntransfer_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="padding: 5px; margin: 5px">
