<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmIncentiveProceedingabstractcastwise_slcdrilldown.aspx.cs" Inherits="UI_TSiPASS_frmIncentiveProceedingabstractcastwise_slcdrilldown" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%; font-family: 'Trebuchet MS'">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/frmIncentiveProceedingabstractcastwise.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
