<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="IncentiveStatusInspectionUploadbyCoi.aspx.cs" Inherits="UI_TSiPASS_IncentiveStatusInspectionUploadbyCoi" %>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: center;" colspan="3" align="center">
                                                ...
                                                <tr id="trNEW1" runat="server" visible="false">
                                                    <td align="center" style="padding: 5px; margin: 5px" valign="top">
                                                        <div style="text-align: left; font-size: 16px; margin-left: 50px; font-weight: 500;">
                                                            Search</div>
                                                        <div style="margin-bottom: 17px; text-align: left; margin-left: 50px;">
                                                            <input type="text" id="search" class="form-control input-sm" style="width: 230px;
                                                                font-size: 14px; height: 35px; float: left; margin-right: 10px;" placeholder="Unit Name" />
                                                            <select class="form-control" id="SelCatgy" style="float: left; margin-right: 10px;
                                                            ...
                                                            <asp:DropDownList ID="DrpDist" runat="server" Style="float: left; margin-right: 10px;"
                                                                class="form-control txtbox" Height="33px" Width="142px" TabIndex="1">
                                                        ...
                                                        <asp:GridView ID="gvdetailsnew" CssClass="floatingTable" runat="server" AllowPaging="false"
                                                            ...
                                                            Font-Names="Verdana" Font-Size="12px" GridLines="Both">
                                                ...
                                                <tr id="trNEW2" runat="server" visible="false">
                                                    <td align="center" style="padding: 5px; margin: 5px; width: 100%" valign="top">
                                                        <div style="text-align: left; font-size: 16px; margin-left: 50px; font-weight: 500;">
                                                            Search</div>
                                                        <div style="margin-bottom: 17px; text-align: left; margin-left: 50px;">
                                                            <input type="text" id="Text1" class="form-control input-sm" style="width: 230px;
                                                                font-size: 14px; height: 35px; float: left; margin-right: 10px;" placeholder="Unit Name" />
                                                            <select class="form-control" id="Select1" style="float: left; margin-right: 10px;
                                                                width: 148px; height: 35px;">
                                                                <option value="0">Select Category</option>
                                                                <option value="SC">SC</option>
                                                                <option value="ST">ST</option>
                                                            ...
                                                            <asp:DropDownList ID="DropDownList1" runat="server" Style="float: left; margin-right: 10px;"
                                                                class="form-control txtbox" Height="33px" Width="142px" TabIndex="1">
                                                                <asp:ListItem Value="0">Select District</asp:ListItem>
                                                            </asp:DropDownList>
