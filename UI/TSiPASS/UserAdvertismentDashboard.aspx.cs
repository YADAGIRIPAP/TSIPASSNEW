...
public partial class UI_TSiPASS_UserAdvertismentDashboard : System.Web.UI.Page
{
    string Qnreid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("SAO_GetShow_TAdvertismentQuestionaries_ques", osqlConnection);
    ...
    public DataSet GetEnterpreneourDashboardDetails_Advertisment(string intEntid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SOA_GetEnterpreneourDashboardDetails_Advertsment", osqlConnection);
