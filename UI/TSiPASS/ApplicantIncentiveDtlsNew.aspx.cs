...
public partial class UI_TSiPASS_ApplicantIncentiveDtlsNew : System.Web.UI.Page
{
    //95106
    ...
    List<officerRemarks> lstremarksclerk = new List<officerRemarks>();
    List<officerRemarks> lstremarkssupdt = new List<officerRemarks>();
    List<officerRemarks> lstremarksdd = new List<officerRemarks>();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["uid"] != null)
            {
                ...
                try
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        if (!IsPostBack)
                        {
                            ...
                            gvJDReturneddDtls.DataSource = null;
                            gvJDReturneddDtls.DataBind();
                            if (dsjdreturned != null && dsjdreturned.Tables.Count > 0 && dsjdreturned.Tables[0].Rows.Count > 0)
                            {
                                gvJDReturneddDtls.DataSource = dsjdreturned.Tables[0];
                                gvJDReturneddDtls.DataBind();
                                Div40.Visible = true;
                            }
                            else
                            ...
                            gvADDlReturneddDtls.DataSource = null;
                            gvADDlReturneddDtls.DataBind();
                            if (dsADDLreturned != null && dsADDLreturned.Tables.Count > 0 && dsADDLreturned.Tables[0].Rows.Count > 0)
                            {
                                gvADDlReturneddDtls.DataSource = dsADDLreturned.Tables[0];
                                gvADDlReturneddDtls.DataBind();
                                Div51.Visible = true;
                            }
                            else
                            ...
                            dsIPOREP = GetInspectionreportData(Request.QueryString[0].ToString(), Incids);
                            ...
                            DataSet dsAddlAbeyance = new DataSet();
                            dsAddlAbeyance = getADDLAbeyancedList(Request.QueryString[0].ToString(), Incids);
                            gvaddlabeyanced.DataSource = null;
                            gvaddlabeyanced.DataBind();
                            if (dsAddlAbeyance != null && dsAddlAbeyance.Tables.Count > 0 && dsAddlAbeyance.Tables[0].Rows.Count > 0)
                            {
                                tr8.Visible = true;
                                gvaddlabeyanced.DataSource = dsAddlAbeyance.Tables[0];
                                gvaddlabeyanced.DataBind();
                                Div2.Visible = true;
                            }
                            else
                        ...
                        string usercode = "";
                        if (Role_Code == "COI-AD" || Role_Code == "COI-DD" || Role_Code == "COI-SUPDT" || Role_Code == "COI-CLERK")
                        {
                            Userid = "3377";
                        }
                        else
                        ...
                        try
                        {
                            ...
                            if (Role_Code == "JD" || Role_Code == "COI-AD" || Role_Code == "COI-DD" || Role_Code == "COI-SUPDT" || Role_Code == "COI-CLERK")
                            {
                                ...
                                if (Role_Code == "COI-CLERK")
                                {
                                    if (Request.QueryString["Sts"].ToString() != "" && Request.QueryString["Sts"].ToString() != "100"
                                        && Request.QueryString["Sts"].ToString() != "101" && Request.QueryString["Sts"].ToString() != "102"
                                        && Request.QueryString["Sts"].ToString() != "104" && Request.QueryString["Sts"].ToString() != "105"
                                        && Request.QueryString["Sts"].ToString() != "50"
                                        && Request.QueryString["Sts"].ToString() != "51"
                                        && Request.QueryString["Sts"].ToString() != "83"
                                        && Request.QueryString["Sts"].ToString() != "84")
                                    {
                                        trRemarks1.Visible = false;
                                        trRemarks_clerklevel.Visible = true;
                                    ...
                                    else
                                    {
                                        ...
                                        trRemarks_clerklevel.Visible = false;
                                    }
                                }
                                if (Role_Code == "COI-SUPDT")
                                {
                                    if (Request.QueryString["Sts"].ToString() != "" && Request.QueryString["Sts"].ToString() != "500"
                                      && Request.QueryString["Sts"].ToString() != "511" && Request.QueryString["Sts"].ToString() != "108"
                                      && Request.QueryString["Sts"].ToString() != "109" && Request.QueryString["Sts"].ToString() != "103" && Request.QueryString["Sts"].ToString() != "85")
                                    // && Request.QueryString["Sts"].ToString() != "104" && Request.QueryString["Sts"].ToString() != "105"
                                    {
                                        trRemarks_supdtlevel.Visible = false;
                                        trRemarks1.Visible = false;

                                    }
                                    else
                                    {
                                        trRemarks_supdtlevel.Visible = true;
                                        trRemarks1.Visible = false;
                                        Divclerkr.Visible = true;
                                    }
                                }
                                if (Role_Code == "COI-DD")
                                {
                                    ...
                                    {
                                        trRemarks1.Visible = false;
                                        trRemarks_DDlevel.Visible = true;
                                    }
                                    else
                                    {
                                        // trRemarks1.Visible = true;
                                        trRemarks_DDlevel.Visible = false;
                                    }
                                ...
                                if (Role_Code == "JD" || Role_Code == "COI-AD" || Role_Code == "ADDL" || Role_Code == "COI-DD" || Role_Code == "COI-CLERK" || Role_Code == "COI-SUPDT")
                                {
                                    ...
                                    if (dsADQuery != null && dsADQuery.Tables.Count > 0)
                                    {
                                        ...
                                        {
                                            string datecheck1 = Convert.ToDateTime(dsADQuery.Tables[2].Rows[0]["Query Raised Date"].ToString()).ToShortDateString();
                                            if (Session["uid"].ToString() != "32953")
                                            {
                                            ...
                                            else
                                            {
                                                if ((Convert.ToDateTime(datecheck1) >= Convert.ToDateTime("01-June-24") && Convert.ToDateTime(datecheck1) < Convert.ToDateTime("15-June-24"))
                                                    || (Convert.ToDateTime(datecheck1) >= Convert.ToDateTime("24-July-24") && Convert.ToDateTime(datecheck1) < Convert.ToDateTime("31-August-24")))
                                                {
                                                    gvsupdtquery.DataSource = dsADQuery.Tables[2];
                                                    gvsupdtquery.DataBind();
                                                    //trqueryDtls1IO.Visible = true;
                                                    Divsupdtquery.Visible = false;
                                                }
                                                else
                                                {
                                                    gvsupdtquery.DataSource = dsADQuery.Tables[2];
                                ...
                                else if (Role_Code == "COI-AD" || Role_Code == "COI-DD" || Role_Code == "COI-CLERK" || Role_Code == "COI-SUPDT")
                                {

                                    dsince = GetIncetiveDropDownListCOIOffice(Applicantinid, Role_Code, Role_Code, Incids);
                                    if (dsince != null && dsince.Tables.Count > 0 && dsince.Tables["Table"].Rows.Count > 0)
                                    {
                                        if (Incids != null && Incids != "")
                                        {
                                ...
                                if (Role_Code == "COI-CLERK")
                                {
                                    ddlTypeofinc_clerklevel.DataSource = dsince.Tables["Table"];
                                    ddlTypeofinc_clerklevel.DataValueField = "MstIncentiveId";
                                    ddlTypeofinc_clerklevel.DataTextField = "IncentiveName";
                                    ddlTypeofinc_clerklevel.DataBind();
                                }
                                if (Role_Code == "COI-SUPDT")
                                {
                                    ddlTypeofinc_supdtlevel.DataSource = dsince.Tables["Table"];
                                    ddlTypeofinc_supdtlevel.DataValueField = "MstIncentiveId";
                                    ddlTypeofinc_supdtlevel.DataTextField = "IncentiveName";
                                    ddlTypeofinc_supdtlevel.DataBind();
                                }
                                if (Role_Code == "COI-DD")
                                {
                                    ddlTypeofinc_DDlevel.DataSource = dsince.Tables["Table"];
                                    ddlTypeofinc_DDlevel.DataValueField = "MstIncentiveId";
                                    ddlTypeofinc_DDlevel.DataTextField = "IncentiveName";
                                    ddlTypeofinc_DDlevel.DataBind();
                                }
                                ///END OF ADDED CODE NIKHIL 
                ...
                DataSet dsnew1_new = new DataSet();
                dsnew1_new = Gen.GetIncetiveDetailsdeptAttachements(Request.QueryString[0].ToString());
                if (dsnew1_new != null && dsnew1_new.Tables.Count > 0 && dsnew1_new.Tables[0].Rows.Count > 0)
                {
                    gvSubsidy.DataSource = dsnew1_new.Tables[0];
                    gvSubsidy.DataBind();

                    gvfinalgrid.DataSource = dsnew1_new.Tables[0];
                    gvfinalgrid.DataBind();

                    if (dsnew1_new != null && dsnew1_new.Tables.Count > 1 && dsnew1_new.Tables[1].Rows.Count > 0)
                    {
                        trQueryResponceAttachments.Visible = true;
                        gvqquryresponceattachment.DataSource = dsnew1_new.Tables[1];
                        gvqquryresponceattachment.DataBind();

                        trattachemntslastgrid.Visible = true;
                        gvlastattachments.DataSource = dsnew1_new.Tables[1];
                        gvlastattachments.DataBind();
                    }
                }
                string userid = "";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                int statusapp = Gen.GMCertificateInsertUploadNew(lblIncentiveID, Session["uid"].ToString(), "", ddlapprove.SelectedValue, txtIncQueryFnl2, lblMstIncentiveId, txtrecomandedamount, getclientIP(), txtGMRecommendedRemarks, txtLoanAgreement.Text.ToString(), "");
            }
            else if (ddlapprove.SelectedValue == "1")
            {
                int incRtrVal = Gen.insertInctveQueryResponsedataNewatApproval(lblIncentiveID, txtIncQueryFnl2, Session["uid"].ToString(), lblMstIncentiveId, getclientIP(), null, null, null, null, null);
    ...
    protected void BtnAddremarks_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (CheckBoxList1.SelectedValue == "2")    // Query
            {
            ...
            foreach (GridViewRow gvrow in gvdicinspection.Rows)
            {
                ...
                try
                {
                    ...
                    if (lblvehno.Text != "")  //for vehicle
                        cmf.SendSingleSMSnew(txtunitmobileno.Text, "Dear Sir, Incentive Inspection is scheduled for your application (" + lblApplicationNo.Text.ToString() + ") on " + date1.ToString("dd-MMMM-yyyy") + ", and your assigned Inspecting Officer is " + deptIPOName + " and contact number is " + deptIPOMoileNO + ". Please bring your vehicle to  DIC -" + ddldistrictunit.Text + "Thank You, GM, DIC " + ddldistrictunit.Text + " Govt. of Telangana.", "100709214599452954");
                }
                catch (Exception ex)
                {
                    LogErrorFile.LogerrorDB(ex, HttpContext.Current.Request.Url.AbsoluteUri, Session["uid"].ToString());
    ...
    protected void gvinspectionOfficer_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (MstIncentiveId.Text == "18") // Coal
                {
                    (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaCoal.aspx?incentiveid=" + enterid.Text.Trim() + "&MstIncentiveId=" + MstIncentiveId.Text;
                }
                if (MstIncentiveId.Text == "19") // Wood
                {
                    (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaWood.aspx?incentiveid=" + enterid.Text.Trim() + "&MstIncentiveId=" + MstIncentiveId.Text;
                }
                if (MstIncentiveId.Text == "20") // TRANSPORT DUTY
                {
                    (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaTransportDuty.aspx?incentiveid=" + enterid.Text.Trim() + "&MstIncentiveId=" + MstIncentiveId.Text;
                }
    ...
    protected void btnAddQueryAdLevel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (rblStatus_adlevel.SelectedValue == "1")
            {
                ...
                if (ddlTypeofinc_adlevel.SelectedValue == "1")
                {
                    if (txtadrecomamount.Text == "")
                    {
            ...
            if (rblStatus_adlevel.SelectedValue == "2" || rblStatus_adlevel.SelectedValue == "4" || rblStatus_adlevel.SelectedValue == "5")
            {
                if (rblStatus_adlevel.SelectedValue == "4")
                {
                    if (ddlTypeofinc_adlevel.SelectedValue == "0" && txtAdlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter SSC Remarks";
                    }
                    else if (txtAdlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Enter SSC Remarks";
                    }
                }
                if (rblStatus_adlevel.SelectedValue == "5")
                {
                    if (ddlTypeofinc_adlevel.SelectedValue == "0" && txtAdlevelQuery.Text.Trim() == "")
                    {
                    ...
                    {
                        message = "Please Enter Abeyance Remarks";
                    }
                }
                else
                {
            ...
            if (rblStatus_adlevel.SelectedValue == "3")
            {
                if (ddlTypeofinc_adlevel.SelectedValue == "0" && txtadlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Select Type of Incentive \\nPlease Enter Query";
                }
                else if (txtadlevelreturnreason.Text.Trim() == "")
                {
            ...
            if (rblStatus_adlevel.SelectedValue == "1")
            {
                ...
                btnreturnad.Visible = false;
            }
            else if (rblStatus_adlevel.SelectedValue == "2" || rblStatus_adlevel.SelectedValue == "4" || rblStatus_adlevel.SelectedValue == "5")
            {
                ...
                if (rblStatus_adlevel.SelectedValue == "4")
                {
                    Label24.Text = "SSC Inspecion Remarks";
                }
                if (rblStatus_adlevel.SelectedValue == "5")
                {
                    Label24.Text = "Abeyance Remarks";
                }
            }
            else if (rblStatus_adlevel.SelectedValue == "3")
            {
                incentiveremarks = txtadlevelreturnreason.Text;
                btnSubmitAppraisal.Visible = false;
                btnQueryAdLevel.Visible = false;
                btnreturnad.Visible = true;
            }
            if (rblStatus_adlevel.SelectedValue == "2" || rblStatus_adlevel.SelectedValue == "4" || rblStatus_adlevel.SelectedValue == "5")    // Query
            {
                ...
                if (rblStatus_adlevel.SelectedValue == "4")
                {
                    btnQueryAdLevel.Text = "Refer to SSC Inspection";
                }
                if (rblStatus_adlevel.SelectedValue == "5")
                {
                    btnQueryAdLevel.Text = "Send Application to Abeyance Stage";
                }
            ...
            else if (rblStatus_adlevel.SelectedValue == "1")
            {                                               //full in shape
            ...
            if (rblStatus_adlevel.SelectedValue == "3")    // Query
            {

                AddDataToTableCeertificate(ddlTypeofinc_adlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_adlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTb2"]);
                this.gvreturn_adLevel.DataSource = ((DataTable)Session["CertificateTb2"]).DefaultView;
                this.gvreturn_adLevel.DataBind();
                trfullshap_AdRemakrs.Visible = true;
                ddlTypeofinc_adlevel.Items.Remove(ddlTypeofinc_adlevel.Items.FindByValue(ddlTypeofinc_adlevel.SelectedValue));
                if (ddlTypeofinc_adlevel.Items.Count == 1)
                {
    ...
    protected void rblStatus_adlevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rblStatus_adlevel.SelectedValue == "2" || rblStatus_adlevel.SelectedValue == "4" || rblStatus_adlevel.SelectedValue == "5")
            {
                if (gvsupdtquery.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvsupdtquery.Rows)
                    {
                        int rowIndex = gvrow.RowIndex;
                        string EnterperIncentiveID = ((Label)gvrow.FindControl("lblSuperintendentIncentivename")).Text.ToString();
                        string txtrecomandedamount = ((Label)gvrow.FindControl("lblSuperintendentQuery")).Text.ToString();
                        string status = ((Label)gvrow.FindControl("lblSuperintendentStatus")).Text.ToString();

                        if (ddlTypeofinc_adlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            if (rowIndex == 0)
                            {
                                if (status == "Query")
                                {
                                    txtAdlevelQuery.Text = txtrecomandedamount.TrimEnd().TrimStart().Trim();
                                }
                            }
                ...
                trreturnadlevel.Visible = false;
                trQuery_adlevel.Visible = true;
                tradrecommendamount.Visible = false;
                if (rblStatus_adlevel.SelectedValue == "4")
                {
                    Label24.Text = "SSC Inspection Remarks";
                }
                if (rblStatus_adlevel.SelectedValue == "5")
                {
                    Label24.Text = "Abeyance Remarks";
            ...
            {
                if (gvSuprdntrecommended.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvSuprdntrecommended.Rows)
                    {

                        int rowIndex = gvrow.RowIndex;
                        string EnterperIncentiveID = ((Label)gvrow.FindControl("lblIncentiveNameDis")).Text.ToString();
                        string txtrecomandedamountnew = ((TextBox)gvrow.FindControl("txtrecomandedamount")).Text.ToString();

                        if (ddlTypeofinc_adlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            txtadrecomamount.Text = txtrecomandedamountnew;
                        }
                    }
                }
                trQuery_adlevel.Visible = false;
        ...
        try
        {
            ...
            if (Role_Code.Trim() == "COI-AD")
            {
                ...
                if (valid == 1)
                {
                    ...
                    else if (status == "Hold Application")
                    {
                        message = "alert('Application Send to Abeyance Stage Successfully')";
                    }
                    else
                    {
    ...
    protected void ddlTypeofinc_clerklevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
        }
    ...
    protected void rblStatus_clerklevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rblStatus_clerklevel.SelectedValue == "2" || rblStatus_clerklevel.SelectedValue == "4" || rblStatus_clerklevel.SelectedValue == "5")
            {

                trQuery_clerklevel.Visible = true;
                if (rblStatus_clerklevel.SelectedValue == "5")
                {
                    Label27.Text = "Abeyance Remarks";
                }
            }

            //else if (rblStatus_clerklevel.SelectedValue == "3")
            //{
            //    trreturnclerklevel.Visible = true;
            //}
            if (rblStatus_clerklevel.SelectedValue == "1")
            {
                trQuery_clerklevel.Visible = false;
                if ((Request.QueryString[0].ToString() == "87040" && Incids == "5") || (Request.QueryString[0].ToString() == "168601" && Incids == "3"))
                {
                    trclerkrecommendamount.Visible = true;
                }
                else if (ddlTypeofinc_clerklevel.SelectedValue == "12" || ddlTypeofinc_clerklevel.SelectedValue == "7")
                {
                    trclerkrecommendamount.Visible = true;
                }
                else
                {
                    trclerkrecommendamount.Visible = false;
                }
            }
    ...
    protected void btnAddQueryclerkLevel_Click(object sender, EventArgs e)
    {
        string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
        gvQueries_ClerkLevel.Visible = true;
        try
        {

            //modified by chinna
            string message = "";
            if (rblStatus_clerklevel.SelectedValue == "")
            {
                message = "Please Select Status";
            }
            if (ddlTypeofinc_clerklevel.SelectedValue == "0")
            {
                message = "Please Select Type of Incentive";
            }
            if (ddlTypeofinc_clerklevel.SelectedValue == "0" && rblStatus_clerklevel.SelectedValue == "")
            {
                message = "Please Select Type of Incentive \\nPlease Select Status";
            }
            if (rblStatus_clerklevel.SelectedValue == "1")
            {
                ...
                if (ddlTypeofinc_clerklevel.SelectedValue == "1")
                {
                    ///Commented on 18/01/2022/// Pavallavaddi kept live
                    //if (txtclerkrecomamount.Text == "")
                    //{
                    //    message = "Please Enter the amount";
                    //}
            ...
            if (rblStatus_clerklevel.SelectedValue == "2" || rblStatus_clerklevel.SelectedValue == "4" || rblStatus_clerklevel.SelectedValue == "5")
            {
                if (rblStatus_clerklevel.SelectedValue == "4")
                {
                    if (ddlTypeofinc_clerklevel.SelectedValue == "0" && txtclerklevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter SSC Remarks";
                    }
                    else if (txtclerklevelQuery.Text.Trim() == "")
                    {
                        message = "Please Enter SSC Remarks";
                    }
                }
                else if (rblStatus_clerklevel.SelectedValue == "5")
                {
                    if (ddlTypeofinc_clerklevel.SelectedValue == "0" && txtclerklevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter Abeyance Remarks";
            ...
            if (rblStatus_clerklevel.SelectedValue == "1")
            {
                ...
                {
                    trclerkrecommendamount.Visible = true;
                    incentiveremarks = txtclerkrecomamount.Text;
                }
                //else if (ddlTypeofinc_clerklevel.SelectedValue == "1")
                else if (ddlTypeofinc_clerklevel.SelectedValue == "12" || ddlTypeofinc_clerklevel.SelectedValue == "7")
                {
                    //trclerkrecommendamount.Visible = true;
                    incentiveremarks = txtclerkrecomamount.Text;
                ...
                btnSubmitClerkAppraisal.Visible = true;
                btnQueryclerkLevel.Visible = false;
            }
            else if (rblStatus_clerklevel.SelectedValue == "2" || rblStatus_clerklevel.SelectedValue == "4" || rblStatus_clerklevel.SelectedValue == "5")
            {
                incentiveremarks = txtclerklevelQuery.Text;
                btnSubmitClerkAppraisal.Visible = false;
                btnQueryclerkLevel.Visible = true;
            }

            if (rblStatus_clerklevel.SelectedValue == "2" || rblStatus_clerklevel.SelectedValue == "4" || rblStatus_clerklevel.SelectedValue == "5")    // Query
            {

                AddDataToTableCeertificate(ddlTypeofinc_clerklevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_clerklevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTb2"]);
                this.gvQueries_ClerkLevel.DataSource = ((DataTable)Session["CertificateTb2"]).DefaultView;
                this.gvQueries_ClerkLevel.DataBind();
                trfullshap_AdRemakrs.Visible = true;
                ddlTypeofinc_clerklevel.Items.Remove(ddlTypeofinc_clerklevel.Items.FindByValue(ddlTypeofinc_clerklevel.SelectedValue));
                if (ddlTypeofinc_clerklevel.Items.Count == 1)
                {
                    rblStatus_clerklevel.Enabled = false;
                    btnAddQueryclerkLevel.Visible = false;
                }
            }
            ...
            else
            {
                ...
                AddDataToTableCeertificateAmount(ddlTypeofinc_clerklevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_clerklevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTbAmount"]);
                this.GridView17.DataSource = ((DataTable)Session["CertificateTbAmount"]).DefaultView;
                this.GridView17.DataBind();
                tr27.Visible = true;

                // ddlstaire.Items.Remove(ddlstaire.SelectedValue);
                if (Role_Code.Trim() == "COI-CLERK")
                {
                    if (GridView17.Rows.Count > 0)   //&& (txtLandJD.Text != "" && txtBuildingJD.Text != "" && txtPnMJD.Text != "")
                    {
            ...
            lblmsg.Text = "";
            ddlTypeofinc_clerklevel.SelectedValue = "0";
            txtclerklevelQuery.Text = "";

            //rblStatus_clerklevel.SelectedIndex = -1;
            rblStatus_clerklevel.Enabled = false;
            foreach (GridViewRow rown in gvQueries_ClerkLevel.Rows)
            {
                string name = Session["uid"].ToString();
                if (Session["uid"].ToString() != name)
                {
    ...
    protected void gvQueries_ClerkLevel_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            int rowww = e.RowIndex;
            string idnew = ((Label)gvQueries_ClerkLevel.Rows[e.RowIndex].FindControl("Label56")).Text.ToString().Trim();
            string IncentiveName = gvQueries_ClerkLevel.Rows[e.RowIndex].Cells[2].Text;
            string lblMstIncentiveId = ((Label)gvQueries_ClerkLevel.Rows[e.RowIndex].FindControl("Label53")).Text.ToString().Trim();

            ListItem li = new ListItem();
            li.Text = IncentiveName;
            li.Value = lblMstIncentiveId;

            ddlTypeofinc_clerklevel.Items.Add(li);
            ...
            if (gvQueries_ClerkLevel.Rows.Count == 1)
            {
                trfullshap_AdRemakrs.Visible = false;
                btnSubmitAppraisal.Visible = false;
            }
    ...
    protected void gvQueries_ClerkLevel_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
    ...
    protected void btnSubmitClerkAppraisal_Click(object sender, EventArgs e)
    {
        lstremarksclerk.Clear();
        int valid = 0;
        //string IncentiveID = "";
        //DataTable oDataSet;
        //oDataSet = new DataTable();
        ...
        try
        {
            foreach (GridViewRow gvrow in GridView17.Rows)
            {
                ...
                fromvo.id = ((Label)gvrow.FindControl("Label60")).Text.ToString();
                fromvo.status = "Recomm";
                fromvo.Remarks = HttpUtility.HtmlDecode(GridView17.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label59")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();



                lstremarksclerk.Add(fromvo);
            ...
            foreach (GridViewRow gvrow in GridView17.Rows)
            {
                ...
                if (Role_Code.Trim() == "COI-CLERK")
                {
                    if (frmvo.MstIncentiveId == "1") /// PAVALLA VADDI
                    {
                        //Response.Redirect("apparaisalPavallavaddi_New.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                        Response.Redirect("Pavalavaddiregularandmoratorium.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }

                    if (frmvo.MstIncentiveId == "6") /// INVESTMENTSUBSIDY
                    {
                        Response.Redirect("apparaisalnote_isform1.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "15")
                    {
                        Response.Redirect("apparaisalMortgage.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "17")
                    {
                        Response.Redirect("apparaisalnote_isformLandCost.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "14")
                    {
                        Response.Redirect("apparaisalnote_isformStampDuty.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "16")
                    {
                        Response.Redirect("appraisalLandConversion.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "5" && ViewState["IncentveID"].ToString() != "87040")
                    {
                        Response.Redirect("Appraisalnote_SalesTax.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "11")
                    {
                        Response.Redirect("Appraisalnote_QualityCertification.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "3")
                    {
                        Response.Redirect("apparaisalPowerTariff.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "18")
                    {
                        Response.Redirect("Appraisalnote_Coal.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "19")
                    {
                        Response.Redirect("ApraisalNote_Wood.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "20")
                    {
                        Response.Redirect("AppraisalNoteTransportDuty.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    if (frmvo.MstIncentiveId == "4")
                    {
                        Response.Redirect("apparaisalnote_SpecificCleaner.aspx?incentiveid=" + ViewState["IncentveID"].ToString() + "&MstIncentiveId=" + frmvo.MstIncentiveId);
                    }
                    else
                    {
                        valid = InsertincentiveOfficerCommentsAD(lstremarksclerk, lstincentives, getclientIP());
                        if (valid == 1)
                        {
                            btnSubmitClerkAppraisal.Enabled = false;
                            string message = "";
    ...
    protected void btnQueryclerkLevel_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            DataTable oDataSet;
            oDataSet = new DataTable();
            oDataSet = (DataTable)gvQueries_ClerkLevel.DataSource;
            string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
            ...
            foreach (GridViewRow gvrow in gvQueries_ClerkLevel.Rows)
            {
                ...
                fromvo.MstIncentiveId = ((Label)gvrow.FindControl("Label53")).Text.ToString();
                fromvo.id = ((Label)gvrow.FindControl("Label56")).Text.ToString();
                if (rblStatus_clerklevel.SelectedValue == "2")
                {
                    fromvo.status = "Query";
                }
                if (rblStatus_clerklevel.SelectedValue == "4")
                ...
                fromvo.Remarks = HttpUtility.HtmlDecode(gvQueries_ClerkLevel.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label55")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();
            ...
            if (Role_Code.Trim() == "COI-CLERK")
            {
                ...
                if (valid == 1)
                {
                    ...
                    else
                    {
                        ...
                        if (rblStatus_clerklevel.SelectedValue == "4")
                        {
                            message = "alert('Application send to SSC Inspection Successfully')";
                        }
                        else
                        {
                            message = "alert('Query raised Successfully')";
                    ...
                    btnQueryclerkLevel.Enabled = false;
    ...
    protected void ddlTypeofinc_supdtlevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
        }
    ...
    protected void rblStatus_supdtlevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rblStatus_supdtlevel.SelectedValue == "2" || rblStatus_supdtlevel.SelectedValue == "4" || rblStatus_supdtlevel.SelectedValue == "5" || rblStatus_supdtlevel.SelectedValue == "6")
            {
                if (rblStatus_supdtlevel.SelectedValue == "2")
                {
                    if (gvclerkquery.Rows.Count > 0)
                    {
                        foreach (GridViewRow gvrow in gvclerkquery.Rows)
                        {
                            int rowIndex = gvrow.RowIndex;
                            string EnterperIncentiveID = ((Label)gvrow.FindControl("lblclerkIncentiveName")).Text.ToString();
                            string txtrecomandedamount = ((Label)gvrow.FindControl("lblclerkQueryDescription")).Text.ToString();
                            string status = ((Label)gvrow.FindControl("lblclerkAPPstatus")).Text.ToString();

                            if (ddlTypeofinc_supdtlevel.SelectedItem.Text == EnterperIncentiveID)
                            {
                                if (rowIndex == 0)
                                {
                                    if (status == "Query")
                                    {
                                        txtsupdtlevelQuery.Text = txtrecomandedamount.TrimEnd().TrimStart().Trim();
                                    }
                                }
                ...
                trQuery_supdtlevel.Visible = true;
                trreturn_supdtlevel.Visible = false;
                trsupdtrecommendamount.Visible = false;
                if (rblStatus_supdtlevel.SelectedValue == "4")
                {
                    Label35.Text = "SSC Remarks";
                }
                if (rblStatus_supdtlevel.SelectedValue == "5")
                {
                    Label35.Text = "Abeyance Remarks";
                }
                if (rblStatus_supdtlevel.SelectedValue == "6")
                {
                    Label35.Text = "SSC Completion Remarks";
                    trsscreport.Visible = true;
                }
            }

            else if (rblStatus_supdtlevel.SelectedValue == "3")
            {
                trreturn_supdtlevel.Visible = true;
                trsupdtrecommendamount.Visible = false;
                trQuery_supdtlevel.Visible = false;
            }
            if (rblStatus_supdtlevel.SelectedValue == "1")
            {
                if (gvclerkrecommended.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvclerkrecommended.Rows)
                    {
                        ...
                        if (ddlTypeofinc_supdtlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            txtsupdtrecomamount.Text = txtrecomandedamountnew;
                        }
                    }

                    trsupdtrecommendamount.Visible = true;
                    trQuery_supdtlevel.Visible = false;
                    trreturn_supdtlevel.Visible = false;
                    txtsupdtrecomamount.Focus();
                }
                //if (ddlTypeofinc_supdtlevel.SelectedValue == "1")
                //{
                trsupdtrecommendamount.Visible = true;
                trQuery_supdtlevel.Visible = false;
                trreturn_supdtlevel.Visible = false;
    ...
    protected void btnAddQuerysupdtLevel_Click(object sender, EventArgs e)
    {
        string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
        gvQueries_supdtLevel.Visible = true;
        try
        {

            //modified by chinna
            string message = "";
            if (rblStatus_supdtlevel.SelectedValue == "")
            {
                message = "Please Select Status";
            }
            if (ddlTypeofinc_supdtlevel.SelectedValue == "0")
            {
                message = "Please Select Type of Incentive";
            }
            if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && rblStatus_supdtlevel.SelectedValue == "")
            {
                message = "Please Select Type of Incentive \\nPlease Select Status";
            }
            if (rblStatus_supdtlevel.SelectedValue == "1")
            ...
            if (rblStatus_supdtlevel.SelectedValue == "2" || rblStatus_supdtlevel.SelectedValue == "4" || rblStatus_supdtlevel.SelectedValue == "5" || rblStatus_supdtlevel.SelectedValue == "6")
            {
                if (rblStatus_supdtlevel.SelectedValue == "4")
                {
                    if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && txtsupdtlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter SSC Remarks";
                    }
                    else if (txtsupdtlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Enter SSC Remarks";
                    }
                }
                else if (rblStatus_supdtlevel.SelectedValue == "5")
                {
                    if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && txtsupdtlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter Abeyance Remarks";
                ...
                else if (rblStatus_supdtlevel.SelectedValue == "6")
                {
                    if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && txtsupdtlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter SSC Inspection Completed Report Remarks";
                    }
                    else if (txtsupdtlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Enter SSC Inspection Completed Report Remarks";
                    }
                    if (Labelsscreport.Text == null && Labelsscreport.Text == "")
                    {
                        message = "Please Upload the SSC Completion Report";
                    }
                }
                else
                {
            ...
            if (rblStatus_supdtlevel.SelectedValue == "3")
            {
                if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && txtsupdtlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Select Type of Incentive \\nPlease Enter Query";
                }
                else if (txtsupdtlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Enter reason for return";
                }
            }
            ...
            if (rblStatus_supdtlevel.SelectedValue == "1")
            {
                //if (ddlTypeofinc_supdtlevel.SelectedValue != "6")
                //{
                incentiveremarks = txtsupdtrecomamount.Text;
                //}
                //else
                //{
                //    incentiveremarks = "";
                //}
                btnSubmitsupdtAppraisal.Visible = true;
                btnQuerysupdtLevel.Visible = false;
                btnreturnsupdtLevel.Visible = false;
            }
            else if (rblStatus_supdtlevel.SelectedValue == "2" || rblStatus_supdtlevel.SelectedValue == "4" || rblStatus_supdtlevel.SelectedValue == "5")
            {
                incentiveremarks = txtsupdtlevelQuery.Text;
                btnSubmitsupdtAppraisal.Visible = false;
                btnQuerysupdtLevel.Visible = true;
                btnreturnsupdtLevel.Visible = false;
            }
            else if (rblStatus_supdtlevel.SelectedValue == "3")
            {
                incentiveremarks = txtsupdtlevelreturnreason.Text;
                btnSubmitsupdtAppraisal.Visible = false;
                btnQuerysupdtLevel.Visible = false;
                btnreturnsupdtLevel.Visible = true;
            }
            else if (rblStatus_supdtlevel.SelectedValue == "6")
            {
                incentiveremarks = txtsupdtlevelQuery.Text;
            ...
            if (rblStatus_supdtlevel.SelectedValue == "2" || rblStatus_supdtlevel.SelectedValue == "4" || rblStatus_supdtlevel.SelectedValue == "5")    // Query
            {

                AddDataToTableCeertificate(ddlTypeofinc_supdtlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_supdtlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTb2"]);
                this.gvQueries_supdtLevel.DataSource = ((DataTable)Session["CertificateTb2"]).DefaultView;
                this.gvQueries_supdtLevel.DataBind();
                if (rblStatus_supdtlevel.SelectedValue == "4")
                {
                    btnQuerysupdtLevel.Text = "Refer to SSC Inspection";
                }
                if (rblStatus_supdtlevel.SelectedValue == "5")
                {
                    btnQuerysupdtLevel.Text = "Send Application to Abeyance Stage";
                }
                trfullshap_AdRemakrs.Visible = true;
                ddlTypeofinc_supdtlevel.Items.Remove(ddlTypeofinc_supdtlevel.Items.FindByValue(ddlTypeofinc_supdtlevel.SelectedValue));
                if (ddlTypeofinc_supdtlevel.Items.Count == 1)
                {
                    rblStatus_supdtlevel.Enabled = false;
                    btnAddQuerysupdtLevel.Visible = false;
                    btnreturnsupdtLevel.Visible = false;
                }
            }
            ...
            else if (rblStatus_supdtlevel.SelectedValue == "1")
            {                                               //full in shape
                AddDataToTableCeertificateAmount(ddlTypeofinc_supdtlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_supdtlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTbAmount"]);
                this.GridView15.DataSource = ((DataTable)Session["CertificateTbAmount"]).DefaultView;
                this.GridView15.DataBind();
                tr26.Visible = true;

                // ddlstaire.Items.Remove(ddlstaire.SelectedValue);
                if (Role_Code.Trim() == "COI-SUPDT")
                {
                    if (GridView15.Rows.Count > 0)   //&& (txtLandJD.Text != "" && txtBuildingJD.Text != "" && txtPnMJD.Text != "")
                    {
            ...
            if (rblStatus_supdtlevel.SelectedValue == "3" || rblStatus_supdtlevel.SelectedValue == "6")    // Query
            {
            ...
            lblmsg.Text = "";
            ddlTypeofinc_supdtlevel.SelectedValue = "0";
            txtsupdtlevelQuery.Text = "";

            //rblStatus_supdtlevel.SelectedIndex = -1;
            rblStatus_supdtlevel.Enabled = false;
            foreach (GridViewRow rown in gvQueries_supdtLevel.Rows)
            {
                string name = Session["uid"].ToString();
                if (Session["uid"].ToString() != name)
                {
    ...
    protected void gvQueries_supdtLevel_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
        }
    ...
    protected void gvQueries_supdtLevel_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
        }
    ...
    protected void btnSubmitsupdtAppraisal_Click(object sender, EventArgs e)
    {
        lstremarkssupdt.Clear();
        int valid = 0;
        //string IncentiveID = "";
        //DataTable oDataSet;
        //oDataSet = new DataTable();
        ...
        try
        {
            foreach (GridViewRow gvrow in GridView15.Rows)
            {
                ...
                fromvo.id = ((Label)gvrow.FindControl("Label60")).Text.ToString();
                fromvo.status = "Recomm";
                fromvo.Remarks = HttpUtility.HtmlDecode(GridView15.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label59")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();



                lstremarkssupdt.Add(fromvo);
            ...
            foreach (GridViewRow gvrow in GridView15.Rows)
            {
                ...
                if (Role_Code.Trim() == "COI-SUPDT")
                {
                    ...
                    valid = InsertincentiveOfficerCommentsAD(lstremarkssupdt, lstincentives, getclientIP());
                    if (valid == 1)
                    {
                        btnSubmitsupdtAppraisal.Enabled = false;
                        string message = "";
    ...
    protected void btnQuerysupdtLevel_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            DataTable oDataSet;
            oDataSet = new DataTable();
            oDataSet = (DataTable)gvQueries_supdtLevel.DataSource;
            string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
            ...
            foreach (GridViewRow gvrow in gvQueries_supdtLevel.Rows)
            {
                ...
                fromvo.Remarks = HttpUtility.HtmlDecode(gvQueries_supdtLevel.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label55")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();
            ...
            if (Role_Code.Trim() == "COI-SUPDT")
            {
                ...
                if (valid == 1)
                {
                    ...
                    btnQuerysupdtLevel.Enabled = false;
    ...
    protected void ddlTypeofinc_DDlevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
        }
    ...
    protected void rblStatus_DDlevel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rblStatus_DDlevel.SelectedValue == "2" || rblStatus_DDlevel.SelectedValue == "4" || rblStatus_DDlevel.SelectedValue == "5")
            {
                if (GVADQueryStatus.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in GVADQueryStatus.Rows)
                    {
                        int rowIndex = gvrow.RowIndex;
                        string EnterperIncentiveID = ((Label)gvrow.FindControl("lbladIncentiveName")).Text.ToString();
                        string txtrecomandedamount = ((Label)gvrow.FindControl("lbladQueryDescription")).Text.ToString().Replace("\n", "");
                        string status = ((Label)gvrow.FindControl("lbladAPPstatus")).Text.ToString();

                        if (ddlTypeofinc_DDlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            if (rowIndex == 0)
                            {
                                if (status == "Query")
                                {
                                    txtDDlevelQuery.Text = txtrecomandedamount.TrimEnd().TrimStart().Trim();
                                }
                            }
                ...
                else if (gvsupdtquery.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvsupdtquery.Rows)
                    {
                        int rowIndex = gvrow.RowIndex;
                        ...
                        if (ddlTypeofinc_DDlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            if (rowIndex == 0)
                            {
                                if (status == "Query")
                                {
                                    txtDDlevelQuery.Text = txtrecomandedamount;
                                }
                            }
                ...
                trQuery_DDlevel.Visible = true;
                trDDrecommendamount.Visible = false;
                trDDreturn.Visible = false;
                if (rblStatus_DDlevel.SelectedValue == "4")
                {
                    Label63.Text = "SSC Inspection Remarks";
                }
                if (rblStatus_DDlevel.SelectedValue == "5")
                {
                    Label63.Text = "Abeyance Remarks";
                }
            }

            else if (rblStatus_DDlevel.SelectedValue == "3")
            {
                trDDreturn.Visible = true;
                trQuery_DDlevel.Visible = false;
                trDDrecommendamount.Visible = false;
            }
            if (rblStatus_DDlevel.SelectedValue == "1")
            {
                if (gvadrecommended.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvadrecommended.Rows)
                    {
                        ...
                        if (ddlTypeofinc_DDlevel.SelectedItem.Text == EnterperIncentiveID)
                        {
                            txtDDrecomamount.Text = txtrecomandedamountnew;
                        }
                    }
                }
                else if (gvSuprdntrecommended.Rows.Count > 0)
                {
                    foreach (GridViewRow gvrow in gvSuprdntrecommended.Rows)
                    {
                ...
                trDDrecommendamount.Visible = true;
                trDDrecommendamount.Focus();
                trQuery_DDlevel.Visible = false;
                trDDreturn.Visible = false;
    ...
    protected void btnAddQueryDDLevel_Click(object sender, EventArgs e)
    {
        string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
        gvQueries_DDLevel.Visible = true;
        try
        {

            //modified by chinna
            string message = "";
            if (rblStatus_DDlevel.SelectedValue == "")
            {
                message = "Please Select Status";
            }
            if (ddlTypeofinc_DDlevel.SelectedValue == "0")
            {
                message = "Please Select Type of Incentive";
            }
            if (ddlTypeofinc_DDlevel.SelectedValue == "0" && rblStatus_DDlevel.SelectedValue == "")
            {
                message = "Please Select Type of Incentive \\nPlease Select Status";
            }
            if (rblStatus_DDlevel.SelectedValue == "1")
            {
                txtDDrecomamount.Focus();
                if (ddlTypeofinc_DDlevel.SelectedValue == "0")
                {
                    message = "Please Select Type of Incentive";
                }
                if (ddlTypeofinc_DDlevel.SelectedValue == "1")
                {
                    if (txtDDrecomamount.Text == "")
                    {
                        message = "Please Enter the amount";
                    }
            ...
            if (rblStatus_DDlevel.SelectedValue == "2" || rblStatus_DDlevel.SelectedValue == "4" || rblStatus_DDlevel.SelectedValue == "5")
            {
                if (rblStatus_DDlevel.SelectedValue == "4")
                {
                    txtDDlevelQuery.Focus();
                    if (ddlTypeofinc_DDlevel.SelectedValue == "0" && txtDDlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Select Type of Incentive \\nPlease Enter SSC Remarks";
                    }
                    else if (txtDDlevelQuery.Text.Trim() == "")
                    {
                        message = "Please Enter SSC Remarks";
                    }
                }
                else if (rblStatus_DDlevel.SelectedValue == "5")
                {
                    txtDDlevelQuery.Focus();
                    if (ddlTypeofinc_DDlevel.SelectedValue == "0" && txtDDlevelQuery.Text.Trim() == "")
                    {
            ...
            if (rblStatus_DDlevel.SelectedValue == "3")
            {
                trDDreturn.Focus();
                txtDDlevelreturnreason.Focus();
                if (ddlTypeofinc_DDlevel.SelectedValue == "0" && txtDDlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Select Type of Incentive \\nPlease Enter Query";
                }
                else if (txtDDlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Enter reason for return";
                }
            }
            ...
            {
                trDDrecommendamount.Focus();
                //if (ddlTypeofinc_DDlevel.SelectedValue != "6")
                //{
                incentiveremarks = txtDDrecomamount.Text;
                //}
                //else
                //{
                //    incentiveremarks = "";
                //}
                btnSubmitDDAppraisal.Visible = true;
                btnQueryDDLevel.Visible = false;
                btnreturnddLevel.Visible = false;
            }
            else if (rblStatus_DDlevel.SelectedValue == "2" || rblStatus_DDlevel.SelectedValue == "4" || rblStatus_DDlevel.SelectedValue == "5")
            {
                incentiveremarks = txtDDlevelQuery.Text;
                btnSubmitDDAppraisal.Visible = false;
                btnQueryDDLevel.Visible = true;
                btnreturnddLevel.Visible = false;
                if (rblStatus_DDlevel.SelectedValue == "4")
                {
                    Label63.Text = "SSC Inspection Remarks";
            ...
            {
                incentiveremarks = txtDDlevelreturnreason.Text;
                btnSubmitDDAppraisal.Visible = false;
                btnQueryDDLevel.Visible = false;
                btnreturnddLevel.Visible = true;
            }
            if (rblStatus_DDlevel.SelectedValue == "2" || rblStatus_DDlevel.SelectedValue == "4" || rblStatus_DDlevel.SelectedValue == "5")    // Query
            {

                AddDataToTableCeertificate(ddlTypeofinc_DDlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_DDlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTb2"]);
                this.gvQueries_DDLevel.DataSource = ((DataTable)Session["CertificateTb2"]).DefaultView;
                this.gvQueries_DDLevel.DataBind();
                trfullshap_AdRemakrs.Visible = true;
                if (rblStatus_DDlevel.SelectedValue == "4")
                {
                    btnQueryDDLevel.Text = "Refer to SSC Inspection";
                }
                if (rblStatus_DDlevel.SelectedValue == "5")
                {
                    btnQueryDDLevel.Text = "Send Application to Abeyance Stage";
                }
                ddlTypeofinc_DDlevel.Items.Remove(ddlTypeofinc_DDlevel.Items.FindByValue(ddlTypeofinc_DDlevel.SelectedValue));
                if (ddlTypeofinc_DDlevel.Items.Count == 1)
                {
                    rblStatus_DDlevel.Enabled = false;
                    btnAddQueryDDLevel.Visible = false;
                    btnreturnddLevel.Visible = false;
                }
            }
            ...
            else if (rblStatus_DDlevel.SelectedValue == "1")
            {                                               //full in shape
                AddDataToTableCeertificateAmount(ddlTypeofinc_DDlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_DDlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTbAmount"]);
                this.GridView18.DataSource = ((DataTable)Session["CertificateTbAmount"]).DefaultView;
                this.GridView18.DataBind();
                tr26.Visible = true;

                // ddlstaire.Items.Remove(ddlstaire.SelectedValue);
                if (Role_Code.Trim() == "COI-DD")
                {
                    if (GridView18.Rows.Count > 0)   //&& (txtLandJD.Text != "" && txtBuildingJD.Text != "" && txtPnMJD.Text != "")
                    {
            ...
            if (rblStatus_DDlevel.SelectedValue == "3")    // Query
            {
            ...
            lblmsg.Text = "";
            ddlTypeofinc_DDlevel.SelectedValue = "0";
            txtDDlevelQuery.Text = "";

            //rblStatus_DDlevel.SelectedIndex = -1;
            rblStatus_DDlevel.Enabled = false;
            foreach (GridViewRow rown in gvQueries_DDLevel.Rows)
            {
                string name = Session["uid"].ToString();
                if (Session["uid"].ToString() != name)
                {
    ...
    //            }
    //        }
    //        if (rblStatus_DDlevel.SelectedValue == "2")
    //        {
    //            if (ddlTypeofinc_DDlevel.SelectedValue == "0" && txtDDlevelQuery.Text.Trim() == "")
    //            {
    //                message = "Please Select Type of Incentive \\nPlease Enter Query";
    ...
    //            btnQueryDDLevel.Visible = false;
    //        }
    //        else if (rblStatus_DDlevel.SelectedValue == "2")
    //        {
    //            incentiveremarks = txtDDlevelQuery.Text;
    //            btnSubmitDDAppraisal.Visible = false;
    //            btnQueryDDLevel.Visible = true;
    ...
    //        if (rblStatus_DDlevel.SelectedValue == "2")    // Query
    //        {
    ...
    //    gvQueries_DDLevel.Visible = true;
    //}
    protected void gvQueries_DDLevel_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
        }
    ...
    protected void gvQueries_DDLevel_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
        }
    ...
    protected void btnSubmitDDAppraisal_Click(object sender, EventArgs e)
    {
        lstremarksdd.Clear();
        int valid = 0;
        //string IncentiveID = "";
        ...
        try
        {
            foreach (GridViewRow gvrow in GridView18.Rows)
            {
                ...
                fromvo.id = ((Label)gvrow.FindControl("Label60")).Text.ToString();
                fromvo.status = "Recomm";
                fromvo.Remarks = HttpUtility.HtmlDecode(GridView18.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label59")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();



                lstremarksdd.Add(fromvo);
            ...
            foreach (GridViewRow gvrow in GridView18.Rows)
            {
                ...
                if (Role_Code.Trim() == "COI-DD")
                {
                    ...
                    valid = InsertincentiveOfficerCommentsAD(lstremarksdd, lstincentives, getclientIP());
                    if (valid == 1)
                    {
                        btnSubmitDDAppraisal.Enabled = false;
                        string message = "";
    ...
    protected void btnQueryDDLevel_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            DataTable oDataSet;
            oDataSet = new DataTable();
            oDataSet = (DataTable)gvQueries_DDLevel.DataSource;
            string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
            ...
            foreach (GridViewRow gvrow in gvQueries_DDLevel.Rows)
            {
                ...
                fromvo.Remarks = HttpUtility.HtmlDecode(gvQueries_DDLevel.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label55")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();
    ...
    protected void btnAddreturnsupdtLevel_Click(object sender, EventArgs e)
    {
        string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
        gvreturn_supdtLevel.Visible = true;
        try
        {
            ...
            if (rblStatus_supdtlevel.SelectedValue == "6")
            {
                if (ddlTypeofinc_supdtlevel.SelectedValue == "0" && txtsupdtlevelreturnreason.Text.Trim() == "")
                {
                    message = "Please Select Type of Incentive \\nPlease Enter SSC Completion Remarks";
                }
                else if (txtsupdtlevelreturnreason.Text.Trim() == "")
                {
            ...
            else if (rblStatus_supdtlevel.SelectedValue == "2")
            {
                incentiveremarks = txtsupdtlevelQuery.Text;
                btnSubmitsupdtAppraisal.Visible = false;
                btnQuerysupdtLevel.Visible = true;
            }
            else if (rblStatus_supdtlevel.SelectedValue == "3" || rblStatus_supdtlevel.SelectedValue == "6")
            {
                incentiveremarks = txtsupdtlevelreturnreason.Text;
                btnSubmitsupdtAppraisal.Visible = false;
                btnQuerysupdtLevel.Visible = false;
            ...
            if (rblStatus_supdtlevel.SelectedValue == "3" || rblStatus_supdtlevel.SelectedValue == "6")    // return
            {

                AddDataToTableCeertificate(ddlTypeofinc_supdtlevel.SelectedItem.Text, incentiveremarks, Session["username"].ToString(), System.DateTime.Now.ToString("dd/MM/yyyy"), ddlTypeofinc_supdtlevel.SelectedValue, ViewState["IncentveID"].ToString(), Session["uid"].ToString(), (DataTable)Session["CertificateTb2"]);
                this.gvreturn_supdtLevel.DataSource = ((DataTable)Session["CertificateTb2"]).DefaultView;
                this.gvreturn_supdtLevel.DataBind();
                trfullshap_AdRemakrs.Visible = true;
                btnreturnsupdtLevel.Visible = true;
                ddlTypeofinc_supdtlevel.Items.Remove(ddlTypeofinc_supdtlevel.Items.FindByValue(ddlTypeofinc_supdtlevel.SelectedValue));
                if (ddlTypeofinc_supdtlevel.Items.Count == 1)
            ...
            ddlTypeofinc_supdtlevel.SelectedValue = "0";
            txtsupdtlevelQuery.Text = "";
            txtsupdtlevelreturnreason.Text = "";

            rblStatus_supdtlevel.SelectedIndex = -1;
            foreach (GridViewRow rown in gvreturn_supdtLevel.Rows)
            {
                string name = Session["uid"].ToString();
                if (Session["uid"].ToString() != name)
                {
    ...
    protected void gvreturn_supdtLevel_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {

    }
    protected void gvreturn_supdtLevel_RowDataBound(object sender, GridViewRowEventArgs e)
    {

    }
    protected void btnreturnsupdtLevel_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            if (Role_Code.Trim() == "COI-SUPDT")
            {
                ...
                if (valid == 1)
                {
                    ...
                    {
                        message = "alert('Application Returned to Clerk Successfully')";
                    }
                    ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", message, true);

                    btnreturnsupdtLevel.Enabled = false;
    ...
    protected void btnreturnad_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            DataTable oDataSet;
            oDataSet = new DataTable();
            oDataSet = (DataTable)gvreturn_adLevel.DataSource;
            string Role_Code = Session["Role_Code"].ToString().Trim().TrimStart();
            ...
            foreach (GridViewRow gvrow in gvreturn_adLevel.Rows)
            {
                ...
                fromvo.id = ((Label)gvrow.FindControl("Label56")).Text.ToString();
                fromvo.status = "Return";
                fromvo.Remarks = HttpUtility.HtmlDecode(gvreturn_adLevel.Rows[rowIndex].Cells[3].Text);
                fromvo.CreatedByid = ((Label)gvrow.FindControl("Label55")).Text.ToString();
                fromvo.Designation = Role_Code.Trim();
            ...
            if (Role_Code.Trim() == "COI-AD")
            {
                ...
                if (valid == 1)
                {
                    ...
                    {
                        message = "alert('Return Application Successfully')";
                    }
                    ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", message, true);

                    btnreturnad.Enabled = false;
    ...
    protected void gvreturn_adLevel_RowDataBound(object sender, GridViewRowEventArgs e)
    {

    }

    public DataSet GetIncetiveDropDownListCOIOffice(string incentiveID, string RoleCode, string Status, string Incids)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("[USP_COI_DROPDOWNBINDING_ROLEBASE]", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    protected void btnreturnddLevel_Click(object sender, EventArgs e)
    {
        try
        {
            string status = "";
            ...
            if (Role_Code.Trim() == "COI-DD")
            {
                ...
                if (valid == 1)
                {
                    ...
                    {
                        message = "alert('Application Returned to AD Successfully')";
                    }
                    ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", message, true);

                    btnreturnddLevel.Enabled = false;
    ...
    public DataSet getADDLAbeyancedList(string incentiveid, string mstincentiveid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("USP_GET_ADDL_ABEYANCED_DTLS", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
