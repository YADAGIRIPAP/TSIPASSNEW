...
public partial class UI_TSiPASS_frmmsmecfeuitscuurentmonthreports : System.Web.UI.Page
{
    ...
    decimal Nounits, msmemapped, msmenotmapped, tsunits, tsmapped, tsnotmapped, TSIPASSPOULTRYUNITS,
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HyTsipassnotmapped.NavigateUrl = "frmMSMEReportDRILLDOWN.aspx?ROLE=IPO&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&type=TSIPASSNOTMAPPEDWITHMSME";

            HyperLink HyTSIPASSPOULTRYUNITS = (HyperLink)e.Row.FindControl("HyTSIPASSPOULTRYUNITS");
            HyTSIPASSPOULTRYUNITS.NavigateUrl = "frmMSMEReportDRILLDOWN.aspx?ROLE=IPO&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&type=TSIPASSPOULTRYUNITS";
            ...
            decimal tsPoultry1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TSIPASSPOULTRYUNITS"));
            TSIPASSPOULTRYUNITS = tsPoultry1 + TSIPASSPOULTRYUNITS;
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Label lbtsPoultry = new Label();
            lbtsPoultry.Text = TSIPASSPOULTRYUNITS.ToString();
            e.Row.Cells[8].Text = TSIPASSPOULTRYUNITS.ToString();
            e.Row.Cells[8].Controls.Add(lbtsPoultry);

            Label lblTSIPASSMAPPED1 = new Label();
            lblTSIPASSMAPPED1.Text = TSIPASSMAPPED1.ToString();
            e.Row.Cells[9].Text = TSIPASSMAPPED1.ToString();
            e.Row.Cells[9].Controls.Add(lblTSIPASSMAPPED1);

            Label lblTSIPASSMAPPED2 = new Label();
            lblTSIPASSMAPPED2.Text = TSIPASSMAPPED2.ToString();
            e.Row.Cells[10].Text = TSIPASSMAPPED2.ToString();
            e.Row.Cells[10].Controls.Add(lblTSIPASSMAPPED2);

            Label lblTSIPASSMAPPED3 = new Label();
            lblTSIPASSMAPPED3.Text = TSIPASSMAPPED3.ToString();
            e.Row.Cells[11].Text = TSIPASSMAPPED3.ToString();
            e.Row.Cells[11].Controls.Add(lblTSIPASSMAPPED3);

            Label lblTSIPASSMAPPED4 = new Label();
            lblTSIPASSMAPPED4.Text = TSIPASSMAPPED4.ToString();
            e.Row.Cells[12].Text = TSIPASSMAPPED4.ToString();
            e.Row.Cells[12].Controls.Add(lblTSIPASSMAPPED4);

            Label lblTSIPASSMAPPED5 = new Label();
            lblTSIPASSMAPPED5.Text = TSIPASSMAPPED5.ToString();
            e.Row.Cells[13].Text = TSIPASSMAPPED5.ToString();
            e.Row.Cells[13].Controls.Add(lblTSIPASSMAPPED5);

            Label lblTSIPASSMAPPED6 = new Label();
            lblTSIPASSMAPPED6.Text = TSIPASSMAPPED6.ToString();
            e.Row.Cells[14].Text = TSIPASSMAPPED6.ToString();
            e.Row.Cells[14].Controls.Add(lblTSIPASSMAPPED6);

            Label lblTSIPASSMAPPED7 = new Label();
            lblTSIPASSMAPPED7.Text = TSIPASSMAPPED7.ToString();
            e.Row.Cells[15].Text = TSIPASSMAPPED7.ToString();
            e.Row.Cells[15].Controls.Add(lblTSIPASSMAPPED7);

            Label lblTSIPASSMAPPED8 = new Label();
            lblTSIPASSMAPPED8.Text = TSIPASSMAPPED8.ToString();
            e.Row.Cells[16].Text = TSIPASSMAPPED8.ToString();
            e.Row.Cells[16].Controls.Add(lblTSIPASSMAPPED8);

            Label lblTSIPASSMAPPED9 = new Label();
            lblTSIPASSMAPPED9.Text = TSIPASSMAPPED9.ToString();
            e.Row.Cells[17].Text = TSIPASSMAPPED9.ToString();
            e.Row.Cells[17].Controls.Add(lblTSIPASSMAPPED9);

            Label lblTSIPASSMAPPED10 = new Label();
            lblTSIPASSMAPPED10.Text = TSIPASSMAPPED10.ToString();
            e.Row.Cells[18].Text = TSIPASSMAPPED10.ToString();
            e.Row.Cells[18].Controls.Add(lblTSIPASSMAPPED10);

            Label lblTSIPASSMAPPED11 = new Label();
            lblTSIPASSMAPPED11.Text = TSIPASSMAPPED11.ToString();
            e.Row.Cells[19].Text = TSIPASSMAPPED11.ToString();
            e.Row.Cells[19].Controls.Add(lblTSIPASSMAPPED11);

            Label lblTSIPASSMAPPED12 = new Label();
            lblTSIPASSMAPPED12.Text = TSIPASSMAPPED12.ToString();
            e.Row.Cells[20].Text = TSIPASSMAPPED12.ToString();
            e.Row.Cells[20].Controls.Add(lblTSIPASSMAPPED12);

            Label lblTSIPASSMAPPED13 = new Label();
            lblTSIPASSMAPPED13.Text = TSIPASSMAPPED13.ToString();
            e.Row.Cells[21].Text = TSIPASSMAPPED13.ToString();
            e.Row.Cells[21].Controls.Add(lblTSIPASSMAPPED13);

            Label lblTSIPASSMAPPED14 = new Label();
            lblTSIPASSMAPPED14.Text = TSIPASSMAPPED14.ToString();
            e.Row.Cells[22].Text = TSIPASSMAPPED14.ToString();
            e.Row.Cells[22].Controls.Add(lblTSIPASSMAPPED14);

            Label lblTSIPASSMAPPED15 = new Label();
            lblTSIPASSMAPPED15.Text = TSIPASSMAPPED15.ToString();
            e.Row.Cells[23].Text = TSIPASSMAPPED15.ToString();
            e.Row.Cells[23].Controls.Add(lblTSIPASSMAPPED15);

            Label lblTSIPASSMAPPED16 = new Label();
            lblTSIPASSMAPPED16.Text = TSIPASSMAPPED16.ToString();
            e.Row.Cells[24].Text = TSIPASSMAPPED16.ToString();
            e.Row.Cells[24].Controls.Add(lblTSIPASSMAPPED16);

            Label lblTSIPASSMAPPED17 = new Label();
            lblTSIPASSMAPPED17.Text = TSIPASSMAPPED17.ToString();
            e.Row.Cells[25].Text = TSIPASSMAPPED17.ToString();
            e.Row.Cells[25].Controls.Add(lblTSIPASSMAPPED17);

            Label lblTSIPASSMAPPED18 = new Label();
            lblTSIPASSMAPPED18.Text = TSIPASSMAPPED18.ToString();
            e.Row.Cells[26].Text = TSIPASSMAPPED18.ToString();
            e.Row.Cells[26].Controls.Add(lblTSIPASSMAPPED18);

            Label lblTSIPASSMAPPED19 = new Label();
            lblTSIPASSMAPPED19.Text = TSIPASSMAPPED19.ToString();
            e.Row.Cells[27].Text = TSIPASSMAPPED9.ToString();
            e.Row.Cells[27].Controls.Add(lblTSIPASSMAPPED19);

            Label lblTSIPASSMAPPED20 = new Label();
            lblTSIPASSMAPPED20.Text = TSIPASSMAPPED20.ToString();
            e.Row.Cells[28].Text = TSIPASSMAPPED20.ToString();
            e.Row.Cells[28].Controls.Add(lblTSIPASSMAPPED20);

            Label lblTSIPASSMAPPED21 = new Label();
            lblTSIPASSMAPPED21.Text = TSIPASSMAPPED21.ToString();
            e.Row.Cells[29].Text = TSIPASSMAPPED21.ToString();
            e.Row.Cells[29].Controls.Add(lblTSIPASSMAPPED21);

            Label lblTSIPASSMAPPED22 = new Label();
            lblTSIPASSMAPPED22.Text = TSIPASSMAPPED22.ToString();
            e.Row.Cells[30].Text = TSIPASSMAPPED22.ToString();
            e.Row.Cells[30].Controls.Add(lblTSIPASSMAPPED22);

            Label lblTSIPASSMAPPED23 = new Label();
            lblTSIPASSMAPPED23.Text = TSIPASSMAPPED23.ToString();
            e.Row.Cells[31].Text = TSIPASSMAPPED23.ToString();
            e.Row.Cells[31].Controls.Add(lblTSIPASSMAPPED23);

            Label lblTSIPASSMAPPED24 = new Label();
            lblTSIPASSMAPPED24.Text = TSIPASSMAPPED24.ToString();
            e.Row.Cells[32].Text = TSIPASSMAPPED24.ToString();
            e.Row.Cells[32].Controls.Add(lblTSIPASSMAPPED24);

            Label lblTSIPASSMAPPED25 = new Label();
            lblTSIPASSMAPPED25.Text = TSIPASSMAPPED25.ToString();
            e.Row.Cells[33].Text = TSIPASSMAPPED25.ToString();
            e.Row.Cells[33].Controls.Add(lblTSIPASSMAPPED25);

            Label lblTSIPASSMAPPED26 = new Label();
            lblTSIPASSMAPPED26.Text = TSIPASSMAPPED26.ToString();
            e.Row.Cells[34].Text = TSIPASSMAPPED26.ToString();
            e.Row.Cells[34].Controls.Add(lblTSIPASSMAPPED26);

            Label lblTSIPASSMAPPED27 = new Label();
            lblTSIPASSMAPPED27.Text = TSIPASSMAPPED27.ToString();
            e.Row.Cells[35].Text = TSIPASSMAPPED27.ToString();
            e.Row.Cells[35].Controls.Add(lblTSIPASSMAPPED27);

            Label lblTSIPASSMAPPED28 = new Label();
            lblTSIPASSMAPPED28.Text = TSIPASSMAPPED28.ToString();
            e.Row.Cells[36].Text = TSIPASSMAPPED28.ToString();
            e.Row.Cells[36].Controls.Add(lblTSIPASSMAPPED28);

            Label lblTSIPASSMAPPED29 = new Label();
            lblTSIPASSMAPPED29.Text = TSIPASSMAPPED29.ToString();
            e.Row.Cells[37].Text = TSIPASSMAPPED29.ToString();
            e.Row.Cells[37].Controls.Add(lblTSIPASSMAPPED29);

            Label lblTSIPASSMAPPED30 = new Label();
            lblTSIPASSMAPPED30.Text = TSIPASSMAPPED30.ToString();
            e.Row.Cells[38].Text = TSIPASSMAPPED30.ToString();
            e.Row.Cells[38].Controls.Add(lblTSIPASSMAPPED30);


            Label lblTSIPASSMAPPED31 = new Label();
            lblTSIPASSMAPPED31.Text = TSIPASSMAPPED31.ToString();
            e.Row.Cells[39].Text = TSIPASSMAPPED31.ToString();
            e.Row.Cells[39].Controls.Add(lblTSIPASSMAPPED31);

            Label lblTSIPASSMAPPEDMonthlyTotal = new Label();
            lblTSIPASSMAPPEDMonthlyTotal.Text = TSIPASSMAPPEDMonthlyTotal.ToString();
            e.Row.Cells[40].Text = TSIPASSMAPPEDMonthlyTotal.ToString();
            e.Row.Cells[40].Controls.Add(lblTSIPASSMAPPEDMonthlyTotal);
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage.ColumnSpan = 33;
            gvHeaderRowCopy.Cells.AddAt(9, tcMergePackage);
        }
    }
}