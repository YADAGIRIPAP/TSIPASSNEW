<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmUploadProductDescriptionGMVATManufacture.aspx.cs" Inherits="TSTBDCReg1" %>
...
<ContentTemplate>--%>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        1</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" Width="210px">Enterprise 
                                                        Name</asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        2</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label433" runat="server" CssClass="LBLBLACK" Width="210px">TIN number</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                        7</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label456" runat="server" CssClass="LBLBLACK" Width="313px">Do you 
                                                        market your product out side state?</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                ...
                                                <tr id="rem" visible="false" runat="server">
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                        8</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label457" runat="server" CssClass="LBLBLACK" Width="284px">Indicate 
                                                        State</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:TextBox ID="txtIndicatestate" runat="server" class="form-control txtbox" 
                                                            MaxLength="30"  TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                            ControlToValidate="txtIndicatestate" 
                                                            ErrorMessage="Please Enter Indicate State" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr >
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                        9</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label458" runat="server" CssClass="LBLBLACK" Width="313px">Do you 
                                                        Export your product?</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                ...
                                                <tr id="remnew" visible="false" runat="server">
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label459" runat="server" CssClass="LBLBLACK" Width="284px">Country 
                                                        Name</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:TextBox ID="txtCountryName" runat="server" class="form-control txtbox" 
                                                            MaxLength="30"  TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                            </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                                            ...
                                                            ErrorMessage="Please Enter Country Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                                            </td>
                                                </tr>
                                                </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="center" 
                                            ...
                                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                                NavigateUrl="~/UI/TSiPASS/frmVATManufactureGM.aspx">Back</asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <a href="AddQualification.aspx" class="close" data-dismiss="alert" aria-label="close">&times;ia-label="close">&times;</a>
