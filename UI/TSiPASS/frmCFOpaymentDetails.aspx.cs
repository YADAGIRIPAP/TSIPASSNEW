...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHeading.Text = "CFO Payment Details";
        ...
        if (!IsPostBack)
        {
           ...
           // DataSet ds = new DataSet();
            ...
            //ds = Gen.GetpaymentdetailslatsCFO(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), txtfromDate.Text, txttoDate.Text);
    ...
    public void filldetails()
    {
        ...
        {
           // ds = Gen.GetpaymentdetailslatsCFO(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), txtfromDate.Text, txttoDate.Text, ddlBank.SelectedValue);
            ds = GetcfepaydetailsNewCFO(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), FromdateforDB, TodateforDB, ddlBank.SelectedValue, "CFO");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                grdDetails.DataSource = ds.Tables[0];
                grdDetails.DataBind();
        ...
        {
           // ds = Gen.GetpaymentdetailslatsCFO(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), txtfromDate.Text, txttoDate.Text);
            ds = GetcfepaydetailsNewCFO(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), FromdateforDB, TodateforDB, "", "CFO");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                grdDetails.DataSource = ds.Tables[0];
                grdDetails.DataBind();
    ...
    public DataSet GetcfepaydetailsNewCFO(string intDeptid, string UID_No, string nameofunit, string District, string paymentmode, string fromdate, string todate, string BankName, string ApplicationType)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("USP_GET_PAYMENT_ABSTRACT_DTLS_ONLINE", con.GetConnection);
