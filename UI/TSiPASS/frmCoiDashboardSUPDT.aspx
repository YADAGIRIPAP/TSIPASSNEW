<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmCoiDashboardSUPDT.aspx.cs" Inherits="UI_TSiPASS_frmCoiDashboardSUPDT" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <span id="htitle">Superintendent&#39;s Dashboard </span>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                                                ...
                                                <tr>
                                                    <td style="width: 395px" valign="top">
                                                        <div class="list-group">
                                                            <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=1" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="lblAppl" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i><b>No of Applications Received from G.M</b> </a><a class="list-group-item"><i
                                                                        class="fa fa-fw fa-check"></i>Scrutiny Pending </a><a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=50">
                                                                            <span class="badge">
                                                                                <asp:Label ID="Label1" runat="server"></asp:Label>
                                                                            </span><i class="fa fa-fw fa-calendar"></i>Within 7 Days </a><a class="list-group-item"
                                                                                href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=51"><span class="badge"
                                                                                    style="background-color: #d9534f;">
                                                                                    <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                                </span><i class="fa fa-fw fa-calendar"></i>Beyond 7 Days </a>
                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=80">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label8" runat="server"></asp:Label>
                                                                </span><i class="fa fa-fw fa-calendar"></i>Total </a><a class="list-group-item"><i
                                                                    class="fa fa-fw fa-check"></i><b>Forwarded from Clerk</b></a> <a class="list-group-item"
                                                                        href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=500"><span class="badge">
                                                                            <asp:Label ID="lblforwardedclerk" runat="server"></asp:Label>
                                                                        </span><i class="fa fa-fw fa-calendar"></i>Applications Forwarded from Clerk
                                                                    </a><a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=511">
                                                                        <span class="badge" style="background-color: #d9534f;">
                                                                            <asp:Label ID="lblclerkquery" runat="server"></asp:Label>
                                                                        </span><i class="fa fa-fw fa-calendar"></i>Applications Query from Clerk </a>
                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=103">
                                                                <span class="badge">
                                                                    <asp:Label ID="LabelJDReturned" runat="server"></asp:Label>
                                                                </span><i class="fa fa-fw fa-calendar"></i>AD Returned</a> <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=100"
                                                                    class="list-group-item"><span class="badge">
                                                                        <asp:Label ID="LabelForwarded" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i><b>No of Applications Forwarded to AD</b> </a><a class="list-group-item"><i class="fa fa-fw fa-check"></i>Forwarded to AD</a><a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=101">
                                                                            <span class="badge">
                                                                                <asp:Label ID="lbladrecommended" runat="server"></asp:Label>
                                                                            </span><i class="fa fa-fw fa-calendar"></i>Recommended to AD</a><a class="list-group-item"
                                                                                href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=102"> <span class="badge">
                                                                                    <asp:Label ID="LabelQueryAD" runat="server"></asp:Label>
                                                                                </span><i class="fa fa-fw fa-calendar"></i>Query Forwarded to AD</a><a class="list-group-item"
                                                                                    href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=51r">
                                                        </div>
                                                    </td>
                                                    <td style="width: 30px">&nbsp;
                                                    </td>
                                                    <td style="width: 395px" valign="top">
                                                        <div class="list-group" style="vertical-align: top">
                                                            <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Queries</b></a> <a
                                                                href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=54" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label5" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Yet to Respond </a><a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=83"
                                                                        class="list-group-item"><span class="badge">
                                                                            <asp:Label ID="Label10" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Within</a> <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=84"
                                                                                class="list-group-item"><span class="badge" style="background-color: #d9534f;">
                                                                                    <asp:Label ID="Label11" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Beyond</a> <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=55"
                                                                                        class="list-group-item"><span class="badge">
                                                                                            <asp:Label ID="Label6" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Total Queries Responded </a><a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=91"
                                                                                                class="list-group-item"><span class="badge">
                                                                                                    <asp:Label ID="lblAutorejected" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Total Auto Rejected</a> <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Queries Responded/Received from Clerk</b></a>
                                                            <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=108" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="lblqueryrespondedrecommendedbyclerk" runat="server"></asp:Label></span>
                                                                <i class="fa fa-fw fa-calendar"></i>Queries Responded - Recommended from Clerk</a>
                                                            <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=109" class="list-group-item">
                                                                <span class="badge" style="background-color: #d9534f;">
                                                                    <asp:Label ID="lblqueryrespondedqueryraisedbyclerk" runat="server"></asp:Label></span>
                                                                <i class="fa fa-fw fa-calendar"></i>Queries Responded - Query Raised by Clerk</a>
                                                            <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Queries Responded/Forwarded
                                                                to AD</b></a> <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=104" class="list-group-item">
                                                                    <span class="badge">
                                                                        <asp:Label ID="lblqueryforwardedtojd" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Forwarded to AD</a> <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=105"
                                                                            class="list-group-item"><span class="badge" style="background-color: #d9534f;">
                            ...
                            <tr>
                                <td valign="top" style="width: 395px">
                                    <div class="list-group" style="vertical-align: top">
                                        <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Abeyance Applications Approved by Joint Director/Additional Director</b></a>
                                        <a href="IncentiveStatusInspectionUploadbyCoiSUPDT.aspx?Stg=85" class="list-group-item">
                                            <span class="badge">
                                                <asp:Label ID="lblAbeyance" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Total Abeyance Applications </a>
                                    </div>
                                    <%--   <div class="list-group">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                            ...
                            <tr id="trIncentivesHead" runat="server" visible="false">
                                <td valign="top" style="width: 395px">
                                    <div class="list-group">
                                        <a href="IncentiveWiseSLClistGMADSubPlan.aspx?Stg=4" class="list-group-item"><span
                                            class="badge">
