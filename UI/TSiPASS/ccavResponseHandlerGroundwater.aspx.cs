...
public partial class UI_TSiPASS_ccavResponseHandlerGroundwater : System.Web.UI.Page
{
    ...
    public void GetTESTVALUES(string Responce)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE_groundwater", con.GetConnection);
    ...
    public void GetTESTVALUESgroundwater(string Responce)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE_groundwater1", con.GetConnection);
            da.SelectCommand.Parameters.Add("@responce", SqlDbType.VarChar).Value = Responce.ToString();
            da.SelectCommand.Parameters.Add("@Online", SqlDbType.VarChar).Value = "Online";
