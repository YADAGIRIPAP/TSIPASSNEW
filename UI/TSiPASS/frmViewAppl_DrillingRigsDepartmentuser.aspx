<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmViewAppl_DrillingRigsDepartmentuser.aspx.cs" Inherits="UI_TSiPASS_frmViewAppl_DrillingRigsDepartmentuser" %>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="S No">
                                                                <ItemTemplate>
                                                                    <%# Container.DataItemIndex + 1%>           
                                                                     ...
                                                                     <asp:HiddenField ID="hf_griduidno" runat="server" Value='<%# Eval("UIDNo") %>' />
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="Approval Name">
                                                                <ItemTemplate>        
                                                                    <%# Eval("ApprovalName") %>
                                                                  </ItemTemplate>                                          
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                             ...
                                                             <asp:TemplateField HeaderText="Application No">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnk_uid_no" runat="server" Text='<%# Eval("UIDNo") %>'></asp:LinkButton>
                                                                </ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="Application Present Status">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_rejetedstatusofapplication" ForeColor="Red" Text='<%# Eval("ReasonForRejection") %>' runat="server" />
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="View">
                                                                <ItemTemplate>        
                                                                    <asp:HyperLink ID="hyp_Applicationform" runat="server" Text="Application form" ForeColor="Green"></asp:HyperLink>
                                                                    <br />  <br />
                                                                     <asp:HyperLink ID="hyp_attachments" runat="server" Text="Attachments" ForeColor="Blue"></asp:HyperLink>
                                                                    <br />  <br />
                                                                      <asp:HyperLink ID="hyp_paymentdetails" runat="server" Text="Payment Details" ForeColor="#6666ff"></asp:HyperLink>
                                                                    <br /><br />
                                                                  </ItemTemplate>                                          
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemStyle Width="50px" />
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="District RTO registration">
                                                                <ItemTemplate>        
                                                                    <%# Eval("RTODistrict") %>
                                                                  </ItemTemplate>                                          
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                             ...
                                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="vehicleRegistration No.">
                                                                <ItemTemplate>        
                                                                    <%# Eval("regvehicleno") %>
                                                                  </ItemTemplate>                                          
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="Applicant Details">
                                                                <ItemTemplate>   
                                                                    <b>Name:</b><%# Eval("Nameoftheapplicant") %>
                                                                    <br />  <br />
                                                            ...
                                                            <asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="hyp_approveapplication" Text="Action" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Query View">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="hyp_userqueryrespose" Target="_blank"  runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:BoundField DataField="Areaofoperation" HeaderText="Area of operation" />
                                                              ...
                                                              <%-- <asp:BoundField DataField="ApprovalName" HeaderText="ApprovalName" />  --%> 
                                                            <%-- <asp:TemplateField HeaderText="">
                                                             ...
                                                             <asp:TemplateField HeaderText="">
                                                                <ItemTemplate>
                                                                     <asp:HyperLink ID="hyp_attachments" runat="server" Text="Attachments" ForeColor="Green"></asp:HyperLink>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>   --%>
                                                            <%-- <asp:BoundField DataField="RTODistrict" HeaderText="District RTO registration "  />
                                                           ...
                                                           <%-- <asp:TemplateField HeaderText="payment Details">
                                                                <ItemTemplate>
                                                                   <asp:HyperLink ID="hyp_paymentdetails" runat="server" Text="View" ForeColor="Green"></asp:HyperLink>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>--%>
                                                            ...
                                                            <asp:BoundField DataField="QueryRaisedDate" HeaderText="Query raised Date" />
                                                            <asp:BoundField DataField="QueryresponseDate" HeaderText="Query Responded Date" />
