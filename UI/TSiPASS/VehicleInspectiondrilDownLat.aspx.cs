...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
          ...
          //  ddlYear.SelectedValue = ddlYear.Items.FindByValue(System.DateTime.Now.Year.ToString()).Value;
           ...
           // ddlMonth.Enabled = false;
            ...
            DataSet ds = Gen.getvehicleInspLookUp(Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
            ...
            ds1 = Gen.GetVehicleInspectionTarget(Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
    ...
    {
//
       // Response.Redirect("frmCAFEntrepreneurDetails.aspx?intApplicationId=" + Session["uidIPO"].ToString());
    }
    ...
    //        //i = Gen.insertVehicleInspection(hdfID.Value.ToString(),Session["uidIPO"].ToString(), Label432.Text, lblVehicleInspected.Text, LblVehiclenotInspected.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
    //        //// i = Gen.insertIndustryCatelog(Session["User_Code"].ToString(), txtNoofUnit.Text, txtYetCapture.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());//txtresMandals.Text,
    ...
    //        i = Gen.insertVehicleInspection("0",Session["uidIPO"].ToString(), Label432.Text, lblVehicleInspected.Text, LblVehiclenotInspected.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
    //       // i = Gen.insertIndustryCatelog(Session["User_Code"].ToString(), txtNoofUnit.Text, txtYetCapture.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());//txtresMandals.Text,
    ...
    //        {
    //            AddDataToTableCeertificate(Session["uidIPO"].ToString(), txtnameunit.Text, txtaddressunit.Text, txtdetailsvehicle.Text,cmf.convertDateIndia(txtDDDate.Text).ToString("MM-dd-yyyy"),ddlincentive.SelectedItem.Text.ToString(),ddlcstatus.SelectedItem.Text.ToString(),txtremark.Text, (DataTable)Session["CertificateTb2"]);//Session["uidIPO"].ToString()
