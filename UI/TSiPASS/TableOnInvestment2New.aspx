<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TableOnInvestment2New.aspx.cs" Inherits="UI_TSiPASS_TableOnInvestment2New" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">R6.5 Investment wise Abstract</asp:Label>
                                ...
                                <td colspan="2" align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="InvestmentRange" HeaderText="Investment Range (Rs. in Cr)"></asp:BoundField>
                                            <asp:HyperLinkField ControlStyle-Font-Underline="false" FooterStyle-CssClass="text-right" DataTextField="Number" HeaderText="No of Industries">
                                            ...
                                            <asp:HyperLinkField ControlStyle-Font-Underline="false" FooterStyle-CssClass="text-right" DataTextField="Investment"
                                                HeaderText="Investment (Rs. in Cr)">
                                                <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Underline="false" CssClass="text-right" />
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-right" />
                                            </asp:HyperLinkField>
                                            <asp:HyperLinkField ControlStyle-Font-Underline="false"  FooterStyle-CssClass="text-right" DataTextField="Employment"
                                                HeaderText="Total Employment">
                                                <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Underline="false" CssClass="text-right" />
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-right" />
                                            </asp:HyperLinkField>
                                            <asp:HyperLinkField ControlStyle-Font-Underline="false"  FooterStyle-CssClass="text-right" DataTextField="Invst in Cr per Employee"
                                                HeaderText="Investment(Rs. in Cr) per Employee">
                                                <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Underline="false" CssClass="text-right" />
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-right"/>
                                            </asp:HyperLinkField>
                                        </Columns>
