<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"  CodeFile="frmApplLoanDetails.aspx.cs" Inherits="UI_TSiPASS_MonthlyReportGMIpo" EnableEventValidation="false" %>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Name_of_unit" HeaderText="NAME OF UNIT" />
                                                            
                                                           
                                                            <asp:BoundField DataField="aadhar_number" HeaderText="AADHAR NO" />
                                                            <asp:BoundField DataField="mobile_numnber" HeaderText="MOBILE NO" />
                                                            <asp:BoundField DataField="district" HeaderText="DISTICT" />
                                                            <asp:BoundField DataField="bank_name" HeaderText="BANK NAME" />
                                                            <asp:BoundField DataField="branch_name" HeaderText="BRANCH NAME" />
                                                            <asp:BoundField DataField="loan_application_date" HeaderText="LOAN APPL DATE" />
