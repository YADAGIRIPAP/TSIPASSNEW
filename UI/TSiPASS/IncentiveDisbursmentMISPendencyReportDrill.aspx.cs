...
public partial class UI_TSiPASS_IncentiveDisbursmentMISPendencyReportDrill : System.Web.UI.Page
{
    ...
    public void FillGridDetails()
    {
        ...
        if (status != "")
        { 
            ds = Gen.GetIncentiveDisbursmentMISPendencyReportDrill(status, ddlDistrict.SelectedValue);
        }
