<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmTravelAgentDepartmentsViewAppl.aspx.cs" Inherits="UI_TSiPASS_frmTravelAgentDepartmentsViewAppl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Popup(intval) {
            ...
            win = window.open("TravelAgentAdminPopup.aspx?UID=" + intval, "List", "scrollbars=yes,resizable=yes,width=780,height=400,left=" + ((window.screen.width / 2) - 320) + ",top=" + ((window.screen.height / 2) - 200) + ";display : block;position:absolute");
