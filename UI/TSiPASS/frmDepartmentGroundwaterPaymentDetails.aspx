<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartmentGroundwaterPaymentDetails.aspx.cs" Inherits="UI_TSiPASS_frmDepartmentGroundwaterPaymentDetails" %>
 ...
 <script src="../../Resource/Scripts/js/validations.js" type="text/javascript"></script>
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        ...
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                    ...
                    <li class="">
                        <i class="fa fa-fw fa-edit">Ground water Other Services</i>
                    </li>
                    <li class="active">
