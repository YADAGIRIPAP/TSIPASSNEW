<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="StageOfImplementationReportold2NewDropped.aspx.cs" Inherits="UI_TSIPASS_StageOfImplementationReportold2NewDropped" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="divPrint" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        ...
                        <h2 class="panel-title" style="font-weight: bold;">
                            ...
                            <asp:Label ID="lblHeading" runat="server">R6.7: Dropped Industries </asp:Label>
                                            ...
                                            <td class="col-xs-3" style="padding: 5px; margin: 5px" runat="server" visible="false">
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlType" runat="server" class="form-control txtbox" Height="33px"
                                                        ...
                                                        <asp:ListItem Value="9">2022-23</asp:ListItem>
                                                        <asp:ListItem Value="10">2023-24</asp:ListItem>
                                                        <asp:ListItem Value="11">2024-25</asp:ListItem>
        ...
        <tr id="trpichart" runat="server" visible="false">
            <td colspan="2" align="center" style="padding: 5px; margin: 5px">
                <div>
                    ...
                    <div id="piechart_3d" style="border-style: solid; border-width: 1px; width: 100%; height: 500px;">
                    </div>
                </div>
            </td>
        </tr>
