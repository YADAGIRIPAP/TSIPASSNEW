<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaCoal.aspx.cs" Inherits="UI_TSiPASS_ProformaCoal" %>
        ...
        <div class="container" id="Receipt" runat="server" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px; top: 0px; left: 0px;">
                <span class="floatleft auto-style3"><span style="font-weight: bold">Sub :-  </span>
                    &nbsp;<span style="font-weight: bold"><asp:Label ID="lblTIdeaTPride1" runat="server"></asp:Label></span>&nbsp; Incentive Scheme – Claim application for Sanction of Reimbursement of Coal of &nbsp;<span style="font-weight: bold"><asp:Label ID="lblEnterpreneurDetails1" runat="server"></asp:Label></span>&nbsp; Proposal – Recommended – Reg.
                </span>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px">
                <span class="floatleft auto-style3">Through the reference cited, &nbsp;<span style="font-weight: bold"><asp:Label ID="lblEnterpreneurDetails2" runat="server"></asp:Label></span>&nbsp; 
                                have applied for sanction of Reimbursement of Coal for the &nbsp;
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px; display: none">
                <span class="floatleft auto-style3"><b>The eligible reimbursement of Coal is calculated as under :-</b>
                </span>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px; display: none">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">As per form - A, The unit holder has paid an amount of Rs. &nbsp;<span style="font-weight: bold"><asp:Label ID="lblSTAmountPaid" runat="server"></asp:Label></span>&nbsp; for the <span style="font-weight: bold">&nbsp;<asp:Label ID="lblFinancialYear3" runat="server"></asp:Label></span>. The eligible reimbursement ofCoal is calculated as under:
                    <span style="font-weight: bold">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">Therefore The eligible reimbursement of Coal @
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="Div1" runat="server" style="padding-top: 14px">
                <span class="floatleft auto-style3">Therefore, I request the Commissioner of Industries, Telangana, Hyderabad kindly to consider the proposal of the captioned unit for sanction of 
                    <asp:Label ID="lblpercentage" runat="server"> </asp:Label>
                    Reimbursement of Coal for Rs. &nbsp; <span style="font-weight: bold">
