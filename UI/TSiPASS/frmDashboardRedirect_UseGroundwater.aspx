<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDashboardRedirect_UseGroundwater.aspx.cs" Inherits="UI_TSiPASS_frmDashboardRedirect_UseGroundwater" %>
                                        ...
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            ...
                                            <tr>
                                                <td align="center" class="style8" style="padding: 5px; margin: 5px; text-align: center;"
                                                    valign="top">
                                                    <asp:Label ID="lbl_headtitle" runat="server" CssClass="LBLBLACK" Width="150px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr id="checkQuery">
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="ApplicationType_IndusorAgriName" HeaderText="Application Type" />
                                                            <asp:BoundField DataField="TypeOfDrwngWaterName" HeaderText="Type of Drining Water" />
                                                            <asp:BoundField DataField="TypeofWellName" HeaderText="Type of Well" />
                                                            <asp:BoundField DataField="District_Name" HeaderText="District" />
                                                            <asp:BoundField DataField="Manda_lName" HeaderText="Mandal" />
                                                            <asp:BoundField DataField="Address" HeaderText="Address" />
                                                            <asp:BoundField DataField="LocationOfWell" HeaderText="Location Of Well" />
                                                            <asp:BoundField DataField="DistanceFromExistWell" HeaderText="Polution Category" />
                                                            <asp:BoundField DataField="SpecifactioncnOFPump" HeaderText="Last Date of PreScrutiy" />
                                                            <asp:BoundField DataField="PaymentDate" HeaderText="PaymentDate" />

                                                             <asp:TemplateField HeaderText="Query Raise Date">
                                                                <ItemTemplate>
                                                               <asp:Label ID="lbl_queryraisedetails" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Query Responded Date">
                                                                <ItemTemplate>
                                                                 <asp:Label ID="lbl_queryresponsedetails" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:BoundField DataField="MROApproveddate" HeaderText="Approval Date" />
                                                            <asp:BoundField DataField="MRORejecteddate" HeaderText="Rejected Date" />
                                                              <asp:TemplateField>
                                                                 <HeaderTemplate>
