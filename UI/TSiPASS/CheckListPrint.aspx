<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="CheckListPrint.aspx.cs" Inherits="UI_TSiPASS_CheckListPrint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style type="text/css">
        ...
        /*
        .ctl00_ContentPlaceHolder1_lbtnBack {
            padding: 5px 10px;
            font-size: 12px;
                                        ...
                                        <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                                ...
                                                <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                                                    <div id="Div1" style="width: 100%" runat="server">
                                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                            ...
                                                            Width="100%" CellSpacing="4" OnRowCreated="grdDetails_RowCreated" OnRowDataBound="grdDetails_RowDataBound">
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="chkRow" runat="server" onclick="Check_Click(this)" AutoPostBack="true" OnCheckedChanged="chkRow_CheckedChanged" />
                                                                    </ItemTemplate>
                                            ...
                                            <tr id="divForward" runat="server" visible="false">
                                                <td colspan="2" style="padding: 3px;" align="left" class="style7" id="Td1" runat="server">
                                                    <table width="90%">
                                                        <tr id="trUpload" runat="server" visible="true">
                                                            <td style="padding: 2px; width: 90px;">
                                                                <asp:Label ID="Label549" runat="server" CssClass="LBLBLACK" Style="display: inline-block; width: 80px; color: BLACK;">Upload:</asp:Label>
                                                            </td>
                                                            <td style="padding: 2px; color: BLACK;">:</td>
                                                            <td style="padding: 2px;" colspan="3">
                                                                ...
                                                                <asp:HyperLink ID="lblFileName1" runat="server" CssClass="LBLBLACK"
                                                                    Target="_blank" Width="120px">[lblFileName]</asp:HyperLink>
                                                                <br />
                                                            ...
                                                            <td style="padding: 2px;" colspan="3">
                                                                <asp:Button ID="BtnUpload" runat="server" CssClass="btn btn-xs btn-warning"
                                                                    Height="28px" TabIndex="10" Text="Upload" Width="72px" OnClick="BtnUpload_Click1" />
                                                            </td>
                                                        </tr>
                                                        <tr id="RandomNo" runat="server" visible="false">
                                                            <td class="style42" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label543" runat="server" CssClass="LBLBLACK" Style="display: inline-block; width: 80px; color: BLACK;">Random No:</asp:Label>
                                                            </td>
                                                            <td class="style26" style="padding: 5px; margin: 5px; color: BLACK;">:</td>
                                                        ...
                                                        <tr id="trgrivenance" runat="server" visible="true">
                                                            <td class="style34" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK" Style="display: inline-block; width: 80px; color: BLACK;">Forward To</asp:Label>
                                                            </td>
                                                            <td class="style46" style="padding: 5px; margin: 5px; color: BLACK;">:</td>
                                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left; color: BLACK;">
                                                                <asp:DropDownList ID="ddlForward" runat="server" class="form-control txtbox"
                                                                    Height="33px" TabIndex="1" Width="250px">
                                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                                    <asp:ListItem Value="151">Forward To Clerk</asp:ListItem>
                                                                    <asp:ListItem Value="152">Forward To Supdt</asp:ListItem>
                                                                    <asp:ListItem Value="153">Forward To AD</asp:ListItem>
                                                                    <asp:ListItem Value="154">Forward To DD</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr id="trRemarks" runat="server" visible="true">
                                                            <td class="style36" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Style="display: inline-block; width: 80px; color: BLACK;">Remarks:</asp:Label>
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; color: BLACK;">:</td>
                                                            <td style="padding: 5px; margin: 5px; width: 300px; text-align: left; font-weight: bold">
                                                                <asp:TextBox runat="server" ID="txtRemarks" class="form-control txtbox" Height="48px"
                                                                    MaxLength="150" TabIndex="1" Width="300px" TextMode="MultiLine"></asp:TextBox>
                                                            </td>
                                                        </tr>

                                                        <tr id="tblselection" runat="server" class="style7">
                                                            <td colspan="12" style="padding: 4px; text-align: left;">
                                                                <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Generate Cheque List"
                                                                    OnClick="Button1_Click" Enabled="true" />
                                                                <asp:Button ID="Button6" CssClass="btn btn-primary" runat="server" Text="Download PDF"
