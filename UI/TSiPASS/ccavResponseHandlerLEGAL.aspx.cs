...
public partial class UI_TSiPASS_ccavResponseHandlerLEGAL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string encResponse = "order_id=00105011001BMW&tracking_id=111711415100&bank_ref_no=null&order_status=Success&failure_message=&payment_mode=NEFT&card_name=Kotak Mahindra Bank&status_code=&status_message=null&currency=INR&amount=100.00&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=7702542727&billing_email=kmrias@gmail.com&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=1001&merchant_param2=Kotak20221117163143&merchant_param3=LEGAL&merchant_param4=NODEPT&merchant_param5=Y&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=100.00&eci_value=&retry=null&response_code=&billing_notes=&trans_date=17/11/2022 16:31:22&bin_country=&bene_account=APCCA111711415100&bene_name=APCCA&bene_ifsc=KKBK0ALPYCC&bene_bank=Kotak Mahindra Bank&bene_branch=Mumbai&trans_fee=0.0&service_tax=0.0";
        ...
        //string encResponse ="order_id=SML00700262862REN&tracking_id=107446255318&bank_ref_no=001062&order_status=Success&failure_message=&payment_mode=Debit Card&card_name=Visa Debit Card&status_code=null&status_message=Success&currency=INR&amount=5053.1&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=9848018418&billing_email=srenviro123@gmail.com&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=2862&merchant_param2=Kotak20181005165621&merchant_param3=REN&merchant_param4=NODEPT&merchant_param5=NA&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=5000.0&eci_value=05&retry=N&response_code=0&billing_notes=&trans_date=05/10/2018 16:57:45&bin_country=INDIA&trans_fee=45.0&service_tax=8.1";
        ...
        if (msg != null)
        {
            ...
            if (paymentresponseVOsobj.AdditionalInfo4_19 == "NODEPT")
            {
                ...
                {
                    dspaydtls = objVerify.GetEnterprinerpaymentDtlsLEGAL(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, paymentresponseVOsobj.AdditionalInfo5_20);
                ...
                {
                    dspaydtls = objVerify.GetEnterprinerpaymentDtlsLEGAL(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, "");
                    //Departmentdetails (Questionnaire id#Entrepreneur id1#Department id1#TSIPASSUID#amount1#ApprovalId)
                    paymentresponseVOsobj.Createdby = dspaydtls.Tables[1].Rows[0]["CREATEDBY"].ToString();
                    if (dspaydtls != null && dspaydtls.Tables.Count > 1 && dspaydtls.Tables[1].Rows.Count > 0)
                    {
            ...
            if (paymentresponseVOsobj.AuthStatus_14 == "Success")
            {
                ...
                if (valid == 1)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alertMsg", "alert('Payment Done Successfully');" + "window.location='IpassPrintReceiptLegal.aspx';", true);
                }
            }
            else
            {
