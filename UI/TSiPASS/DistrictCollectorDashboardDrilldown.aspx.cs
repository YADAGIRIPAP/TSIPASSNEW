...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void BtnSave_Click1(object sender, EventArgs e)
    {
        ...
        if (ddlStatus.SelectedValue.ToString() == "5")//|| ddlStatus.SelectedValue.ToString()=="9"
        {
            ...
            int j = Gen.UpdateAdditionalpayments(hdfGroundedNo.Value, "", "Completed", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, ""); //fix by CMS by passing string IPaddress
        ...
        else if (ddlStatus.SelectedValue.ToString() == "7")
        {
            ...
            int j = Gen.UpdateAdditionalpayments(hdfGroundedNo.Value, txtAmount.Text, "Y", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value,""); //fix by CMS by passing string IPaddress
        }
        else if(ddlStatus.SelectedValue.ToString()=="10")
        {
            int j = Gen.UpdateAdditionalpayments(hdfGroundedNo.Value, txtAmount.Text, "Completed", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value,""); //fix by CMS by passing string IPaddress
