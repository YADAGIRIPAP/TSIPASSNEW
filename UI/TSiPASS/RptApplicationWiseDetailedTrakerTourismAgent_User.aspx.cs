...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerTourismAgent_User : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds = ApplicationWiseDetailedTrakerTourismEvent(intqnreid.ToString());
    ...
    public DataSet ApplicationWiseDetailedTrakerTourismEvent(string Quesionary_id)
    {
        ...
        try
        {
            da = new SqlDataAdapter("RetriveR4ReportTourismAgent", con);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            if (Quesionary_id.Trim() == "" || Quesionary_id.Trim() == null)
                da.SelectCommand.Parameters.Add("@TravelAgent_ID", SqlDbType.VarChar).Value = "%";
            else
                da.SelectCommand.Parameters.Add("@TravelAgent_ID", SqlDbType.VarChar).Value = Quesionary_id.ToString();
            da.Fill(ds);
            return ds;
        }
        catch (Exception ex)
