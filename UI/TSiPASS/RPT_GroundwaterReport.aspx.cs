...
using System.Data;
public partial class UI_TSiPASS_RPT_GroundwaterReport : System.Web.UI.Page
{
    ...
    protected void grdDetails_state_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=state&Status=WellApplications" + "&Category=1" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts"; ;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=state&Status=DrillingRigApplications" + "&Category=1" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts"; ;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Totalstatewellappl.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=state&Status=WellApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts"; ;
            ...
            Totalstaterigsappl.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=state&Status=DrillingRigApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts"; ;
    ...
    protected void grdDetails_district_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=District&Status=WellApplications" + "&Category=1" + "&Districtid=" + DistrictID + "&DistrictName=" + DistrictName;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=District&Status=DrillingRigApplications" + "&Category=1" + "&Districtid=" + DistrictID + "&DistrictName=" + DistrictName;
            }
        }
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            HyperLink Totalstatewellappl = new HyperLink();
            Totalstatewellappl.ForeColor = System.Drawing.Color.White;
            Totalstatewellappl.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=District&Status=WellApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            Totalstatewellappl.Text = districtwellappl.ToString();
            e.Row.Cells[2].Controls.Add(Totalstatewellappl);

            HyperLink Totalstaterigsappl = new HyperLink();
            Totalstaterigsappl.ForeColor = System.Drawing.Color.White;
            Totalstaterigsappl.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=District&Status=DrillingRigApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
    ...
    protected void grd_groundwaterappltype_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=WellApplications&Status=" + ApplicationType + "&Category=" + ApplicationTypeID + "&Districtid=ALL" + "&DistrictName=ALL";
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            HyperLink Totalstatewellappl = new HyperLink();
            Totalstatewellappl.ForeColor = System.Drawing.Color.White;
            Totalstatewellappl.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=WellApplications&Status=ALL WellApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
    ...
    protected void grd_drillingappltype_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=DrillingRigApplications&Status=" + ApplicationType + "&Category=" + ApplicationTypeID + "&Districtid=ALL" + "&DistrictName=ALL";
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            HyperLink Totalstaterigsappl = new HyperLink();
            Totalstaterigsappl.ForeColor = System.Drawing.Color.White;
            Totalstaterigsappl.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=DrillingRigApplications&Status=ALL DrillingRigApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
    ...
    protected void grd_alldata_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=ALL" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Agriculture/Irrigation" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Drinking/Domestic Water" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Institution/Infrastructure/Others" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=ALL" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=New" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=Renewal" + "&Districtid=" + DistrictID + "&DistrictName=" + DIstrictName;
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Totalallwellappl.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallwellappltype2.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Agriculture/Irrigation" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallwellappltype3.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Drinking/Domestic Water" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallwellappltype4.NavigateUrl = "frmlistofwellapplicationdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=WellApplications" + "&Category=Institution/Infrastructure/Others" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallrigappl.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=ALL" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallrignew.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=New" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
            ...
            Totalallrigrenewal.NavigateUrl = "frmlistofDrillingrigdetails.aspx?Typedataofappl=TotalDistrictApplications&Status=DrillingRigApplications" + "&Category=Renewal" + "&Districtid=ALL" + "&DistrictName=" + "ALLDistricts";
