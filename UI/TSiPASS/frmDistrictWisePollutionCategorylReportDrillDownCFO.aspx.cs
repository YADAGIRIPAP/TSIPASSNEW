...
public partial class UI_TSiPASS_frmDistrictWisePollutionCategorylReportDrillDownCFO : System.Web.UI.Page
{
    int delete = 0;
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string polcategory)
    {
       ...
       // Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_POLLUTIONCATEGORY_DRILLDOWN", pp);
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_POLLUTIONCATEGORY_DRILLDOWN_CFO", pp);
        return Dsnew;
    }
}