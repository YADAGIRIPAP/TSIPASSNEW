<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleasePendingViewDIPCAgenda.aspx.cs" Inherits="UI_TSiPASS_ReleasePendingViewDIPCAgenda" %>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7" id="tblselection" runat="server">
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Submit Proposed DIPC Agenda" OnClick="Button1_Click" /> &nbsp; &nbsp;
