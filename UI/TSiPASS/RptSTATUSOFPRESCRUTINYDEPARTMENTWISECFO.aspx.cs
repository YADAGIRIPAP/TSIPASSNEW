...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void FillGridDetails()
    {
       //Label1.Text = "Report from " + txtFromDate.Text.Trim() + " To " + txtTodate.Text.Trim();
        ...
        ds = Gen.sp_DepartmentWiseReportCFO(ddlCategory.SelectedItem.ToString().Trim(), ddldistrict.SelectedValue, FromdateforDB, TodateforDB);
        if (ds.Tables[0].Rows.Count > 0)
        {
            grdDetails.DataSource = ds.Tables[0];
            grdDetails.DataBind();
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=A&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h2.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=B&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            h3.Target = "_blank";
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=C&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();

            HyperLink h3a = (HyperLink)e.Row.Cells[5].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3a.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=D&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3b.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=E&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();

            HyperLink h3bc = (HyperLink)e.Row.Cells[7].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3bc.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=F&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=A&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalComp.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=B&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalQuery.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=C&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            Totalless3days.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=D&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalMore3days.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=E&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalPayment.NavigateUrl = "frmstatusDepartmentNextCFO.aspx?status=F&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            string FileName = "CFO R2.1 STATUS OF PRESCRUTINY - DEPARTMENT WISE";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                string headerTable = @"<table width='100%' class='TestCssStyle'><tr><td align='center' colspan='8'><h4>" + "CFO R2.1 STATUS OF PRESCRUTINY - DEPARTMENT WISE" + "</h4></td></td></tr><tr><td align='center' colspan='8'><h4>" + label1text + "</h4></td></td></tr></table>";
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("CFO R2.1 STATUS OF PRESCRUTINY - DEPARTMENT WISE \n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=R2.1 RptSTATUSOFPRESCRUTINYDEPARTMENTWISECFO" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
