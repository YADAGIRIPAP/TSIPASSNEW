<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/UI/TSiPASS/CCMaster.master"  CodeFile="APMCReimbursement.aspx.cs" Inherits="UI_TSiPASS_APMCReimbursement" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color: #339966">
                            <table class="nav-justified" style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:Label ID="LBLTFAP1" runat="server" Visible="false" Text="APPLICATION CUM VERIFICATION FOR CLAIMING APMC SUBSIDY UNDER TFAP—TELANGANA STATE PROGRAM FOR 
                                        ...
                                        <asp:Label ID="LBLTFAP" runat="server" Visible="false" Text="APPLICATION CUM VERIFICATION FOR CLAIMING REIMBURSEMENT OF APMC UNDER TFAP
                                    ...
                                    <td style="padding: 5px; margin: 5px" valign="top">
                                        <table cellpadding="4" cellspacing="5" style="width: 80%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" style="padding: 5px; margin: 5px; text-align: left; font-weight: bold">Details of APMC fees paid</td>
                                            </tr>
                                            <tr id="trschemeEligible" runat="server">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.1
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">APMC fee paid year<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:DropDownList ID="ddlapmcfeepaidyear" runat="server" class="form-control txtbox" Height="33px" Width="180px">
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                </asp:DropDownList>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="ddlapmcfeepaidyear"
                                                        ErrorMessage="Please Select  APMC fee paid year" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trgenSC1" runat="server">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.1
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Amount Paid in rupees<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtamountpaidindupees" runat="server" class="form-control txtbox" onkeypress="NumberOnly()"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" ></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtamountpaidindupees"
                                                        ErrorMessage="Please enter  Amount paid in rupees" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                    ...
                                    <td colspan="4" style="padding: 5px; margin: 5px; text-align: center;">
                                        <table style="width: 80%">
                                            ...
                                            <tr id="trEnclosures" runat="server">
                                                ...
                                                <td align="left" style="border: solid thin black; background: white; color: black">	Bills,Vouchers and proof of payment in support of  APMC fees paid<br />
