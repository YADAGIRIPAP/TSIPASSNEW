<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaApplicantskillupgradationSubsidyNew.aspx.cs" Inherits="UI_TSIPASS_ProformaApplicantskillupgradationSubsidyNew" %>
        ...
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 14px">
                <span class="floatleft auto-style3">Sub :- &nbsp;&nbsp;<asp:Label ID="lblTIdeaTPrideIIPP1" runat="server" Font-Bold="true"></asp:Label>&nbsp;-
                                                -Sanction of Reimbursement of cost involved in skill upgradation and training to 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the subject cited, we are pleased to inform you that you have been sanctioned the Reimbursement of cost involved in skill upgradation and training for the year&nbsp;<span style="font-weight: bold"><asp:Label ID="lbl1stOR2ndHalfYearFinYearFromTo" runat="server"></asp:Label></span>&nbsp;   
