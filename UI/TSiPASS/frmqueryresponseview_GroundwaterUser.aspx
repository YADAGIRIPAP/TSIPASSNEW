<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmqueryresponseview_GroundwaterUser.aspx.cs" Inherits="UI_TSiPASS_frmqueryresponseview_GroundwaterUser" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Grounwater: VIEW DETAILS</a> </li>
                </ol>
            </div>
            <div align="left">
