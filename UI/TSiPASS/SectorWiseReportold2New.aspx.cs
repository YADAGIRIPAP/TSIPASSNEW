...
public partial class UI_TSiPASS_SectorWiseReportold2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalSectorwise_New_NEW(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalSectorwise_New_NEW(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmSectorDrilldownold2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "FrmSectorDrilldownold2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "FrmSectorDrilldownold2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmSectorDrilldownold2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    protected void btnNewPdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=R6.2_Sector_wise_Abstract" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
