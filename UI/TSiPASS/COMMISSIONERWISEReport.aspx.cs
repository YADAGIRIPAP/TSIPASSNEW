...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void fillGrid()
    {
        ...
        try
        {
            ...
            ds = Gen.GetCommissionerwiseDashboard(ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), ddlIPOname.SelectedValue.ToString(), ddlStatus.SelectedValue.ToString(), Session["uid"].ToString());
