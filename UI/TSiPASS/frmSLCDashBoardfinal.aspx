<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSLCDashBoardfinal.aspx.cs" Inherits="UI_TSiPASS_frmSLCDashBoardfinal" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Generate SLC Agenda</h1>
                            </div>
                                        ...
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width:300px">Proposed SLC Date : </td>
                                                    ...
                                                    <td>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtsvcdate"
                                                            ErrorMessage="Please Enter SVC Date" ValidationGroup="group">Please Enter Proposed SLC Date</asp:RequiredFieldValidator></td>
                                                </tr>
                                            </table>
