...
public partial class UI_TSiPASS_frmViewAttachmentDetailsBatdealer : System.Web.UI.Page
{
    int delete = 0;
    ...
    void FillDetails()
    {
        ...
        try
        {
            ...
            {
                dsdept = GetdataBatdealerApprovaldocument(hdfFlagID0.Value.ToString());
            }
            else
            {
                dsdept = GetdatabyDeptinbatterydocument(hdfFlagID0.Value.ToString(), Session["User_Code"].ToString().Trim());
            }
            ...
            dsdept1 = GetdatabyDeptinbatterydocumentRespondDetails(hdfFlagID0.Value.ToString());
    ...
    public DataSet GetdatabyDeptinbatterydocument(string intEnterprenuerid, string deptid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
    ...
    public DataSet GetdatabyDeptinbatterydocumentRespondDetails(string intEnterprenuerid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("sp_RetrivelinkbyDeptidbatterybyRespondant", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataSet GetdataBatdealerApprovaldocument(string intEnterprenuerid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("sp_RetriveApprovallinkbatdealer", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
