<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmApproveDetailsbyqueryCFOIndus.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True" 
                                                Width="210px">Approval Process</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                    ...
                                    <tr>
                                        <td align="center" 
                                            ...
                                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                                NavigateUrl="~/UI/TSiPASS/frmCFEDepartmentsApprovalProcessCFO.aspx">Back</asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
