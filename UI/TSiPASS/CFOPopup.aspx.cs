...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            dscheck = Gen.GetShowQuestionariesbyUIDPOPCFO(Request.QueryString[0].ToString().Trim());
            ...
            Response.Redirect("ApplicationTrakerDetailedCFO.aspx?UID=" + Session["Applid"].ToString() + "");

            if (Session["Applid"].ToString() != "" || Session["Applid"].ToString() != "0")
            {
                DataSet dsnew = new DataSet();

                dsnew = clsGeneral.GetEnterPreneurdatabyQueCFO(Session["Applid"].ToString());
                ...
                if (dsnew != null && dsnew.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds = new DataSet();
                    ds = Gen.GetQuestionereisPopupCFO(Session["Applid"].ToString());
