...
public partial class UI_TSiPASS_SectorWiseReport : System.Web.UI.Page
{
                ...
                if (grdDetails.Rows[i].RowType == DataControlRowType.DataRow)
                {
                    for (int j = 0; j < CountColumns; j++)
                    {
                        ...
                        else
                        {
                            ...
                            //    //cellText = grdDetails.Rows[i].Cells[j].Controls[0];
                            //    cellText = Server.HtmlDecode(grdDetails.Rows[i].Cells[j].Text);
                            //}
                            //else
                            //    continue;
