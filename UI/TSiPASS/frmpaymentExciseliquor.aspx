<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmpaymentExciseliquor.aspx.cs" Inherits="UI_TSiPASS_frmpaymentExciseliquor" %>
            ...
            <div class="col-lg-12">
                <table>
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: x-large">Departments and Approvals for Grant of Liquor (A4) Shop License for excise</h1>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                            <tr>
                                                ...
                                                The following are the Approvals required for Grant of Liquor (A4) Shop License for excise
                                            </tr>
                                            <tr>
                                                <td>
                    ...
                    <tr>
                        <td align="center" style="padding: 5px; margin: 5px; text-align: center;">
                            ...
                            <asp:Button ID="BtnClear" runat="server" CausesValidation="False" CssClass="btn btn-warning"
                                Height="32px" OnClick="BtnClear_Click" TabIndex="10" Text="Previous" ToolTip="To Clear  the Screen"
                                Width="90px" />&nbsp;&nbsp;
