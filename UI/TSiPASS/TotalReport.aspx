<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TotalReport.aspx.cs" Inherits="UI_TSiPASS_TotalReport" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;"><asp:Label ID="lblHeading" runat="server">R6.13 : TGiPASS- District Wise Report Application Date Wise </asp:Label>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Districtname" HeaderText="District">
                                                 ...
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Appliedwithinperiod" HeaderText="No Of Industries Applied Within Selected Period">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Approvedwithinperiod" HeaderText="No Of Industries Approved Within Selected Peroid">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="Investment" HeaderText="Investment Approve (Rs. in Cr)">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="Employment" HeaderText="Total Employment Approve">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>                                                
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="False" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Approvedoutofperiod" HeaderText="No Of Industries Approved Beyond Selected Period">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
