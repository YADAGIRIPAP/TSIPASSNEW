<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSVCDashBoardFinalPrint.aspx.cs" Inherits="UI_TSiPASS_frmSVCDashBoardFinalPrint" %>
                        ...
                        <td>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    <tr id="trConvened1" runat="server">
                                        <td style="padding: 10px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width: 30px"></td>
                                                    <td style="vertical-align: middle; width: 250px" id="tddatetext" runat="server">Proposed SVC Date: </td>
                                                    ...
                                                    <td>
                                                        <asp:button id="btnupdatestatus" cssclass="btn btn-primary" runat="server" text="Submit" onclick="btnupdatestatus_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
