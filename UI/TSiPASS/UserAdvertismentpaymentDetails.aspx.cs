...
public partial class UI_TSiPASS_UserAdvertismentpaymentDetails : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(" ~/UI/TSiPASS/AdvertismentDashboardList.aspx");
    }
    ...
    private DataSet BindReceipt(string TranRefNo)
    {
        try
        {
            ...
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("USP_GET_ACKNOWLEDGEMENT_Advertisment", conn);
