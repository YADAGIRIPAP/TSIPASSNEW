...
public partial class UI_TSIPASS_comReportDrill_drilldown : System.Web.UI.Page
{
    string codes, dists;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (codes == "CFE" || codes == "CFO" || codes == "RAW MATERIALS" || codes == "RENEWALS" || codes == "NOT YET ASSIGNED BY GM" || codes == "INCENTIVE GM RECOMMEND PENDENCY" || codes == "INSPECTION DATE NOT YET ASSIGNED" || codes == "INSPECTION REPORT NOT UPLOADED" || codes == "QUERY NOT RESPONDED BEYOND 30 DAYS BY APPLICANT" || codes == "REPORT NOT SUBMITTED" || codes == "REPORT SUBMITTED" || codes == "REPORT NOT SUBMITTED BUT SALARY PROCESSED" || codes == "REPORT SUBMITTED BUT SALARY NOT YET PROCESSED" || codes == "MSME CATALOGUE DETAILS UPLOADED" || codes == "INITIAL STAGE" || codes == "Yet to Start Construction" || codes == "ADVANCED STAGE" || codes == "-CFE" || codes == "-CFO" || codes == "COMMENCED OPERATIONS" || codes == "DEPT GRIEVANCES")
            {
            ...
            if (fromdate != "" && todate != "")
            {
                ...
                lbldists.Text = dists;                
                getdetails(codes, dists, fromdate, todate);
    ...
    private void getdetails(string codes1,string dists1,string FromdateforDB1,string TodateforDB1)
    {
        SqlConnection osqlConnection = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["TSiPASSSkils"].ConnectionString);
        SqlDataAdapter oSqlDataAdapter = new SqlDataAdapter();
        DataSet oDataSet = new DataSet();
        osqlConnection.Open();
        oSqlDataAdapter = new SqlDataAdapter("USP_GET_COI_DASHBOARD_ALL_DRILLDOWN", osqlConnection);
