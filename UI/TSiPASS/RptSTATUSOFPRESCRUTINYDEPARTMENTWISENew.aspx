<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="RptSTATUSOFPRESCRUTINYDEPARTMENTWISENew.aspx.cs"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">R2.1 STATUS OF SCRUTINY - DEPARTMENT WISE</asp:Label>&nbsp; <a id="A1" href="#"
                                ...
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ApprovalName" HeaderText="Type of Approval" />
                                            ...
                                            <asp:HyperLinkField FooterStyle-CssClass="text-center" HeaderText="Payment received for"
                                             ...
                                             <asp:HyperLinkField FooterStyle-CssClass="text-center" HeaderText="Prescrutiny Completed Within" DataTextField="Completed Within">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                            </asp:HyperLinkField>
                                            <asp:HyperLinkField FooterStyle-CssClass="text-center" HeaderText="Prescrutiny Completed Beyond" DataTextField="Completed Beyond">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                            </asp:HyperLinkField>
                                        </Columns>
