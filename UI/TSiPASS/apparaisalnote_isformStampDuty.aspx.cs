...
public partial class UI_TSiPASS_apparaisalnote_isformStampDuty : System.Web.UI.Page
{
    ...
    public void USP_GETDETAILSFORSECTION()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtWC7.Text = (Convert.ToDecimal(txtLand7.Text) + Convert.ToDecimal(txtBuilding7.Text) +
              Convert.ToDecimal(txtPM7.Text) + Convert.ToDecimal(txtMCont7.Text) +
              Convert.ToDecimal(txtErec7.Text) + Convert.ToDecimal(txtTFS7.Text)).ToString();
            ...
            if (ds.Tables[0].Rows[0]["Land_ValueRecommendedByGM"].ToString() != null)
            {
                ...
                txtLandcostCompc.Text = ds.Tables[0].Rows[0]["Land_ProjectCost"].ToString();
            ...
            if (ds.Tables[0].Rows[0]["Building_ValueRecommendedByGM"].ToString() != null)
            {
                ...
                txtfacCostCompc.Text = ds.Tables[0].Rows[0]["Building_ProjectCost"].ToString();
            ...
            if (ds.Tables[0].Rows[0]["ProjcostPlant"].ToString() != null)
            {
                ...
                TextBox30.Text = ds.Tables[0].Rows[0]["PlantMachry_ProjectCost"].ToString();
            ...
            TXTBUILDINGRECOMMENDEDVALUE.Text = ds.Tables[0].Rows[0]["Building_ValueRecommendedByGM"].ToString();
           ...
           // TextBox31.Text = ds.Tables[0].Rows[0]["PlantSubTotal"].ToString(); //cost comptd
            TextBox31.Text = (Convert.ToDecimal(TextBox30.Text) + Convert.ToDecimal(TextBox32.Text)).ToString();

            TextBox34.Text = ds.Tables[0].Rows[0]["PlantMCstatements"].ToString();
            TextBox60.Text = ds.Tables[0].Rows[0]["Land_ProjectCost"].ToString();
            TextBox5.Text = ds.Tables[0].Rows[0]["Building_ProjectCost"].ToString();
            TextBox7.Text = ds.Tables[0].Rows[0]["PlantMachry_ProjectCost"].ToString();
        ...
        {
            txtLandsq.Text = ds.Tables[2].Rows[0]["AreaRegdSaledeed"].ToString();
            //txtLandsq_TextChanged(this, EventArgs.Empty);
            txtstampdutypaid.Text = ds.Tables[2].Rows[0]["StampTranfrDutyAP"].ToString();
            //txtstampdutypaid_TextChanged(this, EventArgs.Empty);
            txtbuildingplinth.Text = ds.Tables[2].Rows[0]["PlnthAreaBuild"].ToString();
            txtbuildingplinth_TextChanged(this, EventArgs.Empty);
        }
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.Recomamount = oIncentiveVosA.FINALELIGIBLEAMOUNT;
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_STAMPDUTY]";
            ...
            // -----------=====---------------
            if (oIncentiveVosA.LandSqmt != null)
                com.Parameters.AddWithValue("@LandSqmt", oIncentiveVosA.LandSqmt);
            if (oIncentiveVosA.StampDuty != null)
                com.Parameters.AddWithValue("@StampDuty", oIncentiveVosA.StampDuty);
            if (oIncentiveVosA.BuildingPlinth != null)
                com.Parameters.AddWithValue("@BuildingPlinth", oIncentiveVosA.BuildingPlinth);
            if (oIncentiveVosA.Proportionatearea != null)
                com.Parameters.AddWithValue("@Proportionatearea", oIncentiveVosA.Proportionatearea);
            if (oIncentiveVosA.GMValue != null)
                com.Parameters.AddWithValue("@GMValue", oIncentiveVosA.GMValue);
            if (oIncentiveVosA.StampComputed != null)
                com.Parameters.AddWithValue("@StampComputed", oIncentiveVosA.StampComputed);
            if (oIncentiveVosA.StampSubTotal != null)
                com.Parameters.AddWithValue("@StampSubTotal", oIncentiveVosA.StampSubTotal);
            if (oIncentiveVosA.StampBuildingPlinth != null)
                com.Parameters.AddWithValue("@StampBuildingPlinth", oIncentiveVosA.StampBuildingPlinth);
            if (oIncentiveVosA.FINALELIGIBLEAMOUNT != null)
                com.Parameters.AddWithValue("@FINALELIGIBLEAMOUNT", oIncentiveVosA.FINALELIGIBLEAMOUNT);

            if (oIncentiveVosA.GMRECOMMENDEDAMOUNTBUILDING != null)
                com.Parameters.AddWithValue("@GMRECOMMENDEVALUE_BUILDING", oIncentiveVosA.GMRECOMMENDEDAMOUNTBUILDING);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.GMRECOMMENDEDAMOUNTBUILDING = TXTBUILDINGRECOMMENDEDVALUE.Text;
        ...
        oIncentiveVosA.MstIncentiveId = "14";
        oIncentiveVosA.LandSqmt =Convert.ToDecimal( txtLandsq.Text);
        oIncentiveVosA.StampDuty =Convert.ToDecimal( txtstampdutypaid.Text);
        oIncentiveVosA.BuildingPlinth = Convert.ToDecimal( txtbuildingplinth.Text);
        oIncentiveVosA.Proportionatearea = Convert.ToDecimal( txtproportionate.Text);
        oIncentiveVosA.GMValue = Convert.ToDecimal( txtgmRecommend.Text);
        oIncentiveVosA.StampComputed = Convert.ToDecimal( txtvaluecomputed.Text);
        if(txtsubtotal.Text==""|| txtsubtotal.Text==null)
        {
            oIncentiveVosA.StampSubTotal = 0;
        }
        else
        {
            oIncentiveVosA.StampSubTotal = Convert.ToDecimal(txtsubtotal.Text);
        }
        
        oIncentiveVosA.StampBuildingPlinth = Convert.ToDecimal(txttotalplinth.Text);
        oIncentiveVosA.FINALELIGIBLEAMOUNT = Convert.ToDecimal(TXTFINALELIGIBLAMOUNT.Text);
    ...
    {
        public string GMRECOMMENDEDAMOUNTBUILDING { get; set; }
        ...
        public Decimal? LandSqmt { get; set; }
        public Decimal? StampDuty { get; set; }
        public Decimal? BuildingPlinth { get; set; }
        public Decimal? Proportionatearea { get; set; }
        public Decimal? GMValue { get; set; }
        public Decimal? StampComputed { get; set; }
        public Decimal? StampSubTotal { get; set; }
        public Decimal? StampBuildingPlinth { get; set; }
    ...
    public string ValidateControls()
    {
        ...
        if (txtLandsq.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please enter Land Measuring in Sq, Mts.\\n";
            slno = slno + 1;
        }
        if (txtstampdutypaid.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter Stamp Duty paid by the unit in Rs.  \\n";
            slno = slno + 1;
        }
        if (txtbuildingplinth.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter Building plinth area in Sq. Mts \\n";
            slno = slno + 1;
        }
    ...
    {
        TextBox20.Text = (Convert.ToDecimal(TextBox61.Text) + Convert.ToDecimal(TextBox6.Text) + Convert.ToDecimal(TextBox8.Text)
           + Convert.ToDecimal(TextBox10.Text) + Convert.ToDecimal(TextBox12.Text) + Convert.ToDecimal(TextBox14.Text)
           + Convert.ToDecimal(TextBox16.Text)).ToString();
    }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=14");
        }
    ...
    protected void rdeligibility_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (Convert.ToDecimal(txtproportionate.Text) > Convert.ToDecimal(txtstampdutypaid.Text))
                {
                    if (rdeligibility.SelectedValue == "Regular")
                    {
                        txtvaluecomputed.Text = Math.Round(Convert.ToDecimal(txtstampdutypaid.Text), 2).ToString();

                    }
                    else if (rdeligibility.SelectedValue == "Belated")
                    {
                        txtvaluecomputed.Text =  Math.Round((Convert.ToDecimal(txtstampdutypaid.Text) / 2),2).ToString();
                    }
                    else if (rdeligibility.SelectedValue == "OneYear")
                    {
                        txtvaluecomputed.Text = "0";
                    }
                }
                else
                {
                    ...
                    if (rdeligibility.SelectedValue == "Regular")
                    {
                        txtvaluecomputed.Text = Math.Round(Convert.ToDecimal(txtproportionate.Text), 2).ToString();

                    }
                    else if (rdeligibility.SelectedValue == "Belated")
                    {
                        txtvaluecomputed.Text =  Math.Round((Convert.ToDecimal(txtproportionate.Text) / 2),2).ToString();
                    }
                    else if (rdeligibility.SelectedValue == "OneYear")
                    {
                        txtvaluecomputed.Text = "0";
            ...
            if (txtvaluecomputed.Text != null || txtvaluecomputed.Text != "")
            {
                if (Convert.ToDecimal(txtproportionate.Text) > Convert.ToDecimal(txtstampdutypaid.Text))
                {
                    TXTFINALELIGIBLAMOUNT.Text = txtvaluecomputed.Text;
                }
                else
                {

                    if (Convert.ToDecimal(txtvaluecomputed.Text) > Convert.ToDecimal(txtgmRecommend.Text))
                    {
                        TXTFINALELIGIBLAMOUNT.Text = txtgmRecommend.Text;
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        // string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_STAMPDUTY" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_STAMPDUTY" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111113", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    protected void txtLandsq_TextChanged(object sender, EventArgs e)
    {
        //decimal STAMPDUTY;
        //if(txtstampdutypaid.Text==null|| txtstampdutypaid.Text=="")
        //{
        //    STAMPDUTY = 0;
        //}
        //else
        //{
        //    STAMPDUTY = Convert.ToDecimal(txtstampdutypaid.Text);
        //}
            
        //DataSet ds = new DataSet();
        //ds = GetAmount(Convert.ToDecimal( txtLandsq.Text), STAMPDUTY);
        //if (ds.Tables[0].Rows.Count > 0)
        //{
        //    txtsubtotal.Text = Convert.ToString(ds.Tables[0].Rows[0]["totalamount"]);
        //}
    }
    protected void txtstampdutypaid_TextChanged(object sender, EventArgs e)
    {
        //decimal LANDSQ;
        //if(txtLandsq.Text==null|| txtLandsq.Text == "")
        //{
        //    LANDSQ = 0;
        //}
        //else
        //{
        //    LANDSQ = Convert.ToDecimal(txtLandsq.Text);
        //}

        //DataSet ds = new DataSet();
        //ds = GetAmount(LANDSQ, Convert.ToDecimal(txtstampdutypaid.Text.Trim()));
        //if (ds.Tables[0].Rows.Count > 0)
        //{
        //    txtsubtotal.Text = Convert.ToString(ds.Tables[0].Rows[0]["totalamount"]);
        //}
    }
    public DataSet GetAmount(decimal landmeasuring, decimal stampdutypaid)
    {
        DataSet Dsnew = new DataSet();

        SqlParameter[] pp = new SqlParameter[]
       {
             new SqlParameter("@landmeasurement",SqlDbType.VarChar),
             new SqlParameter("@stampdutypaid",SqlDbType.VarChar)
       };
        pp[0].Value = landmeasuring;
        pp[1].Value = stampdutypaid;
        Dsnew = Gen.GenericFillDs("GetTotalAmount", pp);
        return Dsnew;
    }
    protected void txtbuildingplinth_TextChanged(object sender, EventArgs e)
    {
        //string COMPUTEDVALUE = "";
        txttotalplinth.Text = Convert.ToString(Convert.ToDecimal(txtbuildingplinth.Text) * 5);
        if(txttotalplinth.Text!=null|| txttotalplinth.Text!="")
            {

            txtproportionate.Text = (Convert.ToDecimal((Convert.ToDecimal(txttotalplinth.Text) * Convert.ToDecimal(txtstampdutypaid.Text)) / Convert.ToDecimal(txtLandsq.Text))).ToString("F2");
        }
    ...
    protected void txtvalCompc1_TextChanged(object sender, EventArgs e)
    {
        TextBox56.Text = txtvalCompc1.Text;
        TextBox56_TextChanged(this, EventArgs.Empty);
    }

    protected void txtCompvalCompc_TextChanged(object sender, EventArgs e)
    {
        TextBox57.Text = txtCompvalCompc.Text;
        TextBox57_TextChanged(this, EventArgs.Empty);

    }
    protected void TextBox42_TextChanged(object sender, EventArgs e)
    {
        TextBox58.Text = TextBox42.Text;
    ...
    protected void txtstampdutypaid_TextChanged1(object sender, EventArgs e)
    {

        txtproportionate.Text = Math.Round((Convert.ToDecimal((Convert.ToDecimal(txttotalplinth.Text) * Convert.ToDecimal(txtstampdutypaid.Text)) / Convert.ToDecimal(txtLandsq.Text))),2).ToString();
    }
    protected void txtLandsq_TextChanged1(object sender, EventArgs e)
    {
        if (txttotalplinth.Text == "")
        { txttotalplinth.Text = "0"; }
        if (txtstampdutypaid.Text == "")
        { txtstampdutypaid.Text = "0"; }
        if (txtLandsq.Text == "")
        { txtLandsq.Text = "0"; }
