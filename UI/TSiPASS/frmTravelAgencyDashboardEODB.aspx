<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="frmTravelAgencyDashboardEODB.aspx.cs" Inherits="UI_TSiPASS_frmTravelAgencyDashboardEODB" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Travel Agency Dashboard</asp:Label>&nbsp;
