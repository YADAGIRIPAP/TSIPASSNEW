<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveFormCFECFO.aspx.cs" Inherits="UI_TSiPASS_IncentiveFormCFECFO" %>
...
text margin: 5px">&nbsp;<b>I Hereby declare that, i am applying for first time for service activity and no one in my family has earlier filed for this claim by any means. I am Liable for any deviation or violation of rules.</b>
                                    ...
                                    <tr id="TRISMSMEUNIT" runat="server" visible="false">
                                      <td align="center" valign="middle"  >
                                            ...
                                            IS UNIT ENTERED IN INDUSTRY CATELOGE</td>
                                         <td style="width: 28%">
                                    ...
                                    <tr id="checkUID" runat="server" visible="false">
                                        <td align="center" colspan="6" style="padding: 5px; color: red; margin: 5px"><b>Note : There is no UID number for this user id. Please apply for incentives from the login through which CFE is applied. </b></td>
                                    </tr>
                                    <tr>
