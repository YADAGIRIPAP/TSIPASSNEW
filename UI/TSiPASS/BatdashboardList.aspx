<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="BatdashboardList.aspx.cs" Inherits="UI_TSiPASS_BatdashboardList" %>
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Incentiveid" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblbatdealerID" Text='<%#Eval("RENENTERPID") %>' runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
