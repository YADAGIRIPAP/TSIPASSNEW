<%@ Page Title=":: TSiPASS : Add Vulnerability " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="AddDisability.aspx.cs" Inherits="AddDisability" %>
...
function OpenPopup() 
 
   {
    ...
    window.open("Lookups/LookupDisability.aspx","List","scrollbars=yes,resizable=yes,width=1000,height=650;display = block;position=absolute");
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Add Vulnerability</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Vulnerability</h3>
                            </div>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label303" runat="server" CssClass="LBLBLACK" Width="165px">Vulnerability</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                            ControlToValidate="txtMSName" 
                                                            ValidationGroup="group" ErrorMessage="Please Enter Vulnerability">*</asp:RequiredFieldValidator> &nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td style="width: 27px">
