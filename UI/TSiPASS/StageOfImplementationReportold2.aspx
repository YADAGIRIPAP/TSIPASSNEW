<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="StageOfImplementationReportold2.aspx.cs"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        ...
                        <h2 class="panel-title" style="font-weight: bold;">
                            R6.3: TSiPASS - Progress Of Implementation Report <a id="Button2" href="#" onclick="javascript:return Panel1();"
                                runat="server">
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField FooterStyle-CssClass="text-center" ControlStyle-Font-Underline="false"
                                                ControlStyle-ForeColor="Black" DataTextField="Number" HeaderText="No of Industries">
