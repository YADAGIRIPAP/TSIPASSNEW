...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    public void GetDetails()
    {
        try
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                //return;
                dsn = Gen.GetShowDistricttFilesCFO1(rstages.ToString().Trim(), DistrictID.ToString().Trim());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HyperLink1.NavigateUrl = "CFOCertificate.aspx?intCFEEnterpid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim();
    ...
    protected void BtnSave_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            int result = 0;
            result = Gen.UpdCommissionerApprovalCFO(hdfGroundedNo.Value, hdfGroundedNo0.Value, hdfGroundedNo1.Value, ddlStatus.SelectedValue.ToString(), hdfGroundedNo2.Value, Session["uid"].ToString().Trim(), hdfApplID.Value);
            ...
            if (result > 0)
            {
                ...
                {
                    Response.Redirect("CFOCertificate.aspx?id=" + hdfGroundedNo.Value);
                }
