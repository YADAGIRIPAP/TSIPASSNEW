<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBankRegistrationReport.aspx.cs" Inherits="UI_TSiPASS_frmBankRegistrationReport" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Banker Registration Report</asp:Label>&nbsp;
                                            ...
                                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No of Banks Registered"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="NOOFBANKS" runat="server" Text='<%#Eval("NOOFBANKS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
