...
public partial class UI_TSiPASS_ProformaCoal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"] != null)
        {
            if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
            {
                ...
                ds2 = Gen.GetBasicUnitDetails_Proforma_lettersPSR(incentiveid, "18");
                binddatanew(ds2);
                ...
                dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "18", userid, "", "RECOMMENDATION");
                if (dsname.Tables.Count > 0 && dsname.Tables[0].Rows.Count > 0)
                {
