<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmVATExportGM.aspx.cs" Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Exporters details(TS)</a>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <table cellpadding="7" cellspacing="7" width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label10" runat="server" CssClass="LBLBLACK" Width="180px">Name of Company</asp:Label>
                                                            </td>
                                                            <td>
                                                                :
                                                            </td>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label380" runat="server" CssClass="LBLBLACK" Width="180px">IEC Number</asp:Label>
                                                            </td>
                                                            <td valign="top">
                                                                :
                                                            </td>
                                                            <td valign="top">
                                                                <asp:TextBox ID="TxtIECNumber" runat="server" AutoPostBack="True" class="form-control txtbox"
                                                                    Height="28px" MaxLength="50" TabIndex="0" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtCommodity" runat="server" AutoPostBack="True" class="form-control txtbox"
                                                                    Height="28px" MaxLength="50" TabIndex="0" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlStatus"
                                                                    ErrorMessage="Please Select Status" InitialValue="--All--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">
                                                        ...
                                                        <RowStyle BackColor="#EBF2FE" HorizontalAlign="Left" VerticalAlign="Middle" />        &nbsp;
                                                            ...
                                                            <td align="center" colspan="3" style="text-align: center">
                                                                <asp:Button ID="BtnSave2" runat="server" CssClass="btn-success" Height="32px" OnClick="BtnClear0_Click"
                                                                    TabIndex="10" Text="Search" ValidationGroup="group" Width="80px" />
                                                            </td>
                                                            <td valign="top">
                                                                &nbsp;
                                                            </td>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                     <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Nameofthecompany" HeaderText="Name of Company" />
                                                            <asp:BoundField DataField="ContactDetails" HeaderText="Contact Details" 
                                                                 />
                                                            <asp:BoundField DataField="FactoryAddress" HeaderText="Factory Address" />
                                                            <asp:BoundField DataField="IECNumber" HeaderText="IEC Number" />
                                                            <asp:BoundField DataField="StatusofExporter" HeaderText="Status of Exporter" />
                                                            <asp:BoundField DataField="Commodity" 
                                                                HeaderText="Commodity" />
                                                                   <asp:BoundField DataField="ValueofExport2015_16" 
                                                                HeaderText="Value of Export (2015-16)" />
                                                                
                                                                   <asp:BoundField DataField="ValueofExport2014_15" 
                                                                HeaderText="Value of Export (2014-15)" />
                                                                
                                                                   <asp:BoundField DataField="ValueofExport2013_14" 
                                                                HeaderText="Value of Export (2013-14)" />
                                                                
                                                                   <asp:BoundField DataField="EPC" 
                                                                HeaderText="EPC" />
