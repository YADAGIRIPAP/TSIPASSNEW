...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ds = Gen.DistrictWiseCerGenReportCFO();
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h5.Target = "_blank";
            h5.NavigateUrl = "CertGenDrillDownReportCFO.aspx?Stage=5&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistrictId")).Trim();

            HyperLink h6 = (HyperLink)e.Row.Cells[3].Controls[0];
            h6.Target = "_blank";
            h6.NavigateUrl = "CertGenDrillDownReportCFO.aspx?Stage=6&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistrictId")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            dtotal.NavigateUrl = "CertGenDrillDownReportCFO.aspx?Stage=5&District=%";
            ...
            stotal.NavigateUrl = "CertGenDrillDownReportCFO.aspx?Stage=6&District=%";
