<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmADMGViewAppl.aspx.cs" 
    Inherits="UI_TSiPASS_frmADMGViewAppl" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <%--<li class=""><i class="fa fa-fw fa-edit">Mines Noc</i> </li>--%>
                    <li class="active"><i class="fa fa-edit"></i><a href="#">ADM&G View Applications</a> </li>
                </ol>
            </div>
            <div align="left">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="HdfADMGID" runat="server" />
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:BoundField DataField="ExtentinHectors" HeaderText="Total Extent in Hectors" />
                                                            <asp:BoundField DataField="District" HeaderText="District" />
                                                            <asp:BoundField DataField="mandal" HeaderText="Mandal" />
                                                            <asp:BoundField DataField="village" HeaderText="Village Names" />
                                                            <asp:BoundField DataField="MineralSurveyNo" HeaderText="Survey Nos." />
                                                            <asp:BoundField DataField="PartExtent" HeaderText="Individual Extent(per Survey No." />
                                                             <asp:BoundField DataField="MobileNo" HeaderText="Mobile No." />
                                                             <asp:BoundField DataField="Email" HeaderText="E-Mail" />
                                                             <asp:BoundField DataField="AadharNo" HeaderText="Aadhar No." />
                                                             <%--<asp:BoundField DataField="GST" HeaderText="GST No." />--%>
                                                            <asp:HyperLinkField HeaderText="ADM&G Appl" Text="View" />
