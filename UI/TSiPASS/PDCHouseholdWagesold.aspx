<%@ Page Title=":: TSiPASS : Beneficiary Job Card " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="PDCHouseholdWagesold.aspx.cs" Inherits="CheckPOITD" %>
                                ...
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label414" runat="server" CssClass="LBLBLACK" Width="160px">Kulipapa</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        &nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label415" runat="server" CssClass="LBLBLACK" Width="165px"> Available Funds</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label416" runat="server" CssClass="LBLBLACK" Width="160px">200000</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        &nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;<asp:Label ID="Label394" runat="server" CssClass="LBLBLACK" Width="128px">Paid Date</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr>
                                        <td colspan="3" style="padding: 5px; margin: 5px" valign="top">
                                            ...
                                            <iframe src="dummy2.aspx"  width="100%" height="500px"></iframe>
