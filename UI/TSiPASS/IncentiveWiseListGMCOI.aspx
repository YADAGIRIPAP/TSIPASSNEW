<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveWiseListGMCOI.aspx.cs" Inherits="UI_TSiPASS_IncentiveWiseListGMCOI" %>
                                                    ...
                                                    <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server" Text="View" Width="150px" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
