...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        ds = Gen.sp_GetDepartmentNameReport(ddlDepartment.SelectedValue, ddldistrict.SelectedValue, ddlStatus.SelectedValue);
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=R2.2 Pre-scrutiny - Query Details" + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
