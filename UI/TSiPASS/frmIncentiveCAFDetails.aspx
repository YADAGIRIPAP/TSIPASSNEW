<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmIncentiveCAFDetails.aspx.cs" Inherits="UI_TSiPASS_frmIncentiveCAFDetails" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: x-large">Incentive Types</h1>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                            <tr id="trno" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px" valign="top" class="style8">The following are the Approvals required for Establishment of your Unit.please select
                                                    the Approvals for which you intend to apply for.
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 5px; margin: 5px; text-align: center;">
                            <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                OnClick="BtnSave_Click" TabIndex="10" Text="Next" ValidationGroup="group" Width="90px"
                                />
                            &nbsp;&nbsp;<asp:Button ID="BtnDelete"  Visible="False" runat="server" CausesValidation="False" CssClass="btn btn-danger"
