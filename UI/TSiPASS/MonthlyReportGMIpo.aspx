<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"  CodeFile="MonthlyReportGMIpo.aspx.cs" Inherits="UI_TSiPASS_MonthlyReportGMIpo" EnableEventValidation="false" %>
                    ...
                    <div class="col-lg-12">
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Attachment" Visible="false">
                                                                <ItemTemplate >
                                                                   <asp:HyperLink ID="hprlink" runat="server" Visible="true" NavigateUrl='<%#Eval("FilePath") %>' Target="_blank"></asp:HyperLink>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="GM Remarks"> 
                                                               <ItemTemplate>

                                                                   
                                                               <asp:TextBox  runat="server" class="form-control txtbox" Height="50px" Width="180px"
                                                                        AutoComplete="false" ID="TxtReject" placeholder="Remarks" TextMode="MultiLine" ></asp:TextBox>
                                                               </ItemTemplate>
                                                           </asp:TemplateField>
                                                           
                                                            
                                                           <asp:TemplateField HeaderText="Verified Details">
                                                                    <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Submit" Visible="false">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button ID="BtnSave" runat="server" CausesValidation="False" CssClass="btn-success"
                                                                        Height="32px"  
                                                                        TabIndex="10" Text="Approve" ValidationGroup="group" Width="100px" OnClick="BtnSave_Click" />
                        ...
                        <td align="center" style="padding: 5px; margin: 5px; text-align: center;">
                            <asp:Button ID="BtnClear" runat="server" CausesValidation="False" CssClass="btn btn-warning"
                                Height="32px" TabIndex="10" Text="ClearAll" ToolTip="To Clear  the Screen" Visible="false"
                                Width="90px" />&nbsp;&nbsp;
                            <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                 OnClick="BtnSave1_Click" TabIndex="10" Text="Submit" ValidationGroup="group" Width="90px"
                                Visible="true" />
                            &nbsp;&nbsp;<asp:Button ID="BtnDelete" runat="server" CausesValidation="False" CssClass="btn btn-danger"
                                Height="32px" TabIndex="10" Text="Submit" Width="90px" Visible="false" />
