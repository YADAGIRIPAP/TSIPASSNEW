<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="Pavalavaddiregularandmoratorium.aspx.cs" Inherits="UI_TSiPASS_Pavalavaddiregularandmoratorium" %>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    <asp:GridView ID="grd_eglibilepallavaddi" runat="server" CssClass="table table-small-font table-bordered table-striped" AutoGenerateColumns="false"
                                                        AllowPaging="false" ShowHeaderWhenEmpty="true" ShowFooter="true" EmptyDataText="&lt;b&gt;No Data Available&lt;/b&gt;" OnSelectedIndexChanged="grd_eglibilepallavaddi_SelectedIndexChanged">
                                                        <Columns>
                                    ...
                                    <td colspan="5">
                                        <table>
                                            ...
                                            <tr id="trTransNonTrans" runat="server" visible="false">
                                                <td class="auto-style3">Transport/Non-Transport Type
                                                </td>
