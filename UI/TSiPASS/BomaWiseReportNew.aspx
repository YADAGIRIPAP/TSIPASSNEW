<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="BomaWiseReportNew.aspx.cs" Inherits="BomaWiseReportNew" Title=":: TSiPASS Online Management System ::" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                ...
                <td><asp:Label ID="lblmsg1" Text="Boma wise type of works report" Font-Bold="true"   runat="server" Font-Size="Medium"></asp:Label>
                </td>
                </tr>
