<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CheckStatusUpdatedDetails.aspx.cs" Inherits="UI_TSiPASS_CheckStatusUpdatedDetails" %>
                                                    ...
                                                    <div id="Div1" style="width: 100%" runat="server">
                                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="UTR_NUMBER" ItemStyle-HorizontalAlign="Center" HeaderText="UTR NUMBER">
                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                </asp:BoundField>

                                                                <asp:BoundField DataField="CheckStatus" ItemStyle-HorizontalAlign="Center" HeaderText="Status of Cheque">
                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                </asp:BoundField>


                                                                 <asp:TemplateField HeaderText="UTR Number" Visible="false"> 
                                                               <ItemTemplate>
