<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSteamPipelineInspectUpload.aspx.cs" Inherits="UI_TSiPASS_frmSteamPipelineInspectUpload" %>
            ...
            <div class="col-lg-11">
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title">Steam Pipeline Errection Permission Details</h3>
                    </div>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True"
                                        Width="210px">Steam Pipeline Errection Permission</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr id="truidno" runat="server" visible="false">
                                        ...
                                        <tr id="trindusname" runat="server" visible="false">
                                        ...
                                        <tr id="trenttype" runat="server" visible="false">
                                        ...
                                        <tr id="trapprovalname" runat="server" visible="false">
                                        ...
                                        <tr id="trRemarks" runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">Errection Permission Remarks*</td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">1&nbsp;</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label439" runat="server" CssClass="LBLBLACK" Width="165px">Errection Permission Attachment<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="btnnext" runat="server"
                                                ...
                                                ValidationGroup="group" OnClick="btnnext_Click" />
                                            &nbsp;<asp:Button ID="btnprevious" runat="server" CausesValidation="False"
                                                CssClass="btn btn-danger" Height="32px"
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="BtnClr" runat="server" CausesValidation="False"
                                                ...
                                                Text="ClearAll" ToolTip="To Clear  the Screen" Width="90px" OnClick="BtnClr_Click" /></td>
                                    </tr>
                            <tr>
