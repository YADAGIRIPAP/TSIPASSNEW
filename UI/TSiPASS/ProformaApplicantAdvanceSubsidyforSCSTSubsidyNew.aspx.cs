...
public partial class UI_TSIPASS_ProformaApplicantAdvanceSubsidyforSCSTSubsidyNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //dsnew = Gen.GetSLCDetails(incentiveid, "12");
        ...
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "12", "0", "", "INTIMATION");
    ...
    public void fillSLCDetails(DataSet ds)
    {
        ...
        if (Request.QueryString.Count > 0)
        {
            if (Request.QueryString["Scheme"] != null)
            {
                ...
                lblTIdeaTPrideIIPP1.Text = scheme;
                lblTIdeaTPrideIIPP2.Text = scheme;
                lblTIdeaTPrideIIPP3.Text = scheme;
            ...
            ////string s = "2014/11/29";
            ////DateTime DCPBaseDate = DateTime.ParseExact(s, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
            ...
            //Added by sridhar
                if (DipcCoiFlag == "Y")
                {
                    ...
                    lblLetterNomngr.Text = "DIPC/" + ds.Tables[1].Rows[0]["applicationno"].ToString();//Request.QueryString["incentiveid"].ToString();
                ...
                else
                {
                    ...
                    lblLetterNomngr.Text = "COI/" + ds.Tables[1].Rows[0]["applicationno"].ToString(); //Request.QueryString["incentiveid"].ToString();
