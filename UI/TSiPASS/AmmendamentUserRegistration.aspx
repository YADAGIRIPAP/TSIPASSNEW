<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="AmmendamentUserRegistration.aspx.cs" Inherits="UI_TSiPASS_AmmendamentUserRegistration" %>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title" >
                                   <asp:Label id="lblHeading" runat="server" Text="User Registration"></asp:Label></h3>
                            </div>
                                        ...
                                        <div>
                                            <table id="Table1" runat="server" align="center" cellpadding="10" cellspacing="5" 
                                                ...
                                                <tr runat="server" id="tblRegister">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; width: 192px;">
                                                                    <asp:TextBox ID="txtDesignation" runat="server" class="form-control txtbox"  
                                                                       Height="28px"   MaxLength="40" TabIndex="2" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; width: 10px;">
                                                    ...
                                                    <td align="center" valign="top">
                                                        <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                            <tr runat="server" id="tradhar" visible="false">
                                                                <td style="padding: 5px; margin: 5px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:Button ID="BtnSave2" runat="server" CssClass="btn btn-primary" ValidationGroup="group"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtpasswordnew" runat="server" class="form-control txtbox" 
                                                                        ...
                                                                        ValidationGroup="group1" Width="180px"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                                                        ...
                                                                        ErrorMessage="Please Enter Correct Passowrd" ValidationGroup="group1">*</asp:CompareValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px">
                                                ...
                                                <tr runat="server"  visible="false" id="tblRegister1">
                                                   ...
                                                   <tr runat="server"  id="tblRegister2" >
