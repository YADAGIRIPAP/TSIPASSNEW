<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartmentApprovalPaymentDetailsNew.aspx.cs" Inherits="TSTBDCReg1" %>
                                                ...
                                                <tr ID="DD" runat="server" >
                                                    ...
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:TextBox ID="txtDDNumber" runat="server" 
                                                            class="form-control txtbox" Height="28px" MaxLength="6" 
                                                            onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group" 
                                                            Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                            ...
                                            <asp:RadioButtonList ID="rdbOnlineBankType" runat="server" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" colspan="4">
                                                        ...
                                                        1800-3070-3405 or upload a grievance.
                                                        <br />
                                    ...
                                    <tr>
                                        <td align="center" 
                                            ...
                                            <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" 
                                                Height="32px" onclick="BtnSave_Click" TabIndex="10" Text="SBH Challan" 
                                                ValidationGroup="group" Width="105px" Visible="False" />
                                            &nbsp;&nbsp;<asp:Button ID="BtnDelete" runat="server" 
                                                CssClass="btn btn-danger" Height="32px" onclick="BtnClear0_Click" TabIndex="10" 
                                                Text="Pay" Width="160px" ValidationGroup="group" 
                                                />
