<%@ Page Title="" Language="VB" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="false" CodeFile="SWGApplicationTracker.aspx.vb" Inherits="UI_TSiPASS_SWGApplicationTracker" %>
            ...
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">SEWERAGE CONNECTION DETAILED TRACKER REPORT</h3>
                    </div>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" __designer:mapid="365">
                                                <asp:Label ID="Label359" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Font-Bold="True" Visible="False">4. 
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="Label362" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Font-Bold="True">6. Address of the Industry</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px">
