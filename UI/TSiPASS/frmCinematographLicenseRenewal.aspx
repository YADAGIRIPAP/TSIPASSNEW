<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmCinematographLicenseRenewal.aspx.cs" Inherits="UI_TSiPASS_frmCinematographLicenseRenewal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        ...
        &nbsp;!&nbsp; &nbsp; &nbsp; 
            ...
            <li class="active">
                <i class="fa fa-edit"></i><a href="#">Cinematograph License & License for Screening a Film</a>
            </li>
        </ol>
    </div>
        ...
        <div class="row" align="left">
            <div class="col-lg-11">
                <div class="panel-heading" align="center" style="background-color:forestgreen">
                        <h3 class="panel-title" style="color:white">Cinematograph License & License for Screening a Film</h3>
                    </div>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" class="auto-style6">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style10">1.</td>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:DropDownList ID="ddlexpyear" runat="server" class="form-control txtbox"
...
<font 
                                       ...
                                       <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtelectricalcertificatevaliddate" runat="server" class="form-control txtbox" onkeypress="DecimalOnly()"
                                                    Height="28px"   TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>
                                               </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                     <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtfirenocvaliddate" runat="server" class="form-control txtbox" onkeypress="DecimalOnly()"
                                                    Height="28px"   TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>
                                               </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:RadioButtonList ID="rbttheatretype" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="190px" TabIndex="1" >                                                
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtnoofscreens" runat="server" class="form-control txtbox" onkeypress="DecimalOnly()"
                                                    Height="28px"   TabIndex="1"
                                                    ValidationGroup="group" Width="180px" AutoPostBack="true" OnTextChanged="txtnoofscreensoftheatre_TextChanged"></asp:TextBox>
                                               </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                        ...
                                        <tr id="trbuildingpermissionnumber" runat="server" >
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:DropDownList ID="ddlnoofshows" runat="server" class="form-control txtbox"
                                                    Height="33px" Width="180px" TabIndex="1">
                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                        ...
                                        <tr id="troccupancycertificatenumber" runat="server" visible="false" >
                                            <td style="padding: 5px; margin: 5px; text-align: left;">11.</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label10" runat="server" CssClass="LBLBLACK" Width="200px">Commissionerate<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:DropDownList ID="ddlcommissionerate" runat="server" class="form-control txtbox" AutoPostBack="true" OnSelectedIndexChanged="ddlcommissionerate_SelectedIndexChanged"
                                                    Height="33px" Width="180px" TabIndex="1">
                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                        ...
                                        <tr id="trbuildingpermissiondate" runat="server"  visible="false" >
                                            <td style="padding: 5px; margin: 5px; text-align: left;">12.</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label11" runat="server" CssClass="LBLBLACK" Width="200px">Zone<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                        ...
                                        <tr id="troccupancycertificatedate" runat="server"  visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">13.</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label12" runat="server" CssClass="LBLBLACK" Width="200px">Division<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                        ...
                                        <tr id="trps" runat="server"  visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label3" runat="server" CssClass="LBLBLACK" Width="200px">
                                                    Police Station
                                                    <font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                        ...
                                        <tr id="trplotorsitedocumentno" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">15.</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label8" runat="server" CssClass="LBLBLACK" Width="200px">Traffic Zone<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                        ...
                                        <tr id="tr11" runat="server" visible="false" >
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label5" runat="server" CssClass="LBLBLACK" Width="200px">Traffic Division<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" align="center" class="auto-style6"><asp:Label runat="server"><strong>Documents To Upload</strong></asp:Label></td>
                                <td style="width: 27px">&nbsp;</td>
                                <td valign="top">&nbsp;</td>
                            </tr>
                            <tr>
...
<font 
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                <asp:FileUpload ID="fup8BNOC" runat="server" class="form-control txtbox"
                                                    Height="28px" />

                                                <asp:HyperLink ID="hyper8BNOC" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="lbl8BNOC" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btn8BNOC" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btn8BNOC_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                <asp:FileUpload ID="fup9BNOC" runat="server" class="form-control txtbox"
                                                    Height="28px" />

                                                <asp:HyperLink ID="hyper9BNOC" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="lbl9BNOC" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btn9BNOC" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btn9BNOC_Click" />
                                            </td>
                                        </tr>
                                        <tr runat="server" id="tr3" visible="true">
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                ...
                                                <asp:HyperLink ID="hyperfireoccupancycertificate" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnfireoccupancycertificate" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnfireoccupancycertificate_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                ...
                                                <asp:HyperLink ID="hyperGHMCoccupancycertificate" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnGHMCoccupancycertificate" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnGHMCoccupancycertificate_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnTSFTCANDTDCNOC" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnTSFTCANDTDCNOC_Click" />
                                            </td>
                                        </tr>
 ...
 <font 
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnfirmchambernoc" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnfirmchambernoc_Click"/>
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                <asp:FileUpload ID="fupfirmdivision" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnfirmdivision" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnfirmdivision_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnleaseagreement" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnleaseagreement_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; width:500px ; text-align: left;" >
                                                <asp:FileUpload ID="fupblueprint" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnblueprint" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnblueprint_Click" />
                                            </td>
                                        </tr>
...
<font 
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="btnseatingdetails" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload"
                                                    Width="72px" OnClick="btnseatingdetails_Click" />
                                            </td>
                                        </tr>
