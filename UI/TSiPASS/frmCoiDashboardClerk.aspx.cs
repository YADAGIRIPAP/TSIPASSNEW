...
public partial class UI_TSiPASS_frmCoiDashboardClerk : System.Web.UI.Page
{
    ...
    private void fillDetails()
    {
        ...
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            LabelForwarded.Text = ds.Tables[0].Rows[0]["TOTALAPPLFORWARDEDTOSUPT"].ToString();
            LabelQueryAD.Text = ds.Tables[0].Rows[0]["TOTALAPPLQUERYTOSUPT"].ToString();
            LabelJDReturned.Text = ds.Tables[0].Rows[0]["TOTALAPPLRETURNEDFROMSUPT"].ToString();
            lbladrecommended.Text = ds.Tables[0].Rows[0]["TOTALAPPLADRECOMMENDTOSUPT"].ToString();
            lblqueryforwardedtojd.Text = ds.Tables[0].Rows[0]["QUERIESRESPNDEDSUPTFORWARDED"].ToString();
            lblqueryraisedbyforqiery.Text = ds.Tables[0].Rows[0]["QUERIESRESPNDEDSUPTQUERY"].ToString();
    ...
    public DataSet GetCoiIncetivePOSDetailsdeptClerk(string UserId)
    {
        ...
        try
        {
            da = new SqlDataAdapter("[USP_GET_COI_Dashboard_CLERK]", con.GetConnection);
