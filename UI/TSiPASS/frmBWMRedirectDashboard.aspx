<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBWMRedirectDashboard.aspx.cs" Inherits="UI_TSiPASS_frmBWMRedirectDashboard" %>
                                                ...
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:HyperLinkField HeaderText="Boiler Status" Text="Please Click here to view Status" Visible="false"/>
                                                        </Columns>
