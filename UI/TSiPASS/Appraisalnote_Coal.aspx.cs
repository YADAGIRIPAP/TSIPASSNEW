...
public partial class UI_TSiPASS_Appraisalnote_Coal : System.Web.UI.Page
{
    ...
    public void USP_GETDETAILSFORSECTION()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                txtcoalquantity.Text = ds.Tables[2].Rows[0]["Quantity_Coal"].ToString();
                txtcoalquantity_TextChanged(this, EventArgs.Empty);
                TXTELIGIBLEAMOUNT.Text = ds.Tables[2].Rows[0]["Amountclaimed"].ToString();
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.MstIncentiveId = "18";// Request.QueryString["MstIncentiveId"].ToString();
            ...
            string lblMstIncentiveId = "18";// Request.QueryString["MstIncentiveId"].ToString();
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_COAL]";
            ...
            if (oIncentiveVosA.COALQUANTITY != null)
                com.Parameters.AddWithValue("@COALQUANTITY", oIncentiveVosA.COALQUANTITY);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.MstIncentiveId = "18";// Request.QueryString["MstIncentiveId"].ToString();
        oIncentiveVosA.COALQUANTITY = Convert.ToDecimal(txtcoalquantity.Text);
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                       ...
                       // string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_COAL" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_COAL" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111116", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    {
        TXTELIGIBLEAMOUNT.Text = (Convert.ToDecimal(txtcoalquantity.Text) * 1000).ToString();
        if(Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text)<= Convert.ToDecimal(txtgmRecommend.Text))
        {
            TXTFINALSUBSIDYAMOUNT.Text = TXTELIGIBLEAMOUNT.Text;
        }
        if (Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text) > Convert.ToDecimal(txtgmRecommend.Text))
        {
