<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="InspectionForm.aspx.cs" Inherits="TSTBDCReg1" %>
                                ...
                                <td align="center" class="style21" style="padding: 5px; margin: 2px">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlDepartment" runat="server" class="form-control txtbox" Height="33px" Enabled="false"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtDesignation"
                                                    ErrorMessage="Please Enter nspection Authority Designation" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                                &nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style47" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label567" runat="server" CssClass="LBLBLACK" Width="148px">Need for Inspection<font color="red">*</font></asp:Label>
                                            </td>
                                            <td class="style46" style="padding: 5px; margin: 5px">
                                                :&nbsp;
                                            </td>
                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddltypofinspection" runat="server" class="form-control txtbox"
                                                    AutoPostBack="true" OnSelectedIndexChanged="ddltypofinspection_SelectedIndexChanged"
                                                    Height="33px" TabIndex="3" Width="180px">
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                    <asp:ListItem Value="1">Approval Request</asp:ListItem>
                                                    <asp:ListItem Value="2">Renewal</asp:ListItem>
                                                    <asp:ListItem Value="3">Complaint based</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style49" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label573" runat="server" CssClass="LBLBLACK" Width="135px">Date 
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtdateofinspection"
                                                    ErrorMessage="Please Enter Date of Inspection" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                            ...
                                            <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtPromotermobile" runat="server" class="form-control txtbox" Height="28px"
