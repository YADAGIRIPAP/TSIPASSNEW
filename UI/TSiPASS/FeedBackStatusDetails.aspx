<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="FeedBackStatusDetails.aspx.cs" Inherits="UI_TSiPASS_FeedBackStatusDetails" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Feedback Details</a> </li>
                </ol>
            </div>
            <div align="left">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px" class="style17">
                                                                ...
                                                                <tr>
                                                                    <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                                                        <asp:GridView ID="grdDetails" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                                            CellPadding="4" CssClass="GRD" ForeColor="#333333" GridLines="Both" OnPageIndexChanging="grdDetails_PageIndexChanging"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="Grivance_Subject" HeaderText="Feedback Subject" />
                                                                                <asp:BoundField DataField="Grievance_Description" HeaderText="Feedback Description" />
                                                        ...
                                                        <ItemTemplate>
                                                            <a ID="lnkChangeStatus" 
                                                                href='GreivanceChangeStatus.aspx?intGrievanceid=<%# Eval("intGrievanceid") %>'>
                                                            Change Status</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                                                                                <%--    <asp:HyperLinkField HeaderText="Forward" Text="Forward" />
