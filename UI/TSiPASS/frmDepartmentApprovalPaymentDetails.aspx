<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmDepartmentApprovalPaymentDetails.aspx.cs"
    Inherits="TSTBDCReg1" %>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:GridView ID="gvUpload4" runat="server" AutoGenerateColumns="False" CellPadding="3" OnRowDataBound="gvUpload4_RowDataBound"
                                                        ...
                                                        <asp:TemplateField HeaderText="DC Letter">
                                                            <ItemTemplate>
                                                                <%--<a id="dcletter" href='<%# Eval("letter") %>' target="_blank">DC Letter</a>--%>
                                                                        <asp:HyperLink ID="HyperLinkSubsidy" Text="view" NavigateUrl='<%#Eval("letter")%>' Target="_blank" runat="server" />
