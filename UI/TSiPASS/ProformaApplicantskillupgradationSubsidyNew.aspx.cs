...
public partial class UI_TSIPASS_ProformaApplicantskillupgradationSubsidyNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //dsnew = Gen.GetSLCDetails(incentiveid, "8");
        ...
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "8", "0", "", "INTIMATION");
