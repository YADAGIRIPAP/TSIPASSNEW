...
public partial class UI_TSiPASS_Kotakadvertisement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = obj_adv.GetAdvertisementpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
