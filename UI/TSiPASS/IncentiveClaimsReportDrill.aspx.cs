...
public partial class UI_TSiPASS_IncentiveClaimsReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["fromdt"] != null && Request.QueryString["fromdt"] != "" && Request.QueryString["todt"] != null && Request.QueryString["todt"] != "")
            {
                ...
                if (Request.QueryString["IncentiveType"] != null && Request.QueryString["IncentiveType"] != "")
                {
                    ddlIncentiveType.SelectedValue = Request.QueryString["IncentiveType"].ToString();
                }
                if (Request.QueryString["EntType"] != null && Request.QueryString["EntType"] != "")
                {
                    ddlIncentiveType.SelectedValue = Request.QueryString["EntType"].ToString();
                }
                ...
                if (Request.QueryString["Sector"] != null && Request.QueryString["Sector"] != "")
                {
                    ddlSector.SelectedValue = Request.QueryString["Sector"].ToString();
                }
                if (Request.QueryString["Subsector"] != null && Request.QueryString["Subsector"] != "")
                {
                    ddlManufacture.SelectedValue = Request.QueryString["Subsector"].ToString();
                }
    ...
    public void FillGridDetails()
    {
       ...
       // Label1.Text = "Report from " + txtFromDate.Text.Trim() + " To " + txtTodate.Text.Trim();
        ...
        ds = Gen.GetIncentivesClaimedReportDrill(status, ddlDistrict.SelectedValue, ddlCaste.SelectedValue, ddlEnterPriseType.SelectedValue, ddlIncentiveType.SelectedValue, FromdateforDB, TodateforDB, ddlSector.SelectedValue, ddlManufacture.SelectedValue);
