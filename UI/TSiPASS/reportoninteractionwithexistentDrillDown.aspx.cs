...
public partial class UI_TSiPASS_reportoninteractionwithexistentDrillDown : System.Web.UI.Page
{
    ...
    protected void Binddata(string Districtid, string type, string fromdate, string todate)
    {
        try
        {
            ...
            connection.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_Existing_WomenEntr", connection);
            ...
            Grdexistent.DataSource = ds.Tables[0];
            Grdexistent.DataBind();
    ...
    protected void Grdexistent_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void Button2_ServerClick(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            ...
            {
                Grdexistent.AllowPaging = false;

                // this.fillgrid();

                Grdexistent.HeaderRow.ForeColor = System.Drawing.Color.Black;
                Grdexistent.HeaderStyle.ForeColor = System.Drawing.Color.Black;

                Grdexistent.FooterRow.ForeColor = System.Drawing.Color.Black;
                // grdExport.Columns[1].Visible = false;
                Grdexistent.RenderControl(hw);
