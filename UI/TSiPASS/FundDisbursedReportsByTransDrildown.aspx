<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="FundDisbursedReportsByTransDrildown.aspx.cs" Inherits="FundDisbursedReportsByTransDrildown" Title=":: TSiPASS Online Management System ::" %>
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                           ...
                                           <%-- <asp:BoundField DataField="Created_by" HeaderText="Created_by" >
                                            ...
                                            <asp:BoundField DataField="Modified_dt" HeaderText="Modified_dt" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                            --%>
                                        </columns>
