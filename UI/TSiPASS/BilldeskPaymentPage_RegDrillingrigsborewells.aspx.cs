...
public partial class UI_TSiPASS_BilldeskPaymentPage_RegDrillingrigsborewells : System.Web.UI.Page
{
    ...
    Cls_DrillingRigs obj_adv = new Cls_DrillingRigs();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = obj_adv.GetDrillingRigspaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
