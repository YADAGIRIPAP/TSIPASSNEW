<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Departmentwiseapprovalstatus.aspx.cs"
    Inherits="UI_TSiPASS_Departmentwiseapprovalstatus" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server">Incentives Applications- Department Wise Status: </asp:Label>
                                ...
                                <a id="pdfPrint" href="#" onclick="javascript:return Panel1();"
                                    ...
                                    <img src="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/Resource/Images/pdf-printer-icon.jpg" alt="PDF" width="30px;" height="30px;"
                                        style="float: right;" /></a>
                                <a id="Button1" href="#" onserverclick="Button1_ServerClick3" runat="server">
                                        ...
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 100%">
                                            <tr>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:LinkButton CssClass="btn btn-link" ID="HyperLink1" runat="server"  OnClick="HyperLink1_Click"
                                                        Text="<< Back">
                                                    </asp:LinkButton>
                                                </td>


                                                <td style="padding: 5px; margin: 5px; width: 100px" align="center" runat="server" id="tdFromDate">From Date
                                                </td>
                                                <td>
                                                ...
                                                <td></td>
                                                <td style="padding: 5px; margin: 5px; width: 100px" runat="server" id="tdToDate">To Date
                                                </td>
                                                <td>
                                ...
                                <tr id="GridPrint" runat="server">
                                    <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                                        ...
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                            OnRowDataBound="grdDetails_RowDataBound" Width="100%" GridLines="Both"
                                            ShowFooter="True">
                                            <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                            <RowStyle Height="40px" />
                                            <%--CssClass="GridviewScrollC1Item"--%>
                                            <PagerStyle CssClass="GridviewScrollC1Pager" />
                                            <FooterStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1Footer" />
                                            <AlternatingRowStyle Height="40px" />
                                            <%--CssClass="GridviewScrollC1Item2"--%>
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Department ID"
                                                    DataTextField="Deptid">
                                                    <ItemStyle Font-Underline="false" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Department Name"
                                                ...
                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Total Applications"
                                                    DataTextField="TotalApplications">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>

                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Approved"
                                                    DataTextField="Approved">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>

                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Returned"
                                                    DataTextField="Returned">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                ...
                                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Pending"
                                                 ...
                                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Slc Approved"
                                                    DataTextField="SlcApproved">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
