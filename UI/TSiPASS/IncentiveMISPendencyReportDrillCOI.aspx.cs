...
public partial class UI_TSiPASS_IncentiveMISPendencyReportDrillCOI : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"].ToString() == "1213" || Session["uid"].ToString() == "1424" || Session["uid"].ToString() == "77141" || Session["uid"].ToString() == "34668" || Session["uid"].ToString() == "3377" || Session["uid"].ToString() == "21345")
        {
            if (!IsPostBack)
            {
    ...
    public void FillGridDetails()
    {
        ...
        ds = GetIncentivesMISPendingReportDrill(status, ddlDistrict.SelectedValue);
    ...
    public DataSet GetIncentivesMISPendingReportDrill(string status,string ddlDistrict)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("USP_GET_Incentives_MISPendencyReportDrillCOI", con.GetConnection);
            da.SelectCommand.Parameters.Add("@District", SqlDbType.VarChar).Value = ddlDistrict.ToString();
