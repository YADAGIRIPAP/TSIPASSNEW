<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="FrmCommissionerReportDrillDownCFO.aspx.cs" Inherits="UI_TSiPASS_FrmCommissionerReportDrillDownCFO" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeader" runat="server">TSiPASS- Abstract Report(CFO) </asp:Label>
