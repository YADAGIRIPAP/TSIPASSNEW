<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="KotakPageLEGAL.aspx.cs" Inherits="UI_TSiPASS_KotakPageLEGAL" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerLEGAL.aspx">
    <div id="myDIV">
        <center>
        ...
        <table id="Table1" width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerBMW.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmDepartmentApprovalDetailsLegal.aspx" />
                </td>
            </tr>
            <tr>
                <td>
