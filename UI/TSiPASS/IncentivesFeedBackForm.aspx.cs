...
public partial class UI_TSiPASS_IncentivesFeedBackForm : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        objvo.Feedbackfrom = "INC";

        if (objvo.Feedbackfrom == "INC")
        {
    ...
    {
        Response.Redirect("IncentivesFeedBackForm.aspx");
    }
}