...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTableOnEmployment_New(ddlType.SelectedValue);
       // lblMsg.Text = "";
...
//    } 
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "TableOnEmploymentDill2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Employment Range")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "TableOnEmploymentDill2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Employment Range")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "TableOnEmploymentDill2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Employment Range")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "TableOnEmploymentDill2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&Stage=%";
