<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="StageOfImplementationReportold2New.aspx.cs" Inherits="UI_TSiPASS_StageOfImplementationReportold2New" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        ...
                        <h2 class="panel-title" style="font-weight: bold;">
                            <%--<asp:Label ID="lblHeading" runat="server">R6.3: TSiPASS - Progress Of Implementation Report </asp:Label>--%>
                            <asp:Label ID="lblHeading" runat="server">R6.3 : Implementation status wise Abstract </asp:Label>
                                ...
                                <td>
                                    <table runat="server" id="tblselection" cellpadding="4" cellspacing="5">
                                        <tr>
                                            ...
                                            <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                <div class="input-group" id="year" runat="server" visible="false">
                                                    ...
                                                    <asp:DropDownList ID="ddlType" runat="server" class="form-control txtbox" Height="33px"
                                                        ...
                                                        <asp:ListItem Value="4">2014-15</asp:ListItem>
                                                        <asp:ListItem Value="2">2015-16</asp:ListItem>
                                                        <asp:ListItem Value="3">2016-17</asp:ListItem>
                                                        <asp:ListItem Value="5">2017-18</asp:ListItem>
                                                        <asp:ListItem Value="6">2018-19</asp:ListItem>
                                                        <asp:ListItem Value="7">2019-20</asp:ListItem>
                                                        <asp:ListItem Value="8">2020-21</asp:ListItem>
                                                        <asp:ListItem Value="9">2021-22</asp:ListItem>
                                                        <asp:ListItem Value="10">2022-23</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
            ...
            <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Progress" HeaderText="Progress"></asp:BoundField>
                        <asp:HyperLinkField FooterStyle-CssClass="text-center" ControlStyle-Font-Underline="false"
                             DataTextField="Number" HeaderText="No of Industries">
                            <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-right" />
                        ...
                        <asp:HyperLinkField FooterStyle-CssClass="text-center" DataTextField="Investment"
                            ControlStyle-Font-Underline="false" HeaderText="Investment (Rs. in Cr)">
                            <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-right" />
                            <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-right" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField FooterStyle-CssClass="text-center" DataTextField="Employment"
                            ControlStyle-Font-Underline="false"  HeaderText="Total Employment">
                            <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-right" />
                            <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-right" />
                        </asp:HyperLinkField>
                    </Columns>
