...
public partial class UI_TSiPASS_RptDrillingApplicationlistReport : System.Web.UI.Page
{
    Cls_DrillingRigs obj_insert = new Cls_DrillingRigs();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                lbl_headtitle.Text = "Drilling Rigs Applications-"+ Category + "-"+ DistrictName;
            }
            fillgrid(applicationtype, Districtid);
        }
    }

    public void fillgrid(string Typedataofappl, string Districtid)
    {


        DataSet vehicleDS = new DataSet();
        vehicleDS = obj_insert.DB_RptDrillingApplicationlist(Typedataofappl, Districtid);
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                this.fillgrid(applicationtype, Districtid);
