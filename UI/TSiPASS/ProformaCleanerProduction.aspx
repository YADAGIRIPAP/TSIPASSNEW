<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaCleanerProduction.aspx.cs" Inherits="UI_TSiPASS_ProformaCleanerProduction" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container" id="Receipt" runat="server" style="border: 3px solid #000000; text-align: center;">
            ...
            <asp:Label Font-Bold="true" Font-Size="12pt" ID="lblheadTPRIDE" runat="server"><h3 style="color: #0000FF;">GOVERNMENT OF TELANGANA <br /> DEPARTMENT OF INDUSTRIES</h3></asp:Label>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3"><span style="font-weight: bold">Sub :-  </span>
                    ...
                    Incentives Scheme – Claim application for Sanction of Reimbursement of Cleaner Production measures of
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">In the reference cited, 
                                ...
                                have applied for Reimbursement of Cleaner Production measures under 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">In this connection, i submit that the unit has been inspected by <asp:Label ID="lblInspectedOfficer" Font-Bold="true" runat="server"></asp:Label> on 
                                ...
                                <span style="font-weight: bold"><asp:Label ID="lblUdyogAadhaardate" runat="server"></asp:Label></span> for the
                                line of activity of <span style="font-weight: bold"><asp:Label ID="lblloa" runat="server"></asp:Label></span>
            ...
            <%--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px; display:none" >
                <span class="floatleft auto-style3">The eligible reimbursement of Seed Cap is calculated as under :- 
                        <asp:Label ID="lbl1st2nd1" runat="server"></asp:Label>&nbsp;  Half year of &nbsp;
                                <asp:Label ID="lblFinancialYear2" runat="server"></asp:Label>
                </span>
            </div>--%>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">The unit holder has paid for Cleaner Production measures an amount of Rs. &nbsp; <span style="font-weight: bold">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="tr1" runat="server" style="padding-top: 14px">
                <span class="floatleft auto-style3">The eligible reimbursement of Cleaner Production measures @ 25% = Rs. &nbsp; <span style="font-weight: bold">
                    <asp:Label ID="lblSTAmountPaid1" runat="server"></asp:Label></span>&nbsp; 
                </span>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">Therefore, I request the Commissioner of Industries, Telangana, Hyderabad kindly to consider the proposal of the captioned unit for sanction of 25% Reimbursement of Cleaner Production measures of Rs.
