...
public partial class UI_TSiPASS_TotalReport : System.Web.UI.Page
{
    decimal /*NumberTotal,*/ IndustriesApplied, IndustriesApproved,InvestmnetTotal, EmploymentTotal, ApprovedBeyond;
    #region Declaration
            ...
            if (Request.QueryString.Count > 0)
            {
                if (Request.QueryString["fromdate"] != null && Request.QueryString["fromdate"] != "" && Request.QueryString["todate"] != null && Request.QueryString["todate"] != "")
                {
                    ...
                    else if (districid != "%")
                    {
                        ...
                        //ddldistrict.SelectedItem.Value = Request.QueryString["Districtid"].ToString();
                        //ddldistrict.SelectedItem.Text= Request.QueryString["Districtname"].ToString();
                        //ddldistrict_SelectedIndexChanged(sender, e);
                        //ddldistrict.SelectedIndex = Convert.ToInt32(districid);
                    }
                }
            }
            else
    ...
    public void fillgrid()
    {
        ...
        if(valid == 0)
        {
            ...
            dsnew = Gen.Sp_DistApplDatewiseTotalAppl(FromdateforDB, TodateforDB, District);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.Sp_DistApplDatewiseTotalAppl(FromdateforDB, TodateforDB, ddldistrict.SelectedItem.Text).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            decimal IndustrialApplie = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Appliedwithinperiod"));
            IndustriesApplied = IndustrialApplie + IndustriesApplied;

            decimal IndustApprove = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Approvedwithinperiod"));
            IndustriesApproved = IndustApprove + IndustriesApproved;
            ...
            decimal BeyondData = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Approvedoutofperiod"));
            ApprovedBeyond = BeyondData + ApprovedBeyond;

            

            HyperLink h1 = (HyperLink)e.Row.Cells[2].Controls[0];

            h1.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Appliedwithinperiod"+ "&Districtid="+ distid; 

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];

            h2.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Approvedwithinperiod"+ "&Districtid="+ distid; 

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];

            h3.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Investment"+ "&Districtid="+ distid; 

            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];

            h4.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Employment"+ "&Districtid="+ distid; 

            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];

            h5.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Approvedoutofperiod"+ "&Districtid="+ distid; 
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + district + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Appliedwithinperiod";
            Total.Text = IndustriesApplied.ToString();
            e.Row.Cells[2].Text = IndustriesApplied.ToString();
            ...
            Approvedwithin.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + district + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&status=Approvedwithinperiod";
            Approvedwithin.Text = IndustriesApproved.ToString();
            e.Row.Cells[3].Text = IndustriesApproved.ToString();
            ...
            HyperLink Beyond = new HyperLink();
                ...
                Beyond.NavigateUrl = "TotalReportDrilldown.aspx?dist=" + district + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&status=Approvedoutofperiod";
                Beyond.Text = ApprovedBeyond.ToString();
                e.Row.Cells[6].Text = ApprovedBeyond.ToString();
    ...
    protected void Button2_ServerClick(object sender, EventArgs e)
    {
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=R6.10:TSiPASS-TotalReportold2NewReport" + ".pdf");
