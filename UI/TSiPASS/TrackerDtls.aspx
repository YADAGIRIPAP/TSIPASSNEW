<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TrackerDtls.aspx.cs" Inherits="UI_TSiPASS_TrackerDtls" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-6" style="width: 90%">
                    ...
                    <div class="form-group">
                        <table style="width: 100%">
                            ...
                            <tr id="trresponce2" runat="server">
                                ...
                                <td style="padding: 5px; margin: 5px; text-align: left;">Short fall Letter</td>
                            ...
                            <tr id="trsDraawingfalldoc" runat="server" visible="false">
                                <td style="padding: 5px; margin: 5px; text-align: left;">Drawing Short fall</td>
                                <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                            ...
                            <tr id="Trqueryresponceattachemnts" runat="server" visible="false">
                                <td style="padding: 10px; margin: 5px;" colspan="8">
                                    <asp:GridView ID="gvqueryresponse" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvqueryresponse_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Response Documents" HeaderStyle-VerticalAlign="Middle">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="HyperLinkSubsidy" Text='<%#Eval("Name")%>' NavigateUrl='<%#Eval("Linknew")%>' Target="_blank" runat="server" />
                                                </ItemTemplate>
            ...
            <div class="panel panel-default" id="trrejectionDtls" runat="server" visible="false">
                <div class="panel-heading">
                    Rejection Details
                    ...
                    <div class="form-group">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px; width: 218px;" id="td8" runat="server" align="left" valign="top">
                                    <asp:Label ID="lblDepartmentName" runat="server" Text="Label"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="width: 147px; padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">2). Rejected Date</td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="td9" runat="server" align="left" valign="top">
                                    <asp:Label ID="lblRejectedDate" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">3). Rejection Remarks</td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="td10" runat="server" colspan="5" align="left" valign="top">
                                    <asp:Label ID="lblRejectionRemarks" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                            <tr id="tr6" runat="server">
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">4). Appeal Remarks </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                               <td style="padding: 5px; margin: 5px" id="td1" runat="server" colspan="5" align="left" valign="top">
                                    <asp:Label ID="lblAppeal" runat="server" Text="Label"></asp:Label>
                                </td>
                                
                               
                            </tr>
                            <tr id="tr7" runat="server">
                                <td style="padding: 5px; margin: 5px; font-weight: bold; height: 35px;" align="left" valign="top">5). Appeal Date</td>
                                <td style="width: 3px; padding: 5px; margin: 5px; height: 35px;" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px; height: 35px;" id="td13" runat="server" colspan="5" align="left" valign="top">
                                    <asp:Label ID="lblAppealDate" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                                <tr id="tr8" runat="server" visible="false">
                                <td style="padding: 5px; margin: 5px; text-align: left;">Rejection Letter</td>
                                <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                <td class="style6" style="padding: 5px; margin: 5px; text-align: left; width: 218px;">
                                    <asp:HyperLink ID="hplRejection" runat="server" ForeColor="#FF6600" Target="_blank">[HyperLink1]</asp:HyperLink>
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;</td>
                            </tr>
                            ...
                            <tr id="Tr10" runat="server" visible="false">
                                <td style="padding: 10px; margin: 5px;" colspan="8">
                                    ...
                                    <table cellpadding="5px" cellspacing="5px" width="100%">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; font-weight: bold; height: 35px; width: 157px;" align="left" valign="top">Appeal Attachments</td>
                                        </tr>
                                        <tr>
                                            <td  style="border: 1px solid #003366; font-weight: bold; width: 157px;">
                                                S.No
                                            </td>
                    ...
                    <div class="form-group">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="width: 180px; padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">2). Rejected Date 
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                    ...
                    <div class="form-group">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="width: 250px; padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">2). Approval Applied Date 
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdtpscdate" runat="server" align="left" valign="top"></td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">4). Pre-scrutiny date  
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdpscdate" runat="server"  align="left" valign="top"></td>
                            </tr>
                           <tr>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">5). No. of days taken for Pre-scrutiny  
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tddaystakenpsc" runat="server" align="left" valign="top"></td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">6). Pre-scrutiny days  
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="td2" runat="server"  align="left" valign="top" >3</td>
                            </tr>
                             <tr>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">7). Date Received to Approval Stage   
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdReceivedApproval" runat="server" align="left" valign="top"></td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">8). Target Date to Send MAUD 
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdSendMAUDTarget" runat="server"  align="left" valign="top" ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdDateofSenttoMAUD" runat="server" align="left" valign="top"></td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">10). No. of Days Taken (Sent to MAUD) 
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdDaysTaken" runat="server"  align="left" valign="top" ></td>
                            </tr>
                            <tr runat="server" id="trmauddata1" visible="false">
                                <td style="padding: 5px; margin: 5px; font-weight: bold; font-size:14pt"  align="left" valign="top" colspan="4">
                                  -->  MA & UD Info
                                </td>
                            </tr>
                            <tr runat="server" id="trmauddata" visible="false">
                                ...
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdTargetDateforApprovalmaud" runat="server"  align="left" valign="top"></td>
                                <td style="padding: 5px; margin: 5px; width: 30px"></td>
                                <td style="padding: 5px; margin: 5px; font-weight: bold" align="left" valign="top">12). Actual Approval Date
                                </td>
                                <td style="width: 3px; padding: 5px; margin: 5px" align="left" valign="top">: </td>
                                <td style="padding: 5px; margin: 5px" id="tdActualApprovaldate" runat="server"   align="left" valign="top" ></td>
                            </tr>
