<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmProcessADMGappl.aspx.cs" Inherits="UI_TSiPASS_frmProcessADMGappl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            <td style="padding: 5px; margin: 5px" valign="top">
                <asp:Label ID="Label4" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="278px">Processing of ADM&G Appliction<font 
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="ADM_G_MineralID" HeaderText="Application ID" />
                                                            <asp:BoundField DataField="NameoftheMineral" HeaderText="Name of the Mineral" />
                                                            <asp:BoundField DataField="ExtentinHectors" HeaderText="Extent in Hectors" />
                                                            <asp:BoundField DataField="District" HeaderText="District" />
                                                            <asp:BoundField DataField="mandal" HeaderText="Mandal" />
                                                            <asp:BoundField DataField="village" HeaderText="Village" />
                                                            <asp:BoundField DataField="MineralSurveyNo" HeaderText="Survey No." />
    ...
    <table>
        <tr>
            <td style="padding: 5px; margin: 5px" valign="top">
                <asp:Label ID="Label10" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="278px">To Process above ADM&G Appliction<font 
                                                            color="red">*</font></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                <table cellpadding="4" cellspacing="5" style="width: 100%; text-align: left;">
                    ...
                    <tr id="trNOC" Visible="false" runat="server">
                        <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style1">2. </td>
                        <td style="padding: 5px; margin: 5px; text-align: left;">
                            <asp:Label ID="Label3" runat="server" CssClass="LBLBLACK" data-balloon="Self Certification Form" 
                                data-balloon-length="large" data-balloon-pos="down" style="left: 0px; top: 10px; width: 265px">If you want to Approve Please Upload NOC.<font 
                                                            color="red">*</font></asp:Label>
                        </td>
                        <td style="padding: 5px; margin: 5px">: </td>
                        <td class="style6" style="padding: 5px; margin: 5px; text-align: left; width: 350px">
                    ...
                    <tr id="trDGPS" visible="false" runat="server">
                        ...
                        <td style="padding: 5px; margin: 5px; text-align: left;">
                            <asp:Label ID="Label23" runat="server" CssClass="LBLBLACK" data-balloon="Self Certification Form" data-balloon-length="large" data-balloon-pos="down" style="left: 0px; top: 10px; width: 244px">Please Upload Signed Copy of DGPS Map<font 
                                                            color="red">*</font></asp:Label>
                        </td>
                        <td style="padding: 5px; margin: 5px">: </td>
                        <td class="style6" style="padding: 5px; margin: 5px; text-align: left; width: 350px">
