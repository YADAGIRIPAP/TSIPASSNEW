<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ClusterReport.aspx.cs" Inherits="UI_TSiPASS_ClusterReport" %>
                                            ...
                                            <td>
                                                <table style="vertical-align: top; text-align: center;" cellpadding="0" cellspacing="0" width="90%">
                                                        ...
                                                        <td align="center" style="padding: 5px; vertical-align: top; text-align: center">
                                                            <asp:GridView ID="gvDistrictData" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" OnRowCommand="gvDistrictData_RowCommand" Width="90%">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="COUNT" HeaderText="No. of Clusters">
                                                    ...
                                                    <tr runat="server" id="trMandalData" visible="false">
                                                        <td align="center" style="padding: 5px; vertical-align: top; text-align: center">
                                                            <asp:GridView ID="gvMandalCount" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" OnRowCommand="gvMandalCount_RowCommand" Width="90%">
                                                                <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <FooterStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                                                <RowStyle Height="40px" CssClass="GridviewScrollC1Item" HorizontalAlign="Left" />
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Sl. No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="srn0" runat="server" Text='<%#Container.DataItemIndex + 1 %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="center" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Mandal Name">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lbtnMandal" runat="server" CommandArgument='<%# Eval("Mandal_Cd") %>'
                                                                                CommandName="MANDAL" Text='<%# Eval("Manda_lName") %>'></asp:LinkButton>
                                                                            <asp:Label ID="lblMandalName" Text='<%# Eval("Manda_lName") %>' Visible="false" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="COUNT" HeaderText="No. of Clusters">
                                                    ...
                                                    <tr runat="server" id="trVillageData" visible="false">
                                                        <td align="center" style="padding: 5px; vertical-align: top; text-align: center">
                                                            <asp:GridView ID="gvVillageData" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" OnRowCommand="gvVillageData_RowCommand" Width="90%">
                                                                <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <FooterStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Village Name">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lbtnVillage" runat="server" CommandArgument='<%# Eval("Village_Cd") %>'
                                                                                CommandName="VILLAGE" Text='<%# Eval("Village_Name") %>'></asp:LinkButton>
                                                                            <asp:Label ID="Label2" Text='<%# Eval("Village_Name") %>' Visible="false" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="COUNT" HeaderText="No. of Clusters">
                                                            ...
                                                            <asp:GridView ID="gvCluster" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" OnRowCommand="gvCluster_RowCommand" Width="100%">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Edit">
                                                                        <ItemTemplate>
                                                                            <%-- <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%# Eval("Cluster_Id") %>'
                                                                                CommandName="ALTER" Text="Edit" href="frmClusterInformation.aspx" ></asp:LinkButton>--%>
                                                                            <asp:HyperLink ID="lbtnEdit" runat="server" CommandArgument='<%# Eval("Cluster_Id") %>'
                                                                                CommandName="ALTER" Text="Edit" NavigateUrl='<%# "frmClusterInformation.aspx?ClusterID="+Eval("Cluster_Id") %>' Target="_blank"></asp:HyperLink>
                                                                            <%--<a href="frmClusterInformation.aspx"  height="32px" tabindex="11" target="_blank">Edit</a>--%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                </Columns>
