...
public partial class UI_TSiPASS_TableOnEmploymentDill2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchEmploymentwiseDrildownNew(ddlType.SelectedValue, Request.QueryString[2].ToString().Trim(), FromdateforDB, TodateforDB);
        // lblMsg.Text = "";
        if (dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            {
                lblHeader.Text = "Employment Potential Abstract";
            }
            else
            {
                lblHeader.Text = "Employment Potential Abstract - " + Request.QueryString[2].ToString().Trim();
            }
        }
        else
        {
