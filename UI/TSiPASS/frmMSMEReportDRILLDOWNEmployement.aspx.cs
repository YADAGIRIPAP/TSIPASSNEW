...
public partial class UI_TSiPASS_frmMSMEReportDRILLDOWNEmployement : System.Web.UI.Page
{
    ...
    void FillDetails()
    {
        try
        {
            ...
            DataSet ds = GetMSMEApplicationsDrill(FromdateforDB, TodateforDB, district, rolecode, Request.QueryString["type"].ToString().Trim());
    ...
    public DataSet GetMSMEApplicationsDrill(string fromdate, string todate, string district, string rolecode, string drillDowntype)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_MSME_EMPLOYEEMENT_REPORT_DRILLDOWN", pp);
        return Dsnew;
    }
