...
public partial class UI_TSiPASS_UpdateCheckClearenceNew : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("UpdateCheckChearenceDateALL.aspx?checkNo=" + txtcheckno.Text.Trim()+"&MstIncentiveId="+lblMstIncentiveId);
    ...
    protected void txtcheckno_TextChanged(object sender, EventArgs e)
    {
        ...
        pp[0].Value = txtcheckno.Text.Trim();
       



        ds = gen.GenericFillDs("USP_GET_LIST_INCENTIVEWISE_CHECKCLEARENCE_ABSTRACT_NEW", pp);//USP_GET_UNIT_INCENTIVEWISE_CheckClearence_new
