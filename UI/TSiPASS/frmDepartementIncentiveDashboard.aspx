<%@ Page Title=":: TSiPASS : Works wise Report " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartementIncentiveDashboard.aspx.cs" Inherits="Dashboard" %>
                            ...
                            <div class="panel-body" align="center">
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                     ...
                                     <a href="IncentiveStatusDetails.aspx?Stg=99" class="list-group-item">
                                        <span class="badge"  style=" background-color:#d9534f;">
                                    ...
                                    <a class="list-group-item" href="IncentiveStatusDetails.aspx?Stg=4"><span class="badge" >
                                        ...
                                        <div class="list-group">
                                             ...
                                             <a class="list-group-item" ><i class="fa fa-fw fa-check"></i>Inspection report not uploaded </a>
                                                ...
                                                <a class="list-group-item" href="IncentiveStatusDetails.aspx?Stg=8"><span class="badge" style=" background-color:#d9534f;">
                                 ...
                                 <table runat="server" id="trGmDashboard" cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                         <td style="width: 395px" valign="top">
                                             <div class="list-group">
                                                 <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=1">
                                                 <span class="badge">
                                                 <asp:Label ID="Label6" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>Assigned to GM</a>
                                                    <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=3">
                                                 <span class="badge">
                                                 <asp:Label ID="Label4" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>Inspection yet to be scheduled </a>
                                                 <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=4">
                                                 <span class="badge">
                                                 <asp:Label ID="Label10" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>Inspection scheduled </a>
                                                 <a class="list-group-item"><i class="fa fa-fw fa-check"></i>Inspection report 
                                                 uploaded</a> <a class="list-group-item" 
                                                      href="IncentiveStatusInspectionDateDetails.aspx?Stg=4"><span class="badge">
                                                 <asp:Label ID="Label13" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>With in 48 hrs </a>
                                                 <a class="list-group-item" 
                                                     href="IncentiveStatusInspectionDateDetails.aspx?Stg=5"><span class="badge" 
                                         ...
                                         <td style="width: 395px" valign="top">
                                             <div class="list-group">
                                                 ...
                                                 not uploaded </a><a class="list-group-item" 
                                                     href="IncentiveStatusInspectionUploadDetails.aspx?Stg=6"><span class="badge">
                                                 <asp:Label ID="Label20" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>With in 48 hrs </a>
                                                 <a class="list-group-item" href="IncentiveStatusInspectionUploadDetails.aspx?Stg=7">
                                                 <span class="badge" style=" background-color:#d9534f;">
                                                 <asp:Label ID="Label21" runat="server"></asp:Label>
                                                 </span><i class="fa fa-fw fa-calendar"></i>Beyond 48 hrs </a>
