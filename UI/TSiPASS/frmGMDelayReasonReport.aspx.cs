...
public partial class UI_TSiPASS_frmGMDelayReasonReport : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h8.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=2";


            HyperLink h1 = (HyperLink)e.Row.FindControl("HyNOOFDELAYAPP");
            h1.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=3";
            ...
            H4.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=5";

            HyperLink h5 = (HyperLink)e.Row.FindControl("HyNOOFSHOWCAUSEREPLIED");
            h5.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=6";


            HyperLink h2 = (HyperLink)e.Row.FindControl("HyNOOFDELAYPENDING");
            h2.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=7";

            HyperLink h6 = (HyperLink)e.Row.FindControl("HyNOOFSHOWCAUSENOTREPLIED");
            h6.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=8";
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=1";
            //withintotal.ForeColor = System.Drawing.Color.White;

            HyperLink beyondtotal = new HyperLink();
            beyondtotal.Text = beyond.ToString();
            e.Row.Cells[2].Text = beyond.ToString();
            e.Row.Cells[2].Controls.Add(beyondtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            beyondtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=2";
            ...
            e.Row.Cells[3].Text = totalexplaination.ToString();
            e.Row.Cells[3].Controls.Add(totalexplainationtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            totalexplainationtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=3";
            ...
            e.Row.Cells[4].Text = explainationaccepted.ToString();
            e.Row.Cells[4].Controls.Add(explainationacceptedtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            explainationacceptedtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=4";
            ...
            e.Row.Cells[5].Text = explainationnotaccepted.ToString();
            e.Row.Cells[5].Controls.Add(explainationnotacceptedtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            explainationnotacceptedtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=5";
            ...
            e.Row.Cells[7].Text = showcausereplied.ToString();
            e.Row.Cells[7].Controls.Add(showcauserepliedtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            showcauserepliedtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=6";
            ...
            e.Row.Cells[6].Text = pendingataddl.ToString();
            e.Row.Cells[6].Controls.Add(pendingataddltotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            pendingataddltotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=7";
            ...
            e.Row.Cells[8].Text = pendingatgm.ToString();
            e.Row.Cells[8].Controls.Add(pendingatgmtotal);
            //withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
            pendingatgmtotal.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=ALL" + "&StatusFlag=8";
            ...
            //e.Row.Cells[10].Text = explanationgiven.ToString();
            //e.Row.Cells[10].Controls.Add(explanationgiventotal);
            ////withintotal.NavigateUrl = "frmGMDelayResonseDrillDownCOI.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&StatusFlag=1";
    ...
    //        HyperLink h1 = (HyperLink)e.Row.FindControl("HyNOOFDELAYAPP");
    //        h1.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=ALL";


    //        HyperLink h8 = (HyperLink)e.Row.FindControl("HyNOOFBEYONDTIMELIMITS");
    //        h8.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=B";

    //        HyperLink h2 = (HyperLink)e.Row.FindControl("HyNOOFDELAYPENDING");
    //        h2.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=P";

    //        HyperLink h3 = (HyperLink)e.Row.FindControl("HyNODELAYRESONACCEPTED");
    //        h3.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=Y";

    //        HyperLink H4 = (HyperLink)e.Row.FindControl("HyNODELAYREASONNOTACCEPTED");
    //        H4.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=N";

    //        HyperLink h5 = (HyperLink)e.Row.FindControl("HyNOOFSHOWCAUSEREPLIED");
    //        h5.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=N" + "&SCREPLIED=Y";

    //        HyperLink h6 = (HyperLink)e.Row.FindControl("HyNOOFSHOWCAUSENOTREPLIED");
    //        h6.NavigateUrl = "frmGMDelayResonseDrillDown.aspx?district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&NOOFDELAYAPP=N" + "&SCREPLIED=N";
    ...
    public DataSet GetGMDelayApplications(string fromdate, string todate, string districtid, string designation)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_GMEXPLAINATION_DETAILS", pp);
        return Dsnew;
    }
}