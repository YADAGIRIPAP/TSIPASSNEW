<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="UpdateCheckClearence.aspx.cs" Inherits="UI_TSiPASS_UpdateCheckClearence" %>
                                                ...
                                                <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                                    ...
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                        ...
                                                        <tr id="trCheckblock" runat="server" visible="false">
                                                            ...
                                                            <td style="padding: 15px; margin: 5px;">
                                                                <asp:Button ID="Button2" Visible="false" CssClass="btn btn-primary" runat="server" Text="Get Working List"
                                                                    Width="150px" OnClick="Button2_Click" />
                                                            </td>
                                                        </tr>
