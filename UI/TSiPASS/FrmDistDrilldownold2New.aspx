<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="FrmDistDrilldownold2New.aspx.cs" Inherits="UI_TSiPASS_FrmDistDrilldownold2New"  EnableEventValidation="False" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeader" runat="server">R6.1: TGiPASS- District Wise Report </asp:Label>
