<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RPT_GroundwaterDistrictMandalwise.aspx.cs" Inherits="UI_TSiPASS_RPT_GroundwaterDistrictMandalwise" %>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading" align="center">
                <h2 class="panel-title" style="font-weight: bold;">Ground Water Mandal wise Report
                        ...
                        <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint" runat="server">
                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Mandal"
                                        ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%--MandalID--%>
                                            <%#Eval("Mandal") %>
