...
public partial class UI_TSiPASS_frmCommissionerReportDashboardCFO : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalDistrictwise_New_NewCommissionerCFO(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text, ddlsector.SelectedValue, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue, ddlSector_Ent.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            //    TodateforDB = Convert.ToString(DateTime.ParseExact(txtTodate.Text, "dd-MM-yyyy", null).ToString("MM-dd-yyyy"));
            //}
            dsChartData = Gen.FetchTotalDistrictwise_New_NewCommissionerCFO(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text, ddlsector.SelectedValue, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue, ddlSector_Ent.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmCommissionerReportDrillDownCFO.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString() + "&ddlinsutrytype=" + ddlSector_Ent.SelectedValue.ToString(); 
