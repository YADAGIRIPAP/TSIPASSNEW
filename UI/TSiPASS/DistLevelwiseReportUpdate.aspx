<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="DistLevelwiseReportUpdate.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            District level Report<a id="A2" href="#" onserverclick="BtnSave2_Click1" runat="server">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 80%">
                            ...
                            <tr>
                                <td align="left" style="padding: 5px; margin: 5px; text-align: left;">
                                    <b>Note : DIC has to upload Undertaking form from the unit holder, describe that they
                                                    ...
                                                    <table style="width: 100%" cellpadding="4" cellspacing="5">
                                                        ...
                                                        <tr>
                                                            <td style="width: 132px; height: 29px">
                                                                ...
                                                                <asp:TextBox ID="txtreasonschange" TextMode="MultiLine" Height="80px" Width="180px"
