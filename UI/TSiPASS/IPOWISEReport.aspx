<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="~/UI/TSiPASS/IPOWISEReport.aspx.cs" Inherits="TSTBDCReg1" %>
                                        ...
                                        <td align="left" style="padding: 5px; margin: 5px; text-align: left;" 
                                            ...
                                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:HyperLinkField DataTextField="Dept_Name" HeaderText="IPO Name" />
                                                    ...
                                                    <asp:HyperLinkField DataTextField="IndustryCatelogCompleted" 
                                                        HeaderText="Completed" />
                                                          <asp:HyperLinkField DataTextField="IndustryCatelogCompleted" 
                                                        HeaderText="Status" Visible="False" />
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" 
                                                                       ...
                                                                       Width="180px" onselectedindexchanged="ddlStatus_SelectedIndexChanged">
                                                                        <asp:ListItem>--Select--</asp:ListItem>
                                                                        <asp:ListItem Value="Approved with Justification">Approved with Justification</asp:ListItem>
