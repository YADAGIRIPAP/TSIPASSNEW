...
public partial class UI_TSiPASS_frmDistrictWisePollutionCategorylReportCFO : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "R" + "&district=" + district;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "O" + "&district=" + district;
            }

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "G" + "&district=" + district;
            }

            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "W" + "&district=" + district;
            }

            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "T" + "&district=" + district;
            }

            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "T" + "&district=" + district;
            }

            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "frmDistrictWisePollutionCategorylReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlpolcategory=" + "T" + "&district=" + district;
            }
    ...
    public DataSet GetDistrictWisePollutionCategory(string fromdate, string todate, string districtid, string financialcd)
    {
        ...
        //USP_GET_DISTRICTREPORT_POLLUTIONCATEGORY
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_POLLUTIONCATEGORY_CFO", pp);
        return Dsnew;
    }
