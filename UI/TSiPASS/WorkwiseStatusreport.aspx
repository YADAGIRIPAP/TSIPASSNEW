<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="WorkwiseStatusreport.aspx.cs" Inherits="WorkwiseStatusreport" Title=":: TSiPASS Online Management System ::" %>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="TotalWorkProposed" HeaderText="Total Work Proposed" />
                                            ...
                                            <asp:BoundField DataField="TotalFemaleBeneficiaries" HeaderText="Total Female Beneficiaries" />
