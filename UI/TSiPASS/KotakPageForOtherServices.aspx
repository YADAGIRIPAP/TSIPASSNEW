<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPageForOtherServices.aspx.cs" Inherits="UI_TSiPASS_KotakPageForOtherServices" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerOtherServices.aspx">
        <div id="myDIV">
            ...
            <table width="50%" height="100" border='1' align="center" runat="server" visible="true" style="display: none">
                <tr>
...
<%--                    <td>
                ...
                <tr>
                    <td>Merchant Id	:</td>
                    <td>
                        <input type="text" name="merchant_id" id="merchant_id" runat="server" /></td>
                </tr>
                <tr>
                    <td>Order Id	:</td>
                    <td>
                        <input type="text" name="order_id" id="order_id" runat="server" /></td>
                </tr>
                <tr>
                    <td>Amount	:</td>
                    <td>
                        <input type="text" name="amount" id="amount" runat="server" /></td>
                </tr>
                <tr>
                    <td>Currency	:</td>
                    <td>
                ...
                <tr>
                    <td>Redirect URL	:</td>
                    <td>
                        <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerOtherServices.aspx" /></td>
                </tr>
                <tr>
                    <td>Cancel URL	:</td>
                    <td>
                        <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmOtherServicesDepartmentApprovalPaymentDetails.aspx.aspx" /></td>
                </tr>
                <tr>
                    <td>Language	:</td>
                    <td>
                        <input type="text" name="language" value="EN" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Billing Name	:</td>
                    <td>
                        <input type="text" name="billing_name" id="billingname" runat="server"/></td>
                </tr>
                <tr>
                    <td>Billing Address	:</td>
                    <td>
                        <input type="text" name="billing_address" id="billingaddress" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing City	:</td>
                    <td>
                        <input type="text" name="billing_city" id="billingcity" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing State	:</td>
                    <td>
                        <input type="text" name="billing_state" id="billingstate" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Zip	:</td>
                    <td>
                        <input type="text" name="billing_zip" id="billingzip" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Country	:</td>
                    <td>
                        <input type="text" name="billing_country" id="billingcountry" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Tel	:</td>
                    <td>
                        <input type="text" name="billing_tel" id="billingtel" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Email	:</td>
                    <td>
                        <input type="text" name="billing_email" id="billingemail" runat="server" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Shipping Name	:</td>
                    <td>
                        <input type="text" name="delivery_name" value="" /></td>
                </tr>
                <tr>
                    <td>Shipping Address	:</td>
                    <td>
                        <input type="text" name="delivery_address" value="" /></td>
                </tr>
                <tr>
                    <td>shipping City	:</td>
                    <td>
                        <input type="text" name="delivery_city" value="" /></td>
                </tr>
                <tr>
                    <td>shipping State	:</td>
                    <td>
                        <input type="text" name="delivery_state" value="" /></td>
                </tr>
                <tr>
                    <td>shipping Zip	:</td>
                    <td>
                        <input type="text" name="delivery_zip" value="" /></td>
                </tr>
                <tr>
                    <td>shipping Country	:</td>
                    <td>
                        <input type="text" name="delivery_country" value="" /></td>
                </tr>
                <tr>
                    <td>Shipping Tel	:</td>
                    <td>
                        <input type="text" name="delivery_tel" value="" /></td>
                </tr>
                <tr>
                    <td>Merchant Param1	:</td>
                    <td>
                        <input type="text" name="merchant_param1" id="merchant_param1" runat="server" /></td>
                </tr>
                <tr>
                    <td>Merchant Param2	:</td>
                    <td>
                        <input type="text" name="merchant_param2" id="merchant_param2" runat="server" /></td>
                </tr>
                <tr>
                    <td>Merchant Param3	:</td>
                    <td>
                        <input type="text" name="merchant_param3" id="merchant_param3" runat="server" /></td>
                </tr>
                <tr>
                    <td>Merchant Param4	:</td>
                    <td>
                        <input type="text" name="merchant_param4" id="merchant_param4" runat="server" /></td>
                </tr>
                <tr>
                    <td>Merchant Param5	:</td>
                    <td>
                        <input type="text" name="merchant_param5" id="merchant_param5" runat="server" /></td>
                </tr>
                ...
                <tr style="display: none">
                    <td>Card Type: </td>
                    <td>
                        <input type="text" id="card_type" name="card_type" value="" readonly="readonly" /></td>
                </tr>
                ...
                <tr style="display: none">
                    ...
                    <td>
                        <input type="text" id="data_accept" name="data_accept" readonly="readonly" /></td>
                </tr>

                <tr style="display: none">
                    <td>Card Number: </td>
                    <td>
                        <input type="text" id="card_number" name="card_number" value="" />e.g. 4111111111111111 </td>
                </tr>
                <tr style="display: none">
                    <td>Expiry Month: </td>
                    <td>
                        <input type="text" name="expiry_month" value="" />e.g. 07 </td>
                </tr>
                <tr style="display: none">
                    <td>Expiry Year: </td>
                    <td>
                        <input type="text" name="expiry_year" value="" />e.g. 2027</td>
                </tr>
                <tr style="display: none">
                    <td>CVV Number:</td>
                    <td>
                        <input type="text" name="cvv_number" value="" />e.g. 328</td>
                </tr>
                <tr style="display: none">
                    <td>Issuing Bank:</td>
                    <td>
                        <input type="text" name="issuing_bank" value="" />e.g. State Bank Of India</td>
                </tr>
                <tr style="display: none">
                    <td>Mobile Number:</td>
                    <td>
                        <input type="text" name="mobile_number" value="" />e.g. 9770707070</td>
                </tr>
                <tr style="display: none">
                    <td>MMID:</td>
                    <td>
                        <input type="text" name="mm_id" value="" />e.g. 1234567</td>
                </tr>
                <tr style="display: none">
                    <td>OTP:</td>
                    <td>
                        <input type="text" name="otp" value="" />e.g. 123456</td>
                </tr>
                <tr style="display: none">
                    <td>Promotions:</td>
                    <td>
