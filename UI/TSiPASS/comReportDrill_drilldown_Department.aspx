<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="comReportDrill_drilldown_Department.aspx.cs" Inherits="UI_TSiPASS_comReportDrill_drilldown_Department"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="divPrint" runat="server" border="0" cellpadding="10" cellspacing="5" style="width: 100%">
                            <tr>
                                <td>
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/comRepDrill_dist.aspx"
                                        Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                                <td>
