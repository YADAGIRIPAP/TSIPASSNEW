<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="CentralInspectionMisreport.aspx.cs" Inherits="UI_TSiPASS_CentralInspectionMisreport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <div align="left">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><i ></i>Central Inspection MIS Report</li>
                                </ol>
                            </div>
    <div align="center">
                                ...
                                <td>
                                    <table style="vertical-align: top; text-align: center;" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr style="height: 35px" id="trdate" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: right;" class="auto-style1">
                                                <strong>Schedule Generation Date:</strong> <strong><asp:Label ForeColor="Black" Font-Bold="true" ID="lbldate" runat="server" Visible="true"></asp:Label></strong></td>
                                            ...
                                            <td>
                                                <table style="vertical-align: top; text-align: center;" cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <td align="center" style="padding: 5px; vertical-align: top; text-align: center">
                                                            <asp:GridView ID="gvCluster" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" Width="100%" OnRowCommand="gvCluster_RowCommand">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Scheduled Notice" Visible="false">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="UPLOADWITHIN24HRS" HeaderText="Inspection Uploaded Within 48hours"  Visible="false">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="left" />
                                                                    </asp:BoundField>

                                                                    <asp:TemplateField HeaderText="Inspection Report" Visible="false">
                                                                        <ItemTemplate>
                                                    ...
                                                    <tr runat="server" id="trjoint" visible="false">
                                                        <td align="center" style="padding: 5px; vertical-align: top; text-align: center">
                                                            <asp:GridView ID="grdjoint" runat="server" AutoGenerateColumns="False" border="3" CellPadding="1" CellSpacing="1" Width="100%" OnRowCommand="grdjoint_RowCommand">
                                                                <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <FooterStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                                                <RowStyle Height="40px" CssClass="GridviewScrollC1Item" HorizontalAlign="Left" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="UPLOADWITHIN24HRS" HeaderText="Inspection Uploaded Within 48hours">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="left" />
                                                                    </asp:BoundField>

                                                                    <asp:TemplateField HeaderText="Labour Inspection Report" Visible="false">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Factory Inspection Report" Visible="false">
                                                                        <ItemTemplate>
                                        ...
                                        <td colspan="6" align="center" style="padding: 5px; margin: 5px">
                                            <div id="DIVUPDATEDDATE" runat="server" >
