...
public partial class UI_TSiPASS_COIVERIFIED_NOTVERIFIED_DELETEDRECORDS : System.Web.UI.Page
{
    General gen = new General();
    DB.DB con = new DB.DB();
    decimal  InvestmnetTotal, EmploymentTotal;
    ...
    protected void Getlist_Click(object sender, EventArgs e)
    {
        ...
        if (ddltype.SelectedValue == "" || ddltype.SelectedValue == null|| ddltype.SelectedValue =="0"|| ddltype.SelectedItem.Text == "--Select--")
        {
            Label2.Text += "<br/> Please Select type";
            valid = 1;
        }
        ...
        if (valid == 0)
        {
            ...
            pp[2].Value = ddltype.SelectedValue;
            DataSet ds2 = new DataSet();
            ds2 = gen.GenericFillDs("SP_GET_NOTVERIFIED_VERIFIED_DELETEDRECORDS", pp);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            decimal InvestmnetTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "InvestmentNEW"));
            InvestmnetTotal = InvestmnetTotal1 + InvestmnetTotal;


            decimal EmploymentTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "NoofEmployee"));
