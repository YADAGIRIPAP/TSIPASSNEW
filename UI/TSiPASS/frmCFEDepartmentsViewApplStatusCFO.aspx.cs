...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  dsn = Gen.GetShowDepartmentFiles("15", "3", "5");
            ...
            ds = Gen.GetRespondQueryStatusCFO(Session["uid"].ToString());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            string approvalid = "", createdby = "", Commondetatilsupdated="";
            ...
            else
            {
                ...
                h1.NavigateUrl = "frmResponceQueriesCFO.aspx?intApplicationid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intQueryTrnsid")).Trim();
            }
        }
