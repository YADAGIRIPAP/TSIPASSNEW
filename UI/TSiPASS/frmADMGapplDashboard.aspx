<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmADMGapplDashboard.aspx.cs" Inherits="UI_TSiPASS_frmADMGapplDashboard" %>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">&nbsp; ADM&G Department Dashboard</h3>
                            </div>
                                    ...
                                    <tr>
                                        <td style="font-size: 16px; text-align: center;" colspan="3" >
                                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Small" 
                                                NavigateUrl="~/UI/TSiPASS/ADMandGDashboard.aspx">Back</asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 468px; font-size: 16px;">
                                            <b>Consent for ADM&G APPLICATIONS</b></td>
                                        <td style="width: 30px">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td style="width: 468px" valign="top">
                                             <div class="list-group">
                                              ...
                                              <a href="frmADMGmandalwiseView.aspx?Stg=3" class="list-group-item">
                                        <span class="badge">
                                            <asp:Label ID="lblTotAppl" runat="server"></asp:Label></span>
                                        <i class="fa fa-fw fa-calendar"></i> No of Total Applications&nbsp;
                                    </a>
                                             </a>
                                                 <a class="list-group-item" href="frmADMGmandalwiseView.aspx?Stg=12"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="LblPendng" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> No of Appliactions pending </a>

                                                 <a class="list-group-item" href="frmADMGmandalwiseView.aspx?Stg=13"><span class="badge">
                                                <asp:Label ID="lblApproved" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> No of Applications Approved </a>

                                                  
                                                
                                                 <a class="list-group-item" href="frmADMGmandalwiseView.aspx?Stg=16"><span class="badge" style=" background-color:#d9534f;">
