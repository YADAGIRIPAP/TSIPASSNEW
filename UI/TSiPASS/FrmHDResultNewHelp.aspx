<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/webmasterpage.master" AutoEventWireup="true" CodeFile="FrmHDResultNewHelp.aspx.cs" Inherits="FrmUsers" Title=":: TSiPASS TSiPASS ::  Result" %>
                  ...
                  <%--  <tr>
                     ...
                     <tr>
                        <td colspan="3" 
                             ...
                             align="center">
                         <a href="Home.aspx" target="_self" style="color: blue">Click Here to Home</a></td>
                    </tr>
                </table>
</div>
</asp:Content>
