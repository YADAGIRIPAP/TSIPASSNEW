<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmMSMEedit_MSMESURVEY.aspx.cs" Inherits="UI_TSiPASS_frmMSMEedit_MSMESURVEY" %>
                    ...
                    <div class="col-lg-11">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtUnitName" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="100" onkeypress="Names()" TabIndex="1" ValidationGroup="group"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Is Unit Registered <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rdUnitRegistered" RepeatDirection="Horizontal" ValidationGroup="group"
                                        AutoPostBack="true" OnSelectedIndexChanged="rdUnitRegistered_SelectedIndexChanged"
                                        TabIndex="4" runat="server">
                                        <asp:ListItem Value="1">Yes</asp:ListItem>
                                        <asp:ListItem Value="0" Selected="True">No</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="RegisterationType" runat="server" visible="false">
                                    <label class="formlabel">
                                        Type of Registration <font color="red">*</font></label>
                                    <asp:DropDownList ID="ddlRegstrType" runat="server" class="form-control txtbox" Height="33px"
                                        TabIndex="1" Width="180px">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                        <asp:ListItem Value="1">Part II</asp:ListItem>
                                        <asp:ListItem Value="2">Udyogaadhar</asp:ListItem>
                                        <asp:ListItem Value="3">Udyam Registration Number</asp:ListItem>
                                        <asp:ListItem Value="4">IEM</asp:ListItem>
                                        <asp:ListItem Value="5">IL ID</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="Registerationo" runat="server" visible="false">
                                    <label class="formlabel">
                                        Registration No : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtUAMID" autocomplete="off" runat="server" AutoPostBack="True"
                                        class="form-control txtbox" Height="33px" TabIndex="2" ValidationGroup="group"
                            ...
                            <div class="row">--%>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Click on below link to get Location :<font color="red">*</font></label>
                                    <asp:LinkButton ID="btn_close" Text="Click here to add Location" runat="server" OnClientClick="togglePopup()" />
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                ...
                                <div class="col-sm-3 form-group" align="left" runat="server" visible="false">
                                    ...
                                    <asp:TextBox ID="txt_laltuide" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="100" TabIndex="1" ValidationGroup="group" Width="250px"></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group" align="left">
                                    <label class="formlabel">
                                        Please check the details below and confirm if this unit is Duplicate/Not Existing /NA <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rblisDuplicate" runat="server" RepeatDirection="Horizontal"
                                        AutoPostBack="true" OnSelectedIndexChanged="rblisDuplicate_SelectedIndexChanged">
                                        <asp:ListItem Value="Duplicate" style="padding-right: 15px">Duplicate</asp:ListItem>
                                        <asp:ListItem Value="Not Existing" style="padding-right: 15px">Not Existing</asp:ListItem>
                                        <asp:ListItem Value="Not Applicable">Not Applicable</asp:ListItem>
                                    </asp:RadioButtonList>                                    
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divduplicate" runat="server" visible="false">
                                    <label class="formlabel">
                                        Select the Original unit <font color="red">*</font></label>
                                    <asp:DropDownList ID="ddlDistrictUnits" runat="server" class="form-control txtbox" Height="33px"
                                        Width="180px" AutoPostBack="true" TabIndex="16">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator67" runat="server" ControlToValidate="ddlstatus"
                                        ErrorMessage="Please select Present Status" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divNEConfirm" runat="server" visible="false">
                                    <label class="formlabel">
                                        Confirmation done through <font color="red">*</font></label>
                                    <asp:DropDownList ID="ddlNEConfirm" runat="server" RepeatDirection="Horizontal"
                                        Width="180px" AutoPostBack="true" class="form-control txtbox" OnSelectedIndexChanged="ddlNEConfirm_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                        <asp:ListItem Value="Physical Verification" style="padding-right: 15px">Physical Verification</asp:ListItem>
                                        <asp:ListItem Value="Telephone">Telephone </asp:ListItem>
                                        <asp:ListItem Value="Others">Others </asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divOtherConfrmation" runat="server" visible="false">
                                    <label class="formlabel">
                                        Other Confirmation <font color="red">*</font></label>
                                    <asp:TextBox ID="txtOtherConfrmation" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="100" TabIndex="17" ValidationGroup="group" Width="180px"></asp:TextBox>
                                </div>
                                
                            </div>
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left" id="divNEConfirmBy" runat="server" visible="false">
                                    <label class="formlabel">
                                        Confirmation done by <font color="red">*</font></label>
                                    <asp:DropDownList ID="ddlConfirmBy" runat="server" RepeatDirection="Horizontal"
                                        Width="180px" AutoPostBack="true" class="form-control txtbox" OnSelectedIndexChanged="ddlNEConfirm_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Present Status Confirmed by GM <font color="red">*</font></label>
                                ...
                                <div class="col-sm-3 form-group" align="left" id="divddlclosed" runat="server" visible="false">
                                    <label class="formlabel">
                                        Reasons For Closure <font color="red">*</font></label>
                                    <asp:DropDownList ID="ddlCloseReason" runat="server" class="form-control txtbox" Height="33px"
                                        Width="180px" AutoPostBack="true" TabIndex="16" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                            <asp:ListItem Value="Competetion">Competetion</asp:ListItem>
                                        <asp:ListItem Value="Covid">Covid</asp:ListItem>
                                        <asp:ListItem Value="Dispute among Partners">Dispute among Partners</asp:ListItem>
                                        <asp:ListItem Value="Finance Problem">Finance Problem</asp:ListItem>
                                        <asp:ListItem Value="Labour Problems">Labour Problems</asp:ListItem>
                                        <asp:ListItem Value="Management Problems">Management Problems</asp:ListItem>
                                        <asp:ListItem Value="No Demand">No Demand</asp:ListItem>
                                        <asp:ListItem Value="Legal Dispute">Legal Dispute</asp:ListItem>
                                        <asp:ListItem Value="Not Established">Not Established</asp:ListItem>
                                        <asp:ListItem Value="Other Activity">Other Activity</asp:ListItem>
                                        <asp:ListItem Value="Out Dated">Out Dated</asp:ListItem>
                                        <asp:ListItem Value="Personal Reasons">Personal Reasons</asp:ListItem>
                                        <asp:ListItem Value="Phone Not Working">Phone Not Working</asp:ListItem>
                                        <asp:ListItem Value="Relocation">Relocation</asp:ListItem>
                                        <asp:ListItem Value="Temporarily Closed">Temporarily Closed</asp:ListItem>
                                        <asp:ListItem Value="Seasonally Closed">Seasonally Closed</asp:ListItem>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator69" runat="server" ControlToValidate="ddlstatus"
                                        ErrorMessage="Please select Present Status" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divtextclosed" runat="server" visible="false">
                                    <label class="formlabel">
                                        Enter Reason <font color="red">*</font></label>
                                    <asp:TextBox ID="txtCloseReason" autocomplete="off" runat="server"
                                        class="form-control txtbox" Height="33px" TabIndex="13" ValidationGroup="group"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-sm-3 form-group" align="left" id="divrblTsipassmap" runat="server">
                                    <label class="formlabel">
                                        Does the unit Registered with
                                    <br />
                                        TS-iPASS :<font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rblTsipassmap" runat="server" ValidationGroup="group" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblTsipassmap_SelectedIndexChanged"
                                        Height="33px" Width="180px" TabIndex="1">
                                        <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divTSIPASSmap" runat="server" visible="false">
                                    <label class="formlabel">
                            ...
                            <div align="left">
                                <b style="color: red" align="left">Please Fill below fields from the Complete Unit Address Field
                                Above</b>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txt_houseno" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="9" ValidationGroup="group" Width="180px"></asp:TextBox>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txt_Locality" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="10" ValidationGroup="group" Width="180px"></asp:TextBox>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txt_street" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="11" ValidationGroup="group" Width="180px"></asp:TextBox>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txt_landmark" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="12" ValidationGroup="group" Width="180px"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtinvestment" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="6" onkeypress="return isNumberKey(event,this)" TabIndex="14"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtDateOfCommencement" AutoPostBack="true" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="40" OnTextChanged="txtDateofCommencement_TextChanged"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        MSME Owner Generation <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rdownergeneration" runat="server" TabIndex="21"
                                        RepeatDirection="Horizontal">
                                        <asp:ListItem Value="First generation">First generation</asp:ListItem>
                                        <asp:ListItem Value="Family business">Family business</asp:ListItem>
                                    </asp:RadioButtonList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator40" runat="server" ControlToValidate="rdownergeneration"
                                        ErrorMessage="Please select  MSME Owner Generation" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                ...
                                <div class="col-sm-3 form-group" align="left" id="divcountry" runat="server" visible="false">
                                    ...
                                    <asp:TextBox ID="txtEXPORTCOUNTRY" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="100" TabIndex="22" ValidationGroup="group" Width="180px"></asp:TextBox>
                                </div>
                                <div id="div_dateofcapture" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Date of Capture : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtDateofCapture" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" TabIndex="23" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDate"
                                        ErrorMessage="Please Select Date" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Loan availed under which scheme(such as PMEGP) <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rdscheme" runat="server"
                                        RepeatDirection="Horizontal" OnSelectedIndexChanged="rdscheme_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="PMEGP">PMEGP</asp:ListItem>
                                        <%--<asp:ListItem Value="Direct Loan">Direct Loan</asp:ListItem>--%>
                                        <asp:ListItem Value="Other">Other</asp:ListItem>
                                        <asp:ListItem Value="No Loan">No Loan</asp:ListItem>

                                    </asp:RadioButtonList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator55" runat="server" ControlToValidate="rdscheme"
                                        ErrorMessage="Please select Loan availed under which scheme(such as PMEGP)" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>

                            <div class="row">
                                <div id="divotherscheme" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Enter Other Scheme Name : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtotherscheme" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator54" runat="server" ControlToValidate="txtotherscheme"
                                        ErrorMessage="Please Enter Enter Other Scheme Name" InitialValue="Enter Other Scheme Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divPMEGP1" runat="server" visible="false">
                                    <label class="formlabel">
                                        Loan Status : <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rdloan" runat="server" TabIndex="21"
                                        RepeatDirection="Horizontal">
                                        <asp:ListItem Value="Ongoing">Ongoing</asp:ListItem>
                                        <asp:ListItem Value="Fully paid">Fully paid</asp:ListItem>
                                    </asp:RadioButtonList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator56" runat="server" ControlToValidate="rdownergeneration"
                                        ErrorMessage="Please select  MSME Owner Generation" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left" id="divPMEGP2" runat="server" visible="false">
                                    <label class="formlabel">
                                        Financing Institute <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rblFinBank" runat="server" OnSelectedIndexChanged="rblFinBank_SelectedIndexChanged" AutoPostBack="true"
                                        RepeatDirection="Horizontal">
                                        <asp:ListItem Value="Bank">Bank</asp:ListItem>
                                        <asp:ListItem Value="NBFC">NBFC</asp:ListItem>
                                        <asp:ListItem Value="Hand Loan">Hand Loan</asp:ListItem>
                                    </asp:RadioButtonList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator57" runat="server" ControlToValidate="rdownergeneration"
                                        ErrorMessage="Please select  MSME Owner Generation" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>

                            </div>
                            <div class="row">
                                <div id="divBankname" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Enter Bank Name : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtBankName" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" TabIndex="23" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator62" runat="server" ControlToValidate="txtotherscheme"
                                        ErrorMessage="Please Enter Enter Other Scheme Name" InitialValue="Enter Other Scheme Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div id="divNBFC" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Enter NBFC Name : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtNBFCname" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" TabIndex="23" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator63" runat="server" ControlToValidate="txtotherscheme"
                                        ErrorMessage="Please Enter Enter Other Scheme Name" InitialValue="Enter Other Scheme Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Capital Investment (In Lakhs) <font color="red">*</font></label>
                                    <asp:TextBox ID="txtCapitalInvestment" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator59" runat="server" ControlToValidate="rdownergeneration"
                                        ErrorMessage="Please select  MSME Owner Generation" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Annual Turnover (In Lakhs) <font color="red">*</font></label>
                                    <asp:TextBox ID="txtTurnover" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator60" runat="server" ControlToValidate="rdownergeneration"
                                        ErrorMessage="Please select  MSME Owner Generation" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Profit / Loss : <font color="red">*</font></label>
                                    <asp:RadioButtonList ID="rblProftloss" runat="server" TabIndex="20" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblProftloss_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="Profit">Profit</asp:ListItem>
                                        <asp:ListItem Value="Loss">Loss</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div id="divProfit" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Profit in Lakhs : </label>
                                    <asp:TextBox ID="txtProfit" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" TabIndex="23" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator64" runat="server" ControlToValidate="txtotherscheme"
                                        ErrorMessage="Please Enter Enter Other Scheme Name" InitialValue="Enter Other Scheme Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div id="divLoss" class="col-sm-3 form-group" runat="server" visible="false"
                                    align="left">
                                    <label class="formlabel">
                                        Loss in Lakhs : <font color="red">*</font></label>
                                    <asp:TextBox ID="txtLoss" runat="server" AutoComplete="off" class="form-control txtbox"
                                        Height="33px" MaxLength="15" TabIndex="23" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator65" runat="server" ControlToValidate="txtotherscheme"
                                        ErrorMessage="Please Enter Enter Other Scheme Name" InitialValue="Enter Other Scheme Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <asp:TableFooterRow ID="TableFooterRow1" runat="server" HorizontalAlign="Center"
                                            ...
                                            <asp:TableCell Height="29px">
                                                <asp:TextBox runat="server" ID="txtEmployment" Width="60px" Enabled="false" AutoPostBack="true"
                                                    OnTextChanged="txtEmployment_TextChanged" Height="33px" MaxLength="8" onkeypress="NumberOnly()"
                            ...
                            <div class="row" id="Employment3" runat="server" visible="false">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtmenemp" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtwomen" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group" Enabled="false"
                                        Width="180px"></asp:TextBox>
                            ...
                            <div class="row" id="Employment4" runat="server" visible="false">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtlocal" autocomplete="off" runat="server" class="form-control txtbox"
                                        OnTextChanged="txtlocal_TextChanged" AutoPostBack="true" Height="33px"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtmigrant" autocomplete="off" runat="server" class="form-control txtbox"
                                        ...
                                        MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group"
                                        Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator46" runat="server" ControlToValidate="txtmigrant"
                                        ErrorMessage="Please enter no of Employees" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row" id="Employment5" runat="server" visible="false">

                                <div class="col-sm-3 form-group" align="left" id="directemp" runat="server" visible="true">
                                    <label class="formlabel">
                                    ...
                                    <asp:TextBox ID="txt_noofdirectemp" autocomplete="off" runat="server" class="form-control txtbox"
                                        OnTextChanged="txt_noofdirectemp_TextChanged" AutoPostBack="true" Height="33px"
                                        MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txt_totnoofindirectemp" autocomplete="off" runat="server" class="form-control txtbox"
                                        OnTextChanged="txt_totnoofindirectemp_TextChanged" AutoPostBack="true" Height="33px"
                                        MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group"
                                        Width="180px"></asp:TextBox>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        <b>No of people employed within the District:</b><font color="red">*</font></label>
                                    <asp:TextBox ID="txtEmpWithinDist" autocomplete="off" runat="server" class="form-control txtbox"
                                        AutoPostBack="true" Height="33px"
                                        MaxLength="8" onkeypress="NumberOnly()" TabIndex="15" ValidationGroup="group"
                                        Width="180px"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator58" runat="server" ControlToValidate="txt_totnoofindirectemp"
                                        ErrorMessage="Please enter no of Employees" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                            ...
                                            <asp:TemplateField HeaderText="Women Employee">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtempos_women" Text='<%#Eval("Women") %>' autocomplete="off" runat="server"
                                                        class="form-control txtbox" Height="33px" MaxLength="8" onkeypress="NumberOnly()"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Women Employee">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtemp_conwomen"
                                                        ErrorMessage="Please enter Women Employee" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Men Employee">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtemp_conmen"
                                                        ErrorMessage="Please enter Men Employee" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtNameofEntrepreneur" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="24" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtNameofEntrepreneur"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtMObileNo" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="10" onkeypress="NumberOnly()" TabIndex="25" ValidationGroup="group"
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtAltMobileNo" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="10" onkeypress="NumberOnly()" TabIndex="25" ValidationGroup="group"
                                        onblur="checkLength(this)" Width="180px" AutoPostBack="True"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator66" runat="server" ControlToValidate="txtMObileNo"
                                        ErrorMessage="Please enter Your Mobile number" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:TextBox ID="txtEmail" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" MaxLength="40" TabIndex="26" ValidationGroup="group" Width="180px"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group" align="left">
                                    <h4>
                                        <b>CORPORATE OFFICE ADDRESS</b></h4>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group" align="left">
                                    <label>
                                        Corporate Office Address same as Unit Address: </label>
                                    <asp:RadioButtonList runat="server" ID="rblsameasUnitaddr" RepeatDirection="Horizontal">
                                        <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        H.No/Plot.No : </label>
                                    <asp:TextBox ID="txt_Corhouseno" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="9" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator47" runat="server" ControlToValidate="txt_Corhouseno"
                                        ErrorMessage="Please enter House No" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Street Name :</label>
                                    <asp:TextBox ID="txt_Corstreet" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="11" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator48" runat="server" ControlToValidate="txt_Corstreet"
                                        ErrorMessage="Please enter Street" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Location :</label>
                                    <asp:TextBox ID="txt_CorLocality" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="10" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator49" runat="server" ControlToValidate="txt_CorLocality"
                                        ErrorMessage="Please enter Locality" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Landmark :</label>
                                    <asp:TextBox ID="txt_CorLandmark" autocomplete="off" runat="server" class="form-control txtbox"
                                        Height="33px" TabIndex="10" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator61" runat="server" ControlToValidate="txt_CorLocality"
                                        ErrorMessage="Please enter Locality" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        District : </label>
                                    <asp:DropDownList ID="ddl_Cordistrict" runat="server" ValidationGroup="group" AutoPostBack="True"
                                        Enabled="true" class="form-control txtbox" Height="33px" TabIndex="5" Width="180px"
                                        OnSelectedIndexChanged="ddl_Cordistrict_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator50" runat="server" ControlToValidate="ddl_Cordistrict"
                                        ErrorMessage="Please select  District" ValidationGroup="group" InitialValue="--Select--">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Mandal :</label>
                                    <asp:DropDownList ID="ddl_CorMandal" runat="server" ValidationGroup="group" class="form-control txtbox"
                                        Enabled="true" Height="33px" Width="180px" AutoPostBack="True" TabIndex="7" OnSelectedIndexChanged="ddl_CorMandal_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator52" runat="server" ControlToValidate="ddl_CorMandal"
                                        ErrorMessage="Please select  Mandal" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3 form-group" align="left">
                                    <label class="formlabel">
                                        Village:</label>
                                    <asp:DropDownList ID="ddl_Corvillage" runat="server" ValidationGroup="group" class="form-control txtbox"
                                        Height="33px" Width="180px" TabIndex="8">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator53" runat="server" ControlToValidate="ddl_Corvillage"
                                        ErrorMessage="Please select  Mandal" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="auto-style2">
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:DropDownList ID="ddlSector" runat="server" class="form-control txtbox" Height="33px"
                                        Width="230px" OnSelectedIndexChanged="ddlSector_SelectedIndexChanged"
                                        AutoPostBack="true">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="col-sm-3 form-group" align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ControlToValidate="ddlintLineofActivity"
                                ...
                                <div class="col-sm-3 form-group" align="left" runat="server">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator31" runat="server" ControlToValidate="ddlCategorybyZone"
                                ...
                                <div id="div_productspecfication" class="col-sm-3 form-group" runat="server" visible="false"
                                    ...
                                    <asp:TextBox ID="txtProductSpec" autocomplete="off" runat="server" AutoPostBack="True"
                                        class="form-control txtbox" Height="33px" MaxLength="20" TabIndex="33" ValidationGroup="group"
                                        Width="180px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <asp:TextBox ID="txtManfitem" autocomplete="off" runat="server" class="form-control txtbox" Width="230px"
                                            Height="33px" onkeypress="Names()" ValidationGroup="group"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator44" runat="server" ControlToValidate="txtManfitem"
                                            ErrorMessage="Please enter Item Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label class="formlabel">
                                            Quantity Per Annum <font color="red">*</font></label>
                                        <asp:TextBox ID="txtManfquantityperannum" autocomplete="off" runat="server" class="form-control txtbox" Width="230px"
                                            Height="33px" MaxLength="40" onkeypress="NumberOnly()" ValidationGroup="group"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ControlToValidate="txtManfquantityperannum"
                                    ...
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <asp:DropDownList ID="ddlManfquantityin" runat="server" class="form-control txtbox" Width="230px"
                                            AutoPostBack="True" Height="33px" OnSelectedIndexChanged="ddlManfquantityin_SelectedIndexChanged">
                                            <asp:ListItem>--Select--</asp:ListItem>
                                    ...
                                    <div class="col-sm-3 form-group" style="margin-top: -20px;" id="trothers" runat="server"
                                        ...
                                        <asp:TextBox ID="txtMfgothers" autocomplete="off" runat="server" class="form-control txtbox"
                                            Height="33px" MaxLength="40" ValidationGroup="group" Width="230px"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <asp:TextBox ID="txtotherproduct" autocomplete="off" runat="server" class="form-control txtbox"
                                            Width="230px" Height="33px" ValidationGroup="group"></asp:TextBox>
                                    ...
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <asp:FileUpload ID="fpdSketch" runat="server" Height="33px" />
                                    ...
                                    <div class="col-sm-6 form-group" style="text-align: center; margin-top: -10px;">
                                        ...
                                        <asp:Button ID="btnFirstGrid" runat="server" CssClass="btn btn-xs btn-warning" Height="33px"
                                        ...
                                        &nbsp;<asp:Button ID="ButtonMfgcancel" runat="server" OnClick="ButtonMfgcancel_Click"
                                            CausesValidation="False" CssClass="btn btn-xs btn-danger" Height="33px" Text="Cancel"
                            ...
                            <div class="box" style="margin-top:20px !important;">
                                <div class="row">
                                    <div class="col-sm-12 form-group" align="left">
                                        <h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 form-group" runat="server" id="div_rawcountry">
                                        ...
                                        <asp:TextBox ID="txtfromcountry" Width="180px" autocomplete="off" Visible="false"
                                            runat="server" class="form-control txtbox" Height="33px" MaxLength="40" TabIndex="42"
                                ...
                                <div class="row">
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <asp:TextBox ID="txtRawItem" autocomplete="off" runat="server" class="form-control txtbox"
                                            Height="33px" MaxLength="40" onkeypress="Names()" TabIndex="43" ValidationGroup="group"
                                            Width="180px"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label class="formlabel">
                                        ...
                                        <asp:TextBox ID="txtRawQntyperAnnum" autocomplete="off" runat="server" class="form-control txtbox"
                                            Height="33px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="44" ValidationGroup="group"
                                            Width="180px"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label class="formlabel">
                                    ...
                                    <div class="col-sm-3 form-group" id="trrawothers" runat="server" visible="false">
                                        ...
                                        <asp:TextBox ID="txtRawothers" autocomplete="off" runat="server" class="form-control txtbox"
                                            Height="33px" MaxLength="40" TabIndex="46" ValidationGroup="group" Width="180px"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 form-group" style="text-align: center; margin-top: 12px">
                                        ...
                                        <asp:Button ID="btn_addrawmaterial" runat="server" CssClass="btn btn-xs btn-warning"
                                            Height="33px" Text="Add" ValidationGroup="child" Width="90px" OnClick="btn_addrawmaterial_Click" />
                                        &nbsp;<asp:Button ID="btnSecondGridClear" runat="server" CausesValidation="False"
                                            CssClass="btn btn-xs btn-danger" Height="33px" Text="Cancel" ToolTip="To Clear  the Screen"
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group" style="text-align: left; margin-top: 12px">
                                ...
                                <asp:TextBox ID="txtremarks" runat="server" TabIndex="47" Height="38px"
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group" style="text-align: center; margin-top: 12px">
                                <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-primary" CausesValidation="False"
                                    Height="33px" Text="Submit" ValidationGroup="group" Width="72px" OnClick="btnsubmit_Click"
                                ...
                                &nbsp;<asp:Button ID="btnclear" runat="server" CausesValidation="false" CssClass="btn btn-xs btn-danger"
                                    Height="33px" Text="Cancel" ToolTip="To Clear  the Screen" Width="73px" OnClick="btnclear_Click" />
