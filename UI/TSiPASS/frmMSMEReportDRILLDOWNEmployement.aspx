<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmMSMEReportDRILLDOWNEmployement.aspx.cs" Inherits="UI_TSiPASS_frmMSMEReportDRILLDOWNEmployement" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="View & Edit">
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="LinkEDIT" runat="server" Text='<%# Eval("msmeNo") %>' Target="_blank" Visible="false"></asp:HyperLink>
                                            </td>     
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Delete" Visible="false">
                                        <ItemTemplate>
                                           <asp:Label ID="lbl_deletestatus" runat="server" Text='<%# Eval("DeletedReason") %>' />
                                            <br />
                                            <asp:DropDownList ID="ddl_griddeletedstatus" runat="server" class="form-control txtbox" Height="33px"
                                                TabIndex="1" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="ddl_griddeletedstatus_SelectedIndexChanged" >
                                             ...
                                             <br />
                                                <asp:TextBox runat="server" class="form-control" Height="50px" Width="230px"
                                                    AutoComplete="false" ID="TXTREMARKS"  placeholder="Remarks" TextMode="MultiLine" />
                                            <br />
                                            <asp:HiddenField ID="hf_msmeid" runat="server" Value='<%# Eval("msmeNo") %>' />
                                            <asp:LinkButton ID="linkdelete" runat="server" Text="DELETE" OnClick="linkdelete_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="NAME_OF_ENTREPRENEUR" ItemStyle-HorizontalAlign="Center" HeaderText="Promoter Name">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="LineofActivity_Name" ItemStyle-HorizontalAlign="Center" HeaderText="LINE OF ACTIVITY">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="DATEOFCOMMENCEMENT" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Commencement">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="RAWMATERIALPROCURED" ItemStyle-HorizontalAlign="Center" HeaderText="Raw Material Procured">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
