                                        ...
                                        <td align="center" colspan="6" style="padding: 5px; margin: 5px">
                                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False" OnRowCreated="grdDetails_RowCreated"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Total Catalogue UNITS"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No of Units Edited"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALUNITSEDITED" runat="server" Text='<%#Eval("TOTALUNITSEDITED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No of Units Not Edited"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALUNITSNOTEDITED" runat="server" Text='<%#Eval("TOTALUNITSNOTEDITED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Total TGIPASS UNITS"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Catalogue UNITS MAPPED WITH TGIPASS"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTSIPASSMAPPEDWITHMSME" runat="server" Text='<%#Eval("MSMEMAPPEDWITHTSIPASS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="TGiPASS Units not mapped with Catalogue"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="hypBalUnits" runat="server" Text='<%#Eval("TSIPASSBALANCEUNITS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Unable to Map"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="hypunabletoMap" runat="server" Text='<%#Eval("TSIPASSUNABLETOMAP") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <%--  <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Balance TSIPASS Units"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="hypBalUnits" runat="server" Text='<%#Eval("TSIPASSBALANCEUNITS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Duplicate Units"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALDUPLICATE" runat="server" Text='<%#Eval("TOTALDUPLICATE") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Not Existing Units"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALNOTEXISTING" runat="server" Text='<%#Eval("TOTALNOTEXISTING") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Total Closed Units as per Catalogue"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALAPPCCLOSEDUNIT" runat="server" Text='<%#Eval("TOTALAPPCCLOSEDUNIT") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Total Closed Units Confirmed by GM"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyTOTALSTATUSUPDATEDAPPCCBYGM" runat="server" Text='<%#Eval("TOTALSTATUSUPDATEDAPPCCBYGM") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
