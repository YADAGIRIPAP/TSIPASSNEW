<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmFireDetails.aspx.cs" Inherits="TSTBDCReg1" %>
            ...
            <div class="col-lg-11">
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title">Fire Details</h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtHight_EachFloor" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px" Enabled="true"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top"><strong>E) Fire Fighting Drawings/Plans :</strong></td>
                                <td style="width: 27px">&nbsp;</td>
                                <td valign="top">&nbsp;</td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 60%">
                                        <tr runat="server" id="trerector" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="BtnPlanapproval" runat="server" CssClass="btn btn-xs btn-warning"
                                                    ...
                                                    Width="72px" OnClick="BtnPlanapproval_Click" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr runat="server" id="tr6" visible="true">
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                ...
                                                <asp:HyperLink ID="HpSection" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
