...
public partial class UI_TSiPASS_RPT_GroundwaterDistrictwise : System.Web.UI.Page
{
    ...
    Cls_OSGroundWater Gen = new Cls_OSGroundWater();
    ...
    public void fillgrid()
    {
        ...
        vehicleDS = Gen.DB_getgroundwaterrpdistrictwise(DistrictID);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hyp_TotalApplications.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApplications&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Applications";

            HyperLink hyp_TotalPrescrunitypendinginMROappl = (HyperLink)e.Row.FindControl("hyp_TotalPrescrunitypendinginMROappl");
            hyp_TotalPrescrunitypendinginMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalPrescrunitypendinginMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Presrunity Pending";

            HyperLink hyp_TotalQueryraisedbyMROappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryraisedbyMROappl");
            hyp_TotalQueryraisedbyMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Pre-Scrunity Pending after 14 Days";

            HyperLink hyp_TotalQueryrespondedtoMROappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryrespondedtoMROappl");
            hyp_TotalQueryrespondedtoMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedtoMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Raised  For Applications";

            HyperLink hyp_TotalPrescrunityrejectedMROappl = (HyperLink)e.Row.FindControl("hyp_TotalPrescrunityrejectedMROappl");
            hyp_TotalPrescrunityrejectedMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalPrescrunityrejectedMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Raised Applications";

            HyperLink hyp_TotalapplforwardtoDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotalapplforwardtoDGWOappl");
            hyp_TotalapplforwardtoDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalapplforwardtoDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query raised, no response within 7 days From Applicants";

            HyperLink hyp_TotalQueryraisedbyDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryraisedbyDGWOappl");
            hyp_TotalQueryraisedbyDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Responded Application";


            HyperLink hyp_TotalQueryrespondedDGwoappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryrespondedDGwoappl");
            hyp_TotalQueryrespondedDGwoappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedDGwoappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Responded Application";

            HyperLink hyp_TotalApprovedbyDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotalApprovedbyDGWOappl");
            hyp_TotalApprovedbyDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query Responded,No action Taken within 7 days";

            HyperLink hyp_TotalRejectedbyDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotalRejectedbyDGWOappl");
            hyp_TotalRejectedbyDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalRejectedbyDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Approved Application";


            HyperLink hyp_TotalApprovedbyMROappl = (HyperLink)e.Row.FindControl("hyp_TotalApprovedbyMROappl");
            hyp_TotalApprovedbyMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Applications";

            HyperLink hyp_TotalApprovalRejectedbyMROappl = (HyperLink)e.Row.FindControl("hyp_TotalApprovalRejectedbyMROappl");
            hyp_TotalApprovalRejectedbyMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovalRejectedbyMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";
            ...
            hyp_totalPrescrunitypendingMRObeyond14days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalPrescrunitypendingMRObeyond14days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Presrunity Pending";
            ...
            hyp_TotalMROQueryraisedNoresponsebyapplbeyond7days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalMROQueryraisedNoresponsebyapplbeyond7days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Pre-Scrunity Pending after 14 Days";
            ...
            hyp_TotalQueryrespondedapplnoactionbeyond7daysMRO.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysMRO&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Raised  For Applications";

            HyperLink hyp_totalapplpendinginDGWObeyond7days = (HyperLink)e.Row.FindControl("hyp_totalapplpendinginDGWObeyond7days");
            hyp_totalapplpendinginDGWObeyond7days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalapplpendinginDGWObeyond7days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Raised Applications";
            ...
            hyp_TotalDGWOQueryraisedNoresponsebyapplbeyond7days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalDGWOQueryraisedNoresponsebyapplbeyond7days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query raised, no response within 7 days From Applicants";
            ...
            hyp_TotalQueryrespondedapplnoactionbeyond7daysDGWO.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysDGWO&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Responded Application";

            HyperLink hyp_DGWOApprovedwithintimelimit = (HyperLink)e.Row.FindControl("hyp_DGWOApprovedwithintimelimit");
            hyp_DGWOApprovedwithintimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DGWOApprovedwithintimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Responded Application";

            HyperLink hyp_DGWOapprovedbeyondtimelimit = (HyperLink)e.Row.FindControl("hyp_DGWOapprovedbeyondtimelimit");
            hyp_DGWOapprovedbeyondtimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DGWOapprovedbeyondtimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query Responded,No action Taken within 7 days";

            HyperLink hyp_MROApprovedwithintimelimit = (HyperLink)e.Row.FindControl("hyp_MROApprovedwithintimelimit");
            hyp_MROApprovedwithintimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=MROApprovedwithintimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Approved Application";

            HyperLink hyp_MROapprovedbeyondtimelimit = (HyperLink)e.Row.FindControl("hyp_MROapprovedbeyondtimelimit");
            hyp_MROapprovedbeyondtimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=MROapprovedbeyondtimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";

            HyperLink hyp_DWGOrejecteddocuploadedbyMRO = (HyperLink)e.Row.FindControl("hyp_DWGOrejecteddocuploadedbyMRO");
            hyp_DWGOrejecteddocuploadedbyMRO.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DWGOrejecteddocuploadedbyMRO&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Approved Application";

            HyperLink hyp_DWGOrejecteddocuploadpendingbyMRO = (HyperLink)e.Row.FindControl("hyp_DWGOrejecteddocuploadpendingbyMRO");
            hyp_DWGOrejecteddocuploadpendingbyMRO.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DWGOrejecteddocuploadpendingbyMRO&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";


            HyperLink hyp_TotCurr_PrescrunitypendinginMROappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_PrescrunitypendinginMROappl");
            hyp_TotCurr_PrescrunitypendinginMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_PrescrunitypendinginMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";

            HyperLink hyp_TotCurr_QueryraisedbyMROappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryraisedbyMROappl");
            hyp_TotCurr_QueryraisedbyMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";

            HyperLink hyp_TotCurr_QueryrespondedtoMROappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryrespondedtoMROappl");
            hyp_TotCurr_QueryrespondedtoMROappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedtoMROappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";

            HyperLink hyp_TotCurr_applforwardtoDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_applforwardtoDGWOappl");
            hyp_TotCurr_applforwardtoDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_applforwardtoDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";

            HyperLink hyp_TotCurr_QueryraisedbyDGWOappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryraisedbyDGWOappl");
            hyp_TotCurr_QueryraisedbyDGWOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyDGWOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";


            HyperLink hyp_TotCurr_QueryrespondedDGwoappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryrespondedDGwoappl");
            hyp_TotCurr_QueryrespondedDGwoappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedDGwoappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";
           ...
           ///Transco
            ...
            hyp_TotalapplforwardtoTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalapplforwardtoTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query raised, no response within 7 days From Applicants";
            
            HyperLink hyp_TotalQueryraisedbyTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryraisedbyTRANSCOappl");
            hyp_TotalQueryraisedbyTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Responded Application";
          
            HyperLink hyp_TotalQueryrespondedTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotalQueryrespondedTRANSCOappl");
            hyp_TotalQueryrespondedTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Responded Application";
           
            HyperLink hyp_TotalApprovedbyTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotalApprovedbyTRANSCOappl");
            hyp_TotalApprovedbyTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query Responded,No action Taken within 7 days";
           
            HyperLink hyp_TotalRejectedbyTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotalRejectedbyTRANSCOappl");
            hyp_TotalRejectedbyTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalRejectedbyTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Approved Application";
          
            HyperLink hyp_TotCurr_applforwardtoTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_applforwardtoTRANSCOappl");
            hyp_TotCurr_applforwardtoTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_applforwardtoTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";


            HyperLink hyp_TotCurr_QueryraisedbyTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryraisedbyTRANSCOappl");
            hyp_TotCurr_QueryraisedbyTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";
           
            HyperLink hyp_TotCurr_QueryrespondedTRANSCOappl = (HyperLink)e.Row.FindControl("hyp_TotCurr_QueryrespondedTRANSCOappl");
            hyp_TotCurr_QueryrespondedTRANSCOappl.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedTRANSCOappl&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Rejected Applications";


            HyperLink hyp_totalapplpendinginTRANSCObeyond7days = (HyperLink)e.Row.FindControl("hyp_totalapplpendinginTRANSCObeyond7days");
            hyp_totalapplpendinginTRANSCObeyond7days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalapplpendinginTRANSCObeyond7days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Raised Applications";
            ...
            hyp_TotalTRANSCOQueryraisedNoresponsebyapplbeyond7days.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalTRANSCOQueryraisedNoresponsebyapplbeyond7days&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query raised, no response within 7 days From Applicants";
            ...
            hyp_TotalQueryrespondedapplnoactionbeyond7daysTRANSCO.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysTRANSCO&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Total Query Responded Application";
           
            HyperLink hyp_TRANSCOApprovedwithintimelimit = (HyperLink)e.Row.FindControl("hyp_TRANSCOApprovedwithintimelimit");
            hyp_TRANSCOApprovedwithintimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TRANSCOApprovedwithintimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Current Query Responded Application";

            HyperLink hyp_TRANSCOapprovedbeyondtimelimit = (HyperLink)e.Row.FindControl("hyp_TRANSCOapprovedbeyondtimelimit");
            hyp_TRANSCOapprovedbeyondtimelimit.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TRANSCOapprovedbeyondtimelimit&DistrictID=" + DistrictID + "&DistrictName=" + DistrictName + "&Category=Query Responded,No action Taken within 7 days";
            ...
            //TRANSCO
            int TotalapplforwardtoTRANSCOappl = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "TotalapplforwardtoTRANSCOappl"));
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[2].Text = totrw_TotalApplications.ToString();
            e.Row.Cells[3].Text = totrw_TotalPrescrunitypendinginMROappl.ToString();
            e.Row.Cells[4].Text = totrw_TotCurr_PrescrunitypendinginMROappl.ToString();
            e.Row.Cells[5].Text = totrw_totalPrescrunitypendingMRObeyond14days.ToString();
            e.Row.Cells[6].Text = totrw_TotalQueryraisedbyMROappl.ToString();
            e.Row.Cells[7].Text = totrw_TotCurr_QueryraisedbyMROappl.ToString();
            e.Row.Cells[8].Text = totrw_TotalMROQueryraisedNoresponsebyapplbeyond7days.ToString();
            e.Row.Cells[9].Text = totrw_TotalQueryrespondedtoMROappl.ToString();
            e.Row.Cells[10].Text = totrw_TotCurr_QueryrespondedtoMROappl.ToString();
            e.Row.Cells[11].Text = totrw_TotalQueryrespondedapplnoactionbeyond7daysMRO.ToString();
            e.Row.Cells[12].Text = totrw_TotalPrescrunityrejectedMROappl.ToString();
            e.Row.Cells[13].Text = totrw_TotalapplforwardtoDGWOappl.ToString();
            e.Row.Cells[14].Text = totrw_TotCurr_applforwardtoDGWOappl.ToString();
            e.Row.Cells[15].Text = totrw_totalapplpendinginDGWObeyond7days.ToString();
            e.Row.Cells[16].Text = totrw_TotalQueryraisedbyDGWOappl.ToString();
            e.Row.Cells[17].Text = totrw_TotCurr_QueryraisedbyDGWOappl.ToString();
            e.Row.Cells[18].Text = totrw_TotalDGWOQueryraisedNoresponsebyapplbeyond7days.ToString();
            e.Row.Cells[19].Text = totrw_TotalQueryrespondedDGwoappl.ToString();
            e.Row.Cells[20].Text = totrw_TotCurr_QueryrespondedDGwoappl.ToString();
            e.Row.Cells[21].Text = totrw_TotalQueryrespondedapplnoactionbeyond7daysDGWO.ToString();
            e.Row.Cells[22].Text = totrw_TotalApprovedbyDGWOappl.ToString();
            e.Row.Cells[23].Text = totrw_DGWOApprovedwithintimelimit.ToString();
            e.Row.Cells[24].Text = totrw_DGWOapprovedbeyondtimelimit.ToString();
            e.Row.Cells[25].Text = totrw_TotalRejectedbyDGWOappl.ToString();
            e.Row.Cells[26].Text = totrw_TotalApprovedbyMROappl.ToString();
            e.Row.Cells[27].Text = totrw_MROApprovedwithintimelimit.ToString();
            e.Row.Cells[28].Text = totrw_MROapprovedbeyondtimelimit.ToString();
            e.Row.Cells[29].Text = totrw_TotalApprovalRejectedbyMROappl.ToString();
            e.Row.Cells[30].Text = totrw_DWGOrejecteddocuploadedbyMRO.ToString();
            e.Row.Cells[31].Text = totrw_DWGOrejecteddocuploadpendingbyMRO.ToString();




            e.Row.Cells[32].Text =Convert.ToString(totrw_TotalapplforwardtoTRANSCOappl);
            e.Row.Cells[33].Text = Convert.ToString(totrw_TotCurr_applforwardtoTRANSCOappl);
            e.Row.Cells[34].Text = Convert.ToString(totrw_totalapplpendinginTRANSCObeyond7days);

            e.Row.Cells[35].Text = Convert.ToString(totrw_TotalQueryraisedbyTRANSCOappl);
            e.Row.Cells[36].Text = Convert.ToString(totrw_TotCurr_QueryraisedbyTRANSCOappl);
            e.Row.Cells[37].Text = Convert.ToString(totrw_TotalTRANSCOQueryraisedNoresponsebyapplbeyond7days);

            e.Row.Cells[38].Text = Convert.ToString(totrw_TotalQueryrespondedTRANSCOappl);
            e.Row.Cells[39].Text = Convert.ToString(totrw_TotCurr_QueryrespondedTRANSCOappl);
            e.Row.Cells[40].Text = Convert.ToString(totrw_TotalQueryrespondedapplnoactionbeyond7daysTRANSCO);

            e.Row.Cells[41].Text = Convert.ToString(totrw_TotalApprovedbyTRANSCOappl);
            e.Row.Cells[42].Text = Convert.ToString(totrw_TRANSCOApprovedwithintimelimit);
            e.Row.Cells[43].Text = Convert.ToString(totrw_TRANSCOapprovedbeyondtimelimit);

            e.Row.Cells[44].Text = Convert.ToString(totrw_TotalRejectedbyTRANSCOappl);
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApplications&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Applications";
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalPrescrunitypendinginMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Presrunity Pending";
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_PrescrunitypendinginMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalPrescrunitypendingMRObeyond14days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Current Query Responded Application";
            ...
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Pre-Scrunity Pending after 14 Days";
            ...
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalMROQueryraisedNoresponsebyapplbeyond7days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
            ...
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedtoMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Query Raised  For Applications";
            ...
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedtoMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysMRO&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
            ...
            if (h11.Text != "0")
            {
                h11.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalPrescrunityrejectedMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Current Query Raised Applications";
            ...
            if (h12.Text != "0")
            {
                h12.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalapplforwardtoDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query raised, no response within 7 days From Applicants";
            ...
            if (h13.Text != "0")
            {
                h13.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_applforwardtoDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h14.Text != "0")
            {
                h14.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalapplpendinginDGWObeyond7days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h15.Text != "0")
            {
                h15.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Query Responded Application";
            ...
            if (h16.Text != "0")
            {
                h16.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
            ...
            if (h17.Text != "0")
            {
                h17.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalDGWOQueryraisedNoresponsebyapplbeyond7days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
            ...
            if (h18.Text != "0")
            {
                h18.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedDGwoappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Current Query Responded Application";
                e.Row.Cells[19].Controls.Add(h18);
            }
            ...
            if (h19.Text != "0")
            {
                h19.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedDGwoappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[20].Controls.Add(h19);
            }
            HyperLink h20 = new HyperLink();
            h20.Text = totrw_TotalQueryrespondedapplnoactionbeyond7daysDGWO.ToString();
            if (h20.Text != "0")
            {
                h20.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysDGWO&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[21].Controls.Add(h20);
            }
            ...
            if (h21.Text != "0")
            {
                h21.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
                e.Row.Cells[22].Controls.Add(h21);
            }
            ...
            if (h22.Text != "0")
            {
                h22.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DGWOApprovedwithintimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[23].Controls.Add(h22);
            }
            ...
            if (h23.Text != "0")
            {
                h23.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DGWOapprovedbeyondtimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
                e.Row.Cells[24].Controls.Add(h23);
            }
            ...
            if (h24.Text != "0")
            {
                h24.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalRejectedbyDGWOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[25].Controls.Add(h24);
            }
            HyperLink h25 = new HyperLink();
            h25.Text = totrw_TotalApprovedbyMROappl.ToString();
            if (h25.Text != "0")
            {
                h25.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[26].Controls.Add(h25);
            }
            ...
            if (h26.Text != "0")
            {
                h26.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=MROApprovedwithintimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[27].Controls.Add(h26);
            }
            ...
            if (h27.Text != "0")
            {
                h27.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=MROapprovedbeyondtimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[28].Controls.Add(h27);
            }
            ...
            if (h28.Text != "0")
            {
                h28.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovalRejectedbyMROappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Query Responded Application";
                e.Row.Cells[29].Controls.Add(h28);
            }
            ...
            if (h29.Text != "0")
            {
                h29.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DWGOrejecteddocuploadedbyMRO&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[30].Controls.Add(h29);
            }
            ...
            if (h30.Text != "0")
            {
                h30.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=DWGOrejecteddocuploadpendingbyMRO&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[31].Controls.Add(h30);
            }
            ...
            if (h31.Text != "0")
            {
                h31.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalapplforwardtoTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query raised, no response within 7 days From Applicants";
                e.Row.Cells[32].Controls.Add(h31);
            }
            ...
            if (h32.Text != "0")
            {
                h32.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_applforwardtoTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[33].Controls.Add(h32);
            }
            ...
            if (h33.Text != "0")
            {
                h33.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=totalapplpendinginTRANSCObeyond7days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[34].Controls.Add(h33);
            }
            ...
            if (h34.Text != "0")
            {
                h34.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryraisedbyTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Query Responded Application";
                e.Row.Cells[35].Controls.Add(h34);
            }
            ...
            if (h35.Text != "0")
            {
                h35.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryraisedbyTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[36].Controls.Add(h35);
            }
            ...
            if (h36.Text != "0")
            {
                h36.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalTRANSCOQueryraisedNoresponsebyapplbeyond7days&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
                e.Row.Cells[37].Controls.Add(h36);
            }
            ...
            if (h37.Text != "0")
            {
                h37.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Current Query Responded Application";
                e.Row.Cells[38].Controls.Add(h37);
            }
            ...
            if (h38.Text != "0")
            {
                h19.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotCurr_QueryrespondedTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[39].Controls.Add(h38);
            }
            ...
            if (h39.Text != "0")
            {
                h39.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalQueryrespondedapplnoactionbeyond7daysTRANSCO&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[40].Controls.Add(h39);
            }
            ...
            if (h40.Text != "0")
            {
                h40.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalApprovedbyTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
                e.Row.Cells[41].Controls.Add(h40);
            }
            ...
            if (h41.Text != "0")
            {
                h41.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TRANSCOApprovedwithintimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Rejected Applications";
                e.Row.Cells[42].Controls.Add(h41);
            }
            ...
            if (h42.Text != "0")
            {
                h42.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TRANSCOapprovedbeyondtimelimit&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Query Responded,No action Taken within 7 days";
                e.Row.Cells[43].Controls.Add(h42);
            }
            ...
            if (h43.Text != "0")
            {
                h43.NavigateUrl = "RptWellApplicationlistdistrictwiseReport.aspx?Typedataofappl=TotalRejectedbyTRANSCOappl&DistrictID=ALL" + "&DistrictName=ALL" + "&Category=Total Approved Application";
                e.Row.Cells[44].Controls.Add(h43);
            }
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                cell2.ColumnSpan = 13;
                cell2.Text = "District Ground Officer Applications";
                ...
                cell21.Text = "District TRANSCO Applications";
