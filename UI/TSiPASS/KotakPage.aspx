<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPage.aspx.cs" Inherits="UI_TSIPASS_KotakPage" %>
    ...
    <div id="myDIV">
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandler.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmDepartmentApprovalPaymentDetails.aspx" />
                </td>
            </tr>
            <tr>
                <td>
