...
public partial class UI_TSiPASS_UserDrillingrigsborewellsPaymentDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.Count > 0)
        {
            ...
            {
                DataSet dsnew = obj_dashboard.BindUserPaymentReceipt_Drillingrigs(Request.QueryString[0].ToString());
    ...
    {
        Response.Redirect(" ~/UI/TSiPASS/UserDrillingRigsborewelllist.aspx");
