<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmQurieResponseStatus_TourismEvent.aspx.cs" Inherits="UI_TSiPASS_frmQurieResponseStatus_TourismEvent" %>
                                        ...
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            ...
                                            <tr>
                                                <td align="center" class="style8"
                                                    style="padding: 5px; margin: 5px; text-align: center;" valign="top"></td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;"
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NameAddEventManagement" HeaderText="Name and address of the Event Management Company / Organization on whose behalf the applicant is applying for Performance License " />
                                                            <%--<asp:BoundField DataField="Sector_EntA" HeaderText="Sector of Enterprise" />--%>
                                                             <asp:BoundField DataField="nameofunit" HeaderText="Name and location of the place where the performance is to be held" />
                                                            <asp:BoundField DataField="TypeofEvent" HeaderText="Type of Event" />
                                                            <asp:BoundField DataField="ClassificationofEvent" HeaderText="Classification of the event" />
                                                            ...
                                                            <asp:BoundField DataField="PLoutionCategorys" HeaderText="Pollution Category"  Visible="false"/> 
