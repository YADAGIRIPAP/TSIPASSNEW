...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalSectorwise_New(ddlType.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalSectorwise_New(ddlType.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmSectorDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "FrmSectorDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "FrmSectorDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmSectorDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%";
    ...
    protected void ExportToExcel()
    {
        ...
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=R6.2: TSiPASS - Sector Wise Report.xls");
            Response.Charset = "";
