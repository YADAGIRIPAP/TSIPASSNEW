...
public partial class UI_TSIPASS_frmImplstatuspendencyDistwise : System.Web.UI.Page
{
    int Yet_to_Start1;
    int Initial_Stage1;
    int Advanced_Stage1;
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=A&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }
            //-----------------------------------------------------------------------------------------------------------------------------------------------
            HyperLink h9 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=B&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }

            //-----------------------------------------------------------------------------------------------------------------------------------------------
            HyperLink h16 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h16.Text != "0")
            {
                h16.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=C&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }
            //----------------------------------------------------------------------------------------------------------------------
            HyperLink h23 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h23.Text != "0")
            {
                h23.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=D&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }
            HyperLink h24 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h24.Text != "0")
            {
                h24.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=E&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }
            HyperLink h25 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h25.Text != "0")
            {
                h25.NavigateUrl = "frmImplstatuspendencyDistwiseDrill.aspx?status=F&Dist=" + lbldist.Text.Trim() + "&ApprovalType=" + ddltypeapps.SelectedValue + "&Appltype=" + ddlTSiPASSType.SelectedValue + "&Year=" + ddlType.SelectedValue;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[4].Text = Initial_Stage1.ToString();
            e.Row.Cells[5].Text = Advanced_Stage1.ToString();
            e.Row.Cells[6].Text = Commenced_Operations.ToString();
            e.Row.Cells[7].Text = Drpped.ToString();
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            {
                tcMergePackage = "Report for the Financial year of " + ddlType.SelectedItem.Text;
            }
            else
            {
                tcMergePackage = "";
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R6.9: Status of Implementation Abstract - District wise Pendency\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=R6_9_RStatus_of_Implementation_Abstract_District_wise_Pendency" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
    ...
    public DataSet GetAppealApplications(string District, string AppsType, string TSiPASSType, string Year)
    {
        ...
        pp[3].Value = Year;
        Dsnew = gen.GenericFillDs("USP_GET_IMPLIMENTAION_STATUS_ABSTRACT_Wise", pp);
        return Dsnew;
    }
}