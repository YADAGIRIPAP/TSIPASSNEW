<%@ Page Title=":: TSiPASS : Works wise Report " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmIPOIncentiveDashboard.aspx.cs" Inherits="Dashboard" %>
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> Assigned by GM
                                             ...
                                             <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=2"><span class="badge" >
                                                <asp:Label ID="Label8" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Inspection scheduled </a>
                                               
                                               
                                                 <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=3" class="list-group-item">
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> Inspection not yet scheduled
                                                  ...
                                                  <a class="list-group-item" ><i class="fa fa-fw fa-check"></i>Inspection report uploaded</a>
                                                   ...
                                                   <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=4"><span class="badge" >
                                                <asp:Label ID="Label15" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>With in 48 hrs </a>
                                                
                                                
                                                <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=5"><span class="badge" style=" background-color:#d9534f;">
                                        ...
                                        <div class="list-group">
                                               ...
                                               <a class="list-group-item" ><i class="fa fa-fw fa-check"></i>Inspection report Pending </a>
                                                ...
                                                <a class="list-group-item" href="IncentiveStatusInspectionUploadDetails.aspx?Stg=6"><span class="badge" >
                                                <asp:Label ID="Label11" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>With in 48 hrs </a>
                                                
                                                
                                                <a class="list-group-item" href="IncentiveStatusInspectionUploadDetails.aspx?Stg=7"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="Label12" runat="server"></asp:Label>
                                                  ...
                                                  <a class="list-group-item" href="IncentiveStatusInspectionDateDetails.aspx?Stg=8"><span class="badge" >
