...
public partial class UI_TSiPASS_frmLabourShopRenewal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsnew = Gen.getdataofidentityRENAPPROVALID(Request.QueryString[0].ToString(), "56");//Session["Applid"].ToString()
                ...
                else
                {
                    if (Request.QueryString[1].ToString() == "N")
                    {
                       ...
                       // Response.Redirect("frmBoilerRenewals.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&next=" + "N");
                        Response.Redirect("frmRenWaterDetails.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&next=" + "N");
    ...
    void FillDetails()
    {
        ...
        trvisibleregno.Visible = true;
        tragree.Visible = true;
        LabelPreviouscertificate.Visible = true;
        LabelPreviouscertificate.Text = dsdept.Tables[0].Rows[0]["ATTACHMENT"].ToString();
        HyperlinkPreviouscertificate.NavigateUrl = dsdept.Tables[0].Rows[0]["ATTACHMENT"].ToString();
