<%@ Page Language="C#" AutoEventWireup="true" CodeFile="waltaform3.aspx.cs" Inherits="UI_TSiPASS_waltaform3" %>
                            ...
                            <table bgcolor="White" border="2px" style="font-family: Verdana; font-size: small; width: 1000px;">
                                <tr>
                                    <td>
                                        ...
                                        <center>
                                     <h2>FROM–3<br />
(See Rule 13) <br /> Permission of digging
 <asp:Label ID="lbl_typeofappl" runat="server"></asp:Label>
<%-- an Agricultural well / Drinking water well--%>
</h2> 
                                    </center>
                                        <br />
                                    </td>
                                ...
                                <tr>
                                    <td width="900px">
                                        <p style="height: 208px; width: 993px">
                                            Sri  <b>
                                                <asp:Label ID="lbl_nameofapplicant" runat="server"></asp:Label></b> of
                                         <b>
                                             <asp:Label ID="lbl_address" runat="server"></asp:Label></b> (Address) is permitted to dig a new well at 
                                        <b>
                                            <asp:Label ID="lbl_location" runat="server"></asp:Label></b>. (location) 
                                   ...
                                   <br />
                                            ...
                                            (5)	The utilization of water will be subject to the regulation from time to time based on the extraction water from the well.
                                                               <br />
                                            <br />
                                          <%--  (6)	The bore well is insured for a sum of Rs. --%>
                                                                  <b>
                                                                      <asp:Label runat="server" Visible="false" ID="lbl_insuredamount"></asp:Label></b>
                                            <%--wide the insurance master policy No--%>
                                             <b>
                                                <asp:Label ID="lbl_policyNo" Visible="false" runat="server"></asp:Label></b>
                                            <%--. The applicant has paid the premium amount of Rs. --%>
                                            <b>
                                                <asp:Label ID="lbl_applicantfee" Visible="false"  runat="server"></asp:Label></b>
                                            <br />
                                            <br />
                                        </p>
                                        <br />
                                        <br />
                                        <p style="height: 22px; width: 993px">
                                            Note : Geologist report including site plan is enclosed.
                                        </p>
