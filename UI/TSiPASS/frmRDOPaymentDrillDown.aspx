<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmRDOPaymentDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmRDOPaymentDrillDown" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr id="rdoPayments" runat="server" visible="false">
            <td>
                <asp:GridView ID="grdRDOPayments" runat="server" AutoGenerateColumns="true" CellPadding="5"
                    ShowFooter="True" Width="80%" AllowPaging="false" PageSize="20" OnSelectedIndexChanged="grdRDOPayments_SelectedIndexChanged"
