...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void fetchIncentivedet()
    {
        ...
        ds = Gen.GetSubsidydetailsByIpo(ddlMonth.SelectedValue, ddlYear.SelectedValue, Session["uid"].ToString());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intAdvanceSubsidyid"));
    ...
    protected void BtnSaveg_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            int returnValue = Gen.UpdateAdvancedSubsidyStatus(HdfintApplicationid.Value, Session["uid"].ToString(), ddlStatus.SelectedValue.ToString().Trim());
