<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleaseProcedingsStep2CompletedListPrintDIPC.aspx.cs" Inherits="UI_TSiPASS_ReleaseProcedingsStep2CompletedListPrintDIPC" %>
                                ...
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    <tr>
                                        <td style="padding: 10px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width: 30px" colspan="4">
                                                        <asp:Label ID="lblmsg1" runat="server" Visible="false"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width: 30px"></td>
                                                    <td style="vertical-align: middle; width: 250px" align="right">
                                                        <%--G.O. Number:--%>
                                                        Release Proceeding No :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 280px; text-align: left;">
                                                        <asp:DropDownList ID="ddlapplicationto" runat="server" Width="280px" class="form-control txtbox"
                                                            Height="33px">
                                                            <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnAmtAllotedList" CssClass="btn btn-primary" runat="server" Text="Get Amount Alloted List "
                                                            OnClick="btnAmtAllotedList_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <div style="width: 100%">
                                                    <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Alloted Amount">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="txtsanctionedamount" Text='<%#Eval("AllotedAmount") %>' runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="Button1" Height="25px" CssClass="btn btn-primary" runat="server"
                                                                        Text="View" Width="100px" OnClick="Button1_Click" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
