<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    CodeFile="frmPattadarApplDashboard.aspx.cs" Inherits="UI_TSiPASS_frmPattadarApplDashboard" %>
                                                        ...
                                                        <tr>
                                                            <td style="width: 468px" valign="top">
                                                                <div class="list-group">
                                                                    <a href="frmViewPattalandAppliactions.aspx?Stg=3" class="list-group-item"><span class="badge">
                                                                        <asp:Label ID="lblTotAppl" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar">
                                                                        </i>No of Total Applications&nbsp; </a></a> <a class="list-group-item" href="frmViewPattalandAppliactions.aspx?Stg=12">
                                                                    ...
                                                                    <a class="list-group-item" href="frmViewPattalandAppliactions.aspx?Stg=13"><span
                                                                        class="badge">
                                                                        ...
                                                                        href="frmViewPattalandAppliactions.aspx?Stg=16"><span class="badge" style="background-color: #d9534f;">
