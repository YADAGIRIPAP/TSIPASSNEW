<%@ Page Title=":: TS-iPASS ::  " Language="C#" EnableEventValidation="false" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmstatusbyent.aspx.cs" Inherits="TSTBDCReg1" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                            ...
                            <tr id="divPrint" runat="server">
                                <td align="center" style="text-align: center;" valign="top">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="true" CellPadding="5" GridLines="None"
                                        ShowFooter="True" OnRowDataBound="grdDetails_RowDataBound" Width="100%">
