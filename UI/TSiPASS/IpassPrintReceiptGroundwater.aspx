<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpassPrintReceiptGroundwater.aspx.cs" Inherits="UI_TSiPASS_IpassPrintReceiptGroundwater" %>
                                            ...
                                            <td colspan="4" valign="top">
                                                <table align="center" border="1" style="width: 100%; border-right: #000000 thin solid; border-top: #000000 thin solid; border-left: #000000 thin solid; border-bottom: #000000 thin solid; border-collapse: collapse;">
                                                    <tr style="height: 40px">
                                                        <td class="tdStyle" align="left" style="width: 120px">UID No.:
                                                        </td>
                                                        <td class="tdStyle" align="left" style="width: 150px">
                                                            <asp:Label ID="lbl_uidno" runat="server"></asp:Label>
                                                        </td>
                                                        <td class="tdStyle" align="left" style="width: 120px">Applicant Name:
                                                        </td>
                                                    ...
                                                    <tr style="height: 40px">
                                                        <td class="tdStyle" align="left" style="width: 120px">Application Type:
                                                        </td>
                                                        <td class="tdStyle" align="left" style="width: 150px">
                                                            <asp:Label ID="lbl_applicationtype" runat="server"></asp:Label>
                                                        </td>
                                                        <td class="tdStyle" align="left" style="width: 120px">Communication Address:
                                                        </td>
                                                    ...
                                                    <tr style="height: 40px">
                                                        <td class="tdStyle" align="left" style="width: 120px">Transaction No:
                                                        </td>
                                                        <td class="tdStyle" align="left">
                                                            <asp:Label ID="txtrcptno" runat="server" CssClass="input"></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr style="height: 40px">
                                                        ...
                                                        <td class="tdStyle" align="left" style="width: 120px">Email Id:
                                                        </td>
                                                        <td class="tdStyle" align="left">&nbsp;
                                                            <asp:Label ID="txtEmailId" runat="server" Font-Bold="True"></asp:Label>
                                                        </td>
                                                    </tr>
        ...
        <table border="0" align="center" cellpadding="1" cellspacing="2" style="width: 595px">
            <tr>
                <td align="center" colspan="4">
                    <asp:Button ID="btnclose" runat="server" CssClass="NoPrint" PostBackUrl="~/IpassLogin.aspx"
