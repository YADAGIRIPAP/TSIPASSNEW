...
public partial class UI_TSiPASS_TotalReportold2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
       ...
       // dsnew = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB , TodateforDB);
        dsnew = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue, ddldistrict.SelectedItem.Text);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue, ddldistrict.SelectedItem.Text).Tables[0];
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=R6.1:TGiPASS-DistrictWiseReport.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        Government.Visible = true;
        divPrint1.Style["width"] = "680px";
