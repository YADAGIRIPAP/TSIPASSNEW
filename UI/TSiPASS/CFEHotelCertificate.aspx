<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CFEHotelCertificate.aspx.cs" Inherits="UI_TSiPASS_CFEHotelCertificate" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
       <title>CFE Hotel Certficate</title>
    <style type="text/css">
        .div3
        {
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center;padding:0px;" >
                            <h3 style="color: #0000FF; font-size: medium; text-align: center; font-family: Verdana;">(CONSENT FOR ESTABLISHMENT)</h3>
                        <br />
