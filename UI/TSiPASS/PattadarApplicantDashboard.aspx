<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="PattadarApplicantDashboard.aspx.cs" Inherits="UI_TSiPASS_PattadarApplicantDashboard" %>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">
                                    PattadarLand Applicant DASHBOARD&nbsp;</h3>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                                ...
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PATTADARID" ItemStyle-HorizontalAlign="Left" HeaderText="Application No" />
                                                             <asp:BoundField DataField="CREATED_DT" ItemStyle-HorizontalAlign="Left"
                                                                HeaderText="Applied Date" />
                                                            <asp:BoundField DataField="StageID" ItemStyle-HorizontalAlign="Left"
                                                                HeaderText="StageID" Visible="false" />
                                                            <asp:BoundField DataField="ID" ItemStyle-HorizontalAlign="Left"
                                                            ...
                                                            <asp:TemplateField HeaderText="Attachments">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="Attachments" runat="server" Text="View" Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField> 
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                    &nbsp;<b>Note:</b> To Apply Again for another application, Please Click on &#39;Apply Again&#39;, the page will be redirected to application form..&nbsp;&nbsp;
                                                    <br />
                                                    Fill all the details again as applicable and click on submit, you will get new application number and new acknowledgement after
                                                    <br />
                                                    uploaing required attachment.
                                                </td>
                                            </tr>
