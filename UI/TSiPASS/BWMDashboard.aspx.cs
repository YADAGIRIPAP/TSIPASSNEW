...
public partial class UI_TSiPASS_BWMDashboard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DataSet dscheck = new DataSet();
            oSqlDataAdapter = new SqlDataAdapter("GetShowBWMQuestioneries_ques", osqlConnection);
    ...
    void FillDetails()
    {
        ...
        ds = ObjBMW.GetBWMDashboardDetails(Qnreid);
