<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmQuesstionniareReg1.aspx.cs" Inherits="TSTBDCReg1" %>
                ...
                <tr>
                            ...
                            <asp:View ID="View1" runat="server">
                                <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid;
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 38px; padding: 5px; margin: 5px">
                                            <asp:TextBox ID="TxtTot_ExtentNew" runat="server" class="form-control txtbox" Height="30px" oncopy="return false" onpaste="return false" oncut="return false"
                                    ...
                                    <tr id="trtxtgunthas" runat="server">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtgunthas" runat="server" Text="0" class="form-control txtbox"
                                                Height="30px" placeholder="gunthas" MaxLength="10" onkeypress="DecimalOnly()"  oncopy="return false" onpaste="return false" oncut="return false"
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                            <td style="height: 38px; padding: 5px; margin: 5px">
                                                <asp:TextBox ID="TxtTot_Extent" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="TxtBuilt_up_Area" runat="server" class="form-control txtbox" Height="28px"
                                                MaxLength="9" TabIndex="0" ValidationGroup="group" Width="180px" AutoPostBack="True"
                            ...
                            <asp:View ID="View2" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid;
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px;">
                                            <asp:TextBox ID="TxtProp_Emp" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                                    ...
                                                    <td>
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    <asp:TextBox ID="TxtVal_Land_Actual" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="TxtVal_Land" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                                            ...
                                                            <tr id="trmarketvalue" runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtmarketvalue" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="20" ValidationGroup="group" oncopy="return false" onpaste="return false" oncut="return false"
                                ...
                                color="red">*</font></asp:Label>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    <asp:TextBox ID="TxtVal_Build_Actual" runat="server" class="form-control txtbox" oncopy="return false" onpaste="return false" oncut="return false"
                                ...
                                color="red">*</font></asp:Label>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" class="auto-style1">
                                                                    <asp:TextBox ID="TxtVal_Plant_Actual" runat="server" class="form-control txtbox" oncopy="return false" onpaste="return false" oncut="return false"
                                                                        Height="28px" MaxLength="20" onkeypress="DecimalOnly()" TabIndex="0" ValidationGroup="group"
                                ...
                                color="red">*</font></asp:Label>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" oncopy="return false" onpaste="return false" oncut="return false" class="form-control txtbox" Height="28px" MaxLength="20" onkeypress="DecimalOnly()" OnTextChanged="TextBox1_TextChanged" TabIndex="0" ValidationGroup="group" Width="180px"></asp:TextBox>
                    ...
                    ErrorMessage="Please Enter Value of Expansion Land" ValidationGroup="group">*</asp:RequiredFieldValidator>--%>
                                ...
                                color="red">*</font></asp:Label>
                                     ...
                                     <asp:HiddenField ID="HDNEXPANSIONUSER" runat="server" />
                                    <tr>
                                        <td colspan="5">
                                        </td>
                                        <td align="right">
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid;
                                            ...
                                            <asp:GridView ID="gvmodelsnames" TabIndex="41" runat="server" Width="661px" border="0"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Water Required per day( in KLD)" ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="txtwaterrequired" MaxLength="10" Width="180px" oncopy="return false" onpaste="return false" oncut="return false"></asp:TextBox>
                                                        </ItemTemplate>
                                    ...
                                    <tr runat="server" id="trUserid">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:TextBox ID="TxtHight_Build" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                                MaxLength="5" TabIndex="0" ValidationGroup="group" Width="180px" OnTextChanged="TxtHight_Build_TextChanged"></asp:TextBox>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr runat="server" id="trtrees" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:TextBox ID="Txt_NoofTrees" runat="server" class="form-control txtbox" Height="28px" oncopy="return false" onpaste="return false" oncut="return false"
                                    ...
                                    <tr runat="server" id="tr4" visible="false">
                                     ...
                                     <tr runat="server" id="trlink" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label18" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="" data-balloon-pos="down">Transportation of timber and bamboo from private lands/govt/private depot and other minor forest produce</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            
                                        </td>
                                       <td style="padding: 5px; margin: 5px">
                                                                    <asp:HyperLink ID="HyperLink1" ForeColor="Red" runat="server" NavigateUrl="https://ntps.nic.in"
                                                                        Target="_blank" CssClass="blink" Text="Click Here"></asp:HyperLink>
                                                                </td>
                                        <td style="padding-bottom: 2px; margin-bottom: 2px;" valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <asp:HiddenField ID="hdres" runat="server" />
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr id="trvolcapacity" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                             <asp:TextBox ID="txtagrcapacity" runat="server" Height="28px" class="form-control txtbox" oncopy="return false" onpaste="return false" oncut="return false"
                                                MaxLength="5" onkeypress="NumberOnly()" TabIndex="0" ValidationGroup="group"
                                                Width="180px" Enabled="true"></asp:TextBox>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
