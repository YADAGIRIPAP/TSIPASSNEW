...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void FillDetails()
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    if (sen.Contains("SelfCertificationForm"))
                    {
                        ...
                        //using (FileStream fs = File.OpenRead(sen1))
                        //{
                        ...
                        //    Response.AddHeader("content-disposition", String.Format("attachment;filename={0}", Path.GetFileName(sen1)));
                        //    Response.ContentType = "application/" + Path.GetExtension(sen1).Substring(1);
                        //    Response.TransmitFile(sen1);
            ...
            {
                int c = ds1.Tables[1].Rows.Count;
                string sen, sen1;
                int i = 0;

                while (i < c)
                {
                    sen = ds1.Tables[1].Rows[i][0].ToString();
                    string filepathnew = ds1.Tables[1].Rows[i]["linkNew"].ToString();// LINKNEW .Tables[0].Rows[i][0].ToString();
                    ...
                    lab[i].Text += "<tr><td> <a href='CS.aspx?filepathnew=" + encpassword + "' target='_blank' style='color:#FF6600;'>" + ds1.Tables[1].Rows[i][1].ToString() + "</a></td></tr>";
                    lab[i].Text += "</table><br/>";
            ...
            {
                dsdept = Gen.GetdataCFEApprovaldocument(hdfFlagID0.Value.ToString());
            }
            else
            {
                dsdept = Gen.GetdatabyDeptinCFEdocument(hdfFlagID0.Value.ToString(), Session["User_Code"].ToString().Trim());
            }
            ...
            if (dsdpmsplans != null && dsdpmsplans.Tables.Count > 0 && dsdpmsplans.Tables[0].Rows.Count > 0)
            {
                //trdigi1.Visible = true;
                //trdigi.Visible = true;
            ...
            dsdept1 = Gen.GetdatabyDeptinCFEdocumentRespondDetails(hdfFlagID0.Value.ToString());
           ...
           // if (dsdept1.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    sennew = dsdept1.Tables[0].Rows[i]["LINKNEW"].ToString();// LINKNEW
                    string encpassword = Gen.Encrypt(sennew, "SYSTIME");
                    //sen1 = sen2.Replace(@"\", @"/");
                    // D:\Frux Hosting\TS-iPASS\Attachments\1061\Combinedbuildingplan
                    sen1 = dsdept1.Tables[0].Rows[i][0].ToString();// sen.Replace("D:/TS-iPASSFinal/", "../../");
                    lab[i] = new Label();
                    lab[i].Text += "<table style='border: 1px solid #003366;' width='100%'>";
            ...
            if (dsAppeal.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    string filepathnew = dsAppeal.Tables[0].Rows[i]["linkNew"].ToString();// LINKNEW .Tables[0].Rows[i][0].ToString();
                    string encpassword = Gen.Encrypt(filepathnew, "SYSTIME");
                    ...
                    lab[i].Text += "<tr><td> <a href='CS.aspx?filepathnew=" + encpassword + "' target='_blank' style='color:#FF6600;'>" + dsAppeal.Tables[0].Rows[i][1].ToString() + "</a></td></tr>";
                    lab[i].Text += "</table><br/>";
            ...
            if (dsRejct_Doc.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    //sen1 = sen2.Replace(@"\", @"/");
                    sennew = dsRejct_Doc.Tables[0].Rows[i]["LINKNEW"].ToString();// LINKNEW
                    string encpassword = Gen.Encrypt(sennew, "SYSTIME");
                    // D:\Frux Hosting\TS-iPASS\Attachments\1061\Combinedbuildingplan
                    sen1 = sen.Replace("D:/TS-iPASSFinal/", "../../");
                    lab[i] = new Label();
                    ...
                    lab[i].Text += "<tr><td> <a href='CS.aspx?filepathnew=" + encpassword + "' target='_blank' style='color:#FF6600;'>" + dsRejct_Doc.Tables[0].Rows[i][1].ToString() + "</a></td></tr>";
                    lab[i].Text += "</table><br/>";
            ...
            if (dsoffline.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    string filepathnew = dsoffline.Tables[0].Rows[i]["linkNew"].ToString();// LINKNEW .Tables[0].Rows[i][0].ToString();
                    string encpassword = Gen.Encrypt(filepathnew, "SYSTIME");
                    //sen1 = sen2.Replace(@"\", @"/");
                    // D:\Frux Hosting\TS-iPASS\Attachments\1061\Combinedbuildingplan
                    sen1 = dsoffline.Tables[0].Rows[i][0].ToString();// sen.Replace("D:/TS-iPASSFinal/", "../../");
                    lab[i] = new Label();
                    lab[i].Text += "<table style='border: 1px solid #003366;' width='100%'>";
                    //lab[i].Text += "<tr><td> <a href='" + sen1 + "' target='_blank' style='color:#FF6600;'>" + dsoffline.Tables[0].Rows[i][1].ToString() + "</a></td></tr>";
                    lab[i].Text += "<tr><td> <a href='CS.aspx?filepathnew=" + encpassword + "' target='_blank' style='color:#FF6600;'>" + dsoffline.Tables[0].Rows[i][1].ToString() + "</a></td></tr>";
                    lab[i].Text += "</table><br/>";
