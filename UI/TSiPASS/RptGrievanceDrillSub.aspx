<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptGrievanceDrillSub.aspx.cs" Inherits="UI_TSIPASS_RptGrievanceDrillSub" %>
                                    ...
                                    <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                               ...
                                               <asp:BoundField DataField="UID" HeaderText="UID Number" />
                                                    <asp:BoundField DataField="Name of the Unit" HeaderText="Name of the Unit" />
                                                    <asp:BoundField DataField="Grievance" HeaderText="Grievance" />
                                                    <asp:BoundField DataField="Redressal" HeaderText="Redressal" />
                                                    <asp:BoundField DataField="Date of grievance raised" HeaderText="Date of Grievance Raised" />
                                                    <asp:BoundField DataField="Date of Grievance redressed" HeaderText="Date of Grievance Redressed" />
                                                    <asp:BoundField DataField="No of days taken for the grievance" HeaderText="No of days Taken For the Grievance" />
                                             <asp:TemplateField HeaderText="Attachments">
                                                <ItemTemplate>
                                                    <%--<asp:LinkButton ID="LinkButton1" target="blank"  Text="View" runat="server" Url='<%# Eval("Attachments") %>'></asp:LinkButton>--%>
                                                    <asp:HyperLink ID="HyperLink2" Target="_blank" NavigateUrl='<%# Eval("Attachments") %>' runat="server">View</asp:HyperLink>
                                                </ItemTemplate>
