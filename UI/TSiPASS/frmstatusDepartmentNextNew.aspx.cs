...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string fromdt = Request.QueryString[4].ToString().Trim();
            string todt = Request.QueryString[5].ToString().Trim();


            txtFromDate.Text = fromdt;
            txtTodate.Text = todt;
            ...
            ds = Gen.RetriveStatusForViewApplicationDepartmentwiseNew(Request.QueryString[0].ToString().Trim(), ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, Request.QueryString[1].ToString().Trim(), FromdateforDB, TodateforDB, Request.QueryString[6].ToString().Trim());
            ...
            HyperLink1.NavigateUrl = "RptSTATUSOFPRESCRUTINYDEPARTMENTWISENew.aspx?Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
    ...
    protected void GetDepartment()
    {
        ...
        {
            lblHeading.Text = "Prescrutiny - Pending Beyond 3 days - ";// +dsd.Tables[0].Rows[0]["Dept_Name"].ToString();
            lblLink.Text = "Prescrutiny - Pending Beyond 3 days - ";// +dsd.Tables[0].Rows[0]["Dept_Name"].ToString();
        }
        ...
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename= " + FileName + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
