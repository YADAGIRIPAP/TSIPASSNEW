...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    void FillDetails()
    {
        ...
        ds = Gen.GetDepartmentDashboardDetailsRenewals(Session["User_Code"].ToString().Trim());
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //labNameandAddress0.Text = ds.Tables[0].Rows[0]["PropAddress"].ToString();
               ...
               Label4.Text =    ds.Tables[0].Rows[0]["No of ApplicationReceived"].ToString();
            Label12.Text = ds.Tables[0].Rows[0]["Awaiting for payment"].ToString();

            Label1.Text = ds.Tables[0].Rows[0]["Renewals"].ToString();
            Label2.Text = ds.Tables[0].Rows[0]["Rejected"].ToString();
