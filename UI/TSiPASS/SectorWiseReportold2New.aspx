<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="SectorWiseReportold2New.aspx.cs" Inherits="UI_TSiPASS_SectorWiseReportold2New" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 class="panel-title">
                                <asp:Label ID="lblHeading" runat="server" Font-Bold="true"> R6.2 : Sector wise Abstract </asp:Label>
                                        ...
                                        <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField FooterStyle-CssClass="text-center" DataTextField="Investment"
                                                    ...
                                                    <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Underline="false" CssClass="text-right" />
                                                    <ItemStyle Font-Underline="false" Wrap="true" HorizontalAlign="Center" CssClass="text-right" />
                                                </asp:HyperLinkField>
