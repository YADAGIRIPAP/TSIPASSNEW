<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="FeedBackDashBoard.aspx.cs" Inherits="UI_TSiPASS_FeedBackDashBoard" %>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px;" align="center">
                                                                <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                    CellPadding="4" CssClass="GRD" ForeColor="#333333" Height="62px" OnRowDataBound="grdDetails_RowDataBound"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:HyperLinkField DataTextField="total" HeaderText="Total Feedbacks" NavigateUrl="FeedBackStatusDetails.aspx?Status=All" />
                                                                    </Columns>
