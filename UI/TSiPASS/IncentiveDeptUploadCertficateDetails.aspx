<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="IncentiveDeptUploadCertficateDetails.aspx.cs"
    Inherits="TSTBDCReg1" %>
                                                                        ...
                                                                        <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                        ...
                                                                                        <asp:UpdatePanel runat="server" UpdateMode="Conditional" RenderMode="Inline" ID="updFU">
                                                                                            <ContentTemplate>
                                                                                                <table style="width: 100%" cellpadding="4" cellspacing="5">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="DdlStatus" runat="server" CssClass="form-control txtbox" Height="32px"
                                                                                                                Width="120px" AutoPostBack="True" OnSelectedIndexChanged="DdlStatus_SelectedIndexChanged">
                                                                                                    ...
                                                                                                    <tr runat="server" id="trRemarks">
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="TxtRemarks" runat="server" class="form-control txtbox" Height="56px"
                                                                                ...
                                                                                <asp:TemplateField HeaderText="View Inspection Report">
                                                                                    <ItemTemplate>
                                                                                        <a id="View" target="_blank" href="<%# Eval("FilePathReport") %>">View</a>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
