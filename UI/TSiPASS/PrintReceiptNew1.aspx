<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PrintReceiptNew1.aspx.cs" Inherits="InterfaceNetBanking_PrintReceipt" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center">
            <tr>
                <td>
                    <div id="Receipt" runat="server" style="width: 595px; height: 742px;">
                                        ...
                                        <tr>
                                            <td valign="top" class="style2">
                                                <table align="center" border="1" style="width: 100%; border-right: #000000 thin solid;
                                                    ...
                                                    <tr>
                                                        <td align="right" visible="false" class="style1">
                    EM No / Udyog Aadhaar:
                                                            :</td>
                    ...
                    District::
                                        ...
                                        <tr>
                                            <td align="left" class="tdStyle">
                                                <strong>Note:- Print this Raw Material receipt for further reference.</strong></td>
                                        </tr>
                                        </table>
                                </td>
                            </tr>
