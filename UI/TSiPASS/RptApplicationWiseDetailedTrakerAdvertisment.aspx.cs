...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerAdvertisment : System.Web.UI.Page
{
    ...
    public DataSet ApplicationWiseDetailedTrakerTourismEvent(string Quesionary_id)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SOA_RetriveR4ReportAdvertisment", con);
