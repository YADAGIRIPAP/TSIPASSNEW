<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="ADDITIONAL_DIRECTOR_LIST_APPROVAL.aspx.cs" Inherits="UI_TSiPASS_ADDITIONAL_DIRECTOR_LIST_APPROVAL" %>
        ...
        <div class="col-lg-12">
            ...
            <table style="width: 100%" id="divUpdate" runat="server">
                <tr>
                    <td>
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="left" style="font-size: large">Cheque Preparation List ADDITIONAL DIRECTOR</h1>
                        </div>
            ...
            <%--<FooterStyle BackColor="#1d9a5b" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />--%> <RowStyle BackColor="#D1DDF1" Font-Bold="True" CssClass="GRDITEM" HorizontalAlign="Center" VerticalAlign="Middle"/>
                ...
                <table>
                    <tr>
                        <td colspan="1" style="padding: 5px; margin: 5px" align="Center" class="style7"
                            ...
                            <br />
                            <asp:Button ID="UpdateFlagToDB" CssClass="btn btn-primary" runat="server" Text="Approve and Forward to ACCOUNTS OFFICER"
                ...
                <div>
                    <tr>
                        <td align="center"><asp:Label ID="lblSuccessMessage" runat="server" ForeColor="#800020" Font-Bold="true" class="alert blink alert-dismissible" data-dismiss="alert" text-size="50px" Text="" /><br /></td>
                    </tr>
                </div>
