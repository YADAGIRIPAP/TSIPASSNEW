<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmQuesstionniareRegEdit.aspx.cs" Inherits="UI_TSiPASS_frmQuesstionniareRegEdit" %>
                                                            ...
                                                            <tr id="trmarketvalue" runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtmarketvalue" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="20" onkeypress="return inputOnlyNumbers(event)" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "txtmarketvalue" ID="RegularExpressionValidator1" ValidationExpression = "^[0-9]{5,20}$" runat="server" ErrorMessage="Market value of land cannot be lessthan Rs.10000/-">
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid;
                                    ...
                                    <tr id="Tr1" runat="server" visible="true">
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">
                                            Does your establishment provide 05 or more inter-state migrant workmen on contractual basis as defined in the Inter-state Migrant Workmen Act, 1979?(for Contractor)
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                    ...
                                    <tr id="tr20d" runat="server" visible="false">
                                      ...
                                      <tr id="tract5License" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">
                                            Does your establishment employ 05 or more contract Laour as defined in the Contract Labour Act(Contractor) - License?
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            :
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Does the unit Location fall within 100mts vicinity of any water body?</td>
                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rdvicinitywaterbody" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding: 15px; margin: 5px" valign="top" height="40px">22. </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RadioButtonList ID="RdpIndustry" runat="server"
                                                RepeatDirection="Horizontal" Width="200px" TabIndex="1" OnTextChanged="RdpIndustry_TextChanged" AutoPostBack="true">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server"
                                                ControlToValidate="RdpIndustry" ErrorMessage="Please Select meter to your (HT)"
                                                ValidationGroup="group">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr id="trregulation" runat="server" visible="false">
                                        <td height="40px" style="padding: 15px; margin: 5px" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">Regulation</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr id="trvoltage" runat="server" visible="false">
                                        <td height="40px" style="padding: 15px; margin: 5px" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">Voltage</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="ddlvoltage" ErrorMessage="Please select Voltage" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator></td>
                                    </tr>
                                    <tr id="trPlant" runat="server" visible="false">
                                        <td height="40px" style="padding: 15px; margin: 5px" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">Plant</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ControlToValidate="ddlplant" ErrorMessage="Please select Plant" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator></td>
                                    </tr>
                                    ...
                                    <tr id="tr2" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtremarks" TextMode="MultiLine" CssClass="form-control" Height="180px" runat="server"></asp:TextBox>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator31" runat="server" ControlToValidate="txtremarks" ErrorMessage="Please enter remarks" ValidationGroup="group">*</asp:RequiredFieldValidator></td>
                                    </tr>
