<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptApplicationWiseDetailedTrakerREN.aspx.cs" Inherits="UI_TSiPASS_RptApplicationWiseDetailedTrakerREN" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Certificate">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HyperLink ID="HyperLink2" Text='<%# Eval("FileName") %>' Target="_blank" NavigateUrl='<%# Eval("link") %>' runat="server"></asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle Width="20px" />
                                            </asp:TemplateField>
