<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TRAVEL_AGENCY.aspx.cs" Inherits="UI_TSiPASS_TRAVEL_AGENCY" %>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center;padding:0px;" >
                            <h3 style="color: #0000FF; font-size: medium; text-align: center; font-family: Verdana;">(TRAVEL AGENCY)</h3>
                        <br />
