...
public partial class UI_TSiPASS_frmDepartementDashboardNewREN : System.Web.UI.Page
{
    ...
    public DataSet GetDepartmentDashboardDetailsREN(string intDeptid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("sp_GetDepartmentDashboardDetailsREN_TEST", con.GetConnection);
