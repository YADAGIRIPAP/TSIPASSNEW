<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptCA.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
   ...
   function GetRowValue(val)
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    Width="165px">County Adminstration</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtca" runat="server" class="form-control txtbox" 
                            ...
                            <tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                         <asp:HyperLinkField  HeaderText="Edit" DataTextField="intCountyAdm">
      ...
      <FooterStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="CountyAdmName" HeaderText="County Admin Name" />
