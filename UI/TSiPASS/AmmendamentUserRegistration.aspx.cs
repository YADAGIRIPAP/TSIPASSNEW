...
public partial class UI_TSiPASS_AmmendamentUserRegistration : System.Web.UI.Page
{
    ...
    protected void GetDepartment()
    {
        try
        {
            ...
            dsd = Gen.GetAmmendamentFullName();
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dsUser = Gen.CheckUseridAmmendament(txtname2.Text.Trim());
            //
            ...
            int i = Gen.AddnewAmmendamentUserRegistration(ddlDepartment.SelectedValue, txtDesignation.Text, ddlDistrict.SelectedValue, ddlMandal.SelectedValue,
