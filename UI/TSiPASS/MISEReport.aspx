<%@ Page Title=":: TS-iPASS :: MSME Catalogue  " Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master"AutoEventWireup="true" CodeFile="MISEReport.aspx.cs" Inherits="TSTBDCReg1" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">TSI Catalogue Report</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">TSI Catalogue Report</h3>
                            </div>
...
--%>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="style6">
                                                                    :</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddltypeofncentive" runat="server" 
...
--%>
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <table cellpadding="7" cellspacing="7" class="style5">
                                                            <tr>
                                                                <td height="40px">
                                                                    <asp:Label ID="Label454" runat="server" CssClass="LBLBLACK" 
                                                                        Width="200px">SSI Reg./EM/Udyog Aadhar/IEM/SIA/IEC No.</asp:Label>
                                                                </td>
                                                                <td>
                                                                    :</td>
                                                                <td>
                                                                    <asp:TextBox ID="txtEMpartnumber" runat="server" class="form-control txtbox" 
                                                                        Height="28px" MaxLength="100" TabIndex="1" ValidationGroup="group" 
                                                                        Width="180px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    :</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddlCategory0" runat="server" class="form-control txtbox" 
                                                                        Height="33px" TabIndex="1" Width="180px">
                                                                        <asp:ListItem>--Select--</asp:ListItem>
...
<asp:ListItem>General</asp:ListItem>--%>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    &nbsp;</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddlCategory1" runat="server" class="form-control txtbox" 
                                                                        Height="33px" TabIndex="1" Width="180px">
                                                                        <asp:ListItem>--Select--</asp:ListItem>
