...
public partial class UI_TSiPASS_RptYEARWISEPROGRESSNew : System.Web.UI.Page
{
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=R1.3 CFE Abstract -Financial Year wise " + DateTime.Now.ToString("MM-dd-yyyy") + ".xls");
            Response.Charset = "";
        ...
        try
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename= R1.3 Abstract -Financial Year wise  " + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R1.3 CFE Abstract -Financial Year Wise\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
