...
public partial class UI_TSiPASS_comReportDrillNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //lbldate.Text = "Report as on date " + DateTime.Now;
            div_Print.Attributes.Add("style", "display:none");
            FromDateFinancialYear();
        }
                ...
                if (grdDetails.Rows[i].RowType == DataControlRowType.DataRow)
                {
                    for (int j = 0; j < CountColumns; j++)
                    {
                        ...
                        //if (j == 0 && (cellText == "CFE - Total" || cellText == "CFO - Total" || cellText == "CFE + CFO TOTAL" || cellText == "GRAND TOTAL"))
                        {
                            ...
                            || cellText == "INCENTIVES" || cellText == "RECEIVED CFO NOT APPLIED FOR INCENTIVES" || cellText == "MONTHLY PERFORMANCE REPORT" || cellText == "MSME CATALOGUE DETAILS UPLOADED")
                        {
                            phrase.Add(new Chunk(cellText, FontFactory.GetFont("Trebuchet MS", 11, Font.BOLD, Color.BLACK)));
                        }
                        else
                        {
                            ...
                            //if ((cellTextnew1 == "A" || cellTextnew1 == "B" || cellTextnew1 == "C" || cellTextnew1 == "D" || cellTextnew1 == "E" || cellTextnew1 == "F" || cellTextnew1 == "G"))
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (testing2 == "GRIEVANCES" || testing2 == "GRIEVANCES" || testing2 == "DEPT GRIEVANCES" || testing2 == "-CFE" || testing2 == "-CFO")
            {
                h1.Font.Bold = false;
                HyperLink h12 = (HyperLink)e.Row.Cells[2].Controls[0];
                if (testing2 == "-CFE" || testing2 == "-CFO" || testing2 == "DEPT GRIEVANCES")
                {
                ...
                h12.NavigateUrl = "comRepDrill_dist.aspx?CODE=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Type")).Trim() + "&fromdate=" + FromdateforDB + "&todate=" + TodateforDB;
                            ...
                            || testing2 == "INCENTIVES" || testing2 == "RECEIVED CFO NOT APPLIED FOR INCENTIVES" || testing2 == "MONTHLY PERFORMANCE REPORT" || testing2 == "MSME CATALOGUE DETAILS UPLOADED")
            {
    ...
    protected void grdDetails_PreRender(object sender, EventArgs e)
    {
        foreach (GridViewRow grdrow in grdDetails.Rows)
        {
            ...
            if (statusLabel.Text == "PENDENCY BEYOND TIMELIMITS" || statusLabel.Text == "APPEAL PENDENCY" || statusLabel.Text == "INCENTIVE" || statusLabel.Text == "MONTHLY PERFORMANCE REPORT" || statusLabel.Text == "MSME CATALOGUE DETAILS UPLOADED" || statusLabel.Text == "STATUS OF IMPLEMENTATION BEYOND 6 MONTHS ABOVE" || statusLabel.Text == "RECEIVED CFO NOT APPLIED FOR INCENTIVES")//|| statusLabel.Text == "PENDENCY "
            {
    ...
    protected void grdDetails1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (testing2 == "GRIEVANCES" || testing2 == "GRIEVANCES" || testing2 == "DEPT GRIEVANCES" || testing2 == "-CFE" || testing2 == "-CFO" || testing2 == "RECEIVED CFO NOT APPLIED FOR INCENTIVES")
            {
                e.Row.Cells[1].HorizontalAlign = HorizontalAlign.Right;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (testing2 == "GRIEVANCES" || testing2 == "GRIEVANCES" || testing2 == "QUERY" || testing2 == "-CFE" || testing2 == "-CFO" || testing2 == "RECEIVED CFO NOT APPLIED FOR INCENTIVES")
            {
                h1.Font.Bold = false;
                HyperLink h12 = (HyperLink)e.Row.Cells[2].Controls[0];
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (testing2 == "CFE" || testing2 == "CFO" || testing2 == "RAW MATERIALS" || testing2 == "RENEWALS" || testing2 == "NOT YET ASSIGNED BY GM" || testing2 == "INCENTIVE GM RECOMMEND PENDENCY" || testing2 == "INSPECTION DATE NOT YET ASSIGNED" || testing2 == "INSPECTION REPORT NOT UPLOADED" || testing2 == "QUERY NOT RESPONDED BEYOND 30 DAYS BY APPLICANT" || testing2 == "REPORT NOT SUBMITTED" || testing2 == "REPORT SUBMITTED" || testing2 == "REPORT NOT SUBMITTED BUT SALARY PROCESSED" || testing2 == "REPORT SUBMITTED BUT SALARY NOT YET PROCESSED" || testing2 == "INITIAL STAGE" || testing2 == "Yet to Start Construction" || testing2 == "ADVANCED STAGE" || testing2 == "RECEIVED CFO ELIGIBLE FOR INCENTIVES" || testing2 == "RECEIVED CFO NOT ELIGIBLE FOR INCENTIVES")
            {
                ...
                h1.Font.Bold = false;
                HyperLink h2 = (HyperLink)e.Row.Cells[2].Controls[0];
                if (testing2 == "CFE" || testing2 == "CFO" || testing2 == "RAW MATERIALS" || testing2 == "RENEWALS" || testing2 == "NOT YET ASSIGNED BY GM" || testing2 == "INCENTIVE GM RECOMMEND PENDENCY" || testing2 == "INSPECTION DATE NOT YET ASSIGNED" || testing2 == "INSPECTION REPORT NOT UPLOADED" || testing2 == "QUERY NOT RESPONDED BEYOND 30 DAYS BY APPLICANT" || testing2 == "REPORT NOT SUBMITTED" || testing2 == "INITIAL STAGE" || testing2 == "Yet to Start Construction" || testing2 == "ADVANCED STAGE" || testing2 == "QUERY" || testing2 == "COMMENCED OPERATIONS" || testing2 == "RECEIVED CFO ELIGIBLE FOR INCENTIVES" || testing2 == "RECEIVED CFO NOT ELIGIBLE FOR INCENTIVES")
                {
                    h2.Style.Add("color", "#ff4615");
                }
                h2.NavigateUrl = "comRepDrill_dist.aspx?CODE=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Type")).Trim() + "&fromdate=" + FromdateforDB + "&todate=" + TodateforDB;
            }
            else if (testing2 == "GRIEVANCES" || testing2 == "GRIEVANCES" || testing2 == "QUERY" || testing2 == "-CFE" || testing2 == "-CFE" || testing2 == "RECEIVED CFO NOT APPLIED FOR INCENTIVES")
            {
                e.Row.Cells[1].HorizontalAlign = HorizontalAlign.Right;
                h1.Font.Bold = false;
                HyperLink h12 = (HyperLink)e.Row.Cells[2].Controls[0];
            ...
            if (testing2 == "INCENTIVES" || testing2.Contains("RECEIVED CFO NOT APPLIED FOR INCENTIVES") || testing2.Contains("MONTHLY PERFORMANCE REPORT") || testing2.Contains("MSME CATALOGUE DETAILS"))
            {
                e.Row.Cells[1].HorizontalAlign = HorizontalAlign.Center;
            }
            //h1.NavigateUrl = "comReportDrill_drilldown.aspx?CODE=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Type")).Trim();
