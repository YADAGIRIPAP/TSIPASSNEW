<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="IncentivesFeedBackForm.aspx.cs" Inherits="UI_TSiPASS_IncentivesFeedBackForm" %>
    ...
    <form id="form1" runat="server">
        <table align="center"
            ...
            <tr style="padding: 0px; margin: 0px; border: 1px solid #000000; font-family: Verdana; font-size: 18px;">
                <td align="center" style="text-align: center; font-family: Verdana; font-weight: bold; font-size: 18px; border: 1px solid #000000;" class="auto-style1">TS-iPASS INCENTIVES FEEDBACK FORM</td>
            </tr>
            <tr>
                            ...
                            <td colspan="2">
                                <table>
                                    <tr id="tr1" runat="server">
                                        ...
                                        <td align="left"><b>Are you aware that the application for all State Incentives is being provided in a common form through the TS-iPASS online single window system to all industries / business</b><br />
                                            <br />
                                    ...
                                    <tr id="tr2" runat="server">
                                        ...
                                        <td align="left"><b>Were you able to find the required information related to procedures, documents checklist applicable for availing the service on the website<br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr3" runat="server">
                                        ...
                                        <td align="left"><b>Are you aware of the timelines within which the departments have to fulfill the applied services<br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr4" runat="server">
                                        <td style="margin: 5px; font-weight: bold;" valign="top">4. </td>
                                        <td align="left"><b>Were you able to submit the entire application online, and uploading of documents<br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr5" runat="server">
                                        ...
                                        <td align="left"><b>Were you given the intent letter/ sanction letter within the stipulated timelines and were you able to download them through the online portal<br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr7" runat="server">
                                        ...
                                        <td align="left"><b>Were you asked for any offline information or documents for application processing
                                            <br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr8" runat="server">
                                        ...
                                        <td align="left"><b>Was the inspection of you premises conducted on the scheduled date<br />
                                        </b>
                                            <br />
                                    ...
                                    <tr id="tr9" runat="server">
                                        ...
                                        <td align="left"><b>Were you happy with the overall quality of the TS-iPASS system<br />
                                        </b>
                                            <br />
