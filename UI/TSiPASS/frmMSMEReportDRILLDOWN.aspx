<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmMSMEReportDRILLDOWN.aspx.cs" Inherits="UI_TSiPASS_frmMSMEReportDRILLDOWN" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:TemplateField>
                                    ...
                                    <asp:HiddenField ID="hdfMSMENo" runat="server" Value='<%# Eval("msmeNo") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="UID NO">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUIDNo" runat="server" Text='<%# Eval("UIDNO") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Unable to Map">
                                        <ItemTemplate>
                                            <asp:RadioButtonList ID="rdbUnabletoMap" AutoPostBack="true" runat="server" RepeatDirection="Horizontal"
                                                OnSelectedIndexChanged="rdbUnabletoMap_SelectedIndexChanged">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                            <asp:Button ID="BtnReject" Visible="false" runat="server" CausesValidation="False" CssClass="btn-danger"
                                                Height="32px" OnClick="BtnReject_Click" TabIndex="11" Text="Submit" ValidationGroup="group"
                                                Width="100px" />
                                                 <asp:Button ID="btnInsertCatalogue" visible="false" runat="server" CausesValidation="False" CssClass="btn-danger"
                                                Height="32px"  TabIndex="11" Text="Insert into Catalogue" ValidationGroup="group"
                                                Width="150px" OnClick="btnInsertCatalogue_Click" />
                                            <br />
                                            <br />
