...
public partial class UI_TSiPASS_waltaform3 : System.Web.UI.Page
{
    string Applicantid = "";
    string downloadfilename = "Form3";
...
//2
                                ...
                                //ApplicationType_IndusorAgriName
                                //lbl_insuredamount.Text = Convert.ToString(ds.Tables[0].Rows[0]["AddressApplicant"]);
                                //lbl_policyNo.Text = Convert.ToString(ds.Tables[0].Rows[0]["AddressApplicant"]);
                                lbl_applicantfee.Text = Convert.ToString(ds.Tables[0].Rows[0]["Amountpaid"]);
                                //lbl_place.Text = Convert.ToString(ds.Tables[0].Rows[0]["AddressApplicant"]);
