...
public partial class UI_TSiPASS_UserFormView_plotallotment : System.Web.UI.Page
{
    ...
    {
        Applicationid = Convert.ToInt32(Request.QueryString["intApplid"].ToString());
        if (!IsPostBack)
        {
    ...
    public DataSet tsiicdetailsdata(int applicationid)
    {
        try
        {
            ...
            GDs = Gen.GenericFillDs("USP_GET_TSIICabsractDETAILS_deptplotallotment", p);
