<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster_Meeseva.master"
    AutoEventWireup="true" CodeFile="Incentives_Meeseva.aspx.cs" Inherits="Incentives_Meeseva" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style type="text/css">
        /*Calendar Control CSS*/.cal_Theme1 .ajax__calendar_container
        {
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        <ContentTemplate>
            ...
            <div class="style4" style="padding: 5px; margin: 5px; font-weight: bold; font-size: 16px;">
                <a href="Helpdesk_MeeSeva.aspx" target="_blank">If any technical Issues, please click
                    here to register in Help-Desk</a>
            </div>
            <div align="left">
                                                ...
                                                <td style="padding: 5px; margin: 5px" align="center">
                                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style26" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtEmUdgAadhar" runat="server" class="form-control txtbox" Height="28px"
                                                                    MaxLength="12" TabIndex="1" ValidationGroup="Save" Width="180px" AutoPostBack="True"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style21" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtLandValue" runat="server" CssClass="text-right" class="form-control txtbox"
                                                                    Height="28px" MaxLength="40" TabIndex="19" ValidationGroup="group" Width="180px"
                                                                    AutoPostBack="True" OnTextChanged="txtTotalValueCalculation"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style21" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtBuildingValue" runat="server" class="form-control txtbox" Height="28px"
                                                                    MaxLength="40" TabIndex="20" ValidationGroup="group" Width="180px" AutoPostBack="True"
                                                                    OnTextChanged="txtTotalValueCalculation" CssClass="text-right"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style37" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtPlantandMachinery" runat="server" class="form-control txtbox"
                                                                    Height="28px" MaxLength="40" TabIndex="21" ValidationGroup="group" Width="180px"
                                                                    AutoPostBack="True" OnTextChanged="txtTotalValueCalculation" CssClass="text-right" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtTotal" runat="server" class="form-control txtbox" Enabled="false"
                                                                    Height="28px" MaxLength="40" TabIndex="23" ValidationGroup="group" Width="180px"
                                                                    CssClass="text-right" />
                                                        ...
                                                        <tr runat="server" id="trSectorVeh">
                                                            ...
                                                            <td class="style42" colspan="9" style="padding: 5px; margin: 5px; text-align: left;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtDateofCommencement" runat="server" class="form-control txtbox"
                                                                    Width="180px" AutoPostBack="true" OnTextChanged="txtDateofCommencement_TextChanged" />
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtvehicleRegistratioNumber" runat="server" class="form-control txtbox"
                                                                    Width="180px" MaxLength="15" Visible="false" />
                                                                <cc1:FilteredTextBoxExtender ID="fteVehNo" runat="server" TargetControlID="txtvehicleRegistratioNumber"
