...
public partial class UI_TSiPASS_TOURISM_EVENTS : System.Web.UI.Page
{
    ...
    public DataSet GetCFECertificatedata(string applicationid)
    {
        ...
        Dsnew = clsGeneral.GenericFillDs("getCertificateDetailsdata_TourismEvent", pp);
        return Dsnew;
    }
}