<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master"
    AutoEventWireup="true" CodeFile="frmViewAttachmentDetailsCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title">
                            View CFO Attachment Details</h3>
                    </div>
...
<ContentTemplate>--%>
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                    <table cellpadding="5px" cellspacing="5px" width="100%" style="font-size: 14px; font-family: Verdana;">
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366; font-weight: 700;">
                                                S.No
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyper8BNOC" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyper9BNOC" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperfireoccupancycertificate" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                GHMC Occupancy Certificate
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperGHMCoccupancycertificate" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperTSFTCANDTDCNOC" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                NOC of Film Chamber of Commerce
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperfirmchambernoc" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperfirmdivision" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Lease Agreement or any other relavent document
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperleaseagreement" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Blue print of Cinema Theatre/Multiplex with Screens and seating Capacity
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperblueprint" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Details with regard to Screens, seating and Ticket Rates proposed
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hyperseatingdetails" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:Label ID="Label423" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="196px">Demand Draft Attachments</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:Label ID="Label424" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="264px">Uplaod CFE Approval 
Attachments</asp:Label>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:Label ID="Label427" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="196px">Approval Attachment</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="227px">HMDA Occupancy Attachments</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                  ...
                                  <%--      <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaGifrDeed" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaLandvalueCert" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Photographs constructed building
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaPhotoGraphConst" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMdaBuildingComplete" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaFinalFire" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                State Central government order copy
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaStateCentralGovt" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Completed building plan
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaCompletedBuildingPlan" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style9" style="border: 1px solid #003366">
                                            ...
                                            <td class="style10" style="border: 1px solid #003366">
                                                Architect/Structural Engineer Completion Certificate
                                            </td>
                                            <td style="border: 1px solid #003366">
                                                <asp:HyperLink ID="hplHMDaEngineerCompleteCert" runat="server" ForeColor="#FF6600">[HyperLink1]</asp:HyperLink>
                                            </td>
                                        </tr>
