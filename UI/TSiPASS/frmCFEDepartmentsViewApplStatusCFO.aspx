<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmCFEDepartmentsViewApplStatusCFO.aspx.cs" Inherits="TSTBDCReg1" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Update Application Details</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">View Department Approval Status</h3>
                            </div>
...
<ContentTemplate>
                                        ...
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                            <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:BoundField DataField="nameofunit" HeaderText="Name of Industry">
                                                    </asp:BoundField>
                    ...
                    DataNavigateUrlFormatString="KeywordSrchSumDtl.aspx?Keyword={0}&State={1}&City={2}"/>--%>
                     <asp:HyperLinkField HeaderText="Respond to Query"  Text="Respond" />
                     ...
                     <asp:BoundField DataField="intApprovalid" HeaderText="Department Approval ID" Visible="false" />
                     <%--DataNavigateUrlFields="intQueryTrnsid" DataTextField="intQueryTrnsid"  
                    DataNavigateUrlFormatString="frmResponceQueries.aspx?intQueryTrnsid={0}"--%>
                                                </columns>
