...
public partial class UI_TSiPASS_RptGrievanceDrill : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ds = Gen.RetriveStatusByTypeDistrictNewGrievance(status, DistrictID, FromdateforDB, TodateforDB);
            ...
            HyperLink1.NavigateUrl = "RptGrievance.aspx";
        }
    }
