...
public partial class UI_TSiPASS_frmIncentiveSanctionedYearwiseDrilldown : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("USP_GET_INCENTIVES_SANCTIONED_YEARWISE_Drilldown", con);
