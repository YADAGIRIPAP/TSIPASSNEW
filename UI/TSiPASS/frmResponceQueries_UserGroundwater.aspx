<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmResponceQueries_UserGroundwater.aspx.cs" Inherits="UI_TSiPASS_frmResponceQueries_UserGroundwater" %>
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="lbl_headplaceofrto" runat="server" CssClass="LBLBLACK" Width="165px">Mandal<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
