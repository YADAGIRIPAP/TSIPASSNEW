<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="RawMaterialsReportNew1.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" >
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="District Name" DataField="District" />
                                                <asp:BoundField HeaderText="Mandal Name" DataField="Mandal" />
                                                <asp:BoundField HeaderText="Raw Meterial" DataField="RawmaterialforAllotment" />
                                                <asp:BoundField HeaderText="Requirement" DataField="Requirement" />
                                               <%-- <asp:BoundField HeaderText="Usagedetails" DataField="Usagedetails" ControlStyle-Width="50px" />--%>
