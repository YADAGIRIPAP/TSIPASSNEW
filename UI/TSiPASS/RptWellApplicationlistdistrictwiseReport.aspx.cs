...
public partial class UI_TSiPASS_RptWellApplicationlistdistrictwiseReport : System.Web.UI.Page
{
   ...
   string Category = ""; string Districtid = ""; string DistrictName = ""; string applicationtype = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lbl_headtitle.Text = "Well Applications-" + DistrictName;
    ...
    public void fillgrid(string Typedataofappl,string Districtid)
    {
        ...
        vehicleDS = obj_insert.DB_RptWellApplicationlistdistrictwiseReport(Typedataofappl,Districtid);
