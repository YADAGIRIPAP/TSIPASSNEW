<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CommensedOperationDrilldown.aspx.cs" Inherits="UI_TSiPASS_CommensedOperationDrilldown" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeader" runat="server">R6.14: Status of Implementations </asp:Label>
                                <asp:Label ID="LblGet" runat="server" Visible="true"></asp:Label>
                                        ...
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 100%">
                                            <tr>
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/frmCommensedOperation.aspx"
                                                        Text="<< Back">
                                                    </asp:HyperLink>
                                                </td>
                                            </tr>
                                    ...
                                    <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                                        <asp:GridView ID="grdReports" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="UnitName" HeaderText="Name of Industry" />
