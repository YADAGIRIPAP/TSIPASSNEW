...
public partial class UI_TSiPASS_appraisalnoteprint_stampland : System.Web.UI.Page
{
    ...
    public void getDetails()
    {
        ...
        foreach (string Item in arListApplNo)
        {
            ...
            da.SelectCommand.Parameters.Add("@mstincentiveid", SqlDbType.VarChar).Value = "14";
            da.Fill(ds);
            ...
            if (ds.Tables[0].Rows.Count > 0)//[lblLand_ProjectCost]   
            {
                ...
                sbPrint.Append("</table></td></tr></table>");
                sbPrint.Append("<table  align='center' style='width: 650px;' border='0' cellpadding='0px' cellspacing='0px'>");
                sbPrint.Append("<tr ><td><table cellpadding='0px' cellspacing='0px' style='width: 100%;'><td style='height: 10px; width: 0px;' class='addressing' valign='top' align='left'> </td><td style='height: 15px; width: 900px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; a) Land Measuring In Sq. Mtrs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 500px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; " + ds.Tables[0].Rows[0]["LandSqmt"].ToString() + " &nbsp;</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; b) Stamp Duty Paid by the unit in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["StampDuty"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; c) Building Plinth area in Sq. Mtrs. </td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["BuildingPlinth"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; d) Proportionate value for the area in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["Proportionatearea"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; e) Value Recommended by G.M. DIC. in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["GMValue"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; f) Five Times of Building plinth Area.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["StampBuildingPlinth"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; g) Final Eligible Amount</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["FINALELIGIBLEAMOUNT"].ToString() + "</td></tr>");
