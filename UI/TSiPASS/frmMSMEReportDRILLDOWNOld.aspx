<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmMSMEReportDRILLDOWNOld.aspx.cs" Inherits="UI_TSiPASS_frmMSMEReportDRILLDOWNOld" %>
                        ...
                        <td align="center" colspan="4" style="padding: 5px; margin: 5px; text-align: center;"
                            ...
                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CATEGOERY_ID" ItemStyle-HorizontalAlign="Center" HeaderText="CATEGORY">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="LINE_OF_ACTIVITY" ItemStyle-HorizontalAlign="Center" HeaderText="LINE OF ACTIVITY">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PRODUCT_SPEC" ItemStyle-HorizontalAlign="Center" HeaderText="PRODUCT SPECIFY">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
