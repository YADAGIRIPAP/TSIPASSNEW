<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPageCFO.aspx.cs" Inherits="UI_TSIPASS_KotakPageCFO" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerCFO.aspx">
        <div id="myDIV">
            ...
            <table id="Table1" width="50%" height="100" border='1' align="center" runat="server" visible="true" style="display: none">
                <tr>
...
<%--                    <td>
                ...
                <tr>
                    <td>Redirect URL	:</td>
                    <td>
                        <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerCFO.aspx" /></td>
                </tr>
                <tr>
                    <td>Cancel URL	:</td>
                    <td>
                        <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmDepartmentApprovalPaymentDetailsCFO.aspx" /></td>
                </tr>
                <tr>
                    <td>Language	:</td>
                    <td>
                ...
                <tr>
                    <td>Billing Name	:</td>
                    <td>
                        <input type="text" name="billing_name" value="" /></td>
                </tr>
                <tr>
                    <td>Billing Address	:</td>
                    <td>
                        <input type="text" name="billing_address" value="" /></td>
                </tr>
                <tr>
                    <td>Billing City	:</td>
                    <td>
                        <input type="text" name="billing_city" value="" /></td>
                </tr>
                <tr>
                    <td>Billing State	:</td>
                    <td>
                        <input type="text" name="billing_state" value="" /></td>
                </tr>
                <tr>
                    <td>Billing Zip	:</td>
                    <td>
                        <input type="text" name="billing_zip" value="" /></td>
                </tr>
                <tr>
                    <td>Billing Country	:</td>
                    <td>
                        <input type="text" name="billing_country" id="billing_country" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Tel	:</td>
                    <td>
                        <input type="text" name="billing_tel" id="billing_tel" runat="server" /></td>
                </tr>
                <tr>
                    <td>Billing Email	:</td>
                    <td>
                        <input type="text" name="billing_email" id="billing_email" runat="server" /></td>
                </tr>
                <tr>
