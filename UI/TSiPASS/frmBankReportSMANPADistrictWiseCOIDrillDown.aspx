<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBankReportSMANPADistrictWiseCOIDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmBankReportSMANPADistrictWiseCOIDrillDown" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">View Banker Applications</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-12">
                    ...
                    <tr>
                        <td colspan="4">
                            <table width="100%">
                                ...
                                <tr runat="server" id="trBetweenDates" runat="server" visible="false">
                        ...
                        <td align="center" colspan="4" style="padding: 5px; margin: 5px; text-align: center;"
                            ...
                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Bank Name" ItemStyle-HorizontalAlign="Center" HeaderText="Bank Name">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NAME_OF_THE_UNIT" ItemStyle-HorizontalAlign="Center" HeaderText="NAME OF UNIT">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LINE_OF_ACTIVITY" ItemStyle-HorizontalAlign="Center" HeaderText="SECTOR">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DISTRICT_ID" ItemStyle-HorizontalAlign="Center" HeaderText="DISTRICT NAME">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MANDAL_ID" ItemStyle-HorizontalAlign="Center" HeaderText="MANDAL NAME">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CONTACT_NO" ItemStyle-HorizontalAlign="Center" HeaderText="MOBILE NUMBER">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EMAIL_ID" ItemStyle-HorizontalAlign="Center" HeaderText="EMAIL ID">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="TYPEOFACCOUNT" ItemStyle-HorizontalAlign="Center" HeaderText="Type of Account">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NOTIFIEDDATE" ItemStyle-HorizontalAlign="Center" HeaderText="NOTIFIED DATE">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LOANAMOUNT" ItemStyle-HorizontalAlign="Center" HeaderText="LOAN AMOUNT(In Lakhs.)">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LOANDATE" ItemStyle-HorizontalAlign="Center" HeaderText="LOAN APPLICATION DATE">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="APPLICATIONDATE" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Entry">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
