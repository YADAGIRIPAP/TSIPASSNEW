...
public partial class UI_TSiPASS_IncentiveProceedingsStep1DIPC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ds = gen.getincentiveDIPClistStep1(Request.QueryString[0].ToString());
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtGoNo != "" && txtGodate != "" && txtLocno != "" && txtLocdate != "" && lblsactionedAmount != "")
            {
                ...
                Response.Redirect("ReleaseProcedingsStep2DIPC.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&sactionedAmount=" + lblsactionedAmount+"&SubIncId="+ lblSubIncType+ "&GoNo="+txtGoNo+"&GoDate="+txtGodate+"&LocNo="+txtLocno+"&LocDate="+txtLocdate);
