<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="RPTGlance2.aspx.cs" Inherits="LookupCA"
                ...
                <div class="panel panel-default" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;
                    ...
                    <div class="panel-body">
                        <table align="center" class="width" cellspacing="5">
                                    ...
                                    <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                <asp:HyperLink CssClass="btn btn-link" ID="BtnBack" runat="server" NavigateUrl="~/UI/TSiPASS/ReportsDashboard.aspx"
                                                    Text="<< Back">
                                                </asp:HyperLink>
                                            </td>
                            ...
                            <tr style="width: 100%">
                                <td colspan="2" style="padding: 5px;" valign="top" colspan="2">
                                    <table border="solid" style="width: 100%; border: 1px solid #929090;">
                                        ...
                                        <tr style="background-color: #84b2b9;">
                                            <td colspan="2" style="padding: 10px; margin: 5px; text-align: center; color: White;
                                                font-weight: bold;">
                                                <asp:Label ID="Label6" runat="server" CssClass="LBLBLACK">AT A GLANCE REPORT</asp:Label>
                                            </td>
                                            <td style="padding: 10px; margin: 5px; text-align: center; color: White;
                                                font-weight: bold;">
                                                <asp:Label ID="Label8" runat="server" CssClass="LBLBLACK">2016-2017</asp:Label>
                                            </td>
                                            <td style="padding: 10px; margin: 5px; text-align: center; color: White;
                                                font-weight: bold;">
                                        ...
                                        <tr>
                                            ...
                                            </td><td style="padding: 10px; margin: 5px; text-align: right;">
