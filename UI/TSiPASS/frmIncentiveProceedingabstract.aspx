<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmIncentiveProceedingabstract.aspx.cs" EnableEventValidation = "false" Inherits="UI_TSIPASS_frmIncentiveProceedingabstract" %>
        ...
        <div class="panel panel-default">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        <td style="text-align: left">
                            <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/IncentiveReportsDashboard.aspx"
                                Text="<< Back">
                            </asp:HyperLink>
                        </td>
                    </tr>
