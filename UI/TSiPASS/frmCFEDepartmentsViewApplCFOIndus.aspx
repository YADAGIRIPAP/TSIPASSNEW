<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmCFEDepartmentsViewApplCFOIndus.aspx.cs" Inherits="TSTBDCReg1" %>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" 
                                                    ...
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Small" 
                                                        NavigateUrl="~/UI/TSiPASS/frmDepartementDashboardNewCFOIndus.aspx">Back</asp:HyperLink>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="LastDateofPreScrutiy" 
                                                            ...
                                                            <asp:TemplateField HeaderText="Status">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" 
                                                                        ...
                                                                        <asp:ListItem Value="10">Completed with Payment Request</asp:ListItem>
                                                                        <asp:ListItem Value="16">Rejected</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <br />
                                                                    <asp:Label ID="Label378" runat="server" CssClass="LBLBLACK" Visible="False" 
                                                                        Width="180px">Query Description</asp:Label>
                                                                    <br />
                                                                    ...
                                                                    <asp:TextBox ID="txtAmount" runat="server" class="form-control txtbox" 
                                                                        Height="27px" MaxLength="10" onkeypress="return inputOnlyNumbers(event)" 
                                                                        TabIndex="1" ValidationGroup="group" Visible="False" Width="180px"></asp:TextBox>
                                                                    <br />
                                                            ...
                                                            <asp:TemplateField HeaderText="Submit">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="BtnSave" runat="server" CausesValidation="False" 
                                                                        ...
                                                                        OnClientClick="return confirm('Do you want to update the record ? ');" 
