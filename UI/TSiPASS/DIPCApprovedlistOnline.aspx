<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="DIPCApprovedlistOnline.aspx.cs" Inherits="UI_TSIPASS_DIPCApprovedlistOnline" %>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlApplicationMode" class="form-control txtbox"
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlworkingstatus" class="form-control txtbox"
                                                            ...
                                                            <asp:ListItem Value="1" Text="DIPC Approved and Yet to Release"></asp:ListItem>
                                                ...
                                                <tr>
                                                    <td style="vertical-align: middle; width: 200px" align="right">Application Timelines:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="DropDownList1" class="form-control txtbox"
                                                            Height="30px" Width="240px" TabIndex="1">
                                                            <asp:ListItem Value="0" Text="--All--"></asp:ListItem>
                                                    ...
                                                    <td style="vertical-align: middle; width: 200px" align="left" runat="server" id="td1">DIPC No :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlDIPCno" class="form-control txtbox"
                                                            Height="30px" Width="240px" TabIndex="1">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
