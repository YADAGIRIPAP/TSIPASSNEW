<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmBankReportDistrictWiseCOI.aspx.cs" Inherits="UI_TSiPASS_frmBankReportDistrictWiseCOI" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Banker Report District Wise</asp:Label>&nbsp;
                                        ...
                                        <td align="center" colspan="6" style="padding: 5px; margin: 5px">
                                            <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Bank Name" HeaderText="District Name" />
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No of Banks Registered"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofbanksregistered" runat="server" Text='<%#Eval("NOOFBANKS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="No Units" HeaderText="Banks Updated Nill Data" />

                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Banks Updated Data"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofUpdatedData" runat="server" Text='<%#Eval("NOOFUPDATED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Sick" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SARFAESI" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
