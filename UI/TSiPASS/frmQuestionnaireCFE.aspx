<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master"
    AutoEventWireup="true" CodeFile="frmQuestionnaireCFE.aspx.cs" Inherits="UI_TSiPASS_frmQuestionnaireCFE" %>
                                                            ...
                                                            <tr id="trmarketvalue" runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtmarketvalue" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="20" ValidationGroup="group" Width="180px" onkeypress="DecimalOnly()"></asp:TextBox>
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid;
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">
                                            Do you require approval from Commerical Tax
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rdprofessiontax" runat="server" Height="17px" RepeatDirection="Horizontal"
                                                Width="210px">
                                                <asp:ListItem Selected="True" Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr id="trvoltage" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:DropDownList ID="ddlvoltage" runat="server" class="form-control txtbox" Height="33px"
                                                TabIndex="1" Width="180px" OnSelectedIndexChanged="ddlvoltage_SelectedIndexChanged"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            ...
                                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%--<asp:TemplateField HeaderText="" ItemStyle-Width="60px">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnprocess" CssClass="btn btn-primary" OnClick="btnprocess_Click"
                                                                runat="server" Text="Apply Now" Width="60px" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                                                    <asp:TemplateField HeaderText="" ItemStyle-Width="60px">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkChecklist" ForeColor="blue" runat="server" NavigateUrl="https://ipass.telangana.gov.in/Information.aspx"
                                                    ...
                                                    <asp:TemplateField HeaderText="" ItemStyle-Width="80px">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkApplynow" ForeColor="blue" runat="server" NavigateUrl="https://ipass.telangana.gov.in/IpassLogin.aspx"
