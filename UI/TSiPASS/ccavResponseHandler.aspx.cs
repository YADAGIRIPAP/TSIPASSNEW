...
public partial class UI_ccavResponseHandler : System.Web.UI.Page
{
    private void Kotak()
    {
    ...
    private void billdesk()
    {
        try
        {
            if (!Page.IsPostBack)
            {
                string msg = "COITS|Bill20180620180412|RTGS|498871-002887|23467425.00|RTGS|516640|03|INR|DIRECT|NA|NA|00000000.00|20-06-2018 11:04:39|0300|NA|4714|MEG006000512762|CFE|NODEPT|txtadditional5| txtadditional6| txtadditional7|NA|Success|58BB0DF9AC4FA97402AF8341DBFFB539594629D3C7C34BEFCEECFD8B082AD697";
                ...
                if (msg != null)
                {
                    ...
                    paymentresponseVOsobj.AdditionalInfo5_20 = "Y";   //  AddtionalPayment flag
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CCACrypto ccaCrypto = new CCACrypto();
        string encResponse = ccaCrypto.Decrypt(Request.Form["encResp"], workingKey);
        //string encResponse = "order_id=MIC014002026530&tracking_id=109956919871&bank_ref_no=163420&order_status=Success&failure_message=&payment_mode=Debit Card&card_name=RuPay&status_code=null&status_message=Success&currency=INR&amount=500.00&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=9441721777&billing_email=omanjaneya@gmail.com&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=28034&merchant_param2=Kotak20200910131204&merchant_param3=CFE&merchant_param4=NODEPT&merchant_param5=NA&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=500.00&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=10/09/2020 13:12:38&bin_country=INDIA&trans_fee=0.0&service_tax=0.0";
        //string encResponse = "order_id=MIC002057026383&tracking_id=109950156708&bank_ref_no=CHE3537502&order_status=Success&failure_message=&payment_mode=Net Banking&card_name=State Bank of India&status_code=null&status_message=Completed Successfully&currency=INR&amount=2508.26&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=9494908111&billing_email=dhanpal.murali@gmail.com&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=27869&merchant_param2=Kotak20200902121111&merchant_param3=CFE&merchant_param4=NODEPT&merchant_param5=NA&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=2500.00&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=02/09/2020 12:11:31&bin_country=&trans_fee=7.0&service_tax=1.26";
        NameValueCollection Params = new NameValueCollection();
        string[] segments = encResponse.Split('&');
        foreach (string seg in segments)
        {
        ...
        if (msg != null)
        {
            ...
            if (paymentresponseVOsobj.AuthStatus_14 == "Success")// sucess payment done.
            {
                ...
                {
                    //LogErrorToText1("Payment done successfully,Reference number: " + paymentresponseVOsobj.TxnReferenceNo_2);
                    GetTESTVALUESCFE(BilldeskResponse);
                    Session["Amount"] = paymentresponseVOsobj.TxnAmount_4;
                    Session["RefNo"] = paymentresponseVOsobj.BankID_5;
                    Session["TranRefNo"] = paymentresponseVOsobj.TxnReferenceNo_2;
    ...
    public void GetTESTVALUESCFE(string Responce)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE_CFE", con.GetConnection);
            da.SelectCommand.Parameters.Add("@responce", SqlDbType.VarChar).Value = Responce.ToString();
            da.SelectCommand.Parameters.Add("@Online", SqlDbType.VarChar).Value = "Online";
