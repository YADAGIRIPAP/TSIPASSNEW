...
<%@ Page Language="C#" CodeFile="apparaisalMortgage.aspx.cs" MaintainScrollPositionOnPostback="true" ValidateRequest="false" MasterPageFile="~/UI/TSiPASS/CCMaster.master"  Inherits="UI_TSIPASS_apparaisalMortgage" %>
                      ...
                      <tr id="tprideTr" runat="server">
                       ...
                       <tr>
                        <td style=" text-align: center; font-weight: bold;">
                            <u>Sanction of Mortgage - Appraisal Note</u></td>
                    </tr>
                    <tr>
                        <td>
                            <table>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                      <td class="auto-style56">4.1</td>
                        <td style="padding: 5px; margin: 5px;  " class="auto-style57">
                            Name of the Financial Institution</td>
                        ...
                        <td class="auto-style56">
                            ...
                            <asp:TextBox ID="txtFinancialInstit"  runat="server" class="form-control txtbox txtcomn"
                    ...
                    <tr>
                      <td class="auto-style56">4.2</td>
                        ...
                        <td class="auto-style56">
                            ...
                            <asp:TextBox ID="txtLoanSanctioned"  runat="server" class="form-control txtbox txtcomn"
                    ...
                    <tr>
                      <td class="auto-style56">4.3</td>
                        ...
                        <td class="auto-style48">
                            ...
                            4.4</td>
                        <td class="auto-style48">
                            Term Loan availed by Unit</td>
                        <td class="auto-style48">

                            :</td>
                        <td class="auto-style48">
                     
                            <asp:TextBox ID="txtTermloanAvailed" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                                Height="30px" MaxLength="80" TabIndex="34" onkeypress="DecimalOnly()"  Width="150px" ></asp:TextBox>
                    ...
                    <tr id="tr4231" runat="server" visible="true">
                      <td class="auto-style56">4.5</td>
                        <td style="padding: 5px; margin: 5px;  " class="auto-style57">
                            Proportionate Mortgage Duty</td>
                        <td style="padding: 5px; margin: 5px; " class="auto-style56">
                            :</td>
                        <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                    ...
                    <tr id="tr4233" runat="server" visible="true">
                        <td>4.7</td>
                        <td style="padding: 5px;  margin: 5px;" >
                            Elegible for Reimbursement of Mortgage<br />
                            Duty in Rs.</td>
                        <td style="padding: 5px; margin: 5px; ">
                            :</td>
                        <td>
                            ...
                            <asp:TextBox ID="txtEligibleMortgage" Enabled="false" runat="server" class="form-control txtbox txtcomn"
                                Height="30px" MaxLength="80" TabIndex="34" onkeypress="DecimalOnly()"  Width="150px"></asp:TextBox>
                    ...
                    <tr id="tr4232" runat="server" visible="true">
                       <td class="auto-style55">4.6</td>
                        <td style="padding: 5px; margin: 5px; " class="auto-style55">
                            Mortgage Duty Recommended by GM</td>
                        <td style="padding: 5px; margin: 5px; " class="auto-style55">
                            :</td>
                        <td class="auto-style55">
                    ...
                    <tr id="tr2" runat="server" visible="true">
                        <td>4.7</td>
                        <td style="padding: 5px;  margin: 5px;" >
                            Final Elegible Amount of Mortgage<br />
                            Duty in Rs.</td>
                        <td style="padding: 5px; margin: 5px; ">
                            :</td>
                        <td>
                            ...
                            <asp:TextBox ID="txtfinalelifibleamount" Enabled="true" runat="server" class="form-control txtbox txtcomn"
                                Height="30px" MaxLength="80" TabIndex="34" onkeypress="DecimalOnly()"  Width="150px"></asp:TextBox>
