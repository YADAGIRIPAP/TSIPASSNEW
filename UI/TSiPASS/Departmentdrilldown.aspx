<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Departmentdrilldown.aspx.cs" Inherits="UI_TSIPASS_Departmentdrilldown" %>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td style="text-align: left">
                                                <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="frmDepartementDashboardNew.aspx" Text="<< Back">
                                                </asp:HyperLink>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                            ...
                                            <Columns>
                                                ...
                                                <%-- <asp:TemplateField HeaderText="UID">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1"  PostBackUrl='<%# Eval("CFELINK") %>' runat="server" Text='<%# Eval("UID") %>'></asp:LinkButton>
                                                            </ItemTemplate>
