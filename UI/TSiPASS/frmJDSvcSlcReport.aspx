<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmJDSvcSlcReport.aspx.cs" Inherits="UI_TSIPASS_frmJDSvcSlcReport" %>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                   ...
                                   <tr>
                                        ...
                                        <td style="padding: 5px; margin: 8px; text-align: left;" colspan="4">
                                            <table class="auto-style1">
                                                <tr>

                                                 
                                        <%--             <td style="vertical-align: middle; font-weight: bold; width: 200px">DIPC/SLC No </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left; font-weight: bold">
                                                        <asp:DropDownList ID="ddlDIPCSLCNo" class="form-control txtbox" runat="server">
                                                        </asp:DropDownList>

                                                    </td>--%>
                                                    <td class="auto-style2"><b>Select SLC/DIPC</b></td>
                                                    <td>
                                                         <asp:DropDownList ID="ddlDIPCSLC" AutoPostBack="true" Width="150px" class="form-control txtbox" runat="server" OnSelectedIndexChanged="ddlDIPCSLC_SelectedIndexChanged">
                                                             <asp:ListItem>SLC</asp:ListItem>
                                                             <asp:ListItem>DIPC</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                       <td style="vertical-align: middle; font-weight: bold; " class="auto-style3">Select Proposed DIPC Date : </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left; font-weight: bold">
                                                        <asp:DropDownList ID="ddlDIPCSlcDate" class="form-control txtbox" runat="server">
                                                        </asp:DropDownList>

                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnSubmit"  Height="30px" Width="100px" ForeColor="White" BackColor="ForestGreen" CssClass="button"  runat="server" Text="Submit" OnClick="btnSubmit_Click" />
                                                          
                                                    </td>
                                                    <td  style="padding: 5px; text-align: right; margin: 5px" colspan="7">
                                            <b>
                                                ...
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Incentiveid" Visible="false">
                                                         ...
                                                         <asp:BoundField DataField="RecommAmount" ItemStyle-HorizontalAlign="Center" HeaderText="Recommended Amount">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                    </Columns>
