<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDDDashboard.aspx.cs" Inherits="frmDDDashboard" %>
            ...
            <div class="col-lg-11">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Deputy Director&#39;s Dashboard</h3>
                    </div>
                                                ...
                                                <tr>
                                                    <td style="width: 395px" valign="top">
                                                        <div class="list-group">
                                                            <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=1" class="list-group-item">
                                                                ...
                                                                <i class="fa fa-fw fa-calendar"></i>No of Applications Received from A.D
                                                            </a>
                                                            <a class="list-group-item"><i class="fa fa-fw fa-check"></i>Scrutiny Pending </a>

                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=40"><span class="badge">
                                                                <asp:Label ID="Label1" runat="server"></asp:Label>
                                                            </span><i class="fa fa-fw fa-calendar"></i>With in 3 Days </a>


                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=41"><span class="badge" style="background-color: #d9534f;">
                                                            ...
                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=42"><span class="badge">
                                                                <asp:Label ID="Label3" runat="server"></asp:Label>
                                                            </span><i class="fa fa-fw fa-calendar"></i>With in 3 Days </a>


                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=43"><span class="badge" style="background-color: #d9534f;">
                                                    ...
                                                    <td>
                                                        <div class="list-group" style="vertical-align: top">
                                                            ...
                                                            <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=44" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label5" runat="server"></asp:Label></span>
                                                                <i class="fa fa-fw fa-calendar"></i>Queries Yet to Respond
                                                            </a>

                                                            <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=45" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label6" runat="server"></asp:Label></span>
                                                                <i class="fa fa-fw fa-calendar"></i>Queries Responded
                                                            </a>

                                                            <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=46" class="list-group-item">
                                                                <span class="badge">
