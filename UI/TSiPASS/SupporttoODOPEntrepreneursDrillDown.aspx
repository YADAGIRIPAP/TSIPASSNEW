<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="SupporttoODOPEntrepreneursDrillDown.aspx.cs" Inherits="UI_TSiPASS_SupporttoODOPEntrepreneursDrillDown" %>
        ...
        <div class="row" align="left">
           <div class="col-lg-12" id="divPrint1" runat="server">
                  <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;"><asp:Label ID="lblHeading" runat="server" Visible="false">SupporttoODOPEntrepreneurs Details</asp:Label>
                ...
                <div>
                      <tr>
                                <td colspan="8" style="width: 883px; height: 25px;">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/SupporttoODOPEntrepreneurs.aspx"
                                                        Text="<< Back">
                                                    </asp:HyperLink>
               ...
               <%-- <div>
                    <asp:LinkButton ID="linkbtn" runat="server" OnClick="linkbtn_Click">Back</asp:LinkButton>
                </div>--%>
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" style="text-align:center;">
                            <asp:Label ID="lblHead2" runat="server" CssClass="LBLBLACK" Font-Bold="True"
                                Width="500px" > ODOP Entrepreneurs Details</asp:Label>
                        </h3>
                    </div>   
                    <br />
  <%--  <div  style="overflow-x: auto; width: 950px; max-height: 300px">--%>
       <asp:GridView ID="GrdOdopEntpnrdtls" runat="server" AutoGenerateColumns="False"  Width="95%"  BorderColor="#003399" BorderStyle="Solid" BorderWidth="1px" ForeColor="#333333" 
           Style="margin-left:15px; margin-right:5px;" AllowSorting="true" CssClass="floatingtable"  HeaderStyle-CssClass="FixedHeader" OnRowDataBound="GrdOdopEntpnrdtls_RowDataBound" >
