<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSanctionedReleasedDrilldown.aspx.cs" Inherits="UI_TSiPASS_frmSanctionedReleasedDrilldown" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeader" runat="server">R5.4 TSiPASS-SANCTIONED RELEASE PENDING FINACIAL YEARWISE REPORT</asp:Label>
                                ...
                                <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 100%">
                                    <tr>
                                        <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                            <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/frmSanctioned_ReleasingPending_Yearwise.aspx"
                                                Text="<< Back">
                                            </asp:HyperLink>
                                        </td>
                                    </tr>
