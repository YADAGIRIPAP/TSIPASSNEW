                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px">
                                                                <asp:RadioButtonList ID="rblGHMC" runat="server" Width="200px" TabIndex="6">
                                                                    <asp:ListItem Value="0" Selected="True">GHMC</asp:ListItem>
                                                                    <asp:ListItem Value="1">Other than GHMC</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                &nbsp;
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Height="32px"
                                                        OnClick="btnSubmit_Click" TabIndex="8" Text="Search" ValidationGroup="group"
                                                        Width="90px" />
                                                </td>
                                            </tr>
                                            <tr>
