<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartmentApprovalPaymentDetailsCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <div class="GRD" style="width: 100%">
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Do you want to pay 10% or Full of Amount" Visible="false">
                                                    <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" align="center">
                                            <asp:RadioButtonList ID="rblPaymentMode" runat="server" AutoPostBack="True" Font-Bold="True"
                                                ...
                                                RepeatDirection="Horizontal" Width="350px" Enabled="False">
                                        ...
                                        <tr id="amt" runat="server">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtAmount"
                                                    ErrorMessage="Please enter Amount" InitialValue="0" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%" runat="server" id="paynotOnline">
                                        <tr id="amt0" runat="server">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                               ...
                                               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TxtAmountOnline"
                                                    ErrorMessage="Please enter Amount" InitialValue="0" ValidationGroup="group">*</asp:RequiredFieldValidator>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" colspan="4">
                                                <asp:RadioButtonList ID="rdbOnlineBankType" runat="server" Font-Bold="True" Font-Names="Verdana"
                                                   ...
                                                   <%-- <asp:ListItem Selected="True">SBI</asp:ListItem>
                                                    ...
                                                    <asp:ListItem Value="Billdesk"  Enabled="false" visible="false">Bill desk</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" id="trbuilddesc" runat="server" visible="false">
                                                <asp:CheckBox ID="chkBuilldesc" Enabled="false" runat="server" Text="" Checked="True" /><img alt="Builddesc" src="../../images/billdesk.png" width="140px" height="100px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">&nbsp;
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" colspan="3">
                                    ...
                                    &nbsp;&nbsp;<asp:Button ID="BtnDelete" runat="server" CssClass="btn btn-danger" Height="32px"
                                        OnClick="BtnClear0_Click" TabIndex="10" Width="150px" Text="Pay"  ValidationGroup="group" />
