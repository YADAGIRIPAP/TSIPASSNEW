...
public partial class UI_TSiPASS_frmDistrictReportIndustryCategoeryDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmDistrictReportIndustryCategoery.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string categoery)
    {
        ...
        SqlParameter[] pp = new SqlParameter[] {
             new SqlParameter("@FromDate",SqlDbType.VarChar),
              ...
              // new SqlParameter("@FinancialYearCd",SqlDbType.VarChar),
               new SqlParameter("@INDUSCATEGORY",SqlDbType.VarChar)
        ...
        pp[3].Value = categoery;

        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_INDUSTRYCATEGORY_DRILLDOWN", pp);
        return Dsnew;
    }
