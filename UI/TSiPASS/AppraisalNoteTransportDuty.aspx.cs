...
public partial class UI_TSiPASS_AppraisalNoteTransportDuty : System.Web.UI.Page
{
    ...
    IncentiveVosAppraisalStamp oIncentiveVosA = new IncentiveVosAppraisalStamp();
    DB.DB con = new DB.DB();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["uid"] != null)
            {
                // txtgmRecommend.Text = "123";
                // txtINCNoEntry.Text = "112528";
                ...
                if (Request.QueryString[0].ToString() != "")
                {
                    ...
                    // oIncentiveVosA.MstIncentiveId = "16";
                    btnINCSearch_Click(sender, e);
                    getCasteDetails();
                }
            }
    ...
    public void USP_GETDETAILSFORSECTION()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            hdncastename.Value = ds.Tables[0].Rows[0]["SocialStatus"].ToString();
            hdndifferentlyabled.Value = ds.Tables[0].Rows[0]["IsDifferentlyAbled"].ToString();
           ...
           // lblAllwomen.Value = ds.Tables[0].Rows[0]["allwomen"].ToString();
            ...
            {
                txtDCP_unit.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["CommencmentOfCommrclProdcn_Date"]).ToString("dd/MM/yyyy");
                txtDCP_unit_TextChanged(this, EventArgs.Empty);
            }
            else
                txtDCP_unit.Text = "";
            ...
            txtgmRecommend.Text = ds.Tables[0].Rows[0]["Total_ValueRecommendedByGM"].ToString();
            //txtgmRecommend.Text = "123";

            //---------------------Computation of Capital Cost-  ----------A.LAND----------------------------------------
            if (ds.Tables[0].Rows[0]["Land_ValueRecommendedByGM"].ToString() != null)
            {
                txtLandcostCompc.Text = ds.Tables[0].Rows[0]["Land_ValueRecommendedByGM"].ToString();
                TextBox56.Text = ds.Tables[0].Rows[0]["Land_ValueRecommendedByGM"].ToString();
            }
            ...
            if (ds.Tables[0].Rows[0]["Building_ValueRecommendedByGM"].ToString() != null)
            {
                ...
                TextBox57.Text = ds.Tables[0].Rows[0]["Building_ValueRecommendedByGM"].ToString();
            }
            ...
            {
                TextBox30.Text = ds.Tables[0].Rows[0]["ProjcostPlant"].ToString();
                TextBox58.Text = ds.Tables[0].Rows[0]["ProjcostPlant"].ToString();
            }
            ...
            txtLandAreaCompc.Text = ds.Tables[0].Rows[0]["LandMeasuring"].ToString();
            txtPurchaCompc.Text = ds.Tables[0].Rows[0]["LandPurchaseValue"].ToString();
            txtStmpDutyCompc.Text = ds.Tables[0].Rows[0]["LandStampDuty"].ToString();
            txtRegnfeeCompc.Text = ds.Tables[0].Rows[0]["LandRegistrationFee"].ToString();
            txtTotalCompc.Text = ds.Tables[0].Rows[0]["TotalLand"].ToString();
            txtBuildingAreCompc.Text = ds.Tables[0].Rows[0]["LandBuildingPlinthArea"].ToString();
            txtvalDICCompc.Text = ds.Tables[0].Rows[0]["LandValue_RecommdedBy_GM"].ToString();
            txtvalCompc1.Text = ds.Tables[0].Rows[0]["LandValue_Computed"].ToString();
            ...
            //}
            hdnfirstorsecondhalfyear.Value = ds.Tables[3].Rows[0]["Fin1stOr2ndHalfYear"].ToString();
            HDNYEAR.Value= ds.Tables[3].Rows[0]["FYEAR"].ToString();
            if (hdnfirstorsecondhalfyear.Value=="1")
            {
                txt_grdmonth1.Text = "April";
                HiddenFieldapr.Value = "4";
                txt_grdmonth2.Text = "May";
                HiddenFieldmay.Value = "5";
                txt_grdmonth3.Text = "June";
                HiddenFieldjune.Value = "6";
                txt_grdmonth4.Text = "July";
                HiddenFieldjuly.Value = "7";
                txt_grdmonth5.Text = "August";
                HiddenFieldaug.Value = "8";
                txt_grdmonth6.Text = "September";
                HiddenFieldsep.Value = "9";
                txt_grdmonthyear1.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear2.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear3.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear4.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear5.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear6.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
            }
            else
            {
                txt_grdmonth1.Text = "October"; HiddenFieldoct.Value = "10";
                txt_grdmonth2.Text = "November"; HiddenFieldnov.Value = "11";
                txt_grdmonth3.Text = "December"; HiddenFielddec.Value = "12";
                txt_grdmonth4.Text = "January"; HiddenFieldjan.Value = "1";
                txt_grdmonth5.Text = "February"; HiddenFieldfeb.Value = "2";
                txt_grdmonth6.Text = "March"; HiddenFieldmar.Value = "3";
                txt_grdmonthyear1.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear2.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear3.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
                txt_grdmonthyear4.Text = ds.Tables[3].Rows[0]["FinancialYear"].ToString();
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.MstIncentiveId = "20";// Request.QueryString["MstIncentiveId"].ToString();
            ...
            fromvo.Recomamount = oIncentiveVosA.FINALSUBSIDYAMOUNT;
            ...
            string lblMstIncentiveId = "20";// Request.QueryString["MstIncentiveId"].ToString();
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        string valid = "";
        SqlConnection connection = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["TSiPASSSkils"].ConnectionString);
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_TRANSPORTDUTY]";
            ...
            if (oIncentiveVosA.txt423guideline != null)
                com.Parameters.AddWithValue("@txt423guideline", oIncentiveVosA.txt423guideline);
            ...
            //if (oIncentiveVosA.lmv != null || oIncentiveVosA.lmv == null)
            //    com.Parameters.AddWithValue("@RDLMV", oIncentiveVosA.lmv);

            //if (oIncentiveVosA.womenmen != null || oIncentiveVosA.womenmen == null)
            //    com.Parameters.AddWithValue("@RDWOMENMEN", oIncentiveVosA.womenmen);

            if (oIncentiveVosA.eligibletype != null || oIncentiveVosA.eligibletype == null)
                com.Parameters.AddWithValue("@RDELIGIBLE", oIncentiveVosA.eligibletype);
            if (oIncentiveVosA.Remarks != null || oIncentiveVosA.Remarks == null)
            ...
            // -----------=====---------------
            if (oIncentiveVosA.month1 != null && oIncentiveVosA.month1 != "")
                com.Parameters.AddWithValue("@month1", oIncentiveVosA.month1);
            if (oIncentiveVosA.month2!= null && oIncentiveVosA.month2 != "")
                com.Parameters.AddWithValue("@month2", oIncentiveVosA.month2);
            if (oIncentiveVosA.month3 != null && oIncentiveVosA.month3 != "")
                com.Parameters.AddWithValue("@month3", oIncentiveVosA.month3);
            if (oIncentiveVosA.month4 != null && oIncentiveVosA.month4 != "")
                com.Parameters.AddWithValue("@month4", oIncentiveVosA.month4);
            if (oIncentiveVosA.month5 != null && oIncentiveVosA.month5 != "")
                com.Parameters.AddWithValue("@month5", oIncentiveVosA.month5);
            if (oIncentiveVosA.month6 != null && oIncentiveVosA.month6 != "")
                com.Parameters.AddWithValue("@month6", oIncentiveVosA.month6);

            if (oIncentiveVosA.month1_year != null && oIncentiveVosA.month1_year != "")
                com.Parameters.AddWithValue("@month1_year", oIncentiveVosA.month1_year);
            if (oIncentiveVosA.month2_year != null && oIncentiveVosA.month2_year != "")
                com.Parameters.AddWithValue("@month2_year", oIncentiveVosA.month2_year);
            if (oIncentiveVosA.month3_year != null && oIncentiveVosA.month3_year != "")
                com.Parameters.AddWithValue("@month3_year", oIncentiveVosA.month3_year);
            if (oIncentiveVosA.month4_year != null && oIncentiveVosA.month4_year != "")
                com.Parameters.AddWithValue("@month4_year", oIncentiveVosA.month4_year);
            if (oIncentiveVosA.month5_year != null && oIncentiveVosA.month5_year != "")
                com.Parameters.AddWithValue("@month5_year", oIncentiveVosA.month5_year);
            if (oIncentiveVosA.month6_year != null && oIncentiveVosA.month6_year != "")
                com.Parameters.AddWithValue("@month6_year", oIncentiveVosA.month6_year);


            if (oIncentiveVosA.month1amountpaid != null && oIncentiveVosA.month1amountpaid != "")
                com.Parameters.AddWithValue("@month1amountpaid", oIncentiveVosA.month1amountpaid);
            if (oIncentiveVosA.month2amountpaid != null && oIncentiveVosA.month2amountpaid != "")
                com.Parameters.AddWithValue("@month2amountpaid", oIncentiveVosA.month2amountpaid);
            if (oIncentiveVosA.month3amountpaid != null && oIncentiveVosA.month3amountpaid != "")
                com.Parameters.AddWithValue("@month3amountpaid", oIncentiveVosA.month3amountpaid);
            if (oIncentiveVosA.month4amountpaid != null && oIncentiveVosA.month4amountpaid != "")
                com.Parameters.AddWithValue("@month4amountpaid", oIncentiveVosA.month4amountpaid);
            if (oIncentiveVosA.month5amountpaid != null && oIncentiveVosA.month5amountpaid != "")
                com.Parameters.AddWithValue("@month5amountpaid", oIncentiveVosA.month5amountpaid);
            if (oIncentiveVosA.month6amountpaid != null && oIncentiveVosA.month6amountpaid != "")
                com.Parameters.AddWithValue("@month6amountpaid", oIncentiveVosA.month6amountpaid);

            if (oIncentiveVosA.month1eligiblesubsidy != null && oIncentiveVosA.month1eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month1eligiblesubsidy", oIncentiveVosA.month1eligiblesubsidy);
            if (oIncentiveVosA.month2eligiblesubsidy != null && oIncentiveVosA.month2eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month2eligiblesubsidy", oIncentiveVosA.month2eligiblesubsidy);
            if (oIncentiveVosA.month3eligiblesubsidy != null && oIncentiveVosA.month3eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month3eligiblesubsidy", oIncentiveVosA.month3eligiblesubsidy);
            if (oIncentiveVosA.month4eligiblesubsidy != null && oIncentiveVosA.month4eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month4eligiblesubsidy", oIncentiveVosA.month4eligiblesubsidy);
            if (oIncentiveVosA.month5eligiblesubsidy != null && oIncentiveVosA.month5eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month5eligiblesubsidy", oIncentiveVosA.month5eligiblesubsidy);
            if (oIncentiveVosA.month6eligiblesubsidy != null && oIncentiveVosA.month6eligiblesubsidy != "")
                com.Parameters.AddWithValue("@month6eligiblesubsidy", oIncentiveVosA.month6eligiblesubsidy);

            //if (oIncentiveVosA.TOTALCAPITALELIGIBLEINVESTMENT != null)
            //    com.Parameters.AddWithValue("@TOTALCAPITALELIGIBLEINVESTMENT", oIncentiveVosA.TOTALCAPITALELIGIBLEINVESTMENT);
            if (oIncentiveVosA.ELIGIBLEAMOUNT != null)
                com.Parameters.AddWithValue("@ELIGIBLEAMOUNT", oIncentiveVosA.ELIGIBLEAMOUNT);
            if (oIncentiveVosA.GMVALUE != null)
                com.Parameters.AddWithValue("@GMVALUE", oIncentiveVosA.GMVALUE);
            if (oIncentiveVosA.FINALSUBSIDYAMOUNT != null)
                com.Parameters.AddWithValue("@FINALSUBSIDYAMOUNT", oIncentiveVosA.FINALSUBSIDYAMOUNT);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        //oIncentiveVosA.TextBox59 = TextBox59.Text;
        //oIncentiveVosA.txt423guideline = txt423guideline.Text;
        //oIncentiveVosA.txtTSSFCnorms423 = txtTSSFCnorms423.Text;
        oIncentiveVosA.txtvalue424 = txtvalue424.Text;
        ...
        //oIncentiveVosA.lmv = rdlmv.SelectedValue;
        //oIncentiveVosA.womenmen = rdmenwomen.SelectedValue;
        oIncentiveVosA.eligibletype = rdeligibility.SelectedValue;
        oIncentiveVosA.Remarks = txtremarks.Text;
        oIncentiveVosA.MstIncentiveId = "20";// Request.QueryString["MstIncentiveId"].ToString();
        
        oIncentiveVosA.month1 = txt_grdmonth1.Text;
        oIncentiveVosA.month2 = txt_grdmonth2.Text;
        oIncentiveVosA.month3 = txt_grdmonth3.Text;
        oIncentiveVosA.month4 = txt_grdmonth4.Text;
        oIncentiveVosA.month5 = txt_grdmonth5.Text;
        oIncentiveVosA.month6 = txt_grdmonth6.Text;

        oIncentiveVosA.month1_year = txt_grdmonthyear1.Text;
        oIncentiveVosA.month2_year = txt_grdmonthyear2.Text;
        oIncentiveVosA.month3_year = txt_grdmonthyear3.Text;
        oIncentiveVosA.month4_year = txt_grdmonthyear4.Text;
        oIncentiveVosA.month5_year = txt_grdmonthyear5.Text;
        oIncentiveVosA.month6_year = txt_grdmonthyear6.Text;

        oIncentiveVosA.month1amountpaid = txtmonth1amountpaid.Text;
        oIncentiveVosA.month2amountpaid = txtmonth2maountpaid.Text;
        oIncentiveVosA.month3amountpaid = txtmonth3amountpaid.Text;
        oIncentiveVosA.month4amountpaid = txtmonth4amountpaid.Text;
        oIncentiveVosA.month5amountpaid = txtmonth5amountpaid.Text;
        oIncentiveVosA.month6amountpaid = txtmonth6amountpaid.Text;

        oIncentiveVosA.month1eligiblesubsidy = txtmonth1eligiblesubsidy.Text;
        oIncentiveVosA.month2eligiblesubsidy = txtmonth2eligiblesubsidy.Text;
        oIncentiveVosA.month3eligiblesubsidy = txtmonth3eligiblesubsidy.Text;
        oIncentiveVosA.month4eligiblesubsidy = txtmonth4eligiblesubsidy.Text;
        oIncentiveVosA.month5eligiblesubsidy = txtmonth5eligiblesubsidy.Text;
        oIncentiveVosA.month6eligiblesubsidy = txtmonth6eligiblesubsidy.Text;

        oIncentiveVosA.ELIGIBLEAMOUNT = Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text);
        
        oIncentiveVosA.GMVALUE = Convert.ToDecimal(txtgmRecommend.Text);
        oIncentiveVosA.FINALSUBSIDYAMOUNT = Convert.ToDecimal(TXTFINALELIGIBLEAMOUNT.Text);
    ...
    //business logic
    public class IncentiveVosAppraisalStamp
    {
        ...
        public string month1_year { get; set; }
        public string month2_year { get; set; }
        public string month3_year { get; set; }
        public string month4_year { get; set; }
        public string month5_year { get; set; }
        public string month6_year { get; set; }

        public string month1amountpaid { get; set; }
        public string month2amountpaid { get; set; }
        public string month3amountpaid { get; set; }
        public string month4amountpaid { get; set; }
        public string month5amountpaid { get; set; }
        public string month6amountpaid { get; set; }

        public string month1eligiblesubsidy { get; set; }
        public string month2eligiblesubsidy { get; set; }
        public string month3eligiblesubsidy { get; set; }
        public string month4eligiblesubsidy { get; set; }
        public string month5eligiblesubsidy { get; set; }
        public string month6eligiblesubsidy { get; set; }

       
        public Decimal? ELIGIBLEAMOUNT { get; set; }
        public Decimal? GMVALUE { get; set; }
        public Decimal? FINALSUBSIDYAMOUNT { get; set; }
    ...
    public string ValidateControls()
    {
        ...
        if (txtmonth1amountpaid.Text.TrimStart().TrimEnd().Trim() == ""|| txtmonth1amountpaid.Text.TrimStart().TrimEnd().Trim()==null)
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 1st month of claim period  \\n";
            slno = slno + 1;
        }
        if (txtmonth2maountpaid.Text.TrimStart().TrimEnd().Trim() == ""|| txtmonth2maountpaid.Text.TrimStart().TrimEnd().Trim() == null)
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 2nd month of claim period  \\n";
            slno = slno + 1;
        }
        if (txtmonth3amountpaid.Text.TrimStart().TrimEnd().Trim() == ""||txtmonth3amountpaid.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 3rd month of claim period  \\n";
            slno = slno + 1;
        }
        if (txtmonth4amountpaid.Text.TrimStart().TrimEnd().Trim() == ""|| txtmonth4amountpaid.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 4th month of claim period  \\n";
            slno = slno + 1;
        }
        if (txtmonth5amountpaid.Text.TrimStart().TrimEnd().Trim() == ""|| txtmonth5amountpaid.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 5th month of claim period  \\n";
            slno = slno + 1;
        }
        if (txtmonth6amountpaid.Text.TrimStart().TrimEnd().Trim() == ""|| txtmonth6amountpaid.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Enter amount paid for 6th month of claim period  \\n";
            slno = slno + 1;
        }
        if (rdeligibility.SelectedValue.TrimStart().TrimEnd().Trim() == ""|| rdeligibility.SelectedValue.TrimStart().TrimEnd().Trim() == null)
        {
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=5");
        }
    ...
    protected void rdeligibility_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rdeligibility.SelectedValue == "Regular")
        {
                ...
                if (Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text) <= Convert.ToDecimal(txtgmRecommend.Text))
                {
                    TXTFINALELIGIBLEAMOUNT.Text = TXTELIGIBLEAMOUNT.Text;
                }
                else
                {
                    TXTFINALELIGIBLEAMOUNT.Text = txtgmRecommend.Text;
                }
        ...
        else if (rdeligibility.SelectedValue == "Belated")
        {
                ...
                if ((Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text) / 2) <= Convert.ToDecimal(txtgmRecommend.Text))
                {
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        string serverpath = Server.MapPath("~\\IncentivesAttachmentsNew\\" + "\\ADWORKSHEET" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "100024", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    {
        Response.Redirect("frmCoiDashboardclerk.aspx");// + hdfID.Value
    }
    ...
    protected void txtDCP_unit_TextChanged(object sender, EventArgs e)
    {
        //commented by me
        //if (Convert.ToDateTime(txtDCP_unit.Text) > DateTime.Parse("01/01/2015"))
        //{
        //    //DDLSCHEME.SelectedValue = "T-IDEA";
        //    //DDLSCHEME_SelectedIndexChanged(this, EventArgs.Empty);
        //    if (hdncastename.Value == "SC" || hdncastename.Value == "ST" || hdndifferentlyabled.Value.ToUpper() == "Y")
        //    {
        //        DDLSCHEME.SelectedValue = "T-PRIDE";
        //        DDLSCHEME_SelectedIndexChanged(this, EventArgs.Empty);
        //    }
        //    else
        //    {
        ...
        //else
        //{
        //    DDLSCHEME.SelectedValue = "IIPP 2010-15";
        //    DDLSCHEME_SelectedIndexChanged(this, EventArgs.Empty);
        //}
    ...
    protected void txtmonth1amountpaid_TextChanged(object sender, EventArgs e)
    {
        if(txtmonth1amountpaid.Text==""|| txtmonth1amountpaid.Text == null)
        {
            txtmonth2maountpaid.Enabled = false;
            txtmonth3amountpaid.Enabled = false;
            txtmonth4amountpaid.Enabled = false;
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;

        }
        else
        {
            txtmonth2maountpaid.Enabled = true;
            txtmonth3amountpaid.Enabled = false;
            txtmonth4amountpaid.Enabled = false;
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;
        ...
        if (hdnfirstorsecondhalfyear.Value=="1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldapr.Value + "-01";
        }
        else
        {
            date = HDNYEAR.Value + "-" + HiddenFieldoct.Value + "-01";

        }

        string sDate = txtDCP_unit.Text;
        DateTime endDate = DateTime.Parse(date);
        DateTime DCPDATE = (Convert.ToDateTime(sDate.ToString()));
        HDNDCPYEAR.Value = DCPDATE.Year.ToString();
        HDNDCPMONTH.Value = DCPDATE.Month.ToString();
        HDNDCPDATE.Value = DCPDATE.Day.ToString();
        DateTime ENDDATE_NEW = (Convert.ToDateTime(endDate.ToString()));
        HDNENDYEAR.Value = ENDDATE_NEW.Year.ToString();
        HDNENDMONTH.Value = ENDDATE_NEW.Month.ToString();
        HDNENDDATE.Value = ENDDATE_NEW.Day.ToString();
        if (HDNENDMONTH.Value == "1" || HDNENDMONTH.Value == "3" || HDNENDMONTH.Value == "5" ||
            HDNENDMONTH.Value == "7" || HDNENDMONTH.Value == "8" || HDNENDMONTH.Value == "10" ||
            HDNENDMONTH.Value == "12")
        {
            totaldays = 31;
        }
        else if (HDNENDMONTH.Value == "4" || HDNENDMONTH.Value == "6" || HDNENDMONTH.Value == "9" ||
            HDNENDMONTH.Value == "11" )
        {
            totaldays = 30;
        }
        else
        {
            if (DateTime.IsLeapYear(Convert.ToInt32(HDNENDYEAR.Value)))
            {
                totaldays = 29;
            }
            else
        ...
        if(days<=365)
        {
            if(HDNDCPMONTH.Value==HDNENDMONTH.Value && (((Convert.ToDecimal( HDNDCPYEAR.Value)+1)).ToString()==HDNENDYEAR.Value))
            {
                txtmonth1eligiblesubsidy.Text = Math.Round(((((Convert.ToDecimal(txtmonth1amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value)))*60)/100
                    +
                    (((Convert.ToDecimal(txtmonth1amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value) ))) * 50) / 100),2).ToString();
            }
            else
            {
                txtmonth1eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth1amountpaid.Text) * 60) / 100),2).ToString();
            }
        }
        else if(days>365 && days<=730 )
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth1eligiblesubsidy.Text = Math.Round(((((Convert.ToDecimal(txtmonth1amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth1amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100),2).ToString();
            }
            else
            {
                txtmonth1eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth1amountpaid.Text) * 50) / 100),2).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth1eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth1amountpaid.Text) * 40) / 100),2).ToString();

        }
        else

        {
            txtmonth1eligiblesubsidy.Text = "0";
        }
        if (txtmonth1eligiblesubsidy.Text == null || txtmonth1eligiblesubsidy.Text == "")
        {
            txtmonth1eligiblesubsidy.Text = "0";
        }
        if (txtmonth2eligiblesubsidy.Text == null || txtmonth2eligiblesubsidy.Text == "")
        {
            txtmonth2eligiblesubsidy.Text = "0";
        }
        if (txtmonth3eligiblesubsidy.Text == null || txtmonth3eligiblesubsidy.Text == "")
        {
            txtmonth3eligiblesubsidy.Text = "0";
        }
        if (txtmonth4eligiblesubsidy.Text == null || txtmonth4eligiblesubsidy.Text == "")
        {
            txtmonth4eligiblesubsidy.Text = "0";
        }
        if (txtmonth5eligiblesubsidy.Text == null || txtmonth5eligiblesubsidy.Text == "")
        {
            txtmonth5eligiblesubsidy.Text = "0";
        }
        if (txtmonth6eligiblesubsidy.Text == null || txtmonth6eligiblesubsidy.Text == "")
        {
            txtmonth6eligiblesubsidy.Text = "0";
        }
        TXTELIGIBLEAMOUNT.Text = Math.Round((Convert.ToDecimal(txtmonth1eligiblesubsidy.Text) +
        Convert.ToDecimal(txtmonth2eligiblesubsidy.Text) +
        Convert.ToDecimal(txtmonth3eligiblesubsidy.Text) +
        Convert.ToDecimal(txtmonth4eligiblesubsidy.Text) +
        Convert.ToDecimal(txtmonth5eligiblesubsidy.Text) +
        Convert.ToDecimal(txtmonth6eligiblesubsidy.Text)), 2).ToString();
    }

    protected void txtmonth2maountpaid_TextChanged(object sender, EventArgs e)
    {
        if (txtmonth2maountpaid.Text == "" || txtmonth2maountpaid.Text == null)
        {
            txtmonth3amountpaid.Enabled = false;
            txtmonth4amountpaid.Enabled = false;
            txtmonth5amountpaid.Enabled = false;
        ...
        {
            txtmonth3amountpaid.Enabled = true;
            txtmonth4amountpaid.Enabled = false;
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;
        }
        if (hdnfirstorsecondhalfyear.Value == "1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldmay.Value + "-01";
        }
        else
        {
            date = HDNYEAR.Value + "-" + HiddenFieldnov.Value + "-01";
        ...
        if (days <= 365)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 1)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth2eligiblesubsidy.Text = Math.Round(((((Convert.ToDecimal(txtmonth2maountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 60) / 100
                    +
                    (((Convert.ToDecimal(txtmonth2maountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 50) / 100),2).ToString();
            }
            else
            {
                txtmonth2eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth2maountpaid.Text) * 60) / 100),2).ToString();
            }
        }
        else if (days > 365 && days <= 730)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth2eligiblesubsidy.Text = Math.Round(((((Convert.ToDecimal(txtmonth2maountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth2maountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100),2).ToString();
            }
            else
            {
                txtmonth2eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth2maountpaid.Text) * 50) / 100),2).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth2eligiblesubsidy.Text = Math.Round(((Convert.ToDecimal(txtmonth2maountpaid.Text) * 40) / 100),2).ToString();
    ...
    protected void txtmonth3amountpaid_TextChanged(object sender, EventArgs e)
    {
        if (txtmonth3amountpaid.Text == "" || txtmonth3amountpaid.Text == null)
        {
            txtmonth4amountpaid.Enabled = false;
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;
        ...
        {
            txtmonth4amountpaid.Enabled = true;
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;
        }
        if (hdnfirstorsecondhalfyear.Value == "1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldjune.Value + "-01";
        }
        else
        {
            date = HDNYEAR.Value + "-" + HiddenFielddec.Value + "-01";
        ...
        if (days <= 365)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 1)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth3eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth3amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 60) / 100
                    +
                    (((Convert.ToDecimal(txtmonth3amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 50) / 100).ToString();
            }
            else
            {
                txtmonth3eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth3amountpaid.Text) * 60) / 100).ToString();
            }
        }
        else if (days > 365 && days <= 730)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth3eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth3amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth3amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100).ToString();
            }
            else
            {
                txtmonth3eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth3amountpaid.Text) * 50) / 100).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth3eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth3amountpaid.Text) * 40) / 100).ToString();
    ...
    protected void txtmonth4amountpaid_TextChanged(object sender, EventArgs e)
    {
        if (txtmonth4amountpaid.Text == "" || txtmonth4amountpaid.Text == null)
        {
            txtmonth5amountpaid.Enabled = false;
            txtmonth6amountpaid.Enabled = false;
        ...
        {
            txtmonth5amountpaid.Enabled = true;
            txtmonth6amountpaid.Enabled = false;
        }
        if (hdnfirstorsecondhalfyear.Value == "1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldjuly.Value + "-01";
        }
        else
        {
            date =(Convert.ToDecimal( HDNYEAR.Value)+1).ToString() + "-" + HiddenFieldjan.Value + "-01";
        ...
        if (days <= 365)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 1)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth4eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth4amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 60) / 100
                    +
                    (((Convert.ToDecimal(txtmonth4amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value))))* 50) / 100).ToString();
            }
            else
            {
                txtmonth4eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth4amountpaid.Text) * 60) / 100).ToString();
            }
        }
        else if (days > 365 && days <= 730)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth4eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth4amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth4amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100).ToString();
            }
            else
            {
                txtmonth4eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth4amountpaid.Text) * 50) / 100).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth4eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth4amountpaid.Text) * 40) / 100).ToString();
    ...
    protected void txtmonth5amountpaid_TextChanged(object sender, EventArgs e)
    {
        if (txtmonth5amountpaid.Text == "" || txtmonth5amountpaid.Text == null)
        {
            txtmonth6amountpaid.Enabled = false;
        ...
        {
            txtmonth6amountpaid.Enabled = true;
        }
        if (hdnfirstorsecondhalfyear.Value == "1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldaug.Value + "-01";
        }
        else
        {
            date = (Convert.ToDecimal(HDNYEAR.Value) + 1).ToString() + "-" + HiddenFieldfeb.Value + "-01";
        ...
        if (days <= 365)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 1)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth5eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth5amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 60) / 100
                    +
                    (((Convert.ToDecimal(txtmonth5amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 50) / 100).ToString();
            }
            else
            {
                txtmonth5eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth5amountpaid.Text) * 60) / 100).ToString();
            }
        }
        else if (days > 365 && days <= 730)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth5eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth5amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth5amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100).ToString();
            }
            else
            {
                txtmonth5eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth5amountpaid.Text) * 50) / 100).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth5eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth5amountpaid.Text) * 40) / 100).ToString();
    ...
    protected void txtmonth6amountpaid_TextChanged(object sender, EventArgs e)
    {
        if (hdnfirstorsecondhalfyear.Value == "1")
        {
            date = HDNYEAR.Value + "-" + HiddenFieldsep.Value + "-01";
        }
        else
        {
            date = (Convert.ToDecimal(HDNYEAR.Value) + 1).ToString() + "-" + HiddenFieldmar.Value + "-01";
        ...
        if (days <= 365)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 1)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth6eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth6amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 60) / 100
                    +
                    (((Convert.ToDecimal(txtmonth6amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 50) / 100).ToString();
            }
            else
            {
                txtmonth6eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth6amountpaid.Text) * 60) / 100).ToString();
            }
        }
        else if (days > 365 && days <= 730)
        {
            if (HDNDCPMONTH.Value == HDNENDMONTH.Value && (((Convert.ToDecimal(HDNDCPYEAR.Value) + 2)).ToString() == HDNENDYEAR.Value))
            {
                txtmonth6eligiblesubsidy.Text = ((((Convert.ToDecimal(txtmonth6amountpaid.Text) / totaldays) * (Convert.ToDecimal(HDNDCPDATE.Value))) * 50) / 100
                    +
                    (((Convert.ToDecimal(txtmonth6amountpaid.Text) / totaldays) * (totaldays - (Convert.ToDecimal(HDNDCPDATE.Value)))) * 40) / 100).ToString();
            }
            else
            {
                txtmonth6eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth6amountpaid.Text) * 50) / 100).ToString();
            }

        }
        else if (days > 730 && days <= 1825)
        {
            txtmonth6eligiblesubsidy.Text = ((Convert.ToDecimal(txtmonth6amountpaid.Text) * 40) / 100).ToString();
