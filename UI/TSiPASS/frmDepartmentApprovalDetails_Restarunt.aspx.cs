...
using System.IO;
public partial class UI_TSiPASS_frmDepartmentApprovalDetails_Restarunt : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dscheck = GetShowQuestionaries_Restaraunt(Session["uid"].ToString().Trim());
            ...
            {
                Response.Redirect("frmQuesstionniareReg1_restarunts.aspx");
            }
            DataSet dsdtls = new DataSet();
            dsdtls = GetQuestionereisReceiptDetails_restaurent(Session["Applid"].ToString().Trim());
    ...
    public DataSet GetQuestionereisReceiptDetails_restaurent(string intQuessionaireid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("GetQuestionereisReceiptDetails_restaurent", con.GetConnection);
    ...
    public DataSet GetShowQuestionaries_Restaraunt(string Created_by)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("GetShowQuestionaries_Restaraunt", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    void FillDetailsNew(DataSet dsent)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                string sen, sen1, sen2, intapprovalidnew, OfflineApprovalflag;
                int i = 0;
                ...
                while (i < c)
                {
                    ...
                    {
                        // legal
                        HlptrLegalMetrologyDepartment.NavigateUrl = sen;
                    ...
                    {
                        // labour
                        HpLabourDepartment.NavigateUrl = sen;
                    ...
                    {
                        // labour
                        HpLabourDepartment48.NavigateUrl = sen;
                    ...
                    {
                        // labour
                        HpLabourDepartment49.NavigateUrl = sen;
                    ...
                    {
                        // forest
                        hpltrforestdept.NavigateUrl = sen;
                    ...
                    if (intapprovalidnew == "32" && OfflineApprovalflag == "Y")
                    {
                        ...
                        hlpTrExplosiveLicenser.NavigateUrl = sen;
                    ...
                    if (intapprovalidnew == "60" && OfflineApprovalflag == "Y")
                    {
                        ...
                        hptrFTLRevenue.NavigateUrl = sen;
