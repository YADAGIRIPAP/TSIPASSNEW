<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" EnableEventValidation="false" 
    AutoEventWireup="true" CodeFile="frmstatusbytypeCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <%--<td style="padding: 5px; margin: 5px" align="right">
                                                <asp:Button ID="BtnBack" runat="server" CssClass="btn btn-primary" TabIndex="10"
                                                    Text="<< Back" OnClick="BtnBack_Click1" />
                                            </td>--%>
