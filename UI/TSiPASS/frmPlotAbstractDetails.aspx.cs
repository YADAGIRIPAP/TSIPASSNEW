...
public partial class UI_TSiPASS_frmPlotAbstractDetails : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        vehicleDS = DeptReportDepartmentWise(FromdateforDB, TodateforDB);

        if (vehicleDS.Tables[0].Rows.Count > 0)
        {
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            int NumberTotal1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "NoOFApplications"));
            NumberTotal = NumberTotal1 + NumberTotal;

            int NumberTotal2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "ApprovedApplns"));
            NumberTotalUpto = NumberTotal2 + NumberTotalUpto;

            int Aproved1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "RejectedApplns"));
            Aproved = Aproved + Aproved1;

            int Aproved2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "QuaryRaisedAppns"));
            AprovedUpto = Aproved2 + AprovedUpto;

            int pending1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "UnderProcessApplns"));
            pending = pending + pending1;

            HyperLink h2 = (HyperLink)e.Row.Cells[2].Controls[0];
            if (h2.Text != "")
            {
                h2.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=TotalApplications&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "districtid")).Trim() + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }

            HyperLink h3 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h3.Text != "")
            {
                h3.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Approved&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "districtid")).Trim() + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }

            HyperLink h4 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h4.Text != "")
            {
                h4.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Rejected&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "districtid")).Trim() + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h5.Text != "")
            {
                h5.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Shortfall&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "districtid")).Trim() + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }

            HyperLink h6 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h6.Text != "")
            {
                h6.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Under process&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "districtid")).Trim() + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            HyperLink hyNumberTotal = new HyperLink();
            hyNumberTotal.ForeColor = System.Drawing.Color.White;
            hyNumberTotal.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=TotalApplications&dist=%"+ "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            hyNumberTotal.Text = NumberTotal.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[2].Text = NumberTotal.ToString();
            e.Row.Cells[2].Controls.Add(hyNumberTotal);

            e.Row.Cells[3].Text = NumberTotalUpto.ToString();

            HyperLink hyNumberTotalUpto = new HyperLink();
            hyNumberTotalUpto.ForeColor = System.Drawing.Color.White;
            hyNumberTotalUpto.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Approved&dist=%" + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            hyNumberTotalUpto.Text = NumberTotalUpto.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[3].Text = NumberTotalUpto.ToString();
            e.Row.Cells[3].Controls.Add(hyNumberTotalUpto);


            e.Row.Cells[4].Text = Aproved.ToString();
            HyperLink hyAproved = new HyperLink();
            hyAproved.ForeColor = System.Drawing.Color.White;
            hyAproved.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Rejected&dist=%" + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            hyAproved.Text = Aproved.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[4].Text = Aproved.ToString();
            e.Row.Cells[4].Controls.Add(hyAproved);


            e.Row.Cells[5].Text = AprovedUpto.ToString();
            HyperLink hyAprovedUpto = new HyperLink();
            hyAprovedUpto.ForeColor = System.Drawing.Color.White;
            hyAprovedUpto.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Shortfall&dist=%" + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            hyAprovedUpto.Text = AprovedUpto.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[5].Text = AprovedUpto.ToString();
            e.Row.Cells[5].Controls.Add(hyAprovedUpto);

            e.Row.Cells[6].Text = pending.ToString();
            HyperLink hypending = new HyperLink();
            hypending.ForeColor = System.Drawing.Color.White;
            hypending.NavigateUrl = "frmPlotAbstractDrillDown.aspx?Status=Under process&dist=%" + "&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            hypending.Text = pending.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[6].Text = pending.ToString();
            e.Row.Cells[6].Controls.Add(hypending);
    ...
    public DataSet DeptReportDepartmentWise(string fromdate, string todate)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        ...
        {// if Your Changeing the query same should be in "DeptReportDepartmentWise_New_export"
            da = new SqlDataAdapter("usp_tempPlotProc", con.GetConnection);
