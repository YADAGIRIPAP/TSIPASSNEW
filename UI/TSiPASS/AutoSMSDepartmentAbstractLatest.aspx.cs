...
public partial class FrmUsers : System.Web.UI.Page
{
    ...
    int pendingafter, pendingbefore, closedafter, closedbefore, total, Reject, QueryRaised, QueryRaiseda, Pending, Pendinga, Approved, Approveda, payment, tomorrow, tomorrowa;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            tbl1.Width = "750";
            TTotal("Gr");
            //SendSingleSMSnew("9985328475", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007218852372699583");

            SendSingleSMSnew("9030904595", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");

            //SendSingleSMSnew("9985328475", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            // cmf.SendSingleSMSnew("9502036517", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");

            // 9866584550  Francies
            //SendSingleSMSnew("9866584550", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
            // KCS BABU SIR
            SendSingleSMSnew("9908077333", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            // Shanthi Kumari MAdam
            //SendSingleSMSnew("9100986717", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")"); commented on 02/02/2020
            // Ahmad Nadeem IAS
            //SendSingleSMSnew("8008007748", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
            // Manick Raj IAS

            //SendSingleSMSnew("7702542727", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            //SendSingleSMSnew("9441882727", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");

            SendSingleSMSnew("9000728887", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");

            SendSingleSMSnew("8096465555", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            //SendSingleSMSnew("9502036517", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");

            SendSingleSMSnew("9618445500", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            SendSingleSMSnew("7702948880", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
            SendSingleSMSnew("9490694577", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + tomorrowa.ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");//COI MALSUR
            //SendSingleSMSnew("9182775855", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
            hdfsms.Value = "0";
        }
    ...
    public void FillGrid()
    {
        ...
        //{
        //    vehicleDS = tran1.DeptReportDepartmentWise_New(Session["DistrictID"].ToString().Trim(), "%");
        //}
        //else
        //{
        vehicleDS = tran1.DeptReportDepartmentWise_New("%", "%");
        // }
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=R5.1: Department wise performance Tracker" + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MobileNumber")).Trim() != "" && hdfsms.Value == "1")
            {
                ...
                if ((Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CompletedBeyondDays")) + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Pending More than 3 Days"))) > 0)
                {
                    ...
                    {
                        SendSingleSMSnew(Convert.ToString(DataBinder.Eval(e.Row.DataItem, "NodalMobileNumber")).Trim(), "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Pending More than 3 Days")).ToString().Trim() + "  and Approvals stage : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CompletedBeyondDays")).ToString().Trim().ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "TOMORROW")).ToString().Trim().ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
                    }
                    if (Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MobileNumber")).Trim() != "")
                    {
                        SendSingleSMSnew(Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MobileNumber")).Trim(), "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Pending More than 3 Days")).ToString().Trim() + "  and Approvals stage : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CompletedBeyondDays")).ToString().Trim().ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "TOMORROW")).ToString().Trim().ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
                    }
                    //SendSingleSMSnew(Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MobileNumber")).Trim(), " " + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Department Name")) + " - Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Pending More than 3 Days")).ToString().Trim() + "  and Approvals stage : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CompletedBeyondDays")).ToString().Trim().ToString().Trim() + " . Application status informed for perusal and necessary action. Cases that could cross timelimit tomorrow : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "TOMORROW")).ToString().Trim().ToString().Trim() + ". TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")", "1007942185675543679");
                    ...
                    //  cmf.SendSingleSMS("9246761959", " " + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Department Name")) + " - Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Pending More than 3 Days")).ToString().Trim() + "  and Approvals stage : " + Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CompletedBeyondDays")).ToString().Trim().ToString().Trim() + " . Application status informed for perusal and necessary action. TS-iPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
    ...
    public void TChildHead(string Service_id, string Department, string Service, string totalReceived, string beforeclose, string afterclose, string beforeopen, string afteropen, string Rejected, string PPending, string QQueryRaised, string Payment, string Approvals, string tomorrow)
    {
        cnt = cnt + 1;
        ...
        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=4&Type=Total'> " + totalReceived.Trim() + "</a>";
        tcell1.Align = "Right";

        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=2&Type=Total'> " + QQueryRaised.Trim() + "</a>";
        tcell1.Align = "Right";
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=1&Type=Within Three Days'> " + beforeopen.Trim() + "</a>";
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=1&Type=Beyond Three Days'> " + afteropen.Trim() + "</a>";
        tcell1.Align = "Right";
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=5&Type=Total'> " + Payment.ToString() + "</a>";
        tcell1.Align = "Right";
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype.aspx?Id=" + Service_id.Trim() + "&Status=3&Type=Total'> " + PPending.ToString() + "</a>";
        tcell1.Align = "Right";

        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype1.aspx?Id=" + Service_id.Trim() + "&Status=2&Type=Within time limits'> " + beforeclose.Trim() + "</a>";
        tcell1.Align = "Right";

        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype1.aspx?Id=" + Service_id.Trim() + "&Status=2&Type=Beyond time limits'> " + afterclose.Trim() + "</a>";
        tcell1.Align = "Right";
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype1.aspx?Id=" + Service_id.Trim() + "&Status=1&Type=Total'> " + Approvals + "</a>";
        tcell1.Align = "Right";
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype1.aspx?Id=" + Service_id.Trim() + "&Status=3&Type=Total'> " + Rejected.Trim() + "</a>";
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tbl1.Rows.Add(tRow);

        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = "<a href='frmDeptstatusbytype1.aspx?Id=" + Service_id.Trim() + "&Status=3&Type=Total'> " + tomorrow.Trim() + "</a>";
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tbl1.Rows.Add(tRow);
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        SendSingleSMSnew("9985328475", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        // cmf.SendSingleSMSnew("9502036517", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        SendSingleSMSnew("9014886811", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        // 9866584550  Francies
        SendSingleSMSnew("9866584550", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        // KCS BABU SIR
        SendSingleSMSnew("9908077333", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        // Shanthi Kumari MAdam
        SendSingleSMSnew("9100986717", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
        // Ahmad Nadeem IAS
        SendSingleSMSnew("8008007748", "Madam/Sir, CFE : Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " . Application status informed for perusal and necessary action. TSiPASS (" + System.DateTime.Now.ToString("dd-MMM-yyyy") + ")");
