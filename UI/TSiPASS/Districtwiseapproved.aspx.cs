...
public partial class UI_TSiPASS_Disticwiseapproved : System.Web.UI.Page
{
    decimal NumberTotal, InvestmnetTotal, EmploymentTotal, AppliedwithinperiodTotal, AppliedoutofperiodTotal, ApprovedwithinperiodTotal;
    #region Declaration
    ...
    public void fillgrid()
    {
        ...
        if (valid == 0)
        {
            ...
            dsnew = Gen.DistApprovalDatewiseTotalAppl(FromdateforDB, TodateforDB, district);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            //dsChartData = Gen.FetchTotalDistrictwise_New_New( FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue, ddldistrict.SelectedItem.Text).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
              decimal NumberTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Approvedwithinperiod"));
            ...
            decimal AppliedwithinperiodTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Appliedwithinperiod"));
            AppliedwithinperiodTotal = AppliedwithinperiodTotal + AppliedwithinperiodTotal1;

            decimal AppliedoutofperiodTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Appliedoutofperiod"));
            AppliedoutofperiodTotal = AppliedoutofperiodTotal + AppliedoutofperiodTotal1;


                 HyperLink h1 = (HyperLink)e.Row.Cells[2].Controls[0];
                 if (h1.Text != "0")
                 h1.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() +  "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text+ "&Status=Appliedwithinperiod"+ "&DistrictID="+distid;
            

            HyperLink h2 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h2.Text != "0")
                h2.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim() + "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text + "&Status=Appliedwithinperiod"+ "&DistrictID="+ distid;

            HyperLink h3 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h3.Text != "0")
                h3.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Districtname")).Trim()+ "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text + "&Status=Appliedoutofperiod"+ "&DistrictID="+ distid;
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" +district+ "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text + "&Status=Approvedwithinperiod";
            ...
            HyperLink hplinkAppliedwithinperiodTotal = new HyperLink();
            hplinkAppliedwithinperiodTotal.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" + district + "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text + "&Status=Appliedwithinperiod";
            hplinkAppliedwithinperiodTotal.Text= AppliedwithinperiodTotal.ToString();
            hplinkAppliedwithinperiodTotal.ForeColor = System.Drawing.Color.White;
            e.Row.Cells[5].Text = AppliedwithinperiodTotal.ToString();
            e.Row.Cells[5].Controls.Add(hplinkAppliedwithinperiodTotal);


            HyperLink hplinkAppliedoutofperiodTotal = new HyperLink();
            hplinkAppliedoutofperiodTotal.NavigateUrl = "DistrictWiseApprovedDrillDown.aspx?District=" + district + "& From=" + txtFromDate.Text + "& To=" + txtTodate.Text + "&Status=Appliedoutofperiod";

            hplinkAppliedoutofperiodTotal.Text= AppliedoutofperiodTotal.ToString();
            hplinkAppliedoutofperiodTotal.ForeColor = System.Drawing.Color.White;
            e.Row.Cells[6].Text = AppliedoutofperiodTotal.ToString();
            e.Row.Cells[6].Controls.Add(hplinkAppliedoutofperiodTotal);
