<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveSingleUploadsNew.aspx.cs" Inherits="UI_TSiPASS_IncentiveSingleUploadsNew" %>
                                                            ...
                                                            <asp:TemplateField HeaderText="Upload Documents">
                                                                <ItemTemplate>
                                                                    <asp:UpdatePanel runat="server" UpdateMode="Conditional" RenderMode="Inline" ID="updFU">
                                                                        <ContentTemplate>
                                                                            <asp:FileUpload ID="fuDocuments" CssClass="CS" runat="server" />
