<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TourismDashBoard.aspx.cs" Inherits="UI_TSiPASS_TourismDashBoard" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> Tourism Event Dashboard</a>
                            </h4>
                        </div>
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    <tr style="height: 40px">
                                        <td style="width: 395px; font-size: 16px;" colspan="3" valign="top">
                                            <u><b>Tourism Event</b> </u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 395px">
                                            <div class="list-group">
                                                <a href="frmDraftQuestionnaireTourisamEvent.aspx" class="list-group-item"><span class="badge">
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a class="list-group-item" href="frmDraftQuestionnaireTourisamEvent.aspx?status=B"><span class="badge">
                                    ...
                                    <tr>
                                        <td style="width: 395px">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approvals Required as per TS-iPASS'>
                                                    <span class="badge">
                                        ...
                                        <td style="width: 395px">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approvals already Obtained'>
                                                    <span class="badge">
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approvals - Applied now'>
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approvals - Yet to be applied'>
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Queries Raised'>
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Queries Responded'>
                                                    <span class="badge">
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href="frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Queries -Yet to Respond"><span class="badge" style="background-color: #d9534f;">
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Pre-Scrutiny - Rejected'>
                                                    <%--                                              frmCFEDepartmentsViewApplStatus.aspx--%>
                                                    <span class="badge" style="background-color: #d9534f;">
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href="frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Pre-Scrutiny - Completed">
                                                    <span class="badge">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a
                                                    class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approval - Paid for'><span
                                                        class="badge">
                                    ...
                                    <tr id="trnotrequired" runat="server" visible="false">
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item" href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approvals - Payment not required'>
                                                    <span class="badge">
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approval - Issued'>
                                                    <span class="badge">
                                        ...
                                        <td style="width: 395px" valign="top">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href='frmDashboardRedirectTourism.aspx?id=<%= Session["Applid"]%>&status=Approval - Pending'>
                                                    <span class="badge" style="background-color: #d9534f;">
                                    ...
                                    <tr>
                                        <td style="width: 395px; font-size: 16px;">
                                            <div class="list-group">
                                                <a class="list-group-item"
                                                    href='frmDashboardRedirectTourism.aspx?id=<%= Request.QueryString[0].ToString()%>&status=Approval - Rejected'>
                                                    <span class="badge" style="background-color: #d9534f;">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="width: 395px" id="trackappl" runat="server" visible="true">
                                            ...
                                            <div class="text-right">
                                                <img src="../../gif-new.gif" />
                                                <a href="RptApplicationWiseDetailedTrakerTourismEvent.aspx" style="font-size: 16px">Track your application
