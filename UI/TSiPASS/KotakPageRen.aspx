<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPageRen.aspx.cs" Inherits="UI_TSIPASS_KotakPageRen" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerRen.aspx">
    <div id="myDIV">
        <center>
        ...
        <table id="Table1" width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerRen.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmDepartmentRenewalPaymentDetails.aspx" />
                </td>
            </tr>
            <tr>
                <td>
