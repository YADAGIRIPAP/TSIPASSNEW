...
public partial class UI_TSiPASS_TotalReportold2New_MANDALWISE : System.Web.UI.Page
{
    ...
    protected void FINANCIALYEARS()
    {
        DataSet dsnew = new DataSet();

        dsnew = GETFINANCIALYEARS();
        ddlType.DataSource = dsnew.Tables[0];
        ddlType.DataTextField = "FinancialYear";
        ddlType.DataValueField = "FYEAR";
        ddlType.DataBind();
    ...
    public void fillgrid()
    {
        ...
        dsnew = FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue,ddldistrict.SelectedItem.Text, ddlimplementation.SelectedItem.Text, ddlsector.SelectedValue);
        if (dsnew.Tables.Count > 1)
        {
            if (dsnew.Tables[1].Rows.Count > 0)
            {
                HDNFROMDATE.Value = dsnew.Tables[1].Rows[0]["FROMDATE"].ToString().Trim();
                HDNTODATE.Value = dsnew.Tables[1].Rows[0]["TODATE"].ToString().Trim();
            }
        }
        DataSet ds = new DataSet();
        ...
        if (dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            {
                Label1.Text = "Report from  " + HDNFROMDATE.Value + " to " + HDNTODATE.Value;//.ToString("dd-MMM-yyyy");
            }
            else
            {
                if (txtFromDate.Text.Trim() != "" && txtTodate.Text.Trim() != "")
    ...
    public DataSet FetchTotalDistrictwise_New_New(string status, string fromdate, string todate, string EnterPriseType, string Districtid, string Implementationstatus, string SECTOR)
    {
        ...
        try
        {
            da = new SqlDataAdapter("FetchTotalDistrictwise_New_New_MANDAL_new", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;

            if (status.Trim() == "" || status.Trim() == null || status.Trim() == "--Select--"|| status.Trim() == "0")
            ...
            if (EnterPriseType.Trim() == "" || EnterPriseType.Trim() == null || EnterPriseType.Trim() == "--Select--"|| EnterPriseType.Trim()=="0")
                da.SelectCommand.Parameters.Add("@EntType", SqlDbType.VarChar).Value = "%";
            else
            ...
            if (Implementationstatus.Trim() == "" || Implementationstatus.Trim() == null || Implementationstatus.Trim() == "--Select--")
                da.SelectCommand.Parameters.Add("@Implementationstatus", SqlDbType.VarChar).Value = "%";
            else
                da.SelectCommand.Parameters.Add("@Implementationstatus", SqlDbType.VarChar).Value = Implementationstatus.ToString();

            if (SECTOR.Trim() == "" || SECTOR.Trim() == null || SECTOR.Trim() == "--Select--"|| SECTOR.Trim() == "0")
...
//                TodateforDB = Convert.ToString(DateTime.ParseExact(txtTodate.Text, "dd-MM-yyyy", null).ToString("MM-dd-yyyy"));
//            }
//            dsChartData = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue).Tables[0];
...
//    }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Mandal=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MandalID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue+ "&District="+ddldistrict.SelectedItem.Text+"&progress="+ddlimplementation.SelectedItem.Text+"&sector="+ddlsector.SelectedValue;

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];

            h2.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Mandal=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MandalID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue + "&District=" + ddldistrict.SelectedItem.Text + "&progress=" + ddlimplementation.SelectedItem.Text + "&sector=" + ddlsector.SelectedValue;

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];

            h3.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Mandal=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MandalID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue + "&District=" + ddldistrict.SelectedItem.Text + "&progress=" + ddlimplementation.SelectedItem.Text + "&sector=" + ddlsector.SelectedValue;
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&District=" + ddldistrict.SelectedItem.Text + "&progress=" + ddlimplementation.SelectedItem.Text + "&sector=" + ddlsector.SelectedValue;
            Total.Text = NumberTotal.ToString();

            e.Row.Cells[2].Text = NumberTotal.ToString();
           // e.Row.Cells[2].Controls.Add(Total);

            HyperLink InvestmnetTotal1 = new HyperLink();
            InvestmnetTotal1.ForeColor = System.Drawing.Color.White;
            InvestmnetTotal1.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&District=" + ddldistrict.SelectedItem.Text + "&progress=" + ddlimplementation.SelectedItem.Text + "&sector=" + ddlsector.SelectedValue;
            InvestmnetTotal1.Text = InvestmnetTotal.ToString();

            e.Row.Cells[3].Text = InvestmnetTotal.ToString();
            //e.Row.Cells[3].Controls.Add(InvestmnetTotal1);

            HyperLink EmploymentTotal1 = new HyperLink();
            EmploymentTotal1.ForeColor = System.Drawing.Color.White;
            EmploymentTotal1.NavigateUrl = "FrmDistDrilldownold2New_MANDALWISE.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&District=" + ddldistrict.SelectedItem.Text + "&progress=" + ddlimplementation.SelectedItem.Text + "&sector=" + ddlsector.SelectedValue;
            EmploymentTotal1.Text = EmploymentTotal.ToString();

            e.Row.Cells[4].Text = EmploymentTotal.ToString();
            //e.Row.Cells[4].Controls.Add(EmploymentTotal1);
       }
    }
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=R20:TSiPASS-MandalWiseReport.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        Government.Visible = true;
        divPrint1.Style["width"] = "680px";
    ...
    protected void BtnPDF_Click(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=R20:TSiPASS-TotalReportold2NewReport_Mnadalwise" + ".pdf");
    ...
    protected void btnNewPdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=R20_Mandal_wise_Abstract" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
