...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerREN : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds = Gen.ApplicationWiseDetailedTrakerREN(intqnreid.ToString());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //    {
        //        Label lbl = (e.Row.FindControl("lblFileName") as Label);
        //        HyperLink HyperLinkSubsidy = (e.Row.FindControl("HyperLink2") as HyperLink);
        //        if (lbl.Text != "")
        //        {
