...
public partial class UI_TSiPASS_DeptFeedBackStatusDetails : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //    h1.Text = "Forward";
            //    h1.NavigateUrl = "frmFeedBackChangestatus.aspx?intGrievanceid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intGrievanceid")).Trim() + "&forward=Y";
            //    h1.Visible = true;
            //}
        }
    }
