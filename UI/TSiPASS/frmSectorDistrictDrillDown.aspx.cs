...
public partial class UI_TSiPASS_frmSectorDistrictDrillDown : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchSectorwiseDrildownNewNewDistrict(Request.QueryString[0].ToString().Trim(), QueryString2, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
        // lblMsg.Text = "";
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "frmsectorDistrictDrillunitswise.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + sector + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue + "&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "frmsectorDistrictDrillunitswise.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + sector + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue + "&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "frmsectorDistrictDrillunitswise.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Sec=" + sector + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue + "&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "frmsectorDistrictDrillunitswise.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
