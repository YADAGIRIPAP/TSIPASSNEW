<%@ Page Title=":: TSiPASS : Implentation Partner Details" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="TSTIPregistration.aspx.cs" Inherits="TSTIPregistration" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="">
                                <i class="fa fa-fw fa-edit"></i> TST Team
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Implementation Partners</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Implementation Partners</h3>
                            </div>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:TextBox ID="txtip" runat="server" class="form-control txtbox" 
                                                            Height="42px" MaxLength="40"  TabIndex="1" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:TextBox ID="txtauthorised" runat="server" class="form-control txtbox" 
                                                            Height="35px" MaxLength="40"  TabIndex="1" 
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label350" runat="server" CssClass="LBLBLACK" Width="137px">Authorised 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:TextBox ID="txtmail" runat="server" class="form-control txtbox" 
                                                            Height="34px" MaxLength="40" TabIndex="1" ValidationGroup="group" 
                                                            Width="180px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                            ControlToValidate="txtmail" ErrorMessage="Please Enter Email" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                                            ControlToValidate="txtmail" ErrorMessage="Please Enter Correct Email" 
                                        ...
                                        <td valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label370" runat="server" CssClass="LBLBLACK" Width="145px">Secondary Authorised 
                                                        Person Contact No</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtSEmail" runat="server" class="form-control txtbox" 
                                                            Height="38px" MaxLength="40"  TabIndex="1" 
                                                            ValidationGroup="group" Width="180px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                                                            ControlToValidate="txtweb" ErrorMessage="Please Enter Valid website" 
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label357" runat="server" CssClass="LBLBLACK" Width="137px">Password</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
