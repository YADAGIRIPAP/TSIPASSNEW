<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="FormApplicationADMandG.aspx.cs" Inherits="UI_TSiPASS_FormApplicationADMandG" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <script src="../../Resource/Scripts/js/validations.js" type="text/javascript"></script>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Government Land Details</a>
                    </li>
                </ol>
            </div>
            <div align="left">
                <div class="row" align="left">
                    <div class="auto-style3">
                        ...
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="center" style="font-size: x-large">Application format by ADM&G For Govt. Lands</h1>
                        </div>
                        <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>--%>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" valign="top">
                                                <table cellpadding="4" cellspacing="5" style="width: 70%">
                                                    <tr>
                                                        <td style="padding: 5px; margin: 5px; font-size:20px;  text-align: left;" >Sl.No.
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; font-size:20px;text-align: left;">
                                                            <asp:Label ID="Label4" runat="server" CssClass="LBLBLACK" Width="210px">Item<font 
                                                            color="red"></font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; font-size:20px; width: 192px; text-align: left;">
                                                            <asp:Label ID="Label398" runat="server" CssClass="LBLBLACK" Text-allign="center" Width="210px">Desription<font color="red"></font></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" Width="210px">Mineral Name<font 
                                                            color="red">*</font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:DropDownList ID="ddlMineral" runat="server" class="form-control txtbox" Height="33px"
                                                                Width="180px" AutoPostBack="True" ValidationGroup="group" TabIndex="1" OnSelectedIndexChanged="ddlMineral_SelectedIndexChanged">
                                                                <asp:ListItem>--Select--</asp:ListItem></asp:DropDownList>
                                                           
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; " class="auto-style2">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlMineral"
                                                                ErrorMessage="Please Select Mineral Name" ValidationGroup="group" >*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>                                                                                                     
                                                    <tr>
                                                        <td style="padding: 5px; margin: 5px" class="auto-style1">2.
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px">
                                                            <asp:DropDownList ID="ddlmandal" runat="server" class="form-control txtbox" Height="33px"
                                                                Width="180px" AutoPostBack="True" ValidationGroup="group" OnSelectedIndexChanged="ddlmandal_SelectedIndexChanged"
                                                                TabIndex="1">
                                                                <asp:ListItem>--Select--</asp:ListItem>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; " class="auto-style2">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlmandal"
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top" align="left">
                                    &nbsp;</td>
                                <td style="width: 27px">
                                    <asp:Label ID="Label399" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="280px">Select Village,Enter Survey No's,</asp:Label>
                                                        </td>
                                <td valign="top">&nbsp;</td>
                            </tr>
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px">
                                                            <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Width="165px">Village (Multiple Villages may Present)<font 
                                                            color="red">*</font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:
                                                        </td>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; " class="auto-style2">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlvillage"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label6" runat="server" CssClass="LBLBLACK" Width="210px">Survey No. (Multiple Survey Numbers May Present)<font 
                                                            color="red">*</font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="TxtSurveyNo" runat="server" class="form-control txtbox" Height="28px"
                                                                TabIndex="1" AutoCompleteType="Disabled"  Width="250px"></asp:TextBox>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; " class="auto-style2">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtSurveyNo"
                                                                ErrorMessage="Please enter Survey No's" >*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label9" runat="server" CssClass="LBLBLACK" Width="210px">Extent (in Hectare) for above Survey No.<font 
                                                            color="red">*</font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="TxtPartExtent" runat="server" onkeypress="DecimalOnly()" class="form-control txtbox" Height="28px"
                                                                 AutoCompleteType="Disabled" TabIndex="1"  ValidationGroup="group" Width="250px"></asp:TextBox>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; " class="auto-style2">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TxtPartExtent"
                                                                ErrorMessage="Please enter Extent" >*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                ...
                                <td style="padding: 5px; margin: 5px; text-align: left;" colspan="5">
                                    <asp:GridView ID="gvVillageAdd" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <AlternatingRowStyle BackColor="White" />
                                                    ...
                                                    <tr>
                        <td style="padding: 5px; margin: 5px; text-align: left;">7.<asp:HiddenField ID="HdfldTotalExtent" runat="server" />
                         </td>
                         <td style="padding: 5px; margin: 5px; text-align: left;">
                          <asp:Label ID="Label5" runat="server" CssClass="LBLBLACK" Width="210px">Total Extent (in Hectare)<font 
                               color="red">*</font></asp:Label>
                            </td>
                           <td style="padding: 5px; margin: 5px">:
                          </td>
                       <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;" class="auto-style4">
                                   &nbsp;
                        <asp:TextBox ID="TxtTotalExtent" runat="server" class="form-control txtbox" Height="28px"
                          TabIndex="1" AutoCompleteType="Disabled" ValidationGroup="group" Width="250px"></asp:TextBox>
                      ...
                      <td style="padding: 5px; margin: 5px; " class="auto-style2">    
                           <asp:HiddenField ID="HDNAPPLICATIONID" runat="server" />                            
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="BtnClearAll" runat="server" CausesValidation="False" CssClass="btn btn-warning"
                                                    Height="32px"  TabIndex="10" Text="ClearAll" ToolTip="To Clear  the Screen"
                                                    Width="90px" OnClick="BtnClearAll_Click" />&nbsp;
                                                <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                                     TabIndex="10" Text="Submit" Width="90px" ValidationGroup="group" OnClick="BtnSave1_Click" />
                                                &nbsp;
                                        ...
                                        <td align="center" style="padding: 5px; margin: 5px">
                                            ...
                                            ShowSummary="true" ValidationGroup="group" />
                                            </div>
                ...
                <table cellpadding="4" cellspacing="5" style="width: 100%; text-align: left;">
                    ...
                    <tr id="trAtchment" Visible="false" runat="server">
                        ...
                        <td style="padding: 5px; margin: 5px; width: 10px;" valign="top">
                            <asp:Button ID="BTNDGPSMAP" runat="server" CssClass="btn btn-xs btn-warning" Height="28px" 
                                OnClick="BTNDGPSMAP_Click" TabIndex="10" Text="Upload" Width="72px" />
                    ...
                    <tr id="tratchmentsave" runat="server" visible="false">
                        ...
                        <td align="center" style="padding: 5px; margin: 5px; text-align: center;">
                            <asp:Button ID="Button3" runat="server" CssClass="btn btn-primary" Height="32px"
                                 TabIndex="10" Text="Save"  Width="90px"
                                Visible="true" OnClick="Button3_Click" />
                            &nbsp;&nbsp;<asp:Button ID="Button4" runat="server" CausesValidation="False" CssClass="btn btn-danger"
                                Height="32px"  TabIndex="10" Text="Clear" Width="90px" OnClick="Button4_Click" />
                        </td>
                    </tr>
                    <tr id="trsuccess" runat="server" visible="false">
                        ...
                        </asp:UpdatePanel>--%> <%--End of Updatepanel1--%>
    ...
    </asp:UpdatePanel> <%--END OF upd1 updatepanel--%>
