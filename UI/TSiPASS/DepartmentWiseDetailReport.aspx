<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="DepartmentWiseDetailReport.aspx.cs"
    Inherits="TSTBDCReg1" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            Department Wise Progress&nbsp;<a id="A1" href="#" onserverclick="BtnPDF_Click" runat="server">
                                <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                    alt="PDF" /></a> <a id="A2" href="#" onserverclick="BtnExport_Click1" runat="server">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px" align="right">
                                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-default" TabIndex="10"
                                                    Text="Submit" OnClick="BtnSearch_Click" />
                                            </td>
                            ...
                            <%--<tr>
                                    <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                                        ...
                                        <asp:Button ID="BtnExport" runat="server" CssClass="btn btn-primary" Height="32px"
                                            TabIndex="10" Text="Export" Width="90px" OnClick="BtnExport_Click1" />
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:BoundField DataField="Name of the Industry" HeaderText="Name of the Industry" />
                                                            ...
                                                            <asp:BoundField DataField="Approval Name" HeaderText="Type Of Approval" />
                                                            <asp:BoundField DataField="Date Of Application" HeaderText="Date Of Application" />
                                                            <asp:BoundField DataField="Date Of Prescrutiny" HeaderText="Date Of Prescrutiny" />
                                                            <asp:BoundField DataField="Date Of Approval" HeaderText="Date Of Approval" />
                                                            <asp:BoundField DataField="No Of Days Taken For Approval" HeaderText="No Of Days Taken For Approval" />--%>
