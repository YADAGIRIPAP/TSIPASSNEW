<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="apparaisalnote_SpecificCleaner.aspx.cs" Inherits="UI_TSiPASS_apparaisalnote_SpecificCleaner" %>
...
<table style="width: 100%; font-weight: bold;">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <tr>
                    <td class="auto-style96">4.1</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Expenditure Incurred.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">:</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txtexpenditureincurred" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)"  MaxLength="80" TabIndex="36"
                            Width="150px" OnTextChanged="txtexpenditureincurred_TextChanged"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">25% Expenditure Incurred</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55"></td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55"> <asp:TextBox ID="txtexpenditureincurred25" runat="server" class="form-control txtbox txtcomn"
            ...
            <tr id="tr4232" runat="server" visible="true">
                    <td class="auto-style96">4.2</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Eligible Specific Cleaner in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                ...
                <tr id="tr1" runat="server" visible="true">
                    ...
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Final Eligible Specific Cleaner in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
