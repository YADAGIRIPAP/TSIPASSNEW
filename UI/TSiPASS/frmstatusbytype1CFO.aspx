<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmstatusbytype1CFO.aspx.cs"
    Inherits="TSTBDCReg1" %>
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5">
                            ...
                            <tr id="divPrint" runat="server" style="width: 100%">
                                <td align="center" colspan="4" style="padding: 5px; margin: 5px; width: 100%; text-align: center;"
                                    valign="top">
