<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmdaywiseIncentivedrillmanufacture.aspx.cs" Inherits="UI_TSiPASS_frmdaywiseIncentivedrillmanufacture" %>
                            ...
                            <tr>
                                <td colspan="4">
                                    <table width="100%">
                                        ...
                                        <tr runat="server" id="trBetweenDates" align="center">
                                            <td style="padding: 5px; margin: 5px">Date:   
                                            ...
                                            <td style="padding: 5px; margin: 5px" Visible="false">To Date:  
                                            
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTodate" runat="server" Visible="false" class="form-control txtbox" Height="28px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group" Width="125px" ></asp:TextBox>
                                ...
                                <td align="center" colspan="4" style="padding: 5px; margin: 5px; text-align: center;"
                                    ...
                                    <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="View" Visible="false">
                                                <ItemTemplate>
                                                   <%--<asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" Text="View" Target="_blank" NavigateUrl='<%# Eval("ENTERPERINCENTIVEID", "ApplicationIncentiveDetailsView.aspx?ENTERPERINCENTIVEID={0}") %>'>
                                                   </asp:HyperLink>--%>
                                                    <asp:HyperLink CssClass="btn btn-link"  ID="HyperLink1" runat="server" Text="View" Target="_blank" NavigateUrl='<%# string.Format("~/UI/TSiPASS/ApplicantIncentiveDetailsView.aspx?EntrpId={0}&Role={1}&IncName={2}&Sts=10&SVCStatus=PRESVC",Eval("ENTERPERINCENTIVEID"),Request.QueryString["type"].ToString(),Eval("IncentiveName")) %>'>
                                                   </asp:HyperLink>
                                            ...
                                            <asp:BoundField DataField="UnitType" ItemStyle-HorizontalAlign="Center" HeaderText="Unit Type" >
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>

                                            <asp:BoundField DataField="UnitCategory" ItemStyle-HorizontalAlign="Center" HeaderText="Unit Category" >
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
