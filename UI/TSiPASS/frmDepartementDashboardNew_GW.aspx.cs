...
public partial class UI_TSIPASS_frmDepartementDashboardNew_GW : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                DataSet ds = obj_dashboard.GetDepartentApplications_GroundwaterDept(Session["User_Code"].ToString().Trim());
    ...
    void FillDetails()
    {
        DataSet ds = obj_dashboard.GetDepartmentDashboardDetails_GroundwaterDept(Session["User_Code"].ToString().Trim());
