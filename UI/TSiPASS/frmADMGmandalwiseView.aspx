<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmADMGmandalwiseView.aspx.cs" Inherits="UI_TSiPASS_frmADMGmandalwiseView" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class=""><i class="fa fa-fw fa-edit">MineNoc</i> </li>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="MineralDistrict" HeaderText="District" />
                                                            <asp:BoundField DataField="MineralMandal" HeaderText="Mandal" />
