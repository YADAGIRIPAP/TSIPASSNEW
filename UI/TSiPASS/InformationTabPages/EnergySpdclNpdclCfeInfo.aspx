<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnergySpdclNpdclCfeInfo.aspx.cs" Inherits="UI_TSiPASS_InformationTabPages_EnergySpdclNpdclCfeInfo" %>
            ...
            <div id="main">
                <div class="container">
                    <section id="primary" class="page-with-sidebar with-right-sidebar">
                        <h3>Electricity Connection from Energy Department</h3><br />
                        ...
                        <h4>Processing of the Application: </h4>                      
                            <ul class="dt-sc-fancy-list chocolate check-circle">
                                <li><span>If the application is found to be in order, the feasibility assessment will be carried out followed by which deposit amount will be intimated to consumer for electricity connection.</span></li>
                                <li><span>Post feasibility assessment, estimation will be carried out. After estimation is carried out on payment of fees an approval copy will be sent to the industrialist based on which the consumer can carry out extension works.</span></li>
