<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TspcbCfoInfo.aspx.cs" Inherits="UI_TSiPASS_InformationTabPages_TspcbCfoInfo" %>
                ...
                <div id="main">
                    <div class="container">
                        <section id="primary1" class="page-with-sidebar with-right-sidebar">
                            <h3><br />Consent for Operation (CFO) and Authorisation under Hazardous and other Wastes (Management & Transboundary Movement) Rules, 2016 from TS Pollution Control Board</h3>
