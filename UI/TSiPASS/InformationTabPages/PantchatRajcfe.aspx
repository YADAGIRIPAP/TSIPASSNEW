<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PantchatRajcfe.aspx.cs" Inherits="UI_TSiPASS_InformationTabPages_PantchatRajcfe" %>
            ...
            <div id="main">
                <div class="container">
                    <section class="page-with-sidebar with-right-sidebar">
                        ...
                        <h4>Gram Panchayat NoCfrom Gram Panchayat</h4>
                        <div class="dt-sc-hr-invisible-very-small"></div>
                        <h4>Application for Gram Panchayat NoC: </h4>
                        <div class="column">
