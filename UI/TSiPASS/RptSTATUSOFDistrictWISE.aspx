<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="RptSTATUSOFDistrictWISE.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight:bold;">
                            R3.1 PENDENCY OF NALA APPLICATIONS - DISTRICT WISE&nbsp; <a id="A1" href="#" onserverclick="BtnPDF_Click"
                                runat="server">
                                <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                    /></a> <a id="A2" href="#" onserverclick="BtnSave2_Click" runat="server">
                            ...
                            <tr id="div_Print" runat="server">
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="None" OnRowDataBound="grdDetails_RowDataBound" 
