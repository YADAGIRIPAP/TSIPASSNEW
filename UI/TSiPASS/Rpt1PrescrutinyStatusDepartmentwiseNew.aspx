<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="Rpt1PrescrutinyStatusDepartmentwiseNew.aspx.cs"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        ...
        <tr>
            <td style="padding-right: 10px; padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                valign="top" align="center">--%>
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">R2.2 Scrutiny - Query Details</asp:Label>&nbsp;
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 50%; font-family: 'Trebuchet MS'">
                            ...
                            <tr id="divPrint" runat="server">
                                <td align="center" colspan="4" style="padding: 5px; width: 80%; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ShowFooter="true" Width="80%" OnPageIndexChanging="grdDetails_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Query Response Delay (In Days)" DataField="DelayNumberOfDays">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField HeaderText="Query Response Remarks" DataField="QueryResponseRemarks" />
