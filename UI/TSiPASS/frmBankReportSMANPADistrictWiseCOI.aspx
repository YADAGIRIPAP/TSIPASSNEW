<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBankReportSMANPADistrictWiseCOI.aspx.cs" Inherits="UI_TSiPASS_frmBankReportSMANPADistrictWiseCOI" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Banker Sub-Debt Scheme Report District Wise</asp:Label>&nbsp;
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Bank Name" HeaderText="District Name" />
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No of Units"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofunits" runat="server" Text='<%#Eval("No Units") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                   

                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SMA Updated Data"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofUpdatedSMA" runat="server" Text='<%#Eval("SMA") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="NPA Updated Data"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofUpdatedNPA" runat="server" Text='<%#Eval("NPA") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
