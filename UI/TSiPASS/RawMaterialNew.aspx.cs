...
comFunctions cmf = new comFunctions();
    ...
    public void Insert()
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "ale41", "alert('Please Enter Upload Document');", true);
            return;
        }
      ...
      Response.Redirect("PrintReceiptNew1.aspx?id=" + dss.Tables[0].Rows[0][0].ToString());
