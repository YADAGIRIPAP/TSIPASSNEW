...
public partial class UI_TSiPASS_UpdateUTRNumberListALL : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("UpdateUTRNUMBERDeatailFinalALL.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&Date=" + ddlapplicationto.SelectedValue + "&SubIncTypeId=" + lblsubInctypeid + "&DIPC=" + DIPCFlag + "&distid=" + distid);
    ...
    protected void ddlFinancialYear_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ds = getChecklistDtls(DIPCFlag, ddlFinancialYear.SelectedValue, ddlcategory.SelectedValue, distid);
    ...
    public DataSet getChecklistDtls(string DIPCFlag, string FinalId, string Caste, string distid)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
    ...
    public DataSet getincentiveslclistWorkigngListNEW(string date, string DIPCFlag, string distid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_LIST_INCENTIVEWISE_WORKING_ABSTRACT_PRINTEDDATE_CHECKNO_UTRNUMBER_ALL", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
