<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="TouragentDashboardList_User.aspx.cs" Inherits="UI_TSiPASS_TouragentDashboardList_User" %>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">
                                    TRAVEL AGENCY USER DASHBOARD&nbsp;</h3>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        Height="62px" Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDataBound="grdDetails_RowDataBound">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="ApprovalRejection" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblApplApprRejection" Text='<%#Eval("PendingAprRejection") %>' runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Acknowledgement">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="anchortaglinkAcknowledgement" runat="server" Text="Print" Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                            ...
                                            <tr id="trApplyAgainNote" runat="server">
                                                <td align="left" style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                                    &nbsp;<b>Note:</b> To Apply Again for another application, Please Click on &#39;Apply
                                                    Again&#39; and click on Next, Next..&nbsp;&nbsp; Fill other details again as applicable.In
                                                    the final page you will get new application number and new acknowledgement after
