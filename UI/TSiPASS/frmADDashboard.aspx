<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmADDashboard.aspx.cs" Inherits="frmADDashboard" %>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Assistant Director&#39;s Dashboard</h3>
                            </div>
                            ...
                            <div class="panel-body" align="center">
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> No of Applications Received from Superintendent
                                    </a>   
                                          <a class="list-group-item" ><i class="fa fa-fw fa-check"></i>Scrutiny Pending </a>

                                                <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=30"><span class="badge" >
                                                <asp:Label ID="Label1" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>With in 3 Days </a>
                                                
                                                
                                                <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=31"><span class="badge" style=" background-color:#d9534f;">
                                         ...
                                         <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=32"><span class="badge" >
                                                <asp:Label ID="Label3" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>With in 3 Days </a>
                                                
                                                
                                                <a class="list-group-item" href="IncentiveStatusInspectionUploadDetailsnew.aspx?Stg=33"><span class="badge" style=" background-color:#d9534f;">
                                    ...
                                    <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=36" class="list-group-item">
                                        <span class="badge">
                                            <asp:Label ID="Label5" runat="server"></asp:Label></span>
                                        <i class="fa fa-fw fa-calendar"></i> Queries Yet to Respond
                                    </a>   

                                                 <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=34" class="list-group-item">
                                        <span class="badge">
                                            <asp:Label ID="Label6" runat="server"></asp:Label></span>
                                        <i class="fa fa-fw fa-calendar"></i> Queries Responded
                                    </a>   

                                                          <a href="IncentiveStatusInspectionDateDetails.aspx?Stg=35" class="list-group-item">
                                        <span class="badge">
