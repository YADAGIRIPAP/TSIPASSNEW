...
public partial class UI_TSIPASS_appraisalLandConversion : System.Web.UI.Page
{
    ...
    protected void rdeligibility_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            txtEligibleMortgage.Text = TextBox21.Text;
        }
        else if (rdeligibility.SelectedValue == "Belated")
        {
            txtEligibleMortgage.Text =(Convert.ToDecimal(TextBox21.Text)/2).ToString();
        }
        else
        {
        ...
        {
            txtfinaleligibleamount.Text = txtEligibleMortgage.Text;
        }
        else
        {
            txtfinaleligibleamount.Text = txtMortgageRecomended.Text;
        }
    }
    ...
    public void USP_GETDETAILSFORSECTION()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            TextBox44.Text = "0";
            txtLoanSanctioned.Text = ds.Tables[0].Rows[0]["MortgageHypothDutyAP"].ToString();



            txtFinancialInstit.Text = ds.Tables[0].Rows[0]["AreaRegdSaledeed"].ToString();
            txtMortgageDutyPaid.Text = ds.Tables[0].Rows[0]["PlnthAreaBuild"].ToString();
            txtFveBuiltupArea.Text = ds.Tables[0].Rows[0]["FivePlnthAreaBuild"].ToString();
            if (txtFinancialInstit.Text != "" & txtFinancialInstit.Text != null & txtMortgageDutyPaid.Text != "" & txtMortgageDutyPaid.Text != null & txtFveBuiltupArea.Text != "" & txtFveBuiltupArea.Text != null)
            {
                txtMortgageDutyPaid_TextChanged(this, EventArgs.Empty);
               // txtFveBuiltupArea.Text = ((Convert.ToDecimal(txtMortgageDutyPaid.Text)) * 5).ToString();  //builtup area *5
            }
            
            //txtTermloanAvailed.Text = "";
            ...
            //txtEligibleMortgage.Text = TextBox21.ToString();
    ...
    public string InsertCommonData(IncentiveVosAppraisal oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal1_Landconv]";
            ...
            if (oIncentiveVosA.FinancialInstitution != null)
                com.Parameters.AddWithValue("@FinInstitution", oIncentiveVosA.FinancialInstitution);  //land measuring
            if (oIncentiveVosA.TermLoanSanctioned != null)
                com.Parameters.AddWithValue("@TermLoanSanctioned", oIncentiveVosA.TermLoanSanctioned); //purchase value
            if (oIncentiveVosA.MortgagePaid != null)
                com.Parameters.AddWithValue("@MortgagePaid", oIncentiveVosA.MortgagePaid); //building plinth area
            if (oIncentiveVosA.MortgagePaidFveTimess != null)
                com.Parameters.AddWithValue("@MortgagePaidFveTimes", oIncentiveVosA.MortgagePaidFveTimess); //building plinth area 5 times
            if (oIncentiveVosA.TermLoanAvailed != null)
                com.Parameters.AddWithValue("@TermLoanAvailed", oIncentiveVosA.TermLoanAvailed); //proportinate vlaue
            if (oIncentiveVosA.PropMortgageDuty != null)
                com.Parameters.AddWithValue("@PropMortgageDuty", oIncentiveVosA.PropMortgageDuty);  //landvalue computed
            if (oIncentiveVosA.Mortgage_gM != null)
                com.Parameters.AddWithValue("@Mortgage_gM", oIncentiveVosA.Mortgage_gM);  //value recomndd by gm
            if (oIncentiveVosA.Mortgage_Reirmbursement != null)
                com.Parameters.AddWithValue("@Mortgage_Reirmbursement", oIncentiveVosA.Mortgage_Reirmbursement);  //eligible land conv
            ...
            if (oIncentiveVosA.twntyfveComputed != null)
                com.Parameters.AddWithValue("@twntyfveComputed", oIncentiveVosA.twntyfveComputed);  //25% of computed val
            ...
            if (oIncentiveVosA.Finaleligibleamount != null || oIncentiveVosA.Finaleligibleamount == null)
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.FinancialInstitution = txtFinancialInstit.Text;// land measuring
        oIncentiveVosA.TermLoanSanctioned = txtLoanSanctioned.Text; // Purchase value
        oIncentiveVosA.MortgagePaid = txtMortgageDutyPaid.Text; //Building plinth area
        oIncentiveVosA.MortgagePaidFveTimess = txtFveBuiltupArea.Text; //5 times Building plinth area
        oIncentiveVosA.TermLoanAvailed = txtTermloanAvailed.Text; //proportionarte value of area
        oIncentiveVosA.PropMortgageDuty = txtProportionateMortgage.Text;  // land value computed.
        oIncentiveVosA.Mortgage_gM = txtMortgageRecomended.Text;  //value recommended by gm
        oIncentiveVosA.Mortgage_Reirmbursement = txtEligibleMortgage.Text;  //eligible land conversion
        oIncentiveVosA.belatedClaim = rdeligibility.SelectedValue.ToString(); 
        oIncentiveVosA.mortgageRemarks = txtremarks.Text;
        oIncentiveVosA.twntyfveComputed = TextBox21.Text;  //25% of computed value
    ...
    public class IncentiveVosAppraisal
    {
        ...
        public string MortgagePaidFveTimess { get; set; }
        ...
        public string twntyfveComputed { get; set; }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=16");
        }
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        //string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_LANDCONVERSION" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_LANDCONVERSION" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111115", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    protected void txtMortgageDutyPaid_TextChanged(object sender, EventArgs e)
    {
        //txtTermloanAvailed.Text = ((Convert.ToDecimal(txtMortgageDutyPaid.Text) * Convert.ToDecimal(txtLoanSanctioned.Text)) / Convert.ToDecimal(txtFinancialInstit.Text)).ToString();

        //if(Convert.ToDecimal(txtLoanSanctioned.Text) < Convert.ToDecimal(txtTermloanAvailed.Text))
        //{
        //    txtProportionateMortgage.Text = txtLoanSanctioned.Text;
        //}
        //else
        //{
        //    txtProportionateMortgage.Text = txtTermloanAvailed.Text;
        //}

        //TextBox21.Text = ((25 * Convert.ToDecimal(txtProportionateMortgage.Text)) / 100).ToString();
        txtFveBuiltupArea.Text = ((Convert.ToDecimal(txtMortgageDutyPaid.Text)) * 5).ToString();  //builtup area *5
        if (Convert.ToDecimal(txtFinancialInstit.Text) < Convert.ToDecimal(txtFveBuiltupArea.Text))
        {
            txtProportionateMortgage.Text = txtFinancialInstit.Text;
        }
        else
        {
            txtProportionateMortgage.Text = txtFveBuiltupArea.Text;
        }
        txtTermloanAvailed.Text = ((Convert.ToDecimal(txtLoanSanctioned.Text) * Convert.ToDecimal(txtProportionateMortgage.Text)) / Convert.ToDecimal(txtFinancialInstit.Text)).ToString();

        TextBox21.Text = ((25 * Convert.ToDecimal(txtTermloanAvailed.Text)) / 100).ToString();
