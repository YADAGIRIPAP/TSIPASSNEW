<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmGMDelayReasonReportCOI.aspx.cs" Inherits="UI_TSiPASS_frmGMDelayReasonReportCOI" %>
                            ...
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    ...
                                    <a id="A1" href="#" onserverclick="BtnPDF_Click" runat="server">
                                     ...
                                     <a id="A3" href="#" visible="true" runat="server" onclick="doPrint()">
                                ...
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 50%; font-family: 'Trebuchet MS'">
                                    <tr>
                                        <td style="text-align: left">
                                            <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/IncentiveReportsDashboard.aspx"
                                                Text="<< Back">
                                            </asp:HyperLink>
                                        </td>
                                            ...
                                            <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Within Timelimits"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNOOFWITHINTIMELIMITS" runat="server" Text='<%#Eval("WITHINTIMELIMITS") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Explanation given application not processed"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNONOOFEXPLAINATION" runat="server" Text='<%#Eval("NOOFEXPLANATIONGIVENNOTPROCESSED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Explanation found acceptable"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNODELAYRESONACCEPTED" runat="server" Text='<%#Eval("NODELAYRESONACCEPTED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Explanation found not acceptable Showcause generated"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNODELAYREASONNOTACCEPTED" runat="server" Text='<%#Eval("NODELAYREASONNOTACCEPTED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="GM Explanation under scrutiny"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNOOFDELAYPENDING" runat="server" Text='<%#Eval("NOOFDELAYPENDING") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SCN Replied"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNOOFSHOWCAUSEREPLIED" runat="server" Text='<%#Eval("NOOFSHOWCAUSEREPLIED") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SCN - Not Replied"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
