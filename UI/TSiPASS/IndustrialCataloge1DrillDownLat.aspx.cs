...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    //        ddlYear.SelectedValue = ddlYear.Items.FindByValue(System.DateTime.Now.Year.ToString()).Value;
      ...
      //      ddlMonth.SelectedValue = ddlMonth.Items.FindByValue(System.DateTime.Now.Month.ToString()).Value;
        //    ddlMonth.Enabled = false;
            ...
            DataSet ds = Gen.getIndustryCatelogLookUp(Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
            ...
            ds1 = Gen.GetInitialCatelogTarget(Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString());
            ...
            //dscheck1 = Gen.GetShowQuestionariesCFO(Session["uidIPO"].ToString().Trim());
    ...
    //        i = Gen.insertIndustryCatelog(hdfID.Value.ToString(), Session["uidIPO"].ToString(), txtNoofUnit.Text, txtYetCapture.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString(), txtresMandals.Text, Label435.Text);//txtresMandals.Text,
    ...
    //        i = Gen.insertIndustryCatelog("0", Session["uidIPO"].ToString(), txtNoofUnit.Text, txtYetCapture.Text, Request.QueryString[1].ToString(), Request.QueryString[0].ToString(), Session["uidIPO"].ToString(), txtresMandals.Text, Label435.Text);//txtresMandals.Text,
    ...
    //    //    int i = Gen.DelCFOLineofActivity_Man(Session["uidIPO"].ToString());
    ...
    void FillDetails()
    {
        ...
        try
        {
            ...
            //DataSet dsTradenew = Gen.getCFOLineofActMan(Session["uidIPO"].ToString());
    ...
    //        {
    //            AddDataToTableCeertificate(Session["ApplidA"].ToString(),txtBankName.Text,txtBankBranchName.Text,ddlNatureOfLoan.SelectedItem.ToString(), txtPromoterName.Text,ddlintLineofActivity.SelectedItem.ToString(),txtLoanAmont.Text,txtDDDate.Text, (DataTable)Session["CertificateTb2"]);//Session["uidIPO"].ToString()
    ...
    //        {
    //            AddDataToTableCeertificate1(Session["ApplidA"].ToString(), Session["uidIPO"].ToString(), txtRawItem.Text, txtRawQuantity.Text, ddlRawQuantityIn.SelectedItem.Text.ToString(), ddlRawQuantityPer.SelectedItem.Text.ToString(), (DataTable)Session["CertificateTb1"]);//Session["uidIPO"].ToString()
    ...
    //                AddDataToTableCeertificate1(Session["ApplidA"].ToString(), Session["uidIPO"].ToString(), txtRawItem.Text, txtRawQuantity.Text, ddlRawQuantityIn.SelectedItem.Text.ToString(), ddlRawQuantityPer.SelectedItem.Text.ToString(), (DataTable)Session["CertificateTb1"]);
    //                this.gvCertificate0.DataSource = ((DataTable)Session["CertificateTb1"]).DefaultView;
    //                this.gvCertificate0.DataBind();
    //                gvCertificate0.Columns[0].Visible = false;
    //                //clear_child_TOT();
    ...
    //        if ((hdfID.Value.Trim() == "" && hdfFlagID.Value == "0") || (hdfID.Value.Trim() == "" && hdfFlagID.Value == "0") || (hdfID.Value.Trim() == "" && hdfFlagID.Value == "0") || (hdfID.Value.Trim() == "" && hdfFlagID.Value == ""))
    //        {
    //            AddDataToTableCeertificate(Session["uidIPO"].ToString(), txtUnitName.Text, txtaddress.Text, ddlintLineofActivity.SelectedValue.ToString(), cmf.convertDateIndia(txtDateofVisit.Text).ToString("MM-dd-yyyy"), ddlcstatus.SelectedItem.Text.ToString(), txtremark.Text, (DataTable)Session["CertificateTb2"],ddlintLineofActivity.SelectedItem.Text.ToString());//Session["uidIPO"].ToString()
