...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        if (valid == 0)
        {
            ...
            ds = Gen.RptAPPROVALSBYDEPARTMENTWISECFO(ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue,FromdateforDB,TodateforDB);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=A&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=B&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=C&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h3a.Text != "0")
            {
                h3a.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=D&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h3ab.Text != "0")
            {
                h3ab.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=E&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h3ac.Text != "0")
            {
                h3ac.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=F&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
            ...
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=G&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=A&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            Totalpayment.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=G&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalComp.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=B&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalQuery.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=C&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalReject.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=D&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            Totalmorthan3days.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=E&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
            ...
            TotalBeyond3days.NavigateUrl = "frmstatusDepartmentApprovalNextCFO.aspx?status=F&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%" + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                string headerTable = @"<table width='100%' class='TestCssStyle'><tr><td align='center' colspan='10'><h4>" + "CFO R3: Total Approvals Status - Department Wise" + "</h4></td></td></tr><tr><td align='center' colspan='10'><h4>" + label1text + "</h4></td></td></tr></table>";
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R3: Total Approvals Status - Department Wise \n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            phrase = new Phrase();
            cellTextnew = "Department Approvals";
            phrase.Add(new Chunk(cellTextnew, FontFactory.GetFont("Trebuchet MS", 11, Font.NORMAL, Color.WHITE)));
            cell = PhraseCell(phrase, PdfPCell.ALIGN_MIDDLE);
            cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=R3: Total Approvals Status - Department Wise" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
