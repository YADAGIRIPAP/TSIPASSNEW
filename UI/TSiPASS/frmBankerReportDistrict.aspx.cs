...
public partial class UI_TSiPASS_frmBankerReportDistrict : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h2.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=2&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;

            HyperLink h3 = (HyperLink)e.Row.FindControl("HyperLink3");
            h3.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=3&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;

            HyperLink h4 = (HyperLink)e.Row.FindControl("HyperLink10");
            h4.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=4&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;

            HyperLink h5 = (HyperLink)e.Row.FindControl("HyperLink5");
            h5.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=5&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;

            HyperLink h6 = (HyperLink)e.Row.FindControl("HyperLink6");
            h6.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=6&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;

            HyperLink h7 = (HyperLink)e.Row.FindControl("HyperLink11");
            h7.NavigateUrl = "frmBankerReportDistrictDrillDown.aspx?type=7&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&bankname=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Bank Name")).Trim() + "&district=" + ddlProp_intDistrictid.SelectedValue;
        }
    ...
    public DataSet GetBankerApplications(string fromdate, string todate, string districtid)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_BANKERREPORT_DISTRICT", pp);
        return Dsnew;
    }
}