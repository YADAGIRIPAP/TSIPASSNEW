...
public partial class UI_TSiPASS_ReleaseProceedingFinalGmDIPC : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Agreement == "" || Agreement == null || Agreement == "A" || Agreement == "Y" || Agreement == "N" || Agreement == "R" || Agreement == "O")  //O
            {
                ...
                pp[0].Value = Slcno;
                pp[1].Value = EnterperIncentiveID;
                pp[2].Value = MstIncentiveId;
                pp[3].Value = Session["DistrictID"].ToString().Trim();
                pp[4].Value = subinctypeid;

                ds = gen.GenericFillDs("USP_GET_UNIT_INCENTIVEWISE_GM_FINAL_DIPC", pp);
                ...
                if (ds != null && ds.Tables.Count > 1 && ds.Tables[1].Rows.Count > 0)
                {
                    ...
                    if (ds.Tables[1].Rows[0]["LoanAggrementAcNo"].ToString() != "")
                    {
                        ...
                        txtLoanAggrementAcNo.Text = ds.Tables[1].Rows[0]["LoanAggrementAcNo"].ToString();
                    }
                    else
                ...
                dsROLLBACKED = getReleaseProceedingsGMDIPCFinal_ROLLBACKED(EnterperIncentiveID, MstIncentiveId, Session["DistrictID"].ToString().Trim(), subinctypeid);
    ...
    public DataSet getReleaseProceedingsGMDIPCFinal_ROLLBACKED(string EnterperIncentiveID, string MstIncentiveId, string DistID, string SubIncTypeId)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            ...
            da = new SqlDataAdapter("USP_GET_UNIT_INCENTIVEWISE_GMDIPC_FINAL_LAPSED_ROLLBACKED", con.GetConnection);
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        if (i == 1)
        {
            if (ddlworkingstatus.SelectedValue == "2")
            {
                ...
                gmfinalproceedings.AccNoConfirmationFlg = "";
                ...
                new SqlParameter("@EnterperIncentiveID",SqlDbType.VarChar),
                new SqlParameter("@MstIncentiveId",SqlDbType.VarChar),
                new SqlParameter("@SLCNumer",SqlDbType.VarChar),
                new SqlParameter("@WorkingStatus",SqlDbType.VarChar),
                new SqlParameter("@Newbankname",SqlDbType.VarChar),
                new SqlParameter("@NewBranchname",SqlDbType.VarChar),
                new SqlParameter("@NewIFSCcode",SqlDbType.VarChar),
                new SqlParameter("@AccountNumber",SqlDbType.VarChar),
                new SqlParameter("@NewAccountType",SqlDbType.VarChar),
                new SqlParameter("@Remarks",SqlDbType.VarChar),
                new SqlParameter("@AccNoConfirmationFlg",SqlDbType.VarChar),
                new SqlParameter("@Created_By",SqlDbType.VarChar),
                new SqlParameter("@SubIncType",SqlDbType.VarChar),
                new SqlParameter("@LoanAggrementAcNo",SqlDbType.VarChar),
                new SqlParameter("@Valid",SqlDbType.VarChar)

            };

                pp[0].Value = gmfinalproceedings.EnterperIncentiveID;
                pp[1].Value = gmfinalproceedings.MstIncentiveId;
                pp[2].Value = gmfinalproceedings.SLCNumer;
                pp[3].Value = gmfinalproceedings.WorkingStatus;
                pp[4].Value = gmfinalproceedings.Newbankname;
                pp[5].Value = gmfinalproceedings.NewBranchname;
                pp[6].Value = gmfinalproceedings.NewIFSCcode;
                pp[7].Value = gmfinalproceedings.AccountNumber;
                pp[8].Value = gmfinalproceedings.NewAccountType;
                pp[9].Value = gmfinalproceedings.Remarks;
                pp[10].Value = gmfinalproceedings.AccNoConfirmationFlg;
                pp[11].Value = gmfinalproceedings.CreatedByid;
                pp[12].Value = gmfinalproceedings.SubIncTypeId;
                pp[13].Value = txtLoanAggrementAcNo.Text.ToString();
                pp[14].Value = "0";
                pp[14].Direction = ParameterDirection.Output;


                int valid = gen.GenericExecuteNonQuery("USP_UPD_ReleaseProceedings_GM_DIPC", pp);
    ...
    protected void RBTYESORNO_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = GETWORKINGSTATUSDETAILS_DIPC(Request.QueryString[1].ToString(), Request.QueryString[2].ToString());
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
    ...
    public DataSet GETWORKINGSTATUSDETAILS_DIPC(string ENTERPINCID, string MSTINCID)
    {
        try
        {
            con.OpenConnection();
            SqlDataAdapter myDataAdapter;
            myDataAdapter = new SqlDataAdapter("SP_GETWORKINGSTATUSDETAILS_DIPC", con.GetConnection);
    ...
    protected void ddlBank_SelectedIndexChanged2(object sender, EventArgs e)
    {
