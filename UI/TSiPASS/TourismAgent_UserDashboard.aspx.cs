...
using System.Data;
public partial class UI_TSiPASS_TourismAgent_UserDashboard : System.Web.UI.Page
{
    string Qnreid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("GetShow_TourismAgentQuestionaries_ques", osqlConnection);
    ...
    public DataSet GetEnterpreneourDashboardDetails_TourismEvent(string intEntid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("GetEnterpreneourDashboardDetails_Tourismagent", osqlConnection);
