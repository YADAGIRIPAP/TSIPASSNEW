...
public partial class UI_TSIPASS_apparaisalnote_isform1 : System.Web.UI.Page
{
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            if (oIncentiveVosA.txtvalue424 != "")
            {
                Decimal Amount = Convert.ToDecimal(oIncentiveVosA.txtvalue424);
    ...
    public string InsertCommonData(IncentiveVosAppraisal oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal]";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=6");
        }
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        //string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_IS" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_IS" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111110", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    {
        if (Session["Role_Code"].ToString() == "COI-CLERK")
        {
