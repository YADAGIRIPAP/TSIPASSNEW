...
public partial class UI_TSiPASS_frmCFOHotelDashboardEODB : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    public void fillgrid(string fromDate, string toDate)
    {
        ...
        lblHeadingText.Text = "CFO HOTEL Dashboard from " + txtFromDate.Text + " to " + txtTodate.Text + "";
    }
    ...
    public DataSet GetReleaseDashboardApplications(string deptid, string approvalid, string appltype, string fromDate, string toDate)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_DASHBOARD_EODB_CFOHOTEL", pp);
        return Dsnew;
