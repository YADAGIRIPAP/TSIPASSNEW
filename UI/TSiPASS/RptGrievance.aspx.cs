...
public partial class UI_TSiPASS_RptGrievance : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        {
            vehicleDS = Gen.DeptReportDepartmentWiseGrievance(Session["DistrictID"].ToString().Trim(), "%", FromdateforDB, TodateforDB);
        }
        else
        {
            vehicleDS = Gen.DeptReportDepartmentWiseGrievance("%", "%", FromdateforDB, TodateforDB);
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=3&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=4&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=5&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=6&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "RptGrievanceDrill.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
