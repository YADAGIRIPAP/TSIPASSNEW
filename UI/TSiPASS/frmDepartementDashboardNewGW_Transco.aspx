<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartementDashboardNewGW_Transco.aspx.cs" Inherits="UI_TSiPASS_frmDepartementDashboardNewGW_Transco" %>
                                                        ...
                                                        <tr>
                                                            <td style="width: 395px" valign="top">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=1&lbl=Pre-Scrutiny Applications Received" target="_blank" class="list-group-item">
                                                                        <span class="badge">
                                                                    ...
                                                                    <a href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=6&lbl=Total Query Raised for Applications" target="_blank"  class="list-group-item">
                                                                        <span class="badge">
                                                                    ...
                                                                    <a href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=7&lbl=Total Query Responded Applications" target="_blank"  class="list-group-item">
                                                                        <span class="badge">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=2&Pre-Scrutiny-Pending Within 7 Days">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=3&Pre-Scrutiny-Pending Beyond 7 Days">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=4&lbl=Pre-Scrutiny-Pending Total Applications">
                                                                        <span class="badge">
                                                                            <asp:Label ID="lbl_fwdtogwtotal" runat="server"></asp:Label>
                                                                        </span><i class="fa fa-fw fa-calendar"></i>Total 
                                                                    </a>
                                                                      <a target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=5&lbl=No of Application Awaiting for Query Response" class="list-group-item">
                                                                        <span class="badge">
                                                            ...
                                                            <td valign="top" style="width: 395px" runat="server">
                                                                <div class="list-group">
                                                                    <a class="list-group-item" href="#">
                                                                     ...
                                                                     <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=8&lbl=Recommended to MRO Within 7 Days">
                                                                        <span class="badge" style="background-color: #87D37C;">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=9&lbl=Recommended to MRO Beyond 7 Days">
                                                                        <span class="badge" style="background-color: #d9534f;">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=10&lbl=Total Recommended to MRO">
                                                                        <span class="badge">
                                                                            <asp:Label ID="lbl_completedtotal" runat="server"></asp:Label>
                                                                        </span>
                                                                        <i class="fa fa-fw fa-calendar"></i>Total Recommended to MRO
                                                                    </a>
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=11&lbl=No of Applications Not Recommend to MRO">
                                                                        <span class="badge">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=12&lbl=Awaiting for Approval Near MRO">
                                                                        <span class="badge" style="background-color: #87D37C;">
                                                                    ...
                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=13&lbl=Approval Issued by MRO">
                                                                            <span class="badge" style="background-color: #d9534f;">
                                                                                <asp:Label ID="lbl_approvalissuedbyMRO" runat="server"></asp:Label>
                                                                            </span><i class="fa fa-fw fa-calendar"></i>Approval Issued by MRO</a> 

                                                                    <a class="list-group-item" target="_blank"  href="frmViewAppl_groundwaterDepartmentuser_Transco.aspx?Stg=16&lbl=No of Applications Rejected by MRO">
                                                                                    <span class="badge">
