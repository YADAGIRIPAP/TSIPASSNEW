...
public partial class UI_TSiPASS_frmBankerReportDistrictDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmBankerReportDistrict.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    public DataSet GetBankerApplicationsDrill(string fromdate, string todate, string district, string typeofaccount, string bankname)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_BANKERREPORT_DISTRICT_DRILLDOWN", pp);
        return Dsnew;
    }
}