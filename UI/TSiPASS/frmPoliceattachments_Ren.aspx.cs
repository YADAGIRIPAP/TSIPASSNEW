...
using System.IO;
public partial class UI_TSIPASS_frmPoliceattachments_Ren : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            dsnew = Gen.getdataofidentityRENAPPROVALID(Request.QueryString[0].ToString(), "120");//Session["Applid"].ToString()
            ...
            else
            {
                ...
                {
                    Response.Redirect("frmtradeRenewal.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&next=" + "N");
                }
                else
                {
                    //Response.Redirect("manufactureRegistrations.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&Previous=" + "P");
                    Response.Redirect("frmCinematographLicenseRenewal.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&Previous=" + "P");// added by madhuri on 16/06/2022
                ...
                if ((fupRentalDeed.PostedFile != null) && (fupRentalDeed.PostedFile.ContentLength > 0))
                {
                    ...
                    try
                    {
                        ...
                        if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR")
                        {
                            ...
                            result = t1.InsertRenewalAttachement(Request.QueryString[0].ToString(), Session["uid"].ToString(), "1", "1", fileType[i - 1].ToUpper(), sFileName, newPath, "A", Session["uid"].ToString(), "cfoRentalDeed");
                ...
                if ((fupsiteplan.PostedFile != null) && (fupsiteplan.PostedFile.ContentLength > 0))
                {
                    ...
                    try
                    {
                        ...
                        if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR")
                        {
                            ...
                            result = t1.InsertRenewalAttachement(Session["Applid"].ToString(), Session["uid"].ToString(), "1", "1", fileType[i - 1].ToUpper(), sFileName, newPath, "A", Session["uid"].ToString(), "cfoSitePlan");
                ...
                if ((fupTradeLic.PostedFile != null) && (fupTradeLic.PostedFile.ContentLength > 0))
                {
                    ...
                    try
                    {
                        ...
                        if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR")
                        {
                            ...
                            result = t1.InsertRenewalAttachement(Request.QueryString[0].ToString(), Session["uid"].ToString(), "1", "1", fileType[i - 1].ToUpper(), sFileName, newPath, "A", Session["uid"].ToString(), "cfoTradeLic");
                ...
                if ((fupDfo.PostedFile != null) && (fupDfo.PostedFile.ContentLength > 0))
                {
                    ...
                    try
                    {
                        ...
                        if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR")
                        {
                            ...
                            result = t1.InsertRenewalAttachement(Request.QueryString[0].ToString(), Session["uid"].ToString(), "1", "1", fileType[i - 1].ToUpper(), sFileName, newPath, "A", Session["uid"].ToString(), "cfoFireAppr");
                ...
                if ((fupExcise.PostedFile != null) && (fupExcise.PostedFile.ContentLength > 0))
                {
                    ...
                    try
                    {
                        ...
                        if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR")
                        {
                            ...
                            result = t1.InsertRenewalAttachement(Request.QueryString[0].ToString(), Session["uid"].ToString(), "1", "1", fileType[i - 1].ToUpper(), sFileName, newPath, "A", Session["uid"].ToString(), "cfoExciseLic");
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        if (rdbBarRest.SelectedIndex == 0 || rdbWhetherAll.SelectedIndex == 1)
        {
            if (rdbWhetherAll.SelectedIndex == 0 || rdbWhetherAll.SelectedIndex == 1)
            {
                ...
                try
                {
                    ...
                    com.CommandText = "USP_InsertPoliceAttachmentDet_Ren";
                    ...
                    com.Parameters.AddWithValue("@intQnreID", (Request.QueryString[0].ToString()));
                    com.Parameters.AddWithValue("@Police_LicNo", txtLicenseNumber.Text.ToString());
                    com.Parameters.AddWithValue("@licenseDate", txtLicenseDate.Text.ToString());
                    com.Parameters.AddWithValue("@Last_licenseDate", txtLastRenDate.Text.ToString());
            ...
            else if (rdbWhetherAll.SelectedIndex != 0 && rdbWhetherAll.SelectedIndex != 1)
            {
        ...
        else if (rdbBarRest.SelectedIndex != 0 && rdbBarRest.SelectedIndex != 1)
        {
