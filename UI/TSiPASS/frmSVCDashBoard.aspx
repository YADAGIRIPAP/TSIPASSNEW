<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSVCDashBoard.aspx.cs" Inherits="UI_TSiPASS_frmSVCDashBoard" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Generate SVC Agenda</h1>
                            </div>
                                        ...
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width:300px">Proposed SVC Date : </td>
