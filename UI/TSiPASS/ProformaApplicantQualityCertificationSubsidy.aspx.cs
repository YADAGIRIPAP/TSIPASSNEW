...
public partial class UI_TSiPASS_ProformaApplicantQualityCertificationSubsidy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            //dsnew = Gen.GetSLCDetails(incentiveid, "11");
            ...
            if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
            {
             // string userid = Session["uid"].ToString();
                ...
                dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "11", "0", "", "INTIMATION");
