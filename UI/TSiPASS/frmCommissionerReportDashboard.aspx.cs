...
public partial class UI_TSiPASS_frmCommissionerReportDashboard : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = FetchTotalDistrictwise_New_NewCommissioner(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text,
                ddlsector.SelectedItem.Text, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue, ddlSector_Ent.SelectedValue, ddlStatus.SelectedValue, ddlEligibility.SelectedValue, ddlincentiveapplied.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            //    TodateforDB = Convert.ToString(DateTime.ParseExact(txtTodate.Text, "dd-MM-yyyy", null).ToString("MM-dd-yyyy"));
            //}
            //dsChartData = FetchTotalDistrictwise_New_NewCommissioner(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text, ddlsector.SelectedValue, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue, ddlSector_Ent.SelectedValue).Tables[0];
            dsChartData = FetchTotalDistrictwise_New_NewCommissioner(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text,
                ddlsector.SelectedItem.Text, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue, ddlSector_Ent.SelectedValue, ddlStatus.SelectedValue, ddlEligibility.SelectedValue, ddlincentiveapplied.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmCommissionerReportDrillDown.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString() + "&ddlinsutrytype=" + ddlSector_Ent.SelectedValue.ToString() + "&ddlStatus=" + ddlStatus.SelectedValue.ToString() + "&ddlEligibility=" + ddlEligibility.SelectedValue.ToString();
    ...
    public void BindenterpriseSectors()
    {
        try
        {
            ...
            if (dsSector != null && dsSector.Tables.Count > 0 && dsSector.Tables[0].Rows.Count > 0)
            {
                ...
                ddlSector_Ent.Items.Insert(0, "--Select--");
    ...
    public DataSet FetchTotalDistrictwise_New_NewCommissioner(string FINYEAR, string DISTRICT, string SECTOR, string CATEGORY, string COLOR, string TYPEOFSECTOR, string Progress, string INCENTIVEEligibility,string incentivesapplied)
    {
        DataSet Dsnew = new DataSet();
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_COMMISSIONER_REPORT", pp);
        return Dsnew;
    }
