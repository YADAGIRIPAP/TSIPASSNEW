...
public partial class UI_TSiPASS_BilldeskPaymentPage : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
                {
                    ...
                    dspaydtls = objgen.GetEnterprinerpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
                    ...
                    // string ReturnURL = "http://localhost:10389/TSIPASS/UI/TSiPASS/BilldeskPaymentResponse.aspx";
                    //string ReturnURL = "http://120.138.9.236/TSIPASSTEST/UI/TSiPASS/BilldeskPaymentResponse.aspx";
                    string ReturnURL = "https://ipass.telangana.gov.in/UI/TSiPASS/BilldeskPaymentResponse.aspx";
