...
public partial class UI_TSiPASS_IncentiveClaimsReport : System.Web.UI.Page
{
    ...
    public void FillGridDetails()
    {
        ...
        pp[0].Value = Session["DistrictID"].ToString().Trim();

        ds = Gen.GenericFillDs("USP_GET_Release_Proceedings_District_wise",pp);

        //ds = Gen.GetIncentivesMISDisbursmentPendingReport();
    ...
    int RpTot = 0, RaTot = 0, UUwTot = 0, UUcTot = 0, UUnTot = 0, wTot = 0, bTot = 0;
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=A&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h2 = (HyperLink)e.Row.FindControl("HyperLink2");
            h2.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=B&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h3 = (HyperLink)e.Row.FindControl("HyperLink3");
            h3.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=C&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h4 = (HyperLink)e.Row.FindControl("HyperLink4");
            h4.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=D&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h10 = (HyperLink)e.Row.FindControl("HyperLink5");
            h10.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=E&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h11 = (HyperLink)e.Row.FindControl("HyperLink6");
            h11.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=F&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h12 = (HyperLink)e.Row.FindControl("HyperLink7");
            h12.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=G&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();

            HyperLink h1HyperLinkSLC = (HyperLink)e.Row.FindControl("HyperLinkSLC");
            h1HyperLinkSLC.NavigateUrl = "IncentiveDisbursmentMISPendencyReportDrill.aspx?status=H&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistId")).Trim();
