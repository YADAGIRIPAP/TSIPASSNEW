<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/NewCCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="AutoSMSDepartmentAbstractLatestCFO.aspx.cs"
    Inherits="FrmUsers" Title="::TS-iPASS::" %>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center" align="center">
                <h3 class="panel-title" style="font-family: Verdana; font-size: 16px">
                    CFO R5: Department wise performance Tracker</h3>
            ...
            <div class="panel-body">
                <div align="center" style="font-family: Helvetica Neue,Helvetica,Arial,sans-serif;
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Excel" Width="61" Height="21" OnClick="BtnSave2_Click1"
                        class="BTN_Login" />
