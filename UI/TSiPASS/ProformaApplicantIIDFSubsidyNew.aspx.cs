...
public partial class UI_TSIPASS_ProformaApplicantIIDFSubsidyNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //dsnew = Gen.GetSLCDetails(incentiveid, "7");
        ...
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "7", "0", "", "INTIMATION");
    ...
    public void fillSLCDetails(DataSet ds)
    {
        ...
        {
            string scheme = "";
            scheme = Request.QueryString["Scheme"].ToString().ToUpper(); 
