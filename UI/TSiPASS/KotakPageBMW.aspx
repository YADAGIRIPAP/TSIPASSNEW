<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPageBMW.aspx.cs" Inherits="UI_TSiPASS_KotakPageBMW" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerBMW.aspx">
    <div id="myDIV">
        <center>
        ...
        <table id="Table1" width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmDepartmentBMWPaymentDetails.aspx" />
                </td>
            </tr>
            <tr>
                <td>
