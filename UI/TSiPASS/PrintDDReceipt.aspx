<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PrintDDReceipt.aspx.cs" Inherits="InterfaceNetBanking_PrintReceipt" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Offline Payment Receipt</title>
                                            ...
                                            <td colspan="4" align="center"> 
                                                ...
                                                <div>
                                                    <font size="2"><strong style="font-family: Arial">Telangana Industries<br />
                                                        Industries Offline Payment Receipt </strong></font>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
