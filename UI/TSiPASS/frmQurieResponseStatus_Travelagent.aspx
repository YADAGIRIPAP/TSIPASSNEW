<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmQurieResponseStatus_Travelagent.aspx.cs" Inherits="UI_TSiPASS_frmQurieResponseStatus_Travelagent" %>
                                            ...
                                            <tr>
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top" class="style8"
                                                    ...
                                                    <asp:DropDownList ID="ddlProp_intDistrictid" runat="server" class="form-control txtbox"
                                                        Height="33px" Width="180px" Visible="False">
                                                ...
                                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Constitution of the unit"  Visible="false"/>
                                                            <%--<asp:BoundField DataField="Sector_EntA" HeaderText="Sector of Enterprise" />--%>
                                                            <asp:BoundField HeaderText="Total Extent of Land" Visible="false" />
