<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RP_MSMETSIPASSMAPPEDUNITSMonthlyReports.aspx.cs" Inherits="UI_TSiPASS_RP_MSMETSIPASSMAPPEDUNITSMonthlyReports" %>
                                        ...
                                        <td colspan="6" align="left">
                                            <table width="80%">
                                                <tr runat="server">             
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddl_Month" runat="server" class="form-control txtbox"
