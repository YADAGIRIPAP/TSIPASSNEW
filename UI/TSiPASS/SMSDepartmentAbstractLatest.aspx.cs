...
public partial class FrmUsers : System.Web.UI.Page
{
      ...
      // this.txtFrom.Attributes.Add("onfocus", "popUpCalendarLeft(this,document.getElementById('ctl00_ContentPlaceHolder1_txtFrom'), 'dd-mmm-yyyy')");
       // this.txtTo.Attributes.Add("onfocus", "popUpCalendarLeft(this,document.getElementById('ctl00_ContentPlaceHolder1_txtTo'), 'dd-mmm-yyyy')");
            ...
            if (!Page.IsPostBack)
            {
                ...
                //cmf.SendSingleSMS("9885696486", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You");


                cmf.SendSingleSMS("9246761959", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You.");

                //cmf.SendSingleSMS("7702542727", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You.");

                //cmf.SendSingleSMS("9100986717", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You.");

                //cmf.SendSingleSMS("8331029999", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You.");
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
       ...
       // cmf.SendSingleSMS("7702542727", "Respected Sir / Madam, TS-iPASS Online System CFE Status on  " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You");
        ...
        //cmf.SendSingleSMS("9247492919", "Respected Sir / Madam, TS-iPASS CFE Status on " + System.DateTime.Now.ToString("dd-MMM-yyyy") + " - Pendency beyond due date - Pre-scrutiny stage  : " + pendingafter.ToString().Trim() + "  and Approvals stage : " + closedafter.ToString().Trim() + " .Thank You.");
