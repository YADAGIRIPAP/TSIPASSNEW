<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="FinancialYear.aspx.cs" Inherits="UI_TSiPASS_FinancialYear" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">Abstract -Financial Year wise</asp:Label>
                                ...
                                <td align="center" colspan="10" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Total Application received" HeaderText="Application received">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            <asp:BoundField DataField="Total Investments" HeaderText="Total Investments (Rs Crores)">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            <asp:BoundField DataField="Deptl Approvals Applied by applicant" HeaderText="Approvals Applied by applicant">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            <asp:BoundField DataField="Query Raised" HeaderText="Query Raised">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            <asp:BoundField DataField="Deptl Approvals Pending" HeaderText="Approvals Pending">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            <asp:BoundField DataField="Deptl Approvals Issued" HeaderText="Approvals Issued">
                                                    <ItemStyle Wrap="true" CssClass="text-uppercase" />
                                                </asp:BoundField>
