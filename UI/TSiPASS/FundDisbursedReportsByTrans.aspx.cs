...
public partial class FundDisbursedReportsByTrans : System.Web.UI.Page
{
    #region Declaration
    ...
    void fillgrid()
    {
        try
        {
            ...
            DataSet ds = Gen.FundDisbursedReportsByTrans("%", IP);
            ...
            //DataSet dsNew = Gen.PayamwisereportByTypeNew("%", IP);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if ((e.Row.RowType == DataControlRowType.DataRow))
        {
            ...
            decimal TotaltobeApproved = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalApproved"));
            TotaltobeApproved1 = TotaltobeApproved + TotaltobeApproved1;

            decimal TotalInprogress = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalReleaseFundsAmt"));
            TotalInprogress1 = TotalInprogress + TotalInprogress1;

            decimal TotalClosed = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalFundsTrans"));
            TotalClosed1 = TotalClosed + TotalClosed1;

            //decimal TotalFundsDisbursed = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalReleaseFundsAmt"));
            ...
            // HyperLink HyperLink1 = (HyperLink)e.Row.Cells[2].FindControl("HyperLink1");
            // HyperLink1.Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "TotalWorkProposed")).Trim();
            // HyperLink1.NavigateUrl = "FundDisbursedReportsByTransDrildown.aspx?id=" + DataBinder.Eval(e.Row.DataItem, "intIP").ToString() ;



            // HyperLink HyperLink2 = (HyperLink)e.Row.Cells[3].FindControl("HyperLink2");
            // HyperLink2.Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "TotalApproved")).Trim();
            // HyperLink2.NavigateUrl = "FundDisbursedReportsByTransDrildown.aspx?id=" + DataBinder.Eval(e.Row.DataItem, "intIP").ToString() ;



            // HyperLink HyperLink3 = (HyperLink)e.Row.Cells[4].FindControl("HyperLink3");
            // HyperLink3.Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "TotalReleaseFundsAmt")).Trim();
            //// HyperLink3.NavigateUrl = "FundDisbursedReportsByTransDrildown.aspx?id=" + DataBinder.Eval(e.Row.DataItem, "intIP").ToString() ;


            HyperLink HyperLink4 = (HyperLink)e.Row.Cells[5].FindControl("HyperLink4");
            HyperLink4.Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "TotalFundsTrans")).Trim();

            if (HyperLink4.Text != "0")
            {
                HyperLink4.NavigateUrl = "FundDisbursedReportsByTransDrildown.aspx?id=" + DataBinder.Eval(e.Row.DataItem, "intIP").ToString();
