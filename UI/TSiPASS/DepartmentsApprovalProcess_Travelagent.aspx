<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="DepartmentsApprovalProcess_Travelagent.aspx.cs" Inherits="UI_TSiPASS_DepartmentsApprovalProcess_Travelagent" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Update Application Details</a>
                    </li>
                </ol>
            </div>
            <div align="left">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ForeColor="#333333" Height="62px" OnRowDataBound="grdDetails_RowDataBound" PageSize="15"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NameofIndustrialUnder" HeaderText="Name of Industry">
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="LastDateofPreScrutiy" HeaderText="Last date of Prescrutiny" />
