<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpassPrintReceiptOtherService.aspx.cs" Inherits="UI_TSiPASS_IpassPrintReceiptOtherService" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function CallPrint(strid) {
            var asknew = window.confirm("Thank you for filing application. Please spare some time for filling feedback form, it will help us in improving our service.");
            if (asknew) {
                window.location = "IpassFeedBackForm.aspx?Rfrom=2";
            }
            else {
        ...
        function Redirect() {
            var ask = window.confirm("Thank you for filing application. Please spare some time for filling feedback form, it will help us in improving our service.");
            if (ask) {
                window.location = "IpassFeedBackForm.aspx?Rfrom=2";
            }
            else {
            ...
            <tr>
                <td align="center" colspan="4">
                   <%-- <asp:Button ID="btnclose" runat="server" CssClass="NoPrint" PostBackUrl="~/UI/TSiPASS/Dashboard.aspx"
                    ...
                    <input type="button" value="Print" onclick="javascript:CallPrint('Receipt')" />
