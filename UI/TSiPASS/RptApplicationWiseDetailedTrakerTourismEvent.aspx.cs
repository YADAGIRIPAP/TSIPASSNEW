...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerTourismEvent : System.Web.UI.Page
{
    ...
    public DataSet ApplicationWiseDetailedTrakerTourismEvent(string Quesionary_id)
    {
        ...
        try
        {
            da = new SqlDataAdapter("sp_RetriveR4ReportTourismEvent", con );
