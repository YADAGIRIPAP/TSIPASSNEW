...
public partial class UI_TSiPASS_TotalReportold2NewDuplicate : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalDistrictwise_New_NewWithoutDuplicate(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalDistrictwise_New_NewWithoutDuplicate(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmDistDrilldownold2NewWithoutDuplicate.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];

            h2.NavigateUrl = "FrmDistDrilldownold2NewWithoutDuplicate.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];

            h3.NavigateUrl = "FrmDistDrilldownold2NewWithoutDuplicate.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Enttype=" + ddlEnterPriseType.SelectedValue;
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmDistDrilldownold2NewWithoutDuplicate.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
