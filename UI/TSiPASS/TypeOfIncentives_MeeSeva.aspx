<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster_Meeseva.master"
    AutoEventWireup="true" CodeFile="TypeOfIncentives_MeeSeva.aspx.cs" Inherits="TSTBDCReg1" %>
                                        ...
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            <tr>
                                                <th style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:RadioButtonList ID="rblSelection" runat="server" AutoPostBack="true" 
                                                        ...
                                                        <asp:ListItem Value="1">New / Existing Entreprenuer</asp:ListItem>
                                                        <asp:ListItem Value="2" Enabled="false">Expansion / Diversification Entreprenuer</asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </th>
                                            </tr>
                                            <tr id="trVehIncentive" runat="server" visible="false">
                                                <th style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:RadioButtonList ID="rblVehicleIncetive" runat="server" AutoPostBack="true" 
                                                        OnSelectedIndexChanged="rblVehicleIncetive_SelectedIndexChanged">
                                            ...
                                            <tr id="trOnetime" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                                    ...
                                                    <asp:GridView ID="gvSingleTerm" runat="server" AutoGenerateColumns="False"
                                                        BorderWidth="1px" CellPadding="2" Font-Names="Verdana" Font-Size="13px" ForeColor="#333333"
                                                        Width="100%">
                                                        <RowStyle BackColor="#EFF3FB" />
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Incentive Name">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbIncentive" runat="server" Text='<%#Eval("IncentiveName")%>'
                                                                         Checked='<%# Convert.ToBoolean(Eval("Validate")) %>' />
                                                                    <asp:Label ID="lblIncentiveId" runat="server" Text='<%#Eval("IncentiveID") %>' 
                                                                        Visible="false" />
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                    ...
                                                    <asp:GridView ID="gvRepetitive" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDropdown" runat="server" Text='<%# Eval("FromDate") %>' 
                                                                        ToolTip='<%# Eval("ToDate") %>' Visible="false" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Incentive Name">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbIncentiveCheck" runat="server" 
                                                                        Text='<%#Eval("IncentiveName")%>' />
                                                                    <asp:Label ID="lblIncentiveId" runat="server" Text='<%#Eval("IncentiveID") %>' 
                                                                        Visible="false" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Period From">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <cc1:CalendarExtender ID="ctefrom" runat="server" TargetControlID="txtFrom" 
                                                            ...
                                                            <asp:TemplateField HeaderText="Period To">
                                                                ...
                                                                <asp:TextBox ID="txtTo" runat="server" AutoPostBack="true"
                                                                    ...
                                                                    <cc1:CalendarExtender ID="cteTo" runat="server" TargetControlID="txtTo" 
                                                                        Format="dd-MMM-yyyy"  CssClass= "cal_Theme1">
                                                                    </cc1:CalendarExtender>
                                            ...
                                            <tr id="trSkillset" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                                    ...
                                                    <asp:GridView ID="gvskillSet" runat="server" AutoGenerateColumns="False"
                                                        BorderWidth="1px" CellPadding="2" Font-Names="Verdana" Font-Size="13px" ForeColor="#333333"
                                                        Width="100%">
                                                        <RowStyle BackColor="#EFF3FB" />
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbIncentive" runat="server" />
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Incentive Name">
                                                ...
                                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                                    <div id="success" runat="server" visible="false" class="alert alert-success">
                                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">
                                                            &times;</a> <strong>Success!</strong><asp:Label ID="lblmsg" runat="server"></asp:Label></div>
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                                    ...
                                                    <li>Projects Proposed to be set up under T-PRIDE in Municipal Corporation limits of Greater Hyderabad shall obtain pollution clearences where ever neccessary</li>
                                                    <li>Textile Units other than Large industries may select Sector type as Manufacture for applying eligible Incentives</li>
                                                    </ul>
                                                    </div>
                                                </td>
                                            </tr>
