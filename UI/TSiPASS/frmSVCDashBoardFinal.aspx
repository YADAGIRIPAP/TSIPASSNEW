<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSVCDashBoardFinal.aspx.cs" Inherits="UI_TSiPASS_frmSVCDashBoardFinal" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Upload SVC Proceedings</h1>
                            </div>

                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    <tr>
                                        <td style="padding: 10px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width:30px"></td>
                                                    <td style="vertical-align: middle; width:250px">Proposed SVC Date: </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:DropDownList ID="ddlapplicationto" runat="server" Width="150px"
                                                            class="form-control txtbox" Height="33px">
                                                            <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnupdatestatus" CssClass="btn btn-primary" runat="server" Text="Get Updated Proposed SVC Agenda" OnClick="btnupdatestatus_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr id="trConvened" runat="server" visible="false">
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width:30px"></td>
                                                    <td style="vertical-align: middle; width:250px">Convened SVC Date: </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                    ...
                                                    <td>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtsvcdate"
                                                            ErrorMessage="Please Enter SVC Date" ValidationGroup="group">Please Enter SVC Date</asp:RequiredFieldValidator></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px; width: 100%" valign="top">
                                            <div style="width: 100%">
                                                <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    PageSize="15" ShowFooter="false" Width="80%" CellSpacing="4" OnRowDataBound="grdDetailsPavallavaddiSC_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="No. of Claims Applied">
                                                            <ItemTemplate>
