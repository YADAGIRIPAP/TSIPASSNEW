<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="FundDisbursedReports.aspx.cs" Inherits="FundDisbursedReports" Title=":: TSiPASS Online Management System ::" %>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="TotalInProgress" HeaderText="Total No. of works in progress" >
                                            
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                            
                                            <asp:BoundField DataField="TotalRaiseFundsAmt" HeaderText="Total Bill Raised Amount" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                            <asp:BoundField DataField="TotalReleaseFundsAmt" HeaderText="Total Bill Released Amount " >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
