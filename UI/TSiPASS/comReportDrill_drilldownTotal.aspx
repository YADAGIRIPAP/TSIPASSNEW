<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="comReportDrill_drilldownTotal.aspx.cs" Inherits="UI_TSiPASS_comReportDrill_drilldownTotal_aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right; alt="PDF" /></a>
                            <a id="A1" href="#" onserverclick="BtnSave2_Click1" runat="server">
                                        <img src="../../Resource/Images/Excel-icon.png" width="20px;" height="20px;" style="float: right;"
                                            alt="Excel" /></a>

                              <a id="A2" href="#" visible="true"
                                    runat="server" onclick="doPrint()">
                                ...
                                <td>
                                    <div id="PrintPDF" runat="server">
                                        ...
                                        <table width="100%" style="font-family: 'Trebuchet MS'">
                                             ...
                                             <tr>
                                        <td style="text-align:center"><b><asp:Label ID="lblheadingtext" runat="server"></asp:Label></b>
                                            &nbsp;</td>
                                    </tr>
                                             <tr>
                                                 
                                        <td style="text-align:left"><b>District:&nbsp;</b><b><asp:Label ID="lbldists" runat="server"></asp:Label></b>
                                            &nbsp;</td>
                                    </tr>
                                             <tr>
                                    <td align="right">
                                    <asp:Button ID="btnbdf" runat="server" Visible="false" CssClass="btn btn-primary" Height="32px" TabIndex="10" Text="Generate Pdf" OnClick="btnbdf_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
                                </tr>
                                                ...
                                                <td colspan="2" align="center" style="padding: 5px; margin: 5px" runat="server">
                                                    <table style="width: 100%">
                                                        <tr id="GridPrint" runat="server">
                                                            <td colspan="2" align="center" runat="server" id="divPrint1" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
