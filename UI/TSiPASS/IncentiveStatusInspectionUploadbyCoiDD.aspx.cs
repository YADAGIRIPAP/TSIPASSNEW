...
public partial class UI_TSiPASS_IncentiveStatusInspectionUploadbyCoiDD : System.Web.UI.Page
{
    ...
    public DataSet CoifetchIncentivedetIPONewIncType(string intDeptid, string status)
    {
        ...
        try
        {
            da = new SqlDataAdapter("usp_GetJdForwardedApplications_LEVEL_DD", con.GetConnection);
