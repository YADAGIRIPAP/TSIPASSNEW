...
public partial class UI_TSiPASS_IpassFeedBackFormCFO : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            objvo.Feedbackfrom = "CFORET";
        }
        else if (Session["uid"] != null)
        {
            objvo.Feedbackfrom = "CFORET";
        }
        if (objvo.Feedbackfrom == "CFORET")
        {
    ...
    {
        Response.Redirect("IpassFeedBackFormCFO.aspx");
    }
}