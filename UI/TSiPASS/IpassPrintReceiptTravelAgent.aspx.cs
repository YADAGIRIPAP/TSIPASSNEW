...
public partial class UI_TSiPASS_IpassPrintReceiptTravelAgent : System.Web.UI.Page
{
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (lblMobileNumber.Text != "")
                        {
                            try
                            {
                                ...
                                obcmf.SendSingleSMSnew("9440816068", message, "1007856775026438504");
                                //obcmf.SendSingleSMSnew("9618445500", message, "1007856775026438504");
                                //SendSingleSMS(lblMobileNumber.Text, message);
                                //SendSingleSMS("9440816068", message);
                            }
                            catch (Exception ex)
                            {
    ...
    private DataSet BillPaymentReceipt(string TranRefNo)
    {
        try
        {
            ...
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("[GetBilldeskReceipt_TravelAgent]", conn);
