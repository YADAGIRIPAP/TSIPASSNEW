...
public partial class UI_TSiPASS_Appraisalnote_SalesTax : System.Web.UI.Page
{
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.MstIncentiveId = "5";// Request.QueryString["MstIncentiveId"].ToString();
            ...
            string lblMstIncentiveId = "5";// Request.QueryString["MstIncentiveId"].ToString();
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_SALESTAX]";
            ...
            // -----------=====---------------
            if (oIncentiveVosA.SCHEMETYPE != null)
                com.Parameters.AddWithValue("@SCHEMETYPE", oIncentiveVosA.SCHEMETYPE);
            if (oIncentiveVosA.APPLICATIONTYPE != null)
                com.Parameters.AddWithValue("@APPLICATIONTYPE", oIncentiveVosA.APPLICATIONTYPE);
            if (oIncentiveVosA.PRODUCTION != null)
                com.Parameters.AddWithValue("@PRODUCTION", oIncentiveVosA.PRODUCTION);
            if (oIncentiveVosA.TAXPAIDSGST != null)
                com.Parameters.AddWithValue("@TAXPAIDSGST", oIncentiveVosA.TAXPAIDSGST);
            if (oIncentiveVosA.BASEPRODUCTION != null)
                com.Parameters.AddWithValue("@BASEPRODUCTION", oIncentiveVosA.BASEPRODUCTION);
            if (oIncentiveVosA.ELIGIBLEPRODUCTIONQUANTITY != null)
                com.Parameters.AddWithValue("@ELIGIBLEPRODUCTIONQUANTITY", oIncentiveVosA.ELIGIBLEPRODUCTIONQUANTITY);
            if (oIncentiveVosA.PROPORTINATESGST != null)
                com.Parameters.AddWithValue("@PROPORTINATESGST", oIncentiveVosA.PROPORTINATESGST);
            if (oIncentiveVosA.CATEGORYID != null)
                com.Parameters.AddWithValue("@CATEGORYID", oIncentiveVosA.CATEGORYID);
            if (oIncentiveVosA.CATEGORYNAME != null)
                com.Parameters.AddWithValue("@CATEGORYNAME", oIncentiveVosA.CATEGORYNAME);
            if (oIncentiveVosA.MEGA != null)
                com.Parameters.AddWithValue("@MEGA", oIncentiveVosA.MEGA);
            if (oIncentiveVosA.LARGE != null)
                com.Parameters.AddWithValue("@LARGE", oIncentiveVosA.LARGE);
            if (oIncentiveVosA.MEDIUM != null)
                com.Parameters.AddWithValue("@MEDIUM", oIncentiveVosA.MEDIUM);
            if (oIncentiveVosA.SMALL != null)
                com.Parameters.AddWithValue("@SMALL", oIncentiveVosA.SMALL);
            if (oIncentiveVosA.MICRO != null)
                com.Parameters.AddWithValue("@MICRO", oIncentiveVosA.MICRO);
            if (oIncentiveVosA.ELIGIBLEAMOUNT != null)
                com.Parameters.AddWithValue("@ELIGIBLEAMOUNT", oIncentiveVosA.ELIGIBLEAMOUNT);
            if (oIncentiveVosA.TOTALSALESTAXSANCTIONEDONTHISCLAIM != null)
                com.Parameters.AddWithValue("@TOTALSALESTAXSANCTIONEDONTHISCLAIM", oIncentiveVosA.TOTALSALESTAXSANCTIONEDONTHISCLAIM);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.MstIncentiveId = "5";// Request.QueryString["MstIncentiveId"].ToString();
        oIncentiveVosA.SCHEMETYPE = DDLSCHEME.SelectedValue;
        oIncentiveVosA.APPLICATIONTYPE = RBTTYPE.SelectedValue;
        oIncentiveVosA.PRODUCTION = Convert.ToDecimal(TXTPRODUCTION.Text);
        oIncentiveVosA.TAXPAIDSGST = Convert.ToDecimal(TXTTAXPAID.Text);
        oIncentiveVosA.BASEPRODUCTION = Convert.ToDecimal(TXTBASEPRODUCTION.Text);
        oIncentiveVosA.ELIGIBLEPRODUCTIONQUANTITY = Convert.ToDecimal(TXTELIGIBLEPRODUCTIONQTY.Text);
        oIncentiveVosA.PROPORTINATESGST = Convert.ToDecimal(TXTPROPORTINATESGSTVALUE.Text);
        oIncentiveVosA.CATEGORYID = DDLCATEGORY.SelectedValue;
        oIncentiveVosA.CATEGORYNAME = DDLCATEGORY.SelectedItem.Text;
        if (TXTMEGA.Text == "")
        {
            oIncentiveVosA.MEGA = 0;
        }
        else
        {
            oIncentiveVosA.MEGA = Convert.ToDecimal(TXTMEGA.Text);
        }
        if(TXTLARGE.Text=="")
        {
            oIncentiveVosA.LARGE = 0;
        }
        else
        {
            oIncentiveVosA.LARGE = Convert.ToDecimal(TXTLARGE.Text);
        }
        if(TXTMEDIUM.Text=="")
        {
            oIncentiveVosA.MEDIUM = 0;
        }
        else
        {
            oIncentiveVosA.MEDIUM = Convert.ToDecimal(TXTMEDIUM.Text);
        }
        if(TXTSMALL.Text=="")
        {
            oIncentiveVosA.SMALL = 0;
        }
        else
        {
            oIncentiveVosA.SMALL = Convert.ToDecimal(TXTSMALL.Text);
        }
        if(TXTMICRO.Text=="")
        {
            oIncentiveVosA.MICRO = 0;
        }
        else
        {
            oIncentiveVosA.MICRO = Convert.ToDecimal(TXTMICRO.Text);
        }
        oIncentiveVosA.ELIGIBLEAMOUNT = Convert.ToDecimal(TXTELIGIBLEAMOUNT.Text);
        oIncentiveVosA.FINALELIGIBLEAMOUNT = Convert.ToDecimal(TXTFINALELIGIBLEAMOUNT.Text);
        if (TXTSALESTAXSANCTIONED.Text=="")
        {
            oIncentiveVosA.TOTALSALESTAXSANCTIONEDONTHISCLAIM = 0;
        }
        else
        {
            oIncentiveVosA.TOTALSALESTAXSANCTIONEDONTHISCLAIM = Convert.ToDecimal(TXTSALESTAXSANCTIONED.Text);
        }
        if(TXTCAPITALELIGIBLEINVESTMENT.Text=="")
        {
            oIncentiveVosA.TOTALCAPITALELIGIBLEINVESTMENT = 0;
        }
        else
        {
            oIncentiveVosA.TOTALCAPITALELIGIBLEINVESTMENT = Convert.ToDecimal(TXTCAPITALELIGIBLEINVESTMENT.Text);
        }
        oIncentiveVosA.GMVALUE = Convert.ToDecimal(txtgmRecommend.Text);
        oIncentiveVosA.FINALSUBSIDYAMOUNT = Convert.ToDecimal(TXTFINALSUBSIDYAMOUNT.Text);
    ...
    public class IncentiveVosAppraisalStamp
    {
        ...
        public Decimal? TAXPAIDSGST { get; set; }
        public Decimal? BASEPRODUCTION { get; set; }
        public Decimal? ELIGIBLEPRODUCTIONQUANTITY { get; set; }
        public Decimal? PROPORTINATESGST { get; set; }
        ...
        public Decimal? TOTALSALESTAXSANCTIONEDONTHISCLAIM { get; set; }
        public Decimal? TOTALCAPITALELIGIBLEINVESTMENT { get; set; }
    ...
    public string ValidateControls()
    {
        ...
        if (RBTTYPE.SelectedValue.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please Select type of Application\\n";
            slno = slno + 1;
        }
        
        if (TXTPRODUCTION.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please enter production Quantity.\\n";
            slno = slno + 1;
        }
        if (TXTTAXPAID.Text.TrimStart().TrimEnd().Trim() == "")
        {
        ...
        {
            if (TXTBASEPRODUCTION.Text.TrimStart().TrimEnd().Trim() == "")
            {
                ErrorMsg = ErrorMsg + slno + ". Please Base Production \\n";
                slno = slno + 1;
            }

        }
        if(DDLCATEGORY.SelectedValue=="0"||DDLCATEGORY.SelectedValue== "--Select--")
        {
        ...
        {
            if (TXTMEGA.Text.TrimStart().TrimEnd().Trim() == "")
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Claim Percentage(MEGA) \\n";
                slno = slno + 1;
            }
        }
        if (DDLSCHEME.SelectedValue == "T-IDEA" || DDLSCHEME.SelectedValue == "T-PRIDE")//ADDED T PRIDE WITH AD MAHESWAR SIR APPROVAL
        {
            if (TXTSALESTAXSANCTIONED.Text.TrimStart().TrimEnd().Trim() == "")
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter TOTAL SALES TAX ALREADY SANCTIONED PRIOR TO THIS CLAIM \\n";
                slno = slno + 1;
            }
            if (TXTCAPITALELIGIBLEINVESTMENT.Text.TrimStart().TrimEnd().Trim() == "")
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                       ...
                       // string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_SALESTAX" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_SALESTAX" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111111", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
