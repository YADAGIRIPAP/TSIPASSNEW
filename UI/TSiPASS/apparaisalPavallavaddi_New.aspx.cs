...
public partial class UI_TSiPASS_apparaisalPavallavaddi_New : System.Web.UI.Page
{
    ...
    public bool insertallgrideachclaimperioddb(string SUBPallvaid)
    {
        ...
        for (int i = 0; i < grd_eglibilepallavaddi.Rows.Count; i++)
        {
           ...
           // objgriduploads.ActualNoofinstallmentsCompleted = Convert.ToInt32(txt_claimeglibleincentivesloanwiseNoofinstallmentscompleted.Text);
            objgriduploads.ActualNoofinstallmentsCompletedMonths = 0;
            objgriduploads.Actualprincipalamtfornextyrs = Convert.ToDecimal(txt_claimeglibleincentivesloanwisePrincipalamountbecomeDUEbeforethisHALFYEAR.Text);
            objgriduploads.NoofinstallmentsCompletedMonths = 0;
