...
public partial class UI_TSiPASS_AdvertismentDashboardList : System.Web.UI.Page
{
    ...
    public void getdetails()
    {
        try
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("USP_GET_Advertisment_DASHBOARD_HISTORY", osqlConnection);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            anchortaglink.NavigateUrl = "UserAdvertismentDashboard.aspx?Qnreid=" + intApplicationID.Trim();
            anchortaglinkprint.NavigateUrl = "AdvertismentPrint.aspx?Qnreid=" + intApplicationID.Trim();
            anchortaglinkpayment.NavigateUrl = "UserAdvertismentpaymentDetails.aspx?Qnreid=" + intApplicationID.Trim();
            if (Approval_Status == "3")
            {
                anchortaglinkStatus.NavigateUrl = "RptApplicationWiseDetailedTrakerAdvertisment.aspx?intqnreid=" + intApplicationID.ToString();
            }
