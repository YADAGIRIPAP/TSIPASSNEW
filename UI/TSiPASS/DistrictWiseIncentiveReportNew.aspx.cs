...
public partial class UI_TSiPASS_DistrictWiseIncentiveReportNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ds = Gen.DistrictWiseIncentivereportdetailsNewINCType(Session["DistrictID"].ToString().Trim());
        }
        else
        {
            ds = Gen.DistrictWiseIncentivereportdetailsNewINCType("%");
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=1" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=3" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=2" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h15 = (HyperLink)e.Row.Cells[5].Controls[0];
            h15.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=17" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();




            HyperLink h4 = (HyperLink)e.Row.Cells[6].Controls[0];
            h4.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=4" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h5 = (HyperLink)e.Row.Cells[7].Controls[0];
            h5.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=5" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h6 = (HyperLink)e.Row.Cells[8].Controls[0];
            h6.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=6" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h7 = (HyperLink)e.Row.Cells[9].Controls[0];
            h7.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=7" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h8 = (HyperLink)e.Row.Cells[10].Controls[0];
            h8.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=8" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h9 = (HyperLink)e.Row.Cells[11].Controls[0];
            h9.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=9" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h10 = (HyperLink)e.Row.Cells[12].Controls[0];
            h10.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=10" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h11 = (HyperLink)e.Row.Cells[13].Controls[0];
            h11.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=11" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h12 = (HyperLink)e.Row.Cells[14].Controls[0];
            h12.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=16" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h13 = (HyperLink)e.Row.Cells[15].Controls[0];
            h13.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=16" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();
            HyperLink h14 = (HyperLink)e.Row.Cells[16].Controls[0];
            h14.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=16" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();

            HyperLink h99 = (HyperLink)e.Row.Cells[17].Controls[0];
            h99.NavigateUrl = "DistrictWiseIncentiveStatusDetailsNew.aspx?Stg=99" + "&d1=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District_Id")).Trim();
