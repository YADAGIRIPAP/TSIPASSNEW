<%@ Page Title=":: TS-iPASS ::  " Language="C#" EnableEventValidation="false" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="RptApplicationData.aspx.cs" Inherits="TSTBDCReg1" %>
                            ...
                            <tr>
                                <td align="center" colspan="5" style="padding: 5px; margin: 5px">
                                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="verdana" Font-Size="13px"
                                        ForeColor="#006600">Staus - O : Offline Approved / P :	Pre-Scrutiny Pending / Q : Query / NP : Payment Pending / AP : Approval Pending / A : Approved / R : Rejected</asp:Label>
                                </td>
                            </tr>
                            
                            <tr>
                                <td align="center" colspan="5" class="style8" style="padding: 5px; margin: 5px; text-align: right;"
                                    valign="top">
                                </td>
                            </tr>
