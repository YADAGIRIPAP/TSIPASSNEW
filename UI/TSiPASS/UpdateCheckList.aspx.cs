...
public partial class UI_TSiPASS_UpdateCheckList : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("UpdateCheckDeatailFinal.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&Date=" + ddlapplicationto.SelectedValue + "&SubIncTypeId=" + lblsubInctypeid + "&DIPC=" + DIPCFlag);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        ds = gen.getincentiveslclistWorkigngList(SLcDate, DIPCFlag);
