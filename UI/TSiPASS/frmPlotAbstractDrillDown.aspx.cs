...
public partial class UI_TSiPASS_frmPlotAbstractDrillDown : System.Web.UI.Page
{
    ...
    string Status = ""; string districtid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["fromdate"] != null && Request.QueryString["fromdate"] != "" && Request.QueryString["todate"] != null && Request.QueryString["todate"] != "" && Request.QueryString["Status"] != null && Request.QueryString["Status"] != "" && Request.QueryString["dist"] != null && Request.QueryString["dist"] != "")
            {

                districtid = Request.QueryString["dist"].ToString().Trim();
    ...
    public void fillgrid()
    {
        ...
        //    vehicleDS = DeptReportDepartmentWise( FromdateforDB, TodateforDB);
        //}
        vehicleDS = DeptReportDepartmentWise(FromdateforDB, TodateforDB, Status, districtid);
        grdDetails.DataSource = vehicleDS;
        grdDetails.DataBind();

        if (Request.QueryString["Status"].ToString().Trim() != null && Request.QueryString["Status"].ToString().Trim() == "Rejected")
        {
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
           // AssignGridRowStyle(e.Row, "GridviewScrollC1Item");
            ...
            string intUid = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApplicationId")).Trim();
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=R6.3: TGiPASS - Progress Of Implementation Report.xls");
            Response.Charset = "";
    ...
    public DataSet DeptReportDepartmentWise(string fromdate, string todate,string Status, string Dist)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        ...
        {// if Your Changeing the query same should be in "DeptReportDepartmentWise_New_export"
            da = new SqlDataAdapter("USP_GetPlotAllotmentDetailsDrllDown", con.GetConnection);
            ...
            da.SelectCommand.Parameters.Add("@Distid_RegOffice", SqlDbType.VarChar).Value = Dist.ToString();
