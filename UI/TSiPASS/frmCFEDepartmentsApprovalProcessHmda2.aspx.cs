...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void fillGrid()
    {
        ...
        dsn = Gen.GetCompletedbyApproval2HMDA("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim(), Request.QueryString[0].ToString().Trim());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                e.Row.Cells[9].Text = "Please process this application in Concerned Department portal";
                e.Row.Cells[9].Font.Bold = true;
            }
            else
            {
                e.Row.Cells[9].Text = "Please process this application in TS-iPASS portal";
            }
