...
public partial class FrmUsers : System.Web.UI.Page
{
    ...
    public void TChildHead(string Service_id, string Department, string Service, string totalReceived, string beforeclose, string afterclose, string beforeopen, string afteropen, string Rejected, string PPending, string QQueryRaised,string Approvals)
    {
        ...
        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml =  beforeclose.Trim() ;
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = afterclose.Trim();
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = beforeopen.Trim();
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = afteropen.Trim();
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = PPending;
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tbl1.Rows.Add(tRow);

        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = Approvals;
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tbl1.Rows.Add(tRow);
        ...
        tcell1 = new HtmlTableCell();
        tcell1.InnerHtml = Rejected.Trim();
        tcell1.Align = "Right";
        tRow.Cells.Add(tcell1);
        tbl1.Rows.Add(tRow);
