...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerMultiplex : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds = ApplicationWiseDetailedTrakerMulltiplexScreen(intqnreid.ToString());
    ...
    public DataSet ApplicationWiseDetailedTrakerMulltiplexScreen(string Quesionary_id)
    {
        ...
        try
        {
            da = new SqlDataAdapter("FS_RetriveR4ReportMultiplexScreen", con);
