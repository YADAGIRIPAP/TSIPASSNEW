<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="SANCTIONEDSLCDIPCDATA_MANDALWISE.aspx.cs" Inherits="UI_TSiPASS_SANCTIONEDSLCDIPCDATA_MANDALWISE" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;"><asp:Label ID="lblHeading" runat="server">R21: SANCTIONED CLAIMS-MANDALWISE </asp:Label>
                                        ...
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 80%">
                                            <tr>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlcaste" runat="server" class="form-control txtbox" Width="180px">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                         ...
                                                         <asp:ListItem Value="PHC">PHC</asp:ListItem>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlincentivename" runat="server" class="form-control txtbox" Width="180px">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                        ...
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="NO OF CLAIMS" HeaderText="NO OF CLAIMS">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="SANCTIIONED AMOUNT" HeaderText="SANCTIIONED AMOUNT">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
