...
public partial class UI_TSiPASS_frmGraphReport : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = GetGraphReport(ddlEnterPriseType.SelectedValue, ddlProp_intDistrictid.SelectedValue, "", "", "", ddlcolor.SelectedValue, ddlpowerconnection.SelectedValue, ddlWomenEnterprenuer.SelectedValue, ddlDifferentlyabled.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            //    TodateforDB = Convert.ToString(DateTime.ParseExact(txtTodate.Text, "dd-MM-yyyy", null).ToString("MM-dd-yyyy"));
            //}
            //dsChartData = Gen.FetchTotalDistrictwise_New_NewCommissioner(ddlFinYear.SelectedValue, ddlProp_intDistrictid.SelectedItem.Text, ddlsector.SelectedValue, ddlEnterPriseType.SelectedValue, ddlcolor.SelectedValue).Tables[0];
            dsChartData = GetGraphReport(ddlEnterPriseType.SelectedValue, ddlProp_intDistrictid.SelectedValue, "", "", "", ddlcolor.SelectedValue, ddlpowerconnection.SelectedValue, ddlWomenEnterprenuer.SelectedValue, ddlDifferentlyabled.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //h1.NavigateUrl = "FrmCommissionerReportDrillDown.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString();

            //HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];

            //h2.NavigateUrl = "FrmCommissionerReportDrillDown.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString();

            //HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];

            //h3.NavigateUrl = "FrmCommissionerReportDrillDown.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
           ...
           // Total.NavigateUrl = "FrmCommissionerReportDrillDown.aspx?ddlFinYear=" + ddlFinYear.SelectedValue.ToString() + "&ddlProp_intDistrictid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim() + "&ddlsector=" + ddlsector.SelectedValue.ToString() + "&ddlEnterPriseType=" + ddlEnterPriseType.SelectedValue.ToString() + "&ddlcolor=" + ddlcolor.SelectedValue.ToString();
    ...
    protected void btnNewPdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //{
            //    phrase = new Phrase();
            //    phrase.Add(new Chunk("For Financial Year :" + ddlFinYear.SelectedItem.Text.Trim(), FontFactory.GetFont("trebuchet ms", 12, Font.NORMAL, Color.BLACK)));
            //    cell = PhraseCell(phrase, PdfPCell.ALIGN_RIGHT);
            //    cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
            //    cell.HorizontalAlignment = PdfCell.ALIGN_RIGHT;
            //    cell.Colspan = 3;
            ...
            {
                phrase = new Phrase();
                phrase.Add(new Chunk("District :" + ddlProp_intDistrictid.SelectedItem.Text.Trim(), FontFactory.GetFont("trebuchet ms", 12, Font.NORMAL, Color.BLACK)));
                cell = PhraseCell(phrase, PdfPCell.ALIGN_RIGHT);
                cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
                cell.HorizontalAlignment = PdfCell.ALIGN_RIGHT;
                cell.Colspan = 3;
            ...
            //{
            //    phrase = new Phrase();
            //    phrase.Add(new Chunk("Sector :" + ddlsector.SelectedItem.Text.Trim(), FontFactory.GetFont("trebuchet ms", 12, Font.NORMAL, Color.BLACK)));
            //    cell = PhraseCell(phrase, PdfPCell.ALIGN_RIGHT);
            //    cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
            //    cell.HorizontalAlignment = PdfCell.ALIGN_RIGHT;
            //    cell.Colspan = 3;
            ...
            {
                phrase = new Phrase();
                phrase.Add(new Chunk("Pollution Category :" + ddlcolor.SelectedItem.Text.Trim(), FontFactory.GetFont("trebuchet ms", 12, Font.NORMAL, Color.BLACK)));
                cell = PhraseCell(phrase, PdfPCell.ALIGN_RIGHT);
                cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
                cell.HorizontalAlignment = PdfCell.ALIGN_RIGHT;
                cell.Colspan = 3;
    ...
    //    Dsnew = Gen.GenericFillDs("USP_GET_GRAPHCHART_REPORT", pp);

    //    return Dsnew;
    //}

    public DataSet GetGraphReport(string CATEGORY, string DISTRICT, string MANDAL, string STATUS, string INDUSTRYTYPE, string PCBCATEGORY, string TYPEOFCONNECTION, string WOMEN, string DIFFERENTABLED)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_GRAPHCHART_REPORT", con.GetConnection);
           ...
           if (STATUS.Trim() == "" || STATUS.Trim() == null || STATUS.Trim() == "--Select--")
            ...
            if (INDUSTRYTYPE.Trim() == "" || INDUSTRYTYPE.Trim() == null || INDUSTRYTYPE.Trim() == "--Select--")
                da.SelectCommand.Parameters.Add("@INDUSTRYTYPE", SqlDbType.VarChar).Value = '%';
            else
                da.SelectCommand.Parameters.Add("@INDUSTRYTYPE", SqlDbType.VarChar).Value = INDUSTRYTYPE.ToString();

           if (PCBCATEGORY.Trim() == "" || PCBCATEGORY.Trim() == null || PCBCATEGORY.Trim() == "--Select--")
                da.SelectCommand.Parameters.Add("@PCBCATEGORY", SqlDbType.VarChar).Value = '%';
            else
                da.SelectCommand.Parameters.Add("@PCBCATEGORY", SqlDbType.VarChar).Value = PCBCATEGORY.ToString();

           if (TYPEOFCONNECTION.Trim() == "" || TYPEOFCONNECTION.Trim() == null || TYPEOFCONNECTION.Trim() == "--Select--")
                da.SelectCommand.Parameters.Add("@TYPEOFCONNECTION", SqlDbType.VarChar).Value = '%';
            else
                da.SelectCommand.Parameters.Add("@TYPEOFCONNECTION", SqlDbType.VarChar).Value = TYPEOFCONNECTION.ToString();

           if (WOMEN.Trim() == "" || WOMEN.Trim() == null || WOMEN.Trim() == "--Select--")
               da.SelectCommand.Parameters.Add("@WOMEN", SqlDbType.VarChar).Value = '%';
           else
               da.SelectCommand.Parameters.Add("@WOMEN", SqlDbType.VarChar).Value = WOMEN.ToString();

           if (DIFFERENTABLED.Trim() == "" || DIFFERENTABLED.Trim() == null || DIFFERENTABLED.Trim() == "--Select--")
               da.SelectCommand.Parameters.Add("@DIFFERENTABLED", SqlDbType.VarChar).Value = '%';
           else
               da.SelectCommand.Parameters.Add("@DIFFERENTABLED", SqlDbType.VarChar).Value = DIFFERENTABLED.ToString();
