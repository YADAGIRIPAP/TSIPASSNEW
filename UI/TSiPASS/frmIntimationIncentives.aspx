<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="frmIntimationIncentives.aspx.cs" Inherits="UI_TSiPASS_frmIntimationIncentives" %>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    <tr id="trno" runat="server">
                                        <td style="padding: 5px; margin: 5px; color: blue; font-weight: bold" valign="top" runat="server" id="tdinvestments" colspan="2">List of cases sanctioned incentives
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; margin: 5px; font-weight: bold; text-align: right;" valign="top">Unique Id:</td>
                                        <td style="padding: 5px; margin: 5px; font-weight: bold; text-align: center;" valign="top">
                                            <asp:TextBox runat="server" ID="txtUniqueID" class="form-control txtbox"
                                                MaxLength="80" TabIndex="1" Width="150px"></asp:TextBox>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; margin: 5px; font-weight: bold; text-align: right; height:3px" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px; font-weight: bold; text-align: center;" valign="top">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; margin: 5px; font-weight: bold; text-align: center;" valign="top" colspan="2">

                                                                                        <asp:Button ID="btnGet" runat="server" CssClass="btn btn-primary" Text="Get Incetive Details" Width="174px" OnClick="btnGet_Click"  />
