<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/BankMaster.master" AutoEventWireup="true" CodeFile="frmBankReportUserDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmBankReportUserDrillDown" %>
                        ...
                        <td align="center" colspan="4" style="padding: 5px; margin: 5px; text-align: center;"
                            ...
                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LOANAMOUNT" ItemStyle-HorizontalAlign="Center" HeaderText="LOAN AMOUNT(In Rs.)">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LOANDATE" ItemStyle-HorizontalAlign="Center" HeaderText="LOAN APPLICATION DATE">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="APPLICATIONDATE" ItemStyle-HorizontalAlign="Center" HeaderText="APPLICATION DATE">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
