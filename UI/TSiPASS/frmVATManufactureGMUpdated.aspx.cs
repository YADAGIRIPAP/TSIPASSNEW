...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    public void GetDetails()
    {
                ...
                //return;
                dsn = Gen.GetGMManufactureDet(TxtnameofUnit.Text, TxtIECNumber.Text, TxtCommodity.Text, ddlStatus.SelectedValue);
    ...
    public void GetDetailsSearch()
    {
            ...
            dsn = Gen.GetGMManufactureDetUpdated(TxtnameofUnit.Text, TxtIECNumber.Text, TxtCommodity.Text, ddlStatus.SelectedValue);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //h1.NavigateUrl = "frmUploadProductDescriptionGMVATManufacture.aspx?intApplicationId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intVATManufactureId")).Trim();


            HyperLink hypFMB = (HyperLink)e.Row.Cells[11].Controls[0];
    ...
    protected void BtnSave3_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("frmVATManufactureGMUpdated.aspx");
    }
}
