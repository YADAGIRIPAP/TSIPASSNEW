...
public partial class UI_TSiPASS_TourismEventDashboard : System.Web.UI.Page
{
    ...
    void FillDetails()
    {
        ...
        if (Session["user_code"].ToString().Trim() == "266")   
        {
            dsMAUD = obj_dashboard.GetTourismeventDepartmentDashboardDetails(Session["User_Code"].ToString().Trim());
        ...
        {
            ds = obj_dashboard.GetTourismeventDepartmentDashboardDetails(Session["User_Code"].ToString().Trim());
