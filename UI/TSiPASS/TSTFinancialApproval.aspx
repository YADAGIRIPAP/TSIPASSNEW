<%@ Page Title=":: TSiPASS : Invoice Approval " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="TSTFinancialApproval.aspx.cs" Inherits="TSTFinancialApproval" %>
...
TargetControlID="txtPDCApprvDate">
                                     ...
                                     <tr>
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:Label ID="Label429" runat="server" CssClass="LBLBLACK" Font-Bold="True" 
                                                Width="233px">Invoice Details</asp:Label>
                                        </td>
                                        <td style="width: 27px">
                                            &nbsp;</td>
                                        <td valign="top">
                                    ...
                                    <tr runat="server" id="tryy" visible="false">
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Width="158px">Bill 
...
TargetControlID="txtRaiseDate">
                                        ...
                                        <td valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        </td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        </td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        </td>
                                                    <td style="padding: 5px; margin: 5px; width: 13px; height: 35px;">
                                                        </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                            <asp:GridView ID="grdDet0" runat="server" AutoGenerateColumns="False" 
                                                BorderColor="#003399" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" 
                                                ...
                                                onrowdatabound="grdDet0_RowDataBound" ShowFooter="True">
                                                <FooterStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                                <RowStyle BackColor="#FFFFFF" />
                                                <Columns>
                                                    <%--<asp:TemplateField>
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label433" runat="server" CssClass="LBLBLACK" Width="129px">Approved 
                                                        Date</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:TextBox ID="txtRaiseDate0" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                        <cc1:CalendarExtender ID="txtRaiseDate0_CalendarExtender" runat="server" 
                                                            Format="dd-MM-yyyy" PopupButtonID="txtRaiseDate0" 
                                                            TargetControlID="txtRaiseDate0">
                                                        </cc1:CalendarExtender>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                            ControlToValidate="txtRaiseDate0" ErrorMessage="Please Enter Approved Date" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label414" runat="server" CssClass="LBLBLACK" Width="165px">Payment 
                                                        Mode</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:DropDownList ID="ddlPaymentMode" runat="server" class="form-control txtbox" 
                                                            Height="32px" Width="180px" AutoPostBack="True" 
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                                            ControlToValidate="ddlPaymentMode" ErrorMessage="Please Select Payment Mode" 
                                                            ValidationGroup="group" InitialValue="--Select--">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label416" runat="server" CssClass="LBLBLACK" Width="165px">Cheque / Online No</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                                        <asp:TextBox ID="txtChequeNo" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40"  TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                            ControlToValidate="txtChequeNo" ErrorMessage="Please Enter Cheque /Online No" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label412" runat="server" CssClass="LBLBLACK" Width="165px">Date 
                                                        of Payment</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtRaiseDate1" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                        <cc1:CalendarExtender ID="txtRaiseDate1_CalendarExtender" runat="server" 
                                                            Format="dd-MM-yyyy" PopupButtonID="txtRaiseDate1" 
                                                            TargetControlID="txtRaiseDate1">
                                                        </cc1:CalendarExtender>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 13px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                                            ControlToValidate="txtRaiseDate1" ErrorMessage="Please Enter Payment Date" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        <asp:Label ID="Label415" runat="server" CssClass="LBLBLACK" Width="165px">Paid 
                                                        Amount</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        <asp:TextBox ID="txtPaidAmt" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 13px; height: 35px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                                                            ControlToValidate="txtPaidAmt" ErrorMessage="Please Enter Paid Amount" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr runat="server" visible="false" id="trBal">
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        <asp:Label ID="Label417" runat="server" CssClass="LBLBLACK" Width="165px">Balance Amount</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; height: 35px;">
                                                        <asp:Label ID="lblBalance" runat="server" CssClass="LBLBLACK" Width="165px"></asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 13px; height: 35px;">
                                                        &nbsp;</td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                            ...
                                            &nbsp;<asp:Button ID="BtnDelete0" runat="server" CausesValidation="False" 
                                                CssClass="btn btn-warning" Height="32px" onclick="BtnClear0_Click" 
                                                OnClientClick="return confirm('Do you want to delete the record ? ');" 
                                                TabIndex="10" Text="Delete" Width="90px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                            <asp:GridView ID="grdDet" runat="server" AutoGenerateColumns="False" 
                                                BorderColor="#003399" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" 
                                                CssClass="GRD" DataKeyNames="intFundApproval,intWorkId" Font-Names="Verdana" 
                                                Font-Size="12px" ForeColor="#333333" GridLines="None" Width="100%">
                                                <FooterStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                                <RowStyle BackColor="#FFFFFF" />
                                                <Columns>
