<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmCFEDepartmentsApprovalProcessCFOIndus.aspx.cs" Inherits="TSTBDCReg1" %>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">Department Approval Status</h3>
                            </div>
                                            ...
                                            <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:BoundField DataField="LastDateofPreScrutiy" 
                                                        HeaderText="Last date of Prescrutiny" />
