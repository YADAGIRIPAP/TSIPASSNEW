<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IPORptCommon.aspx.cs" Inherits="UI_TSiPASS_IPORptCommon" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                     ...
                                     <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left; width:180px">
                                                <asp:Label ID="Label1" runat="server">Unit Name<font color="red">*</font></asp:Label>
                                            </td>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label2" runat="server"> DCP<font color="red">*</font></asp:Label>
                                            </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 350px">
                                    <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" Width="190px">Amount claimed in Rs.<font color="red">*</font></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 10px">:
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                    <asp:TextBox ID="txtAmountclaimed" runat="server" class="form-control txtbox" Height="28px" MaxLength="80" TabIndex="1" onkeypress="DecimalOnly()" ValidationGroup="group" Width="180px"></asp:TextBox>
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 10px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAmountclaimed" ErrorMessage="Please Enter Amount claimed" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center; width: 20px">2.
                                </td>
                                <td style="text-align: left; width: 350px">
                                    <asp:Label ID="Label351" runat="server" CssClass="LBLBLACK" Width="200px">Amount recommended in Rs.<font color="red">*</font></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 10px">:
                                </td>
                                <td style="padding: 5px; margin: 5px">
                                    <asp:TextBox ID="txtAmountrecommended" runat="server" class="form-control txtbox" Height="28px" MaxLength="30" TabIndex="1" onkeypress="DecimalOnly()" ValidationGroup="group" Width="180px"></asp:TextBox>
                                </td>
                                <td style="padding: 5px; margin: 5px">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAmountrecommended" ErrorMessage="Please Enter Amount recommended" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center; width: 20px" valign="top">3.</td>
                                <td style="text-align: left; width: 350px" valign="top">Remarks<font color="red">*</font></td>
                                ...
                                <td style="padding: 5px; margin: 5px">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtremarks" ErrorMessage="Please Enter Remarks" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>


                            <tr>
                                <td style="text-align: center; width: 20px" valign="top">4.</td>
                                <td style="text-align: left; width: 350px" valign="top"> Whether is DLC (or) SLC<font color="red">*</font></td>
                                <td style="padding: 5px; margin: 5px; width: 10px" valign="top">:</td>
                                <td style="padding: 5px; margin: 5px" valign="top">
                      ...
                      <tr id="trEnergy1" runat="server">
                                <td style="padding: 5px; margin: 5px" valign="top" colspan="5">
                                    <table style="width: 100%; font-weight: bold;">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">5.1</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">5.2</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
...
:
                            ...
                            <tr>
                                <td colspan="5" style="padding: 5px; margin: 5px; text-align: left; font-weight: bold; font-size: 12pt" valign="top">
                                    <p>
                            ...
                            <tr>
                                <td align="center" colspan="5" style="text-align: center; vertical-align: top;">
                            ...
                            <tr>
                                <td colspan="5" style="padding: 5px; margin: 5px; text-align: left; font-weight: bold; font-size: 12pt" valign="top"></td>
                            </tr>
                            <tr>
