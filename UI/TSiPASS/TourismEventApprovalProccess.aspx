<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TourismEventApprovalProccess.aspx.cs" Inherits="UI_TSiPASS_TourismEventApprovalProccess" %>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NameAddEventManagement" HeaderText="Name of Event"></asp:BoundField>
