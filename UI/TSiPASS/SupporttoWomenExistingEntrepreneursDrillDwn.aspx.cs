...
public partial class UI_TSiPASS_SupporttoWomenExistingEntrepreneursDrillDwn : System.Web.UI.Page
{
    ...
    protected void Binddata(string Districtid, string type, string fromdate, string todate)
    {
        try
        {
            ...
            connection.Open();
            SqlDataAdapter da = new SqlDataAdapter("GetWomenExistingEntrepreneurData", connection);
            ...
            GrdwmenEntpnrdtls.DataSource = ds.Tables[0];
            GrdwmenEntpnrdtls.DataBind();
    ...
    protected void GrdwmenEntpnrdtls_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void Button2_ServerClick(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            ...
            {
                GrdwmenEntpnrdtls.AllowPaging = false;

                lblHeading.Visible = true;
                // this.fillgrid();

                GrdwmenEntpnrdtls.HeaderRow.ForeColor = System.Drawing.Color.Black;
                GrdwmenEntpnrdtls.HeaderStyle.ForeColor = System.Drawing.Color.Black;

                GrdwmenEntpnrdtls.FooterRow.ForeColor = System.Drawing.Color.Black;
                // grdExport.Columns[1].Visible = false;
                GrdwmenEntpnrdtls.RenderControl(hw);
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                GrdwmenEntpnrdtls.Style["width"] = "680px";
    ...
    //{
    //    Response.Redirect("SupporttoWomenExistingEntrepreneurs.aspx");
    //}
}