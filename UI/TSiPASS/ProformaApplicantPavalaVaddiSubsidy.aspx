<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaApplicantPavalaVaddiSubsidy.aspx.cs" Inherits="UI_TSiPASS_ProformaApplicantPavalaVaddiSubsidy" %>
    ...
    <form id="form1" runat="server">
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px">
                <span class="floatleft auto-style3">Sub :-  &nbsp;<asp:Label ID="lblTIdeaTPrideIIPP1" runat="server" Font-Bold="true"></asp:Label>&nbsp; –  Sanction of Reimbursement of Interest Subsidy under
                                                    <asp:Label ID="lblSchemeName" runat="server" Text="Pavala Vaddi"></asp:Label>
                    &nbsp;to 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 2px">
                <span class="floatleft auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the subject cited, we are pleased to inform you that you have been sanctioned the Reimbursement of Interest Subsidy under
                                                    <asp:Label Text="Pavala Vaddi" ID="lblSchemeName1" runat="server"></asp:Label>&nbsp;
                                                    Scheme for an amount of Rs.
