<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmQuesstionniareRegCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <table style="width: 100%">
                                <tr>
                                    <td style="font-weight: bold">Questionnaire - Consent for Operations
                                    </td>
                                    <td align="right">
                ...
                <tr>
                    <td>
                        <asp:MultiView ID="MainView" runat="server">
                            <asp:View ID="View1" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid; font-weight: bold; background-color: #d9d9d9">
                                    <tr>
                                        <td style="padding: 15px; margin: 5px">1
                                        </td>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtNameOfIndustrialUndertaking" runat="server" class="form-control txtbox"
                                                Height="28px" MaxLength="60" TabIndex="1" ValidationGroup="group" Width="180px" AutoPostBack="true" OnTextChanged="txtNameOfIndustrialUndertaking_TextChanged"></asp:TextBox>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 15px; margin: 5px; text-align: left;">2
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding: 15px; margin: 5px;">3
                                        </td>
                                        <td style="padding: 5px; margin: 5px;">
                                        ...
                                        <td style="padding: 15px; margin: 5px">4&nbsp;
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label3" runat="server" CssClass="LBLBLACK" Width="165px">Line of Activity<font 
                                                            color="red">*</font></asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top">5
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top">6
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr>
                                        <td style="height: 20px; font-weight: bold;" colspan="3"></td>
                                    </tr>
                                </table>
                            </asp:View>
                            <asp:View ID="View2" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid; font-weight: bold; background-color: #d9d9d9">
                                    <tr>
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">6.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">Proposal For
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="width: 430px; font-weight: bold;"></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">7.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-left: solid 1px black"
                                                                    colspan="3">(Mention Zero in case of leased premises)
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; font-weight: bold; border-top: solid 1px black;"
                                                                    align="left" valign="top" id="tdprojectcostname" runat="server">New/Existing Investment
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black; border-right: solid 1px black"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 15px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-left: solid 1px black; border-right: solid 1px black"
                                                                    valign="top">a)
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px; border-left: solid 1px black; border-right: solid 1px black"></td>
                                                                <td style="padding: 5px; margin: 5px" align="right">In Rs. Lakhs
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">:
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-right: solid 1px black"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 15px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-left: solid 1px black; border-right: solid 1px black"
                                                                    valign="top">b)
                                ...
                                color="red">*</font></asp:Label>
                                                            ...
                                                            <tr>
                                                                <td style="padding: 15px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-left: solid 1px black; border-right: solid 1px black">c)
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" valign="top">
                                ...
                                color="red">*</font></asp:Label>
                                                    ...
                                                    <td valign="top">
                                                        <table id="tblexpansion" runat="server" visible="false">
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black;"></td>
                                                                <td style="padding: 5px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-right: solid 1px black"
                                                                    align="left" valign="top" colspan="2">
                                                                    <span style="font-weight: bold"><u>Expansion Investment </u></span>
                                                                </td>
                                                                <td style="width: 225px; padding: 5px; margin: 5px; font-weight: bold; border-top: solid 1px black; border-right: solid 1px black"
                    ...
                    ErrorMessage="Please Enter Value of Expansion Land" ValidationGroup="group">*</asp:RequiredFieldValidator>--%>
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; background-color: #d9d9d9; border-width: 2px; border-color: #666; border-style: solid; font-weight: bold">
                                    <tr>
                                        <td colspan="15" style="height: 15px; font-weight: bold;"></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 15px; margin: 5px; text-align: left;" valign="top" height="70px">8.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RadioButtonList ID="rdpPOLRDP" runat="server" RepeatDirection="Horizontal" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="rdpPOLRDP_SelectedIndexChanged"
                                                TabIndex="1">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top" height="60px">9.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label358" runat="server" CssClass="LBLBLACK" Width="200px" Height="60px">Have you taken Plan Approval from Factories Department<font 
                                                            color="red">*</font></asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                    ...
                                    <tr id="trceig" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px" valign="top" height="40px">10.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr>
                                        <td height="50px" style="padding: 15px; margin: 5px">11
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top" class="style6">12.
                                        </td>
                                    ...
                                    <tr runat="server" id="trNOC" visible="false">
                                        <td style="padding: 15px; margin: 5px" height="40px">11.a
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr>
                                        <td height="40px" style="padding: 15px; margin: 5px" valign="top">13.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RadioButtonList ID="RdpDrugs0" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RdpDrugs0_SelectedIndexChanged" Enabled="false"
                                                RepeatDirection="Horizontal" TabIndex="1" Width="200px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top" height="40px">14
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr id="servicelat" runat="server" visible="false">
                                        <td height="40px" style="padding: 15px; margin: 5px" valign="top">13a
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr id="lbr1" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">15
                                        </td>
                                    ...
                                    <tr id="lbr2" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">15a.
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Does your establishment fall under the definition of establishment under shops &amp;
                                    ...
                                    <tr id="tract2" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 15px" colspan="7" align="right">No of Workers
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">:
                                        </td>
                                    ...
                                    <tr id="tract2dateofcommencement" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 15px" colspan="7" align="right">Date of Commencement of business(DD-MM-YYYY)
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                    ...
                                    <tr id="lbr3" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">15b.
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Does your establishment employ 05 or more contract Laour as defined in the Contract
                                    ...
                                    <tr id="lbr4" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">15c.
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Does your establishment employ 05 or more Inter-State migrant workmen as defined
                                    ...
                                    <tr id="lbr5" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">16.
                                        </td>
                                    ...
                                    <tr id="Trsteampipeline" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">17.
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">Do you require Steam Pipeline Registration
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;
                                        </td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                    ...
                                    <tr id="troc" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">18. </td>
                                    ...
                                    <tr>
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">19</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require boilers Manufacturer Approval</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="RdpBoilermanu" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr id="trlaborcontractor" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">20. </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">Does your establishment employ 05 or more contract labour(License for contractors) as defined in the contract labour(Regulation and Abolition) act,1970?
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;</td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:RadioButtonList ID="rbtcontractlabouract" runat="server" RepeatDirection="Horizontal" Height="17px" Width="210px" OnSelectedIndexChanged="rbtcontractlabouract_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem Value="Y">YES</asp:ListItem>
                                                <asp:ListItem Value="N">NO</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr id="tr2" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:TextBox ID="txtnoofworkderscontractor" runat="server" Height="28px" class="form-control txtbox"
                                                MaxLength="4" onkeypress="NumberOnly()" TabIndex="0" ValidationGroup="group"
                                                Width="180px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="txtNoofworkers"
                                                ErrorMessage="Please enter Number of workers for Shops and Establishment" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr id="tr3" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <%--<asp:TextBox ID="txtDateofCommenceAct1" runat="server" class="form-control txtbox"
                                                Height="28px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group"
                                                Width="180px"></asp:TextBox>--%>
                                            <asp:TextBox ID="txtcommencementdatecontractor" autocomplete="off" class="form-control txtbox" Width="150px" Height="30px" runat="server" ValidationGroup="group" />
                                            <%--<asp:TextBox ID="" runat="server" class="form-control txtbox" Height="28px"
                                                                MaxLength="13" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ControlToValidate="txtDateofCommenceAct1"
                                                ErrorMessage="Please Select Date of Commencement of business" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            <%--<cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateofCommenceAct1">
                                            </cc1:CalendarExtender>--%>
                                        </td>
                                    </tr>
                                    <tr id="trcinemalicense" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">21. </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">Do you Require Cinematographic License & License for Screening a Film 
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;</td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:RadioButtonList ID="rbtcinemalicense" runat="server" RepeatDirection="Horizontal" Height="17px" Width="210px" AutoPostBack="true" OnSelectedIndexChanged="rbtcinemalicense_SelectedIndexChanged">
                                                <asp:ListItem Value="Y">YES</asp:ListItem>
                                                <asp:ListItem Value="N">NO</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr id="trlicenseperiod" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">22. </td>
                                        <td style="padding: 5px; margin: 5px" valign="middle">The period for which the license has to be granted <b>(In Years)</b>
                                    ...
                                    <tr id="trnoofscreen" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">23. </td>
                                        <td style="padding: 5px; margin: 5px" valign="middle">No of Screens
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;</td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:TextBox ID="txtnoofscreensoftheatre" runat="server" AutoPostBack="true" OnTextChanged="txtnoofscreensoftheatre_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>


                                    <tr id="trTdfdc" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">22</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require Approval from TSFDC</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rbtfdclicense" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr id="trtrade" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">21</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require Approval for Trade License</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rbttradelicense" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px" Enabled="true">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr id="trmaingrid" runat="server" visible="false">
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <asp:GridView ID="grd_dynamic" runat="server" AutoGenerateColumns="false" border="3" CellPadding="1" CellSpacing="1" Width="100%">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_seatcapcity" CssClass="form-control" placeholder="Seat Capacity" AutoPostBack="true" OnTextChanged="txt_seatcapcity_TextChanged" runat="server"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txt_seatcapcity" ValidationExpression="^\d+"
                                                                Display="Dynamic" ErrorMessage="Only Numbers" ForeColor="Red" runat="server"></asp:RegularExpressionValidator>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_screenfee" Enabled="false" CssClass="form-control" placeholder="Fee" runat="server"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txt_screenfee" ValidationExpression="^\d+"
                                                                Display="Dynamic" ErrorMessage="Only Numbers" ForeColor="Red" runat="server"></asp:RegularExpressionValidator>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="txt_screenfee" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_totscreenfee" Enabled="false" CssClass="form-control" placeholder="Total screen Fee" runat="server"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txt_totscreenfee" ValidationExpression="^\d+"
                                                                Display="Dynamic" ErrorMessage="Only Numbers" ForeColor="Red" runat="server"></asp:RegularExpressionValidator>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="txt_totscreenfee" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <tr id="trtotalfee" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">24. </td>
                                        <td style="padding: 5px; margin: 5px" valign="middle">Approval Fee(Cinematographic License)
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;</td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                    ...
                                    <tr id="trApprovalLblRegn" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">25</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require Approval for Label Registration</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rdbLblRegistration" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr id="trExportExcise" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">26</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require Approval for Export</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rdbExportLic" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr id="trBrandRegn" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">27</td>
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">Do you require Approval for Brand Registration</td>

                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rdbBrandRegn" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr id="trIrrigation" runat="server" visible="true">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" class="auto-style1">20. </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">Do you Require Permission to draw water from river/public tanks (Irrigation Department)  
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">&nbsp;</td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:RadioButtonList ID="rblIrrgConn" runat="server" RepeatDirection="Horizontal" Height="17px" Width="210px" OnSelectedIndexChanged="rblIrrgConn_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem Value="Y">YES</asp:ListItem>
                                                <asp:ListItem Value="N">NO</asp:ListItem>
                                            </asp:RadioButtonList>
                                            <asp:HiddenField runat="server" ID="hdnIrrgAmount" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
