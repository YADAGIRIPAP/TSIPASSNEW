<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptApplicationwiseDetailedTrackerLM.aspx.cs" Inherits="UI_TSiPASS_RptApplicationwiseDetailedTrackerLM" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 80%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="Label355" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Font-Bold="True">3. 
                                                        Registration Type</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="labRegistrationtype" runat="server" CssClass="LBLBLACK"
                                ...
                                <td align="center"
                                    ...
                                    <table cellpadding="4" cellspacing="5"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="labAddress0" runat="server" CssClass="LBLBLACK"
                                                    Width="150px"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        </tr>
                                           ...
                                           <%-- <asp:HyperLinkField DataTextField="Status Pre-scrutiny (Completed / Pending / Query raised" HeaderText="Status Pre-scrutiny (Completed / Pending / Query raised)" />
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Certificate">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HyperLink ID="HyperLink2"  Target="_blank" NavigateUrl='<%# Eval("link") %>' runat="server">Certificate</asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle Width="20px" />
                                            </asp:TemplateField>
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%"
                                        __designer:mapid="363">
                                        <tr id="trtsipass" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px">
                                        ...
                                        <tr id="trdateofapproval" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px">
                                ...
                                <td align="center" style="padding: 5px; margin: 5px; vertical-align: top;">
                                    <table cellpadding="4" cellspacing="5"
                                        style="width: 100%; vertical-align: top;">
                                        <tr id="trnoofdays" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px" __designer:mapid="365">
