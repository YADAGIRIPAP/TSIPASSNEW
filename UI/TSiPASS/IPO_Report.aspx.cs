...
public partial class UI_TSiPASS_IPO_Report : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalDistrictwise_IPoList( ddlYear.SelectedValue.ToString(), ddlmonth.SelectedValue.ToString());
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue, Session["DistrictID"].ToString()).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "IPO" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED"; 

            HyperLink h5 = (HyperLink)e.Row.Cells[4].Controls[0];

            h5.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "IPO" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED";
            HyperLink h2 = (HyperLink)e.Row.Cells[5].Controls[0];
            h2.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "AD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h6 = (HyperLink)e.Row.Cells[6].Controls[0];
            h6.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "AD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED"; 

            HyperLink h3 = (HyperLink)e.Row.Cells[7].Controls[0];
            h3.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "DD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            h7.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "DD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED"; 

            HyperLink h4 = (HyperLink)e.Row.Cells[9].Controls[0];
            h4.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "TOTAL" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h8 = (HyperLink)e.Row.Cells[10].Controls[0];
            h8.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "TOTAL" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED"; 
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell.Text = "Industrial Promotion Officer Monthly Report";
            
            HeaderCell.ColumnSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Assistant Director Monthly Report";
            HeaderCell.ColumnSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Deputy Director  Monthly Report";
            HeaderCell.ColumnSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Salary Report";
            HeaderCell.ColumnSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);
