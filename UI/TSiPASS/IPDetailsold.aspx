<%@ Page Title=":: TSiPASS : Implentation Partner Details" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="IPDetailsold.aspx.cs" Inherits="CheckPOITD" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Implentation Partner Details</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Implentation Partner Details</h3>
                            </div>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label351" runat="server" CssClass="LBLBLACK" Width="137px">Authorised Person Email Id</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px;">
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtGuestName1" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40" onkeypress="Names()" TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label366" runat="server" CssClass="LBLBLACK" Width="145px">Authorised 
                                                        Person Secondary Contact No</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtGuestName3" runat="server" class="form-control txtbox" 
                                                            Height="40px" MaxLength="150" onkeypress="Names()" TabIndex="1" 
                                                            TextMode="MultiLine" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        &nbsp;</td>
