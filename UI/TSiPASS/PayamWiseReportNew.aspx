<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="PayamWiseReportNew.aspx.cs" Inherits="PayamWiseReportNew" Title=":: TSiPASS Online Management System ::" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                            ...
                            <tr>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        onrowdatabound="grdDetails_RowDataBound" PageSize="50" Width="100%" 
                ...
                <td><asp:Label ID="lblmsg1" Text="Payam wise type of works report" Font-Bold="true"   runat="server" Font-Size="Medium"></asp:Label>
                </td>
                </tr>
