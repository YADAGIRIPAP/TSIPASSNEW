<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptApplicationWiseDetailedTrakerMobileTower.aspx.cs" Inherits="UI_TSiPASS_RptApplicationWiseDetailedTrakerMobileTower" %>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="Label353" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Font-Bold="True">2. Name of the Industry/Applicant</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px">
