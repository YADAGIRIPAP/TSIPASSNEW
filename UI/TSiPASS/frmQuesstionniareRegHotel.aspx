<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmQuesstionniareRegHotel.aspx.cs" 
    Inherits="UI_TSiPASS_frmQuesstionniareRegHotel" EnableEventValidation="false" %>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td style="font-weight: bold">
                                        Questionnaire - Consent for Hotel Establishment
                                    </td>
                                    <td align="right">
                            ...
                            <asp:View ID="View1" runat="server">
                                <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid;
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="TxtnameofUnit" runat="server" class="form-control txtbox" Height="28px"
                                                ToolTip="text" MaxLength="50" TabIndex="0" ValidationGroup="group" Width="180px"
                                   ...
                                   <%-- <tr>
                                       ...
                                       <tr runat="server" id="trIndusLandCond">
                                    ...
                                    <tr runat="server" id="trHotelLandCond" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">3.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label18" runat="server" data-balloon-length="large" data-balloon="Whether land is"
                                                data-balloon-pos="down" Width="260px">Whether land is</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RadioButtonList ID="rbtnOwnedLease" runat="server" RepeatDirection="Horizontal"
                                                AutoPostBack="True" OnSelectedIndexChanged="rdIaLa_Lst_SelectedIndexChanged">
                                                <asp:ListItem Value="O">Owned</asp:ListItem>
                                                <asp:ListItem Value="L"  >Leased</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                      ...
                                      <tr runat="server" id="trTourismRooms" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">No. of Lettable rooms
                                            <%--<table>
                                            <tr>
                                                <td></td>
                                            </tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">:</td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtNoofRooms" runat="server" class="form-control txtbox" Height="28px"
                                                MaxLength="6" onkeypress="NumberOnly()" ValidationGroup="group" Width="180px"></asp:TextBox></td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                    </tr>
                                    <tr runat="server" id="trTourismOutlets" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">No. of F&amp;B Outlets</td>
                                        <td style="padding: 5px; margin: 5px">:</td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtOutlets" runat="server" class="form-control txtbox" Height="28px"
                                                MaxLength="6" onkeypress="NumberOnly()" ValidationGroup="group" Width="180px"></asp:TextBox></td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                    </tr>
                                    <tr runat="server" id="trTourismBanquets" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;" valign="top">&nbsp;</td>
                                        <td style="padding: 5px; margin: 5px">No. of banquets</td>
                                        <td style="padding: 5px; margin: 5px">:</td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtBanquets" runat="server" class="form-control txtbox" Height="28px"
                                                MaxLength="6" onkeypress="NumberOnly()" ValidationGroup="group" Width="180px"></asp:TextBox></td>
                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label395" runat="server" data-balloon-length="large" data-balloon="Please Select Pollution Category of Unit"
                                                data-balloon-pos="down" CssClass="LBLBLACK" Width="165px">Pollution Category of Unit</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="ddlintLineofActivity"
                                                ErrorMessage="Please Select Pollution Category of Unit" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                        </td>
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">
                                            9.
                                        </td>
                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                            <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="Please Select Line of Activity" data-balloon-pos="down">Line of Activity</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                            <asp:DropDownList ID="ddlHotelType" runat="server" class="form-control txtbox" Height="33px"
                                             ...
                                             <asp:DropDownList ID="ddlSector_Ent" runat="server" class="form-control txtbox" Height="33px"
                                                Width="180px" AutoPostBack="True" OnSelectedIndexChanged="ddlSector_Ent_SelectedIndexChanged" Visible="false">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="padding: 5px; margin: 5px; width: 10px;">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlHotelType"
                                    ...
                                    <tr runat="server" id="trFallinPolution">
                                     ...
                                     <tr runat="server" id="trhotelcfeapproval" visible="false">
                                        <td style="padding: 15px; margin: 5px; font-weight: bold;">11.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label19" runat="server" data-balloon-length="large" 
                                                data-balloon-pos="down" Width="260px">Do you require project approval for hotel classification</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:RadioButtonList ID="rdcfehotelapproval" runat="server" RepeatDirection="Horizontal"
                                                AutoPostBack="True" OnSelectedIndexChanged="rdcfehotelapproval_SelectedIndexChanged">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                        ...
                                        <td style="height: 38px; padding: 5px; margin: 5px">12.</td>
                                        <td>Do you require NOC for soil excavation/Filling </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                            <asp:RadioButtonList ID="rdExcavation" runat="server" RepeatDirection="Horizontal"
                                                AutoPostBack="True" OnSelectedIndexChanged="rdExcavation_SelectedIndexChanged">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N" Selected="True">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr runat="server" id="trTourismPoliceNOC" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label22" runat="server" data-balloon-length="large" 
                                                data-balloon-pos="down" Width="260px">Police NOC for Construction of Unit in terms of Parking and Traffic </asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">:
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr runat="server" id="trTourismPoliceNOCYesCond2" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label21" runat="server" data-balloon-length="large" data-balloon=""
                                                data-balloon-pos="down" Width="260px">Whether sufficient measures have been taken for storage of construction material and 
                                                    ...
                                                    <td>
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr id="trmarketurl" runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:HyperLink ID="HyperLinkmarketvalue0" ForeColor="Red" runat="server" NavigateUrl="http://registration.telangana.gov.in/TGMV_Client/index.jsp"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" valign="top">
                                                                    <asp:Label ID="Label391" runat="server" CssClass="LBLBLACK">Value of Proposed Building<font 
                                color="red">*</font></asp:Label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" valign="top" class="auto-style1">
                                                                    <asp:Label ID="Label392" runat="server" CssClass="LBLBLACK">Value of Plant &amp; Machinery or Service Equipment(including Fixtures and furniture)  
                                                                        <font 
                                color="red">*</font></asp:Label>
                                                                </td>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" valign="top">
                                                                    <asp:Label ID="lblturnOver" runat="server" CssClass="LBLBLACK">Expected Annual Turnover<font 
                                color="red">*</font></asp:Label>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    :
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" class="form-control txtbox" Height="28px" MaxLength="20" onkeypress="DecimalOnly()" OnTextChanged="TextBox1_TextChanged" TabIndex="0" ValidationGroup="group" Width="180px" Text="0"></asp:TextBox>
                                                            ...
                                                            <tr runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="True" class="form-control txtbox" Enabled="false" 
                                                                        Height="28px" MaxLength="20" onkeypress="DecimalOnly()" OnTextChanged="TextBox2_TextChanged" TabIndex="0" ValidationGroup="group" Width="180px" Text="0"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; border-right: solid 1px black">
                                                                </td>
                                                            </tr>
                    ...
                    ErrorMessage="Please Enter Value of Expansion Land" ValidationGroup="group">*</asp:RequiredFieldValidator>--%>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <tr runat="server" visible="false">
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black" valign="top">
                                                                    <asp:TextBox ID="TextBox3" runat="server" AutoPostBack="True" class="form-control txtbox" Height="28px" 
                                                                        MaxLength="20" onkeypress="DecimalOnly()" TabIndex="0" ValidationGroup="group" Width="180px" 
                                                                        OnTextChanged="TextBox3_TextChanged" Text="0" ></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px; border-top: solid 1px black">
                                                                    :
                                                                </td>
                                ...
                                color="red">*</font></asp:Label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px" align="right">
                                                                    <asp:TextBox ID="TextBox4" runat="server" AutoPostBack="True" class="form-control txtbox" Enabled="false" Height="28px" MaxLength="20" onkeypress="DecimalOnly()" TabIndex="0" ValidationGroup="group" Width="180px" OnTextChanged="TextBox4_TextChanged" Text="0"></asp:TextBox>
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; border-width: 2px; border-color: #666; border-style: solid;
                                    ...
                                    color="red">*</font></asp:Label>
                                        ...
                                        <td style="padding: 5px; margin: 5px"  runat="server" visible="false">
                                            <asp:Label ID="Label379" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="Please Select store Rectified Spirit/Kerosene/Naptha" data-balloon-pos="down">Do you store Rectified Spirit/Kerosene/Naptha</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px"  runat="server" visible="false">
                                            :
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            Do you have Existing borewell in proposed Hotel Location
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr runat="server" id="trNoExepted">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label6" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="Is there any need to Fell trees in Proposed Site" data-balloon-pos="down">Is there any need to Fell trees in Proposed Site</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:RadioButtonList ID="RdProp_Site" runat="server" RepeatDirection="Horizontal"
                                                AutoPostBack="True" OnSelectedIndexChanged="RdProp_Site_SelectedIndexChanged"
                                                Height="16px" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Value="N" Selected="True">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        ...
                                        <td id="Td1" style="padding: 5px; margin: 5px" runat="server" visible="false">
                                            <asp:Label ID="Label5" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="Does your location fall under muncipal limit" data-balloon-pos="down">20.Does your location fall under muncipal limit<font 
                                    color="red">*</font></asp:Label>
                                        </td>
                                        <td id="Td2" style="padding: 5px; margin: 5px" runat="server" visible="false">
                                            :
                                        </td>
                                        <td id="Td3" style="padding: 5px; margin: 5px" class="auto-style1" runat="server"
                                            visible="false">
                                            <asp:RadioButtonList ID="RdFall_in_Municipal" runat="server" RepeatDirection="Horizontal"
                                                Height="16px" Width="210px">
                                    ...
                                    <tr runat="server" id="trtrees" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label9" runat="server" CssClass="LBLBLACK" data-balloon-length="large"
                                                data-balloon="" data-balloon-pos="down">Number of trees to be felled(Girth of tree > 30 centimeters)</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                    ...
                                    <tr runat="server" id="tr4" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px">
                                            <asp:Label ID="Label11" runat="server" CssClass="LBLBLACK">Are there any trees in Non-Exempted(Other than trees in this <a  style="font-size:18px; color:Red" target="_blank" href="../../docs/Exempted_Trees.pdf"><b>List</b> </a>)</asp:Label>
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:RadioButtonList ID="RdbExecpted" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <tr id="Tr1" runat="server" visible="true">
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">
                                            Does your establishment provide 05 or more inter-state migrant workmen on contractual
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top" colspan="6">
                                            Does the unit Location fall within 100mts vicinity of any water body?
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            :
                                        </td>
                                    ...
                                    <tr runat="server" visible="false">
                                        <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">24</td>
