...
public partial class UI_TSiPASS_frmOtherServiceDepartmentsViewAppl : System.Web.UI.Page
{
    int delete = 0;
    ...
    public void GetDetails()
    {
        if (Request.QueryString.Count > 0)
        {
            ...
            //return;
            dsn = Gen.GetShowDepartmentFilesOtherServices(Session["User_Code"].ToString().Trim(), rstages.ToString().Trim(), Session["DistrictID"].ToString().Trim());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "OtherServicePrint.aspx?intApplid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
            h2.Target = "_blank";
            h2.NavigateUrl = "frmViewAttachmentDetailsOtherServices.aspx?intApplicationId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
            h3.Target = "_blank";
            ...
            h4.Target = "_blank";
            h4.NavigateUrl = "RptPaymentDetailsOther.aspx?intApplicationId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "UID_No")).Trim();
            // h5.Target = "_blank";
            ...
            hdfApplID.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
            ...
            dsquery = Gen.GetQueryRaisedOtherServices(hdfGroundedNo.Value, hdfGroundedNo0.Value, hdfGroundedNo1.Value);
    ...
    protected void BtnSave_Click1(object sender, EventArgs e)
    {
        ...
        int result = 0;
        result = Gen.insertDepartmentProcessOtherServices(hdfGroundedNo.Value, hdfGroundedNo0.Value, hdfGroundedNo1.Value, ddlStatus.SelectedValue.ToString(), hdfGroundedNo2.Value, Session["uid"].ToString().Trim());
        if (ddlStatus.SelectedValue.ToString() == "5")//|| ddlStatus.SelectedValue.ToString()=="9"
        {
            ...
            {
                int j = Gen.UpdateAdditionalpaymentsOtherServices(hdfGroundedNo.Value, "", "Completed", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, getclientIP());
                int i = Gen.insertQueryResponsedataServices(result.ToString(), hdfGroundedNo.Value, txtPromotor.Text, "Y", Session["uid"].ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, hdfApplID.Value);
                try
                {
                    int k = Gen.InsertDeptDateTracingOtherServices(hdfGroundedNo0.Value, hdfApplID.Value, "", null, null, System.DateTime.Now.ToString("MM/dd/yyyy"), null, null, "CFE", hdfGroundedNo1.Value);
                }
                catch (Exception ex)
                {
                ...
                dsMail = Gen.GetShowEmailidandMobileNumberOtherServices(hdfApplID.Value);
        ...
        {
            int i = Gen.insertQueryResponsedataServices(result.ToString(), hdfGroundedNo.Value, txtPromotor.Text, "Y", Session["uid"].ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, hdfApplID.Value);
            int j = Gen.UpdateAdditionalpaymentsOtherServices(hdfGroundedNo.Value, txtAmount.Text, "Y", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, getclientIP());
            DataSet dsMail = new DataSet();
            dsMail = Gen.GetShowEmailidandMobileNumberOtherServices(hdfApplID.Value);
            if (dsMail.Tables[0].Rows.Count > 0)
            {
        ...
        else if (ddlStatus.SelectedValue.ToString() == "11")
        {
            ...
            int j = Gen.UpdateAdditionalpaymentsOtherServices(hdfGroundedNo.Value, txtAmount.Text, "Completed", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, getclientIP());
            DataSet dsMail = new DataSet();
            try
            {
                int k = Gen.InsertDeptDateTracingOtherServices(hdfGroundedNo0.Value, hdfApplID.Value, "", null, System.DateTime.Now.ToString("MM/dd/yyyy"), null, null, null, "CFE", hdfGroundedNo1.Value);
            }
            catch (Exception ex)
            {
        ...
        else if (ddlStatus.SelectedValue.ToString() == "16")
        {
            ...
            if (txtPromotor.Text.Trim() != "")
            {
                ...
                int j = Gen.UpdateAdditionalpaymentsBeforePreOtherServices(hdfGroundedNo.Value, "", "Rejected", Session["uid"].ToString(), ddlStatus.SelectedValue.ToString(), hdfGroundedNo0.Value, hdfGroundedNo1.Value, txtPromotor.Text, getclientIP());
                int k = Gen.InsertDeptDateTracingOtherServices(hdfGroundedNo0.Value, hdfApplID.Value, "", null, System.DateTime.Now.ToString("MM/dd/yyyy"), null, null, null, "CFE", hdfGroundedNo1.Value);
                DataSet dsMail = new DataSet();
                dsMail = Gen.GetShowEmailidandMobileNumberOtherServices(hdfApplID.Value);
                if (dsMail.Tables[0].Rows.Count > 0)
