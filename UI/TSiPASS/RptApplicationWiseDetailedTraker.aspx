<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptApplicationWiseDetailedTraker.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px; height: 280px;"
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataTextField="Not Yet Applied" HeaderText="Applied" />
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%"
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" align="left">
                                                <asp:Label ID="Label363" runat="server" CssClass="LBLBLACK" 
                                                    Font-Bold="True">9. STATUS OF TSIPASS APPROVAL</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px" align="left">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" align="left">
                                                <asp:Label ID="Label364" runat="server" CssClass="LBLBLACK" 
                                                    Font-Bold="True">10. DATE OF APPROVAL / REJECTION</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px" align="left">
                                ...
                                <td align="center" style="padding: 5px; margin: 5px; vertical-align: top;">
                                    <table cellpadding="4" cellspacing="5"
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" __designer:mapid="365" align="left">
                                                <asp:Label ID="Label367" runat="server" CssClass="LBLBLACK" 
                                                    Font-Bold="True">11. NUMBER OF DAYS TAKEN FOR APPROVAL</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px" __designer:mapid="367">:</td>
                                            <td style="padding: 5px; margin: 5px" __designer:mapid="368" align="left">
