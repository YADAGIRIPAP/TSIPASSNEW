<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="IncentiveStatusInspectionUploadDetailsNew.aspx.cs" Inherits="UI_TSiPASS_IncentiveStatusInspectionUploadDetailsNew" %>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center;" colspan="3" align="center">
                                                ...
                                                <tr id="trNEW2" runat="server" visible="false">
                                                    <td align="center" style="padding: 5px; margin: 5px; width: 100%" valign="top">
                                                        <div style="margin-bottom: 17px; text-align: left; margin-left: 50px;">
                                                            <input type="text" id="search1" class="form-control input-sm" style="width: 380px;
                                                                font-size: 16px; height: 35px; float: left; margin-right: 10px;" placeholder="Type to search" /><input
                                                                    type="button" class="btn btn-default" value="Clear" id="clear1" />
                                                        </div>
                                                        ...
                                                        <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="View Incentives">
                                                                    <ItemTemplate>
                                                                        <a id="View" target="_blank" href="IncetivesDraft.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">
                                                                            View</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="View Attachments">
                                                                    <ItemTemplate>
                                                                        <a id="View" target="_blank" href="Show_AttachmentsNew.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">
                                                                            View</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Inspection Report">
                                                                    <ItemTemplate>
                                                                        <a id="View" target="_blank" href="InspectionRprt.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">
                                                                            View</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Inspection Date">
                                                                    <ItemTemplate>
                                                                        <table id="Table1" style="width: 100%" cellpadding="4" cellspacing="5" runat="server"
                                                                            visible="false">
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="lbl123" Text="Inspection Upload" runat="server"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="270px" id="Boilersupload" runat="server" visible="true">
                                                                                    <asp:FileUpload ID="FileUpload6" runat="server" class="form-control txtbox" Height="28px"
                                                                                        Width="180px" />
                                                                                    <asp:HyperLink ID="lblFileName2" runat="server" CssClass="LBLBLACK" Target="_blank"
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="Label1" Text="Actual Inspection Date" runat="server"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="width: 150px; height: 29px">
                                                                                    <asp:TextBox ID="txtInspectionDate" runat="server"></asp:TextBox>
                                                                                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MM-yyyy" PopupButtonID="txtInspectionDate"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="4" align="center">
                                                                                    ...
                                                                                    <asp:HiddenField ID="HdfintApplicationid" runat="server" Value='<%#Eval("EnterperIncentiveID") %>' />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
                                                                ...
                                                                <%--<asp:TemplateField HeaderText="View Incentives">
                                                                    <ItemTemplate>
                                                                        <a id="View" target="_blank" href="InspectionRprt.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">View</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>--%>
