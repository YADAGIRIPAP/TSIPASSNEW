<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmlapsedchequesrollback.aspx.cs" Inherits="UI_TSiPASS_frmlapsedchequesrollback" %>
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="panel-heading" style="text-align: center">
                                ...
                                <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Uploaded Check Details by Cheque Number </asp:Label>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtlapsedchequeno" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="148px"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:Button ID="btngetlapsedcheequedata" CssClass="btn btn-primary" runat="server" Text="Get details by cheque number"
                                                OnClick="btngetlapsedcheequedata_Click"  />
                                                    </td>
                                                </tr>
                                            ...
                                            <div id="Div1" style="width: 100%" runat="server">
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="SLCORDIPCNumer" ItemStyle-HorizontalAlign="Center" HeaderText="SLC/DIPC Numer">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="SLCORDIPCDate" ItemStyle-HorizontalAlign="Center" HeaderText="SLC/DIPC Date">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                     <%--   <asp:BoundField DataField="SLCDate" ItemStyle-HorizontalAlign="Center" HeaderText="SLCDate">
                                                        ...
                                                        <asp:TemplateField HeaderText="Remarks">
                                                         ...
                                                         <asp:TemplateField HeaderText="SLC/DIPC">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LBLSLCORDIPC" Text='<%#Eval("SLCORDIPC") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>    
                                                        <asp:TemplateField HeaderText="Working Status Updated Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LBLWORKINGSTATUSUPDATEDDATE" Text='<%#Eval("WORKINGSTATUSUPDATEDDATE") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>   
                                                        <asp:BoundField DataField="CHEQUEDATE" ItemStyle-HorizontalAlign="Center" HeaderText="Cheque Date">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="CHEQUEAMOUNT" ItemStyle-HorizontalAlign="Center" HeaderText="Cheque Amount">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                    </Columns>
                                    ...
                                    <tr runat="server" id="trrollbackbutton" visible="false" >
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7"
                                            id="tblselection" runat="server">
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Rollback Check Details"
