<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="CommIncentiveStatusDetails.aspx.cs" Inherits="TSTBDCReg1" %>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: center;" colspan="3" align="center">
                                                                ...
                                                                <ItemTemplate>
                                                                 ...
                                                                 <tr>
                                                                  <asp:Label ID="Label1" Text="GM Certifcate" runat="server"></asp:Label>
                                                                  <br />
                                                                     ...
                                                                     <asp:FileUpload ID="FileUpload6" runat="server" class="form-control txtbox" 
                                                                        ...
                                                                        <br />
                                                                 <asp:Label ID="lbl123" Text="Recommended To" runat="server"></asp:Label>
                                                                 </tr>
                                                                 <tr>
                                                               
                                                                 <td style="width: 150px; height: 29px">
                                                                <asp:DropDownList ID="ddlDeptname" runat="server" Width="180px" 
                                                                    CssClass="DROPDOWN" >
                                                                    <asp:ListItem>--Select--</asp:ListItem>
