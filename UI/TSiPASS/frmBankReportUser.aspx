<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/BankMaster.master" AutoEventWireup="true" CodeFile="frmBankReportUser.aspx.cs" Inherits="UI_TSiPASS_frmBankReportUser" %>
                                        ...
                                        <td align="center" colspan="6" style="padding: 5px; margin: 5px">
                                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="No Units" HeaderText="No Industries" />                                                 
