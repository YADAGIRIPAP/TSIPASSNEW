<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CentralInspectionSystemReport.aspx.cs" Inherits="UI_TSiPASS_CentralInspectionSystemReport" %>
                                ...
                                <td>
                                    <table style="vertical-align: top; text-align: center;" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr style="height: 35px" id="trdate" runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: right;" class="auto-style1">
                                                <strong>Date:</strong> <strong>15/06/2017</strong></td>
