<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmdipcmeetindsDrill.aspx.cs" Inherits="UI_TSIPASS_frmdipcmeetindsDrill" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%; font-family: 'Trebuchet MS'">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/frmdipcmeetings.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
                            ...
                            <tr id="divPrint" runat="server">
                                <td>
                                    <table align="center" cellpadding="10" cellspacing="5" style="width: 60%">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 5px; margin: 5px; width: 60%; text-align: center;"
                                                valign="top">
