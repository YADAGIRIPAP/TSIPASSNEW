<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaApplicantAdvanceSubsidyforSCSTSubsidyNew.aspx.cs" Inherits="UI_TSIPASS_ProformaApplicantAdvanceSubsidyforSCSTSubsidyNew" %>
        ...
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 14px">
                <span class="floatleft auto-style3">Sub :- &nbsp;&nbsp;<asp:Label ID="lblTIdeaTPrideIIPP1" runat="server" Font-Bold="true"></asp:Label>&nbsp;-
                                                -Sanction of Reimbursement of Advance Subsidy before DCP for SC/ST Enterprises to
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 14px">
                <span class="floatleft auto-style3">Ref :-  
                    ...
                    1. <%--G.O.Ms.No. 28, Industries & Commerce (IP) Department, dated: 29/11/2014 read with G.O.Ms No. 77, 
                                                    Industries & Commerce (IP & INF) Department, dt: 09/10/2015.--%>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;Dated:&nbsp;
                                                <asp:Label ID="lblRefLetterDate" runat="server"></asp:Label>: The General Manager,
                                                District Industries Centre,
                                                <asp:Label ID="lblDistrict" runat="server"></asp:Label><br />--%>
                    3. Minutes of the
                                                <asp:Label ID="lblSLCorDIPC" runat="server"></asp:Label>&nbsp;
                                                <asp:Label ID="lblSLCNo" Font-Bold="true" runat="server"></asp:Label>&nbsp; SLC meeting held on&nbsp;
                                                <asp:Label ID="lblSLCDate" Font-Bold="true" runat="server"></asp:Label>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the subject cited, we are pleased to inform you that you have been sanctioned the Reimbursement of Advance Subsidy before DCP for SC/ST Enterprises for the year&nbsp;<span style="font-weight: bold"><asp:Label ID="lbl1stOR2ndHalfYearFinYearFromTo" runat="server"></asp:Label></span>&nbsp;   
                                                    of Rs.
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 25px; padding-bottom: 10px; text-align:left">
                <span class=" pull-right"><span style="font-weight: bold">Yours faithfully,</span><br />
                    ...
                    <asp:Label ID="lblAddlDir_Name" runat="server" Text="O/o. Commissioner of Industries"></asp:Label>
                </span>
