...
public partial class UI_TSiPASS_frmIncentiveYearwiseDrilldown : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter("USP_GET_RELEASEd_YEARWISE_Drilldown", con);
