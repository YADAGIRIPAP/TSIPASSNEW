...
public partial class UI_TSiPASS_BilldeskPaymentPage_Groundwater : System.Web.UI.Page
{
    ...
    Cls_OSGroundWater obj_adv = new Cls_OSGroundWater();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = obj_adv.GetGroundwaterpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
