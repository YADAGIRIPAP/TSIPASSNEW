<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmViewPattalandattachments.aspx.cs" Inherits="UI_TSiPASS_frmViewPattalandattachments" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Pattaland Attachment Details</a>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="303px">Pattaland Application Attachments<font 
                                                            color="red">*</font></asp:Label></br>
                                    <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="174px">Pattaland Application ID:<font 
                                                            color="red">*</font></asp:Label>
                                    <asp:Label ID="LblpattalandID" runat="server" CssClass="LBLBLACK" Font-Bold="True" Width="154px" Height="16px"><font 
                                                            color="red"></font></asp:Label>
