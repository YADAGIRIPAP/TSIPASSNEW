...
public partial class UI_TSiPASS_frmDashboardRedirectRenewal : System.Web.UI.Page
{
    int delete = 0;
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (status == "Approval - Issued")
                {
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        HyperLinkcoi.NavigateUrl = "RENCertificate.aspx?intCFEEnterpid=" + Convert.ToString(ds.Tables[0].Rows[0]["intQuessionaireid"].ToString()).Trim();
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.Target = "_blank";
            h1.NavigateUrl = "frmViewAttachmentDetailsRenewal.aspx?intApplicationId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFEEnterpid")).Trim();
