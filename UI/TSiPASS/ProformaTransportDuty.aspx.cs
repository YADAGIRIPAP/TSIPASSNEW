...
public partial class UI_TSiPASS_ProformaTransportDuty : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"] != null)
        {
            if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
            {
                ...
                ds2 = Gen.GetBasicUnitDetails_Proforma_lettersPSR(incentiveid, "20");
                binddatanew(ds2);
                ...
                dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "20", userid, "", "RECOMMENDATION");
                if (dsname.Tables.Count > 0 && dsname.Tables[0].Rows.Count > 0)
                {
