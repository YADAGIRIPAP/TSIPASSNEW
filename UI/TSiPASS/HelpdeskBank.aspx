<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/BankMaster.master" AutoEventWireup="true" CodeFile="HelpdeskBank.aspx.cs" Inherits="UI_TSiPASS_HelpdeskBank" %>
                                                ...
                                                <td valign="top">
                                                    <table cellpadding="3" cellspacing="3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding: 5px; margin: 5px">
                                                                <asp:FileUpload ID="txtupload" runat="server" class="form-control txtbox" Height="48px" onchange="this.form.submit();" TabIndex="1" Width="180px" />
                                                            </td>
                                                            <td class="auto-style3" style="padding: 5px; margin: 5px"></td>
                                                        </tr>
                                                        <tr>
