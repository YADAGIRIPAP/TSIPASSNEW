...
public partial class UI_TSiPASS_BilldeskPaymentPageREN : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
                {
                    ...
                    dspaydtls = objgen.GetEnterprinerpaymentDtlsRenewal(CustomerID, TSipassOrderNumber, additionalPayment);
                    ...
                    //string ReturnURL = "http://localhost:38114/TSIPASS/UI/TSiPASS/BilldeskPaymentResponseRen.aspx";
                    //string ReturnURL = "http://120.138.9.236/TSIPASSTEST/UI/TSiPASS/BilldeskPaymentResponseRen.aspx";
                    string ReturnURL = "https://ipass.telangana.gov.in/UI/TSiPASS/BilldeskPaymentResponseRen.aspx";
                    ...
                    String data = Billerid + "|" + TSipassOrderNumber + "|NA|" + Totalamount + "|NA|NA|NA|INR|NA|R|coits|NA|NA|F|" + Questionaireid + "|" + CustomerID + "|" + ApplicationType + "|" + Departmentdetails + "|" + additionalPayment + "|txtadditional6|txtadditional7|" + ReturnURL;
