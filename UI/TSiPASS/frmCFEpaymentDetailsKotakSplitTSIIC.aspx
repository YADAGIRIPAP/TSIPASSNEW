<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmCFEpaymentDetailsKotakSplitTSIIC.aspx.cs" Inherits="UI_TSiPASS_frmCFEpaymentDetailsKotakSplitTSIIC" %>
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 80%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlpaymentType" runat="server" class="form-control txtbox"
                                                            Height="28px" TabIndex="1" Width="180px" AutoPostBack="True" OnSelectedIndexChanged="ddlpaymentType_SelectedIndexChanged">
                                                            <asp:ListItem>--Select--</asp:ListItem>
