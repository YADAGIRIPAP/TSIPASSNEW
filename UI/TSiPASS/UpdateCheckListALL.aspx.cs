...
public partial class UI_TSiPASS_UpdateCheckListALL : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("UpdateCheckDeatailFinalALL.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&Date=" + ddlapplicationto.SelectedValue + "&SubIncTypeId=" + lblsubInctypeid + "&DIPC=" + DIPCFlag);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        ds =  getincentiveslclistWorkigngListNEW(SLcDate, DIPCFlag);
    ...
    public DataSet getincentiveslclistWorkigngListNEW(string date, string DIPCFlag)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("USP_GET_LIST_INCENTIVEWISE_WORKING_ABSTRACT_PRINTEDDATE_ALL", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
