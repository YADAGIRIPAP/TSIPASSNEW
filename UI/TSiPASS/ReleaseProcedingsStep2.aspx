<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleaseProcedingsStep2.aspx.cs" Inherits="UI_TSiPASS_ReleaseProcedingsStep2" %>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr style="height: 30px">
                                        <td>
                                          <div style="float:left;margin-top:5px;margin-left:20px;"><label style="font-weight:bold"> Upload Release Proceding Copy :</label>  </div> <div style="float:left"><asp:FileUpload ID="fucReleaseProCopy" runat="server" class="form-control txtbox" /></div><div style="float:left"><asp:Button runat="server" Text="Upload" ID="bntUpload" CssClass="btn btn-primary" Style="margin-left:12px;margin-top:1px;" OnClick="bntUpload_Click" /></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
