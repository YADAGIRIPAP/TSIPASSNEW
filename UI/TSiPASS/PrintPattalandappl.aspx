<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPattalandappl.aspx.cs" Inherits="UI_TSiPASS_PrintPattalandappl" %>
        ...
        <div align="center">
            <div align="center" style="text-align: center">
                <div align="center">
                    ...
                    <h3>PATTADARLAND APPLICATION FORM</h3>
                </div>
                <br />
                <div align="center">
                    <div align="center">
                        <table bgcolor="White" width="800" border="2px" style="font-family: Verdana; font-size: small;">
                            ...
                            <tr>
                                <td>Pattadar Passbook Number
                                </td>
                                <td>
                                    <span>
                                        <asp:Label ID="lblDharaniNo" runat="server"></asp:Label>
                                    </span>
                                </td>
                            </tr>
                            <tr>
