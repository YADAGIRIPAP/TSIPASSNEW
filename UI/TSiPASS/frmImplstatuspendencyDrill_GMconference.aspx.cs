...
public partial class UI_TSiPASS_frmImplstatuspendencyDrill_GMconference : System.Web.UI.Page
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (status == "A")
                {
                    lblHeading.Text = "Within 3 Months - YET TO START CONSTRUCTION";
                }
                else if (status == "B")
                {
                    lblHeading.Text = "3 to 6 Months - YET TO START CONSTRUCTION";
                }
                else if (status == "C")
                {
                    lblHeading.Text = "6 Months to 1 Year - YET TO START CONSTRUCTION";
                }
                if (status == "D")
                {
                    lblHeading.Text = "1 Year to 2 Years - YET TO START CONSTRUCTION";
                }
                else if (status == "E")
                {
                    lblHeading.Text = "2 Years to 3 Years - YET TO START CONSTRUCTION";
                }
                else if (status == "F")
                {
                    lblHeading.Text = "3 Years above - YET TO START CONSTRUCTION";
                }
                //if (status == "G")
                //{
                ...
                {
                    lblHeading.Text = "Within 3 Months - INITIAL STAGE";
                }
                else if (status == "I")
                {
                    lblHeading.Text = "3 to 6 Months - INITIAL STAGE";
                }
                if (status == "J")
                {
                    lblHeading.Text = "6 Months to 1 Year - INITIAL STAGE";
                }
                else if (status == "K")
                {
                    lblHeading.Text = "1 Year to 2 Years - INITIAL STAGE";
                }
                else if (status == "L")
                {
                    lblHeading.Text = "2 Years to 3 Years - INITIAL STAGE";
                }
                else if (status == "M")
                {
                    lblHeading.Text = "3 Years above - INITIAL STAGE";
                }
                //else if (status == "N")
                //{
                ...
                {
                    lblHeading.Text = "Within 3 Months - ADVANCED STAGE";
                }
                else if (status == "Q")
                {
                    lblHeading.Text = "3 to 6 Months - ADVANCED STAGE";
                }
                if (status == "R")
                {
                    lblHeading.Text = "6 Months to 1 Year - ADVANCED STAGE";
                }
                else if (status == "S")
                {
                    lblHeading.Text = "1 Year to 2 Years - ADVANCED STAGE";
                }
                else if (status == "T")
                {
                    lblHeading.Text = "2 Years to 3 Years - ADVANCED STAGE";
                }
                else if (status == "U")
                {
                    lblHeading.Text = "3 Years above - ADVANCED STAGE";
                }
                //else if (status == "V")
                //{
        ...
        public DataSet GetAppealApplications(string ONLINEFLAG, string District, string TSiPASSType, string status, string Year)
        {
            ...
            pp[3].Value = status;
            pp[4].Value = Year;
            Dsnew = Gen.GenericFillDs("USP_GET_IMPLIMENTAION_STATUS_ABSTRACT_DRILL_LATEST_TEST", pp);
            return Dsnew;
        }
