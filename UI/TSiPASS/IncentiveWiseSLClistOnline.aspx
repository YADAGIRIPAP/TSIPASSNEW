<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveWiseSLClistOnline.aspx.cs" Inherits="UI_TSIPASS_IncentiveWiseSLClistOnline" %>
                                        ...
                                        <td style="padding: 15px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlworkingstatus" class="form-control txtbox"
                                                            ...
                                                            <asp:ListItem Value="1"  Text="SLC Approved and Yet to Release"></asp:ListItem>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 200px" align="left" runat="server" id="td1">
                                                     SLC No :
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
