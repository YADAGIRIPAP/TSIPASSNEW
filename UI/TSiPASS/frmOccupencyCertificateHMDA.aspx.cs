...
public partial class UI_TSIPASS_frmOccupencyCertificateHMDA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsnew = Gen.getdataofidentityCFONew(Session["ApplidA"].ToString(), "11");
                if (dsnew.Tables[0].Rows.Count > 0)
                {
                    ...
                    dsDATA = GethmdaocDATA(Session["ApplidA"].ToString(), "73");
                }
                else
                {
                    ...
                    {
                        Response.Redirect("frmOccupencyCertificateTSIIC.aspx?intApplicationId=" + Session["uid"].ToString() + "&Previous=" + "P");
                    }
                }
                //-------------------------------------------------------------------------------
    ...
    protected void btntab1next_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                if (RbtsDPMScheck.SelectedValue == "N")
                {
                    AssignValuestoVosFromcontrols("2");

                }
                Response.Redirect("frmDrugInfo.aspx?intApplicationId=" + Request.QueryString[0].ToString() + "&next=" + "N");
            }
    ...
    public string ValidateControls(string Step)
    {
        ...
        //else if (Step == "2")
        //{
        //if (lblcompletedbuildingplan.Text.TrimStart().TrimEnd() == "")
        //{
        //    ErrorMsg = ErrorMsg + slno + ". Please Upload Copy of completed building plan as per physical ground position\\n";
        //    slno = slno + 1;
        //}
        //if (lblPhotographsofconstructed.Text.TrimStart().TrimEnd() == "")
        //{
        ...
        //    slno = slno + 1;
        //}
        //if (lblLandvaluecertificate.Text.TrimStart().TrimEnd() == "")
        //{
        //    ErrorMsg = ErrorMsg + slno + ". Please Upload Land value certificate issued by the revenue department\\n";
        //    slno = slno + 1;
        //}
        //if (lblBuildingCompletionArchitect.Text.TrimStart().TrimEnd() == "")
        //{
    ...
    public void AssignValuestoVosFromcontrols(string step)
    {
        try
        {
            ...
            if (txtProceedingIssuedOnDate.Text.Trim().TrimStart() != "")
            {
                ...
                string[] newdate = txtProceedingIssuedOnDate.Text.Split('-');
                objvo.ProceedingIssuedOnDate = newdate[2].ToString() + "/" + newdate[1].ToString() + "/" + newdate[0].ToString();
    ...
    {
        Response.Redirect("frmOccupencyCertificateHMDA.aspx?intApplicationId=" + Session["uid"].ToString() + "&next=" + "N");
    }
            ...
            if (dsattachments.Tables[0].Rows.Count > 0)
            {
                ...
                while (i < c)
                {
                    ...
                    if (sen1.Contains("CFOAttachments"))
                    {
                        ...
                        {
                            hplcompletedbuildingplan.NavigateUrl = sen;
                        ...
                        {
                            hplPhotographsofconstructed.NavigateUrl = sen;
                        ...
                        {
                            hplLandvaluecertificate.NavigateUrl = sen;
                        ...
                        {
                            hplBuildingCompletionArchitect.NavigateUrl = sen;
                        ...
                        {
                            hplregisteredgiftdeed.NavigateUrl = sen;
                        ...
                        {
                            hplgovernmentordercopy.NavigateUrl = sen;
                        ...
                        {
                            hplEngineercompletioncertificate.NavigateUrl = sen;
                        ...
                        {
                            hplFinalFireNoc.NavigateUrl = sen;
