<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TotalReportoldbak.aspx.cs" Inherits="UI_TotalReportoldbak" EnableEventValidation="false"  %>
  ...
  vertical-align: middle;
    ...
    <script language="javascript" type="text/javascript">
        function Panel2() {
            ...
            var panel = document.getElementById("<%=divPrint.ClientID %>");
            var printWindow = window.open('', '', 'height=400,width=800');
            printWindow.document.write('<html><head><h3 style="width: 90%;text-align: center;">Government of Telangana</h3>');
    ...
    <table id="divPrint" runat="server" border="0" cellpadding="0" cellspacing="0">
        <tr>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 runat="server" class="panel-title" style="font-weight: bold;">
                                R6.1: TGiPASS- District Wise Report <a id="Button2" href="#" onclick="javascript:return Panel1();"
                                    runat="server">
                                    <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                        alt="PDF" /></a> <a id="Button1" href="#" onserverclick="ExportToExcel" runat="server">
                        ...
                        <div class="panel-body">
                            <table align="center" cellpadding="10" cellspacing="5" style="width: 80%">
                                ...
                                <tr id="GridPrint" runat="server">
                                    <td align="center" style="text-align: center;" valign="top" colspan="2">
