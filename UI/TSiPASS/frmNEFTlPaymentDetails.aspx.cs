...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dscheck = Gen.GetShowQuestionaries(Request.QueryString[1].ToString().Trim());
            ...
            if (Request.QueryString[1].ToString().Trim() == "0")
            {
                Response.Redirect("frmQuesstionniareReg.aspx");
            }
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (GridViewRow row1 in grdDetails.Rows)
                {
                    if (((CheckBox)row1.FindControl("ChkApproval")).Checked)
                    {
                        ...
                        //  int s = Gen.insertDepartmentAprrovalNew(HdfQueid, HdfDeptid, HdfApprovalid, HdfAmount, "N", Request.QueryString[1].ToString().Trim().Trim(), RdWhetherAlreadyApproved);  
                    }
                }
            ...
            else
            {
                ...
                rdbOnlineBankType.SelectedIndex = 1;
            }
        }
                ...
                foreach (GridViewRow row in grdDetails.Rows)
                {
                    if (((CheckBox)row.FindControl("ChkApproval")).Checked)
                    {
                        ...
                        if (dsch.Tables[0].Rows.Count > 0)
                        {
                            ...
                            int s = Gen.InsertNEFTPaymentTransaction(HdfQueid, dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString(), HdfDeptid, HdfApprovalid, rblPaymentMode.SelectedValue, txtDDNumber.Text, DateTime.Now.ToString(), HdfAmount, txtBankName.Text, txtBankBranchName.Text, ViewState["DDUploadName"].ToString(), ViewState["pathDDUpload"].ToString(), Session["uid"].ToString(), DateTime.Now.ToString(), Session["uid"].ToString().Trim(), DateTime.Now.ToString(), hdfUIDNumber.Value, txtRemarks.Text, getclientIP());
                    ...
                    else
                    {
                        ...
                        //string HdfApprovalid = ((HiddenField)row.FindControl("HdfApprovalid")).Value.ToString();
                        //string HdfAmount = ((HiddenField)row.FindControl("HdfAmount")).Value.ToString();
                        //int j = Gen.UpdateAdditionalpayments(HdfQueid, "", "Completed", Request.QueryString[1].ToString().Trim(), "2", HdfDeptid, HdfApprovalid);
            ...
            else
            {
                ...
                foreach (GridViewRow row in grdDetails.Rows)
                {
                    if (((CheckBox)row.FindControl("ChkApproval")).Checked)
                    {
                        ...
                        {
                            Hdfeid.Value = dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString();
                            int s = Gen.InsertUIDGeneration(HdfQueid, dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString(), HdfDeptid, HdfApprovalid, rblPaymentMode.SelectedValue, txtDDNumber.Text, DateTime.Now.ToString(), HdfAmount, txtBankName.Text, txtBankBranchName.Text, ViewState["DDUploadName"].ToString(), ViewState["pathDDUpload"].ToString(), Session["uid"].ToString(), DateTime.Now.ToString(), Session["uid"].ToString(), DateTime.Now.ToString(), hdfUIDNumber.Value);
                    ...
                    else
                    {
                        ...
                        string HdfApprovalid = ((HiddenField)row.FindControl("HdfApprovalid")).Value.ToString();
                        string HdfAmount = ((HiddenField)row.FindControl("HdfAmount")).Value.ToString();
                        int j = Gen.UpdateAdditionalpaymentsUID(HdfQueid, "", "Completed", Request.QueryString[1].ToString().Trim(), "2", HdfDeptid, HdfApprovalid,getclientIP());
                ...
                if (rdbOnlineBankType.SelectedIndex == 0)// SBI
                {
                    ...
                    foreach (GridViewRow row in grdDetails.Rows)
                    {
                        if (((CheckBox)row.FindControl("ChkApproval")).Checked)
                        {
                            ...
                            {
                                Hdfeid.Value = dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString();
                                int s = Gen.InsertPaymentDisbusmentSBI(dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString(), sonlinetrnsNo, HdfDeptid, HdfAmount, "Y", Request.QueryString[1].ToString().Trim(), HdfApprovalid);
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        foreach (GridViewRow row in grdDetails.Rows)
                        {
                            if (((CheckBox)row.FindControl("ChkApproval")).Checked)
                            {
                                ...
                                {
                                    Hdfeid.Value = dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString();
                                    int s = Gen.InsertPaymentDisbusment(dsch.Tables[0].Rows[0]["intCFEEnterpid"].ToString(), sonlinetrnsNo, HdfDeptid, HdfAmount, "Y", Request.QueryString[1].ToString().Trim(), HdfApprovalid, "CFE");
    ...
    //        //    Row["Created_by"] = Request.QueryString[1].ToString().Trim().Trim();
