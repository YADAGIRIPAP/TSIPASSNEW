<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmCommissionerReportDashboard.aspx.cs" Inherits="UI_TSiPASS_frmCommissionerReportDashboard" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server">TSiPASS- Abstract Report(CFE) </asp:Label>
                                        ...
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 100%"
                                            ...
                                            <tr>
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/HomeCommDashboard.aspx"
                                                        Text="<< Back">
                                                    </asp:HyperLink>
                                                </td>
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px" align="left">
                                                ...
                                                <td id="Td1" style="padding: 5px; margin: 5px" runat="server">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            Pollution Category
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="220px" class="form-control txtbox" >
                                                            <asp:ListItem>--Select--</asp:ListItem>
