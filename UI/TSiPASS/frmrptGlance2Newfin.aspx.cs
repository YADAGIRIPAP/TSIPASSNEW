...
public partial class UI_TSIPASS_frmrptGlance2Newfin : System.Web.UI.Page
{
    ...
    public void ExportAv(string fileName, GridView[] gvs)
    {
        ...
        string headerTable = @"<table width='100%' class='TestCssStyle'><tr><td align='left' colspan='6'><h4>" + label1text + "</h4></td></td></tr><tr><td align='left' colspan='6'><h4>R1.1: TGiPASS AT A GLANCE REPORT</h4></td></td></tr></table>";
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage5.Text = "2019-2020";
            ...
            tcMergePackage6.Text = "2020-2021";
            ...
            tcMergePackage7.Text = "2021-2022";
            ...
            tcMergePackage8.Text = "2022-2023";
            tcMergePackage8.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage8.ColumnSpan = 2;
            gvHeaderRowCopy.Cells.AddAt(10, tcMergePackage8);

            TableCell tcMergePackage9 = new TableCell();
            tcMergePackage9.Text = "2023-2024";
            tcMergePackage9.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage9.ColumnSpan = 2;
            gvHeaderRowCopy.Cells.AddAt(11, tcMergePackage9);

            TableCell tcMergePackage10 = new TableCell();
            tcMergePackage10.Text = "Cumulative since Jan 2015";
            tcMergePackage10.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage10.ColumnSpan = 2;
            gvHeaderRowCopy.Cells.AddAt(12, tcMergePackage10);
    ...
    public DataSet GetRptGlance2_New1fin(string Dist)
    {
        ...
        try
        {
            da = new SqlDataAdapter("GetRptGlance2_New1_DROPPED", con.GetConnection);
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R1.1 1 CFE Dashboard at a Glance - Duplicate\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
           ...
           // CountColumns = grdDetails.Rows[0].Cells.Count; ;
            ...
            phrase = new Phrase();
            cellTextnew = "Cumulative since Jan 2015";
            phrase.Add(new Chunk(cellTextnew, FontFactory.GetFont("Trebuchet MS", 11, Font.NORMAL, Color.WHITE)));
            cell = PhraseCell(phrase, PdfPCell.ALIGN_MIDDLE);
            cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            for (int i = 0; i < grdDetails.Rows.Count; i++)
            {
                if (grdDetails.Rows[i].RowType == DataControlRowType.DataRow)
                {
                    for (int j = 0; j < CountColumns; j++)
                    {
                        ...
                        {
                            cellTextnew = Server.HtmlDecode(grdDetails.Rows[i].Cells[1].Text);
