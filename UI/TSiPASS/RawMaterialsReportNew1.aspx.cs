...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    void fillgrid()
    {
       ...
       // ds = gen.getAcknowledgeRawmaterial("%")
        ds = Gen.getAcknowledgeRawmaterialReport(Session["uid"].ToString(), txtUdyogNo.Text, ddlStatus.SelectedValue);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            HyperLink h1 = (HyperLink)e.Row.Cells[10].Controls[0];
            ...
            h1.NavigateUrl = "PrintReceiptNew1.aspx?id=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ID")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[10].FindControl("HdfintApplicationid");
