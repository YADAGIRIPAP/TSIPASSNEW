<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RPTTSSPDCL.aspx.cs" Inherits="TSTBDCReg1" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Inspection Progress Details</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">TSSPDCL Feasibility Report</h3>
                            </div>
                                ...
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                    ...
                                    <tr>
                                        <td align="center"  style="padding: 5px; margin: 5px; text-align: center;" 
                                            valign="top">
                                            <asp:Panel runat="server" Width="1000" ScrollBars="Horizontal">
                                            <asp:GridView ID="grdDetails" runat="server" 
                                                AutoGenerateColumns="true" CellPadding="5" CssClass="GRD" ForeColor="#333333" 
