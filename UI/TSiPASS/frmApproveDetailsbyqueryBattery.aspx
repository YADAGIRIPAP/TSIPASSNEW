<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmApproveDetailsbyqueryBattery.aspx.cs" Inherits="UI_TSiPASS_frmApproveDetailsbyqueryBattery" %>
                            ...
                            <tr>
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle">3
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle">4
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
