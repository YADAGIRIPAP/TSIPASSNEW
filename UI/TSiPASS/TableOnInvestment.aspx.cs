...
//    } 
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTableOnInvestment();
       // lblMsg.Text = "";
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "TableOnInvestmentDill.aspx?status=A&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "TableOnInvestmentDill.aspx?status=B&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "TableOnInvestmentDill.aspx?status=C&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "TableOnInvestmentDill.aspx?status=A&lbl=Total Applications Received&Stage=%";
