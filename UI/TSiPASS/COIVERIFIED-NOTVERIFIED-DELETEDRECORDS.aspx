<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="COIVERIFIED-NOTVERIFIED-DELETEDRECORDS.aspx.cs" Inherits="UI_TSiPASS_COIVERIFIED_NOTVERIFIED_DELETEDRECORDS" %>
                            ...
                            <tr id="trdates" runat="server" visible="true">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddltype" runat="server" >
                                        ...
                                        <asp:ListItem Value="1">Verified Records</asp:ListItem>
                                        <asp:ListItem Value="2">Not Verified Records</asp:ListItem>
                                        <asp:ListItem Value="3">Deleted  Records</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"  OnRowDataBound="grdDetails_RowDataBound" 
                            ...
                            <Columns>
                               ...
                               <%-- <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="intQuessionaireid"
                                ...
                                <asp:BoundField DataField="Remarks_new" HeaderText="Remarks" ItemStyle-HorizontalAlign="Center"
                                    Visible="true">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="InvestmentNEW" HeaderText="Investment  (In Cr)" ItemStyle-HorizontalAlign="Center"
                                    Visible="true">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
