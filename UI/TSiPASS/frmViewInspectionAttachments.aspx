<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="frmViewInspectionAttachments.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                            <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True" 
                                                Width="210px">Inspection Attachments</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                               ...
                                               width="100%" style="font-size: 14px; font-family: Verdana;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #003366">
                                                        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#FF6600"></asp:HyperLink>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="style9" style="border: 1px solid #003366">
                                                    ...
                                                    <td class="style10" style="border: 1px solid #003366">
                                                        Upload 2</td>
                                                    <td style="border: 1px solid #003366">
                                                        <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="#FF6600"></asp:HyperLink>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="style9" style="border: 1px solid #003366">
                                                    ...
                                                    <td class="style10" style="border: 1px solid #003366">
                                                        Upload 3</td>
                                                    <td style="border: 1px solid #003366">
                                                        <asp:HyperLink ID="HyperLink3" runat="server" ForeColor="#FF6600"></asp:HyperLink>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="style9" style="border: 1px solid #003366">
                                                    ...
                                                    <td style="border: 1px solid #003366">
                                                        <asp:HyperLink ID="HyperLink4" runat="server" ForeColor="#FF6600"></asp:HyperLink>
                                                    </td>
                                                </tr>
