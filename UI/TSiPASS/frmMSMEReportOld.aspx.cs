...
public partial class UI_TSiPASS_frmMSMEReportOld : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            decimal Nounits1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "IPOCOUNT"));
            ...
            h1.NavigateUrl = "frmMSMEReportDRILLDOWNOld.aspx?ROLE=IPO&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim();

            HyperLink h2 = (HyperLink)e.Row.FindControl("HyperLink2");
            h2.NavigateUrl = "frmMSMEReportDRILLDOWNOld.aspx?ROLE=AD&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim();

            HyperLink h3 = (HyperLink)e.Row.FindControl("HyperLink3");
            h3.NavigateUrl = "frmMSMEReportDRILLDOWNOld.aspx?ROLE=DD&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim();

            HyperLink h4 = (HyperLink)e.Row.FindControl("HyperLink10");
            h4.NavigateUrl = "frmMSMEReportDRILLDOWNOld.aspx?ROLE=GM&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim();
    ...
    public DataSet GetMSMEApplications(string fromdate, string todate, string districtid)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_MSME_REPORT", pp);
        return Dsnew;
    }
}