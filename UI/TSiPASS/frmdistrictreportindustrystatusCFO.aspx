<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmdistrictreportindustrystatusCFO.aspx.cs" Inherits="UI_TSiPASS_frmdistrictreportindustrystatusCFO" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">District Wise Industry Status Report</asp:Label>&nbsp;
                            ...
                            <Columns>
                                ...
                                <%--<asp:HyperLinkField ItemStyle-HorizontalAlign="Center" Visible="false" DataTextField="DISTRICTID" HeaderText="DISTRICTID">
                                 ...
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="COMMENCED OPERATIONS"
                                    DataTextField="COMMENCEDOPERATIONS">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>                                
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="YETTOSTARTCONSTRUCTION" HeaderText="YET TO START CONSTRUCTION">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="ADVANCEDSTAGE" HeaderText="ADVANCED STAGE">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="INITIALSTAGE" HeaderText="INITIAL STAGE">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
