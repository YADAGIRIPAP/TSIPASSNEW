<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakTravelAgent.aspx.cs" Inherits="UI_TSIPASS_KotakTravelAgent" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerTravelAgent.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerTravelAgent.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentTravelAgent.aspx" />
                </td>
            </tr>
            <tr>
                <td>
