<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apparaisalnote_isformLandCost.aspx.cs" MaintainScrollPositionOnPostback="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" Inherits="UI_TSiPASS_apparaisalnote_isformLandCost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divprint">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.0
                </td>
                <td style="padding: 5px; margin: 5px; width: 220px">Application no <font color="red">*</font>
                </td>
                ...
                <td style="padding: 5px; margin: 5px; font-weight: bold;">2.1
                </td>
                <td style="padding: 5px; margin: 5px;">Name of Industrial Concern <font color="red">*</font>
                </td>
                <td style="padding: 5px; margin: 5px;">:
                </td>
                <td style="padding: 5px; margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;">2.2
                </td>
                <td style="padding: 5px; margin: 5px;">Location of the Industrial concern <font color="red">*</font>
                </td>
                <td style="padding: 5px; margin: 5px;">:
                </td>
                <td style="padding: 5px; margin: 5px;">
                ...
                <td style="padding: 5px; margin: 5px;"></td>
                <td style="padding: 5px; margin: 5px; font-weight: bold;">2.3
                </td>
                <td style="padding: 5px; margin: 5px;">Constitution of the Industrial Concern <font color="red">*</font>
                </td>
                <td style="padding: 5px; margin: 5px;">:
                </td>
                <td style="padding: 5px; margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;">2.4<br />
                    a.
                </td>
                <td style="padding: 5px; margin: 5px;">Whether the SSI Prov. regn. or any other regn/ approval in terms of IEM, ackngmnt LI/IL etc., has the continuity in validity of commercial production. <font color="red">*</font>
                </td>
                <td style="padding: 5px; margin: 5px;">:
                </td>
                <td style="padding: 5px; margin: 5px;">
                ...
                <td style="padding: 5px; margin: 5px; width: 220px">PMT/SSI/IEM acknowledgement, LI/IL No &amp; Dt <font color="red">*</font>
                </td>
                <td style="padding: 5px; margin: 5px;">:
                </td>
                <td style="padding: 5px; margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;">2.5
                </td>
                <td colspan="9" style="padding: 5px; margin: 5px; font-weight: bold;">PRODUCTS MANUFACTURED</td>
            </tr>
            <tr>
                <td></td>
                <td>Line of Acitvity</td>
                <td></td>
                <td>
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.6
                </td>
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top"></td>
                <td style="padding: 5px; margin: 5px;">Date of filing of application with the lead financial Institution for term loan/Date of openings of first Public issue is financed through public issues.</td>
                ...
                <td style="margin: 5px; font-weight: bold;" valign="top"></td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;"></td>
                <td>&nbsp;
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.7<br />
                    a</td>
                <td style="padding: 5px; margin: 5px;">In case term loan obtained from the Financial Institution/Bank Term loan sanction letter No. and date.</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
                ...
                <td style="margin: 5px; font-weight: bold;" valign="top">2.7.<br />
                    b.</td>
                <td style="margin: 5px;">Name of the Financing Institution. Lead Instn. in case of Joint finance.</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.8</td>
                <td style="padding: 5px; margin: 5px;">Date of Power connection with connected load</td>
                <td style="margin: 5px;"></td>
                ...
                <td style="margin: 5px; font-weight: bold;" valign="top">2.9</td>
                <td style="margin: 5px;">Date of Commencement of Commercial production</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    a.</td>
                <td style="padding: 5px; margin: 5px;">Date of receipt of claim application(in DIC)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
                ...
                <td style="margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    b.</td>
                <td style="margin: 5px;">Date of communication of shortfalls to the party(in DIC)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    c.</td>
                <td style="padding: 5px; margin: 5px;">Date of receipt of complete information from the party(in DIC)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    a.</td>
                <td style="padding: 5px; margin: 5px;">Date of receipt of claim application(in COI)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
                ...
                <td style="margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    b.</td>
                <td style="margin: 5px;">Date of communication of shortfalls to the party(in COI)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold;" valign="top">2.10<br />
                    c.</td>
                <td style="padding: 5px; margin: 5px;">Date of receipt of complete information from the party<br />
                    (in COI)</td>
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
            ...
            <tr id="checkTR" runat="server" visible="false">
                ...
                <td>&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="auto-style58">
                            ...
                            <asp:TextBox ID="TextBox61" runat="server" Text="0" class="form-control txtbox" AutoPostBack="true" Height="28px" MaxLength="100" onkeypress="DecimalOnly()"  TabIndex="6" Width="150px" OnTextChanged="TextBox61_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="auto-style59">
                            ...
                            <asp:TextBox ID="TextBox6" Text="0" runat="server" class="form-control txtbox" onkeypress="DecimalOnly()"  Height="28px" MaxLength="100"   TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox6_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="auto-style59">
                            ...
                            <asp:TextBox ID="TextBox8" runat="server" Text="0" class="form-control txtbox" onkeypress="DecimalOnly()" Height="28px" MaxLength="100"   TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox8_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="auto-style60">
                            ...
                            <asp:TextBox ID="TextBox10" runat="server" Text="0" class="form-control txtbox" Height="28px" MaxLength="100"  onkeypress="DecimalOnly()" TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox10_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="TextBox12" runat="server" class="form-control txtbox" Height="28px" onkeypress="DecimalOnly()" MaxLength="100" AutoPostBack="true" OnTextChanged="TextBox12_TextChanged"   TabIndex="6" Width="150px" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style54"></td>
                    <td class="auto-style54">
                        <asp:TextBox ID="TextBox14" runat="server" Text="0" class="form-control txtbox" Height="28px" MaxLength="100" onkeypress="DecimalOnly()"  TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox14_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                    <tr>
                    ...
                    <td class="auto-style61"></td>
                    <td class="auto-style61">
                        <asp:TextBox ID="TextBox16" runat="server" Text="0" class="form-control txtbox" Height="28px" MaxLength="100" onkeypress="DecimalOnly()"  TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox16_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                    <tr>
...
<table style="width: 100%; font-weight: bold;">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="margin: 5px; " class="auto-style54">
                            :</td>
                        <td style="margin: 5px; " class="auto-style54">
                            <asp:TextBox ID="txtCompvalCompc" runat="server" Text="0" class="form-control txtbox" Height="28px" MaxLength="100" AutoPostBack="true" OnTextChanged="txtCompvalCompc_TextChanged" onkeypress="DecimalOnly()" TabIndex="6"  Width="150px"></asp:TextBox>
                        </td>
                        <td class="auto-style54">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                       ...
                       <td style="padding: 5px; margin: 5px; " valign="top" class="auto-style83">
                        ...
                        <td style="margin: 5px; " class="auto-style62">
                            :</td>
                        <td style="margin: 5px; " class="auto-style62">
                            <asp:TextBox ID="TXTBUILDINGRECOMMENDEDVALUE" runat="server" class="form-control txtbox" onkeypress="DecimalOnly()" Height="28px" MaxLength="100" TabIndex="6"  Width="150px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="padding: 5px; margin: 5px;">
                            <asp:TextBox ID="txtvalCompc1" runat="server" onkeypress="DecimalOnly()" class="form-control txtbox" Height="30px"
                                MaxLength="80" TabIndex="10"  AutoPostBack="true" OnTextChanged="txtvalCompc1_TextChanged"
                    ...
                    <tr>
                        ...
                        <td style="margin: 5px; " class="auto-style59">
                            :</td>
                        <td style="margin: 5px; " class="auto-style59">
                            <asp:TextBox ID="TextBox42" runat="server" class="form-control txtbox" AutoPostBack="true" OnTextChanged="TextBox42_TextChanged" onkeypress="DecimalOnly()" Height="28px" MaxLength="100" TabIndex="6"  Width="150px"></asp:TextBox>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold; width: 20px">3.6
                </td>
                <td colspan="4" style="padding: 5px; margin: 5px;">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; font-weight: bold; " class="auto-style93">4.2.3
                </td>
                <td colspan="4" style="padding: 5px; margin: 5px;">
                ...
                <tr>
                    <td class="auto-style94">4.1&nbsp;</td>
                    <td class="auto-style48">Land Purchase in Sq. Mts.</td>
                    <td class="auto-style48">&nbsp;</td>
                    <td class="auto-style48">

                        <asp:TextBox ID="txtlandpurchase" runat="server" class="form-control txtbox txtcomn"
                ...
                <tr>
                    <td class="auto-style95">4.2</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style57">Land Value in Rs.</td>
                    ...
                    <td class="auto-style56">
                        ...
                        <asp:TextBox ID="txtlandvalue" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" MaxLength="80"  TabIndex="34" Width="150px"></asp:TextBox>
                    </td>
                ...
                <tr runat="server" visible="false">
                    ...
                    <td style="padding: 5px; margin: 5px;" class="auto-style57">Total</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;</td>
                    <td class="auto-style56">

                        <asp:TextBox ID="txtlandcosttotal" runat="server" class="form-control txtbox txtcomn"
                ...
                <tr>
                    <td class="auto-style96">4.3</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Plinth Area in Sq.Mts.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">:</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txtbuildingplinth" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)"  MaxLength="80" TabIndex="36"
                            Width="150px" OnTextChanged="txtbuildingplinth_TextChanged"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">5 times (Sq.Mts.)</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55"></td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55"> <asp:TextBox ID="txttotalplinth" runat="server" class="form-control txtbox txtcomn"
                ...
                <tr>
                    <td class="auto-style96">4.4</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Proportionate value in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txtproportionate" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
            ...
            <tr id="tr4232" runat="server" visible="true">
                    <td class="auto-style96">4.6</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Eligible Land Cost in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txteligiblelandcost" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style96">4.5</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Value recommended by G.M., DIC. in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txtgmRecommend" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                ...
                <tr id="tr1" runat="server" visible="true">
                    <td class="auto-style96">4.6</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Final Eligible Land Cost in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="TXTFINALELIGIBLELANDCOST" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="true" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style93" style="padding: 5px; margin: 5px; text-align: left; vertical-align: middle;"></td>
                    ...
                    <table>
                           <tr>
                               <td>
                                            ...
                                            <td colspan="9" style="height: 8px"><b>Please enter the following details</b></td>
                                        </tr>
                                        <tr>
                                            <td   colspan="5" >
                                                <table>
    ...
    <%--</ContentTemplate>--%>
    <triggers> <asp:AsyncPostBackTrigger  ControlID="TextBox56"  /> 
