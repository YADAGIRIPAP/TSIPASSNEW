<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="Advertisement_renewal.aspx.cs" Inherits="UI_TSiPASS_Advertisement_renewal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div align="left">
        ...
        &nbsp;!&nbsp; &nbsp; &nbsp; 
            ...
            <li class="">
                <i class="fa fa-fw fa-edit">Advertisment_Renewal</i>
            </li>
          <%--  <li class="active">
        ...
        <div class="row" align="left">
            <div class="col-lg-11">
                <div class="panel-heading" align="center" style="background-color: forestgreen">
                    <h3 class="auto-style10">ADVERTISEMENT_RENEWAL</h3>
                </div>
