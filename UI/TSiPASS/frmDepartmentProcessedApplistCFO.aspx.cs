...
public partial class UI_TSiPASS_frmDepartmentProcessedApplistCFO : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BindDistricts();
            // txtFromDate.Text = (DateTime.Today)-1;
            DateTime today = DateTime.Today;
            txtTodate.Text = today.ToString("dd-MM-yyyy");
            DateTime oneDayLess = today.AddDays(-1);
            txtFromDate.Text = oneDayLess.ToString("dd-MM-yyyy");
    ...
    public void fillgrid()
    {
        ...
        dsnew = GetMSMEApplications(Session["DistrictID"].ToString().Trim(), "%", FromdateforDB, TodateforDB, "%");
        // lblMsg.Text = "";
    ...
    public DataSet GetMSMEApplications(string intDistrictid, string Category, string fromdate, string todate, string deptid)
    {
        DataSet Dsnew = new DataSet();
        ...
        SqlParameter[] pp = new SqlParameter[] {
             ...
             new SqlParameter("@FromDate",SqlDbType.VarChar),
                ...
                new SqlParameter("@Dept",SqlDbType.VarChar),


           };
        pp[0].Value = intDistrictid;
        pp[1].Value = Category;
        pp[2].Value = fromdate;
        pp[3].Value = todate;
        pp[4].Value = deptid;
        ...
        Dsnew = Gen.GenericFillDs("DeptReportDepartmentWise_New1_CFO_Processdate", pp);
        return Dsnew;
    }
}