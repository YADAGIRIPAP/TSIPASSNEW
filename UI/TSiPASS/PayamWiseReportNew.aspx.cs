...
public partial class PayamWiseReportNew : System.Web.UI.Page
{
    #region Declaration
    ...
    void fillgrid()
    {
        ...
        DataSet ds = Gen.PayamwiseReportNew("%", IP);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[4].Text = TotalWorkProposed1.ToString();
            e.Row.Cells[6].Text = TotalInProgress1.ToString();
            e.Row.Cells[5].Text = TotaltobeApproved1.ToString();
            e.Row.Cells[7].Text = TotalClosed1.ToString();
            e.Row.Cells[8].Text = TotalFundsDisbursed1.ToString();
            e.Row.Cells[9].Text = TotalBeneficiaries1.ToString();
            e.Row.Cells[10].Text = TotalFemaleBeneficiaries1.ToString();
            e.Row.Cells[11].Text = TotalmaleBeneficiaries1.ToString();
