...
public partial class UI_TSiPASS_ProformaSkillUpgradation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"] != null)
        {
            ...
            if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
            {
                ...
                ds2 = Gen.GetBasicUnitDetails_Proforma_letters(incentiveid, "8");
                binddatanew(ds2);

                DataSet dsname = new DataSet();
                dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "8", userid, "", "RECOMMENDATION");
    ...
    public void binddatanew(DataSet ds)
    {
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            if (ds.Tables[0].Rows[0]["unitdistrict"].ToString() != null || ds.Tables[0].Rows[0]["unitdistrict"].ToString() != string.Empty)
            {
                ...
                lbldist3.Text = "DIC-" + ds.Tables[0].Rows[0]["unitdistrict"].ToString();
            }
