<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPO_DrilldownReport.aspx.cs" MasterPageFile="~/UI/TSiPASS/CCMaster.master" Inherits="UI_TSiPASS_IPO_DrilldownReport" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server" Visible="false"> TSiPASS- District Wise List </asp:Label>
                                <asp:Label ID="lblHeading1" runat="server" Visible="false"> TSiPASS- District Wise Industrial Promotion Officer Report </asp:Label>
                                <asp:Label ID="lblHeading2" runat="server" Visible="false"> TSiPASS- District Wise Assistant Director Report </asp:Label>
                                <asp:Label ID="lblHeading3" runat="server" Visible="false"> TSiPASS- District Wise Deputy Director Report </asp:Label>
                                <asp:Label ID="lblHeading4" runat="server" Visible="false"> TSiPASS- District Wise IPO/AD/DD Report </asp:Label>
                                    ...
                                    <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                        alt="PDF" /></a> <a id="Button1" href="#" onserverclick="BtnSave2_Click" runat="server">
                                            <img src="../../Resource/Images/Excel-icon.png" width="20px;" height="20px;" style="float: right;"
                                                alt="Excel" /></a></h2>
                            <div id="grd2pdf" runat="server" visible="false">
                                 <a id="A2" href="#" onserverclick="BtnPDF1_Click"
                                    runat="server">
                                    <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                        alt="PDF" /></a> <a id="A3" href="#" onserverclick="BtnSave2_Click" runat="server">
                                           <%-- <img src="../../Resource/Images/Excel-icon.png" width="20px;" height="20px;" style="float: right;"
                                                alt="Excel" />--%></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <table align="center" cellpadding="10" cellspacing="5" style="width: 80%; font-family: 'Trebuchet MS'">
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px" runat="server" visible="false">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlEnterPriseType" runat="server" class="form-control txtbox" Width="180px" Visible="false">
                                                ...
                                                <td style="padding: 5px; margin: 5px" align="right" runat="server" visible="false">
                                ...
                                <tr>
                                    <td colspan="2" class="col-xs-5" style="padding: 5px; text-align: right; margin: 5px" runat="server" visible="false">
                                ...
                                <tr id="GridPrint" runat="server" visible="false">
                                        ...
                                        <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="EMPNAME" HeaderText="Name">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="STATUS" HeaderText="Status">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="DDStatus" HeaderText="DD Status" Visible="false">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
                                    ...
                                    <tr id="grid2" runat="server" visible="false">
                                            ...
                                            <AlternatingRowStyle Height="40px" CssClass="GridviewScrollC1Item2" />
                                                    ...
                                                    <ItemStyle CssClass="text-uppercase" />
                                                            ...
                                                            <asp:BoundField DataField="EMPNAME" HeaderText="Name of the Officer" />
                                                            <asp:BoundField DataField="DESIGNATION" HeaderText="DESIGNATION">
                                                   <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                   <ItemStyle CssClass="text-uppercase" />
                                               </asp:BoundField>
                                                                  <asp:BoundField DataField="IPOREMARKS" HeaderText="Officer Remarks" />
                                                             <asp:BoundField DataField="IPODATE" HeaderText="Report Entry Date" />
                                                            <asp:TemplateField HeaderText="Attachment" >
                                                                <ItemTemplate >
                                                                   <asp:HyperLink ID="hprlink" runat="server" Visible="true" NavigateUrl='<%#Eval("ATTACHMENT") %>' Target="_blank"></asp:HyperLink>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="UploadedReportStatus" HeaderText="IPO/AD/DD Status" />
                                                       <asp:BoundField DataField="GMREMARKS" HeaderText="GM Remarks" />
                                                         <asp:BoundField DataField="GMDATE" HeaderText="GM Updation" />   
                                                           <asp:BoundField DataField="GMVERIFIED" HeaderText="GM Status" />    
                                                        </Columns>
                                                        <PagerStyle BackColor="#013161" ForeColor="White" HorizontalAlign="Center" />
                                                        <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                        <HeaderStyle BackColor="#013161" Font-Bold="True" ForeColor="White" />
                                ...
                                <tr id="GraphPrint" runat="server">
                                    <td colspan="2" align="center" style="padding: 5px; margin: 5px">
                                        <a id="A1" href="#" onclick="javascript:return Panel2();" runat="server" visible="false">
                                            <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                                alt="PDF"/></a>
                                        <div>
                                            <br />
