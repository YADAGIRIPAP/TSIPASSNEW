<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" 
    CodeFile="frmstatusbytype1New.aspx.cs" Inherits="UI_TSiPASS_frmstatusbytype1New" EnableEventValidation="false" %>
...
//        }
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">R1: APPROVAL STAGE-STATUS DETAILS</a>
            </li>
        </ol>
    </div>
    <div align="left">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="font-family: 'Trebuchet MS'">
                            ...
                            <%--<tr>
                                <td align="center" class="style8" style="padding: 5px; width: 100%; margin: 5px;
                            ...
                            <tr id="divPrint" runat="server">
                                <td colspan="6">
                                    <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            <td align="center" colspan="5" style="padding: 5px; margin: 5px; width: 100%; text-align: center;"
                                                valign="top">
