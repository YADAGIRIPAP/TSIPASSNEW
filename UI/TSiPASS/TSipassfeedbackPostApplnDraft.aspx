<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TSipassfeedbackPostApplnDraft.aspx.cs" Inherits="UI_TSiPASS_TSipassfeedbackPostApplnDraft" %>
...
<body>
    <form id="form1" runat="server">
        <div id="Receipt" runat="server" align="center">
            <table align="center"
                    ...
                    <td align="center" class="auto-style1">
                        <table bgcolor="White" width="900" border="2px" cellpadding="22"
                            ...
                            <tr style="background-color: #6699FF">
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top"><b><span>Post Application Form Draft</span></b></td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td colspan="2" style="padding: 5px; margin: 5px" valign="top" align="left"><b>Feedback Details :</b> </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2" align="left">
                                                <br />
                                                <b>a.	Ease of finding information</b></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="left">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td align="left" colspan="2"><b>4. Are you aware of the timelines within which the department has to fulfill this service
                                            <br />
                                            </b>
                                                <br />
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td colspan="2" align="left"><b>5.	Were you able to submit the entire application online, including payment and uploading of documents
                                            <br />
                                            </b>
                                                <br />
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td colspan="2" align="left"><b>6.	Are you aware of the TS-iPASS Act, its provisions and rights conferred to industries / business
                                            <br />
                                            </b>
                                                <br />
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td colspan="2" align="left"><b>7.	Are you aware of the TS-iPASS online single window system and its services
                                            <br />
                                            </b>
                                                <br />
        ...
        <div align="center">
            <table align="center" style="font-family: Verdana; font-size: 12px; text-align: center; width: 800px;">
                <tr>
