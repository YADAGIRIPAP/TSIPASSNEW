...
public partial class UI_TSiPASS_frmDistrictWiseFinancialReportCFO : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "15" + "&district=" + district;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "16" + "&district=" + district;
            }

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "17" + "&district=" + district;
            }

            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "18" + "&district=" + district;
            }

            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "19" + "&district=" + district;
            }

            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "20" + "&district=" + district;
            }

            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "21" + "&district=" + district;
            }

            HyperLink h8 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "1" + "&district=" + district;
            }

            HyperLink h9 = (HyperLink)e.Row.Cells[10].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "1" + "&district=" + district;
            }

            HyperLink h10 = (HyperLink)e.Row.Cells[11].Controls[0];
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "frmDistrictWiseFinancialReportDrillDownCFO.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&ddlFinYear=" + "1" + "&district=" + district;
            }
    ...
    public DataSet GetDistrictWiseFINANCIALYEAR(string fromdate, string todate, string districtid, string financialcd)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_FINANCIALYEAR_CFO", pp);
        return Dsnew;
    }
