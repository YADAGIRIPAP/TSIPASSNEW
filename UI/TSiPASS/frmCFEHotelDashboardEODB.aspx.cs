...
public partial class UI_TSiPASS_frmCFEHotelDashboardEODB : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           // DateTime today = System.DateTime.Now.ToString();
    ...
    public void fillgrid(string fromDate, string toDate)
    {
        ...
        lblHeadingText.Text = "CFE HOTEL Dashboard from " + txtFromDate.Text + " to " + txtTodate.Text + "";
        LBLDATETIME.Text = System.DateTime.Now.ToString();
    }
    ...
    public DataSet GetReleaseDashboardApplications(string deptid, string approvalid, string appltype, string fromDate, string toDate)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_DASHBOARD_EODB_CFEHOTEL", pp);
        return Dsnew;
