<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmViewAttachmentDetailsOtherServices.aspx.cs" Inherits="UI_TSiPASS_frmViewAttachmentDetailsOtherServices" %>
...
<ContentTemplate>--%>
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                            ...
                            <tr id="idoffline" runat="server" visible="false">
                           ...
                           <%-- <tr>
                            ...
                            <tr id="idadditional" runat="server" visible="false">
                          ...
                          <%--  <tr>
                            ...
                            <tr id="idpayment" runat="server" visible="false">
                                <td style="padding: 5px; margin: 5px; " valign="top" align="center">
                                    <table cellpadding="5px" cellspacing="5px" width="100%" style="font-size: 14px; font-family: verdana;">
                                        <tr>
                                            <td   style="border: 1px solid #003366; font-weight: bold;">
...
Attachments</asp:Label>
                            ...
                            <tr id="idland" runat="server" visible="false">
                                <td style="padding: 5px; margin: 5px; " valign="top" align="center">
                                    <table cellpadding="5px" cellspacing="5px" width="100%" style="font-size: 14px; font-family: verdana;">
                                        <tr>
                                            <td   style="border: 1px solid #003366; font-weight: bold;">
