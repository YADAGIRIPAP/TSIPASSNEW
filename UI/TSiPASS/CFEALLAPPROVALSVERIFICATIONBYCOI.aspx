<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    CodeFile="CFEALLAPPROVALSVERIFICATIONBYCOI.aspx.cs" Inherits="UI_TSiPASS_CFEALLAPPROVALSVERIFICATIONBYCOI" %>
        ...
        <div class="col-lg-12">
            ...
            <table style="width: 100%" id="divUpdate" runat="server">
                <tr>
                    <td>
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="left" style="font-size: large">CONFIRMED APPROVAL ISSUED UNITS DATA</h1>
                        </div>
            ...
            <tr>
                <td style="padding: 5px; margin: 5px; width: 60%" valign="top">
                    <div id="Div1" style="width: 60%" runat="server">
                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="grdDetails_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="lineofActivity" HeaderText="Line of Activity" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Latest Approval Date"
                                    Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lbllatestapprovaldate" runat="server" Text='<%#Eval("Latest Approval Date") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="Proposalfor" HeaderText="Unit Proposal" ItemStyle-HorizontalAlign="Center"
                                    Visible="true"></asp:BoundField>
                                <asp:BoundField DataField="District" HeaderText="District" ItemStyle-HorizontalAlign="Center"
                                    Visible="false"></asp:BoundField>
                                <asp:BoundField DataField="Sector" HeaderText="Sector" ItemStyle-HorizontalAlign="Center"
                                    Visible="false">
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Investment" HeaderText="Investment (In Lacks)" ItemStyle-HorizontalAlign="Center"
                                    Visible="true">
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="NoofEmployee" HeaderText="Employment" ItemStyle-HorizontalAlign="Center"
                                    Visible="true">
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Send to Reports" Visible="false">
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="rbtverified" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbtverified_SelectedIndexChanged">
                                            <asp:ListItem Value="Y">Yes</asp:ListItem>
                                            <asp:ListItem Value="N">No</asp:ListItem>
                                        </asp:RadioButtonList>
                                        <br />
                                        <asp:TextBox runat="server" class="form-control txtbox" Height="50px" Width="180px"
                                            AutoComplete="false" ID="txtremarks" Visible="false" placeholder="Remarks" TextMode="MultiLine" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Submit">
                                    <ItemTemplate>
                                        <asp:Button ID="BtnSave" runat="server" CausesValidation="False" CssClass="btn-success"
                                            Height="32px" OnClick="Update_Click" OnClientClick="return confirm('Do you want to update the record ? ');"
                                            Text="Submit" ValidationGroup="group" Width="100px" />
                    ...
                    <tr>
                        <td align="center" style="padding: 5px; margin: 5px;" class="auto-style8">
                            <div id="SUCCESS" runat="server" class="alert alert-success" visible="false">
                                <a aria-label="close" class="close" data-dismiss="alert" href="AddQualification.aspx">×</a> <strong>Success!</strong><asp:Label ID="Label1" runat="server"></asp:Label>
                            </div>
