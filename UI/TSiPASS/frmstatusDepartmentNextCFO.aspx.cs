...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ds = Gen.getR1DrildownbyidbyDepartmentCFO(Request.QueryString[0].ToString().Trim(), ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, Request.QueryString[1].ToString().Trim(), FromdateforDB, TodateforDB);
