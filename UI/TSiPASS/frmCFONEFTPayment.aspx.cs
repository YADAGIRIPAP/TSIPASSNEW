...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void fillGrid()
    {
        ...
        dsn = Gen.getApplicationforpaymentCFO(txtnameofUnit.Text, txtUID.Text, ddlLand_intDistrictid.SelectedValue.ToString(), ddlProp_intMandalid.SelectedValue.ToString());
    ...
    {
        Response.Redirect("frmCFONEFTPayment.aspx");
    }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            btn.Text = "Pay";
            btn.NavigateUrl = "frmNEFTlPaymentDetailsCFO.aspx?Applid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim() + "&crid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Created_by")).Trim();
        }
    }
