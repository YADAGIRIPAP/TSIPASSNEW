<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="Appraisalnote_QualityCertification.aspx.cs" MasterPageFile="~/UI/TSiPASS/CCMaster.master" Inherits="UI_TSiPASS_Appraisalnote_QualityCertification" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style48">Quality Certification charges Paid</td>
                    <td class="auto-style48">&nbsp;</td>
                    <td class="auto-style48">

                        <asp:TextBox ID="txtqualitycertificationcharges" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" MaxLength="80"  TabIndex="34" Width="150px" AutoPostBack="true" OnTextChanged="txtqualitycertificationcharges_TextChanged"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="padding: 5px; margin: 5px;" class="auto-style57">50% Amount of Charges Paid</td>
                    ...
                    <td class="auto-style56">
                        ...
                        <asp:TextBox ID="txtfiftyperofchargespaid" runat="server" class="form-control txtbox txtcomn"
            ...
            <tr id="tr1" runat="server" visible="true">
                    ...
                    <td style="padding: 5px; margin: 5px;" class="auto-style55"> Eligible Value</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txteligiblevalue" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                ...
                <tr id="tr4232" runat="server" visible="true">
                    <td class="auto-style55">4.6</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Eligible Whichever is less.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txteligiblelessvalue" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
        ...
        <table>
            ...
            <tr id="trsubmit" runat="server" visible="false">
                <td colspan="3" align="center">
                    ...
                    <asp:Button ID="Button4" CssClass="btn btn-xs btn-warning" runat="server" Text="Submit" Height="30px" OnClick="Button3_Click" />
                    &nbsp; &nbsp;<asp:Button ID="Button5" runat="server"
                        CssClass="btn btn-danger" Height="32px" OnClick="btnback_Click" TabIndex="10"
                        Text="previous" Width="90px" />

                    &nbsp;<asp:Button ID="Button6" runat="server" CssClass="btn btn-xs btn-danger" Height="30px" OnClick="Button1_Click" Text="Cancel" />
