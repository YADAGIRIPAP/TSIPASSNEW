<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="JD_Updated_List_Approval.aspx.cs" Inherits="UI_TSiPASS_JD_Updated_List_Approval" %>
        ...
        <div class="col-lg-12">
            ...
            <table style="width: 100%" id="divUpdate" runat="server">
                <tr>
                    <td>
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="left" style="font-size: large">Cheque Preparation List JD Incentives</h1>
                        </div>
                ...
                <table>
                    <tr>
                        <td colspan="1" style="padding: 5px; margin: 5px" align="Center" class="style7"
                            ...
                            <br />
                            <asp:Button ID="UpdateFlagToDB" CssClass="btn btn-primary" runat="server" Text="Approve and Forward to ADDITIONAL DIRECTOR"
