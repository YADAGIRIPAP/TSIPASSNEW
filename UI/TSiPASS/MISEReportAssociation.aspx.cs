...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    public void GetDetails()
    {
               ...
               // dsn = Gen.GetShowSactionedIncentivesDCIP(ddlCategory.SelectedValue, txtindustrialName.Text, ddltypeofncentive.SelectedItem.Text.ToString(), txtEMpartnumber.Text,ddldistrict.SelectedItem.Text.ToString());
                ...
                dsn = Gen.GetMICSDetailsAssociation(txtNameofUnit.Text, txtEMpartnumber.Text, ddlCategory.SelectedValue.ToString(), ddlCategory0.SelectedValue.ToString(), ddltypeofncentive.SelectedValue.ToString(), ddlCategory1.SelectedValue.ToString(), Session["DistrictID"].ToString(), Session["uid"].ToString());
    ...
    {
        Response.Redirect("MISEReportAssociation.aspx");
    }
