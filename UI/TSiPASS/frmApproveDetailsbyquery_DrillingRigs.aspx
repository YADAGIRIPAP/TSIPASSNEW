<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmApproveDetailsbyquery_DrillingRigs.aspx.cs" Inherits="UI_TSiPASS_frmApproveDetailsbyquery_DrillingRigs" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                ...
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" class="nav-justified">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style4" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlStatus" runat="server" class="form-control txtbox" Height="33px"
                                                    ...
                                                    <asp:ListItem Value="6">Queryraise</asp:ListItem>
                                        ...
                                        <tr id="tr_Remarks" visible="false" runat="server">
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top" class="auto-style2"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style1">
                                                <asp:Label ID="label_head9" runat="server" CssClass="LBLBLACK" Width="334px">Remarks</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px" class="auto-style3">:
                                            </td>
                                            <td class="auto-style4" style="padding: 5px; margin: 5px; text-align: left;">
                                        ...
                                        <tr id="tr_download" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle" class="auto-style2"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle" class="auto-style2">
                                                <asp:Label ID="Label58" runat="server" CssClass="LBLBLACK" ForeColor="Red"
                                                    Font-Bold="True">Note:Download the Document and Sign and Upload the Document in .pdf Format Only</asp:Label>
                                            </td>
                                             <td style="padding: 5px; margin: 5px" class="auto-style3">
                                            </td>
                                            <td style="padding: 5px; margin: 5px" class="auto-style3">

                                                   <a class="list-group-item" target="_blank" title="Download Form16A" style="background-color: darkcyan;width:80px"
                                                       href='Waltform16A.aspx?id=<%= Request.QueryString[0].ToString()%>'>Download
                                                   </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="tr_upload" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle" class="auto-style2"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style1">
                                                <asp:Label ID="label_head5" runat="server" CssClass="LBLBLACK" Width="332px">Upload Certificate<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px" class="auto-style3">:
                                            </td>
                            ...
                            <tr>
                                <td colspan="2" align="center" style="padding: 5px; margin: 5px; text-align: center;">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/frmDepartementDashboardNew_DrillingRigs.aspx">Back</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
