<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDistrictWisePollutionCategorylReport.aspx.cs" Inherits="UI_TSiPASS_frmDistrictWisePollutionCategorylReport" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">R6.10: District Wise Pollution Category</asp:Label>&nbsp;
                                        ...
                                        <td colspan="6" align="left">
                                            <table width="100%">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlEnterPriseType" runat="server" class="form-control txtbox" Width="180px" CssClass="auto-style1">
                        ...
                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DISTRICTNAME" HeaderText="District">
                                 ...
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="RED"
                                    DataTextField="RED">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>                                
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="ORANGE" HeaderText="ORANGE">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="GREEN" HeaderText="GREEN">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="WHITE" HeaderText="WHITE">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
