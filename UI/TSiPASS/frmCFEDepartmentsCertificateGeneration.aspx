<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmCFEDepartmentsCertificateGeneration.aspx.cs" Inherits="TSTBDCReg1" %>
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="#">Certificate Generation</a>
                            </li>
                        </ol>
     </div>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">Certificate Generation</h3>
                            </div>
...
<ContentTemplate>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        1</td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" Width="181px">From Date</asp:Label>
                                                    </td>
                                                    <td class="style7" style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:TextBox ID="txtFromDate" runat="server" class="form-control txtbox" 
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtToDate" runat="server" class="form-control txtbox" 
                                                            Height="28px" MaxLength="40" TabIndex="1" 
                                                            ValidationGroup="group" Width="180px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                            <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                                ...
                                                Height="62px" onrowdatabound="grdDetails_RowDataBound" PageSize="15" 
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:BoundField DataField="Created_by" HeaderText="UID Numer"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="ApprovalName" HeaderText="Department Approval" />
                    ...
                    DataNavigateUrlFormatString="KeywordSrchSumDtl.aspx?Keyword={0}&State={1}&City={2}"/>--%>
                                                    <asp:TemplateField HeaderText="Certificate">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label379" runat="server" CssClass="LBLBLACK" Width="180px">Reference Number</asp:Label>
                                                            <br />
                                                            <asp:TextBox ID="txtRefNo" runat="server" class="form-control txtbox" 
                                                                Height="27px" MaxLength="40" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                            <br />
                                                            <asp:Button ID="BtnSearch" runat="server" CssClass="btn btn-primary" 
                                                                Height="28px" onclick="BtnSearch_Click" TabIndex="10" Text="Get Certificate" 
