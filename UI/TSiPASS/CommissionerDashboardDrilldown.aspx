<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="CommissionerDashboardDrilldown.aspx.cs" Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class=""><i class="fa fa-fw fa-edit">COMMISSIONER</i> </li>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PLoutionCategorys" HeaderText="Pollution Cateogry" />
                                                            ...
                                                            <asp:TemplateField Visible="false" HeaderText="Status">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlStatus" runat="server" class="form-control txtbox" Height="33px"
                                                                        Width="180px" AutoPostBack="True" Visible="false" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                                                                    ...
                                                                    <asp:TextBox ID="txtPromotor" runat="server" class="form-control txtbox" Height="40px"
                                                                        MaxLength="40" TabIndex="1" ValidationGroup="group" Width="180px" Visible="False"
