...
public partial class UI_TSiPASS_appraisalnoteprint_qualitycertification : System.Web.UI.Page
{
    ...
    public void getDetails()
    {
        ...
        foreach (string Item in arListApplNo)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)//[lblLand_ProjectCost]   
            {
                ...
                sbPrint.Append("</table></td></tr></table>");
                sbPrint.Append("<table  align='center' style='width: 650px;' border='0' cellpadding='0px' cellspacing='0px'>");
                sbPrint.Append("<tr ><td><table cellpadding='0px' cellspacing='0px' style='width: 100%;'><td style='height: 10px; width: 0px;' class='addressing' valign='top' align='left'> </td><td style='height: 15px; width: 900px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; a) Quality Certification Charges Paid</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 500px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; " + ds.Tables[0].Rows[0]["QUALITYCERTIFICATIONCHARESPAID"].ToString() + " &nbsp;</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; b) 50% of amount Quality Certiifcation Charges Paid</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["FIFTYPEROFCHARGESPAID"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; c) GM Recommended Amount</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["GMValue"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; d) Eligible amount which is less </td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["ELIGIBLETYPE"].ToString() + "</td></tr>");
                //sbPrint.Append("<tr><td colspan='4' style='height: 15px;'></td></tr></table>"); align='center'
                sbPrint.Append("</table></td></tr></table>");
