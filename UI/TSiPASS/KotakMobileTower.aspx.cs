...
public partial class UI_TSiPASS_KotakMobileTower : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = GetMobileTowerpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
    ...
    public DataSet GetMobileTowerpaymentDtls(string UID, string Orderno, string AdditionalPaymentflg)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_Builldesc_PaymentDtls_MobileTower_DESE", con.GetConnection);
