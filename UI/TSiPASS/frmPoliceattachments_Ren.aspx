<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPoliceattachments_Ren.aspx.cs"  MasterPageFile="~/UI/TSiPASS/CCMaster.master"  Inherits="UI_TSIPASS_frmPoliceattachments_Ren" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function pageLoad() {
            ...
            $("input[id$='txtLicenseDate']").datepicker(
                {
                    dateFormat: "dd-mm-yy",
            ...
            $("input[id$='txtLastRenDate']").datepicker(
                {
                    dateFormat: "dd-mm-yy",
                                    ...
                                    <div class="panel-body">
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtLicenseNumber" class="form-control txtbox"  runat="server" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width:20%">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtLicenseDate" runat="server" class="form-control txtbox" Width="200px"></asp:TextBox>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtLastRenDate" runat="server" class="form-control txtbox" Width="200px"></asp:TextBox>
