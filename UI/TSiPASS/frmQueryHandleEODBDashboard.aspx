<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="frmQueryHandleEODBDashboard.aspx.cs" Inherits="UI_TSiPASS_frmQueryHandleEODBDashboard" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Grievance Handled Dashboard</asp:Label>&nbsp;
