...
public partial class UI_TSiPASS_ACCOUNTS_OFFICER_LIST_APPROVAL : System.Web.UI.Page
{
    General gen = new General();
    DB.DB con = new DB.DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        lblSuccessMessage.Text = "Cheque Number and Cheque Date is Updated to List Number";
        ...
        if (!IsPostBack)
        {
            DataTable dropdownData = LIST_No_DropDown_ACCOUNTS_OFFICER_Procedure(ddlcaste.SelectedValue);
    ...
    private DataTable LIST_No_DropDown_ACCOUNTS_OFFICER_Procedure(string selectedValue)
    {
        DataTable dataTable = new DataTable();
        con.OpenConnection();
        {
            using (SqlCommand command = new SqlCommand("LIST_No_DropDown_ACCOUNTS_OFFICER_APPROVAL", con.GetConnection))
            {
    ...
    private DataTable GVData_DD_APPROVAL_Procedure(string Caste, string ListNo)
    {
        ...
        con.OpenConnection();
        {
            using (SqlCommand command = new SqlCommand("GVData_JD_DD1_APPROVAL", con.GetConnection))
            {
                command.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable GVData_JD_APPROVAL_Procedure(string Caste, string ListNo)
    {
        DataTable dataTable = new DataTable();
        con.OpenConnection();
        {
            using (SqlCommand command = new SqlCommand("GVData_ACCOUNTS_OFFICER_DD1_APPROVAL", con.GetConnection))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.AddWithValue("@Caste", Caste);
                command.Parameters.AddWithValue("@ListNo", ListNo);
    ...
    private DataTable GVData_ADDITIONAL_DIRECTOR_APPROVAL_Procedure(string Caste, string ListNo)
    {
        DataTable dataTable = new DataTable();
        con.OpenConnection();
        {
            using (SqlCommand command = new SqlCommand("GVData_ACCOUNTS_OFFICER_AD1_APPROVAL", con.GetConnection))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.AddWithValue("@Caste", Caste);
                command.Parameters.AddWithValue("@ListNo", ListNo);
    ...
    private DataTable GVData_ACCOUNTS_OFFICER_APPROVAL_Procedure(string Caste, string ListNo)
    {
        DataTable dataTable = new DataTable();
        con.OpenConnection();
        {
            using (SqlCommand command = new SqlCommand("GVData_ACCOUNTS_OFFICER_APPROVAL", con.GetConnection))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.AddWithValue("@Caste", Caste);
                command.Parameters.AddWithValue("@ListNo", ListNo);
    ...
    protected void Getlist_Click(object sender, EventArgs e)
    {
        ...
        if (valid == 0)
        {
            ...
            {
                DataTable dropdownData = GVData_JD_APPROVAL_Procedure(ddlcaste.SelectedValue, DropDown_LIST_No.SelectedValue);
                GridView1.DataSource = dropdownData;
                GridView1.DataBind();
            }

            {
                DataTable dropdownData = GVData_ADDITIONAL_DIRECTOR_APPROVAL_Procedure(ddlcaste.SelectedValue, DropDown_LIST_No.SelectedValue);
                GridView2.DataSource = dropdownData;
                GridView2.DataBind();
            }

            {
                DataTable dropdownData = GVData_ACCOUNTS_OFFICER_APPROVAL_Procedure(ddlcaste.SelectedValue, DropDown_LIST_No.SelectedValue);
                GridView3.DataSource = dropdownData;
                GridView3.DataBind();
            }
            ...
            ds2 = gen.GenericFillDs("Updated_List_JD_DD1_APPROVAL", pp);
    ...
    protected void UpdateFlagToDB_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg0.Text = "<br/> Please enter Cheque Number to proceed";
            valid = 1;
        }
        if (ChequeDate.Text == null)
        {
            lblmsg0.Text += "<br/> Please enter Cheque Date to proceed";
            valid = 1;
        }
        if (valid == 0)
        {
            foreach (GridViewRow gvrow in grdDetails.Rows)
            {
                ...
                string Cheque_No = ChequeNo.Text;
                string Cheque_Date = ChequeDate.Text;

                SqlParameter[] pp = new SqlParameter[] {
                  new SqlParameter("@ANNEXTURENUMBER",SqlDbType.VarChar),
                  new SqlParameter("@MasterIncentiveId",SqlDbType.VarChar),
                  new SqlParameter("@Cheque_No",SqlDbType.VarChar),
                  new SqlParameter("@Cheque_Date",SqlDbType.DateTime)
            };
                pp[0].Value = ANNEXTURE;
                pp[1].Value = MasterId;
                pp[2].Value = Cheque_No;
                pp[3].Value = Cheque_Date;

                gen.GenericExecuteNonQuery("ACCOUNTS_OFFICER_APPROVAL", pp);
            }
    ...
    {
        string currentPageUrl = "~/UI/TSIPASS/ACCOUNTS_OFFICER_LIST_APPROVAL.aspx";
    ...
    protected void ddlcaste_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataTable dropdownData = LIST_No_DropDown_ACCOUNTS_OFFICER_Procedure(selectedValue);
