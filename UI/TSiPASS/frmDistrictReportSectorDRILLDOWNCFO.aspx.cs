...
public partial class UI_TSiPASS_frmDistrictReportSectorDRILLDOWNCFO : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmDistrictReportSector.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string sector)
    {
        ...
        SqlParameter[] pp = new SqlParameter[] {
             new SqlParameter("@FromDate",SqlDbType.VarChar),
              ...
              // new SqlParameter("@FinancialYearCd",SqlDbType.VarChar),
               new SqlParameter("@Sectorandmajor",SqlDbType.VarChar)
      ...
      //  Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_SECTOR_DRILLDOWN", pp);
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_SECTOR_DRILLDOWN_CFO", pp);
        return Dsnew;
    }
}