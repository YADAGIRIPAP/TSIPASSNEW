<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LEGAL_CERTIFICATE.aspx.cs" Inherits="UI_TSiPASS_LEGAL_CERTIFICATE" %>
...
<body onload="Redirect();">
    ...
    <div align="center">
        <div align="center" style="border: thin solid #000000; padding:20px; background-position:center; background-repeat:no-repeat; /*background-image: url(../../images/bg_cert.png);*/ text-align: center; width: 800px;
            ...
            <%--<h3 align="center"><span>ANNEXURE – IX</span><br />
           <span>(To G.O.Ms.No. 3, YAT & C (T&PMU) Department, Dated: 12-12-2020)</span>
              </h3>--%>
            <br />
            <div class="row">
                ...
                <tbody>
                    ...
                    <td align="justify">  <img src="telanganalogo.png" style="height: 67px; width: 73px" /></td>
                         ...
                         <td colspan="4" style="text-align:center;padding:3px;" >
                            <h3 align="center"><span>GOVERNMENT OF TELANGANA<br />POLLUTION CONTROL BOARD TELANGANA</span> </h3>
                            <h4 align="center">A-3, Paryavaran Bhavan, Sanath Nagar Rd, Sanath Nagar Industrial Estate, Sanath Nagar, Hyderabad, Telangana - 500018</h4>
                        </td>
                       
                   <%-- <td colspan="1" align="justify"><%-- <img src="../../images/telanganatourism.jpg.png"  style="height: 67px; width: 114px"/>
                        <img src="telanganalogo.png" style="height: 67px; width: 73px" />
                    </td>--%>
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align:center;padding:0px;" >
                            <h3 style="color: #0000FF; font-size: medium; text-align: center; font-family: Verdana;">(Bio Medical Waste Management)</h3>
                        <br />
               ...
               <%-- <tr  style="background-color:Transparent">
                    <td  style="background-color:Transparent;font-family: Verdana; font-size: 20px; text-align: Left; word-spacing: 4px;letter-spacing: 1px;" colspan="3" >
                        <asp:Label ID="lblNameOfCertifiedPerson5" runat="server" ForeColor="Black" Font-Underline="False"
                            Font-Size="15px" Font-Bold="False" Width="100%"> frer</asp:Label>
                    </td>
                </tr>--%>
                <tr  style="background-color:Transparent">
                    ...
                    <td align="center" style="text-align: center;  background-color:Transparent;">
                        <span style="text-align: center;">
                            <asp:Label ID="lblNameOfCertifiedPerson3" runat="server" Font-Bold="True" ForeColor="Black"
                                Font-Size="12px" Height="31px" Width="280px" Font-Names="Verdana">POLLUTION CONTROL BOARD TELANGANA</asp:Label>
                        </span>
                    </td>
                </tr>
                <tr style="background-color:Transparent">
