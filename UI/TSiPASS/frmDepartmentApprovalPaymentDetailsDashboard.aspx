<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartmentApprovalPaymentDetailsDashboard.aspx.cs" Inherits="TSTBDCReg1" %>
...
<ContentTemplate>--%>
                            <div class="panel-body" >
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" align="center" class="style8" colspan="3">
                                        ...
                                        <td style="padding: 5px; margin: 5px" align="center">
                                            ...
                                            <tr>
                                        <td style="padding: 5px; margin: 5px" align="center" class="style8">
                                            <asp:Label ID="Label436" runat="server" CssClass="LBLBLACK" Font-Bold="True" 
                                                ...
                                                <tr ID="DD" runat="server" >
                                                    ...
                                                    <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:TextBox ID="txtDDNumber" runat="server" 
                                                            ...
                                                            onkeypress="NumberCharandHypehn()" TabIndex="1" ValidationGroup="group" 
                                                            Width="180px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                ...
                                                <tr ID="amt0" runat="server">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                            ControlToValidate="TxtAmountOnline" ErrorMessage="Please enter Amount" 
                                                            ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                                            </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <asp:RadioButtonList ID="rdbOnlineBankType" runat="server" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" colspan="4">
                                                        ...
                                                        <br />
                                                        1. Do not press F5 or refresh the page while the transaction is in process.                                                         <br />
                                                        2. Do not press back button while the transaction is in process
                                                        <br />
                                                        3. Only the transactions with “Successful” status message will be deemed to be 
                                                        received
                                                        <br />
                                                        4. In case the transaction is not “Successful” and the amount has been debited 
                                                        from your account and any other queries, please contact the Toll free number: 
                                                        7306-600-600 or upload a grievance.
                                                        <br />
                                                        ...
                                                        store the bank details entered by the entrepreneur.</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" 
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="BtnDelete" runat="server" 
                                                ...
                                                Text="Pay" Width="200px" ValidationGroup="group" 
                                                />
