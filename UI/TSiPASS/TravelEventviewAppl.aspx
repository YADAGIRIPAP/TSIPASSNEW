<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TravelEventviewAppl.aspx.cs" Inherits="UI_TSiPASS_TravelEventviewAppl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Popup(intval) {
            ...
            win = window.open("TourismEventPopUp.aspx?UID=" + intval, "List", "scrollbars=yes,resizable=yes,width=780,height=400,left=" + ((window.screen.width / 2) - 320) + ",top=" + ((window.screen.height / 2) - 200) + ";display : block;position:absolute");
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class=""><i class="fa fa-fw fa-edit">Travel Event</i> </li>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NameAddEventManagement" HeaderText="Event Name" />
                                                            <asp:BoundField DataField="NameofTheApplicant" HeaderText="Name of Applicant" Visible="false" />
                                                            <asp:BoundField DataField="ClassificationofEvent" HeaderText="Classification of event" />
                                                            ...
                                                            <asp:HyperLinkField HeaderText="Application Form" Text="View" />
                                                            ...
                                                            <asp:BoundField DataField="structureType" HeaderText="Reference Number" />
                                                            <asp:HyperLinkField HeaderText="Document" Text="View" />
                                                            <asp:HyperLinkField HeaderText="Feasbility Details" Text="Feasbility Details" />
                                                            <asp:BoundField visible="false" DataField="Reason For Rejection" HeaderText="Reason For Rejection" />
