<%@ Page Title=":: TS-iPASS ::  " Language="C#" EnableEventValidation="false" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="RPTAPPROVALSGIVENINTSiPASSNew.aspx.cs" Inherits="TSTBDCReg1" %>
                            ...
                            <tr id="divPrint" runat="server">
                                <td align="center" style="text-align: center;" valign="top">
                                    <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="true" CellPadding="5"
                                        ShowFooter="True" OnRowDataBound="grdDetails_RowDataBound" Width="80%"  OnRowCreated="grdDetails_RowCreated">
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:TemplateField HeaderText="View" Visible="false">
                                            ...
                                            <asp:HyperLinkField HeaderText="Attachments" Text="Click here for approval" />
                                        </Columns>
                                        <RowStyle Wrap="true" />
                                    </asp:GridView>
                                </td>
