...
public partial class UI_TSIPASS_DistrictWiseUpdateabstarct : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString != null && Request.QueryString.Count > 0)
            {
                ...
                {
                    ddlTSiPASSType.SelectedValue = Request.QueryString[0];
                    Label1.Text = Request.QueryString[0] + " Levle Update - Status of Implementation";
                }
                else
                {
                    ddlTSiPASSType.SelectedValue = "A";
                }
            }
            ddltypeapps.SelectedValue = "A";
            getdistricts();
    ...
    public void fillgrid()
    {
        ...
        dsnew = GetAppealApplications(ddlConnectLoad.SelectedValue, ddltypeapps.SelectedValue, ddlTSiPASSType.SelectedValue);
        // lblMsg.Text = "";
        if (dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            if (ddlConnectLoad.SelectedValue != "0")
            {
                trlastup.Visible = true;
                tdlastup.InnerHtml = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Last Updated On " + dsnew.Tables[0].Rows[0]["LastUpdatedDate"].ToString();
            }
            else
            {
                trlastup.Visible = false;
            }
        }
        else
        {
    ...
    public DataSet GetAppealApplications(string District, string AppsType, string TSiPASSType)
    {
        DataSet Dsnew = new DataSet();
        ...
        Dsnew = gen.GenericFillDs("USP_GET_IMPLIMENTAION_STATUS_ABSTRACT_DISTRICTS", pp);
        return Dsnew;
    }

    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        string AppsTypeflag = ddltypeapps.SelectedValue;
        string ddlTSiPASSTypenew = ddlTSiPASSType.SelectedValue;
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            int NumberTotal1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "ONEMONTHBELOW"));
            NumberTotal = NumberTotal1 + NumberTotal;

            int NumberTotal2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "ONEMONTH"));
            NumberTotalUpto = NumberTotal2 + NumberTotalUpto;

            int Aproved1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "TWOMONTH"));
            Aproved = Aproved + Aproved1;

            int Aproved2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "THREEMONTH"));
            AprovedUpto = Aproved2 + AprovedUpto;

            int pending1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "FOURMONTH"));
            pending = pending + pending1;

            int Yet_to_Start1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "FIVEMONTH"));
            Yet_to_Start = Yet_to_Start1 + Yet_to_Start;

            int Initial_Stage1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "SIXMONTH"));
            Initial_Stage = Initial_Stage + Initial_Stage1;
            int Advanced_Stage1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Total"));
            Advanced_Stage = Advanced_Stage + Advanced_Stage1;



            Label lblDISRICT = (e.Row.FindControl("lblDISRICT") as Label);
            Label lblIMPSTATUSnew = (e.Row.FindControl("lblIMPSTATUSnew") as Label);

            //DistrictWiseUpdateabstarctDrill.aspx?year=2017&month=4&status=A

            HyperLink h1 = (HyperLink)e.Row.Cells[2].Controls[0];
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=A&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=B&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=C&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=D&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=E&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=F&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=G&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
            HyperLink h9 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=H&dist=" + lblDISRICT.Text.Trim() + "&impstatus=" + lblIMPSTATUSnew.Text.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            string lblIMPSTATUSnew = "%";
            string lblDISRICT = ddlConnectLoad.SelectedItem.Text;

            HyperLink h1 = new HyperLink();
            h1.Text = NumberTotal.ToString();
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=A&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=B&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=C&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=D&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=E&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=F&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
            ...
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=G&month=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
                e.Row.Cells[8].Controls.Add(h7);
            }
            HyperLink h8 = new HyperLink();
            h8.Text = Advanced_Stage.ToString();
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "DistrictWiseUpdateabstarctDrill.aspx?status=H&dist=" + lblDISRICT.Trim() + "&impstatus=" + lblIMPSTATUSnew.Trim() + "&AppsType=" + AppsTypeflag.Trim() + "&TSiPASSType=" + ddlTSiPASSTypenew;
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        //    tcMergePackage.Text = "No of Applications Received";
        ...
        //    tcMergePackage1.Text = "No of Applications where all approvals are given";
        ...
        //    tcMergePackage2.Text = "Status of Implmentation";
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            string tcMergePackage = "Report for the Year of " + ddlConnectLoad.SelectedItem.Text;
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("Status of Implementation -Month Wise Pending \n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=ImplementationStatus_" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
