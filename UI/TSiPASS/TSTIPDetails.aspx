<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TSTIPDetails.aspx.cs" Inherits="LookupTSTI" Title=":: TSiPASS Online Management System ::" %>
   ...
   function GetRowValue(val)
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            &nbsp;Implementation Partner Details </h3>
                    </div>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%" 
                                                ...
                                                <tr __designer:mapid="364">
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="365">
                                                        <asp:Label ID="Label350" runat="server" CssClass="LBLBLACK" Width="165px">Type 
                                                        of IP Name</asp:Label>
                                                    </td>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label352" runat="server" CssClass="LBLBLACK" Width="165px">IP 
                                                        Name</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtIPName" runat="server" class="form-control txtbox" 
                            ...
                            <tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                                      <asp:HyperLinkField  HeaderText="Edit" DataTextField="intIP">
      ...
      <FooterStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="TypeofIP" HeaderText="Type of IP" />
