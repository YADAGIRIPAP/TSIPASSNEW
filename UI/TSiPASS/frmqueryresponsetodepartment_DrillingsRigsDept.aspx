<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmqueryresponsetodepartment_DrillingsRigsDept.aspx.cs" Inherits="UI_TSiPASS_frmqueryresponsetodepartment_DrillingsRigsDept" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Drilling Rigs: VIEW DETAILS</a> </li>
                </ol>
            </div>
            <div align="left">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        Height="62px" PageSize="15" ShowFooter="True" Width="120%" 
                                                        BorderColor="Black">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NameoftheApplicant" HeaderText="Name of Applicant" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Query Attachment FilePath">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="hyp_approveapplication" NavigateUrl='<%# Eval("QueryAttachmentFilePath") %>' Target="_blank" Text="View" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
