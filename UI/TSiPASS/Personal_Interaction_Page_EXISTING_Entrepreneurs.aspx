<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="Personal_Interaction_Page_EXISTING_Entrepreneurs.aspx.cs" Inherits="UI_TSiPASS_Personal_Interaction_Page_EXISTING_Entrepreneurs" %>
    ...
    <contenttemplate>
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div id="Grievance_Type_Block" runat="server" visible="false">
                            ...
                            <tr>
                                <td>
                                    <div id="Broad_Grievance" runat="server" visible="false">
                                        <label class="div-Content-NEW">11. Broad Type of Grievance :</label>
                                    </div>
                    ...
                    <%--<div class="div-contentcenter" style="padding-left: 115px">
                        <asp:Button ID="btnMarktng" Text="Marketing" runat="server" OnClick="btnMarktng_Click" />
                        <asp:Button ID="btnFinancial" Text="Financial" runat="server" OnClick="btnFinancial_Click" />
                        <asp:Button ID="btnTechnical" Text="Technical" runat="server" OnClick="btnTechnical_Click" />
                        <asp:Button ID="btnLand" Text="Land" runat="server" OnClick="btnLand_Click" />
                        <asp:Button ID="btnOthrs" Text="Others" runat="server" OnClick="btnOthrs_Click" />
                    </div>--%>
                    <%-- <asp:MultiView ID="MVtype" runat="server">
                        <asp:View ID="vmrktng" runat="server">--%>
                            ...
                            <div style="padding-left: 40px;">
                                <table>
                                    ...
                                    <tr style="padding-left: 15px; padding-top: 15px" id="trincentives" visible="false" runat="server">
                                        ...
                                        <td style="padding-left: 32px;">
                                            <asp:RadioButtonList ID="rdincentives" Font-Bold="false" Font-Size="15px" runat="server" AutoPostBack="true" TabIndex="1" RepeatDirection="Horizontal" OnSelectedIndexChanged="TechnicalType_Grievance_SelectedIndexChanged">
                                                <asp:ListItem Text="S/W Related" Value="0" />
                                    ...
                                    <tr style="padding-left: 15px; padding-top: 15px" id="trRawmaterial" visible="false" runat="server">
                                        ...
                                        <td style="padding-left: 32px;">
                                            <asp:RadioButtonList ID="rdrawmaterial" Font-Bold="false" Font-Size="15px" runat="server" AutoPostBack="true" TabIndex="1" RepeatDirection="Horizontal" OnSelectedIndexChanged="TechnicalType_Grievance_SelectedIndexChanged">
                                                <asp:ListItem Text="S/W Related" Value="0" />
                                    ...
                                    <tr id="trtechschmsothrs" runat="server" visible="false">
                                        ...
                                        <td style="padding-left: 10px">
                                            <asp:TextBox ID="txttechschmsothrs" runat="server" oninput="validateInputText(this)" class="form-control" Width="350px" />
                                        </td>
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 30px">
                                                <asp:TextBox ID="Technical_Others" runat="server" oninput="validateInputText(this)" class="form-control" Width="350px" /></td>
                                        </tr>
                    ...
                    <%--<div class="panel panel-default" id="mrktngpanel" allign="Center" runat="server" visible="false" style="margin-left: 87px"  >
                        <div class="panel-heading">                             
                            <h4 style="padding-left:20px "  class="panel-title" data-toggle="collapse" data-target="#collapseOne">
                             <a class="collapsed" role="button" data-toggle="collapse" aria-expanded="false" >                                                                         
                                <i class="more-less glyphicon glyphicon-plus"></i>Marketing Details </a>
                            </h4>
                        </div>   
                    ...
                    <div class="row" id="MarketingTypes" runat="server" visible="false">
                        <div class="row">
                            <table>
                                <tr>
                                    <td>
                                        <label id="lblmrkgrv" runat="server" visible="false" class="div-Content" style="padding-left: 150px;">a) Please select Marketing Grievance type :</label>
                                        <label id="lblmrkgdnc" runat="server" visible="false" class="div-Content" style="padding-left: 150px;">a) Please select Marketing Guidance type :</label></td>
                    ...
                    <div id="Marketing_BLOCK_OFF" runat="server">
                        ...
                        <div class="div-contentcenter" style="padding-left: 100px; padding-bottom: 10px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="padding-left: 20px; padding-top: 15px;">
                                            <asp:TextBox ID="Marketing_Others_Text_Box" runat="server" oninput="validateInputName(this)" Width="350px" class="form-control" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
            ...
            <%-- </asp:View>
             ...
             <asp:View ID="vfinancial" runat="server">--%>
            <!---------------------------------------- Financial Block -------------------------------------------------------->
            ...
            <div class="row" id="FinancialTypes" runat="server" visible="false">
                <table>
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:DropDownList ID="Financial_Types" runat="server" class="form-control" AutoPostBack="true" Width="350px" Font-Size="15px" OnSelectedIndexChanged="Financial_Types_SelectedIndexChanged"></asp:DropDownList></td>
                    </tr>
                </table>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="padding-left: 25px;">
                                    <asp:TextBox ID="txtFinancialOthers" runat="server" oninput="validateInputName(this)" Width="350px" class="form-control" />
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <asp:View ID="vTechncal" runat="server">--%>


            <%--   </asp:View>

            <asp:View ID="vLand" runat="server">--%>
            <!---------------------------------------- Land Block -------------------------------------------------------->
            <div class="row" style="padding-left: 65px">
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td style="padding-left: 30px">
                                    <asp:TextBox ID="TextBox1" runat="server" oninput="validateInputText(this)" class="form-control" Width="350px" /></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <asp:View ID="vothers" runat="server">--%>
            <!---------------------------------------- Others Block -------------------------------------------------------->
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding-left: 85px">
                            <asp:TextBox ID="TextBox2" runat="server" oninput="validateInputText(this)" class="form-control" Width="350px" /></td>
                    </tr>
                </table>
                <%--</div>--%>
            </div>
            ...
            <div class="row" id="Grievance_Resolution" runat="server" visible="false" style="padding-top: 10px">
                <table>
                    <tr>
                        ...
                        <td style="padding-left: 50px;">
                            <asp:TextBox ID="TextBox3" runat="server" oninput="validateInputText(this)" class="form-control" Width="350px" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="row" id="divWandH" runat="server" visible="true" style="padding-top: 10px">
                <table>
                    ...
                    <tr id="trHealthclinic" runat="server" visible="false">
                        <td style="padding-left: 40px; font-size: 15px; padding-top: 10px">
