<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmApproveDetailsbyqueryOtherService.aspx.cs" Inherits="UI_TSiPASS_frmApproveDetailsbyqueryOtherService" %>
...
<ContentTemplate>--%>
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            ...
                            <tr>
                                <td colspan="2" align="center" style="padding: 5px; margin: 5px; text-align: center;">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/frmDepartmentsApprovalProcessOtherServices.aspx">Back</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
