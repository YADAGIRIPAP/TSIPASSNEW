...
public partial class UI_TSiPASS_ccavResponseHandlerRegDrillingRigsBorewells : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (msg != null)
        {
            ...
            if (paymentresponseVOsobj.AdditionalInfo4_19 == "NODEPT")
            {
                ...
                {
                    dspaydtls = GetEnterprinerpaymentDtlsDrillingrigs(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, paymentresponseVOsobj.AdditionalInfo5_20);
                ...
                {
                    dspaydtls = GetEnterprinerpaymentDtlsDrillingrigs(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, "");
            ...
            {
                int valid = InsertUpdatepaymentdtls_DrillingRigs(paymentresponseVOsobj, paymendepartwisetresponseVOsobj);
                try
                {
                    GetTESTVALUESDrillingRigs(BilldeskResponse);
                }
                catch (Exception ex)
                {
                ...
                if (valid == 1)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alertMsg", "alert('Payment Done Successfully');" + "window.location='IpassPrintReceiptDrillingRigsBorewells.aspx';", true);
                }
            }
            else
            {
    ...
    public void GetTESTVALUES(string Responce)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE", con.GetConnection);//_DrillingRigs
    ...
    public void GetTESTVALUESDrillingRigs(string Responce)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE_DrillingRigs1", con.GetConnection);
            da.SelectCommand.Parameters.Add("@responce", SqlDbType.VarChar).Value = Responce.ToString();
            da.SelectCommand.Parameters.Add("@Online", SqlDbType.VarChar).Value = "Online";
    ...
    public int InsertUpdatepaymentdtls_DrillingRigs(paymentresponseVOs paymentresponseVOsobj, List<paymendepartwisetresponseVOs> paymendepartwisetresponseVOsobj)
    {
        ...
        SqlCommand command = new SqlCommand("USP_UPDATE_Builldesc_PaymentDtls_DrillingRigs", connection);
        ...
        try
        {
            ...
            if (valid == 1)
            {
                ...
                {
                    command1 = new SqlCommand("USP_UPDATE_DEPTWISE_Builldesc_PaymentDtls_DrillingRigs", connection);
    ...
    public DataSet GetEnterprinerpaymentDtlsDrillingrigs(string UID, string Orderno, string AdditionalPaymentflg)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_Builldesc_PaymentDtls_DESE_Drillingrigs", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
