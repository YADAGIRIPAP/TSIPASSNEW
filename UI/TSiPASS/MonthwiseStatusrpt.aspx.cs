...
public partial class UI_TSiPASS_MonthwiseStatusrpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ddlFinancialYear.SelectedValue = "2018";
            fillgrid();
        }
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchMonthwisestatusrpt(ddlFinancialYear.SelectedValue);
        // lblMsg.Text = "";
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            int NumberTotal1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "NOOFAPPLICATIONSDURING"));
            NumberTotal = NumberTotal1 + NumberTotal;

            int NumberTotal2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "NOOFAPPLICATIONSUPTO"));
            NumberTotalUpto = NumberTotal2 + NumberTotalUpto;

            int Aproved1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "APROVALAAREGIVENDURING"));
            Aproved = Aproved + Aproved1;

            int Aproved2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "APROVALAAREGIVENUPTO"));
            AprovedUpto = Aproved2 + AprovedUpto;

            int pending1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "NoofApplicationsPending"));
            pending = pending + pending1;

            int Yet_to_Start1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Yet_to_Start"));
            Yet_to_Start = Yet_to_Start1 + Yet_to_Start;

            int Initial_Stage1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Initial_Stage"));
            Initial_Stage = Initial_Stage + Initial_Stage1;
            int Advanced_Stage1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Advanced_Stage"));
            Advanced_Stage = Advanced_Stage + Advanced_Stage1;
            int Commenced_Operations1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Commenced_Operations"));
            Commenced_Operations = Commenced_Operations + Commenced_Operations1;

            int RejectedTotal1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "RejectedApplications"));
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=A&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=B&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=C&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=D&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=E&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=F&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=G&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h8 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=H&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h9 = (HyperLink)e.Row.Cells[10].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=I&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
            HyperLink h10 = (HyperLink)e.Row.Cells[11].Controls[0];
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "MonthwiseStatusrptDrill.aspx?status=J&month=" + lblmonth.Text.Trim() + "&year=" + lblyear.Text.Trim();
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            //e.Row.Cells[3].Text = grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[3].Text;
            //e.Row.Cells[5].Text = grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[5].Text;
            //e.Row.Cells[4].Text = Aproved.ToString();
            //e.Row.Cells[7].Text = grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[7].Text;
            //e.Row.Cells[8].Text = Yet_to_Start.ToString();
            //e.Row.Cells[9].Text = Initial_Stage.ToString();
            //e.Row.Cells[10].Text = Advanced_Stage.ToString();
            //e.Row.Cells[11].Text = Commenced_Operations.ToString();
            e.Row.Cells[1].Text = "Total";
            e.Row.Cells[2].Text = NumberTotal.ToString();
            HyperLink h3 = (HyperLink)grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[3].Controls[0];
            e.Row.Cells[3].Text = h3.Text;
            HyperLink h5 = (HyperLink)grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[5].Controls[0];
            e.Row.Cells[5].Text = h5.Text;
            HyperLink h6 = (HyperLink)grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[6].Controls[0];
            e.Row.Cells[6].Text = h6.Text;
            //  e.Row.Cells[3].Text = NumberTotalUpto.ToString();
            e.Row.Cells[4].Text = Aproved.ToString();
            //  e.Row.Cells[5].Text = AprovedUpto.ToString();
            // e.Row.Cells[6].Text = pending.ToString();
            // e.Row.Cells[7].Text = RejectedTotal.ToString();
            // e.Row.Cells[7].Text = e.row
            HyperLink h7 = (HyperLink)grdDetails.Rows[grdDetails.Rows.Count - 1].Cells[7].Controls[0];
            e.Row.Cells[7].Text = h7.Text;
            e.Row.Cells[8].Text = Yet_to_Start.ToString();
            e.Row.Cells[9].Text = Initial_Stage.ToString();
            e.Row.Cells[10].Text = Advanced_Stage.ToString();
            e.Row.Cells[11].Text = Commenced_Operations.ToString();
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            string tcMergePackage = "Report for the Year of " + ddlFinancialYear.SelectedItem.Text;
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
