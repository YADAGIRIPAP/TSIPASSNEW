<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InscentiveView_AttachmentsNewIncType.aspx.cs" Inherits="InscentiveView_AttachmentsNewIncType"  Title="Incentive View Attachments" %>
        ...
        <table style="padding-left: 25px; width: 600px;">
                            ...
                            <td>
                                <table border="1" align="center" cellpadding="1" cellspacing="2" style="border-color: Black;
                                    ...
                                    <tr>
                                        <td align="center">
                                            <br />
                                            <img src="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/UI/TSiPASS/telanganalogo.png" height="60px" width="60px" alt="TSiPASS" />
                                            <br />
                                            <div>
                                        ...
                                        <td valign="top" width="100%">
                                            <table align="left" border="1" style="width: 100%; border-right: #000000 thin solid;
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="width:20%" class="tdStyle" >
                                                    ...
                                                    <td class="tdStyle" align="left">
                                                       <asp:Label ID="lblDateofAppln" runat="server"></asp:Label> </td>
                                                       <td></td><td></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" visible="false" style="width: 120px; text-align: left;" class="tdStyle">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdStyle" style="width:20%" align="left">
                                                    ...
                                                    <td class="auto-style1" align="right" style="text-align: left;">
                                                         Land Value: (In Rs Expansion):
                                                    </td>
                                                    <td class="tdStyle" align="left">
                                                        <asp:Label ID="lbllandvalue_Expansion" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="tdStyle" align="right" style="width: 120px; text-align: left;">
                                                    ...
                                                    <td class="auto-style1" align="right" style="text-align: left;">
                                                        Building Value (In Rs Expansion):
                                                    </td>
                                                    <td class="tdStyle" align="left">
                                                        <asp:Label ID="lblbuildingvalue_expansion" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="tdStyle" align="right" style="width: 120px; text-align: left;">
                                                    ...
                                                    <td class="tdStyle" align="right" style="width: 120px; text-align: left;">
                                                        Plant &amp; Machinery (In Rs) :
                                                    </td>
                                                    <td class="tdStyle" align="left">
                                                        <asp:Label ID="lblPlantValue" runat="server" Font-Bold="False"></asp:Label>
                                                    </td>
                                                     <td class="auto-style1" align="right" style="text-align: left;">
                                                        Plant &amp; Machinery (In Rs Expansion) :
                                                    </td>
                                                    <td class="tdStyle" align="left">
                                                        <asp:Label ID="lblplantandmachinaryvalue_expansion" runat="server" Font-Bold="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="tdStyle" align="right" style="width: 120px; text-align: left;">
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            <asp:GridView ID="gvIncetiveTypes" runat="server" AutoGenerateColumns="False" Width="100%" ShowHeader="true" HeaderStyle-HorizontalAlign="Left"  OnRowDataBound="gvIncetiveTypes_RowDataBound" >
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Incentives" ItemStyle-HorizontalAlign="left" >
                                                        <ItemTemplate>
                                                            <asp:Label Width="100%" ID="lblIncentiveName" runat="server" Text='<%# Eval("IncentiveName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                       
                                                    </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="FirstHalf/SecondHalf" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center" >
                                                        <ItemTemplate>
                                                            <asp:Label Width="100%" ID="lblfirstSecHf" runat="server" Text='<%# Eval("FstHf2ndHf") %>'></asp:Label>
                                                        </ItemTemplate>
                                                       
                                                    </asp:TemplateField>
                                                     <asp:BoundField ItemStyle-Width="16%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" DataField="fromDate" HeaderText="From Date" />
                                                    <asp:BoundField ItemStyle-Width="16%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" DataField="toDate" HeaderText="To Date" />
                                                </Columns>
                                            </asp:GridView>
            ...
            <tr>
                <td align="left" class="tdStyle">
                    <strong>Note:- Print this acknowledgement for further reference.</strong>
                </td>
            </tr>
            <tr id="autorejectedTR" visible="false" runat="server">
                <td align="left" class="tdStyle">
                    <strong>Note:- THIS CLAIM IS AUTO REJECTED AS THE QUERY RAISED IS NOT RESPONDED WITHIN 45 DAYS.</strong>
                </td>
            </tr>
        </table>
    </div>
