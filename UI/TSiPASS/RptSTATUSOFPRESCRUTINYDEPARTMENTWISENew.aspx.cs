...
{
    decimal NumberofApprovalsappliedfor1,Completed1within, Completed1Beyond, Completed1, Pendinglessthan3days1, Pendingmorthan3days1, QueryRaised1, Numberofpaymentreceivedfor1,
        completedwithin1, comletedbeyond1;
    #region Declaration
    ...
    public void FillGridDetails()
    {
       ...
       // Label1.Text = "Report from " + txtFromDate.Text.Trim() + " To " + txtTodate.Text.Trim();
        ...
        ds = Gen.sp_DepartmentWiseReportNew(ddlCategory.SelectedItem.ToString().Trim(), ddldistrict.SelectedValue, FromdateforDB, TodateforDB);
        if (ds.Tables[0].Rows.Count > 0)
        {
            grdDetails.DataSource = ds.Tables[0];
            grdDetails.DataBind();
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            decimal Completedwithin = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Completed Within"));
            Completed1within = Completedwithin + Completed1within;

            decimal CompletedBeyond = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Completed Beyond"));
            Completed1Beyond = CompletedBeyond + Completed1Beyond;
            ...
            decimal completedwithin = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Completed Within"));
            completedwithin1 = completedwithin + completedwithin1;

            decimal comletedbeyond = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Completed Beyond"));
            comletedbeyond1 = comletedbeyond + comletedbeyond1;
            ...
            h1.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=A&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[4].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h2.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=B&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();
            ...
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=C&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();

            HyperLink h3a = (HyperLink)e.Row.Cells[6].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3a.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=D&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();


            HyperLink h3b = (HyperLink)e.Row.Cells[7].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3b.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=E&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();

            HyperLink h3bc = (HyperLink)e.Row.Cells[8].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3bc.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=F&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();

            HyperLink h3bd = (HyperLink)e.Row.Cells[9].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3bd.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=G&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();

            HyperLink h3be = (HyperLink)e.Row.Cells[10].Controls[0];
            //HiddenField HdfintApplicationid = (HiddenField)e.Row.Cells[0].FindControl("HdfintApplicationid");
            //HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intHousingID")).Trim();
            //h1.NavigateUrl = "BatchwisetrngMFrpt.aspx?trngids=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intTrngID")).Trim() + "&trngnames=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "trngName")).Trim() + "&intprjid=1025" + "&totsum=0";
            h3be.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=H&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intDeptid")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=A&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            ...
            TotalComp.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=B&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalComp.Text = Completed1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[4].Text = Completed1.ToString();
            e.Row.Cells[4].Controls.Add(TotalComp);

            HyperLink TotalQuery = new HyperLink();
            TotalQuery.ForeColor = System.Drawing.Color.White;
            TotalQuery.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=C&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalQuery.Text = QueryRaised1.ToString();
            e.Row.Cells[5].Text = QueryRaised1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[5].Controls.Add(TotalQuery);

            HyperLink Totalless3days = new HyperLink();
            Totalless3days.ForeColor = System.Drawing.Color.White;
            Totalless3days.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=D&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            Totalless3days.Text = Pendinglessthan3days1.ToString();
            e.Row.Cells[6].Text = Pendinglessthan3days1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[6].Controls.Add(Totalless3days);

            HyperLink TotalMore3days = new HyperLink();
            TotalMore3days.ForeColor = System.Drawing.Color.White;
            TotalMore3days.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=E&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalMore3days.Text = Pendingmorthan3days1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[7].Text = Pendingmorthan3days1.ToString();
            e.Row.Cells[7].Controls.Add(TotalMore3days);

            HyperLink TotalPayment = new HyperLink();
            TotalPayment.ForeColor = System.Drawing.Color.White;
            TotalPayment.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=F&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalPayment.Text = Numberofpaymentreceivedfor1.ToString();
            e.Row.Cells[8].Text = Numberofpaymentreceivedfor1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[8].Controls.Add(TotalPayment);

            HyperLink TotalWithin = new HyperLink();
            TotalWithin.ForeColor = System.Drawing.Color.White;
            TotalWithin.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=G&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalWithin.Text = completedwithin1.ToString();
            e.Row.Cells[9].Text = completedwithin1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[9].Controls.Add(TotalWithin);

            HyperLink TotalBeyond = new HyperLink();
            TotalBeyond.ForeColor = System.Drawing.Color.White;
            TotalBeyond.NavigateUrl = "frmstatusDepartmentNextNew.aspx?status=H&intDeptid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim() + "&ApprovalId=%";
            TotalBeyond.Text = comletedbeyond1.ToString();
            e.Row.Cells[10].Text = comletedbeyond1.ToString();
            //e.Row.Cells[2].Controls.RemoveAt(0);
            e.Row.Cells[10].Controls.Add(TotalBeyond);
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage.Text = "Scrutiny Status (Approvals)";
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R2.1 STATUS OF PRESCRUTINY - DEPARTMENT WISE \n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            phrase = new Phrase();
            cellTextnew = "Prescrutiny Status (Approvals)";
            phrase.Add(new Chunk(cellTextnew, FontFactory.GetFont("Trebuchet MS", 11, Font.NORMAL, Color.WHITE)));
            cell = PhraseCell(phrase, PdfPCell.ALIGN_MIDDLE);
            cell.VerticalAlignment = PdfCell.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
