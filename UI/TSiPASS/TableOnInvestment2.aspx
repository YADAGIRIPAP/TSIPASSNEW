<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="TableOnInvestment2.aspx.cs" Inherits="LookupCA"
            ...
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">R6.5 Investment wise Abstract<a id="Button2" href="#" onclick="javascript:return Panel1();"
                            runat="server">
                                ...
                                <td colspan="2" align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black" FooterStyle-CssClass="text-center" DataTextField="Invst in Cr per Employee"
