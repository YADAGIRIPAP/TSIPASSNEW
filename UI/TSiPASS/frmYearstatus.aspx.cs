...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename= R1.3 Application Received " + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
        ...
        try
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename= R1.3 Application Received" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
