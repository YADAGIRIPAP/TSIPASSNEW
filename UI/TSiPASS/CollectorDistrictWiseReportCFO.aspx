<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="~/UI/TSiPASS/CollectorDistrictWiseReportCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">COLLECTOR'S DASH BOARD</h3>
                            </div>
                                ...
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                    ...
                                    <tr>
                                        <td align="center" class="style8" 
                                            ...
                                            <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK" Width="250px">TS-iPASS APPROVALS
                                            Report</asp:Label>
                                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" 
                                                ...
                                                ShowFooter="True" Width="100%" onrowcreated="grdDetails_RowCreated">
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:HyperLinkField DataTextField="District Level Rejected" 
                                                        HeaderText="District Level" />
