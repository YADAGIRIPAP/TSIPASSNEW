<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UserFormView_plotallotment.aspx.cs" Inherits="UI_TSiPASS_UserFormView_plotallotment" %>
    ...
    <div class="row">
     ...
     <div style="background-color:lightblue">
                   ...
                   <table class="table">
                                ...
                                <tr>
                                    <td ><img style="text-align:left" width="50px" height="50px" src="../../Masterfiles/images/tsiiclogo.png" /></td>
                                ...
                                (A GOVT OF TELANGANA STATE UNDERTAKING) </td>
                                    ...
                                    <td> <img style="text-align:right"  width="50px" height="50px" src="../../Masterfiles/images/tsipasslogo.png" /> </td>
                                </tr>
...
Measurement	" />
                                     ...
                                     <tr>
                                     <td colspan="3">                                   <asp:TextBox ID="txtprovidedetails" Enabled="false" runat="server" class="form-control txtbox" Height="150px" TabIndex="1" TextMode="MultiLine" Width="250px"></asp:TextBox></td>
                                   </tr>
                                     <tr>
	<td colspan="3">  Do you have any technical collaboration?</td>

                                     <td> <asp:RadioButtonList ID="rdIaLa_Lst" runat="server"  Enabled="false" RepeatDirection="Horizontal">
	...
	<tr>
		<td colspan="3">                                   <asp:TextBox ID="TextBox2" runat="server" class="form-control txtbox" Enabled="false" Height="150px" TabIndex="1" TextMode="MultiLine" Width="250px"></asp:TextBox></td>
	</tr>
...
<td align="left" colspan="8" style="padding: 10px; margin: 5px; font-weight: bold; border-radius:1px;">
                                        ...
                                        <td style="text-align: left; padding: 5px; margin: 5px">
                                          ...
                                          <asp:TextBox runat="server" Enabled="false" ID="txtvessel"></asp:TextBox>
                                ...
                                <%--          <td style="padding: 10px; margin: 5px; font-weight: bold; width: 10px"></td>
                                     ...
                                     <tr>
                                       ...
                                       <td style="padding: 10px; margin: 5px; font-weight: bold; width: 10px"></td>
                                         ...
                                         <td style="padding: 5px; margin: 5px; width: 1px">:</td>
                                         <td style="padding: 5px; margin: 5px">
                                            <asp:TextBox ID="txtdesceff" runat="server" class="form-control txtbox" Enabled="false" Height="150px" TabIndex="1" TextMode="MultiLine" Width="250px"></asp:TextBox>
                                         </td>
                                    </tr>
