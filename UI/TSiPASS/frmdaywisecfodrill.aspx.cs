...
public partial class UI_TSiPASS_frmdaywisecfodrill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //lblHeading.Text = "CFO Applications for Dated " + txtFromDate.Text.Trim();
        if (!IsPostBack)
        {
    ...
    public DataSet GetDayWiseStatusDRILL(string DISTRICTID, string AppnId, string status)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_DAYWISE_CFO_COI", osqlConnection);
