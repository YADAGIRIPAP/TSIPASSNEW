<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBatdealDepartmentsViewAppl.aspx.cs" Inherits="UI_TSiPASS_frmBatdealDepartmentsViewAppl" %>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Name of the Battery Dealer" DataField="nameofunit" />
                                                            ...
                                                            <asp:HyperLinkField HeaderText="Battery Dealer" Text="View" />
