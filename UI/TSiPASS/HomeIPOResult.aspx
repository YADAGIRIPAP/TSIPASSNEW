<%@ Page Language="C#" MasterPageFile="CCMaster.master" AutoEventWireup="true" CodeFile="HomeIPOResult.aspx.cs" Inherits="Default3" Title=":: TS-iPass Govenrnment of Telengana :: Home" %>
        ...
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px; text-align: center;" 
                valign="top" align="center">
                    ...
                    CssClass="LBLBLACK" Width="205px">Target Registered Successfully</asp:Label>
                                                    <br />
                <br />
                                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Small" 
                                                
                    NavigateUrl="~/UI/TSiPASS/IpowiseTargetmaster1lat.aspx">Click here</asp:HyperLink>
       </td>
        </tr>
    </table>
</asp:Content>
