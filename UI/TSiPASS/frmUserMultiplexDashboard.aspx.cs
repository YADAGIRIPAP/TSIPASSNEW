...
public partial class UI_TSiPASS_frmUserMultiplexDashboard : System.Web.UI.Page
{
    string Qnreid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("M_GetShow_MultiplexQuestionaries_ques", osqlConnection);
    ...
    public DataSet GetEnterpreneourDashboardDetails_Advertisment(string intEntid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("M_GetEnterpreneourDashboardDetails_Multiplex", osqlConnection);
