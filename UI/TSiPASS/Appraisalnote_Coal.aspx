<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Appraisalnote_Coal.aspx.cs" Inherits="UI_TSiPASS_Appraisalnote_Coal" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style48"> &nbsp;&nbsp;Coal Quantity</td>
                    <td class="auto-style48">&nbsp;</td>
                    <td class="auto-style48">

                        <asp:TextBox ID="txtcoalquantity" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" MaxLength="80"  TabIndex="34" Width="150px" AutoPostBack="true" OnTextChanged="txtcoalquantity_TextChanged"></asp:TextBox>
