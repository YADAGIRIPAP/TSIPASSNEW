   ...
   public void fillgrid()
    {
        ...
        if (valid == 0)
        {
            ...
            ds = Gen.RptAPPROVALSBYDEPARTMENTWISENew(ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, FromdateforDB , TodateforDB);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
         ...
         if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=A&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=B&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=C&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h3a.Text != "0")
            {
                h3a.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=D&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h3ab.Text != "0")
            {
                h3ab.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=E&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h3ac.Text != "0")
            {
                h3ac.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=F&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
            ...
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=G&intApprovalid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "ApprovalId")).Trim() + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Dept_Id")).Trim() + "&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=A&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            Totalpayment.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=G&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            TotalComp.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=B&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            TotalQuery.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=C&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            TotalReject.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=D&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            Totalmorthan3days.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=E&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
            ...
            TotalBeyond3days.NavigateUrl = "frmstatusDepartmentApprovalNextNew.aspx?status=F&intApprovalid=%" + "&Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&intDeptid=%&fromdt=" + txtFromDate.Text + "&todt=" + txtTodate.Text;
