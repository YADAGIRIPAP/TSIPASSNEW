<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    CodeFile="frmDepartmentDashboardADMG.aspx.cs" Inherits="UI_TSiPASS_frmDepartmentDashboardADMG" %>
                                                    ...
                                                    <table cellpadding="3" cellspacing="5" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td style="width: 468px; font-size: 16px;">
                                                                <b>Consent for ADM&G APPLICATIONS</b>
                                                            </td>
                                                            <td style="width: 30px">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 468px" valign="top">
                                                                <div class="list-group">
                                                                    <a href="frmADMGViewAppl.aspx?Stg=4" class="list-group-item"><span class="badge">
                                                                        <asp:Label ID="lblTotAppl" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar">
                                                                        </i>No of Total Applications&nbsp; </a></a> <a class="list-group-item" href="frmADMGViewAppl.aspx?Stg=12">
                                                                    ...
                                                                    <a class="list-group-item" href="frmADMGViewAppl.aspx?Stg=13"><span class="badge">
                                                                        ...
                                                                        href="frmADMGViewAppl.aspx?Stg=16"><span class="badge" style="background-color: #d9534f;">
