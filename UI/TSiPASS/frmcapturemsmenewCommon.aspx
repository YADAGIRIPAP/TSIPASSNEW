<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmcapturemsmenewCommon.aspx.cs" Inherits="UI_TSiPASS_frmcapturemsmenewCommon" %>
                            ...
                            <div class="row">
                                <div class="col-sm-4 form-group" align="left">
                                    ...
                                    <asp:DropDownList ID="ddldistrict" runat="server" AutoPostBack="True" class="form-control txtbox"
                                        Height="33px" TabIndex="1" Width="180px" OnSelectedIndexChanged="ddldistrict_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group" align="left">
                                    ...
                                    <asp:DropDownList ID="ddlSector" runat="server" class="form-control txtbox" Height="33px"
                                        Width="230px" OnSelectedIndexChanged="ddlSector_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                    </asp:DropDownList>
