...
public partial class UI_TSIPASS_ReleaseProceedingsabstractDistrictwiseDLCDrill : System.Web.UI.Page
{
    int delete = 0;
    ...
    public DataSet GetAbstractdrill(string Distid, string ProcdNo, string Status)
    {
        ...
        pp[1].Value = ProcdNo;
        pp[2].Value = Status;
        Dsnew = Gen.GenericFillDs("USP_GET_Release_Proceedings_abstract_District_wise_DIPC_Drill", pp);
        return Dsnew;
    }
