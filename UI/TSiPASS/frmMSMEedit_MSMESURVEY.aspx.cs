...
public partial class UI_TSiPASS_frmMSMEedit_MSMESURVEY : System.Web.UI.Page
{
    ...
    public void FillDetails(string MSMENO)
    {
        ...
        DataSet dsemp = GetMSMEDetailsbyMSMEID(MSMENO);
        ...
        if (dsemp.Tables[0].Rows.Count > 0)
        {
            try
            {
                ...
                if (dsemp.Tables[0].Rows[0]["CATEGOERY_ID"].ToString() != "0" || dsemp.Tables[0].Rows[0]["CATEGOERY_ID"].ToString() != null)
                    rdUnitRegistered.SelectedValue = "1";
                rdUnitRegistered_SelectedIndexChanged(null, EventArgs.Empty);
                ddlRegstrType.SelectedValue = dsemp.Tables[0].Rows[0]["CATEGOERY_ID"].ToString();
                ...
                //ddldistrict_SelectedIndexChanged(this, null);
                loadmandals();
                ddlMandal.SelectedValue = dsemp.Tables[0].Rows[0]["MANDAL_ID"].ToString();
                ddlMandal.Enabled = false;
                load_village();
                ddl_village.SelectedValue = dsemp.Tables[0].Rows[0]["village_id"].ToString();
                ddl_village_SelectedIndexChanged(null, EventArgs.Empty);
                BindIndustrialParks();
                ...
                txt_laltuide.Text = Convert.ToString(dsemp.Tables[0].Rows[0]["latitude"]);
                txt_longitude.Text = Convert.ToString(dsemp.Tables[0].Rows[0]["longitude"]);
                ...
                txt_houseno.Text = dsemp.Tables[0].Rows[0]["address_hou_no"].ToString();
                txt_Locality.Text = dsemp.Tables[0].Rows[0]["address_location"].ToString();
                txt_street.Text = dsemp.Tables[0].Rows[0]["address_street_name"].ToString();
                txt_landmark.Text = dsemp.Tables[0].Rows[0]["address_landmark"].ToString();
                ...
                if (!string.IsNullOrEmpty(dsemp.Tables[0].Rows[0]["PresentStatus"].ToString()))
                {
                    ...
                    if (!string.IsNullOrEmpty(dsemp.Tables[0].Rows[0]["ClosedMainReason"].ToString()))
                    {
                        ddlCloseReason.SelectedValue = dsemp.Tables[0].Rows[0]["ClosedMainReason"].ToString();
                    }
                }
                else
                {
                ...
                rdownergeneration.SelectedValue = dsemp.Tables[0].Rows[0]["msme_owner_generation_id"].ToString();
                ...
                rdscheme.SelectedValue = dsemp.Tables[0].Rows[0]["loan_scheme_id"].ToString();
                rdscheme_SelectedIndexChanged(null, EventArgs.Empty);
                txtotherscheme.Text = dsemp.Tables[0].Rows[0]["loan_other_scheme"].ToString();
                rdloan.SelectedValue = dsemp.Tables[0].Rows[0]["loan_status_id"].ToString().Trim();
                rblFinBank.SelectedValue = dsemp.Tables[0].Rows[0]["financing_institution"].ToString();
                txtCapitalInvestment.Text = dsemp.Tables[0].Rows[0]["capital"].ToString();
                txtTurnover.Text = dsemp.Tables[0].Rows[0]["turnover"].ToString();
                rblProftloss.SelectedValue = dsemp.Tables[0].Rows[0]["profit_loss_id"].ToString();
                if (rblProftloss.SelectedIndex != -1)
                {
                    rblProftloss_SelectedIndexChanged(null, EventArgs.Empty);
                    if (rblProftloss.SelectedValue == "Profit")
                    {
                        txtProfit.Text = dsemp.Tables[0].Rows[0]["profit_loss_number"].ToString();
                    }
                    else if (rblProftloss.SelectedValue == "Loss")
                    {
                        txtLoss.Text = dsemp.Tables[0].Rows[0]["profit_loss_number"].ToString();
                    }
                }
                ...
                ddlCaste.SelectedValue = dsemp.Tables[0].Rows[0]["STATUS"].ToString();
                ...
                //txtCorrAddress.Text = dsemp.Tables[0].Rows[0]["CorrsAddress"].ToString();
                txt_Corhouseno.Text = dsemp.Tables[0].Rows[0]["cor_addr_hou_no"].ToString();
                txt_Corstreet.Text = dsemp.Tables[0].Rows[0]["cor_addr_street_name"].ToString();
                txt_CorLocality.Text = dsemp.Tables[0].Rows[0]["cor_addr_location"].ToString();
                txt_CorLandmark.Text = dsemp.Tables[0].Rows[0]["cor_addr_landmark"].ToString();
                ...
                ddlSector.Enabled = false; ddlintLineofActivity.Enabled = false; ddlCategorybyZone.Enabled = false;
    ...
    public DataSet GetMSMEDetailsbyMSMEID(string MsmeNo)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SP_GETMSMESURVEYDETAILS_MSMESURVEY", con.GetConnection);
    ...
    public void GetProductManfacturedetails()
    {
        try
        {
            DataTable Dt = getProductMANFDETAILSbyMSMEID(Request.QueryString[0].ToString().Trim());
    ...
    public void getRAWRecords()
    {
        try
        {
            DataTable dt = getRAWDETAILSbyMSMEID(Request.QueryString[0].ToString().Trim());
    ...
    public DataTable getProductMANFDETAILSbyMSMEID(string MsmeNo)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SP_GETMSMESURVEYDETAILS_MANFDETAILS", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            if (MsmeNo.Trim() == "" || MsmeNo.Trim() == null)
                da.SelectCommand.Parameters.Add("@MsmeNo", SqlDbType.VarChar).Value = "%";
            else
    ...
    public DataTable getRAWDETAILSbyMSMEID(string MsmeNo)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SP_GETMSMESURVEYDETAILS_RAWMATERIALDETAILS", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            if (MsmeNo.Trim() == "" || MsmeNo.Trim() == null)
                da.SelectCommand.Parameters.Add("@MsmeNo", SqlDbType.VarChar).Value = "%";
            else
    ...
    protected void ddlstatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlstatus.SelectedItem.Text == "Other")
        {
            ...
            divddlclosed.Visible = false;
            divtextclosed.Visible = false;
        }
        else if (ddlstatus.SelectedItem.Text == "Closed")
        {
            otherstatus.Visible = false;
            divddlclosed.Visible = true;
            divtextclosed.Visible = true;
        }
        else
        {
            otherstatus.Visible = false;
    ...
    public string ValidateLandControlsSumbit()
    {
        int slno = 1;
        string ErrorMsg = "";
        if (rblisDuplicate.SelectedValue != "Duplicate" || rblisDuplicate.SelectedValue != "Not Existing")// || rblisDuplicate.SelectedValue != "Not Applicable"
        {
            ...
            if (rdUnitRegistered.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select Unit is Registered or not \\n";
                slno = slno + 1;
            }
            if (rdUnitRegistered.SelectedValue == "1")
            {
                if (ddlRegstrType.SelectedItem.Text == "--Select--" || ddlRegstrType.SelectedIndex <= 0)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Select Type of Registration  \\n";
                    slno = slno + 1;
                }
                if (string.IsNullOrEmpty(txtUAMID.Text) || txtUAMID.Text == "" || txtUAMID.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter UAM ID Details \\n";
                    slno = slno + 1;
                }
            }
            if (rdunitIEORNOT.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select Whether the unit is in Industrial estate or Park/Not  \\n";
                slno = slno + 1;
            }
            if (rdunitIEORNOT.SelectedValue == "1")
            {
                ...
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Select Name of the Industrial Park  \\n";
                    slno = slno + 1;
                }
            }
            ...
            if (string.IsNullOrEmpty(txt_longitude.Text) || txt_longitude.Text == "" || txt_longitude.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter langitude \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txt_laltuide.Text) || txt_laltuide.Text == "" || txt_laltuide.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter laltuide \\n";
                slno = slno + 1;
            }



            if (string.IsNullOrEmpty(txt_houseno.Text) || txt_houseno.Text == "" || txt_houseno.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter House No \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txt_Locality.Text) || txt_Locality.Text == "" || txt_Locality.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Locality \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txt_street.Text) || txt_street.Text == "" || txt_street.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Street \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txt_landmark.Text) || txt_landmark.Text == "" || txt_landmark.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Land Mark \\n";
                slno = slno + 1;
            }

            if (string.IsNullOrEmpty(txtinvestment.Text) || txtinvestment.Text == "" || txtinvestment.Text == null)
            {
            ...
            if (ddlstatus.SelectedItem.Text == "Other")
            {
                if (string.IsNullOrEmpty(txtOtherStatus.Text) || txtOtherStatus.Text == "" || txtOtherStatus.Text == null)
                {
            ...
            {
                if (string.IsNullOrEmpty(txtCloseReason.Text) || txtCloseReason.Text == "" || txtCloseReason.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Reason for Closing  \\n";
                    slno = slno + 1;
                }
                if (ddlCloseReason.SelectedItem.Text == "--Select--" || ddlCloseReason.SelectedIndex <= 0)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Select Reason for Closing from the list \\n";
                    slno = slno + 1;
                }
            }
            ...
            if (string.IsNullOrEmpty(txtDateOfCommencement.Text) || txtDateOfCommencement.Text == "" || txtDateOfCommencement.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Date Of Commencement of Production\\n";
                slno = slno + 1;
            }
            if (RdtypeofConn.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select Type Of Connection   \\n";
                slno = slno + 1;
            }
            if (rdownergeneration.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select MSME Owner Generation  \\n";
                slno = slno + 1;
            }
            if (rdnUnitExport.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select Does Unit Export   \\n";
                slno = slno + 1;
            }
            if (rdnUnitExport.SelectedValue == "Y")
            {
                if (string.IsNullOrEmpty(txtEXPORTCOUNTRY.Text) || txtEXPORTCOUNTRY.Text == "" || txtEXPORTCOUNTRY.Text == null)
                {
            ...
            if (rdscheme.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select wherther Loan is availed under which scheme(such as PMEGP)   \\n";
                slno = slno + 1;
            }
            if (rdscheme.SelectedValue == "PMEGP" || rdscheme.SelectedValue == "Other")
            {
                if (rdscheme.SelectedValue == "Other")
                {
                    if (string.IsNullOrEmpty(txtotherscheme.Text) || txtotherscheme.Text == "" || txtotherscheme.Text == null)
                    {
                        ErrorMsg = ErrorMsg + slno + ". Please Enter Other Scheme Name of Availed Loan  \\n";
                        slno = slno + 1;
                    }
                }
                if (rdloan.SelectedIndex == -1)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Select Loan Status   \\n";
                    slno = slno + 1;
                }

                if (rblFinBank.SelectedIndex == -1)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Select Financing Institute  \\n";
                    slno = slno + 1;
                }
                else if (rblFinBank.SelectedValue == "Bank")
                {
                    if (string.IsNullOrEmpty(txtBankName.Text) || txtBankName.Text == "" || txtBankName.Text == null)
                    {
                        ErrorMsg = ErrorMsg + slno + ". Please Enter Bank Name \\n";
                        slno = slno + 1;
                    }
                }
                else if (rblFinBank.SelectedValue == "NBFC")
                {
                    if (string.IsNullOrEmpty(txtNBFCname.Text) || txtNBFCname.Text == "" || txtNBFCname.Text == null)
                    {
                        ErrorMsg = ErrorMsg + slno + ". Please Enter NBFC Name \\n";
                        slno = slno + 1;
                    }
                }
            }
            ...
            if (rblProftloss.SelectedIndex == -1)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Select Profit or Loss   \\n";
                slno = slno + 1;
            }
            //if (rblProftloss.SelectedValue == "Profit")
            //{
            //    if (string.IsNullOrEmpty(txtProfit.Text) || txtProfit.Text == "" || txtProfit.Text == null)
            //    {
            //        ErrorMsg = ErrorMsg + slno + ". Please Enter Profit Amount \\n";
            //        slno = slno + 1;
            //    }
            //}
            else if (rblProftloss.SelectedValue == "Loss")
            {
                if (string.IsNullOrEmpty(txtLoss.Text) || txtLoss.Text == "" || txtLoss.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Loss Amount \\n";
                    slno = slno + 1;
                }
            }
            if (string.IsNullOrEmpty(txtEmployment.Text) || txtEmployment.Text == "" || txtEmployment.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Employment \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txtunitaddress.Text) || txtunitaddress.Text == "" || txtunitaddress.Text == null)
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Complete Unit Address \\n";
                slno = slno + 1;
            }
            if (string.IsNullOrEmpty(txtNameofEntrepreneur.Text) || txtNameofEntrepreneur.Text == "" || txtNameofEntrepreneur.Text == null)
            {
            ...
            //if (string.IsNullOrEmpty(txtAltMobileNo.Text) || txtAltMobileNo.Text == "" || txtAltMobileNo.Text == null)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Enter Alternate MobileNo Details \\n";
            //    slno = slno + 1;
            //}
            ...
            //if (string.IsNullOrEmpty(txt_Corhouseno.Text) || txt_Corhouseno.Text == "" || txt_Corhouseno.Text == null)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Correspondance Address House No \\n";
            //    slno = slno + 1;
            //}
            //if (string.IsNullOrEmpty(txt_Corstreet.Text) || txt_Corstreet.Text == "" || txt_Corstreet.Text == null)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Correspondance Address Street Name \\n";
            //    slno = slno + 1;
            //}
            //if (string.IsNullOrEmpty(txt_CorLocality.Text) || txt_CorLocality.Text == "" || txt_CorLocality.Text == null)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Correspondance Address Lacality Name \\n";
            //    slno = slno + 1;
            //}
            //if (string.IsNullOrEmpty(txt_CorLandmark.Text) || txt_CorLandmark.Text == "" || txt_CorLandmark.Text == null)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Correspondance Address Landmark Name \\n";
            //    slno = slno + 1;
            //}

            //if (ddl_Cordistrict.SelectedItem.Text == "--Select--" || ddl_Cordistrict.SelectedIndex <= 0)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Select Correspondance Address District \\n";
            //    slno = slno + 1;
            //}

            //if (ddl_CorMandal.SelectedItem.Text == "--Select--" || ddl_CorMandal.SelectedIndex <= 0)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Select Correspondance Address Mandal \\n";
            //    slno = slno + 1;
            //}
            //if (ddl_Corvillage.SelectedItem.Text == "--Select--" || ddl_Corvillage.SelectedIndex <= 0)
            //{
            //    ErrorMsg = ErrorMsg + slno + ". Please Select Correspondance Address Village \\n";
            //    slno = slno + 1;
            //}
            ...
            if (ddlCategory.SelectedValue == "1" || ddlCategory.SelectedValue == "2" || ddlCategory.SelectedValue == "3")
            {
                if (string.IsNullOrEmpty(txtskilledcontract.Text) || txtskilledcontract.Text == "" || txtskilledcontract.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Skilled Contract Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtskilledoutsourcing.Text) || txtskilledoutsourcing.Text == "" || txtskilledoutsourcing.Text == null)
                {
                ...
                if (string.IsNullOrEmpty(txtsemiskilledcontract.Text) || txtsemiskilledcontract.Text == "" || txtsemiskilledcontract.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter  SemiSkilled Contract Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtsemiskilledoutsourcing.Text) || txtsemiskilledoutsourcing.Text == "" || txtsemiskilledoutsourcing.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter SemiSkilled OutSourcing Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtunskilledcontract.Text) || txtunskilledcontract.Text == "" || txtunskilledcontract.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter UnSkilled Contract Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtunskilledoutsourcing.Text) || txtunskilledoutsourcing.Text == "" || txtunskilledoutsourcing.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter UnSkilled OutSourcing Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtmanagerialcontract.Text) || txtmanagerialcontract.Text == "" || txtmanagerialcontract.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Managerial Contract Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtmanagerialoutsourcing.Text) || txtmanagerialoutsourcing.Text == "" || txtmanagerialoutsourcing.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Managerial OutSourcing Employment \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txtmenemp.Text) || txtmenemp.Text == "" || txtmenemp.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Number of Men Employees \\n";
                    slno = slno + 1;
                }
                if (string.IsNullOrEmpty(txtwomen.Text) || txtwomen.Text == "" || txtwomen.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Number of women Employees \\n";
                    slno = slno + 1;
                }
                if (string.IsNullOrEmpty(txt_noofdirectemp.Text) || txt_noofdirectemp.Text == "" || txt_noofdirectemp.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Number of direct Employees \\n";
                    slno = slno + 1;
                }
                if (string.IsNullOrEmpty(txt_totnoofindirectemp.Text) || txt_totnoofindirectemp.Text == "" || txt_totnoofindirectemp.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Number of indirect Employees \\n";
                    slno = slno + 1;
                }
                if (string.IsNullOrEmpty(txt_totemppfesi.Text) || txt_totemppfesi.Text == "" || txt_totemppfesi.Text == null)
                {
                    ErrorMsg = ErrorMsg + slno + ". Please Enter Employees getting PF/ESI \\n";
                    slno = slno + 1;
                }

                if (string.IsNullOrEmpty(txt_totempnopfesi.Text) || txt_totempnopfesi.Text == "" || txt_totempnopfesi.Text == null)
                {
                ...
                if (string.IsNullOrEmpty(txtmigrant.Text) || txtmigrant.Text == "" || txtmigrant.Text == null)
                {
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                OBJMSMEUNITDETAILS.isUnitRegistered = rdUnitRegistered.SelectedValue;
                OBJMSMEUNITDETAILS.CorrAdr_HouseNo = txt_Corhouseno.Text;
                OBJMSMEUNITDETAILS.CorrAdr_StreetName = txt_Corstreet.Text;
                OBJMSMEUNITDETAILS.CorrAdr_Locality = txt_CorLocality.Text;
                OBJMSMEUNITDETAILS.CorrAdr_LandMark = txt_CorLandmark.Text;
                OBJMSMEUNITDETAILS.CorrAdr_DistrictId = ddl_Cordistrict.SelectedValue;
                OBJMSMEUNITDETAILS.CorrAdr_MandalId = ddl_CorMandal.SelectedValue;
                OBJMSMEUNITDETAILS.CorrAdr_VillageId = ddl_Corvillage.SelectedValue;

                OBJMSMEUNITDETAILS.MSMEOwnerGeneration = rdownergeneration.SelectedValue;
                OBJMSMEUNITDETAILS.AvailedLoanScheme = rdscheme.SelectedValue;

                OBJMSMEUNITDETAILS.OtherLoanScheme = txtotherscheme.Text;
                OBJMSMEUNITDETAILS.LoanStatus = rdloan.SelectedValue;
                OBJMSMEUNITDETAILS.LoanBankName = txtBankName.Text;
                OBJMSMEUNITDETAILS.LoanNBFCName = txtNBFCname.Text;
                OBJMSMEUNITDETAILS.CapitalInvestment = txtCapitalInvestment.Text;
                OBJMSMEUNITDETAILS.Turnover = txtTurnover.Text;
                OBJMSMEUNITDETAILS.ProfitorLoss = rblProftloss.SelectedValue;
                OBJMSMEUNITDETAILS.ProfitAmount = txtProfit.Text;
                OBJMSMEUNITDETAILS.LossAmount = txtLoss.Text;
                OBJMSMEUNITDETAILS.EmpWithinDistrict = txtEmpWithinDist.Text;
                OBJMSMEUNITDETAILS.AltMobileNo = txtAltMobileNo.Text;

                OBJMSMEUNITDETAILS.IsDuplorNEorNA = rblisDuplicate.SelectedValue;
                OBJMSMEUNITDETAILS.DuplMaptoMSMEID = ddlDistrictUnits.SelectedValue;
                OBJMSMEUNITDETAILS.DuplMaptoMSMEUnitname = ddlDistrictUnits.SelectedItem.Text;
                OBJMSMEUNITDETAILS.ConfrmDonethrough = ddlNEConfirm.SelectedValue;
                OBJMSMEUNITDETAILS.OtherConfrmation = txtOtherConfrmation.Text;
                OBJMSMEUNITDETAILS.ConfrmDoneby = ddlConfirmBy.SelectedValue;
                OBJMSMEUNITDETAILS.ClosingMainReason = ddlCloseReason.SelectedValue;
                OBJMSMEUNITDETAILS.ClosingSubReason = txtCloseReason.Text;
                //--------------Newly added after Survey----------//
    ...
    public DataSet GetUpdatedUnitsAfterSurvey(string districtid, string mandalid, string villageid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SP_GetUpdatedMSMEUnitsAterSurvey", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            ...
            if (villageid.Trim() == "" || villageid.Trim() == null || villageid.Trim() == "0")
                da.SelectCommand.Parameters.Add("@VILLAGEID", SqlDbType.VarChar).Value = "%";
            else
                da.SelectCommand.Parameters.Add("@VILLAGEID", SqlDbType.VarChar).Value = villageid.ToString();
        ...
        try
        {
            ...
            else
            {
                ...
                if (dsm.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddltsipass.DataBind();
                    AddSelectForTSipass(ddltsipass);
                    //divTSIPASSmap.Visible = true;
                    divrblTsipassmap.Visible = true;
                }
                else
                {
                    ddltsipass.Items.Clear();
                    ...
                    divTSIPASSmap.Visible = false;
                    divrblTsipassmap.Visible = false;
                }

            }
            DataSet ds = new DataSet();
            ds = GetUpdatedUnitsAfterSurvey(ddldistrict.SelectedValue, ddlMandal.SelectedValue, ddl_village.SelectedValue);
            if (ds.Tables[0].Rows.Count > 0)
            {
                ddlDistrictUnits.DataSource = ds.Tables[0];
                ddlDistrictUnits.DataValueField = "MSME_NO";
                ddlDistrictUnits.DataTextField = "UNIT_NAME";
                ddlDistrictUnits.DataBind();
                AddSelectForTSipass(ddlDistrictUnits);
                //divTSIPASSmap.Visible = true;
                // divrblTsipassmap.Visible = true;
            }
        }
    ...
    protected void rdUnitRegistered_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rdUnitRegistered.SelectedValue == "1")
            {
                Registerationo.Visible = true;
                RegisterationType.Visible = true;
            }
            else
            {
                Registerationo.Visible = false;
                RegisterationType.Visible = false;
    ...
    protected void ddl_CorMandal_SelectedIndexChanged(object sender, EventArgs e)
    {
        load_Corvillage();
    }

    protected void ddl_Cordistrict_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddl_Cordistrict.SelectedIndex > 0)
        {
            loadCormandals();
            load_Corvillage();
        }
    ...
    public void loadCormandals()
    {
        try
        {
            if (ddl_Cordistrict.SelectedIndex == 0)
            {
                ddl_CorMandal.Items.Clear();
                AddSelectForMandal(ddl_CorMandal);
            }
            else
            {
                ddl_CorMandal.Items.Clear();
                DataSet dsm = new DataSet();
                dsm = Gen.GetMandals(ddl_Cordistrict.SelectedValue);
                if (dsm.Tables[0].Rows.Count > 0)
                {
                    ddl_CorMandal.DataSource = dsm.Tables[0];
                    ddl_CorMandal.DataValueField = "Mandal_Id";
                    ddl_CorMandal.DataTextField = "Manda_lName";
                    ddl_CorMandal.DataBind();
                    AddSelectForMandal(ddl_CorMandal);
                }
                else
                {
                    ddl_CorMandal.Items.Clear();
                    AddSelect(ddl_CorMandal);
                }
            }
        }
        catch (Exception ex)
    ...
    public void load_Corvillage()
    {
        try
        {
            if (ddl_Cordistrict.SelectedIndex == 0)
            {
                ddl_Corvillage.Items.Clear();
                AddSelectForMandal(ddl_Corvillage);
            }
            else
            {
                ddl_Corvillage.Items.Clear();
                DataSet dsm = new DataSet();
                dsm = Gen.GetVillages(ddl_CorMandal.SelectedValue);
                if (dsm.Tables[0].Rows.Count > 0)
                {
                    ddl_Corvillage.DataSource = dsm.Tables[0];
                    ddl_Corvillage.DataValueField = "Village_Id";
                    ddl_Corvillage.DataTextField = "Village_Name";
                    ddl_Corvillage.DataBind();
                    AddSelectForMandal(ddl_Corvillage);
                }
                else
                {
                    ddl_Corvillage.Items.Clear();
                    AddSelect(ddl_Corvillage);
                }
            }
        }
        catch (Exception ex)
    ...
    protected void rdscheme_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rdscheme.SelectedValue == "Other")
            {
                divotherscheme.Visible = true;
                divPMEGP1.Visible = true;
                divPMEGP2.Visible = true;
            }
            else if (rdscheme.SelectedValue == "PMEGP")
            {
                divotherscheme.Visible = false;
                divPMEGP1.Visible = true;
                divPMEGP2.Visible = true;
            }
            else
            {
                divotherscheme.Visible = false;
                divPMEGP1.Visible = false;
                divPMEGP2.Visible = false;
            }
    ...
    protected void rblFinBank_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblFinBank.SelectedValue == "Bank")
        {
            divBankname.Visible = true;
            divNBFC.Visible = false;
        }
        else if (rblFinBank.SelectedValue == "NBFC")
        {
            divBankname.Visible = false;
            divNBFC.Visible = true;
        }
        else
        {
            divBankname.Visible = false;
    ...
    protected void rblProftloss_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblProftloss.SelectedValue == "Profit")
        {
            divLoss.Visible = false;
            divProfit.Visible = true;
        }
        else if (rblProftloss.SelectedValue == "Loss")
        {
            divLoss.Visible = true;
            divProfit.Visible = false;
        }
    }

    protected void rblTsipassmap_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblTsipassmap.SelectedValue == "Yes")
        {
            divTSIPASSmap.Visible = true;
        }
        else
    ...
    protected void rblisDuplicate_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblisDuplicate.SelectedValue == "Duplicate")
        {
            divduplicate.Visible = true;
            divNEConfirm.Visible = false;
            divNEConfirmBy.Visible = false;
            divOtherConfrmation.Visible = false;
            ddlConfirmBy.ClearSelection();
            ddlNEConfirm_SelectedIndexChanged(sender, e);
        }
        else if (rblisDuplicate.SelectedValue == "Not Existing")
        {
            divduplicate.Visible = false;
            divNEConfirm.Visible = true;
            divNEConfirmBy.Visible = true;

        }
        if (rblisDuplicate.SelectedValue == "Not Applicable")
        {
            divduplicate.Visible = false;
            divNEConfirm.Visible = false;
            divOtherConfrmation.Visible = false;
    ...
    protected void ddlNEConfirm_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlNEConfirm.SelectedValue == "Others")
        {
            divOtherConfrmation.Visible = true;

        }
        else
        {
            divOtherConfrmation.Visible = false;
            txtOtherConfrmation.Text = "";
