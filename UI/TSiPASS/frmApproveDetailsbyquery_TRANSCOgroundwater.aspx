<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmApproveDetailsbyquery_TRANSCOgroundwater.aspx.cs" Inherits="UI_TSiPASS_frmApproveDetailsbyquery_TRANSCOgroundwater" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style4" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlStatus" runat="server" class="form-control txtbox" Height="33px"
                                                    ...
                                                    <asp:ListItem Value="13">Application Recommened to MRO by TRANSCO</asp:ListItem>
                                                    <asp:ListItem Value="16">Application Not Recommened by TRANSCO</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
