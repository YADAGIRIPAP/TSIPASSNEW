<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="UpdateUTRNUMBERDeatailFinalALL.aspx.cs" Inherits="UI_TSiPASS_UpdateUTRNUMBERDeatailFinalALL" %>
                                        ...
                                        <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                                            <div id="Div1" style="width: 100%" runat="server">
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                    ...
                                                    OnRowCreated="grdDetails_RowCreated" Width="100%" CellSpacing="4">
                                                    ...
                                                    <Columns>
                                                      ...
                                                      <%--  <asp:BoundField DataField="RecommendedAmount" ItemStyle-HorizontalAlign="Center"
                                                        ...
                                                        <asp:TemplateField HeaderText="Cheque Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCheckDate" Text='<%#Eval("CheckClearedDate") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="UTRNUMBER" ItemStyle-HorizontalAlign="Center" HeaderText="UTR NUMBER">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                         <asp:BoundField DataField="UTRDATE" ItemStyle-HorizontalAlign="Center" HeaderText="UTR DATE">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
