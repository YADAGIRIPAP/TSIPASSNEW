<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="IncentiveNotHavePowerDetails.aspx.cs"
    Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Incentive Status Upload</a> </li>
                </ol>
            </div>
            <div align="left">
                                        ...
                                        <AlternatingRowStyle Height="40px" CssClass="GridviewScrollC1Item2" />
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="View Incentives">
                                                                                    <ItemTemplate>
                                                                                        <a id="View" target="_blank" href="ShowInscentiveView_Attachments.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>">
                                                                                            View</a>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Upload GM Certificate">
                                                                                    <ItemTemplate>
                                                                                        <asp:UpdatePanel runat="server" UpdateMode="Conditional" RenderMode="Inline" ID="updFU">
                                                                                            <ContentTemplate>
                                                                                                <table style="width: 100%" cellpadding="4" cellspacing="5">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lbl124" runat="server" Text="Status"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="DdlStatus" runat="server" CssClass="form-control txtbox" 
                                                                                                                Height="32px" Width="120px" AutoPostBack="True" 
                                                                                                    ...
                                                                                                    <tr runat="server" id="trRemarks" >
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="TxtRemarks" runat="server" class="form-control txtbox" 
                                                                                                                Height="56px" MaxLength="100" TabIndex="3" ValidationGroup="Save" Width="180px"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr runat="server" id="trUpload1">
                                                                                                        <td>
                                                                                                            <asp:Label ID="lbl123" runat="server" Text="GM Certificate"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr runat="server" id="trUpload2">
                                                                                                     ...
                                                                                                     <tr runat="server" id="trUpload3">
                                                                                                        <td width="270px" id="Td1" runat="server" visible="true">
                                                                                                           <asp:Label ID="LblGmto" runat="server" Visible="true"></asp:Label>
                           <br />
                                                                                                            <asp:DropDownList ID="DdlOfficer" runat="server" CssClass="DROPDOWN" Visible="false">
                                                                                                            </asp:DropDownList>
                                                                                                           <asp:HiddenField ID="HdfGMTo" runat="server" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            ...
                                                                                                            <asp:HiddenField ID="HdfintApplicationid" runat="server"  Value='<%#Eval("IncentiveId") %>'   />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ContentTemplate>
                                                                                            <Triggers>
                                                                                                <asp:PostBackTrigger ControlID="BtnSaveg" />
                                                                                            </Triggers>
                                                                                        </asp:UpdatePanel>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                    <asp:BoundField DataField="InspectionDate" HeaderText="Inspection Date" />
                                                                                        <asp:BoundField DataField="InspectionActualDate" HeaderText="Inspection Actual Date" />
                                                                                  <asp:TemplateField HeaderText="View Inspection Report">
                                                                                    <ItemTemplate>
                                                                                        <a id="View" target="_blank" href="<%# Eval("FilePathReport") %>">
                                                                                            View</a>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
