...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Sanctioned incentives(DIPC) " + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
        ...
        try
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=Sanctioned incentives(DIPC) " + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
