<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"AutoEventWireup="true" CodeFile="frmApprovelDocumentCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                            ...
                            <tr visible="false" id="trDetails" runat="server" style="width: 60%;">
                                <td colspan="4" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="3" cellspacing="5" style="width: 80%">
                                        <tr>
                                            <td colspan="6" style="padding: 5px; margin: 5px; text-align: center;" valign="top"
                                                align="center">
                                                <asp:Label ID="Label422" runat="server" CssClass="LBLBLACK" Font-Bold="True"> CFO Upload Approval Document</asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
