<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmdistrictreportsectorCFO.aspx.cs" Inherits="UI_TSiPASS_frmdistrictreportsectorCFO" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">District Wise Sector Report</asp:Label>&nbsp;
                        ...
                        <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <%--<asp:HyperLinkField ItemStyle-HorizontalAlign="Center" Visible="false" DataTextField="DISTRICTID" HeaderText="DISTRICTID">
                                 ...
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" HeaderText="Graniteand Stone Crushing"
                                    DataTextField="GraniteandStoneCrushing">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>                                
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="CementCementConcreteProductsFlyAshBricks" HeaderText="Cement Concrete Products FlyAshBricks">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="Others" HeaderText="Others">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="ThermalPowerPlant" HeaderText="Thermal Power Plant">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="PlasticandRubber" HeaderText="Plastic And Rubber Power Plant">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="AerospaceandDefence" HeaderText="Aero Space And Defence">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="ElectricalandElectronicProducts" HeaderText="Electrical And Electronic Products">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="RD" HeaderText="RD">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="Engineering" HeaderText="Engineering">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="DEFENCEEQUIPMENT" HeaderText="DEFENCE EQUIPMENT">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="PaperandPrinting" HeaderText="Paper And Printing">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="Textiles" HeaderText="Textiles">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="RealEstateIndustrialParksandITBuildings" HeaderText="RealEstate Industrial Parks And IT Buildings">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="SolarandOtherRenewableEnergy" HeaderText="Solar And Other Renewable Energy">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="AgrobasedinclColdStorages" HeaderText="Agro based incl Cold Storages">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="Automobile" HeaderText="Automobile">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="WoodandLeather" HeaderText="Wood And Leather">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="FoodProcessing" HeaderText="Food Processing">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="Beverages" HeaderText="Beverages">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="ITSERVICES" HeaderText="ITSERVICES">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="FertlizersOrganicandInorganicPesticidesInsecticidesandOtherRelated" HeaderText="Fertlizers Organic And Inorganic Pesticides Insecticides and OtherRelated">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField ItemStyle-HorizontalAlign="Center" DataTextField="PharmaceuticalsandChemicals" HeaderText="Pharmaceuticals And Chemicals">
                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                </asp:HyperLinkField>
