<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" MaintainScrollPositionOnPostback="true"
    ValidateRequest="false" CodeFile="ApplicantIncentiveDtlsNew.aspx.cs" Inherits="UI_TSiPASS_ApplicantIncentiveDtlsNew" %>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default">
                                        ...
                                        <div align="center">
                                            <asp:GridView ID="Gvoldapplications" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="INCENTIVENAME" HeaderText="Type of Incentives" />
                                                                ...
                                                                <div align="center" id="divStampDuty1" runat="server" visible="false">
                                                                    <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; font-size: small;">
                                                                        ...
                                                                        <tr>
                                                                            <td>1.1  Area as per registered sale deed in Sq Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaRegdSaledeed1" runat="server"></asp:Label></td>
                                                                            <td>2.1  Nature of transaction / deed registered for industrial use Sale deed / lease deed / Mortgage</td>
                                                                            <td>
                                                                                <asp:Label ID="txtNatureofTrans1" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2  Plinth area of the building as per approved plan By HUDA / DT&CP / IALA in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtPlnthAreaBuild1" runat="server"></asp:Label></td>
                                                                            <td>2.2  Sub Registrar office</td>
                                                                            <td>
                                                                                <asp:Label ID="txtSubRegOffc1" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.3  5 times of the plinth area of factory building in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtFivePlnthAreaBuild1" runat="server"></asp:Label></td>
                                                                            <td>2.3  Registered deed number</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegdDeedNo1" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.4  Area required for the factory as per the appraisal in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdAppraisal1" runat="server"></asp:Label></td>
                                                                            <td>2.4  Date Of Registration</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegDate1" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.5  Area required for the factory as per the norms of TSPCB or any other state govt. department in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdTSPCB1" runat="server"></asp:Label></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <div align="center" id="divStampDuty2" runat="server" visible="false">
                                                                    <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; font-size: small;">
                                                                        ...
                                                                        <tr>
                                                                            <td>1.1  Area as per registered sale deed in Sq Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaRegdSaledeed2" runat="server"></asp:Label></td>
                                                                            <td>2.1  Nature of transaction / deed registered for industrial use Sale deed / lease deed / Mortgage</td>
                                                                            <td>
                                                                                <asp:Label ID="txtNatureofTrans2" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2  Plinth area of the building as per approved plan By HUDA / DT&CP / IALA in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtPlnthAreaBuild2" runat="server"></asp:Label></td>
                                                                            <td>2.2  Sub Registrar office</td>
                                                                            <td>
                                                                                <asp:Label ID="txtSubRegOffc2" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.3  5 times of the plinth area of factory building in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtFivePlnthAreaBuild2" runat="server"></asp:Label></td>
                                                                            <td>2.3  Registered deed number</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegdDeedNo2" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.4  Area required for the factory as per the appraisal in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdAppraisal2" runat="server"></asp:Label></td>
                                                                            <td>2.4  Date Of Registration</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegDate2" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.5  Area required for the factory as per the norms of TSPCB or any other state govt. department in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdTSPCB2" runat="server"></asp:Label></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <div align="center" id="divStampDuty3" runat="server" visible="false">
                                                                    <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; font-size: small;">
                                                                        ...
                                                                        <tr>
                                                                            <td>1.1  Area as per registered sale deed in Sq Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaRegdSaledeed3" runat="server"></asp:Label></td>
                                                                            <td>2.1  Nature of transaction / deed registered for industrial use Sale deed / lease deed / Mortgage</td>
                                                                            <td>
                                                                                <asp:Label ID="txtNatureofTrans3" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2  Plinth area of the building as per approved plan By HUDA / DT&CP / IALA in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtPlnthAreaBuild3" runat="server"></asp:Label></td>
                                                                            <td>2.2  Sub Registrar office</td>
                                                                            <td>
                                                                                <asp:Label ID="txtSubRegOffc3" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.3  5 times of the plinth area of factory building in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtFivePlnthAreaBuild3" runat="server"></asp:Label></td>
                                                                            <td>2.3  Registered deed number</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegdDeedNo3" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.4  Area required for the factory as per the appraisal in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdAppraisal3" runat="server"></asp:Label></td>
                                                                            <td>2.4  Date Of Registration</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegDate3" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.5  Area required for the factory as per the norms of TSPCB or any other state govt. department in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdTSPCB3" runat="server"></asp:Label></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <div align="center" id="divStampDuty4" runat="server" visible="false">
                                                                    <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; font-size: small;">
                                                                        ...
                                                                        <tr>
                                                                            <td>1.1  Area as per registered sale deed in Sq Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaRegdSaledeed4" runat="server"></asp:Label></td>
                                                                            <td>2.1  Nature of transaction / deed registered for industrial use Sale deed / lease deed / Mortgage</td>
                                                                            <td>
                                                                                <asp:Label ID="txtNatureofTrans4" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2  Plinth area of the building as per approved plan By HUDA / DT&CP / IALA in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtPlnthAreaBuild4" runat="server"></asp:Label></td>
                                                                            <td>2.2  Sub Registrar office</td>
                                                                            <td>
                                                                                <asp:Label ID="txtSubRegOffc4" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.3  5 times of the plinth area of factory building in Sq. Mts</td>
                                                                            <td>
                                                                                <asp:Label ID="txtFivePlnthAreaBuild4" runat="server"></asp:Label></td>
                                                                            <td>2.3  Registered deed number</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegdDeedNo4" runat="server"></asp:Label></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>1.4  Area required for the factory as per the appraisal in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdAppraisal4" runat="server"></asp:Label></td>
                                                                            <td>2.4  Date Of Registration</td>
                                                                            <td>
                                                                                <asp:Label ID="txtRegDate4" runat="server"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.5  Area required for the factory as per the norms of TSPCB or any other state govt. department in Sq. Mts.</td>
                                                                            <td>
                                                                                <asp:Label ID="txtAreaReqdTSPCB4" runat="server"></asp:Label></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                ...
                                <div align="center" id="DIVTRANSPORTDUTY" runat="server" visible="false">
                                    <table  bgcolor="White" width="100%" border="2px"
                                        ...
                                        <tr>
                                            <td align="center" colspan="4"
                                                style="text-align: center; background-color: #0066FF; color: #FFFFFF; font-size: large; font-weight: bold;">
                                                <asp:Label ID="Label68" runat="server" Font-Bold="True" Font-Size="18px" ForeColor="White">ANNEXURE:Claiming Transport Subsidy </asp:Label>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="center" colspan="4"
                                                ...
                                                <asp:GridView ID="gvcomponentdetails" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sl No.">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label69" runat="server" Text="<%#Container.DataItemIndex+1 %>"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        ...
                                        <tr style="border-block-end-width:medium">
                                            ...
                                            <td>
                                                ...
                                                <br /><asp:Label ID="lbltrain" runat="server"></asp:Label>
                                                <br /><asp:Label ID="lblowntransport" runat="server"></asp:Label>
                                ...
                                <div align="center" id="DIVWOOD" runat="server" visible="false">
                                    <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; font-size: small;">
                                        <tr>
                                            <td align="center" colspan="4"
                                                style="text-align: center; background-color: #0066FF; color: #FFFFFF; font-size: large; font-weight: bold;">
                                                <asp:Label ID="Label70" runat="server" Font-Bold="True" Font-Size="18px" ForeColor="White">ANNEXURE: XVIII - Claiming WOOD SUBSIDY</asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <td><span style="font-weight: bold; font-size: 14pt"></span></td>
                                                ...
                                                <td colspan="5">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Application In Full Shape to Assign" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="hplink" runat="server" Text="Query Letter" Font-Bold="true" ForeColor="Green" Target="_blank" /></td>
                                            </tr>
                                ...
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">Inspection Report</span></td>
                                        ...
                                        <tr style="height: 30px" id="trInspectionReport2" runat="server" visible="false">
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:HyperLink ID="HyperLink2" runat="server" Text="View Inspection Report" Font-Bold="true" ForeColor="Green" Target="_blank" /></td>
                                        </tr>
                                                ...
                                                <asp:GridView ID="gvquerygmtbyIO" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Send Response to IO/Forward To applicant">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnsendcoiIO" CssClass="btn btn-primary" runat="server" Text="Send Response to Inspecting Officer" Width="320px" OnClick="btnsendcoiIO_Click" /><br />
                                                                <br />
                ...
                <td>
                    ...
                    <asp:RadioButtonList ID="rdbTransportNonTrans" runat="server" AutoPostBack="True" enabled="false" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdbTransportNonTrans_SelectedIndexChanged">
                                                        ...
                                                        <asp:TemplateField HeaderText="Raise Query/Forward Application to DICP/COI">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnotp" runat="server" CssClass="btn btn-xs btn-warning" Height="50px"
                                                                    ...
                                                                    OnClick="btnotp_Click" Visible="false" /><br />
                                                                <asp:TextBox ID="txtOTPVerify" runat="server" class="form-control txtbox"
                                                                    ...
                                                                    OnTextChanged="txtOTPVerify_TextChanged" AutoPostBack="true" Visible="false"></asp:TextBox>
                                                                <br />
                            ...
                            <div id="Div42" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">A.D Query History</span>
                                        ...
                                        <tr>
                                          <td>
                                                <asp:GridView ID="gvclerkquery" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                    ...
                                                    <columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Incentives">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink16" runat="server" Text='<%#Eval("Incentive Name") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblclerkIncentiveName" Text='<%#Eval("Incentive Name") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Query Description">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink17" runat="server" Text='<%#Eval("Query Description") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblclerkQueryDescription" Text='<%#Eval("Query Description") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Query Raised By" HeaderText="Query Raised By" />
                                                        <asp:BoundField DataField="Query Raised Date" HeaderText="Query Raised Date" />
                                                        <asp:BoundField DataField="Applicant Response" HeaderText="Applicant Response" />
                                                        <asp:BoundField DataField="Date of Response" HeaderText="Date of Response" />
                                                        <asp:TemplateField HeaderText="APP Status">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink18" runat="server" Text='<%#Eval("APPstatus") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblclerkAPPstatus" Text='<%#Eval("APPstatus") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                    </columns>
                                                </asp:GridView>
                        ...
                        <div class="panel panel-default" runat="server" id="Divsupdtquery" visible="false">
                            ...
                            <div id="Div44" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">A.D Query History</span>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvsupdtquery" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                    ...
                                                    <columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Incentives">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink7" runat="server" Text='<%#Eval("Incentive Name") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblSuperintendentIncentivename" Text='<%#Eval("Incentive Name") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Query Description">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink9" runat="server" Text='<%#Eval("Query Description") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblSuperintendentQuery" Text='<%#Eval("Query Description") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Query Raised By" HeaderText="Query Raised By" />
                                                        <asp:BoundField DataField="Query Raised Date" HeaderText="Query Raised Date" />
                                                        ...
                                                        <asp:TemplateField HeaderText="APP Status">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink10" runat="server" Text='<%#Eval("APPstatus") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lblSuperintendentStatus" Text='<%#Eval("APPstatus") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                    </columns>
                                                </asp:GridView>
                            ...
                            <div id="DivAD23" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">A.D Query History</span>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVADQueryStatus" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                   ...
                                                   <columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Incentives">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink8" runat="server" Text='<%#Eval("Incentive Name") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lbladIncentiveName" Text='<%#Eval("Incentive Name") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Query Description">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink11" runat="server" Text='<%#Eval("Query Description") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lbladQueryDescription" Text='<%#Eval("Query Description") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Query Raised By" HeaderText="Query Raised By" />
                                                        <asp:BoundField DataField="Query Raised Date" HeaderText="Query Raised Date" />
                                                        ...
                                                        <asp:TemplateField HeaderText="APP Status">
                                                            <itemtemplate>
                                                                <asp:HyperLink ID="HyperLink12" runat="server" Text='<%#Eval("APPstatus") %>' Font-Bold="true" ForeColor="Green" Target="_blank" />
                                                                <asp:Label ID="lbladAPPstatus" Text='<%#Eval("APPstatus") %>' runat="server" Visible="false" />
                                                            </itemtemplate>
                                                        </asp:TemplateField>
                                                    </columns>
                                                </asp:GridView>
                         ...
                         <div class="panel panel-default" runat="server" id="Divadreturnhistory" visible="false">
                            <div class="panel-heading" role="tab" id="Div47">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#DivAD23" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        AD Officer Return History
                                    </a>
                                </h4>
                            </div>
                            <div id="Div48" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        <%--<tr>
                                    <td><span style="font-weight: bold; font-size: 14pt">A.D Query History</span>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVADReturnStatus" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                ...
                                                <asp:GridView ID="gvadrecommended" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Appraisal Note" Visible="false">
                                                         ...
                                                         <asp:TemplateField HeaderText="AD Recommended Date">
                                                            <ItemTemplate>
                                                            <asp:Label ID="lblRECOMMENDED_DATE" Text='<%#Eval("RECOMMENDED_DATE") %>' runat="server" Visible="true" />
                                                ...
                                                <asp:GridView ID="gvDDrcrecommended" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Appraisal Note" Visible="false">
                                                          ...
                                                          <asp:TemplateField HeaderText="DD Recommended Date">
                                                            <ItemTemplate>
                                                            <asp:Label ID="lblRECOMMENDED_DATE" Text='<%#Eval("RECOMMENDED_DATE") %>' runat="server" Visible="true" />
                                ...
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">G.M Query History</span>
                                        ...
                                        <tr style="height: 30px" id="tr13" runat="server" visible="false">
                                            <td colspan="2" style="font-weight: bold">-->
                                            <asp:HyperLink ID="HyperLink3" runat="server" Text="Query Letter" Font-Bold="true" ForeColor="Green" Target="_blank" /></td>
                                        </tr>
                                        <tr style="height: 20px">
                                            <td></td>
                                            <td>
                                ...
                                <div class="panel-body">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">G.M Query History</span>
                                        ...
                                        <tr style="height: 30px" id="trjdqueryletter" runat="server" visible="false">
                                            <td colspan="2" style="font-weight: bold">-->
                                            <asp:HyperLink ID="HyperLinktrjdqueryletter" runat="server" Text="Query Letter" Font-Bold="true" ForeColor="Green" Target="_blank" /></td>
                                        </tr>
                                        <tr style="height: 20px">
                                            <td></td>
                                        </tr>
                        ...
                        <%--end of 22.01.2018--%>
                         <div class="panel panel-default" runat="server" id="Div40" visible="false">
                            <div class="panel-heading" role="tab" id="Div49">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Div50" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        Status of Returned Applications at JD Level
                                    </a>
                                </h4>
                            </div>
                            <div id="Div50" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvJDReturneddDtls" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <headerstyle verticalalign="Middle" height="40px" cssclass="GridviewScrollC1HeaderWrap" />
                                                    <rowstyle cssclass="GridviewScrollC1Item" />
                        ...
                        <div class="panel panel-default" runat="server" id="Div51" visible="false">
                            <div class="panel-heading" role="tab" id="Div52">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Div53" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        Status of Returned Applications at Additional Director Level
                                    </a>
                                </h4>
                            </div>
                            <div id="Div53" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvADDlReturneddDtls" runat="server" AutoGenerateColumns="false"
                                                    CellPadding="4" Height="62px"
                                                    Width="100%" Font-Names="Verdana" Font-Size="12px">
                                                    <headerstyle verticalalign="Middle" height="40px" cssclass="GridviewScrollC1HeaderWrap" />
                                                    <rowstyle cssclass="GridviewScrollC1Item" />
                    ...
                    <div class="panel panel-default" runat="server" id="DIVSVCAPPROVEDHEAD" visible="false">
                          ...
                          <div class="panel panel-default" runat="server" id="DIVCOMMRET" visible="false">
                            ...
                            <div id="DIVCOMMRET2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        <tr id="tr35" runat="server" visible="false">
                        ...
                        <div class="panel panel-default" runat="server" id="DIVAPPROVED_COMMISIONER1" visible="false">
                            ...
                            <div id="DIVAPPROVED_COMMISIONER3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        <tr id="tr36" runat="server" visible="false">
                        ...
                        <div class="panel panel-default" runat="server" id="trRemarks_clerklevel" visible="false">
                            <div class="panel-heading" role="tab" id="Div38_Clerklevel">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseclerkhistorynew" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        Verification of Application (Clerk - LEVEL)
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseclerkhistorynew" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                    ...
                                    <td><span style="font-weight: bold; font-size: 14pt">Query (If any)</span></td>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    <tr id="trclerklevleOperation" runat="server">
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label23" runat="server" CssClass="LBLBLACK" Width="200px">Type of Incentive </asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:DropDownList ID="ddlTypeofinc_clerklevel" runat="server" class="form-control txtbox"
                                                                Height="33px" Width="180px" TabIndex="1" OnSelectedIndexChanged="ddlTypeofinc_clerklevel_SelectedIndexChanged">
                                                                <%-- <asp:ListItem>--Select--</asp:ListItem>--%>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;</td>
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label25" runat="server" CssClass="LBLBLACK" Width="120px">Status</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:RadioButtonList ID="rblStatus_clerklevel" runat="server" AutoPostBack="True" Width="220px" OnSelectedIndexChanged="rblStatus_clerklevel_SelectedIndexChanged">
                                                                <asp:ListItem Text="File in full shape" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Query" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="SSC inspection" Value="4"></asp:ListItem>
                                                                 <asp:ListItem Text="Abeyance Application" Value="5"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        <td>
                                                            <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="true" Font-Size="Large" OnClick="lnkapplntotalprint_Click">Print All Documents</asp:LinkButton>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:DropDownList ID="ddlclerkfrwdto" Height="28px" Width="200px" runat="server">
                                                    ...
                                                    <tr id="trclerkrecommendamount" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label26" runat="server" CssClass="LBLBLACK" Width="200px">Recommended Amount</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtclerkrecomamount" Height="28px" Width="200px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr id="trQuery_clerklevel" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label27" runat="server" CssClass="LBLBLACK" Width="200px">Query</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtclerklevelQuery" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>

                                                    <tr id="tr23" runat="server">
                                                        <td style="padding: 5px; margin: 5px" colspan="8" align="center">
                                                            <asp:Button ID="btnAddQueryclerkLevel" runat="server" CssClass="btn btn-xs btn-warning"
                                                                Height="28px" TabIndex="10" Text="Add" ValidationGroup="group1"
                                                                Width="72px" OnClick="btnAddQueryclerkLevel_Click" />
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvQueries_ClerkLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvQueries_ClerkLevel_RowDeleting" OnRowDataBound="gvQueries_ClerkLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="GridView17" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="GridView17_RowDeleting">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle" colspan="9">
                                                            <asp:Button ID="btnSubmitClerkAppraisal" runat="server" CssClass="btn btn-primary" Height="32px"
                                                                TabIndex="10" Text="Submit for Appraisal Note" Visible="false" OnClick="btnSubmitClerkAppraisal_Click" />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                          <asp:Button ID="btnQueryclerkLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Query" OnClick="btnQueryclerkLevel_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="8">&nbsp;</td>
                        ...
                        <div class="panel panel-default" runat="server" id="trRemarks_supdtlevel" visible="false">
                            <div class="panel-heading" role="tab" id="Div38_supdtlevel">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsesupdthistorynew" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        Verification of Application (Superintendent - LEVEL)
                                    </a>
                                </h4>
                            </div>
                            <div id="collapsesupdthistorynew" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        <%--   <tr style="height: 30px" id="trRemarks1" runat="server" visible="false">
                                    <td><span style="font-weight: bold; font-size: 14pt">Query (If any)</span></td>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    <tr id="trsupdtlevleOperation" runat="server">
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label28" runat="server" CssClass="LBLBLACK" Width="200px">Type of Incentive </asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:DropDownList ID="ddlTypeofinc_supdtlevel" runat="server" class="form-control txtbox"
                                                                Height="33px" Width="180px" TabIndex="1" OnSelectedIndexChanged="ddlTypeofinc_supdtlevel_SelectedIndexChanged">
                                                                <%-- <asp:ListItem>--Select--</asp:ListItem>--%>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;</td>
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label29" runat="server" CssClass="LBLBLACK" Width="120px">Status</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:RadioButtonList ID="rblStatus_supdtlevel" runat="server" AutoPostBack="True" Width="220px" OnSelectedIndexChanged="rblStatus_supdtlevel_SelectedIndexChanged">
                                                                <asp:ListItem Text="File in full shape" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Query" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="Return" Value="3"></asp:ListItem>
                                                                <asp:ListItem Text="SSC inspection" Value="4"></asp:ListItem>
                                                                <asp:ListItem Text="Abeyance Application" Value="5"></asp:ListItem>
                                                                 <asp:ListItem Text="SSC inspection Completed" Value="6"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        <td>
                                                            <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="true" Font-Size="Large" OnClick="lnkapplntotalprint_Click">Print All Documents</asp:LinkButton>
                                                        </td>

                                                    </tr>
                                                    <tr id="trsupdtrecommendamount" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label30" runat="server" CssClass="LBLBLACK" Width="200px">Recommended Amount</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtsupdtrecomamount" Height="28px" Width="200px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr id="trQuery_supdtlevel" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label35" runat="server" CssClass="LBLBLACK" Width="200px">Query</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtsupdtlevelQuery" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>

                                                    <tr id="trreturn_supdtlevel" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label64" runat="server" CssClass="LBLBLACK" Width="200px">Return Reason</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtsupdtlevelreturnreason" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                   ...
                                                   <tr id="trsscreport" runat="server" visible="false">
                                                    ...
                                                    <tr id="tr20" runat="server">
                                                        <td style="padding: 5px; margin: 5px" colspan="8" align="center">
                                                            <asp:Button ID="btnAddQuerysupdtLevel" runat="server" CssClass="btn btn-xs btn-warning"
                                                                Height="28px" TabIndex="10" Text="Add" ValidationGroup="group1"
                                                                Width="72px" OnClick="btnAddQuerysupdtLevel_Click" />
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvQueries_supdtLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvQueries_supdtLevel_RowDeleting" OnRowDataBound="gvQueries_supdtLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <%--  <asp:BoundField DataField="Status" HeaderText="Status" />--%>
                                                                    <asp:BoundField DataField="Remarks" HeaderText="Remarks" />
                                                                    <asp:BoundField DataField="CreatedBy" HeaderText="Query/SSC Raised By" />
                                                                    <asp:BoundField DataField="CreatedDate" HeaderText="Date" />
                                                                    <asp:TemplateField HeaderText="Masterincentiveid" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Label53" Text='<%#Eval("MstIncentiveId") %>' runat="server" />
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvreturn_supdtLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvreturn_supdtLevel_RowDeleting" OnRowDataBound="gvreturn_supdtLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <%--  <asp:BoundField DataField="Status" HeaderText="Status" />--%>
                                                                    <asp:BoundField DataField="Remarks" HeaderText="Remarks" />
                                                                    <asp:BoundField DataField="CreatedBy" HeaderText="Applicantion Returned By" />
                                                                    <asp:BoundField DataField="CreatedDate" HeaderText="Date" />
                                                                    <asp:TemplateField HeaderText="Masterincentiveid" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Label53" Text='<%#Eval("MstIncentiveId") %>' runat="server" />
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="GridView15" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="GridView15_RowDeleting">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle" colspan="9">
                                                            <asp:Button ID="btnSubmitsupdtAppraisal" runat="server" CssClass="btn btn-primary" Height="32px"
                                                                TabIndex="10" Text="Submit for Appraisal Note" Visible="false" OnClick="btnSubmitsupdtAppraisal_Click" />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                          <asp:Button ID="btnQuerysupdtLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Query" OnClick="btnQuerysupdtLevel_Click" /> &nbsp;&nbsp;&nbsp;&nbsp;
                                                             <asp:Button ID="btnreturnsupdtLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Return Reason" OnClick="btnreturnsupdtLevel_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="8">&nbsp;</td>
                                            ...
                                            <td>
                                                <table>
                                                    ...
                                                    <tr id="trQuery_adlevel" runat="server" visible="false">
                                                      ...
                                                      <tr id="trreturnadlevel" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label65" runat="server" CssClass="LBLBLACK" Width="200px">Return Reason</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtadlevelreturnreason" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvreturn_adLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvreturn_supdtLevel_RowDeleting" OnRowDataBound="gvreturn_adLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle" colspan="9">
                                                          ...
                                                          <asp:Button ID="btnQueryAdLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              ...
                                                              <asp:Button ID="btnreturnad" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Return Reason" OnClick="btnreturnad_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="8">&nbsp;</td>
                        ...
                        <div class="panel panel-default" runat="server" id="trRemarks_DDlevel" visible="false">
                            <div class="panel-heading" role="tab" id="Div38_DDlevel">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseDDhistorynew" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                        Verification of Application (DD - LEVEL)
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseDDhistorynew" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <table style="width: 100%">
                                        <%--   <tr style="height: 30px" id="trRemarks1" runat="server" visible="false">
                                    <td><span style="font-weight: bold; font-size: 14pt">Query (If any)</span></td>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    <tr id="trDDlevleOperation" runat="server">
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label52" runat="server" CssClass="LBLBLACK" Width="200px">Type of Incentive </asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:DropDownList ID="ddlTypeofinc_DDlevel" runat="server" class="form-control txtbox"
                                                                Height="33px" Width="180px" TabIndex="1" OnSelectedIndexChanged="ddlTypeofinc_DDlevel_SelectedIndexChanged">
                                                                <%-- <asp:ListItem>--Select--</asp:ListItem>--%>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;</td>
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label61" runat="server" CssClass="LBLBLACK" Width="120px">Status</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:RadioButtonList ID="rblStatus_DDlevel" runat="server" AutoPostBack="True" Width="220px" OnSelectedIndexChanged="rblStatus_DDlevel_SelectedIndexChanged">
                                                                <asp:ListItem Text="File in full shape" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Query" Value="2"></asp:ListItem>
                                                                 <asp:ListItem Text="Return" Value="3"></asp:ListItem>
                                                                <asp:ListItem Text="SSC inspection" Value="4"></asp:ListItem>
                                                        ...
                                                        <td>
                                                            <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="true" Font-Size="Large" OnClick="lnkapplntotalprint_Click">Print All Documents</asp:LinkButton>
                                                        </td>

                                                    </tr>
                                                    <tr id="trDDrecommendamount" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label62" runat="server" CssClass="LBLBLACK" Width="200px">Recommended Amount</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtDDrecomamount" Height="28px" Width="200px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr id="trQuery_DDlevel" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label63" runat="server" CssClass="LBLBLACK" Width="200px">Query</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtDDlevelQuery" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>


                                                      <tr id="trDDreturn" runat="server" visible="false">

                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label66" runat="server" CssClass="LBLBLACK" Width="200px">Return Reason</asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtDDlevelreturnreason" TextMode="MultiLine" Height="80px" Width="300px" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr id="tr28" runat="server">
                                                        <td style="padding: 5px; margin: 5px" colspan="8" align="center">
                                                            <asp:Button ID="btnAddQueryDDLevel" runat="server" CssClass="btn btn-xs btn-warning"
                                                                Height="28px" TabIndex="10" Text="Add" ValidationGroup="group1"
                                                                Width="72px" OnClick="btnAddQueryDDLevel_Click" />
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvQueries_DDLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvQueries_DDLevel_RowDeleting" OnRowDataBound="gvQueries_DDLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="gvreturn_ddLevel" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="gvreturn_supdtLevel_RowDeleting" OnRowDataBound="gvreturn_supdtLevel_RowDataBound">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="9">
                                                            <asp:GridView ID="GridView18" runat="server" AutoGenerateColumns="false"
                                                                CellPadding="4" Height="62px"
                                                                Width="100%" Font-Names="Verdana" Font-Size="12px" OnRowDeleting="GridView18_RowDeleting">
                                                                <HeaderStyle VerticalAlign="Middle" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                <RowStyle CssClass="GridviewScrollC1Item" />
                                                                <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                <FooterStyle BackColor="#013161" Height="40px" CssClass="GridviewScrollC1Header" />
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle" colspan="9">
                                                            <asp:Button ID="btnSubmitDDAppraisal" runat="server" CssClass="btn btn-primary" Height="32px"
                                                                TabIndex="10" Text="Submit for Appraisal Note" Visible="false" OnClick="btnSubmitDDAppraisal_Click" />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                          <asp:Button ID="btnQueryDDLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Query" OnClick="btnQueryDDLevel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                                                               <asp:Button ID="btnreturnddLevel" runat="server" CssClass="btn btn-primary" Height="32px" Visible="false"
                                                              TabIndex="10" Text="Submit Return Reason" OnClick="btnreturnddLevel_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="8">&nbsp;</td>
                        ...
                        <div class="panel panel-default" id="DivSSCgm" runat="server" visible="false">
                            <div class="panel-heading" role="tab" id="Div55">
                                <h4 class="panel-title">
                                                ...
                                                <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Send Response to Additional Director">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnsendcoiadd" CssClass="btn btn-primary" runat="server" Text="Send Response" Width="250px" OnClick="btnsendcoiadd_Click" /><br />
                                                                <br />
                                ...
                                <div class="panel-body">
                                    ...
                                    <div align="center">
                                        ...
                                        <table width="100%" id="Table1" runat="server">
                                            ...
                                            <tr>
                                                <td style="padding: 10px; margin: 5px;">
                                                    <asp:GridView ID="GridView14" runat="server" AutoGenerateColumns="False"  OnRowDataBound="GridView14_RowDataBound"
                                                        Width="80%" HorizontalAlign="Left" ShowHeader="true">
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                                                <ItemTemplate>
