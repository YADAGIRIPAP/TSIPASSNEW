<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBillDeskNotUpdatedSingle.aspx.cs" Inherits="UI_TSiPASS_frmBillDeskNotUpdatedSingle" %>
                ...
                <td>
                    <table style="text-align: center; width: 100%" align="center">
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlappltype" runat="server" class="form-control txtbox" TabIndex="1" Width="180px">

                                    <asp:ListItem Value="1">CFE</asp:ListItem>
                                    <asp:ListItem Value="2">CFO</asp:ListItem>
                                    <asp:ListItem Value="3">REN</asp:ListItem>
                                </asp:DropDownList></td>
