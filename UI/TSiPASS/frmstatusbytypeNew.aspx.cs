...
public partial class UI_TSiPASS_frmstatusbytypeNew : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = Gen.RetriveStatusByTypeNew(status, type, ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, FromdateforDB, TodateforDB);
