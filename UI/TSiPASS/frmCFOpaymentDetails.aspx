<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmCFOpaymentDetails.aspx.cs"
    Inherits="TSTBDCReg1" %>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                               <asp:DropDownList ID="ddlpaymentType" runat="server" 
                                                                    ...
                                                                    <asp:ListItem Value="R">RTGS Payment</asp:ListItem>
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                        ShowFooter="True" Width="100%" OnRowDataBound="grdDetails_RowDataBound" OnPageIndexChanging="grdDetails_PageIndexChanging" AllowPaging="false" PageSize="50"
                                        OnSelectedIndexChanged="grdDetails_SelectedIndexChanged" OnSelectedIndexChanging="grdDetails_SelectedIndexChanging">
