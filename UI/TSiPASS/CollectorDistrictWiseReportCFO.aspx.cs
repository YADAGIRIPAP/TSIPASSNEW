...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ds = Gen.DistrictWiseReportCollectorCFO(Session["DistrictID"].ToString().Trim());
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                h5.Target = "_blank";
                h5.NavigateUrl = "CommissionerApprovalCFO.aspx?Stage=5&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistrictId")).Trim();

                HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
                h6.Target = "_blank";
                h6.NavigateUrl = "CommissionerDashboardDrilldownCFO1.aspx?Stage=6&District=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistrictId")).Trim();
