<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmImplstatuspendencyDistwiseDrill.aspx.cs" Inherits="UI_TSIPASS_frmImplstatuspendencyDistwiseDrill" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server"></asp:Label>&nbsp;&nbsp; <a id="A2" href="#" onserverclick="BtnSave2_Click1" runat="server">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%; font-family: 'Trebuchet MS'">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/frmImplstatuspendencyDistwise.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink3" runat="server" NavigateUrl="~/UI/TSiPASS/frmImplstatuspendencyDistwise.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
                        </table>
