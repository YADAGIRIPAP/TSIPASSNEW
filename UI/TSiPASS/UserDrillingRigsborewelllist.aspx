<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UserDrillingRigsborewelllist.aspx.cs" Inherits="UI_TSiPASS_UserDrillingRigsborewelllist" %>
                    ...
                    <div class="col-lg-11">
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">Drilling Rigs / Hand boring sets DASHBOARD&nbsp;</h3>
                            </div>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="PaymentDetails">
                                                             ...
                                                             <asp:TemplateField HeaderText="Documents">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="anchortaglinkattachment" runat="server" Text="View" Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Application Status">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="anchortaglinkApplicationstatus" runat="server"  Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
