<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleasePendingViewSVCAgenda.aspx.cs" Inherits="UI_TSiPASS_ReleasePendingViewSVCAgenda" %>
                                ...
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                        ...
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="50%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; font-weight: bold; width: 200px">1) Proposed SVC Date : </td>
                                    ...
                                    <tr>
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7" id="tblselection" runat="server">
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Print Agenda" OnClick="Button1_Click" />
                                            &nbsp;&nbsp; 
                                            <asp:Button ID="Button6" CssClass="btn btn-primary" runat="server" Visible="false" Text="Download PDF" OnClick="Button6_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="12">
