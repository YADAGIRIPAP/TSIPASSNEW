<%@ Page Language="C#" MasterPageFile="CCMaster.master" AutoEventWireup="true" CodeFile="Resultdatalatest.aspx.cs" Inherits="Default3" Title=":: TS-iPass Govenrnment of Telengana :: Home" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;" valign="top" align="center">
                                                        <asp:Label ID="Label409" runat="server" 
                    CssClass="LBLBLACK" Font-Bold="True" 
                                                            Width="165px"></asp:Label>
                                                    <br />
                                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                                NavigateUrl="~/UI/TSiPASS/FrmMSMENew.aspx">Click 
                here</asp:HyperLink>
       </td>
        </tr>
    </table>
