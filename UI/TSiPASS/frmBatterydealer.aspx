<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBatterydealer.aspx.cs" Inherits="UI_TSiPASS_frmBatterydealer" %>
            ...
            <div align="left">
                <div class="row" align="left">
                    <div class="col-lg-11">
                        ...
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="left" style="font-size: x-large">Enterprise Details</h1>
                        </div>
                                                ...
                                                <table cellpadding="4" cellspacing="5" style="width: 70%">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label387" runat="server" CssClass="LBLBLACK" Width="210px">Name of the dealer<font 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; width: 10px;">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtindustrialName"
                                                                ErrorMessage="Please select validity date" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
