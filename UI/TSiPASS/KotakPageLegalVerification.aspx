<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakPageLegalVerification.aspx.cs" Inherits="UI_TSiPASS_KotakPageLegalVerification" %>
    ...
    <div id="myDIV">
        ...
        <table id="Table1" width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerLEGAL.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/Legalverificationpayment.aspx" />
                </td>
            </tr>
            <tr>
                <td>
