<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kotakadvertisement.aspx.cs" Inherits="UI_TSiPASS_Kotakadvertisement" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerAdvertisement.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerAdvertisement.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentAdvertisement.aspx" />
                </td>
            </tr>
            <tr>
                <td>
