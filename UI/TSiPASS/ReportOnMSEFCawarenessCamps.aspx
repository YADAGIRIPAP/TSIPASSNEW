<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReportOnMSEFCawarenessCamps.aspx.cs" Inherits="UI_TSiPASS_ReportOnMSEFCawarenessCamps" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            <tr>
                                <td colspan="6" align="center" style="text-decoration: underline; padding-bottom: 30px">
                                    <asp:Label ID="lblhdng" runat="server" Font-Bold="true" Font-Size="25px"> Report on MSEFC Awarness Camps</asp:Label>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:GridView ID="grdsupport" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="District" DataField="DistrictName" ItemStyle-HorizontalAlign="center" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" />                                            
                                             <asp:HyperLinkField HeaderText="No.of Awareness Camps Conducted" DataTextField="MSEFCcampscount" ItemStyle-Width="200px" ControlStyle-ForeColor="Black" FooterStyle-CssClass="text-center">
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-Center" />
                                            </asp:HyperLinkField>
                                             <asp:HyperLinkField HeaderText="No.of MSMEs Participated" DataTextField="MSEFCattendedcount" ItemStyle-Width="200px" ControlStyle-ForeColor="Black" FooterStyle-CssClass="text-center">
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-Center" />
                                            </asp:HyperLinkField>                                           
                                            <asp:HyperLinkField HeaderText="No.of Units having Payment Problems" DataTextField="paymntissuecount" ItemStyle-Width="200px" ControlStyle-ForeColor="Black" FooterStyle-CssClass="text-center">
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-Center" />
                                            </asp:HyperLinkField>  
                                             <asp:HyperLinkField HeaderText="No.of Units case filed" DataTextField="casefiledcount" ItemStyle-Width="200px" ControlStyle-ForeColor="Black" FooterStyle-CssClass="text-center">
                                                <ItemStyle Font-Underline="false" HorizontalAlign="Center" CssClass="text-Center" />
                                            </asp:HyperLinkField>   
