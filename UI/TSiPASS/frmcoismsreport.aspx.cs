...
public partial class UI_TSiPASS_frmcoismsreport : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = GetMSMEApplications(FromdateforDB, TodateforDB );
        // lblMsg.Text = "";
    ...
    public DataSet GetMSMEApplications(string fromdate, string todate )
    {
        DataSet Dsnew = new DataSet();
       ...
       // pp[2].Value = districtid;
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_COISMSPENDINGREPORT", pp);
        return Dsnew;
    }
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage.Text = "CFE Pendency";
            ...
            tcMergePackage1.Text = "CFO Pendency";
