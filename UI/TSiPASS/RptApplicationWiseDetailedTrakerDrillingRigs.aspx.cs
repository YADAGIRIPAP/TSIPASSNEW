...
public partial class UI_TSiPASS_RptApplicationWiseDetailedTrakerDrillingRigs : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds = ApplicationWiseDetailedTrakerDrillingRigs(intqnreid.ToString());
        Session["Applid"] = intqnreid.ToString();

        if (ds.Tables[0].Rows.Count > 0)
        {
            labUidNumber.Text = ds.Tables[0].Rows[0]["UIDNo"].ToString();
            labNameandAddress.Text = ds.Tables[0].Rows[0]["Nameoftheapplicant"].ToString();
            labLineofActivity.Text = ds.Tables[0].Rows[0]["Applicationtype"].ToString();
            labrtodistrict.Text = ds.Tables[0].Rows[0]["RTODistrict"].ToString();
    ...
    public DataSet ApplicationWiseDetailedTrakerDrillingRigs(string Quesionary_id)
    {
        ...
        try
        {
            da = new SqlDataAdapter("GW_RetriveR4ReportDrillingRigs", con);
