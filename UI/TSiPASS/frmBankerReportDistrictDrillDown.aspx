<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBankerReportDistrictDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmBankerReportDistrictDrillDown" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">View Banker Applications</a> </li>
        </ol>
    </div>
    <div class="col-lg-12">
