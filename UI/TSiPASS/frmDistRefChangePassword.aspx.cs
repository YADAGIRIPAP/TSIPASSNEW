...
public partial class UI_TSiPASS_frmDistRefChangePassword : System.Web.UI.Page
{
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        if (BtnSave1.Text == "Submit")
        {
            ...
            DataSet dv = Gen.ValidateLoginResetOtherServices(UserID, Password.ToString(), txtPwd.Text.Trim());
            ...
            if (dv != null && dv.Tables.Count > 0 && dv.Tables[0].Rows.Count > 0)
            {
                ...
                retval = Gen.ChangePasswordForOtherServices(UserID, Newpassword, Session["uid"].ToString());
                if (retval == 1)
                {
