...
public partial class UI_TSiPASS_IncentiveStatusInspectionUploadbyCoiSUPDT : System.Web.UI.Page
{
    ...
    public DataSet CoifetchIncentivedetIPONewIncType(string intDeptid, string status)
    {
        ...
        try
        {
            da = new SqlDataAdapter("usp_GetJdForwardedApplications_LEVEL_SUPTD", con.GetConnection);
