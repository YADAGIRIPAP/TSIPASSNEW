<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="CountyWiseReportNew.aspx.cs" Inherits="CountyWiseReportNew" Title=":: TSiPASS Online Management System ::" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="NoofPayams" HeaderText="No of Implementing Payams" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                            <asp:BoundField DataField="NoofBomas" HeaderText="Number of Implementing Bomas" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                ...
                <td><asp:Label ID="lblmsg1" Text="County wise type of works report" Font-Bold="true"   runat="server" Font-Size="Medium"></asp:Label>
                </td>
                </tr>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails0" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="Type5" HeaderText="No.of Type5" Visible="false" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                            <asp:BoundField DataField="Type6" HeaderText="No.of Type6" Visible="false" >
                                                <ItemStyle HorizontalAlign="Center" />
                                                     </asp:BoundField>
                                           <asp:BoundField DataField="TotalWorkProposed" HeaderText="Total" Visible="false" >
