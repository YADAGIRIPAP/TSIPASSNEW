<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="TotalReportold2New_MANDALWISE.aspx.cs" Inherits="UI_TSiPASS_TotalReportold2New_MANDALWISE" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;"><asp:Label ID="lblHeading" runat="server">R20: TGiPASS- Mandal Wise Report </asp:Label>
                        ...
                        <div class="panel-body">
                            <table align="center" cellpadding="10" cellspacing="5" style="width: 50%;font-family:'Trebuchet MS'">
                                        ...
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 80%">
                                            ...
                                            <tr>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlimplementation" runat="server" class="form-control txtbox" Width="180px">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                       <%-- <asp:ListItem>All</asp:ListItem>--%>
                                    ...
                                    <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MandalID" HeaderText="Mandal" Visible="false">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle CssClass="text-uppercase" />
                                                </asp:BoundField>
                                            </Columns>
                                ...
                                <tr id="GraphPrint" runat="server" visible="false">
