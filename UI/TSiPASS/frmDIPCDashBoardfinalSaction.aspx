<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDIPCDashBoardfinalSaction.aspx.cs" Inherits="UI_TSiPASS_frmDIPCDashBoardfinalSaction" %>
        ...
        <div class="row" align="left">
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td id="divPrint" runat="server">
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Upload DIPC Proceedings</h1>
                            </div>
                                        ...
                                        <td style="padding: 10px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width:250px" runat="server" id="tdnamehead">Proposed DIPC Date: </td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnupdatestatus" CssClass="btn btn-primary" runat="server" Text="Get Updated Proposed DIPC Agenda" OnClick="btnupdatestatus_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                     ...
                     <tr>
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7" id="tblselection" runat="server">
                                            <asp:Button ID="btnprint" runat="server"  CssClass="btn btn-primary" Visible="false" Text="Print Agenda" OnClientClick="javascript:Panel1()" />  &nbsp; &nbsp;
                                        </td>
                                    </tr>
                    <tr>
