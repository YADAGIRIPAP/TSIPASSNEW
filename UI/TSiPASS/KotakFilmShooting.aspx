<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakFilmShooting.aspx.cs" Inherits="UI_TSiPASS_KotakFilmShooting" %>
...
<head runat="server">
    ...
    <body>
 <form method="post" name="customerData" action="ccavRequestHandlerFilmShooting.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerFilmShooting.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentFilmShooting.aspx" />
                </td>
            </tr>
            <tr>
                <td>
