...
public partial class UI_TSiPASS_ProformaApplicantTransportDuty : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsnew = Gen.GetSLCDetails(incentiveid, "20");
        ...
        dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "20", "0", "", "INTIMATION");
    ...
    public void fillSLCDetails(DataSet ds)
    {
        ...
        if (ds != null && ds.Tables.Count > 1 && ds.Tables[1] != null && ds.Tables[1].Rows.Count > 0)
        {
            ...
            if (Request.QueryString["Scheme"] != null)
            {
                ...
                if (IncentiveName.Contains("Coal") && scheme.Contains("IDEA"))
                {
