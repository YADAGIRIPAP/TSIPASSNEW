<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="IncentiveMISPendencyReportDrillCOI.aspx.cs" EnableEventValidation = "false" Inherits="UI_TSiPASS_IncentiveMISPendencyReportDrillCOI" %>
                                             ...
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" Text="View"
                                                        Target="_blank" NavigateUrl='<%# string.Format("~/UI/TSiPASS/ApplicantIncentiveDtlsDraftView.aspx?EntrpId={0}&Sts=1",Eval("ENTERPERINCENTIVEID")) %>'>
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
