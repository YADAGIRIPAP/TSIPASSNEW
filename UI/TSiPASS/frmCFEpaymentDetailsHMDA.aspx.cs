...
public partial class UI_TSiPASS_frmCFEpaymentDetailsHMDA : System.Web.UI.Page
{
    int delete = 0;
    ...
    public void filldetails()
    {
        ...
        if (ddlpaymentType.SelectedValue.ToString() == "O")
        {
            ...
            ds = GetcfepaydetailsNew(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), FromdateforDB, TodateforDB, ddlBank.SelectedValue, "CFE");
        ...
        {
            // ds = Gen.Getpaymentdetailslats(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), txtfromDate.Text, txttoDate.Text);
            ds = GetcfepaydetailsNew(ddlDepartment.SelectedValue.ToString(), txtUidno.Text, txtNameOfUnit.Text, ddldistrict.SelectedValue.ToString(), ddlpaymentType.SelectedValue.ToString(), txtfromDate.Text, txttoDate.Text, "", "CFE");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                grdDetails.DataSource = ds.Tables[0];
                grdDetails.DataBind();
    ...
    public DataSet GetcfepaydetailsNew(string intDeptid, string UID_No, string nameofunit, string District, string paymentmode, string fromdate, string todate, string BankName, string ApplicationType)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_PAYMENT_ABSTRACT_DTLS_ONLINE_HMDA", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
