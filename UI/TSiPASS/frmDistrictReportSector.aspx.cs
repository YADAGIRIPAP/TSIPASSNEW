...
public partial class UI_TSiPASS_frmDistrictReportSector : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Granite and Stone Crushing" + "&district=" + district;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Cement, Cement & Concrete Products, Fly Ash Bricks" + "&district=" + district;
            }

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Others" + "&district=" + district;
            }

            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Thermal Power Plant" + "&district=" + district;
            }

            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Plastic and Rubber" + "&district=" + district;
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Aerospace and Defence" + "&district=" + district;
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Electrical and Electronic Products" + "&district=" + district;
            }
            HyperLink h8 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "R&D" + "&district=" + district;
            }
            HyperLink h9 = (HyperLink)e.Row.Cells[10].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Engineering" + "&district=" + district;
            }
            HyperLink h10 = (HyperLink)e.Row.Cells[11].Controls[0];
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "DEFENCE EQUIPMENT" + "&district=" + district;
            }
            HyperLink h11 = (HyperLink)e.Row.Cells[12].Controls[0];
            if (h11.Text != "0")
            {
                h11.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Paper and Printing" + "&district=" + district;
            }
            HyperLink h12 = (HyperLink)e.Row.Cells[13].Controls[0];
            if (h12.Text != "0")
            {
                h12.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Textiles" + "&district=" + district;
            }
            HyperLink h13 = (HyperLink)e.Row.Cells[14].Controls[0];
            if (h13.Text != "0")
            {
                h13.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Real Estate,Industrial Parks and IT Buildings" + "&district=" + district;
            }
            HyperLink h14 = (HyperLink)e.Row.Cells[15].Controls[0];
            if (h14.Text != "0")
            {
                h14.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Solar and Other Renewable Energy" + "&district=" + district;
            }
            HyperLink h15 = (HyperLink)e.Row.Cells[16].Controls[0];
            if (h15.Text != "0")
            {
                h15.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Agro based incl Cold Storages" + "&district=" + district;
            }
            HyperLink h16 = (HyperLink)e.Row.Cells[17].Controls[0];
            if (h16.Text != "0")
            {
                h16.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Automobile" + "&district=" + district;
            }
            HyperLink h17 = (HyperLink)e.Row.Cells[18].Controls[0];
            if (h17.Text != "0")
            {
                h17.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Wood and Leather" + "&district=" + district;
            }
            HyperLink h18 = (HyperLink)e.Row.Cells[19].Controls[0];
            if (h18.Text != "0")
            {
                h18.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Food Processing" + "&district=" + district;
            }
            HyperLink h19 = (HyperLink)e.Row.Cells[20].Controls[0];
            if (h19.Text != "0")
            {
                h19.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Beverages" + "&district=" + district;
            }
            HyperLink h20 = (HyperLink)e.Row.Cells[21].Controls[0];
            if (h20.Text != "0")
            {
                h20.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "IT SERVICES" + "&district=" + district;
            }
            HyperLink h21 = (HyperLink)e.Row.Cells[22].Controls[0];
            if (h21.Text != "0")
            {

                h21.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Fertlizers Organic and Inorganic,Pesticides,Insecticides, and Other Related" + "&district=" + district;
            }
            HyperLink h22 = (HyperLink)e.Row.Cells[23].Controls[0];
            if (h22.Text != "0")
            {
                h22.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "Pharmaceuticals and Chemicals" + "&district=" + district;
            }
            HyperLink h23 = (HyperLink)e.Row.Cells[24].Controls[0];
            if (h23.Text != "0")
            {
                h23.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "TOTALUNITS" + "&district=" + district;
            }

            HyperLink h25 = (HyperLink)e.Row.Cells[25].Controls[0];
            if (h25.Text != "0")
            {
                h25.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "TOTALUNITS" + "&district=" + district;
            }

            HyperLink h26 = (HyperLink)e.Row.Cells[26].Controls[0];
            if (h26.Text != "0")
            {
                h26.NavigateUrl = "frmDistrictReportSectorDRILLDOWN.aspx?fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&polcategory=" + "TOTALUNITS" + "&district=" + district;
            }
