<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveDisbursmentMISPendencyReportDrill.aspx.cs" Inherits="UI_TSiPASS_IncentiveDisbursmentMISPendencyReportDrill" %>
                    ...
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">INCENTIVE MIS PENDENCY REPORT (SANCTION) - DISTRICT WISE</asp:Label>&nbsp; <a id="A1" href="#"
                                onserverclick="A1_ServerClick" runat="server">
                                <img src="../../Resource/Images/pdf-icon.png" width="20px;" height="20px;" style="float: right;"
                                    alt="PDF" /></a>
                            <a id="A2" href="#" onserverclick="A2_ServerClick" runat="server">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 95%; font-family: 'Trebuchet MS'">
                            <tr id="trFilter" runat="server">
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%;display:none;">
                            ...
                            <tr id="div_Print" runat="server">
                                <td align="center" style="text-align: center;" valign="top">
                                    <asp:GridView ID="grdDetails" CssClass="floatThead-table" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                             ...
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="View" Visible="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" Text="View" Target="_blank" NavigateUrl='<%# Eval("ENTERPERINCENTIVEID", "ApplicantIncentiveDetailsView.aspx?EntrpId={0}") %>'>
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
