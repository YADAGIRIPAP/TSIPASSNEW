<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmVATExportGMUpdated.aspx.cs" Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">TS Exporters</a>
                    </li>
                </ol>
            </div>
            <div align="left">
                                                    ...
                                                    <table cellpadding="7" cellspacing="7" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                &nbsp;</td>
                                                            <td>
                                                                <asp:Label ID="Label384" runat="server" CssClass="LBLBLACK" Width="180px" 
                                                            ...
                                                            <td valign="top">
                                                                <asp:DropDownList ID="ddlStatus" runat="server" class="form-control txtbox" 
                                                                    Height="33px" TabIndex="1" Width="170px" Visible="False">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" colspan="3" style="text-align: center">
                                                                <asp:Button ID="BtnSave2" runat="server" CausesValidation="False" 
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="States_exported_to" HeaderText="States exported to" />
                                                             <asp:BoundField DataField="Countries_exported_to" HeaderText="Countries exported to" />
                                                            <asp:BoundField DataField="Commodity" 
                                                                ...
                                                                HeaderText="EPC" />
                                                            <asp:HyperLinkField HeaderText="View" Text="Attachment" />
