...
public partial class UI_TSiPASS_frmCFEpaymentDetailsKotakSplit : System.Web.UI.Page
{
    ...
    public void filldetails()
    {
        ...
        if (ddlmodule.SelectedValue == "DRigs" || ddlmodule.SelectedValue == "GW")
        {
            if (ddldistrict.SelectedValue == "--Select--")
            {
                lblmsg0.Text = "<font color='red'>Please Select District Name..!</font>";
    ...
    public DataSet GetcfepaydetailsNewKotakSplit(string intDeptid, string UID_No, string nameofunit, string District, string paymentmode, string fromdate, string todate, string BankName, string ApplicationType)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_PAYMENT_ABSTRACT_DTLS_ONLINE_KOTAKSPLIT", con.GetConnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    protected void btntransfer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (selectioncount == 0)
            {
                lblmsg0.Text = "<font color='red'>Please Select Atleast one Department for Approval ..!</font>";
                success.Visible = false;
                Failure.Visible = true;
                return;
            }
         ...
         //           ServicePointManager.Expect100Continue = true;
         //           ServicePointManager.SecurityProtocol = (SecurityProtocolType)3072;
         //           string RequestStringReversal = Reversal(ArgMessageId, "THRSTRAVEL", ArgPaymentDt);//("Split20181102123553", "TSIPASS", "2018-11-02");
         //           //Logfile(ConfigPath, "CallPayment Request : " + RequestString);

         //           String data = RequestStringReversal; /*request packet needs to be entered here*/
         //           String key = "e9d2a40e09d8448b925e5c479a0db1d3";//key 
         //           String encrypted = EncryptData(data, key);
         ...
         //       }
                ...
                //    //HttpWebRequest requestreversal = (HttpWebRequest)WebRequest.Create("https://apigwuat.kotak.com:8443/cms_generic_service");
                //    HttpWebRequest requestreversal = (HttpWebRequest)WebRequest.Create("https://apigw.kotak.com:8443/v1/cms/rev");
                //    requestreversal.UserAgent = "Apache-HttpClient/4.1.1 (java 1.5)";
                //    requestreversal.Method = "POST";
                //    ServicePointManager.Expect100Continue = true;
                //    ServicePointManager.SecurityProtocol = (SecurityProtocolType)3072;
