...
public partial class UI_TSiPASS_frmBankRegistrationDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmBankRegistrationReport.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    void FillDetails()
    {
        ...
        ds = GetBankerApplicationsDrill(FromdateforDB, TodateforDB, district);
    ...
    public DataSet GetBankerApplicationsDrill(string fromdate, string todate, string district)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTWISE_BANKREGISTRATION_DRILLDOWN", pp);
        return Dsnew;
    }
}