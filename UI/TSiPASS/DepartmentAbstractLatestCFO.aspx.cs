...
public partial class FrmUsers : System.Web.UI.Page
{
    ...
    public void FillGrid()
    {
        ...
        {
            vehicleDS = tran1.DeptReportDepartmentWise_NewpdfCFO(Session["DistrictID"].ToString().Trim(), "%", FromdateforDB, TodateforDB);

        }
        else
        {
            vehicleDS = tran1.DeptReportDepartmentWise_NewpdfCFO("%", "%", FromdateforDB, TodateforDB);
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=4&Type=Total&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=2&Type=Total&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=1&Type=Within Three Days&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=1&Type=Beyond Three Days&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text; ;
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=5&Type=Total&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text; ;
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=3&Type=Total&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text; ;
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                
                h7.NavigateUrl = "frmDeptstatusbytype1CFO.aspx?Id=" + Service_id + "&Status=2&Type=Within time limits&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            }
            HyperLink h8 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "frmDeptstatusbytype1CFO.aspx?Id=" + Service_id + "&Status=2&Type=Beyond time limits&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            }
            HyperLink h9 = (HyperLink)e.Row.Cells[10].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "frmDeptstatusbytype1CFO.aspx?Id=" + Service_id + "&Status=1&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text ;
            }
            HyperLink h10 = (HyperLink)e.Row.Cells[11].Controls[0];
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "frmDeptstatusbytype1CFO.aspx?Id=" + Service_id + "&Status=3&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text ;
            }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=4&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=2&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=1&Type=Within Three Days&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            ...
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=1&Type=Beyond Three Days&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            ...
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=5&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
            ...
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDeptstatusbytypeCFO.aspx?Id=" + Service_id + "&Status=3&Type=Total&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
