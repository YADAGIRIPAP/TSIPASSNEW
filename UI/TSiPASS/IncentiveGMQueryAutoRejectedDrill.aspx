<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveGMQueryAutoRejectedDrill.aspx.cs" Inherits="UI_TSiPASS_IncentiveGMQueryAutoRejectedDrill" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">INCENTIVE APPLICATION DETAILS</asp:Label>&nbsp;
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td style="text-align: left">
                                                <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/IncentiveMISPendencyReport.aspx"
                                                    Text="<< Back">
                                                </asp:HyperLink>
                                            </td>
                                        </tr>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                             ...
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink1" runat="server" Text="View"
                                                        Target="_blank" NavigateUrl='<%# string.Format("~/UI/TSiPASS/ApplicantIncentiveDetailsViewCOI.aspx?EntrpId={0}&Role={1}&IncName={2}&Sts=10&SVCStatus=PRESVC",Eval("ENTERPERINCENTIVEID"),"",Eval("Incentive Name")) %>'>
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
