...
public partial class UI_TSiPASS_CFEAllapprovalsIssuedwithFeedetails : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = FetchTotalDistrictwise_New_New(FromdateforDB, TodateforDB);
    ...
    public DataSet FetchTotalDistrictwise_New_New(string fromdate, string todate)
    {
        ...
        try
        {
            da = new SqlDataAdapter("SP_GET_ALLAPPROVALS_FEE_DETAILS", con.GetConnection);
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=TGiPASS-Application wise report with fee details.xlsx");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        Government.Visible = true;
        divPrint1.Style["width"] = "680px";
    ...
    protected void BtnPDF_Click(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.ContentType = "application/pdf";
                Response.AddHeader("content-disposition", "attachment;filename=TGiPASS-Application wise report with fee details" + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label lblFeedetails = (Label)e.Row.FindControl("lblFeedetails");
            string feedtls = lblFeedetails.Text.ToString().ToUpper();
            lblFeedetails.Text = FormatText(feedtls);
        }
    }
    public string FormatText(object dataItem)
    {
