<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="addoflineCFO.aspx.cs" 
    MasterPageFile="~/UI/TSiPASS/CCMaster.master" Inherits="UI_TSIPASS_addoflineCFO" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
          <ContentTemplate>
                <h3 class="panel-title">
                            Add offline data for incentives - CFO</h3>
                                ...
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" class="nav-justified">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style4" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlProp_intDistrictid" runat="server" AutoPostBack="True" class="form-control txtbox" Height="33px"  Width="180px" OnSelectedIndexChanged="ddlProp_intDistrictid_SelectedIndexChanged1">
