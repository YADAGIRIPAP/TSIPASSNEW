<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDistRefChangePassword.aspx.cs" MasterPageFile="~/UI/TSiPASS/OtherServiceMaster.master" Inherits="UI_TSiPASS_frmDistRefChangePassword" %>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <table align="center" cellpadding="10" cellspacing="5" style="width: 80%">
                                    <tr id="hidetablepassword" runat="server">
                                    ...
                                    <tr id="trchangepewmessage" runat="server" visible="false">
                                        <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                            <span style="font-weight: bold; font-size: 15pt">Please Click Here 
                                                <asp:HyperLink ID="HyperLink1" NavigateUrl="~/DistOtherServicesLogin.aspx" runat="server">Click </asp:HyperLink>
