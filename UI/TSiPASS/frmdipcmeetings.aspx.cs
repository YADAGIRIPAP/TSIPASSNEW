...
public partial class UI_TSIPASS_frmdipcmeetings : System.Web.UI.Page
{
    int Yet_to_Start1, DipcTotal;
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            int Yet_to_StartA = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "NOofMeetings"));
            Yet_to_Start1 = Yet_to_StartA + Yet_to_Start1;

            int DipcTotal2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "DIPCPendingList"));
            DipcTotal = DipcTotal2 + DipcTotal;
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmdipcmeetindsDrill.aspx?status=A&District=" + lblDISTID.Text.Trim() + "&Year=" + ddlConnectLoad.SelectedValue;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[3].Text = DipcTotal.ToString();
        }
    }
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            string tcMergePackage = "Report for the Financial Year : " + ddlConnectLoad.SelectedItem.Text;
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R3: DIPC Meetings\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            tablenew.TotalWidth = document.PageSize.Width - 160f;
    ...
    public DataSet GetAppealApplications(string financialYear, string District)
    {
        DataSet Dsnew = new DataSet();
        ...
        pp[0].Value = financialYear;
        pp[1].Value = District;

        Dsnew = gen.GenericFillDs("USP_GET_DIPC_MEETINGS_ABSTRACT_NEW", pp);
        return Dsnew;
    }
}