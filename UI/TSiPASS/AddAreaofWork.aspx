<%@ Page Title=":: TSiPASS : Add Areas of work " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="AddAreaofWork.aspx.cs" Inherits="AddQualiication" %>
...
function OpenPopup() 
 
   {
       ...
       window.open("Lookups/LookupAreaWork1.aspx", "List", "scrollbars=yes,resizable=yes,width=920,height=650;display = block;position=absolute");
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Type of Work
                            </li>
                        </ol>
     </div>
<div align="center">
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Type of Work</h3>
                            </div>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 80%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label303" runat="server" CssClass="LBLBLACK" Width="165px">Type of Work</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtarea" oncopy="return false" oncut="return false" 
                                                            onpaste="return false" runat="server" class="form-control txtbox" 
                                                            Height="48px" MaxLength="50" onkeypress="Names()" TabIndex="1" 
                                                            ValidationGroup="group" Width="230px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                            ControlToValidate="txtarea" 
                                                            ValidationGroup="group" ErrorMessage="Please Enter Areas Of Work">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
