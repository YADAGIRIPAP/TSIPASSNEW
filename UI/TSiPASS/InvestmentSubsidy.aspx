<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="InvestmentSubsidy.aspx.cs" Inherits="UI_TSiPASS_IncentivesAnnexure_InvestmentSubsidy" %>
                                    ...
                                    <td style="padding: 5px; margin: 5px" valign="top">
                                        <table cellpadding="4" cellspacing="5" style="width: 80%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" style="padding: 5px; margin: 5px; text-align: left; font-weight: bold">Incentives Applied for (in Rs.) on fixed capital investment</td>
                                            </tr>
                                            <tr id="trschemeEligible" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.1
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Scheme eligible<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtSchemeEligible" runat="server" class="form-control txtbox" onkeypress="Names()"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" Visible="false"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="txtSchemeEligible"
                                                        ErrorMessage="Please enter  S/O  Promoter" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trgenSC1" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.1
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Investment Subsidy<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtAppldInvestSubsidy" runat="server" class="form-control txtbox" onkeypress="inputOnlyNumbers(evt)"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" AutoPostBack="True" OnTextChanged="txtAppldInvestSubsidy_TextChanged"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtAppldInvestSubsidy"
                                                        ErrorMessage="Please enter  S/O  Promoter" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trSC1" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.3
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Additional amount for Women<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtAppldAddlAmtWomen" runat="server" class="form-control txtbox" onkeypress="inputOnlyNumbers(evt)"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" AutoPostBack="True" OnTextChanged="txtAppldAddlAmtWomen_TextChanged"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtAppldAddlAmtWomen"
                                                        ErrorMessage="Please enter  S/O  Promoter" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trSC2" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.4
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">An additional investment subsidy for SC/ST entrepreneurs<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtISCSCT" runat="server" class="form-control txtbox" onkeypress="inputOnlyNumbers(evt)"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" AutoPostBack="True" OnTextChanged="txtISCSCT_TextChanged"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtISCSCT"
                                                        ErrorMessage="Please enter additional investment subsidy for SC/ST entrepreneurs" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trSC3" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">1.5
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">A<span>dditional investment subsidy for Women entrepreneurs set up in Scheduled areas</span><font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtScheduledAreas" runat="server" class="form-control txtbox" onkeypress="inputOnlyNumbers(evt)"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px" AutoPostBack="True" OnTextChanged="txtScheduledAreas_TextChanged"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtScheduledAreas"
                                                        ErrorMessage="Please enter  investment subsidy for Women entrepreneurs set up in Scheduled areas" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">&nbsp;</td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Total Investment Subsidy<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:TextBox ID="txtAppldTotInvestSubsidy" Enabled="false" runat="server" class="form-control txtbox" onkeypress="inputOnlyNumbers(evt)"
                                                        Height="28px" MaxLength="30" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAppldTotInvestSubsidy"
                                                        ErrorMessage="Please enter  S/O  Promoter" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trex1" runat="server">
                                                <td style="padding: 5px; margin: 5px; width: 5px; text-align: left; font-weight: bold; text-align: left" valign="middle">2</td>
                                                <td colspan="8" style="font: bold; font-weight: bold">Subsidy Already availed i.r.o Expansion / Diversification</td>
                                            </tr>
                                            <tr id="trex2" runat="server">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">2.1
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Scheme <font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                    <asp:TextBox ID="txtAvldSubsidyScheme" runat="server" class="form-control txtbox" Height="28px"
                                                        MaxLength="40" onkeypress="inputOnlyNumbers(evt)" TabIndex="1" ValidationGroup="group" Width="180px" Visible="false"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px; width: 10px;">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAvldSubsidyScheme"
                                                        ErrorMessage="Please enter Industries Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr id="trex3" runat="server">
                                                <td style="padding: 5px; margin: 5px; text-align: center;" valign="middle">2.2
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">Amount in Rs.<font color="red">*</font>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">:
                                                </td>
                                                <td style="padding: 5px; margin: 5px; text-align: left;">
                                                    <asp:TextBox ID="txtAvldSubsidyAmt" runat="server" class="form-control txtbox"
                                                        Height="28px" MaxLength="40" onkeypress="inputOnlyNumbers(evt)" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAvldSubsidyAmt"
                                ...
                                <tr>
                                    <td colspan="4" style="padding: 5px; margin: 5px; text-align: center;">
                                        <table style="width: 80%">
                                            <tr>
                                                <td colspan="4" align="left" style="padding: 5px; margin: 5px; font-weight: bold" valign="middle">Enclosures</td>
                                            </tr>
                                            <tr>
                                                <td style="border: solid thin white; background: #013161; color: white" align="center">Sl.No</td>
                                                <td style="border: solid thin white; background: #013161; color: white" align="center">Document Name</td>
                                                <td style="border: solid thin white; background: #013161; color: white" align="center">Upload Document</td>
                                                <td style="border: solid thin white; background: #013161; color: white" align="center">File Name</td>
                                            </tr>
                                            <tr id="trEnclosures" runat="server">
                                                <td align="center" style="border: solid thin black; background: white; color: black">1</td>
                                                <td align="left" style="border: solid thin black; background: white; color: black">Civil engineers certificate as per format<br />
                                                    <asp:HyperLink ID="HyperLinkCivilEngineersFormat" runat="server" Visible="true" CssClass="LBLBLACK" Width="300px" Target="_blank" NavigateUrl="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/Civil Engineers Certificate Format.pdf">Click here for Prescribed Format</asp:HyperLink>
                                                </td>
                                                <td align="left" style="border: solid thin black; background: white; color: black">
                                                    ...
                                                    <asp:Button ID="btnUpload1" runat="server" Text="Click here to Upload" OnClick="btnUpload1_Click" /></td>
                                                <td align="center" style="border: solid thin black; background: white; color: black">
                                                    <asp:HyperLink ID="lblUpload1" runat="server" CssClass="LBLBLACK" Width="165px"
                                            ...
                                            <tr id="tr1" runat="server">
                                                ...
                                                <td align="left" style="border: solid thin black; background: white; color: black">Statement of accounts in respect of aided enterprises as per format<br />
                                                    <asp:HyperLink ID="HypLnkStatementofaccounts" runat="server" Visible="true" CssClass="LBLBLACK" Width="300px" Target="_blank" NavigateUrl="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/StatementofAccountsFormat for Aided Enterprises.pdf">Click here for Prescribed Format</asp:HyperLink>
                                                </td>
                                                <td align="left" style="border: solid thin black; background: white; color: black">
                                                    <asp:FileUpload ID="fuDocuments2" runat="server" CssClass="CS" />
                                                    <asp:Button ID="btnUpload2" runat="server" Text="Click here to Upload" OnClick="btnUpload2_Click" /></td>
                                                <td align="center" style="border: solid thin black; background: white; color: black">
                                                    <asp:HyperLink ID="lblUpload2" runat="server" CssClass="LBLBLACK" Width="165px"
                                                        Target="_blank"></asp:HyperLink>
                                            ...
                                            <tr id="tr2" runat="server">
                                                <td align="center" style="border: solid thin black; background: white; color: black">2</td>
                                                <td align="left" style="border: solid thin black; background: white; color: black">C.A. Certificate as per Prescribed format<br />
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Visible="true" CssClass="LBLBLACK" Width="300px" Target="_blank" NavigateUrl="viewpdf.aspx?filepathnew=D:/TS-iPASSFinal/docs/IS CA Format.pdf">Click here for Prescribed Format</asp:HyperLink>
                                                </td>
                                                <td align="left" style="border: solid thin black; background: white; color: black">
                                                    <asp:FileUpload ID="fuDocuments3" runat="server" CssClass="CS" />
                                                    <asp:Button ID="btnUpload3" runat="server" Text="Click here to Upload" OnClick="btnUpload3_Click" /></td>
                                                <td align="center" style="border: solid thin black; background: white; color: black">
                                                    <asp:HyperLink ID="lblUpload3" runat="server" CssClass="LBLBLACK" Width="165px"
                                                        Target="_blank"></asp:HyperLink>
