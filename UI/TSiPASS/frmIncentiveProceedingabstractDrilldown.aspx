<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmIncentiveProceedingabstractDrilldown.aspx.cs" EnableEventValidation = "false" Inherits="UI_TSIPASS_frmIncentiveProceedingabstractDrilldown" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            ...
                            <a id="A1" href="#"  onserverclick="BtnSave3_Click"  runat="server">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%; font-family: 'Trebuchet MS'">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/frmIncentiveProceedingabstract.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
