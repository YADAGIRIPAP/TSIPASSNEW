<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmCFONEFTPayment.aspx.cs" Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">CFO Payment</a> </li>
                </ol>
            </div>
            <div align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                                <asp:TextBox ID="txtnameofUnit" runat="server" class="form-control txtbox" Height="28px"
                                                                    MaxLength="40" TabIndex="0" Width="180px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                                <asp:DropDownList ID="ddlLand_intDistrictid" runat="server" AutoPostBack="True" class="form-control txtbox"
                                                                    Height="33px" TabIndex="2" Width="180px" OnSelectedIndexChanged="ddlLand_intDistrictid_SelectedIndexChanged">
                                                ...
                                                <td valign="top">
                                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px;">
                                                                <asp:Label ID="Label426" runat="server" CssClass="LBLBLACK" Width="150px">Mandal</asp:Label>
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                :
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                <asp:DropDownList ID="ddlProp_intMandalid" runat="server" class="form-control txtbox"
                                                                    Height="33px" Width="180px" TabIndex="4">
                                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;" align="center" colspan="3">
                                                                <asp:Button ID="BtnSearch" runat="server" CssClass="btn btn-primary" Height="32px"
                                                                    OnClick="BtnSave_Click" TabIndex="5" Text="Search" ValidationGroup="group" Width="90px" />
                                                                &nbsp;
                                                                <asp:Button ID="BtnCancel" runat="server" CausesValidation="False" CssClass="btn btn-warning"
                                                                    Height="32px" OnClick="BtnClear_Click" TabIndex="6" Text="Cancel" ToolTip="To Clear  the Screen"
                                                                    Width="90px" />
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                &nbsp;
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top" colspan="3">
                                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                        ...
                                                        PageSize="30" ShowFooter="True" Width="100%" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="nameofunit" HeaderText="Name of Unit"></asp:BoundField>
                                                            <asp:BoundField DataField="UID_No" HeaderText="UID Number"></asp:BoundField>
