...
public partial class UI_TSiPASS_frmCheckDetailsprint_ROLLBACKEDCASES : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ds2 = gen.GenericFillDs("USP_GET_RELEASE_PROCEEDING_NOS_LIST", pp);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("CheckListPrint_ROLLBACKED.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&Date=" + txtsvcdate.Text.Trim() + "&SubIncTypeId=" + lblsubInctypeid + "&RlsProceedNo=" + ddlReleaseProceedingNo.Text + "&DIPC=" + DIPCFlag
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        ds = getincentiveslclistWorkigngListcheck_ROLLBACKEDCASES(ProposedDate, DIPCFlag, FromDate, ToDate, ddlworkingstatus.SelectedValue);
    ...
    public DataSet getincentiveslclistWorkigngListcheck_ROLLBACKEDCASES(string date, string DIPCFlag, string fromdate, string todate, string WORKINGSTATUS)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        try
        {
            da = new SqlDataAdapter("USP_GET_LIST_INCENTIVEWISE_WORKING_ABSTRACT_PRINTEDDATE_Working_ROLLBACKEDCASES", con.GetConnection);
