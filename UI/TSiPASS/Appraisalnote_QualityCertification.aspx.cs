...
public partial class UI_TSiPASS_Appraisalnote_QualityCertification : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["uid"] != null)
            {
                //// 11 txtgmRecommend.Text = "123";
                //txtINCNoEntry.Text = "40523";
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.MstIncentiveId = Request.QueryString["MstIncentiveId"].ToString();
            ...
            fromvo.Recomamount = oIncentiveVosA.ELEGIBLEWHICHEVERLESS;
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_QUALITYCERTIFICATION]";
            ...
            // -----------=====---------------
            if (oIncentiveVosA.QUALITYCERTIFICATIONCHARESPAID != null)
                com.Parameters.AddWithValue("@QUALITYCERTIFICATIONCHARESPAID", oIncentiveVosA.QUALITYCERTIFICATIONCHARESPAID);
            if (oIncentiveVosA.FIFTYPEROFCHARGESPAID != null)
                com.Parameters.AddWithValue("@FIFTYPEROFCHARGESPAID", oIncentiveVosA.FIFTYPEROFCHARGESPAID);
            if (oIncentiveVosA.ELIGIBLEVALUE != null)
                com.Parameters.AddWithValue("@ELIGIBLEVALUE", oIncentiveVosA.ELIGIBLEVALUE);
            if (oIncentiveVosA.GMValue != null)
                com.Parameters.AddWithValue("@GMValue", oIncentiveVosA.GMValue);
            if (oIncentiveVosA.ELEGIBLEWHICHEVERLESS != null)
                com.Parameters.AddWithValue("@ELEGIBLEWHICHEVERLESS", oIncentiveVosA.ELEGIBLEWHICHEVERLESS);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.MstIncentiveId = Request.QueryString["MstIncentiveId"].ToString();
        oIncentiveVosA.QUALITYCERTIFICATIONCHARESPAID = Convert.ToDecimal(txtqualitycertificationcharges.Text);
        oIncentiveVosA.FIFTYPEROFCHARGESPAID = Convert.ToDecimal(txtfiftyperofchargespaid.Text);
        oIncentiveVosA.ELIGIBLEVALUE = Convert.ToDecimal(txteligiblevalue.Text);
        oIncentiveVosA.GMValue = Convert.ToDecimal(txtgmRecommend.Text);
        oIncentiveVosA.ELEGIBLEWHICHEVERLESS = Convert.ToDecimal(txteligiblelessvalue.Text);
    ...
    public class IncentiveVosAppraisalStamp
    {
        ...
        public Decimal? QUALITYCERTIFICATIONCHARESPAID { get; set; }
        public Decimal? FIFTYPEROFCHARGESPAID { get; set; }
        public Decimal? ELIGIBLEVALUE { get; set; }
        public Decimal? GMValue { get; set; }
        public Decimal? ELEGIBLEWHICHEVERLESS { get; set; }
    ...
    public string ValidateControls()
    {
        ...
        if (txtqualitycertificationcharges.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please enter Quality Certification Charges Paid\\n";
            slno = slno + 1;
        }
        return ErrorMsg;
    }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=11");
        }
    ...
    protected void rdeligibility_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rdeligibility.SelectedValue != "")
            {
                ...
                if (rdeligibility.SelectedValue == "Regular")
                {
                    txteligiblevalue.Text = txtfiftyperofchargespaid.Text;
                }
                else if (rdeligibility.SelectedValue == "Belated")
                {
                    txteligiblevalue.Text = (Convert.ToDecimal( txtfiftyperofchargespaid.Text)/2).ToString();
                }
                else if (rdeligibility.SelectedValue == "OneYear")
                {
                    txteligiblevalue.Text = "0";
                }

            }
            if(txteligiblevalue.Text!="")
            {
                if(Convert.ToDecimal(txteligiblevalue.Text)< Convert.ToDecimal(txtgmRecommend.Text))
                {
                    txteligiblelessvalue.Text = txteligiblevalue.Text;
                }
                else
                {
                    txteligiblelessvalue.Text = txtgmRecommend.Text;
                }
            }
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        //string serverpath = System.IO.Path.Combine(sFileDir + "\\ADWORKSHEET_QUALITY" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_QUALITY" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111118", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    protected void txtqualitycertificationcharges_TextChanged(object sender, EventArgs e)
    {
        txtfiftyperofchargespaid.Text = (Convert.ToDecimal(txtqualitycertificationcharges.Text) / 2).ToString();
