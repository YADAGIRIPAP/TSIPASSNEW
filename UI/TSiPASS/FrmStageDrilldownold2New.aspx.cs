...
public partial class UI_TSiPASS_FrmStageDrilldownold2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchProgresswiseDrildownnew(ddlType.SelectedValue, Request.QueryString[2].ToString().Trim(), FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
        // lblMsg.Text = "";
        if (dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            grdDetails.DataBind();
            lblHeading.Text = "TSiPASS- Progress Of Implementation - " + Request.QueryString[2].ToString().Trim();
        }
        else
        {
            //lblMsg.Text = "";
