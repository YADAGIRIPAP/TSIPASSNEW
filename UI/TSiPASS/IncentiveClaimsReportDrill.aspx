<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveClaimsReportDrill.aspx.cs" Inherits="UI_TSiPASS_IncentiveClaimsReport" EnableEventValidation = "false" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlManufacture" runat="server" class="form-control txtbox" Width="180px">
                                                        <asp:ListItem>--Select--</asp:ListItem>
                                                        <asp:ListItem>All</asp:ListItem>
