...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalDistrictwise_New(ddlType.SelectedValue);
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalDistrictwise_New(ddlType.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmDistDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];

            h2.NavigateUrl = "FrmDistDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];

            h3.NavigateUrl = "FrmDistDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "District")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmDistDrilldownold2.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&dist=%" ;
