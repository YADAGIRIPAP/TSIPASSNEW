<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleaseProceedingsabstractDistrictwiseSLCDrill.aspx.cs" Inherits="UI_TSIPASS_ReleaseProceedingsabstractDistrictwiseSLCDrill" %>
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%; font-family: 'Trebuchet MS'">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/ReleaseProceedingsabstractDistrictwiseSLC.aspx" Text="<< Back">
                                    </asp:HyperLink>
                                </td>
                            </tr>
