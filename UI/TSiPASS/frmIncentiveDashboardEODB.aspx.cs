...
public partial class UI_TSiPASS_frmIncentiveDashboardEODB : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    public void fillgrid()
    {
        ...
        if (dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            grdDetails.DataBind();
            lblHeadingText.Text = "Incentives Granted Dashboard from " + txtFromDate.Text + " to " + txtTodate.Text + "";
    ...
    public DataSet GetReleaseDashboardApplications(string todate, string fromDate)//, string approvalid, string polcategory, string appltype)
    {
        DataSet Dsnew = new DataSet();
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_INCENTIVE_DASHBOARD_EODB", pp);
        return Dsnew;
