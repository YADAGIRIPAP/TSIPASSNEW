<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CFOMISPendencyReportDrill.aspx.cs" Inherits="UI_TSiPASS_IncentiveClaimsReport" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">CFO PENDENCY REPORT</asp:Label>&nbsp; <a id="A1" href="#"
