<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TourismEventPopUp.aspx.cs" Inherits="UI_TSiPASS_TourismEventPopUp" %>
                        ...
                        <div align="center">
                            <table bgcolor="White" width="100%" border="2px" style="font-family: Verdana; padding: 10px; font-size: x-small;">
                                <tr>
                                    ...
                                    <td>InProgress of  Pre-Scrutiny / Approval / Payment
                                    </td>
                                    <td style="width: 20px; height: 20px; background-color: Green;"></td>

                                    <td>Completed Pre-Scrutiny / Approval / Payment With in Time Limits
                                    </td>
                                    <td style="width: 20px; height: 20px; background-color: #ffa500;"></td>

                                    <td>Offline Approvals
                                    </td>
                                    <td style="width: 20px; height: 20px; background-color: Red;"></td>
                                    <td>Completed Pre-Scrutiny / Approval / Payment Beyond Time Limits / Rejected
                                    </td>
                        ...
                        <div align="center">
                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="OfflineApproval" HeaderText="Approval already obtained offline"></asp:BoundField>
