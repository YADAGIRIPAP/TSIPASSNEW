<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmOtherServiceDepartmentsViewAppl.aspx.cs" Inherits="UI_TSiPASS_frmOtherServiceDepartmentsViewAppl" %>
                                                ...
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="ApplciantName" HeaderText="Name of Industry" Visible="false" />
                                                            <asp:BoundField DataField="Sec_EnterpriseName" HeaderText="Activity Proposed" Visible="false" />
