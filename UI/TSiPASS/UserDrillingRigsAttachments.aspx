<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UserDrillingRigsAttachments.aspx.cs" Inherits="UI_TSiPASS_UserDrillingRigsAttachments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="">
                                <i class="fa fa-fw fa-edit">Drillings Rigs and Hand Bore Sets</i> 
                            </li>
                            <li class="active">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" align="center" class="style7">
                                    &nbsp;<asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                        OnClick="BtnSave_Click" TabIndex="10" Text="Close" ValidationGroup="group" Width="90px"
                                        Visible="False" />
                                </td>
                            </tr>
                            <tr>
