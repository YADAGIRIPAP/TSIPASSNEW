...
public partial class UI_TSiPASS_frmBankReportSMANPADistrictWiseCOIDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmBankReportDistrictWiseCOI.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    void FillDetails()
    {
        ...
        ds = GetBankerApplicationsDrill(FromdateforDB, TodateforDB, district, typeofaccount, Bankname);
    ...
    public DataSet GetBankerApplicationsDrill(string fromdate, string todate, string district, string typeofaccount, string bankname)
    {
        ...
        SqlParameter[] pp = new SqlParameter[] {
             new SqlParameter("@FromDate",SqlDbType.VarChar),
               ...
               new SqlParameter("@DISTRICTID",SqlDbType.VarChar),
                new SqlParameter("@TYPEOFACCOUNT",SqlDbType.VarChar),
        ...
        pp[1].Value = todate;
        pp[2].Value = district;
        pp[3].Value = typeofaccount;
        pp[4].Value = bankname;

        Dsnew = Gen.GenericFillDs("USP_GET_BANKERSMANPA_DISTRICT_DRILLDOWN_COI", pp);
        return Dsnew;
    }
}