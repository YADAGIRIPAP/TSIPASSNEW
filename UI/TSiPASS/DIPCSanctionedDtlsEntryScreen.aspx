<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="DIPCSanctionedDtlsEntryScreen.aspx.cs" Inherits="UI_TSiPASS_DIPCSanctionedDtlsEntryScreen" %>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <table style="width: 100%">
                                <tr>
                                    <td style="font-weight: bold"><asp:Label ID="lblds" runat="server"></asp:Label> Sanctioned Details Entry</td>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlCommittee" runat="server" class="form-control txtbox" Height="33px" ValidationGroup="group"
                                                    ...
                                                    <asp:ListItem Value="2" Text="SLC"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                            ...
                                            <asp:ListItem Value="2" Text="T-PRIDE"></asp:ListItem>--%>
                                                    ...
                                                    <asp:ListItem Value="1" Text="T-IDEA"></asp:ListItem>
                                                    <asp:ListItem Value="4" Text="T-PRIDE"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="IIPP SCheme 2010-15"></asp:ListItem>
                                                    <asp:ListItem Value="3" Text="IIPP Scheme 2005-10"></asp:ListItem>
                                        ...
                                        <tr id="trslc" runat="server" visible="false">
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtunitmobileno" SetFocusOnError="true"
                                                    ErrorMessage="Please enter Mobile Number" ValidationGroup="group" Display="None">*
                                                </asp:RequiredFieldValidator>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: center;" align="center">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; vertical-align: middle;" align="center"></td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center;" align="center">6.</td>
                                            ...
                                            <td style="padding: 5px; margin: 5px; vertical-align: middle;" align="center">7.
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center; height: 60px">8.</td>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: center; vertical-align: middle;" align="center">9.</td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center; height: 60px">10.</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">Is Disabled(PH)<span style="font-weight: bold; color: Red;">*</span>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:RadioButtonList ID="rdl_isph" runat="server" RepeatDirection="Horizontal"
                                                >
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: center; vertical-align: middle;" align="center"></td>
                                            <td class="style36" style="padding: 5px; margin: 5px; text-align: left; vertical-align: middle;" width="15%">
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator70" runat="server" ControlToValidate="ddlUnitDIst"
                                                    InitialValue="--District--" SetFocusOnError="true" ErrorMessage="Please Enter Unit District" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator41" runat="server" ControlToValidate="ddlUnitMandal"
                                                    ErrorMessage="Please Select Unit Mandal" InitialValue="--Mandal--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left; vertical-align: middle;"></td>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator43" runat="server" ControlToValidate="ddlVillageunit"
                                                    ErrorMessage="Please Select Unit Village" InitialValue="--Village--" SetFocusOnError="true"
                                                    ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center;" align="center">&nbsp;</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="style36">Mobile Number<span style="font-weight: bold; color: Red;">&nbsp; *</span>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtunitmobileno" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="10" onkeypress="return inputOnlyNumbers(event)" TabIndex="17" ValidationGroup="group" Width="180px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtunitmobileno" SetFocusOnError="true"
                                                    ErrorMessage="Please enter Mobile Number" ValidationGroup="group" Display="None">*
                                                </asp:RequiredFieldValidator>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: center;" align="center">&nbsp;</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="style36">Email Id<span style="font-weight: bold; color: Red;"> *</span>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtunitemailid" runat="server" class="form-control txtbox" Height="28px"
                                                    TabIndex="18" ValidationGroup="group" Width="180px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtunitemailid" SetFocusOnError="true"
                                                    ErrorMessage="Please Enter Email" ValidationGroup="group" Display="None">*</asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px"></td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK" Width="165px">Bank Name<font color="red"> *</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px" colspan="6">
                                                <asp:DropDownList ID="ddlBank" runat="server" class="form-control txtbox" TabIndex="5" ValidationGroup="group">
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlBank" SetFocusOnError="true"
                                                    ErrorMessage="Please select Bank Name" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: center;">&nbsp;</td>
                                        </tr>
                                        <%--Start 3--%>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: center; vertical-align: middle;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">Type Of Account<span style="font-weight: bold; color: Red;"> *</span>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlAccountType" runat="server" class="form-control txtbox" Visible="true" TabIndex="12" ValidationGroup="group"
                                                    Height="33px" Width="180px" AutoPostBack="True" OnSelectedIndexChanged="ddldistrictunit_SelectedIndexChanged">
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="ddlAccountType" InitialValue="--Select--"
                                                    SetFocusOnError="true" ErrorMessage="Please Select Type Of Account" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: center; vertical-align: middle;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">IFSC Code<span style="font-weight: bold; color: Red;"> *</span>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtIFSCCode" runat="server" class="form-control txtbox" Visible="true" TabIndex="12" ValidationGroup="group"
                                                    Height="33px" Width="180px">
                                                </asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtIFSCCode" SetFocusOnError="true"
                                                ...
                                                <asp:GridView ID="gvincentivedtls" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Sanctioned Amount (In Rs)">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtsanctionAmount" runat="server" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                                                                <itemstyle horizontalalign="Left" width="140px" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="140px" />
                                                        </asp:TemplateField>
