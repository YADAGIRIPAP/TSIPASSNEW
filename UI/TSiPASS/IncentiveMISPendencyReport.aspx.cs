...
public partial class UI_TSiPASS_IncentiveClaimsReport : System.Web.UI.Page
{
    ...
    decimal GMAssignW, GMAssignB, GMAssign90, InspAssignW, InspAssingB, InspAssign90, InspUploadW, InspUploadB, InspUpload90, GMtoCOIW, GMtoCOIB, GMtoCOI90,
        Query, Total, Total90, Noofappsfiled, Deemed;
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[16].Text = Query.ToString();
            e.Row.Cells[16].Controls.Add(Query1);
            ...
            e.Row.Cells[17].Text = Total.ToString();
            e.Row.Cells[17].Controls.Add(Total1);

            Label Total901 = new Label();
            Total901.Text = Total90.ToString();
            e.Row.Cells[18].Text = Total90.ToString();
            e.Row.Cells[18].Controls.Add(Total901);
        }
    }
