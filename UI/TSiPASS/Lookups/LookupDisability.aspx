<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="LookupDisability.aspx.cs" Inherits="LookupDisability" Title=":: TSiPASS Online Management System ::" %>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%" 
                                                ...
                                                <tr __designer:mapid="364">
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="365">
                                                        <asp:Label ID="Label350" runat="server" CssClass="LBLBLACK" Width="165px">Vulnerability</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="367">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="368">
                                                <asp:TextBox ID="txtStName" runat="server" class="form-control txtbox" 
                                ...
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="Disability" HeaderText="Vulnerability" />
                                        </columns>
