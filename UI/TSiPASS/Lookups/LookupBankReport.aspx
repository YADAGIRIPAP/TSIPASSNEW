<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master"
    AutoEventWireup="true" CodeFile="LookupBankReport.aspx.cs" Inherits="LookupBDC"
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                &nbsp;1</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                        <asp:Label ID="Label438" runat="server" CssClass="LBLBLACK" 
                                                    Width="165px">Year</asp:Label>
                                            </td>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px" colspan="5">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="BankR_Year" HeaderText="Year" />
                                            <asp:BoundField DataField="NoofBranches" HeaderText="No of Branches" Visible="false" />
                                            <asp:BoundField DataField="NoofBranchesMandals" HeaderText="No of Branch Mandal" Visible="false" />
                                            <asp:BoundField DataField="NofoBranchesVisited" HeaderText="No of Visited Branches" />
