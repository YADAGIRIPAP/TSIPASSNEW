<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="LookupfrmClosedUnits.aspx.cs" Inherits="LookupBDC" Title=":: TSiPASS Online Management System ::" %>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="width: 200px;">
                                                                <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK" Width="165px">Year<font 
                                        ...
                                        <tr runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label441" runat="server" CssClass="LBLBLACK" Width="165px">HT or LT<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:DropDownList ID="ddlLTHT" runat="server" class="form-control txtbox" 
                                                                    Height="33px" TabIndex="1" Width="180px" 
                                                                    onselectedindexchanged="ddlLTHT_SelectedIndexChanged">
                                                                    <asp:ListItem>--Select--</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:DropDownList ID="ddlMonth" runat="server" class="form-control txtbox" Height="33px"
                                                                    OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged" TabIndex="1" 
                                                                    Width="180px">
                                                                    <asp:ListItem>--Select--</asp:ListItem>
                                        ...
                                        <tr  runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                                <asp:TextBox ID="TxtNameofUnit" runat="server" class="form-control txtbox" 
                                                                    Height="28px" MaxLength="100" onkeypress="Names()" TabIndex="1" 
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                           ...
                                           <asp:BoundField DataField="VI_Year" HeaderText="Year" />
                                            ...
                                            <asp:BoundField DataField="Location" HeaderText="Mandal" />
                                            <asp:BoundField DataField="HTLT" HeaderText="Current HT or LT" />
                                            <asp:BoundField DataField="DateofCloser" HeaderText="DateofCloser" 
DataFormatString="{0:dd/MM/yyyy}" />
                                             <asp:BoundField DataField="BriefReason" HeaderText="Brief Reason" />
                                               <asp:BoundField DataField="OtherRemarks" HeaderText="Other Remarks" />
