<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="LookupDesgination.aspx.cs" Inherits="LookupDesgination" Title=":: TSiPASS Online Management System ::" %>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top">
                                            <table cellpadding="4" cellspacing="5" style="width: 100%" 
                                                ...
                                                <tr __designer:mapid="364">
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="365">
                                                        <asp:Label ID="Label350" runat="server" CssClass="LBLBLACK" Width="165px">Designation</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="367">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="368">
