<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="Loolupunitinspection.aspx.cs" Inherits="LookupWorkActivities" Title=":: TSiPASS Online Management System ::" %>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%" 
                                                ...
                                                <tr __designer:mapid="364">
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="365">
                                                        <asp:Label ID="Label350" runat="server" CssClass="LBLBLACK" Width="165px">Inspection by GM </asp:Label>
                                                    </td>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    Width="165px">Inspections carried out</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
                            ...
                            <tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        onrowdatabound="grdDetails_RowDataBound" PageSize="30" Width="100%">
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="NoofApplicationAssigned" HeaderText="Total no. of Online Applications assigned for" />
                                            <asp:BoundField DataField="InspectionbyGM" HeaderText="Inspection by GM " />
                                            <asp:BoundField DataField="Inspectionscarriedout" HeaderText="Inspections carried out" />
                                            <asp:BoundField DataField="InspectionreporttoGM" HeaderText="Inspection report submitted to GM" />
                                             <asp:BoundField DataField="Inspectionnotdone" HeaderText="Inspection not done" />
