<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="LookupTST.aspx.cs" Inherits="LookupTST" Title=":: TSiPASS Online Management System ::" %>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    Width="165px">TST Name</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtTST" runat="server" class="form-control txtbox" 
                                ...
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            ...
                                            <asp:BoundField DataField="TstName" HeaderText="TST Name" />
                                        </columns>
