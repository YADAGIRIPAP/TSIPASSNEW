<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="LookupfrmadvanceSbsidy.aspx.cs" Inherits="LookupBDC" Title=":: TSiPASS Online Management System ::" %>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        ...
                                        <tr runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:TextBox ID="txtPromoterName" runat="server" 
                                                    class="form-control txtbox" Height="28px"
                                                                  MaxLength="100" onkeypress="Names()" TabIndex="1" ValidationGroup="group"
                                                                    Width="180px" ontextchanged="txtPromoterName_TextChanged"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr runat="server" visible="false">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:DropDownList ID="ddlIPOname" runat="server" Visible="false" class="form-control txtbox" Height="33px"
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                           ...
                                           <asp:BoundField DataField="VI_Year" HeaderText="Year" />
                                             ...
                                             <asp:BoundField DataField="Promoter_Name" HeaderText="Promoter Name" />
                                               <asp:BoundField DataField="CasteA" HeaderText="Caste" />
