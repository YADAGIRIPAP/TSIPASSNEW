<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master"
    AutoEventWireup="true" CodeFile="LookupIpowiseTarget.aspx.cs" Inherits="LookupBDC"
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label2" runat="server" CssClass="LBLBLACK" Width="200px">Month</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            </td>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 200px;">
                                                <asp:Label ID="Label3" runat="server" CssClass="LBLBLACK" Width="210px">Year</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            </td>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px" colspan="5">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="User_id" HeaderText="IPO" />
