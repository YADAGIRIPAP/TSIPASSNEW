<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master"
    AutoEventWireup="true" CodeFile="LookupVehicleInspetion.aspx.cs" Inherits="LookupBDC"
                                ...
                                <td align="center" style="padding: 5px; margin: 5px" colspan="5">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NoofInspected" HeaderText="No of Inspected" />
                                            <asp:BoundField DataField="Noofnotinspected" HeaderText="No of Not Inspected" />
