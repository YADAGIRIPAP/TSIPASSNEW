<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="Bomas.aspx.cs" Inherits="Bomas" Title=":: TSiPASS Online Management System ::" %>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    Width="165px">Boma Name</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
