...
public partial class WorkProposalLookup : System.Web.UI.Page
{
    ...
    void fillgrid()
    {
        ...
        DataSet ds = clsGeneral.getWorkProgressearch(ddlIP.SelectedValue, ddlState.SelectedValue, ddlCounties.SelectedValue, ddlPayam.SelectedValue, ddlBoma.SelectedValue, txtWorkcode.Text,User);
