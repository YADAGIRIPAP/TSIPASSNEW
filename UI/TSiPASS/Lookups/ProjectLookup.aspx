<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master" AutoEventWireup="true" CodeFile="ProjectLookup.aspx.cs" Inherits="ProjectLookup" Title=":: TSiPASS Online Management System ::" %>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%" 
                                                ...
                                                <tr __designer:mapid="1801">
                                                    <td style="padding: 5px; margin: 5px" __designer:mapid="1802">
                                                        <asp:Label ID="Label401" runat="server" CssClass="LBLBLACK" Width="144px">Project Name</asp:Label>
                                                    </td>
...
<asp:BoundField DataField="PrjName" HeaderText="Project Name"></asp:BoundField>
                                            <asp:BoundField DataField="StartDate" HeaderText="Start Date" 
                                                DataFormatString="{0:dd-MM-yyyy}" />
                                            <asp:BoundField DataField="EndDate" HeaderText="End Date" 
                                                DataFormatString="{0:dd-MM-yyyy}" />
                                            <asp:BoundField DataField="PrjSanctionDate" HeaderText="Sanction Date" 
                                                DataFormatString="{0:dd-MM-yyyy}" />
                                            <asp:BoundField DataField="TargetBeneficiary" HeaderText="Target Beneficiary" />
                                            <asp:BoundField DataField="ProjectCost" 
                                                HeaderText="Project Cost" />
                                            <asp:BoundField DataField="PrjInchargeName" HeaderText="Incharge Name" />
                                        </columns>
