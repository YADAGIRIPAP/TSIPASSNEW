...
public partial class LookupBDC : System.Web.UI.Page
{
    ...
    void fillgrid()
    {
        ...
        DataSet ds = Gen.getBDCSearch(ddlState.SelectedValue, ddlCounties.SelectedValue, ddlPayams.SelectedValue, txtBDC.Text,User);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if ((e.Row.RowType == DataControlRowType.DataRow))
        {
            ...
            ((LinkButton)e.Row.FindControl("LinkButton1")).Attributes.Add("onclick", "javascript:GetRowValue('" + DataBinder.Eval(e.Row.DataItem, "intBDC") + "')");
        }
    }
