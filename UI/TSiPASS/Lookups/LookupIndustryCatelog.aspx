<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/Lookups/CCLookupsMaster.master"
    AutoEventWireup="true" CodeFile="LookupIndustryCatelog.aspx.cs" Inherits="LookupBDC"
                                ...
                                <td align="center" style="padding: 5px; margin: 5px" colspan="5">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NoofUnitsCaptures" HeaderText="No of Units Captures" />
                                            <asp:BoundField DataField="YettoCaptured" HeaderText="Yet to Captured" />
