<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="ACCOUNTS_OFFICER_LIST_APPROVAL.aspx.cs" Inherits="UI_TSiPASS_ACCOUNTS_OFFICER_LIST_APPROVAL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-lg-12">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td>
                        <div class="col-md-12">
                            <h1 class="page-head-line" align="left" style="font-size: large">Cheque Preparation List - ACCOUNTS OFFICER</h1>
                        </div>

                        <table align="left" cellpadding="10" cellspacing="5" style="width: 85%">
                    ...
                    <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                        <div id="Div2" style="width: 100%" runat="server">
                            <asp:GridView ID="gvProceedings" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="gvProceedings_RowDataBound"
                                BackColor="#1d9a5b" CssClass="GRD gridview" ForeColor="White" Font-Bold="True" Height="62px" PageSize="15" ShowFooter="False" Width="100%" CellSpacing="4" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                <%--<FooterStyle BackColor="#1d9a5b" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />--%>
                                <RowStyle BackColor="#D1DDF1" Font-Bold="True" CssClass="GRDITEM" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <Columns>
                ...
                <tr>
                    <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                        <div id="Div3" style="width: 100%" runat="server">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="GridView1_RowDataBound"
                                BackColor="#1d9a5b" CssClass="GRD gridview" ForeColor="White" Font-Bold="True" Height="62px" PageSize="15" ShowFooter="False" Width="100%" CellSpacing="4" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                <%--<FooterStyle BackColor="#1d9a5b" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />--%>
                                <RowStyle BackColor="#D1DDF1" Font-Bold="True" CssClass="GRDITEM" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DD INCENTIVES - [Recommended Date]">
                                        <ItemTemplate>
                                            <asp:Label ID="RecommendedDate" runat="server" CssClass="center-align" Text='<%#Bind("LatestUpdatedDateTime", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="80px" />
                ...
                <tr>
                    <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                        <div id="Div4" style="width: 100%" runat="server">
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="GridView2_RowDataBound"
                                BackColor="#1d9a5b" CssClass="GRD gridview" ForeColor="White" Font-Bold="True" Height="62px" PageSize="15" ShowFooter="False" Width="100%" CellSpacing="4" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                <%--<FooterStyle BackColor="#1d9a5b" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />--%>
                                <RowStyle BackColor="#D1DDF1" Font-Bold="True" CssClass="GRDITEM" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="JD INCENTIVES - [Recommended Date]">
                                        <ItemTemplate>
                                            <asp:Label ID="RecommendedDate" runat="server" CssClass="center-align" Text='<%#Bind("LatestUpdatedDateTime", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="80px" />
                ...
                <tr>
                    <td style="padding: 5px; margin: 5px; width: 100%" valign="top" colspan="12">
                        <div id="Div5" style="width: 100%" runat="server">
                            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowDataBound="GridView3_RowDataBound"
                                BackColor="#1d9a5b" CssClass="GRD gridview" ForeColor="White" Font-Bold="True" Height="62px" PageSize="15" ShowFooter="False" Width="100%" CellSpacing="4" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                <%--<FooterStyle BackColor="#1d9a5b" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />--%>
                                <RowStyle BackColor="#D1DDF1" Font-Bold="True" CssClass="GRDITEM" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <Columns>
                ...
                <tr>
                    <td>
                        <div id="dvSUnits" style="margin-top: 5px; margin-bottom: 5px;">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table  id="CHEQUE_DETAILS" runat="server" align="left" cellpadding="5" cellspacing="5" style="width: 85%">
                            <tr>
                                <td style="vertical-align: middle; padding: 10px;" align="left">Cheque No.:
                                </td>
                                <td style="padding: 5px; margin: 5px; text-align: left;">
                                    <asp:TextBox runat="server" ID="ChequeNo" Height="28px" MaxLength="80" TabIndex="1" Width="250px"></asp:TextBox>
                                </td>
                                <td style="vertical-align: middle; padding: 10px;" align="left">Cheque No. Date:
                                </td>
                                <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:TextBox runat="server" ID="ChequeDate" placeholder="DD/MM/YYYY" class="form-control txtbox" Height="28px"
                ...
                <td colspan="1" style="padding: 5px; margin: 5px" align="Center" class="style7"
                    ...
                    <br />
                    <asp:Button ID="UpdateFlagToDB" CssClass="btn btn-primary" runat="server" Text="Approve the Records"
                ...
                <div>
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblSuccessMessage" runat="server" ForeColor="#800020" Font-Bold="true" class="alert blink alert-dismissible" data-dismiss="alert" text-size="50px" Text="" /><br />
                        </td>
                    </tr>
                </div>
                <div align="center">
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            $("input[id$='ChequeDate']").datepicker(
                {
                    dateFormat: "dd/mm/yy",
                });
