<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="Rpt1PrescrutinyStatusDepartmentwise.aspx.cs"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            R2.2 Pre-scrutiny - Query Details&nbsp;<a id="A1" href="#" onserverclick="BtnPDF_Click"
                                runat="server">
