<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmstatusDepartmentApprovalNextNew.aspx.cs"
    Inherits="TSTBDCReg1" %>
...
//            $('#<%=grdDetails.ClientID%>').gridviewScroll({
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#"><a href="#">Applications</a> </li>
        </ol>
    </div>
    <div align="left">
                                    ...
                                    <table width="80%">
                                        <tr align="center">
                                            <td style="padding: 5px; margin: 5px" align="right">
                                                <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" Text="<< Back">
                                                </asp:HyperLink>
                                            </td>
