...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  ddlMonth.SelectedItem.Text = month.ToString();
           ...
           DataSet ds = Gen.getBankReport(ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), Session["uid"].ToString());
           ...
           if (ds.Tables[0].Rows.Count > 0)
           {
            ...
            ds1 = Gen.getIPOTargetBankvisit(ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), Session["uid"].ToString());
    ...
    //        z = Gen.insertIPOBankVisitDet(hdfID.Value.ToString(), txtIPO.Text, TxtNoofMandals.Text, TxtBranchs.Text, Session["uid"].ToString(), Session["uid"].ToString(), ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), GPSFilePath.ToString(), GPSFileName.ToString());
    ...
    //            x = Gen.insertIPOBankVisitDet("0", txtIPO.Text, TxtNoofMandals.Text, TxtBranchs.Text, Session["uid"].ToString(), Session["uid"].ToString(), ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), GPSFilePath.ToString(), GPSFileName.ToString());
    ...
    //        {
    //            AddDataToTableCeertificate(ddlType.SelectedValue.ToString(), ddlBankName.SelectedValue.ToString(), txtBankBranch.Text, txtUnitName.Text, txtAddress.Text, (DataTable)Session["CertificateTb2"],TxtRemarks.Text,ddlBankName.SelectedItem.Text.ToString(),ddlType.SelectedItem.Text.ToString());//Session["uid"].ToString()
