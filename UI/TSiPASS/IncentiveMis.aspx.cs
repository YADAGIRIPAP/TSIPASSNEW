...
public partial class UI_TSiPASS_frmTsipassMis : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        ds = Gen.TsipassapplicationsmisInc(FromdateforDB, TodateforDB);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            Label1.Text = ds.Tables[4].Rows[0]["Total"].ToString().Trim();

            grDisbursment.DataSource = ds.Tables[5];
            grDisbursment.DataBind();
        }
    }
