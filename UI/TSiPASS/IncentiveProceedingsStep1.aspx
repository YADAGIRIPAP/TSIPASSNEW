<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveProceedingsStep1.aspx.cs" Inherits="UI_TSiPASS_IncentiveProceedingsStep1" %>
                                        ...
                                        <td>
                                            <table style="width:50%">
                                                  <tr>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; text-align: left;" class="style42">Type of Sector
                                                                </td>
                                                ...
                                                <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O No">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtGoNo" runat="server" class="form-control txtbox" Height="28px"
                                                                     TabIndex="1" style="margin: 5px auto;" Width="120px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O Date">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtGodate" runat="server" class="form-control txtbox" Height="28px"
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="LOC No">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtLocno" runat="server" style="margin: 5px auto;" class="form-control txtbox" Height="28px"
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="LOC Date">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtLocdate" runat="server" class="form-control txtbox" Height="28px"
                                                                    MaxLength="80" TabIndex="1" placeholder="DD/MM/YYYY" style="margin: 0px auto;padding: 5px;" Width="100px"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O Amount Released">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtsanctionedamountnew" style="margin: 5px;" class="form-control txtbox" Width="150px" Height="28px"
                                                                    MaxLength="80" TabIndex="1" runat="server"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" Width="80px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Process">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server" style="margin:10px;" Text="Process" Width="90px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left"  Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSubIncType" runat="server" Text='<%#Eval("IncSubTypeId") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                    </Columns>
                                                ...
                                                <asp:GridView ID="gvInvestmentSubsidySC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Sanctioned Amount">
                                                         ...
                                                         <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O Amount Released">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtsanctionedamountnew" class="form-control txtbox" Height="28px"
                                                        MaxLength="80" TabIndex="1" runat="server"></asp:TextBox>
                                                            </ItemTemplate>
                                                             <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button2" CssClass="btn btn-primary" OnClick="Button2_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvGeneralSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button3" CssClass="btn btn-primary" OnClick="Button3_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvPavallavaddiST" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button4" CssClass="btn btn-primary" OnClick="Button4_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvInvestmentSubsidyST" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button5" CssClass="btn btn-primary" OnClick="Button5_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O Amount Released">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvGeneralST" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button6" CssClass="btn btn-primary" OnClick="Button6_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvPavallavaddiGeneral" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button7" CssClass="btn btn-primary" OnClick="Button7_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvInvestmentSubsidyGeneral" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button8" CssClass="btn btn-primary" OnClick="Button8_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
                                            ...
                                            <div style="width: 100%">
                                                <asp:GridView ID="gvGeneralGeneral" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button9" CssClass="btn btn-primary" OnClick="Button9_Click" runat="server" Text="Submit" Width="150px" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="masterid" Visible="false">
                                                            <ItemTemplate>
            ...
            $("input[id$='txtLocdate']").datepicker(
              {
               ...
               $("#ctl00_ContentPlaceHolder1_grdDetailsPavallavaddiSC tr td:nth-child(2)").each(function () {
                if ($(this).html() != '')
