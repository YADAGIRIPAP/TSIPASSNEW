...
public partial class UI_TSiPASS_apparaisalnote_SpecificCleaner : System.Web.UI.Page
{
    ...
    public void USP_GETDETAILSFORSECTION()
    {
        ...
        {
            //txtlandpurchase.Text = ds.Tables[2].Rows[0]["AreaRegdSaledeed"].ToString();
            //// txtlandpurchase_TextChanged(this, EventArgs.Empty);
            //txtlandvalue.Text = ds.Tables[2].Rows[0]["LandCostIeIdaIpAP"].ToString();
            //// txtstampdutypaid_TextChanged(this, EventArgs.Empty);
            //txtbuildingplinth.Text = ds.Tables[2].Rows[0]["PlnthAreaBuild"].ToString();
            txtexpenditureincurred_TextChanged(this, EventArgs.Empty);
        }
    }
    ...
    public bool save()
    {
        ...
        if (returnval == "1")
        {
            ...
            fromvo.MstIncentiveId = "4"; //Request.QueryString["MstIncentiveId"].ToString();
            ...
            fromvo.Recomamount = oIncentiveVosA.FINALELIGIBLELANDCOST;
            ...
            string lblMstIncentiveId = Request.QueryString["MstIncentiveId"].ToString();
    ...
    public string InsertCommonData(IncentiveVosAppraisalStamp oIncentiveVosA)
    {
        ...
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandType = CommandType.StoredProcedure;
            com.CommandText = "[USP_INSERT_INCENTIVES_DATA_COMMON_appraisal_SpecificCleaner]";
            ...
            // -----------=====---------------
            if (oIncentiveVosA.LANDPURCHASE != null)
                com.Parameters.AddWithValue("@LANDPURCHASE", oIncentiveVosA.LANDPURCHASE);
            if (oIncentiveVosA.LANDVALUE != null)
                com.Parameters.AddWithValue("@LANDVALUE", oIncentiveVosA.LANDVALUE);
            ...
            if (oIncentiveVosA.ELIGIBLELANDCOST != null)
                com.Parameters.AddWithValue("@ELIGIBLELANDCOST", oIncentiveVosA.ELIGIBLELANDCOST);
            if (oIncentiveVosA.LANDCOST_Total != null)
                com.Parameters.AddWithValue("@LANDCOST_Total", oIncentiveVosA.LANDCOST_Total);
            if (oIncentiveVosA.TotalBuildingPlinth_CALCULATED != null)
                com.Parameters.AddWithValue("@TotalBuildingPlinth_CALCULATED", oIncentiveVosA.TotalBuildingPlinth_CALCULATED);
            if (oIncentiveVosA.FINALELIGIBLELANDCOST != null)
                com.Parameters.AddWithValue("@FINALELIGIBLELANDCOST", oIncentiveVosA.FINALELIGIBLELANDCOST);
            ...
            if (oIncentiveVosA.ExpenditureIncurred != null)
                com.Parameters.AddWithValue("@ExpenditureIncurred", oIncentiveVosA.ExpenditureIncurred);

            if (oIncentiveVosA.ExpenditureIncurred25 != null)
                com.Parameters.AddWithValue("@ExpenditureIncurred_25prcnt", oIncentiveVosA.ExpenditureIncurred25);
    ...
    public void AssignValuestoVosFromcontrols()
    {
        ...
        oIncentiveVosA.MstIncentiveId = "4";//Request.QueryString["MstIncentiveId"].ToString();
        oIncentiveVosA.ExpenditureIncurred = Convert.ToDecimal(txtexpenditureincurred.Text);
        oIncentiveVosA.ExpenditureIncurred25 = Convert.ToDecimal(txtexpenditureincurred25.Text);

        oIncentiveVosA.GMValue = Convert.ToDecimal(txtgmRecommend.Text);
        oIncentiveVosA.ELIGIBLELANDCOST = Convert.ToDecimal(txteligiblelandcost.Text);
        oIncentiveVosA.FINALELIGIBLELANDCOST = Convert.ToDecimal(TXTFINALELIGIBLELANDCOST.Text);
    ...
    public class IncentiveVosAppraisalStamp
    {
        ...
        public Decimal? ExpenditureIncurred25 { get; set; }
        public Decimal? LANDPURCHASE { get; set; }
        public Decimal? LANDVALUE { get; set; }
        public Decimal? BuildingPlinth { get; set; }
        public Decimal? Proportionatearea { get; set; }
        public Decimal? GMValue { get; set; }
        public Decimal? ELIGIBLELANDCOST { get; set; }
        public Decimal? LANDCOST_Total { get; set; }
        public Decimal? TotalBuildingPlinth_CALCULATED { get; set; }
        public Decimal? FINALELIGIBLELANDCOST { get; set; }
    ...
    public string ValidateControls()
    {
        ...
        if (txtexpenditureincurred.Text.TrimStart().TrimEnd().Trim() == "")
        {
            ErrorMsg = ErrorMsg + slno + ". Please enter expenditure incurred.\\n";
            slno = slno + 1;
        }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //    //if (retval == "deleted")
            //    //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Line of activity deleted');", true);
            Response.Redirect("appraisalNote_is.aspx?incid=" + txtINCNoEntry.Text.ToString() + "&mstid=4");
        }
    ...
    protected void rdeligibility_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (rdeligibility.SelectedValue != "")
            {
                ...
                if (rdeligibility.SelectedValue == "Regular")
                {
                    txteligiblelandcost.Text = txtexpenditureincurred25.Text;
                }
                else if (rdeligibility.SelectedValue == "Belated")
                {
                    txteligiblelandcost.Text = (Convert.ToDecimal(txtexpenditureincurred25.Text) / 2).ToString();
                }
                else if (rdeligibility.SelectedValue == "OneYear")
                {
                    txteligiblelandcost.Text = "0";
                }

            }
            if (txteligiblelandcost.Text != null || txteligiblelandcost.Text != "")
            {
                if (Convert.ToDecimal(txtgmRecommend.Text) < Convert.ToDecimal(txteligiblelandcost.Text))
                {
                    if (Convert.ToDecimal(txtgmRecommend.Text) <= 500000)
                    {
                        TXTFINALELIGIBLELANDCOST.Text = txtgmRecommend.Text;
                    }
                    else
                    {
                        TXTFINALELIGIBLELANDCOST.Text = "500000";
                    }
                ...
                if (Convert.ToDecimal(txtgmRecommend.Text) > Convert.ToDecimal(txteligiblelandcost.Text))
                {
                    if (Convert.ToDecimal(txteligiblelandcost.Text) <= 500000)
                    {
                        TXTFINALELIGIBLELANDCOST.Text = txteligiblelandcost.Text;
                    }
                    else
                    {
                        TXTFINALELIGIBLELANDCOST.Text = "500000";
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    if (fileType[i - 1].ToUpper().Trim() == "PDF" || fileType[i - 1].ToUpper().Trim() == "DOC" || fileType[i - 1].ToUpper().Trim() == "JPG" || fileType[i - 1].ToUpper().Trim() == "XLS" || fileType[i - 1].ToUpper().Trim() == "XLSX" || fileType[i - 1].ToUpper().Trim() == "DOCX" || fileType[i - 1].ToUpper().Trim() == "ZIP" || fileType[i - 1].ToUpper().Trim() == "RAR" || fileType[i - 1].ToUpper().Trim() == "JPEG" || fileType[i - 1].ToUpper().Trim() == "PNG")
                    {
                        ...
                        // string serverpath = System.IO.Path.Combine(sFileDir + "ADWORKSHEET_LANDCOST" + "\\" + incentiveid.ToString() + "\\" + masterincentiveid.ToString());
                        string serverpath = System.IO.Path.Combine(sFileDir + incentiveid.ToString() + "\\" + "ADWORKSHEET_LANDCOST" + "\\" + masterincentiveid.ToString());
                        ...
                        t1.InsertIncentiveAttachmentInspReports(incentiveid, "1111114", sFileName, serverpath, CrtdUser, masterincentiveid.ToString(), "WorkSheet");
    ...
    public int InsertincentiveOfficerCommentsAD(List<officerRemarks> Ramarks, List<officerForwarded> lstincentives, string IPAddress)
    {
        ...
        foreach (officerRemarks Ramarksvo in Ramarks)
        {
            ...
            try
            {
                ...
                // cmd.Parameters.AddWithValue("@AD_RECON_AMOUNT", Convert.ToString(Ramarksvo.Remarks));Recomamount
    ...
    public DataSet GetAmount(decimal LANDPURCHASE, decimal LANDVALUE)
    {
        ...
        SqlParameter[] pp = new SqlParameter[]
       {
        ...
        pp[0].Value = LANDPURCHASE;
        pp[1].Value = LANDVALUE;
    ...
    {
        //decimal LANDPURCHASE;
        //if (txtlandpurchase.Text == null || txtlandpurchase.Text == "")
        //{
        //    LANDPURCHASE = 0;
        //}
        //else
        //{
        //    LANDPURCHASE = Convert.ToDecimal(txtlandpurchase.Text);
        //}

        //DataSet ds = new DataSet();
        //ds = GetAmount(LANDPURCHASE, Convert.ToDecimal(txtlandvalue.Text.Trim()));
        //if (ds.Tables[0].Rows.Count > 0)
        //{
        //    txtlandcosttotal.Text = Convert.ToString(ds.Tables[0].Rows[0]["totalamount"]);
        //}
    }

    protected void txtlandpurchase_TextChanged(object sender, EventArgs e)
    {
        //decimal LANDVALUE;
        //if (txtlandvalue.Text == null || txtlandvalue.Text == "")
        //{
        //    LANDVALUE = 0;
        //}
        //else
        ...
        //DataSet ds = new DataSet();
        //ds = GetAmount(Convert.ToDecimal(txtlandpurchase.Text), LANDVALUE);
        //if (ds.Tables[0].Rows.Count > 0)
        //{
        //    txtlandcosttotal.Text = Convert.ToString(ds.Tables[0].Rows[0]["totalamount"]);
        //}
    ...
    protected void txtexpenditureincurred_TextChanged(object sender, EventArgs e)
    {
        // txtexpenditureincurred.Text = Convert.ToString(Convert.ToDecimal(txtbuildingplinth.Text) * 5);
        if (txtexpenditureincurred.Text != null || txtexpenditureincurred.Text != "")
        {
            txtexpenditureincurred25.Text = Convert.ToString((Convert.ToDecimal(txtexpenditureincurred.Text) * 25) / 100);
            txtexpenditureincurred25.Focus();
            if (Convert.ToDecimal(txtgmRecommend.Text) < Convert.ToDecimal(txtexpenditureincurred25.Text))
            {
                if (Convert.ToDecimal(txtgmRecommend.Text) > 1000000)
                {
                    txteligiblelandcost.Text = "1000000";
                }
                else
                {
                    txteligiblelandcost.Text = txtgmRecommend.Text;
                }
            }
            else
            {
                if (Convert.ToDecimal(txtexpenditureincurred25.Text) > 1000000)
                {
                    txteligiblelandcost.Text = "1000000";
                }
                else
