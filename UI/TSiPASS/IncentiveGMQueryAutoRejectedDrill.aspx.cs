...
public partial class UI_TSiPASS_IncentiveGMQueryAutoRejectedDrill : System.Web.UI.Page
{
    ...
    public DataSet GetIncentivesMISPendingReportDrill(string status, string ddlDistrict)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_Incentives_MISPendencyReportDrillCOI_GMQUERYAUTOREJECTED", con.GetConnection);
