...
using System.Data;
public partial class UI_TSiPASS_IncentivesAnnexures_AnnexInvestSubsidyS : System.Web.UI.Page
{
        ...
        if (Session["uid"] != null)
        {
            ...
            if (IncentiveId != null)
            {
                ...
                if (caste == "3" || caste == "4")   //SC, ST
                {
                    ...
                    lblheadTPRIDE.Text = "<center>" + "ANNEXURE: VIII" + "</center>" + "<center>APPLICATION CUM VERIFICATION FOR</center>" + "<b><u><center>CLAIMING INVESTMENT SUBSIDY UNDER T-PRIDE </center></u></b>" + "<center>(TELANGANA STATE PROGRAM FOR RAPID INCUBATION OF DALIT ENTREPRENEURS INCENTIVE SCHEME)</center>" + "<center>(G.O.Ms.No.29 Industries and Commerce (IP & INF) Department. dated.29/11/2014)</center>";
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (MasterIncentiveId == "6")  //IS
                    {
                        ...
                        ds6 = Gen.GetIncentivesISdata(incentiveID,"6");  // master incentive id added on 21.01.2018
                        FilldataIS(ds6);
