...
public partial class UI_TSiPASS_IncentivesAnnexures_AnnexStampDuty : System.Web.UI.Page
{
            ...
            if (IncentiveId != null)
            {
                if (!IsPostBack)
                {
                    ...
                    if (caste == "3" || caste == "4")   //SC, ST
                    {
                        ...
                        lblheadTPRIDE.Text = "<center>" + "ANNEXURE: VI" + "</center>" + "<center>APPLICATION CUM VERIFICATION FOR</center>" + "<b><u><center>CLAIMING REIMBURSEMENT OF STAMP DUTY / TRANSFER DUTY / MORTGAGE DUTY / LAND CONVESERSION CHARGES / REIMBURSEMENT OF LAND COST PURCHASED IN IE/ IDA / IP’s</center> <center> UNDER T - PRIDE </center></u></b>" + "<center>(TELANGANA STATE PROGRAM FOR RAPID INCUBATION OF DALIT ENTREPRENEURS INCENTIVE SCHEME)</center>" + "<center>(G.O.Ms.No.29 Industries and Commerce (IP & INF) Department. dated.29/11/2014)</center>";
