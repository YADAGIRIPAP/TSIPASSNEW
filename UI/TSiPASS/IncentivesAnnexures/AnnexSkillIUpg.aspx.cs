...
public partial class UI_TSiPASS_IncentivesAnnexures_AnnexSkillIUpg : System.Web.UI.Page
{
    ...
    private void FillDetailsSkillUpgradation(DataSet ds)
    {
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            txtagencyName1.Text = ds.Tables[0].Rows[0]["Nameofthetraininginstitute"].ToString();
