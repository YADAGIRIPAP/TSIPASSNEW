...
public partial class UI_TSiPASS_frmIPOREPORTUpdatedDistrictWise : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalDistrictwise_IPoListReportupdated(ddlYear.SelectedValue.ToString(), ddlmonth.SelectedValue.ToString());
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalDistrictwise_New_New(ddlType.SelectedValue, FromdateforDB, TodateforDB,"", ddlProp_intDistrictid.SelectedValue).Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //decimal NumberTotal1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "IPOREPORTNOTUPDATED"));
            ...
            //h1.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text+ "&User=" + "IPO" + "&month=" +ddlmonth.SelectedValue.ToString();

            //HyperLink h2 = (HyperLink)e.Row.Cells[4].Controls[0];
            //h2.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "AD" + "&month=" + ddlmonth.SelectedValue.ToString();

            //HyperLink h3 = (HyperLink)e.Row.Cells[5].Controls[0];
            //h3.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "DD" + "&month=" + ddlmonth.SelectedValue.ToString();


            //HyperLink h4 = (HyperLink)e.Row.Cells[6].Controls[0];
            //h4.NavigateUrl = "IPO_DrilldownReport.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "TOTAL" + "&month=" + ddlmonth.SelectedValue.ToString();


            //HyperLink h1 = (HyperLink)e.Row.Cells[3].Controls[0];
            //h1.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "IPO" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h5 = (HyperLink)e.Row.Cells[3].Controls[0];

            h5.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&User=" + "IPO" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED";
            //HyperLink h2 = (HyperLink)e.Row.Cells[5].Controls[0];
            //h2.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "AD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h6 = (HyperLink)e.Row.Cells[4].Controls[0];
            h6.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&User=" + "AD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED";

            //HyperLink h3 = (HyperLink)e.Row.Cells[7].Controls[0];
            //h3.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "DD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h7 = (HyperLink)e.Row.Cells[5].Controls[0];
            h7.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&User=" + "DD" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED";

            //HyperLink h4 = (HyperLink)e.Row.Cells[9].Controls[0];
            //h4.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&User=" + "TOTAL" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "NOTUPDATED";

            HyperLink h8 = (HyperLink)e.Row.Cells[6].Controls[0];
            h8.NavigateUrl = "frmIPOREPORTUpdatedDistrictWiseDRILL.aspx?year=" + ddlYear.SelectedValue.ToString() + "&lbl=Application Received&dist=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DISTRICTID")).Trim() + "&User=" + "TOTAL" + "&month=" + ddlmonth.SelectedValue.ToString() + "&View=" + "UPDATED";
    ...
    protected void BtnSave1_Click(object sender, EventArgs e)
    {
        ...
        //    }
        //}
        if ((ddlmonth.SelectedValue == "--Select--") || (ddlYear.SelectedValue == "--Select--"))
        {
            lblmsg0.Text = "Please Select  The Details <br/>";
            valid = 1;
        }
        if (valid == 0)
        {
