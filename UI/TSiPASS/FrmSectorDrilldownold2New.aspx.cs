...
public partial class UI_TSiPASS_FrmSectorDrilldownold2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchSectorwiseDrildownNewNew(Request.QueryString[0].ToString().Trim(), QueryString2, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
        // lblMsg.Text = "";
