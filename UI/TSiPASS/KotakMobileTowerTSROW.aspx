<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="KotakMobileTowerTSROW.aspx.cs" Inherits="UI_TSiPASS_KotakMobileTowerTSROW" %>
...
<body>
       <form method="post" name="customerData" action="ccavRequestHandlerMOBILETOWER_TSROW.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerMOBILETOWER_TSROW.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentMobiletowerTSROW.aspx" />
                </td>
            </tr>
            <tr>
                <td>
