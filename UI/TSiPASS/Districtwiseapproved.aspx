<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Districtwiseapproved.aspx.cs" Inherits="UI_TSiPASS_Disticwiseapproved" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server">R6.14:TGiPASS- District Wise Report </asp:Label>
                            ...
                            <table align="center" cellpadding="10" cellspacing="5" style="width: 50%; font-family: 'Trebuchet MS'">
                                    ...
                                    <td>
                                        <table runat="server" id="tblselection" cellpadding="4" cellspacing="5" style="width: 80%">
                                            <tr>
                                                ...
                                                <td id="tdEnterPriseType" visible="false" class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            Type of Enterprise
                                                        </div>
                                                ...
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="ddldistrict" runat="server" class="form-control txtbox" Width="180px" OnSelectedIndexChanged="ddldistrict_SelectedIndexChanged" AutoPostBack="true">
                                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                            <%-- <asp:ListItem>All</asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </div>
                                ...
                                <tr id="GridPrint" runat="server">
                                    <td colspan="2" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="floatingTable"
                                            OnRowDataBound="grdDetails_RowDataBound" Width="80%" OnPageIndexChanging="grdDetails_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Approvedwithinperiod" HeaderText="No of Industries Approved Within selected Period">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Appliedwithinperiod" HeaderText="Number Of Industries Applied Within Selected Period ">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Appliedoutofperiod" HeaderText="Number Of Industries Applied Before selected From Date ">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
