...
public partial class UI_TSiPASS_frmDepartmentProcessedApplist : System.Web.UI.Page
{
    ...
    public DataSet GetMSMEApplications(string intDistrictid, string Category, string fromdate, string todate, string deptid)
    {
        ...
        Dsnew = Gen.GenericFillDs("DeptReportDepartmentWise_New1_CFE_Processdate", pp);
        return Dsnew;
    }
}