<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="COIDELETEDRECORDS_CFE.aspx.cs" Inherits="UI_TSiPASS_COIDELETEDRECORDS_CFE" %>
                        ...
                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"  OnRowDataBound="grdDetails_RowDataBound" 
                            ...
                            <Columns>
                               ...
                               <%-- <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="intQuessionaireid"
                                ...
                                <asp:BoundField DataField="COIDELETE_REMARKS" HeaderText="Remarks" ItemStyle-HorizontalAlign="Center"
                                    Visible="true">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
