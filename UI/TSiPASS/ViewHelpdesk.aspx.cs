...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
              //  ddlstat.SelectedValue = "Open";
                ddlstat.SelectedValue = "--Select--";
                ...
                if (usertype.ToString().Trim() == "Adm")
                {
                    ...
                    btnSearchHelpDesk.Visible = true;
                ...
                else if (usertype.ToString().Trim() == "10" || usertype.ToString().Trim() == "11")
                {
                    try
                    {
                        ddlPIA.SelectedValue = ddlPIA.Items.FindByValue(userid.Trim()).Value;
                ...
                // ddlstat_SelectedIndexChanged(sender,e);
                FillHelp();
    ...
    public void FillHelp()
    {
        ...
        if (usertype == "Adm" && Session["user_id"].ToString() == "admin" || usertype == "Help")
        {
            txtFromDate.Visible = true;
            btnSearchHelpDesk.Visible = true;
            txtToDate.Visible = true;
        ...
        {
            dshelps = cmn.Gethelpdeskbackup(ddlfeedbak.SelectedValue.ToString().Trim(), ddlstat.SelectedValue.ToString().Trim(), ddlPIA.SelectedValue, txtrefno.Text.Trim());

            //txtFromDate.Visible = false;
            //btnSearchHelpDesk.Visible = false;
        ...
        if (usertype == "Adm" || usertype == "Help")
        {
            ...
            else
            {
                gvComplaintsList.Columns[10].Visible = true;
                gvComplaintsList.Columns[9].Visible = true;
                gvComplaintsList.Columns[8].Visible = true;
                gvComplaintsList.Columns[11].Visible = true;
            }
        }
        else
        {
            ...
            gvComplaintsList.Columns[10].Visible = false;
            gvComplaintsList.Columns[12].Visible = false;
        }
        lblerrMsg.Text = "";
        lblStatus.Text = "";
        //  lblresult.Text = "";
    ...
    {
        DataSet dsdet = new DataSet();
        if (txtFromDate.Text == "" || txtToDate.Text == "" || ddlstat.SelectedItem.Text == "--Select--")
        {
            lblerrMsg.Visible = true;
            lblresult.Visible = false;
            lblerrMsg.Text = "Please Enter both To & From Dates for search and select Status";
            txtFromDate.Focus();
        ...
        else
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "" && ddlstat.SelectedItem.Text != "--Select--")
            {
                ...
                gvComplaintsList.DataSource = null;
                gvComplaintsList.DataBind();
                //dsdet = null;
                string[] formdate = txtFromDate.Text.Split('/');
                string[] todate = txtToDate.Text.Split('/');
                dsdet = cmn.Gethelpdeskbackup_search(ddlfeedbak.SelectedValue.ToString().Trim(), ddlstat.SelectedValue.ToString().Trim(), "%", txtrefno.Text.Trim(), todate[2].ToString() + "/" + todate[1].ToString() + "/" + todate[0].ToString(), formdate[2].ToString() + "/" + formdate[1].ToString() + "/" + formdate[0].ToString());
                gvComplaintsList.DataSource = dsdet;
                gvComplaintsList.DataBind();
                if (ddlstat.SelectedItem.Text == "Closed")
                {
                    gvComplaintsList.Columns[11].Visible = false;  //12 chgd to 11
                    gvComplaintsList.Columns[9].Visible = true;
                    gvComplaintsList.Columns[10].Visible = true;
                }
                lblresult.Text = "Total Records Found : " + dsdet.Tables[0].Rows.Count.ToString() + " " + "From" + ": " + txtFromDate.Text.ToString() + " " + "To" + ": " + txtToDate.Text.ToString();
            }
        }
    }
}
