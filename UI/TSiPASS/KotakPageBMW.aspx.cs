...
public partial class UI_TSiPASS_KotakPageBMW : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = objBMW.GetEnterprinerpaymentDtlsBMW(CustomerID, TSipassOrderNumber, additionalPayment);
                string Departmentdetails = "";
                string Questionaireid = "";
                string MobileNo = "";
                string Email = "";
