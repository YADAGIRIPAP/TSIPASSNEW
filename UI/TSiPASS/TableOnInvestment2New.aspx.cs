...
public partial class UI_TSiPASS_TableOnInvestment2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTableOnInvestment_New_New(ddlType.SelectedValue, FromdateforDB , TodateforDB);
        // lblMsg.Text = "";
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "TableOnInvestmentDill2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "TableOnInvestmentDill2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "TableOnInvestmentDill2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Application Received&Stage=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "InvestmentRange")).Trim() + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "TableOnInvestmentDill2New.aspx?status=" + ddlType.SelectedValue.ToString() + "&lbl=Total Applications Received&Stage=%" + "&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    protected void btnNewPdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=R6.5_Investment_wise_Abstract" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
