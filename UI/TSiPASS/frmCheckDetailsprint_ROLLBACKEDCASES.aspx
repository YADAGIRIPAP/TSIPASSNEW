<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/UI/TSiPASS/CCMaster.master"  CodeFile="frmCheckDetailsprint_ROLLBACKEDCASES.aspx.cs" Inherits="UI_TSiPASS_frmCheckDetailsprint_ROLLBACKEDCASES" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td>
                                    <div class="col-md-12">
                                        <h1 class="page-head-line" align="left" style="font-size: large">Generate Check Preparation List</h1>
                                    </div>
                                        ...
                                        <td style="padding: 5px; margin: 5px; width: 900px; font-weight: bold;">A). Pavalla vaddi
                                            ...
                                            <tr>
                                                <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                                    <%--  <table width="100%">
                                                <tr>
                                                    <td style="padding: 15px; margin: 5px; width: 20px">
                                                    </td>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:TextBox runat="server" ID="txtsvcdate" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="150px" Visible="false"></asp:TextBox>
                                                        <asp:DropDownList runat="server" ID="ddlReleaseProceedingNo" class="form-control txtbox"
                                                            Height="28px" width="250px" TabIndex="1">
                                                            <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding: 15px; margin: 5px;">
                                                        <asp:Button ID="Button2" CssClass="btn btn-primary" OnClick="Button2_Click" runat="server"
                                                            Text="Get List" Width="150px" />
                                                    </td>
                                                </tr>
                                            </table>--%>
                                                    <table width="100%">
                                                     ...
                                                     Release Proceeding No :
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                                ...
                                                                <asp:DropDownList runat="server" ID="ddlReleaseProceedingNo" class="form-control txtbox" AutoPostBack="true"
                                                                    Height="30px" Width="240px" TabIndex="1" OnSelectedIndexChanged="ddlReleaseProceedingNo_SelectedIndexChanged">
                                                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                     ...
                                                     UC Status :
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                                <asp:DropDownList runat="server" ID="ddlworkingstatus" class="form-control txtbox"
                                                                    ...
                                                                    <asp:ListItem Value="1" Text="Working Units"></asp:ListItem>
                                                                    <asp:ListItem Value="2" Text="Not - Working Units"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr id="trdates" runat="server" visible="false">

                                                            <td style="vertical-align: middle; width: 200px" align="right">From Date:
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                                <asp:TextBox runat="server" ID="txtFromDate" class="form-control txtbox" Height="28px"
                                                                    MaxLength="10" TabIndex="1" Width="150px"></asp:TextBox>
                                                            </td>
                                                            <td style="padding: 15px; margin: 5px; width: 200px" align="left">To Date:
                                                            </td>
                                                            <td style="padding: 15px; margin: 5px;" align="left">
                                                                <asp:TextBox runat="server" ID="txtToDate" class="form-control txtbox" Height="28px"
                                                                    MaxLength="10" TabIndex="1" Width="150px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="padding: 15px; margin: 5px;" colspan="2" align="left">
                                                                <asp:Button ID="Button3" CssClass="btn btn-primary" runat="server"
                                                                    Text="Clear" Width="150px" OnClick="Button3_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <div id="divprint">
                                                        ...
                                                        <div style="width: 100%">
                                                            <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False"
                                                                CellPadding="4" CssClass="GRD" ForeColor="#333333" Height="62px" OnRowDataBound="grdDetailsPavallavaddiSC_RowDataBound"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Process">
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" Style="margin: 10px;"
                                                                                runat="server" Text="Process" Width="110px" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
