...
public partial class UI_TSIPASS_KotakTravelAgent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = objgen.GetTravelAgentpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
