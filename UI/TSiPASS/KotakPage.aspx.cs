...
public partial class UI_TSIPASS_KotakPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                string UIDNO = Convert.ToString(Session["UID_no"]); string CategoryType = "CFE";
                string intUserid = Convert.ToString(Session["uid"]);
                //obj_nsws.DB_samplepaymentupdatecfe(intUserid); used for testdb only
