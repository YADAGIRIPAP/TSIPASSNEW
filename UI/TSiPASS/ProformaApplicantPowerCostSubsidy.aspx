<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaApplicantPowerCostSubsidy.aspx.cs" Inherits="UI_TSiPASS_ProformaApplicantPowerCostSubsidy" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <asp:Label Font-Bold="true" Font-Size="Large" ID="lblheadTPRIDE" runat="server">GOVERNMENT OF TELANGANA <br /></asp:Label>
            <asp:Label Font-Bold="true" Font-Size="Large" ID="lblcoidipc" runat="server"></asp:Label><b style="display: none;"> :: </b>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px; font-weight: bold">
                <span><u>Lr. No.&nbsp;<asp:Label ID="lblLetterNo" runat="server"></asp:Label></u>&nbsp;&nbsp;&nbsp;&nbsp;<u>Dated:&nbsp;<asp:Label ID="lblLetterDate" runat="server"></asp:Label>.</u></span>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-15" style="padding-top: 6px;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px;">
                <span class="floatleft auto-style3">Sub :- 
                    <asp:Label ID="lblTIdeaTPrideIIPP1" runat="server" Font-Bold="true"></asp:Label>&nbsp;– Sanction of Reimbursement of  Power Cost for the&nbsp;Period of&nbsp;
                                                    <asp:Label ID="lblfinyearsub" runat="server" Font-Bold="true"> </asp:Label>
                    to 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 6px">
                <span class="floatleft auto-style3">Ref :-  
                    ...
                    2.<span>Lr. No.&nbsp;<asp:Label ID="lblLetterNomngr" runat="server" Font-Bold="true"></asp:Label>,&nbsp;Dated:&nbsp;<asp:Label ID="lblLetterDatemngr" runat="server" Font-Bold="true"></asp:Label>.</span> The General  Manager, District Industries Centre, <asp:Label ID="lblDistrict" runat="server" Font-Bold="true"></asp:Label>.<br />
                    3. Minutes of the
                    <asp:Label ID="lblSLCText" runat="server" Font-Bold="true"></asp:Label>&nbsp;<asp:Label ID="lblSLCNo" runat="server" Font-Bold="true"></asp:Label>&nbsp;meeting held on
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px">
                <span class="floatleft auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the subject cited, we are pleased to inform you that you have been sanctioned the Reimbursement of Power Cost of Rs.
                                                    <asp:Label ID="lblSanctionedAmount" runat="server" Font-Bold="true"></asp:Label>
                    &nbsp;(<asp:Label ID="lblSanctionedAmtDesc" runat="server" Font-Bold="true"></asp:Label>) to the captioned unit for the 
                                                     &nbsp;<span style="font-weight: bold"><asp:Label ID="lbl1stOR2ndHalfYearFinYearFromTo" runat="server"></asp:Label></span>&nbsp;under the scheme of&nbsp;<asp:Label ID="lblTIdeaTPrideIIPP3" runat="server" Font-Bold="true"></asp:Label>
                    &nbsp;.
                </span>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px">
            ...
            <%--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 25px; padding-bottom: 10px; text-align:left">
                ...
                <span id="addlDire" runat="server" visible="false" class=" pull-right">
                    ...
                    <asp:Label ID="Label1" Visible="false" runat="server" Text="Additional Director Name"></asp:Label>
                </span> </span>
                <span class="pull-right">
                    <asp:Label ID="lbldesignation" runat="server"></asp:Label>&nbsp;&nbsp;<asp:Label ID="lblDistrict2" runat="server"></asp:Label></span>
            </div>--%>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px">
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 6px; font-weight:bold">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 6px">
                <asp:Label ID="lbladdress" runat="server"></asp:Label>&nbsp;website: http://www.industries.telangana.gov.in
            </div>
        </div>
