<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master"
    AutoEventWireup="true" CodeFile="frmQuestionnaireCFO.aspx.cs" Inherits="UI_TSiPASS_frmQuestionnaireCFO" %>
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        <ContentTemplate>
            ...
            <table width="100%" align="left">
                            ...
                            <asp:View ID="View3" runat="server">
                                <table style="width: 100%; background-color: #d9d9d9; border-width: 2px; border-color: #666;
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 15px; margin: 5px" valign="top" height="60px">
                                            9.
                                        </td>
                                        <td style="padding: 5px; margin: 5px">
                                    ...
                                    <tr id="tract2dateofcommencement" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <%--<asp:TextBox ID="txtDateofCommenceAct1" runat="server" class="form-control txtbox"
                                                ...
                                                Width="180px"></asp:TextBox>--%>
                                            <asp:TextBox ID="txtDateofCommenceAct1" autocomplete="off" class="form-control txtbox"
                                                Width="150px" Height="30px" runat="server" ValidationGroup="group" />
                                    ...
                                    <tr id="troc" runat="server" visible="true">
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            Building Permission obtained from
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            &nbsp;
                                        </td>
                                        <td colspan="6" style="padding: 5px; margin: 5px" valign="top">
                                            <asp:RadioButtonList ID="RDOC" runat="server" RepeatDirection="Horizontal" Height="17px"
                                                Width="210px" OnSelectedIndexChanged="RDOC_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <tr id="trhmdatsiicfileno" runat="server" visible="false">
                                        <td style="padding: 15px; margin: 15px" colspan="7" align="left">
                                            Enter File number of Building Permission
                                        </td>
                                        <td style="padding: 5px; margin: 5px" valign="top">
                                            :
                                        </td>
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:TextBox ID="txtfilenumber" runat="server" Height="28px" class="form-control txtbox"
                                                MaxLength="50" TabIndex="0" ValidationGroup="group" Width="220px" OnTextChanged="txtfilenumber_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="trcanumber" runat="server" visible="false">
                                        ...
                                        <td style="padding: 5px; margin: 5px" class="auto-style1">
                                            <asp:TextBox ID="txtalic1" runat="server" class="textboxPge" TabIndex="1" ValidationGroup="group"
                                                Width="40px" Text="CA" ReadOnly="true"></asp:TextBox>
                                            <asp:TextBox ID="txtalic2" runat="server" class="textboxPge" TabIndex="1" ValidationGroup="group"
                                                Width="50px" MaxLength="4" onkeypress="NumberOnly()"></asp:TextBox>
                                            <asp:TextBox ID="txtalic3" runat="server" class="textboxPge" TabIndex="1" ValidationGroup="group"
                                                Width="60px" MaxLength="5" onkeypress="NumberOnly()"></asp:TextBox>
                                            (Ex : CA-Year-5 digits.)
                                        </td>
                                    </tr>
                                             <tr>
                                    ...
                                    <tr id="trtrade" runat="server" visible="true">
                                     <td style="padding: 15px; margin: 5px; width: 2px; font-weight: bold;">21</td>
                                        ...
                                        <td style="padding: 5px; margin: 5px" valign="top">:</td>
                                        <td style="padding: 5px; margin: 5px 5px 5px 45px" valign="top">
                                            <asp:RadioButtonList ID="rbttradelicense" runat="server" Height="17px" RepeatDirection="Horizontal" Width="210px">
                                                <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                ...
                <ItemTemplate>
                     <b>Screen -    <%# Container.DataItemIndex+1 %></b
                </ItemTemplate>
            </asp:TemplateField>
                                            <asp:TemplateField>
                <HeaderTemplate>
                                            ...
                                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="" ItemStyle-Width="60px">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkChecklist" ForeColor="Red" runat="server" NavigateUrl="https://ipass.telangana.gov.in/Information.aspx"
                                                                Target="_blank" CssClass="blink" Text="Procedure/Checklist/Timelines"></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="" ItemStyle-Width="60px">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkApplynow" ForeColor="Red" runat="server" NavigateUrl="https://ipass.telangana.gov.in/IpassLogin.aspx"
                                                                Target="_blank" CssClass="blink" Text="Apply Now"></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <PagerStyle BackColor="#013161" ForeColor="White" HorizontalAlign="Center" />
