...
public partial class UI_TSIPASS_ReleaseProceedingsabstractDistrictwiseSLC : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "ReleaseProceedingsabstractDistrictwiseSLCDrill.aspx?status=A&ProcdNo=" + lblReleaseProceedingNo.Text.Trim() + "&Dist=" + lblDistId.Text.Trim();
            }
          
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "ReleaseProceedingsabstractDistrictwiseSLCDrill.aspx?status=B&ProcdNo=" + lblReleaseProceedingNo.Text.Trim() + "&Dist=" + lblDistId.Text.Trim();
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "ReleaseProceedingsabstractDistrictwiseSLCDrill.aspx?status=C&ProcdNo=" + lblReleaseProceedingNo.Text.Trim() + "&Dist=" + lblDistId.Text.Trim();
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "ReleaseProceedingsabstractDistrictwiseSLCDrill.aspx?status=D&ProcdNo=" + lblReleaseProceedingNo.Text.Trim() + "&Dist=" + lblDistId.Text.Trim();
            }
        }
    ...
    public DataSet GetAppealApplications(string District, string ReleaseProceedingNo)
    {
        ...
        Dsnew = gen.GenericFillDs("USP_GET_Release_Proceedings_abstract_District_wise", pp);
        return Dsnew;
    }
}