<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveGMQueryAutoRejected.aspx.cs" Inherits="UI_TSiPASS_IncentiveGMQueryAutoRejected" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">R1.3 INCENTIVE CLAIM - GM LEVEL PENDENCY ABSTRACT</asp:Label>&nbsp;
                                            ...
                                            <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="No. of Units"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyNoofunits" runat="server" Text='<%#Eval("NoofUnits") %>'>HyperLink</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="About to Breach (90% of Within Time Lines)"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Query Not Responded - Returned Need to Reapply"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
