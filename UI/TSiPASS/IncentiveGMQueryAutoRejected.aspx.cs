...
public partial class UI_TSiPASS_IncentiveGMQueryAutoRejected : System.Web.UI.Page
{
    ...
    public DataSet GetIncentivesMISPendingReport()
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_INCENTIVEMISPENDINGREPORTCOI_GMQUERYAUTOREJECTED", con.GetConnection);
