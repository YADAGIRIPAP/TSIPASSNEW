...
public partial class UI_TSiPASS_frmBMWApplicationslist : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                (e.Row.FindControl("anchortaglinkAcknowledgement") as HyperLink).NavigateUrl = "AcknowledgmentEntrPrintBMW.aspx?EntrpId=" + enterid.Text.Trim();
                (e.Row.FindControl("anchortaglink") as HyperLink).NavigateUrl = "BWMdealerprint.aspx?EntrpId=" + enterid.Text.Trim();
    ...
    private DataSet BindReceipt(string TranRefNo)
    {
        try
        {
            ...
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("USP_GET_APPLICANT_BMW_HISTORY", conn);
