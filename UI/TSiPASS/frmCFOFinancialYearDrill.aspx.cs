...
public partial class UI_TSiPASS_frmCFOFinancialYearDrill : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //{
                ds = GetPublicViewReportDRILL(status,type);
            //}
            //else
            //{
            //    ds = GetPublicViewReportDRILL(status, type, "%", Request.QueryString[0].ToString().Trim(), "%");
            //}
    ...
    protected void BtnSave1_Click(object sender, EventArgs e)
    {
        ...
        {
            ds = Gen.RetriveStatusByTypeDistrictCFO(status, type, "%", Request.QueryString[0].ToString().Trim(), Session["DistrictID"].ToString().Trim(),"","");
        }
        //ds = Gen.RetriveStatusByTypeDistrictCFO(status, type, "%", Request.QueryString[0].ToString().Trim());
    ...
    public DataSet GetPublicViewReportDRILL(string status, string financialyearcd)
    {
        ...
        pp[0].Value = financialyearcd;
        pp[1].Value = status;
       

        Dsnew = Gen.GenericFillDs("USP_GET_PUBLICVIEWDASHBOARD_CFO_DRILL", pp);
        return Dsnew;
