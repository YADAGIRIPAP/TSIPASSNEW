...
public partial class UI_TSIPASS_frmProceedingsabstractSLCDrill : System.Web.UI.Page
{
    int delete = 0;
    ...
    public DataSet GetAbstractdrill(string ProcdNo, string Status, string District)
    {
        ...
        pp[1].Value = Status;
        pp[2].Value = District;
        Dsnew = Gen.GenericFillDs("USP_GET_Release_Proceedings_abstract_Drill", pp);
        return Dsnew;
    }
