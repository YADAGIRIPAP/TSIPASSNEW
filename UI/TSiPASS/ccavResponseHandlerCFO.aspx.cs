...
public partial class UI_TSIPASS_ccavResponseHandlerCFO : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string encResponse="order_id=MIC020000785729CFO&tracking_id=109950710892&bank_ref_no=2065766514&order_status=Success&failure_message=&payment_mode=Net Banking&card_name=ICICI Bank&status_code=null&status_message=SUCCESS&currency=INR&amount=7508.26&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=9000033114&billing_email=accounts.electromech@shrishti.in&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=15093&merchant_param2=Kotak20200902221010&merchant_param3=CFO&merchant_param4=NODEPT&merchant_param5=NA&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=7500.00&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=02/09/2020 22:10:11&bin_country=&trans_fee=7.0&service_tax=1.26";
        ...
        if (msg != null)
        {
            ...
            if (paymentresponseVOsobj.AuthStatus_14 == "Success")
            {
                ...
                {
                    //GetTESTVALUES("MadhuriCFO");
                    GetTESTVALUESCFO(BilldeskResponse);
                }
                catch (Exception ex)
                {
    ...
    public void GetTESTVALUESCFO(string Responce)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_TEST_WEBSERVISE_CFO", con.GetConnection);
            da.SelectCommand.Parameters.Add("@responce", SqlDbType.VarChar).Value = Responce.ToString();
            da.SelectCommand.Parameters.Add("@Online", SqlDbType.VarChar).Value = "Online";
