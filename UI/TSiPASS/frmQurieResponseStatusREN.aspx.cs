...
public partial class UI_TSiPASS_frmQurieResponseStatusREN : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                ds = Gen.GetQueryResponseDetailsByEnterpIDDeptREN(eid, Session["User_Code"].ToString().Trim());
            ...
            else
            {
                ...
                ds = Gen.GetQueryResponseDetailsByEnterpIDREN(eid);
                grdDetails.DataSource = ds.Tables[0];
                grdDetails.DataBind();
            }
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h3.NavigateUrl = "frmViewAttachmentDetailsRenewal.aspx?intApplicationId=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim();
