<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmcoismsreport.aspx.cs" Inherits="UI_TSiPASS_frmcoismsreport" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                <h3 class="panel-title" style="font-weight: bold;">
                                    <asp:Label ID="lblHeading" runat="server">Pendency Report</asp:Label>&nbsp;
                                        ...
                                        <td colspan="6" align="left">
                                            <table width="80%">
                                                <tr runat="server" id="trBetweenDates" visible="true">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px" id="district" runat="server" visible="false">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px" id="district1" runat="server" visible="false">
                                        ...
                                        <td align="center" colspan="6" style="padding: 5px; margin: 5px">
                                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CFECOUNTSCRUTINY" HeaderText="Scrutiny" />
                                                    <asp:BoundField DataField="CFECOUNTAPPROVAL" HeaderText="Approval" />
                                                    <asp:BoundField DataField="CFOCOUNTSCRUTINY" HeaderText="Scrutiny" />
                                                    <asp:BoundField DataField="CFOCOUNTAPPROVAL" HeaderText="Approval" />
                                                    <asp:BoundField DataField="RAWMATERIAL" HeaderText="Rawmaterial" />
                                                    <asp:BoundField DataField="RENEWAL" HeaderText="Renewal" />
                                                    <asp:BoundField DataField="GRIEVANCES" HeaderText="Grievance" />
                                                    <asp:BoundField DataField="DEPTGRIEVANCE" HeaderText="Department Grievance" />
                                                    <asp:BoundField DataField="APPEALCFE" HeaderText="Appeal CFE" />
                                                    <asp:BoundField DataField="APPEALCFO" HeaderText="Appeal CFO" />
                                                </Columns>
                                            </asp:GridView>
                                        </td>
                                    </tr>
