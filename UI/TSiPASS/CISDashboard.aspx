<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master" AutoEventWireup="true" CodeFile="CISDashboard.aspx.cs" Inherits="UI_TSiPASS_CISDashboard" %>
        ...
        <tr>
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i ></i>Central Inspection System
                    </li>
                </ol>
            </div>
                </td>
                    ...
                    <tr>
                        <td style="height: 30px" colspan="5">
                            <asp:Label ID="Label437" runat="server" CssClass="LBLBLACK" Font-Bold="True" Font-Names="Verdana"
                                Width="210px">Central Inspection System</asp:Label>
                        </td>
                    ...
                    <tr id="trcfe" runat="server" visible="true">
                        <td align="center" style="text-align: center">
                            <asp:Button ID="btninspection" runat="server" CssClass="btn btn-primary" Height="91px"
                                TabIndex="10" Text="View Inspection Report" ValidationGroup="group" Width="450px"
                                Font-Bold="True" Font-Names="Verdana" Font-Size="18px" OnClick="btninspection_Click" />
                        </td>
                        <td>
                        </td>
                        <td align="center" style="text-align: center">
