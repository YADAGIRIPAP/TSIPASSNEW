<%@ Page Language="C#" CodeFile="apparaisalnote_isform1.aspx.cs" ValidateRequest="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master"  Inherits="UI_TSIPASS_apparaisalnote_isform1" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr id="trlmv" runat="server" visible="true">
                      <td class="auto-style56"></td>
                        ...
                        <asp:RadioButtonList ID="rdlmv" runat="server" RepeatDirection="Horizontal"
                                                ...
                                                <asp:ListItem Value="NONLMV">Non-LMV</asp:ListItem>
                    ...
                    <tr id="treligibility" runat="server" visible="false">
                     ...
                     <tr id="trexpansion" runat="server" visible="false">
                      <td class="auto-style56"></td>
                        <td style="padding: 5px; margin: 5px;  " class="auto-style57">
                            Select Expansion Unit Yes/No</td>
                        <td style="padding: 5px; margin: 5px; " class="auto-style56">
                            :</td>
                        <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                    ...
                    <tr id="tr4231" runat="server" visible="true">
                      <td class="auto-style56">4.1</td>
                        <td style="padding: 5px; margin: 5px;  " class="auto-style57">
                            State Investment Subsidy in Rs.</td>
                        <td style="padding: 5px; margin: 5px; " class="auto-style56">
                            :</td>
                        <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
