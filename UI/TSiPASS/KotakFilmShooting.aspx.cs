...
public partial class UI_TSiPASS_KotakFilmShooting : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UID_no"] != null && Session["onlinetransId"].ToString() != null)
            {
                ...
                dspaydtls = GetFilmshootingpaymentDtls(CustomerID, TSipassOrderNumber, additionalPayment);
    ...
    public DataSet GetFilmshootingpaymentDtls(string UID, string Orderno, string AdditionalPaymentflg)
    {
        DB.DB con = new DB.DB();
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_Builldesc_PaymentDtls_filmshooting_DESE", con.GetConnection);
