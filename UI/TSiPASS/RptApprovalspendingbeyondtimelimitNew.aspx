<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"  CodeFile="RptApprovalspendingbeyondtimelimitNew.aspx.cs" Inherits="UI_TSiPASS_RptApprovalspendingbeyondtimelimitNew" EnableEventValidation="false" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server">R4.1: Approvals Pending Beyond Time Limit Report - Detailed list</asp:Label>
                            <a id="A1" href="#"  onserverclick="Button2_Click"
                            runat="server">
                                ...
                                <td align="center" style="padding: 5px; height: 100%; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Time Period as per TG-iPASS" DataField="Time Period as per TS-iPASS">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <asp:BoundField HeaderText="Due Date for giving approval" DataField="Due Date for giving approval" />
                                            <asp:BoundField HeaderText="Approval Delay (In Days)" DataField="Delay(Number of days">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                        </Columns>
                                    </asp:GridView>
