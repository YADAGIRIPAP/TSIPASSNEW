<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ApproveDetailsbyquery_Travelagent.aspx.cs" Inherits="UI_TSiPASS_ApproveDetailsbyquery_Travelagent" %>
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Label ID="Label58" runat="server" CssClass="LBLBLACK" ForeColor="Red" Font-Bold="True">If you want to Upload DWG file. make is as ZIP or RAR folder and upload it.</asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label435" runat="server" CssClass="LBLBLACK" Width="284px">Polution Category<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle">5
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="middle">6
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                            ...
                            <tr>
                                <td colspan="2" align="center" style="padding: 5px; margin: 5px; text-align: center;">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/TSiPASS/frmCFEDepartmentsApprovalProcessCFO.aspx">Back</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
