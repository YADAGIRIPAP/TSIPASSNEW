<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveWisePendencylist.aspx.cs" Inherits="UI_TSiPASS_IncentiveWisePendencylist" %>
                        ...
                        <td>
                            ...
                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr id="dropdown" runat="server" visible="false">
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlApplicationMode" class="form-control txtbox" AutoPostBack="false"
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 250px">
                                                        <asp:DropDownList runat="server" ID="ddlworkingstatus" class="form-control txtbox"
                                                            ...
                                                            <asp:ListItem Value="0" Text="--All--"></asp:ListItem>
                                                            <asp:ListItem Value="1" Selected="True" Text="Pending Applications"></asp:ListItem>
                                            ...
                                            <div id="divprint">
                                                ...
                                                <div style="width: 100%">
                                                    <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        PageSize="15" ShowFooter="false" Width="95%" CellSpacing="4" OnRowDataBound="grdDetailsPavallavaddiSC_RowDataBound">
                                                        ...
                                                        <Columns>
                                                          ...
                                                          <%--  <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Category">
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Head of Account">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Pendancy (Rs.in Cr.)">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Released upto">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRELEASEUPTO" runat="server" Text='<%#Eval("RELEASEUPTO") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Released upto(Date)">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRELEASEDDATE" runat="server" Text='<%#Eval("RELEASEDDATE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" Visible="false">
                                                             ...
                                                             <asp:TemplateField HeaderText="View" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="Button1" Height="25px" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server" Text="View" Width="100px" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
