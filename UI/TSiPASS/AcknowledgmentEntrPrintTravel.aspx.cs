...
public partial class UI_TSiPASS_AcknowledgmentEntrPrintTravel : System.Web.UI.Page
{
    ...
    private DataSet BindReceipt(string TranRefNo)
    {
        try
        {
            ...
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("USP_GET_ACKNOWLEDGEMENT_TRAVELAGENT", conn);
