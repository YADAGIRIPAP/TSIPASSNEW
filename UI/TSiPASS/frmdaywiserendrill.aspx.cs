...
public partial class UI_TSiPASS_frmdaywiserendrill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString[1].ToString().Trim() != "")
            {
                ...
                //{
                lblHeading.Text = "RENEWAL Applications for Dated " + txtFromDate.Text.Trim();
    ...
    public DataSet GetDayWiseStatusDRILL(string DISTRICTID, string AppnId, string status)
    {
        ...
        try
        {
            da = new SqlDataAdapter("USP_GET_DAYWISE_REN_COI", osqlConnection);
