<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmPaymentMobiletowerTSROW.aspx.cs" Inherits="UI_TSiPASS_frmPaymentMobiletowerTSROW" %>
            ...
            <div class="col-lg-12">
                <table>
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: x-large">Departments and Approvals for MOBILETOWERTSROW</h1>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                            <tr>
                                                ...
                                                The following are the Approvals required for MOBILETOWERTSROW.
                                            </tr>
                                            <tr>
                                                <td>
