<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmSLCDashBoardfinalSaction.aspx.cs" Inherits="UI_TSiPASS_frmSLCDashBoardfinalSaction" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Upload SLC Proceedings</h1>
                            </div>
                                        ...
                                        <td style="padding: 10px; margin: 5px;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width:250px">Proposed SLC Date: </td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnupdatestatus" CssClass="btn btn-primary" runat="server" Text="Get Updated Proposed SLC Agenda" OnClick="btnupdatestatus_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
