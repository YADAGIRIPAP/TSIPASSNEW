...
public partial class UI_TSiPASS_ProformaApplicantWoodlReimbursement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsnew = Gen.GetSLCDetails(incentiveid, "19");
        ...
        dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "19", "0", "", "INTIMATION");
    ...
    public void fillSLCDetails(DataSet ds)
    {
        ...
        if (ds != null && ds.Tables.Count > 1 && ds.Tables[1] != null && ds.Tables[1].Rows.Count > 0)
        {
            ...
            if (Request.QueryString["IncentiveName"] != null)
            {
                IncentiveName = Request.QueryString["IncentiveName"].ToString();
            }
            lblScheme_GO_Details.Text = "G.O.Ms.No.28 Industries and Commerce (IP & INF) Department. dated.29/11/2014, Read with G.O.Ms.No.18, dated.21/03/2018";
            ...
            if (Request.QueryString["Scheme"] != null)
            {
                ...
                //if (scheme.Contains("IDEA"))
                //{
                lblScheme_GO_Details.Text = "G.O.Ms.No.28 Industries and Commerce (IP & INF) Department. dated.29/11/2014, Read with G.O.Ms.No.18, dated.21/03/2018";

                //}

                //else if (scheme.ToUpper().Contains("IDEA"))
                //{
                ...
                //}
                //else if ((scheme.Contains("IDEA")) && (IncentiveName.Contains("Coal")))
                //{
                //    lblScheme_GO_Details.Text = "G.O.Ms.No.28 Industries and Commerce (IP & INF) Department. dated.29/11/2014, Read with G.O.Ms.No.18, dated.21/03/2018";
                //}
            }
