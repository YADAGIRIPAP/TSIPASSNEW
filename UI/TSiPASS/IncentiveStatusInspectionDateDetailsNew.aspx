<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveStatusInspectionDateDetailsNew.aspx.cs" Inherits="UI_TSiPASS_IncentiveStatusInspectionDateDetailsNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">Incentive Details</a> </li>
        </ol>
    </div>
    <div align="left">
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px" class="style17">
                                                            <asp:DropDownList ID="ddlstatus" runat="server" class="form-control txtbox" Height="33px"
                                                                Width="180px" AutoPostBack="True" TabIndex="1" Enabled="False">
                                        ...
                                        <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                           ...
                                           <div style="margin-bottom: 17px; text-align: left; margin-left:0px;">
                                                            <input type="text" id="search" class="form-control input-sm" style="width: 380px; font-size: 16px; height: 35px;float:left;margin-right:10px;" placeholder="Type to search" /><input type="button" class="btn btn-default" value="Clear" id="clear" /></div>
                                           <asp:GridView ID="gvdetailsnew" CssClass="floatingTable" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <%--<asp:BoundField DataField="EMiUdyogAadhar" ItemStyle-HorizontalAlign="Center" HeaderText="EMI Udyog Aadhaar" />  --%>
                                                                                  ...
                                                                                  <asp:BoundField  HeaderStyle-Wrap="true" HeaderStyle-Width="100px" DataField="DCP" ItemStyle-HorizontalAlign="Center" HeaderText="DCP" />
                                                                                <%--<asp:BoundField DataField="DCP" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Commencement of Prod" />--%>
                                                                                <asp:BoundField DataField="ApplicationFiledDate" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Filing" />
                                                                                <asp:BoundField DataField="InspectionAssignDate" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Assign" />

                                                                                <asp:BoundField DataField="UnitName" ItemStyle-HorizontalAlign="Center" HeaderText="Unit Name" />
                                                                                <%--<asp:BoundField DataField="ApplciantName" ItemStyle-HorizontalAlign="Center" HeaderText="Applciant Name" />  --%>
                                                                                <asp:BoundField DataField="NoofIncentives" ItemStyle-HorizontalAlign="Center" HeaderText="No. of Incentives" />
                                                                                 <asp:TemplateField HeaderText="Incentiveid" Visible="false">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblIncentiveID" Text='<%#Eval("EnterperIncentiveID") %>' runat="server" />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <%--<asp:BoundField DataField="inStatus" ItemStyle-HorizontalAlign="Center" HeaderText="Status" />--%>
                                                                                <asp:TemplateField HeaderText="View Application" ItemStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                      <%--  <a id="View" target="_blank" href="ApplicantIncentiveDtls.aspx?EntrpId=<%# Eval("EnterperIncentiveID") %>&Status=2">View</a>--%>
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" colspan="3" align="center" runat="server" visible="false">
                                                                ...
                                                                <asp:TemplateField HeaderText="Inspection Date">
                                                                    <ItemTemplate>
                                                                        <table style="width: 100%" cellpadding="4" cellspacing="5">
                                                                            <tr>
                                                                                <asp:Label ID="lbl123" Text="Inspection Date" runat="server"></asp:Label>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="width: 150px; height: 29px">
                                                                                    <asp:TextBox ID="txtInspectionDate" runat="server" AutoPostBack="True"
                                                                                        OnTextChanged="txtInspectionDate_TextChanged"></asp:TextBox>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="4" align="center">
                                                                                    ...
                                                                                    <br />
                                                                                    <asp:Label ID="lblm" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                                    <asp:HiddenField ID="HdfintApplicationid" runat="server" Value='<%#Eval("IncentveId") %>' />
                                                                                    <asp:HiddenField ID="hdfEmailID" runat="server" Value='<%#Eval("UnitEmail") %>' />
                                                                                    <asp:HiddenField ID="hdfMobileNo" runat="server" Value='<%#Eval("UnitMObileNo") %>' />
                                                                                    <asp:HiddenField ID="hdfApplName" runat="server" Value='<%#Eval("ApplciantName") %>' />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
