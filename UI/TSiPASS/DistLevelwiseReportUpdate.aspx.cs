...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    protected void BtnSaveg_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            int returnValue = Gen.ChangeDistrictWiseStatus(HdfintApplicationid.Value, ddlStatus.SelectedValue.ToString().Trim(), 
                Session["uid"].ToString(), txtreasonschange.Text.Trim().TrimStart(), (newPath + "\\" + sFileName),"","","","");
