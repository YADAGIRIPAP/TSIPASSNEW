<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDIPCDashBoardfinal.aspx.cs" Inherits="UI_TSiPASS_frmDIPCDashBoardfinal" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large">Generate DIPC Agenda</h1>
                            </div>
                                        ...
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 300px">Proposed DIPC Date : </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left; width: 150px">
                                                        <asp:TextBox runat="server" autocomplete="off" ID="txtsvcdate" class="form-control txtbox" Height="28px"
                                                    ...
                                                    <td>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtsvcdate"
                                                            ErrorMessage="Please Enter SVC Date" ValidationGroup="group">Please Enter Proposed DIPC Date</asp:RequiredFieldValidator></td>
                                                </tr>
                                            </table>
