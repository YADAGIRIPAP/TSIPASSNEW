<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmFiredetailsCFO.aspx.cs" Inherits="UI_TSiPASS_frmFiredetailsCFO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">Fire Details</a> </li>
        </ol>
    </div>
    <div align="left">
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtHight_Building" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtHight_Building"
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtHight_EachFloor" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtHight_EachFloor"
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" align="left">
                                    <asp:Label ID="Label378" runat="server" CssClass="LBLBLACK" Width="280px" Font-Bold="True">A) Means of Escape</asp:Label>
                                </td>
                                <td style="width: 27px">
                                    &nbsp;
                                </td>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:DropDownList ID="ddlstaire" runat="server" class="form-control txtbox" Height="33px"
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="ddlstaire"
                                                    ErrorMessage="Please Select Type Of Stair Cases" InitialValue="--Select--" ValidationGroup="group1">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtNofStairecases" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px" OnTextChanged="txtcontact13_TextChanged"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtNofStairecases"
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtWidth_Stairs1" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px" OnTextChanged="txtcontact13_TextChanged"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtWidth_Stairs1"
                                                    ErrorMessage="Please Enter Width of Stair Cases" ValidationGroup="group1">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <%--  <tr>
                            ...
                            <tr id="tr2" runat="server">
                                <td style="padding: 5px; margin: 5px" colspan="10" align="center">
                                    <asp:Button ID="BtnSave2" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                        TabIndex="10" Text="Add" ValidationGroup="group1" Width="72px" OnClick="BtnSave2_Click1" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="BtnClear0" runat="server" CausesValidation="False"
                                        ...
                                        Text="Cancel" ToolTip="To Clear  the Screen" Width="73px" OnClick="BtnClear0_Click2" />
                                </td>
                                <td style="padding: 5px; margin: 5px">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" align="left">
                                    <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK" Width="375px" Font-Bold="True">B) Open spaces all around the building: (in mts)</asp:Label>
                                </td>
                                <td style="width: 27px">
                                    &nbsp;
                                </td>
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:TextBox ID="txtFire_East" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtFire_East"
                                                    ErrorMessage="Please Enter Spaces all around the building in East" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtFire_West" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtFire_West"
                                                    ErrorMessage="Please Enter Spaces all around the building in West" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtFire_North" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtFire_South"
                                                    ErrorMessage="Please Enter Spaces all around the building in North" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtFire_South" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="8" onkeypress="return inputOnlyNumbers(event)" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtFire_East"
                                                    ErrorMessage="Please Enter Spaces all around the building in South" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlLevel_ground"
                                                    ErrorMessage="Please Select Level of Ground" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlFire_Detection"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="ddlFire_Alaram"
                                                    ErrorMessage="Please Select File Alarm System" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlfrontsidedir"
                                                    ErrorMessage="Please Select Front Side Direction" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" align="left">
                                    <asp:Label ID="Label7" runat="server" CssClass="LBLBLACK" Width="375px" Font-Bold="True">C) Fire Fighting System:</asp:Label>
                                </td>
                                <td style="width: 27px">
                                    &nbsp;
                                </td>
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:RadioButtonList ID="rblSprinkler" runat="server" RepeatDirection="Horizontal"
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="rblSprinkler"
                                                    ErrorMessage="Please Select Sprinkler" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:RadioButtonList ID="rblHoseReel" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="rblHoseReel"
                                                    ErrorMessage="Please Select Hose Reel" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rblCO2" runat="server" RepeatDirection="Horizontal" Width="200px"
                                                    TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="rblCO2"
                                                    ErrorMessage="Please SelectCO2" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rblWetRiser" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" OnSelectedIndexChanged="RadioButtonList14_SelectedIndexChanged"
                                                    TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="rblWetRiser"
                                                    ErrorMessage="Please Select Wet Riser" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rblDownCorner" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="rblDownCorner"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rdbYardHydrant" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="rdbYardHydrant"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                ...
                                                <asp:RadioButtonList ID="rdbManuallyOperated" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="rdbManuallyOperated"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <%--<asp:TextBox ID="txtCourt_yard_hydrants" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbDetectionSystem" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="rdbDetectionSystem"
                                                    ErrorMessage="Please Select Automatic Detection System" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%-- <asp:TextBox ID="txtFire_pumps_Electrical_15" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbgroundwatersump" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="rdbgroundwatersump"
                                                    ErrorMessage="Please Enter Under Ground Water Sump" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%--<asp:TextBox ID="txtFire_pumps_Diesel" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbTerraceTank" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="rdbTerraceTank"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%--<asp:TextBox ID="txtFire_pumps_Electrical_30" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbTerracePumps" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="rdbTerracePumps"
                                                    ErrorMessage="Please Select Terrace Pumps" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%--<asp:TextBox ID="txtFire_pumps_Electrical_30" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbElectricalpumps" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="rdbElectricalpumps"
                                                    ErrorMessage="Please Select Electrical pumps" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%--<asp:TextBox ID="txtFire_pumps_Electrical_30" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbDieselPumps" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="rdbDieselPumps"
                                                    ErrorMessage="Please Select Diesel pumps" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <%--<asp:TextBox ID="txtFire_pumps_Electrical_30" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="return inputOnlyNumbers(event)" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>--%>
                                                <asp:RadioButtonList ID="rdbJockeyPumps" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="rdbJockeyPumps"
                                                    ErrorMessage="Please Select Jockey Pumps" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top" align="left">
                                    <asp:Label ID="Label15" runat="server" CssClass="LBLBLACK" Width="375px" Font-Bold="True">D) Other protection measures:</asp:Label>
                                </td>
                                <td style="width: 27px">
                                    &nbsp;
                                </td>
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:RadioButtonList ID="rblTrolley_45" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="rblTrolley_45"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="ddlFireLiftsProvided"
                                                    ErrorMessage="Please Select Fire Lifts Provided" InitialValue="--Select--" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rblSoakPit" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" OnSelectedIndexChanged="RadioButtonList18_SelectedIndexChanged"
                                                    TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ControlToValidate="rblSoakPit"
                                                    ErrorMessage="Please Select Air Conditioning Safety Provided" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RadioButtonList ID="rblLightning_Prot" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" OnSelectedIndexChanged="RadioButtonList19_SelectedIndexChanged"
                                                    TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator31" runat="server" ControlToValidate="rblLightning_Prot"
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                <asp:RadioButtonList ID="rblCont_Room" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator32" runat="server" ControlToValidate="rblCont_Room"
                                                    ErrorMessage="Please Select Control Room" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:RadioButtonList ID="rblHydraulic_Platform" runat="server" RepeatDirection="Horizontal"
                                                    Width="200px" TabIndex="1">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            ...
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator33" runat="server" ControlToValidate="rblHydraulic_Platform"
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <strong>E) Fire Fighting Drawings/Plans :</strong>
                                </td>
                                <td style="width: 27px">
                                    &nbsp;
                                </td>
                                ...
                                <td colspan="6">
                                    <table style="width: 60%">
                                        <tr runat="server" id="trerector" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label19" runat="server" CssClass="LBLBLACK" Width="210px">Site Plan<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; width: 500px; text-align: left;">
                                                <asp:FileUpload ID="FilePlanapproval" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="lblPlanapproval" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="LabelPlanapproval" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="BtnPlanapproval" runat="server" CssClass="btn btn-xs btn-warning"
                                                    Height="28px" TabIndex="10" Text="Upload" Width="72px" OnClick="BtnPlanapproval_Click" />
                                            </td>
                                        </tr>
                                        <tr runat="server" id="tr1" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label30" runat="server" CssClass="LBLBLACK" Width="210px">Cellar Floor Plan<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadCellarFloor" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpCellarFloor" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                        ...
                                        <tr runat="server" id="tr3" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label32" runat="server" CssClass="LBLBLACK" Width="210px">Stilt/Ground Floor Plan<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadGroundFloor" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpGroundFloor" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                        ...
                                        <tr runat="server" id="tr4" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label34" runat="server" CssClass="LBLBLACK" Width="210px">Floor Wise Plan<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadFloorWise" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpFloorWise" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="lblFloorWise" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="Button3" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                                    TabIndex="10" Text="Upload" Width="72px" OnClick="Button3_Click" />
                                            </td>
                                        </tr>
                                        <tr runat="server" id="tr5" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label36" runat="server" CssClass="LBLBLACK" Width="210px">Terrace Plan<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadTerracePlan" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpTerracePlan" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="lblTerracePlan" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                        ...
                                        <tr runat="server" id="tr6" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label38" runat="server" CssClass="LBLBLACK" Width="210px">Section<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadSection" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpSection" runat="server" CssClass="LBLBLACK" Width="165px" Target="_blank"></asp:HyperLink>
                                                <br />
                                        ...
                                        <tr runat="server" id="tr7" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label40" runat="server" CssClass="LBLBLACK" Width="210px">Elevation<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUploadElevation" runat="server" class="form-control txtbox"
                                                    Height="28px" />
                                                <asp:HyperLink ID="HpElevation" runat="server" CssClass="LBLBLACK" Width="165px"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="lblElevation" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                        ...
                                        <tr runat="server" id="tr8" visible="true">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label42" runat="server" CssClass="LBLBLACK" Width="210px">If Any Other Plans/Supporting Documents</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            </td>
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:Button ID="Button7" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                                    TabIndex="10" Text="Upload" Width="72px" OnClick="Button7_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FileUpload4" runat="server" class="form-control txtbox" Height="28px" />
