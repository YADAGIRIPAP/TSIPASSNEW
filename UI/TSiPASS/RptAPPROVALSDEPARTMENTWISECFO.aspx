<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="RptAPPROVALSDEPARTMENTWISECFO.aspx.cs" Inherits="LookupCA" Title=":: TSiPASS Online Management System ::" %>
            ...
            <td style="padding-top: 10px; padding-bottom: 20px; padding-left: 9px; height: 675px;"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title" style="font-weight: bold;">CFO R3: Total Approvals Status - Department Wise<a id="A1" href="#" onclick="javascript:return Panel1();"
                            runat="server">
                                                ...
                                                <table width="80%">
                                                    <tr align="center">
                                                        <td style="padding: 5px; margin: 5px" align="right">
                                                            <asp:HyperLink CssClass="btn btn-link" ID="HyperLink2" runat="server" NavigateUrl="~/UI/TSiPASS/ReportsDashboardCFO.aspx" Text="<< Back">
                                                            </asp:HyperLink>
                                                        </td>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails"  runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField FooterStyle-CssClass="text-center" ControlStyle-Font-Underline="false"
                                                HeaderText="Scrutiny Completed Payment Made" DataTextField="Prescrutiny Completed Payment Made">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                            </asp:HyperLinkField>
                                            <asp:HyperLinkField FooterStyle-CssClass="text-center" ControlStyle-Font-Underline="false"
