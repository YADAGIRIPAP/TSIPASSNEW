<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmIncentiveform_WOOD.aspx.cs" Inherits="UI_TSiPASS_frmIncentiveform_WOOD" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            ...
                            <tr>
                                <td style="padding: 5px; margin: 5px; text-align: left; font-weight: bold"> Wood Details
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 100%; font-weight: bold;">
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlFinYearWOOD" runat="server" class="form-control txtbox" Height="33px" Width="180px">
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label4" runat="server">1st/2nd Quarter<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlFirstorSecondQUarter" runat="server" class="form-control txtbox" Height="33px" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="ddlFirstorSecondQUarter_SelectedIndexChanged">
                                                    <asp:ListItem Value="--Select--" Text="--Select--"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="1st Quarter"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="2nd QUarter"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="Label6" runat="server"> <font color="red"></font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                                ...
                                                                                <tr id="trFin1stHalf1stquarter" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">a</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label12" runat="server">1st Half Year 1st quarter Amount Paid <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt1stHalf1stquarterAmountPaid" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">b</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="Label14" runat="server">1st Half Year 1st quarter Amount Claimed <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt1stHalf1stquarterAmountClaimed" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trfirsthalfyearsecondquarter" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">a</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label17" runat="server">1st Half Year 2nd Quarter Amount Paid <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt1stHalf2ndquarterAmountPaid" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">b</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="Label18" runat="server">1st Half Year 2nd Quarter Amount Claimed <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt1stHalf2ndquarterAmountClaimed" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trFin2ndHalf1stquarter" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">a</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label13" runat="server">2nd Half Year 1st Quarter Amount Paid <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt2ndHalf1stquarterAmountPaid" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">b</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="Label15" runat="server">2nd Half Year 1st Quarter Amount Claimed <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt2ndHalf1stquarterAmountClaimed" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                        </tr>                                     
                                        <tr id="trFin2ndHalf2ndquarter" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">a</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label19" runat="server">2nd Half Year 2nd Quarter Amount Paid <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt2ndHalf2ndquarterAmountPaid" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">b</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="Label20" runat="server">2nd Half Year 2nd Quarter Amount Claimed <br />(in Rs)<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txt2ndHalf2ndquarterAmountClaimed" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                        </tr>
                                                            <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label8" runat="server">Is Previously Wood Sanctioned in Year<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:RadioButtonList ID="rbtwoodsanctioned" AutoPostBack="true" OnSelectedIndexChanged="rbtwoodsanctioned_SelectedIndexChanged" RepeatDirection="Horizontal" runat="server" >
                            <asp:ListItem Value="Y" >YES</asp:ListItem>
                            <asp:ListItem Value="N" >NO</asp:ListItem>
                        </asp:RadioButtonList>
                                            </td>
                                            <td id="tdquartera" runat="server" visible="false" style="padding: 5px; margin: 5px; text-align: left;">&nbsp;</td>
                                            <td id="tdquarterb" runat="server" visible="false" style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                                <asp:Label ID="lblsanctionedquarters" runat="server">No of quarters previously Sanctioned In Year <font color="red">*</font></asp:Label> <font color="red"></font></asp:Label>
                                            </td>
                                            <td id="tdquarterc" runat="server" visible="false" style="padding: 5px; margin: 5px"></td>
                                            <td id="tdquarterd" runat="server" visible="false" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:DropDownList ID="ddlnoofquarterssanctioned" runat="server" class="form-control txtbox" Height="33px" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="ddlnoofquarterssanctioned_SelectedIndexChanged">
                                        ...
                                        <tr id="trfirstquarterQuantity" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">4a</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label9" runat="server">1st Quarter Quantity<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="TXTFIRSTQTRQTY" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                        ...
                                        <tr id="trSecondquarterQuantity" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">4b</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label24" runat="server">2nd Quarter Quantity<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="TXTSECONDQTRQTY" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                        ...
                                        <tr id="trThirdquarterQuantity" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">4c</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label22" runat="server">3rd Quarter Quantity<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="TXTTHIRDQTRQTY" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                        ...
                                        <tr id="trcoalqtyandclaimamount" runat="server">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style6">
                                                <asp:Label ID="Label7" runat="server">ADMT Quantity<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="TXTADMTQUANTITY" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px" AutoPostBack="true" OnTextChanged="TXTADMTQUANTITY_TextChanged"></asp:TextBox>
                                            </td>
                                            ...
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtunitofmeasurement" Text="ADMT" runat="server" class="form-control txtbox" 
                                        ...
                                        <%--<tr id="trfourthquarterQuantity" runat="server" visible="false">
                                            <td style="padding: 5px; margin: 5px; text-align: left;">16d</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style2">
                                                <asp:Label ID="Label26" runat="server">4th Quarter Quantity<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="TXTFOURTHQTRQTY" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                    Height="28px" MaxLength="40" TabIndex="36" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;"></td>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="auto-style8">
                                            ...
                                            <td style="padding: 5px; margin: 5px" valign="top">
                                                <table style="width: 100%; font-weight: bold;">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px" class="auto-style1">10</td>
                                                        <td>
                                                            <asp:Label ID="Label10" runat="server" CssClass="LBLBLACK" Width="165px">Unit of Measument<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; margin: 5px">:</td>
                                                        <td style="padding: 5px; margin: 5px">
                                                                                                                        <asp:TextBox ID="txtunitmeasurement_paper" runat="server" class="form-control txtbox" Text="ADMT" Enabled="false"
                                                                Height="28px" MaxLength="40" TabIndex="37" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                    ...
                                                    <%--<tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px" runat="server" visible="false">
                                                            <asp:TextBox ID="txtvalue" runat="server" class="form-control txtbox" onkeypress="return inputOnlyNumbers(event)"
                                                                Height="28px" MaxLength="40" TabIndex="37" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                        </td>
                                                    </tr>--%>
                                ...
                                <td>
                                    <table style="width: 80%">
                                        ...
                                        <tr id="TRTSFDC" runat="server">
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">1 TSFDC Certificate/Invoice</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FUPTSFDC" runat="server" CssClass="CS" Height="28px" />
                                                <asp:HyperLink ID="HYPTSFDC" runat="server" CssClass="LBLBLACK"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="LBLTSFDC" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;" valign="top">
                                                <asp:Button ID="BTNTSFDC" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                                    TabIndex="10" Text="Upload" Width="72px" OnClick="BTNTSFDC_Click" />
                                            </td>
                                        </tr>
                                        <tr id="TR3" runat="server" visible="false">
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">1(b). TSFDC Invoice</td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                ...
                                                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="LBLBLACK"
                                                    Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:HiddenField ID="HDNWOODID" runat="server" Visible="false" />
                                        ...
                                        <tr runat="server">
                                            <td colspan="3" style="padding: 3px; margin: 3px; text-align: left; font-weight: bold">Market Documents
                                            </td>
                                        </tr>
                                        
                                        
                                        <tr>
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">2. CA certificate/Invoice
                                            </td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top" class="auto-style5">3. Proof of Payment Receipts/Bank Statements
                                            </td>
                                            ...
                                            <td style="padding: 5px; margin: 5px; " valign="top" class="auto-style4">
                                        ...
                                        <tr>
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">4.CA Certificate for Paper Production
                                            </td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FUPCACARTIFICATEPAPER" runat="server" CssClass="CS" Height="28px" />
                                                <asp:HyperLink ID="HYPCACERTIFICATEPAPER" runat="server" CssClass="LBLBLACK" Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="LBLCACERTIFICATEPAPER" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;" valign="top">
                                                <asp:Button ID="BTNCACERTIFICATEPAPER" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                                    TabIndex="10" Text="Upload" Width="72px" OnClick="BTNCACERTIFICATEPAPER_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">5. CA Certificate for ADMT Quantity for wood Purchased
                                            </td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:FileUpload ID="FUPCACERTIFICATEADMT" runat="server" CssClass="CS" Height="28px" />
                                                <asp:HyperLink ID="HYPFUPCACERTIFICATEADMT" runat="server" CssClass="LBLBLACK" Target="_blank"></asp:HyperLink>
                                                <br />
                                                <asp:Label ID="LBLFUPCACERTIFICATEADMT" runat="server" Visible="False"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;" valign="top">
                                                <asp:Button ID="BTNFUPCACERTIFICATEADMT" runat="server" CssClass="btn btn-xs btn-warning" Height="28px"
                                                    TabIndex="10" Text="Upload" Width="72px" OnClick="BTNFUPCACERTIFICATEADMT_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 3px; margin: 3px; text-align: left;" valign="top">6. Attested copy of Valid CFO
                                            </td>
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
