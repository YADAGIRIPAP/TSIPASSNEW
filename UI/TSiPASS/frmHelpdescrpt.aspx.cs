...
public partial class UI_TSIPASS_frmHelpdescrpt : System.Web.UI.Page
{
    int NumberTotal,NumberTotal_up, Aproved, pending, Yet_to_Start, Initial_Stage, Advanced_Stage, Commenced_Operations, NumberTotalUpto, AprovedUpto, RejectedTotal;
    ...
    public void fillgrid()
    {
        ...
        vehicleDS = Gen.HelpdescReport(FromdateforDB, TodateforDB);

        grdDetails.DataSource = vehicleDS.Tables[0];
        grdDetails.DataBind();

        grdDetails1.DataSource = vehicleDS.Tables[2];
        grdDetails1.DataBind();

        grdDetails2.DataSource = vehicleDS.Tables[1];
        grdDetails2.DataBind();

           DataSet vehicleDS_up = new DataSet();

           vehicleDS_up = Gen.HelpdescReport_up(FromdateforDB, TodateforDB);

        gvw_up.DataSource = vehicleDS_up.Tables[0];
        gvw_up.DataBind();
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Service_id = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intfb_id"));
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
    ...
    protected void grdDetails1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            int NumberTotal2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Scount"));
            NumberTotalUpto = NumberTotal2 + NumberTotalUpto;

            Service_id = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "SOLVED_BY"));
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        }
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[1].Text = "Grand Total";
            e.Row.Cells[2].Text = NumberTotalUpto.ToString();
           
            Service_id = "%";
            HyperLink h1 = new HyperLink();
            h1.Text = NumberTotalUpto.ToString();
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
                e.Row.Cells[2].Controls.Add(h1);
            }
            h1.ForeColor = System.Drawing.Color.White;
    ...
    protected void grdDetails2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            int Aproved1 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "POSTEDCNT"));
            Aproved = Aproved + Aproved1;

            int Aproved2 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "SOLVEDCOUNT"));
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=3&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=4&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=5&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[2].Text = Aproved.ToString();
            e.Row.Cells[3].Text = AprovedUpto.ToString();
            ...
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=3&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
                e.Row.Cells[2].Controls.Add(h3);
            }
            HyperLink h4 = new HyperLink();
            h4.Text = AprovedUpto.ToString();
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=4&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
                e.Row.Cells[3].Controls.Add(h4);
            }
            HyperLink h5 = new HyperLink();
            h5.Text = pending.ToString();
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=5&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
    ...
    protected void gvw_up_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        string Service_id = "";
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            int NumberTotal4 = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "Scount"));
            NumberTotal_up = NumberTotal4 + NumberTotal_up;
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=6&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text;
            }
        }
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[1].Text = "Grand Total";
            e.Row.Cells[2].Text = NumberTotal_up.ToString();

            Service_id = "%";
            HyperLink h1 = new HyperLink();
            h1.Text = NumberTotal_up.ToString();
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmHelpdescrptDrill.aspx?Id=" + Service_id + "&Status=6&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
                e.Row.Cells[2].Controls.Add(h1);
            }
            h1.ForeColor = System.Drawing.Color.White;
        }
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R11.2: Department Wise Grievance Redressal\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=R11.2_Department_Wise_Grievance_Redressal" + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
            Response.ContentType = "application/pdf";
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage.Text = "Total Applications Pending";
            tcMergePackage.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage.ColumnSpan = 3;
            gvHeaderRowCopy.Cells.AddAt(0, tcMergePackage);
    ...
    protected void grdDetails1_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            TableCell tcMergePackage = new TableCell();
            tcMergePackage.Text = "Total Applications Solved User Wise from " + txtFromDate.Text.Trim() + " To " + txtTodate.Text.Trim();
            tcMergePackage.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage.ColumnSpan = 3;
            gvHeaderRowCopy.Cells.AddAt(0, tcMergePackage);
    ...
    protected void grdDetails2_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            TableCell tcMergePackage = new TableCell();
            tcMergePackage.Text = "Total Applications History from " + txtFromDate.Text.Trim() + " To " + txtTodate.Text.Trim() ;
            tcMergePackage.CssClass = "GridviewScrollC1Headerwrap";
    ...
    protected void gvw_up_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            GridViewRow gvHeaderRow = e.Row;
            ...
            this.gvw_up.Controls[0].Controls.AddAt(0, gvHeaderRowCopy);
            ...
            TableCell tcMergePackage = new TableCell();
            tcMergePackage.Text = "Total Applications Under Proccess";
            tcMergePackage.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage.ColumnSpan = 3;
            gvHeaderRowCopy.Cells.AddAt(0, tcMergePackage);
