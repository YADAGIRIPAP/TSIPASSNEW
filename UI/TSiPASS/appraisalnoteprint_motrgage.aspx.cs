...
public partial class UI_TSiPASS_appraisalnoteprint_motrgage : System.Web.UI.Page
{
    ...
    public void getDetails()
    {
        ...
        foreach (string Item in arListApplNo)
        {
            ...
            da.SelectCommand.Parameters.Add("@mstincentiveid", SqlDbType.VarChar).Value = "15";
            da.Fill(ds);
            ...
            if (ds.Tables[0].Rows.Count > 0)//[lblLand_ProjectCost]   
            {
                ...
                sbPrint.Append("</table></td></tr></table>");
                sbPrint.Append("<table  align='center' style='width: 650px;' border='0' cellpadding='0px' cellspacing='0px'>");
                sbPrint.Append("<tr ><td><table cellpadding='0px' cellspacing='0px' style='width: 100%;'><td style='height: 10px; width: 0px;' class='addressing' valign='top' align='left'> </td><td style='height: 15px; width: 900px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; a) Name of the Financial Institution</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 500px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; " + ds.Tables[0].Rows[0]["FinInstitution"].ToString() + " &nbsp;</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; b) Term Loan Sanctioned Amount in Rs. </td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["TermLoanSancctioned"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; c) Mortgage Duty paid by the unit in Rs. </td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["MortgagePaid"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px; width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; d) Termloan availed by the unit in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'> </td>&nbsp;<td style='height: 15px;width: 1000px;' class='addressing'  valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["TermLoanAvailed"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; e) Base Production</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["PropMortgageDuty"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; f) Mortgage Duty Recommended by GM in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["Mortgage_gM"].ToString() + "</td></tr>");
                sbPrint.Append("<tr><td style='height: 15px; width: 0px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' width: 700px;' class='addressing' valign='top' align='left'>&nbsp; &nbsp; &nbsp; &nbsp; g) Eligible for Reimbursement of Mortgage Duty in Rs.</td><td style='height: 15px; width: 2px;' class='addressing' valign='top' align='left'></td><td style='height: 15px;' class='addressing' valign='top' align='left'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + ds.Tables[0].Rows[0]["FINAL_Mortgage_Reimbursement"].ToString() + "</td></tr>");
