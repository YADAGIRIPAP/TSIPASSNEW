...
public partial class UI_TSiPASS_IncentiveStatusInspectionDateDetailsNew : System.Web.UI.Page
{
    ...
    protected void fetchIncentivedet()
    {
        ...
        if (Session["IncUserIDUrl"] != null && Session["IncUserIDUrl"].ToString() != "")
        {
            ds = Gen.fetchIncentivedetIPONewINCTypeNew(Session["IncUserIDUrl"].ToString(), Request.QueryString[0].ToString().Trim(), ddlIncentiveName.SelectedValue, TxtIndname.Text);
        }
        else
        {
            ds = Gen.fetchIncentivedetIPONewINCTypeNew(Session["uid"].ToString(), Request.QueryString[0].ToString().Trim(), ddlIncentiveName.SelectedValue, TxtIndname.Text);
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //        HdfintApplicationid.Value = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "IncentveId")).Trim();
    ...
    protected void BtnSaveg_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            int returnValue = Gen.UpdateInspectionDateNewIncType(HdfintApplicationid.Value, txtInspectionDate.Text, Session["uid"].ToString());  //nikhil
