<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CheckListPrintNew.aspx.cs" Inherits="UI_TSiPASS_CheckListPrintNew" %>
                                ...
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr runat="server" visible="false">
                                        <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                            <table width="50%">
                                                <tr>
                                                    <td style="vertical-align: middle; font-weight: bold; width: 200px">1) Cheque List Date :
                                                    </td>
                                            ...
                                            <div id="Div1" style="width: 100%" runat="server">
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="NameofUnit" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Name of Unit & Address">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="UnitAddress" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Unit Address">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="DateofReceipt" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Receipt" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Scheme" ItemStyle-HorizontalAlign="Center" HeaderText="Scheme" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="RecommendedAmount" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Recommended Amount" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>

                                                        <asp:BoundField DataField="SanctionedDate" ItemStyle-HorizontalAlign="Center" HeaderText="Sanctioned Date" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="SLCNumer" ItemStyle-HorizontalAlign="Center" HeaderText="SLC Numer" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="SLCDate" ItemStyle-HorizontalAlign="Center" HeaderText="SLCDate" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="SLCDate" ItemStyle-HorizontalAlign="Center" HeaderText="SLCDate" Visible="false">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField HeaderText="CheckPrintedDate" Visible="false">
                                                            <ItemTemplate>
                                    ...
                                    <tr style="height: 30px">
                                        <td>
                                            <table style="width: 80%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" id="tdslcno" runat="server">List Number
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtannexturenumber" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" id="tdslcndate" runat="server">Scheme Category
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:DropDownList ID="SCHCATEGORY" runat="server" class="form-control txtbox" Height="30px" TabIndex="1" Width="220px" AutoPostBack="True"> </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" id="td1" runat="server">Cheque Proceeding Amount
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtamount" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px" Enabled="false"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" id="td2" runat="server">Cheque Proceeding No
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:TextBox runat="server" ID="ChequeProceedingNo" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" id="td3" runat="server">LOC NUMBER
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="LOC_NO" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" id="td4" runat="server">LOC Date
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <%--<asp:TextBox runat="server" ID="TextBox3" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>--%>
                                                        <asp:TextBox runat="server" ID="LOCDate" placeholder="DD/MM/YYYY" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" id="td5" runat="server">LOC AMOUNT
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="LOCAMOUNT" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px" id="td6" runat="server">Sanctioned LOC AMOUNT
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:TextBox ID="San_LOC_AMOUNT" runat="server" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <%--<tr>
                                                    <td style="padding: 5px; margin: 5px" id="td9" runat="server">Sanctioned LOC AMOUNT
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="San_LOC_AMOUNT" runat="server" class="form-control txtbox" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; text-align: left;" id="td10" runat="server">Sanctioned LOC Number
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">:
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        <asp:TextBox runat="server" ID="San_LOCNo" Height="28px"
                                                            MaxLength="80" TabIndex="1" Width="200px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td colspan="12" style="padding: 5px; margin: 5px" align="center" class="style7"
                                            ...
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Update Check Details" OnClick="Button1_Click"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="12">&nbsp;
    ...
    <script type="text/javascript">
        function checkValidation() {
           ...
           <%-- var counter = 0;
            ...
            var LOCNo = $('#ctl00_ContentPlaceHolder1_LOC_NO').val();
            var LOCDATE = $('#ctl00_ContentPlaceHolder1_LOCDate').val();
            var LOCamt = $('#ctl00_ContentPlaceHolder1_LOCAMOUNT').val();
            var SancLOCamt = $('#ctl00_ContentPlaceHolder1_San_LOC_AMOUNT').val();
            var msg = "";
            var a = "Please Enter Cheque No \n";
            var b = "Please Enter Cheque Date \n";
            var c = "Please Enter Cheque Amount\n";
            var d = "Please Enter LOC No \n";
            var e = "Please Enter LOC Date \n";
            var f = "Please Enter LOC Amount\n";
            var g = "Please Enter Sanctioned LOC Amount\n";
            ...
            if (allcount == 0) {
                ...
                if (LOCNo == "" || LOCNo == undefined) { msg = d; }
                if (LOCDATE == "" || LOCDATE == undefined) { msg = e; }
                if (LOCamt == "" || LOCamt == undefined) { msg = f; }
                if (SancLOCamt == "" || SancLOCamt == undefined) { msg = g; }
                if ((chqno == "" || chqno == undefined) && (chqdate == "" || chqdate == undefined) && (LOCDATE == "" || LOCDATE == undefined)) { msg = a + b + e; }
                if ((chqno == "" || chqno == undefined) && (chqamt == "" || chqamt == undefined) && (LOCamt == "" || LOCamt == undefined)) { msg = a + c + f; }
                if ((chqamt == "" || chqamt == undefined) && (chqdate == "" || chqdate == undefined) && (SancLOCamt == "" || SancLOCamt == undefined)) { msg = b + c + g; }
                if ((chqno == "" || chqno == undefined) && (chqdate == "" || chqdate == undefined) && (chqamt == "" || chqamt == undefined) && (LOCNo == "" || LOCNo == undefined) && (LOCDATE == "" || LOCDATE == undefined) && (LOCamt == "" || LOCamt == undefined) && (SancLOCamt == "" || SancLOCamt == undefined)) { msg = a + b + c + d + e + f + g ; }
