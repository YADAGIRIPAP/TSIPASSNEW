...
public partial class UI_TSiPASS_BilldeskPaymentResponseCFOOffline : System.Web.UI.Page
{
    ...
    protected void btn_Request_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string msg = "COITS|" + txtipasstr.Text.Trim().TrimStart() + "|" + txtBankTransactionNo.Text.Trim().TrimStart() + "|498871-002887|" + txtAmountpaid.Text.Trim().TrimStart() + "|" + txtBankId.Text.Trim().TrimStart() + "|516640|03|INR|DIRECT|NA|NA|00000000.00|" + txtTransadate.Text.Trim().TrimStart() + "|0300|NA|4714|" + txtUidNo.Text.Trim() + "|CFO|NODEPT|"+txtadditional5.Text.Trim()+"| txtadditional6| txtadditional7|NA|Success|58BB0DF9AC4FA97402AF8341DBFFB539594629D3C7C34BEFCEECFD8B082AD697";
