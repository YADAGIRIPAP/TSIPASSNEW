<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="MSME_DistrictwiseReport_MSMESURVEY.aspx.cs" Inherits="UI_TSiPASS_MSME_DistrictwiseReport_MSMESURVEY" %>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">
                                    <asp:Label ID="lblHead2" runat="server" Text="MSME Units" CssClass="LBLBLACK" Font-Bold="True" Width="499px"></asp:Label>
                                </h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 form-group" align="center">
                                        <asp:GridView ID="grdDetails" runat="server" OnRowDataBound="grdDetails_RowDataBound" AutoGenerateColumns="False" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hyp_noofunits" runat="server" ForeColor="Black" Text='<%#Eval("Noofunits") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <b style="font-family: Calibri">Updated Units</b>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hplUpdated" runat="server" Text='<%#Eval("updated") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lbl_Updated" runat="server" />
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <b style="font-family: Calibri">To be Updated Units</b>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hplTobeUpdated" runat="server" Text='<%#Eval("tobeupdated") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lbl_tobeUpdated" runat="server" />
                                                    </FooterTemplate>
                                                </asp:TemplateField>
