...
public partial class UI_TSiPASS_RptApplicationwiseDetailedTrackerLM : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
         ...
         intqnreid = "1001";
        ds = ApplicationWiseDetailedTrakerLM(intqnreid.ToString());
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            labRegistrationtype.Text = ds.Tables[0].Rows[0]["RegistrationType"].ToString();
           // labTotalInvestment.Text = ds.Tables[0].Rows[0]["Total Investment"].ToString();
            ...
            labAddress0.Text = ds.Tables[0].Rows[0]["LocationofUnit"].ToString();
        }
    ...
    public DataSet ApplicationWiseDetailedTrakerLM(string Quesionary_id)
    {
        con.OpenConnection();
        SqlDataAdapter da;
        ...
        try
        {
            da = new SqlDataAdapter("sp_RetriveR4ReportLMNew", con.GetConnection);
