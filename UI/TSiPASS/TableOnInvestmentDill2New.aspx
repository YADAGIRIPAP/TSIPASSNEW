<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="TableOnInvestmentDill2New.aspx.cs" Inherits="UI_TSiPASS_TableOnInvestmentDill2New" %>
...
//        }
    ...
    <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%;font-family:'Trebuchet MS'">
        <tr>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="font-weight:bold;">
                            <asp:Label runat="server" ID="lblHeader"></asp:Label>&nbsp; <a id="A1" href="#"
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                          <%-- <tr>
                             ...
                             <tr id="divPrint" runat="server" style="width: 100%">
                                <td align="center" style="padding: 5px; margin: 5px;width: 100%">
