<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="manufactureRegistrations.aspx.cs" Inherits="UI_TSiPASS_manufactureRegistrations" %>
                                ...
                                <td valign="top">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                        <tr>
                                            ...
                                            <td class="style12" style="padding: 5px; margin: 5px">
                                                <asp:Label ID="Label509" runat="server" CssClass="LBLBLACK" Width="200px">Year of establishment</asp:Label>
                                            </td>
                                            <td class="style13" style="padding: 5px; margin: 5px">:</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtestablishyear" runat="server" class="form-control txtbox"
                                                    Height="28px" MaxLength="40" onkeypress="NumberOnly()" TabIndex="1"
                                                    ValidationGroup="group" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px"><asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server"
                                                ControlToValidate="txtestablishyear"
                                    ...
                                    <table style="width: 50%">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label5" runat="server" CssClass="LBLBLACK" ata-balloon-length="large" data-balloon="Combined building plan including all floor plans"
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label7" runat="server" ata-balloon-length="large" data-balloon="Combined site plan" Style="width:100%"
