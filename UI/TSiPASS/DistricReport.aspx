<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="DistricReport.aspx.cs" Inherits="UI_TSiPASS_Reports_Page" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server">R6.11 : TGiPASS- District Report </asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-xs-3" style="padding: 5px; margin: 5px">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="ddldistrict" runat="server" class="form-control txtbox" Width="180px" OnSelectedIndexChanged="ddldistrict_SelectedIndexChanged" 
                                                ...
                                                <td style="padding: 5px; margin: 5px" align="right">
                                                    <asp:Button ID="Button3" runat="server" CssClass="btn btn-default" ForeColor="White" BackColor="Green"
                            ...
                            <table>
                                <tr id="GridPrint" runat="server">
                                    <td colspan="4" align="center" style="padding: 5px; margin: 5px" id="divPrint1" runat="server">
                                        <asp:GridView ID="grddistric" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            OnRowDataBound="grddistric_RowDataBound" Width="80%" OnPageIndexChanging="grddistric_PageIndexChanging"
                                            ShowFooter="True" OnRowCreated="grddistric_RowCreated" OnSelectedIndexChanged="grddistric_SelectedIndexChanged">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Applapprovedwithin" HeaderText="Approvals Issued with in time lines">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Applapprovedbeyond" HeaderText="Approvals Issued beyond time lines">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="NoofApplication" HeaderText=" Total Approved">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="False" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Approvalswithin" HeaderText="Issued with in time lines">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="False" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Approvalsbeyond" HeaderText="Issued beyond time lines">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="False" ControlStyle-ForeColor="blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="totalApprovals" HeaderText="Total Issued">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
