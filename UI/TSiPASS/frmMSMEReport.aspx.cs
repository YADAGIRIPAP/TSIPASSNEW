...
public partial class UI_TSiPASS_frmMSMEReport : System.Web.UI.Page
{
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
           ...
           // HyperLink h1 = (HyperLink)e.Row.FindControl("HyNoofClaimsFiled");
            nounitstotal.NavigateUrl = "frmMSMEReportDRILLDOWN.aspx?ROLE=IPO&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&district=ALL";
    ...
    public DataSet GetMSMEApplications(string fromdate, string todate, string districtid)
    {
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_MSME_REPORT_NEW", pp);
        return Dsnew;
    }
}