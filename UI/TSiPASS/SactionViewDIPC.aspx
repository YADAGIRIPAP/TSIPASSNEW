<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="SactionViewDIPC.aspx.cs" Inherits="UI_TSiPASS_SactionViewDIPC" %>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                    ...
                                                    <td style="padding: 5px; margin: 5px; text-align: center;" colspan="12" align="center">
                                                        ...
                                                        <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                ...
                                                                <asp:BoundField DataField="SVCDATE" ItemStyle-HorizontalAlign="Center" HeaderText="SVC Date" Visible="false">
                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Approved/ Rejected" HeaderStyle-Width="300px">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtIncQueryFnl2" TextMode="MultiLine" Height="100px" Text='<%#Eval("Remarks") %>' Width="300px" Visible="false" runat="server"></asp:TextBox>
                                                                    </ItemTemplate>
                                                ...
                                                <tr style="height: 30px">
                                                    <td>
                                                        <table style="width: 80%">
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px" id="tdslcno" runat="server">DIPC No </td>
                                                                <td style="padding: 5px; margin: 5px">:</td>
                                                                <td>
                                                                    <asp:TextBox ID="txtslcno" autocomplete="off" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="80" TabIndex="1" Width="150px"></asp:TextBox></td>
                                                                <td style="padding: 5px; margin: 5px; width: 10px;">&nbsp;</td>
                                                                <td style="padding: 5px; margin: 5px; text-align: left;" id="tdslcndate" runat="server">DIPC Date
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">:</td>
                                                                <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                                    <asp:TextBox runat="server" ID="txtslcnodate" class="form-control txtbox" Height="28px"
                                                                        MaxLength="80" TabIndex="1" autocomplete="off" Width="150px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px" colspan="12" align="center">
                                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Height="32px" OnClientClick="ClientSideClick(this)"
