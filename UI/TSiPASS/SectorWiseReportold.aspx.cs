...
public partial class LookupCA : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchTotalSectorwise_Old();
    ...
    private void BindPieChart()
    {
        ...
        try
        {
            ...
            dsChartData = Gen.FetchTotalSectorwise_Old().Tables[0];
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h1.NavigateUrl = "FrmSectorDrilldownold.aspx?status=A&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();

            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            h2.NavigateUrl = "FrmSectorDrilldownold.aspx?status=B&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();

            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            h3.NavigateUrl = "FrmSectorDrilldownold.aspx?status=C&lbl=Application Received&Sec=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Sectorandmajor")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            Total.NavigateUrl = "FrmSectorDrilldownold.aspx?status=A&lbl=Total Applications Received&dist=%";
