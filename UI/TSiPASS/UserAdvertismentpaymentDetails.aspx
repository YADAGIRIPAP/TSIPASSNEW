<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAdvertismentpaymentDetails.aspx.cs" Inherits="UI_TSiPASS_UserAdvertismentpaymentDetails" %>
            ...
            <table border="0" align="center" cellpadding="1" cellspacing="2" style="width: 595px">
                <tr>
                    <td align="center" colspan="4">
                        <asp:Button ID="btnclose" runat="server" CssClass="NoPrint" PostBackUrl="~/UI/TSiPASS/AdvertismentDashboardList.aspx"
