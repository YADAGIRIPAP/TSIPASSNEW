...
public partial class UI_TSiPASS_IncentiveMISPendencyReport_GMCONFERENCE : System.Web.UI.Page
{
    ...
    decimal GMAssignW, GMAssignB, GMAssign90, InspAssignW, InspAssingB, InspAssign90, InspUploadW, InspUploadB, InspUpload90, GMtoCOIW, GMtoCOIB, GMtoCOI90,
        Query, Total, Total90, Noofappsfiled, Deemed, TotalWithin, TotalBeyond;
    ...
    public void FillGridDetails()
    {
        ...
        ds = Gen.GetIncentivesMISPendingReport(ddlProp_intDistrictid.SelectedValue);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            decimal Totalwithin1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "WITHINPENDING"));
            TotalWithin = Totalwithin1 + TotalWithin;
            decimal Totalbeyond1 = Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "BEYONDPENDING"));
            TotalBeyond = Totalbeyond1 + TotalBeyond;



            HyperLink h1 = (HyperLink)e.Row.FindControl("HyperLink2");
            h1.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=A&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h2 = (HyperLink)e.Row.FindControl("HyperLink3");
            h2.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=B&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h9 = (HyperLink)e.Row.FindControl("HyperLink10");
            h9.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=C&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h3 = (HyperLink)e.Row.FindControl("HyperLink5");
            h3.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=D&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h4 = (HyperLink)e.Row.FindControl("HyperLink6");
            h4.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=E&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h10 = (HyperLink)e.Row.FindControl("HyperLink11");
            h10.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=F&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h5 = (HyperLink)e.Row.FindControl("HyperLink4");
            h5.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=G&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();
            ...
            h16.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=P&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h17 = (HyperLink)e.Row.FindControl("HyperLinkwithin");
            h17.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=Q&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();

            HyperLink h18 = (HyperLink)e.Row.FindControl("HyperLinkbeyond");
            h18.NavigateUrl = "IncentiveMISPendencyReportDrill.aspx?status=R&intDistid=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "DistCd")).Trim();
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[3].Text = Noofappsfiled.ToString();
            e.Row.Cells[3].Controls.Add(GMrecedtotal);
            ...
            e.Row.Cells[4].Text = GMAssignW.ToString();
            e.Row.Cells[4].Controls.Add(GMAssignW1);

            Label GMAssignB1 = new Label();
            GMAssignB1.Text = GMAssignB.ToString();
            e.Row.Cells[5].Text = GMAssignB.ToString();
            e.Row.Cells[5].Controls.Add(GMAssignB1);

            Label GMAssign901 = new Label();
            GMAssign901.Text = GMAssign90.ToString();
            e.Row.Cells[6].Text = GMAssign90.ToString();
            e.Row.Cells[6].Controls.Add(GMAssign901);

            Label InspAssignW1 = new Label();
            InspAssignW1.Text = InspAssignW.ToString();
            e.Row.Cells[7].Text = InspAssignW.ToString();
            e.Row.Cells[7].Controls.Add(InspAssignW1);

            Label InspAssingB1 = new Label();
            InspAssingB1.Text = InspAssingB.ToString();
            e.Row.Cells[8].Text = InspAssingB.ToString();
            e.Row.Cells[8].Controls.Add(InspAssingB1);

            Label InspAssign901 = new Label();
            InspAssign901.Text = InspAssign90.ToString();
            e.Row.Cells[9].Text = InspAssign90.ToString();
            e.Row.Cells[9].Controls.Add(InspAssign901);

            Label InspUploadW1 = new Label();
            InspUploadW1.Text = InspUploadW.ToString();
            e.Row.Cells[10].Text = InspUploadW.ToString();
            e.Row.Cells[10].Controls.Add(InspUploadW1);

            Label InspUploadB1 = new Label();
            InspUploadB1.Text = InspUploadB.ToString();
            e.Row.Cells[11].Text = InspUploadB.ToString();
            e.Row.Cells[11].Controls.Add(InspUploadB1);

            Label InspUpload901 = new Label();
            InspUpload901.Text = InspUpload90.ToString();
            e.Row.Cells[12].Text = InspUpload90.ToString();
            e.Row.Cells[12].Controls.Add(InspUpload901);

            Label GMtoCOIW1 = new Label();
            GMtoCOIW1.Text = GMtoCOIW.ToString();
            e.Row.Cells[13].Text = GMtoCOIW.ToString();
            e.Row.Cells[13].Controls.Add(GMtoCOIW1);

            Label GMtoCOIB1 = new Label();
            GMtoCOIB1.Text = GMtoCOIB.ToString();
            e.Row.Cells[14].Text = GMtoCOIB.ToString();
            e.Row.Cells[14].Controls.Add(GMtoCOIB1);

            Label GMtoCOI901 = new Label();
            GMtoCOI901.Text = GMtoCOI90.ToString();
            e.Row.Cells[15].Text = GMtoCOI90.ToString();
            e.Row.Cells[15].Controls.Add(GMtoCOI901);

            Label Within = new Label();
            Within.Text = TotalWithin.ToString();
            e.Row.Cells[16].Text = TotalWithin.ToString();
            e.Row.Cells[16].Controls.Add(Within);

            Label Beyond = new Label();
            Beyond.Text = TotalBeyond.ToString();
            e.Row.Cells[17].Text = TotalBeyond.ToString();
            e.Row.Cells[17].Controls.Add(Beyond);

            Label Query1 = new Label();
            Query1.Text = Query.ToString();
            e.Row.Cells[18].Text = Query.ToString();
            e.Row.Cells[18].Controls.Add(Query1);

            //Label Deemed1 = new Label();
            //Deemed1.Text = Deemed.ToString();
            //e.Row.Cells[17].Controls.Add(Deemed1);

            Label Total1 = new Label();
            Total1.Text = Total.ToString();
            e.Row.Cells[19].Text = Total.ToString();
            e.Row.Cells[19].Controls.Add(Total1);

            Label Total901 = new Label();
            Total901.Text = Total90.ToString();
            e.Row.Cells[20].Text = Total90.ToString();
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            TableCell tcMergePackage21 = new TableCell();
            tcMergePackage21.Text = "Total Pendency";
            tcMergePackage21.CssClass = "GridviewScrollC1Headerwrap";
            tcMergePackage21.ColumnSpan = 2;
            gvHeaderRowCopy.Cells.AddAt(8, tcMergePackage21);
        }
