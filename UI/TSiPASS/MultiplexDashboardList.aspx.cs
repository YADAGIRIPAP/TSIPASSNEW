...
public partial class UI_TSiPASS_MultiplexDashboardList : System.Web.UI.Page
{
    ...
    public void getdetails()
    {
        try
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("USP_GET_Multiplex_DASHBOARD_HISTORY", osqlConnection);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            anchortaglink.NavigateUrl = "frmUserMultiplexDashboard.aspx?Qnreid=" + intApplicationID.Trim();
            anchortaglinkprint.NavigateUrl = "CinematographicLicensePrint.aspx?Qnreid=" + intApplicationID.Trim();
            anchortaglinkpayment.NavigateUrl = "UserMultiplexpaymentDetails.aspx?Qnreid=" + intApplicationID.Trim();
            if (Approval_Status == "3")
            {
                anchortaglinkStatus.NavigateUrl = "RptApplicationWiseDetailedTrakerMultiplex.aspx?intqnreid=" + intApplicationID.ToString();
            }
