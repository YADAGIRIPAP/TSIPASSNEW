<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="VehicleInspectiondrilDownLat.aspx.cs" Inherits="TSTBDCReg1" %>
                                                    ...
                                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px;">
                                                                ...
                                                                No of Online Application Recived <font color="red">*</font></asp:Label>
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                :</td>
                                                            <td style="padding: 5px; margin: 5px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px 5px 5px 85px">
                                                                <asp:TextBox ID="lblVehicleInspected" runat="server" 
                                                                    ...
                                                                    ontextchanged="txtRawItem_TextChanged" TabIndex="1" ValidationGroup="group" 
                                                         ...
                                                         <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S No">
                                                          ...
                                                          <asp:CommandField HeaderText="Edit" ShowSelectButton="True" Visible="False" />
                                                           ...
                                                           <%-- <asp:BoundField DataField="SLNo" HeaderText="SLNo" />--%>
                                                            ...
                                                            <asp:BoundField DataField="DateofInspection" HeaderText="Date of Inspection" DataFormatString="{0:dd-MM-yyyy}" />
