<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmbatterydealerdashboard.aspx.cs" Inherits="UI_TSiPASS_frmbatterydealerdashboard" %>
                    ...
                    <div class="col-lg-11">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">&nbsp; Battery Department Dashboard</h3>
                            </div>
                                                    ...
                                                    <table cellpadding="3" cellspacing="5" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td style="width: 395px; font-size: 16px;">
                                                                <b>BATTERY DEALER REGISTARTION</b></td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 395px" valign="top">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="frmBatdealDepartmentsViewAppl.aspx?Stg=1" class="list-group-item">
                                                                        <span class="badge">
                                                                    ...
                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=2"><span class="badge" style="background-color: #87D37C;">
                                                                        <asp:Label ID="Label12" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Within 3 Days</a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=3"><span class="badge" style="background-color: #d9534f;">
                                                                        <asp:Label ID="Label18" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Beyond 3 Days </a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=4"><span class="badge">
                                                                        <asp:Label ID="Label3" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Total </a>

                                                                    <%--<a class="list-group-item" href="frmCFEDepartmentsViewApplREN.aspx?Stg=12"><span class="badge" style="background-color: #87D37C;">
                                                                    ...
                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=5"><span class="badge" style="background-color: #87D37C;">
                                                                        <asp:Label ID="Label21" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Within 3 Days</a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=6"><span class="badge" style="background-color: #d9534f;">
                                                                        <asp:Label ID="Label22" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Beyond 3 Days </a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=7"><span class="badge">
                                                                        <asp:Label ID="Label6" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Total </a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=8">
                                                            ...
                                                            <td valign="top" style="width: 395px">
                                                                ...
                                                                <div class="list-group">
                                                                    ...
                                                                    <a class="list-group-item" href="frmDepartmentsApprovalProcessBattery.aspx?stg=1"><span class="badge" style="background-color: #87D37C;">
                                                                        <asp:Label ID="Label1" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Within Time Limits </a>

                                                                    <a class="list-group-item" href="frmDepartmentsApprovalProcessBattery.aspx?stg=2"><span class="badge" style="background-color: #d9534f;">
                                                                        <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Beyond Time Limits</a>

                                                                     <a class="list-group-item" href="frmDepartmentsApprovalProcessBattery.aspx?stg=3"><span class="badge" style="background-color: #d9534f;">
                                                                    ...
                                                                    <a class="list-group-item" href="frmbatterydealerdashboard.aspx?Stg=13"><span class="badge" style="background-color: #87D37C;">
                                                                        <asp:Label ID="Label7" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Within Time Limits </a>

                                                                    <a class="list-group-item" href="frmbatterydealerdashboard.aspx?Stg=14"><span class="badge" style="background-color: #d9534f;">
                                                                        <asp:Label ID="Label9" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Beyond Time Limits</a>

                                                                    <a class="list-group-item" href="frmbatterydealerdashboard.aspx?Stg=15"><span class="badge">
                                                                        <asp:Label ID="Label10" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Total</a>

                                                                    <a class="list-group-item" href="frmBatdealDepartmentsViewAppl.aspx?Stg=16"><span class="badge">
                                                                        <asp:Label ID="Label17" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>No of Applications Rejected </a>

                                                                    <a class="list-group-item" href="frmbatterydealerdashboard.aspx?Stg=17"><span class="badge">
