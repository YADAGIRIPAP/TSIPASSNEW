<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="Grievance.aspx.cs" Inherits="TSTBDCReg1" %>
                                                ...
                                                <table>
                                                    ...
                                                    <tr runat="server" id="TRdEPTnAME">
                                                        ...
                                                        <td class="style47" style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label566" runat="server" CssClass="LBLBLACK" Width="162px">Department Name:</asp:Label>
                                                        </td>
                                                        <td class="style46" style="padding: 5px; margin: 5px">:</td>
                                                        <td class="style46" style="padding: 5px; margin: 5px; text-align: left;">
                                                    ...
                                                    <tr runat="server" id="trSubject">
                                                        ...
                                                        <td class="style35" style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label563" runat="server" CssClass="LBLBLACK" Width="137px">Subject:</asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="style42" style="padding: 5px; margin: 5px; text-align: left;">
                                                            <asp:Label ID="Label543" runat="server" CssClass="LBLBLACK" Width="210px">Description:</asp:Label>
                                                        </td>
