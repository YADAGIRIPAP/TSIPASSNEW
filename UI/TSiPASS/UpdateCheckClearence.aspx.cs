...
public partial class UI_TSiPASS_UpdateCheckClearence : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("UpdateCheckChearenceDate.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&Date=" + txtsvcdate.Text + "&RlsProceedNo=" + ddlapplicationto.SelectedValue + "&checkNo=" + ddlCheckList.SelectedValue + "&SubIncTypeId=" + lblsubInctypeid + "&DIPC=" + DIPCFlag);
