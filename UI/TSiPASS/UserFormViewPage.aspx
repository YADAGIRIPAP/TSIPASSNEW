<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UserFormViewPage.aspx.cs" Inherits="UI_TSiPASS_UserFormViewPage" %>
     ...
     <div style="background-color:lightblue">
                   ...
                   <table class="table">
                      ...
                      <td style="padding: 10px; margin: 5px; font-weight: bold; width: 10px"></td>
                                    ...
                                    <tr id="Tr1" style="width: 800px" runat="server" visible="false">
                                        <td style="padding: 10px; margin: 5px; font-weight: bold; width: 10px"></td>
