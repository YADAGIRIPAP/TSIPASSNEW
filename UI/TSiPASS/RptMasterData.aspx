<%@ Page Title=":: TS-iPASS ::  " Language="C#" EnableEventValidation="false" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="RptMasterData.aspx.cs" Inherits="TSTBDCReg1" %>
                            ...
                            <tr id="divPrint" runat="server">
                                <td align="center" colspan="5" style="padding: 5px; margin: 5px; text-align: center;"
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="true" CellPadding="5"
                                        GridLines="None" ShowFooter="True" Width="100%" OnRowDataBound="grdDetails_RowDataBound">
