...
public partial class UI_TSiPASS_UserMobileTowerpaymentDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dsnew != null && dsnew.Tables.Count > 0 && dsnew.Tables[0].Rows.Count > 0)
        {
            ...
            {
                Response.Redirect("frmUser_MobileTowerDashboardList.aspx");
            }
        }
        else
        {
    ...
    {
        Response.Redirect(" ~/UI/TSiPASS/frmUser_MobileTowerDashboardList.aspx");
    }
    ...
    private DataSet BindReceipt(string TranRefNo)
    {
        try
        {
            ...
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("USP_GET_ACKNOWLEDGEMENT_MobileTower", conn);
