<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmKotakNotUpdatedXML.aspx.cs" Inherits="UI_TSiPASS_frmKotakNotUpdatedXML" %>
            ...
            <tr>
                <td>
                    <table style="text-align: center; width: 100%" align="center">
                        ...
                        <tr align="center">
                            <td>CC Avenue Reference Number:
                            </td>
                            <td>
                                <asp:TextBox ID="txtccavenuerefno" runat="server" class="form-control txtbox"
