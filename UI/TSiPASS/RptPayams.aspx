<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="RptPayams.aspx.cs" Inherits="LookupPAD" Title=":: TSiPASS Online Management System ::" %>
   ...
   function GetRowValue(val)
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            &nbsp;Payam / Block Development Committee </h3>
                    </div>
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; margin: 5px">
                                                    ...
                                                    Width="165px">Payam / Block Development Committee Name</asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :</td>
                                            <td style="padding: 5px; margin: 5px">
                                                <asp:TextBox ID="txtpdc" runat="server" class="form-control txtbox" 
                            ...
                            <tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px">
                                    <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" 
                                        ...
                                        <columns>
                                            <asp:HyperLinkField  HeaderText="Edit" DataTextField="intPDC">
      ...
      <FooterStyle HorizontalAlign="Left" />
                                            ...
                                            <asp:BoundField DataField="PDCName" HeaderText="PDC Name" />
                                        </columns>
