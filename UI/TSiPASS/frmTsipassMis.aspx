<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master"
    AutoEventWireup="true" CodeFile="frmTsipassMis.aspx.cs" Inherits="UI_TSiPASS_frmTsipassMis" %>
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                        <tr>
                                                            <td>
                                                                <strong>Total CFE Application Received : &nbsp
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px;" align="center">
                                                                <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="False"
                                                                    CellPadding="4" OnRowDataBound="grdDetails_RowDataBound" Width="100%" ShowFooter="True">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 5px; margin: 5px" valign="top">
                                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                        <tr>
                                                            <td>
                                                                <strong>Total CFO Application Received : &nbsp
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px;" align="center">
                                                                <asp:GridView ID="grddetailscfo" CssClass="floatingTable" runat="server" AutoGenerateColumns="False"
                                                                    CellPadding="4" OnRowDataBound="grddetailscfo_RowDataBound" Width="100%" ShowFooter="True">
                                                                    <HeaderStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1HeaderWrap" />
                                                                    <RowStyle Height="40px" CssClass="GridviewScrollC1Item" />
                                                                    <PagerStyle CssClass="GridviewScrollC1Pager" />
                                                                    <FooterStyle ForeColor="#FFFFFF" BackColor="#009688" Height="40px" CssClass="GridviewScrollC1Footer" />
                             ...
                             <tr>
                                        <td colspan="10" align="center" style="padding: 5px; margin: 5px">
                                            <div id="DIVUPDATEDDATE" runat="server" >
                                                 <b><asp:Label ID="LBLDATETEXT" runat="server" Text="The data in the dashboards is updated on a real time basis. Last update:"></asp:Label><asp:Label ID="LBLDATETIME" runat="server"></asp:Label></b>
                                            </div>
