<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmBankRegistrationDrillDown.aspx.cs" Inherits="UI_TSiPASS_frmBankRegistrationDrillDown" %>
                        ...
                        <td align="center" colspan="4" style="padding: 5px; margin: 5px; text-align: center;"
                            ...
                            <asp:GridView ID="grdDetails" CssClass="floatingTable" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BANKNAME" ItemStyle-HorizontalAlign="Center" HeaderText="Bank Name">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="BRANCHNAME" ItemStyle-HorizontalAlign="Center" HeaderText="Branch Name">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="IFSCCODE" ItemStyle-HorizontalAlign="Center" HeaderText="IFSC CODE">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="DATEOFREGISTRATION" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Registration">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
