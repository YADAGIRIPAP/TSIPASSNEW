<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Appraisalnote_SalesTax.aspx.cs" 
    MasterPageFile="~/UI/TSiPASS/CCMaster.master" EnableViewState="true" EnableEventValidation="true"  Inherits="UI_TSiPASS_Appraisalnote_SalesTax" %>
  ...
  <div class="panel-heading">
    ...
    <div id="divprint">
        ...
        <table style="width: 100%">
            ...
            <tr id="TRSCHEME" runat="server">
                ...
                <td class="auto-style56">
                    ...
                    <asp:DropDownList ID="DDLSCHEME" runat="server" class="form-control txtbox" TabIndex="5"
                        ...
                        <asp:ListItem Value="T-IDEA">T-IDEA</asp:ListItem>
            ...
            <tr id="TRCAPITALELIGIBLEINVESTMENT" runat="server" visible="FALSE">
                    <td class="auto-style55"></td>
            ...
            <tr id="TRTOTALSALESTAXSANCTIONED" runat="server" visible="FALSE">
                    <td class="auto-style55"></td>
