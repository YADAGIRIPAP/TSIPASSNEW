...
public partial class UI_TSiPASS_ProformaApplicantCoalReimbursement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
        {
            ...
            dsnew = Gen.GetSLCDetails(incentiveid, "18");
        ...
        dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "18", "0", "", "INTIMATION");
