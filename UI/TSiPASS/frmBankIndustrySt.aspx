<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/BankMaster.master"
    AutoEventWireup="true" CodeFile="frmBankIndustrySt.aspx.cs" Inherits="UI_TSiPASS_frmBankIndustrySt" %>
        ...
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-edit"></i><a href="#">Bank Wise</a> </li>
                </ol>
            </div>
            <div align="left">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title">
                                    Update Details of Incipient Sick / Sick / Willful Defaulters / TEV Study Done /
                                    Restructuring under taken / SARFAESI / Account Closed
                                    <br />
                                    <br />
                                    <p style="color: Red; background-color: white">
                                        **(Manufacturing Units Only Where Loan Amount Sanctioned is More than Rs.5 Lakhs)</p>
                                </h3>
                            </div>
                                ...
                                <ContentTemplate>
                                    <div class="panel-body">
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                            <asp:Label ID="Label1" runat="server" CssClass="LBLBLACK">Do you have Incipient Sick / Sick / Willful Defaulters / TEV Study Done /
                                    Restructuring under taken / SARFAESI / Account Closed Industries</asp:Label>
                                            <%-- </td>
                                                <td style="padding: 5px; margin: 5px">--%>
                                            <asp:RadioButtonList ID="rbtTSIPASS" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rbtTSIPASS_SelectedIndexChanged"
                                            ...
                                            <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px; text-align: center;" valign="top" colspan="3">
                                                        <asp:Label ID="lblmsg1" runat="server"></asp:Label>
                                                        <asp:Label ID="lblmsg2" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" style="padding: 5px; margin: 5px; text-align: center;" valign="top">
                                                        ...
                                                        <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                            <tr>
                                                                ...
                                                                <td style="width: 200px;">
                                                                    <asp:Label ID="Label446" runat="server" CssClass="LBLBLACK" Width="165px">Type of Account<font 
                                                            color="red">*</font></asp:Label>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlType"
                                                            ...
                                                            <tr id="tr2" runat="server">
                                                                ...
                                                                <td style="width: 200px;">
                                                                    &nbsp;
                                                                    <asp:Label ID="Label382" runat="server" CssClass="LBLBLACK" Width="137px">Notified Date or Since When <font 
                                                            color="red">*</font></asp:Label>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    &nbsp;
                                                    ...
                                                    <td valign="top" class="style6">
                                                        <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                            ...
                                                            color="red">*</font></asp:Label>
                                                                ...
                                                                <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                    <asp:TextBox ID="txtcontact" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="10" onkeypress="NumberOnly()" TabIndex="1" Width="180px"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:RequiredFieldValidator ID="requiredfieldvalidator14" runat="server" ControlToValidate="txtcontact"
                                                            ...
                                                            <tr id="qty" runat="server" visible="true">
                                                                ...
                                                                <td style="width: 200px;">
                                                                    <asp:Label ID="Label440" runat="server" CssClass="LBLBLACK" Width="137px">Loan Sanctioned Date (dd/mm/yyyy)</asp:Label>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    :
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtLoanDate" runat="server" AutoComplete="off" class="form-control txtbox"
                                                                        Height="28px" MaxLength="15" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLoanDate"
                                                                        ErrorMessage="Please Enter Loan Sanctioned Date" ValidationGroup="child">*</asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 5px; margin: 5px">
                                                                ...
                                                                <td style="width: 200px;">
                                                                    Loan Sanctioned Amount (More than Rs.5 Lakhs)
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    :
                                                                </td>
                                                                <td style="padding: 5px; margin: 5px">
                                                                    <asp:TextBox ID="txtLoanAmount" runat="server" class="form-control txtbox" Height="28px"
                                                                        MaxLength="10" onkeypress="NumberOnly()" TabIndex="1" Width="180px" OnTextChanged="txtLoanAmount_TextChanged"
