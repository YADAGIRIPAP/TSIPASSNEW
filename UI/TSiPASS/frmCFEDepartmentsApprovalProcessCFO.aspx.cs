...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    void fillGrid()
    {
        ...
        {
            dsn = Gen.GetCompletedbyApprovalCFO2A("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
        else if (Request.QueryString[0].ToString().Trim() == "2")
        { 
            dsn = Gen.GetCompletedbyApprovalCFO3A("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
        else
        {
            dsn = Gen.GetCompletedbyApprovalCFO("12", txtFromDate.Text, txtToDate.Text, Session["User_Code"].ToString().Trim());
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                e.Row.Cells[10].Text = "Please process this application in Concerned Department portal";
                e.Row.Cells[10].Font.Bold = true;
            }
            else
            {
                e.Row.Cells[10].Text = "Please process this application in TS-iPASS portal";
            }
            ...
            if (txtFromDate.Text == "" || txtToDate.Text == "")
            {
                ...
                Todate = "%";
                h1.Text = "Approve";
                h1.NavigateUrl = "frmApproveDetailsbyqueryCFO.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim();
            }
            ...
            else
            {
                ...
                h1.NavigateUrl = "frmApproveDetailsbyqueryCFO.aspx?No=" + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "intCFOEnterpid")).Trim() + "&FromDate=" + fromdate + "&ToDate=" + Todate;
            }
        }
