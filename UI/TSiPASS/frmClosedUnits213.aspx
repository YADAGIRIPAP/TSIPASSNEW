<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmClosedUnits213.aspx.cs" Inherits="TSTBDCReg1" %>
                                                    ...
                                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;" class="style10">
                                                                1</td>
                                                            <td class="style7" style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label442" runat="server" CssClass="LBLBLACK">Month<font 
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" 
                                                    ...
                                                    <asp:Button ID="BtnClear1" runat="server" CausesValidation="False" 
                                                        CssClass="btn btn-warning" Height="32px" OnClick="BtnClear1_Click" 
                                                        TabIndex="10" Text="Clear" ToolTip="To Clear  the Screen" Width="90px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" colspan="3" 
                                                    ...
                                                    <asp:GridView ID="gvCertificate0" runat="server" AllowPaging="True" 
                                                        ...
                                                        <ItemStyle Width="50px" />
                                                            ...
                                                            <asp:BoundField DataField="HTLT" HeaderText="HTLT" />  
                                                            <asp:BoundField DataField="DateofCloser" HeaderText="Date of Closer"  DataFormatString={0:dd-MM-yyyy}  />
