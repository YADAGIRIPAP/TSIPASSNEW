...
public partial class UI_TSiPASS_frmDistrictReportIndustryStatusDrillDownCFO : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmDistrictReportIndustryStatus.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string Progress)
    {
       ...
       // Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_INDUSTRYSTATUS_DRILLDOWN", pp);
        Dsnew = Gen.GenericFillDs("[USP_GET_DISTRICTREPORT_INDUSTRYSTATUS_DRILLDOWN_CFO]", pp);
        return Dsnew;
    }
}