...
public partial class UI_TSiPASS_SupporttoODOPEntrepreneursDrillDown : System.Web.UI.Page
{
    ...
    protected void Binddata(string Districtid, string type, string fromdate, string todate)
    {
        try
        {
            ...
            connection.Open();
            SqlDataAdapter da = new SqlDataAdapter("GetODOPEntrepreneurData", connection);
            ...
            GrdOdopEntpnrdtls.DataSource = ds.Tables[0];
            GrdOdopEntpnrdtls.DataBind();
    ...
    protected void GrdOdopEntpnrdtls_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    {
        GrdOdopEntpnrdtls.Columns[6].Visible = false;
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                GrdOdopEntpnrdtls.AllowPaging = false;

                // this.fillgrid();

                GrdOdopEntpnrdtls.HeaderRow.ForeColor = System.Drawing.Color.Black;
                GrdOdopEntpnrdtls.HeaderStyle.ForeColor = System.Drawing.Color.Black;

                GrdOdopEntpnrdtls.FooterRow.ForeColor = System.Drawing.Color.Black;
                // grdExport.Columns[1].Visible = false;
                GrdOdopEntpnrdtls.RenderControl(hw);
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                GrdOdopEntpnrdtls.Style["width"] = "680px";
    ...
    //{
    //    Response.Redirect("SupporttoODOPEntrepreneurs.aspx");
    //}
}