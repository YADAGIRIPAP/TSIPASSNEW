<%@ Page Title=":: TS-iPASS ::" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="frmPMEGP213.aspx.cs" Inherits="TSTBDCReg1" %>
                                                    ...
                                                    <table cellpadding="4" cellspacing="5" style="width: 83%">
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                1</td>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                <asp:Label ID="Label436" runat="server" CssClass="LBLBLACK" Width="210px">Month<font 
                                                    ...
                                                    <table cellpadding="4" cellspacing="5" style="width: 100%">
                                                        <tr>
                                                            <td class="style6" style="padding: 5px; margin: 5px">
                                                                2</td>
                                                            <td class="style8">
                                                                <asp:Label ID="Label435" runat="server" CssClass="LBLBLACK" Width="210px">Year<font 
                                                            color="red">*</font></asp:Label>
                                                            </td>
