...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string fromdt = Request.QueryString[5].ToString().Trim();
            string todt = Request.QueryString[6].ToString().Trim();
            ...
            ds = Gen.RetriveStatusForViewApplicationDepartmentApprovalwiseCFO(Request.QueryString[0].ToString().Trim(), ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, Request.QueryString[1].ToString().Trim(), Request.QueryString[4].ToString().Trim(), FromdateforDB, TodateforDB);
