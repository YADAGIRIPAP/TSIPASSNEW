...
public partial class UI_TSIPASS_frmTodayapps : System.Web.UI.Page
{
    ...
    protected void btnbdf_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------------
            phrase = new Phrase();
            phrase.Add(new Chunk("R1.6 Periodic Breakup-Investment and Employemnt\n\n", FontFactory.GetFont("trebuchet ms", 12, Font.BOLD, Color.BLACK)));
            ...
            Response.Clear();
            Response.ContentType = "application/pdf";
            Response.AddHeader("Content-Disposition", "attachment; filename=PeriodicRpt.pdf");
            Response.ContentType = "application/pdf";
    ...
    public DataSet GetAppealApplications(string Appstype)
    {
        ...
        pp[0].Value = Appstype;
        Dsnew = Gen.GenericFillDs("USP_GET_UPTODATECFE_DATA", pp);
        return Dsnew;
    }
}