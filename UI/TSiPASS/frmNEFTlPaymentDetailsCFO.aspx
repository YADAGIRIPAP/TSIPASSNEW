<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmNEFTlPaymentDetailsCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <div class="GRD" style="width: 100%">
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Do you want to pay 10% or Full of Amount">
                                                    <ItemTemplate>
                                                        <asp:RadioButtonList ID="RdbAmountPre" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                                            OnSelectedIndexChanged="RdbAmountPre_SelectedIndexChanged">
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" align="center">
                                            <asp:RadioButtonList ID="rblPaymentMode" runat="server" AutoPostBack="True" Font-Bold="True"
                                                ...
                                                <asp:ListItem Value="D" Selected="True">NEFT / RTGS</asp:ListItem>
                                ...
                                <td align="center" style="padding: 5px; margin: 5px" colspan="3">
                                    <table cellpadding="4" cellspacing="5" style="width: 83%" runat="server" id="paynot">
                                        ...
                                        <tr id="DD" runat="server">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label426" runat="server" CssClass="LBLBLACK" Width="200px">Reference Number<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label427" runat="server" CssClass="LBLBLACK" Width="200px">Reference Bank Name<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBankName"
                                                    ErrorMessage="Please enter Reference Bank Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label431" runat="server" CssClass="LBLBLACK" Width="200px">Reference Bank Brach Name<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBankBranchName"
                                                    ErrorMessage="Please enter Reference Bank Branch Name" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="Label433" runat="server" CssClass="LBLBLACK" Width="200px">Upload 
                                                        Payment Proof<font color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:Label ID="LabelRemarks" runat="server" CssClass="LBLBLACK" Width="200px">Remarks<font 
                                                            color="red">*</font></asp:Label>
                                            </td>
                                            <td style="padding: 5px; margin: 5px">
                                                :
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtRemarks" TextMode="multiline" runat="server" class="form-control txtbox" Height="60px" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 83%" runat="server" id="paynotOnline">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; margin: 5px; text-align: left;" colspan="4">
                                                ...
                                                your account and any other queries, please contact the Toll free number: 1800-3070-3405
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" colspan="3">
                                    ...
                                    &nbsp;&nbsp;<asp:Button ID="BtnDelete" runat="server" CssClass="btn btn-danger" Height="32px"
                                        OnClick="BtnClear0_Click" TabIndex="10" Text="Pay" Width="90px" ValidationGroup="group" />
