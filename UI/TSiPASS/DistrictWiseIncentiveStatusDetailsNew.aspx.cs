...
public partial class UI_TSiPASS_DistrictWiseIncentiveStatusDetailsNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string distid = Request.QueryString[1].ToString().Trim();
        ...
        lblHeading.Text = "Incentive applications";
        if (!IsPostBack)
        {
            getdistricts();
        }
    ...
    protected void fetchIncentivedet()
    {
        ...
        ds = Gen.fetchIncentivedetNewINCType(ddlDistrict.SelectedValue, TxtIndname.Text.Trim(), Session["User_Code"].ToString(), Request.QueryString[0].ToString().Trim());
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Applications Received " + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                GridExport.DataSource = ds.Tables[0];
                GridExport.DataBind();
