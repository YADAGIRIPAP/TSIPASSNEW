...
public partial class UI_TSiPASS_frmQuesstionniareRegEdit : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                //{
                //    Session["Applid"] = "15870";// Request.QueryString[0].ToString();
                //}
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("frmQuesstionniareRegEdit.aspx");
            }
            foreach (GridViewRow gvrTEMPVehMstr in gvmodelsnames.Rows)
            {
                CheckBox txtMakerGvV = (CheckBox)gvrTEMPVehMstr.FindControl("chkmodelname");
    ...
    public void CalcFees()
    {
        try
        {
            ...
            {
                dsceigdrawings = Gen.GetShowApprovalandFeesCEIGCFE("70", Enterpriseid, ddlregulation.SelectedValue, ddlvoltage.SelectedValue, ddlproposal.SelectedItem.Text, "");
    ...
    public void CalcFeesNewDepartment()
    {
        ...
        try
        {
            ...
            if (RdpIndustry.SelectedValue == "Y")
            {
                dsceigdrawings = Gen.GetShowApprovalandFeesCEIGCFE("65", Enterpriseid, ddlregulation.SelectedValue, ddlvoltage.SelectedValue, ddlproposal.SelectedItem.Text, "");
                dsv.Tables[0].Merge(dsceigdrawings.Tables[0]);
            }
    ...
    protected void BtnClear0_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int s = Gen.insertQuetieneroesEdit(quesionervoobj);
            Session["Applid"] = s.ToString();
            ...
            if (s >= 0)
            {
                for (int iii = 0; iii < grdDetails.Rows.Count; iii++)
                {
                    ...
                    int a = Gen.insertQuetieneroesDeptEdited(s.ToString(), HdfQueid.Value, HdfApprovalid.Value, "1000", grdDetails.Rows[iii].Cells[3].Text,txtremarks.Text,Session["uid"].ToString().Trim());
                }
                success.Visible = true;
                Failure.Visible = false;
