<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true"
    CodeFile="frmCoiDashboardClerk.aspx.cs" Inherits="UI_TSiPASS_frmCoiDashboardClerk" %>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <span id="htitle">Clerk&#39;s Dashboard </span>
                        </h3>
                    </div>
                                                ...
                                                <tr>
                                                    <td style="width: 395px" valign="top">
                                                        <div class="list-group">
                                                            <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=1" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="lblAppl" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i><b>No of Applications Received from G.M</b> </a><a class="list-group-item"><i
                                                                        class="fa fa-fw fa-check"></i>Scrutiny Pending </a><a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=50">
                                                                            <span class="badge">
                                                                                <asp:Label ID="Label1" runat="server"></asp:Label>
                                                                            </span><i class="fa fa-fw fa-calendar"></i>Within 7 Days </a><a class="list-group-item"
                                                                                href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=51"><span class="badge"
                                                                                    style="background-color: #d9534f;">
                                                                                    <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                                </span><i class="fa fa-fw fa-calendar"></i>Beyond 7 Days </a>
                                                            <a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=80">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label8" runat="server"></asp:Label>
                                                                </span><i class="fa fa-fw fa-calendar"></i>Total </a><a class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=103">
                                                                    <span class="badge">
                                                                        <asp:Label ID="LabelJDReturned" runat="server"></asp:Label>
                                                                    </span><i class="fa fa-fw fa-calendar"></i>Superintendent Returned</a> <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=100"
                                                                        class="list-group-item"><span class="badge">
                                                                            <asp:Label ID="LabelForwarded" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i><b>No of Applications Forwarded to Superintendent</b> </a><a class="list-group-item">
                                                                                <i class="fa fa-fw fa-check"></i>Forwarded to Superintendent</a><a class="list-group-item"
                                                                                    href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=101"> <span class="badge">
                                                                                        <asp:Label ID="lbladrecommended" runat="server"></asp:Label>
                                                                                    </span><i class="fa fa-fw fa-calendar"></i>Recommended to Superintendent</a><a class="list-group-item"
                                                                                        href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=102"> <span class="badge">
                                                                                            <asp:Label ID="LabelQueryAD" runat="server"></asp:Label>
                                                                                        </span><i class="fa fa-fw fa-calendar"></i>Query Forwarded to Superintendent</a><a
                                                                                            class="list-group-item" href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=51r">
                                                        </div>
                                                    </td>
                                                    <td style="width: 30px">&nbsp;
                                                    </td>
                                                    <td style="width: 395px" valign="top">
                                                        <div class="list-group" style="vertical-align: top">
                                                            <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Queries</b></a> <a
                                                                href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=54" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label5" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Yet to Respond </a><a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=83"
                                                                        class="list-group-item"><span class="badge">
                                                                            <asp:Label ID="Label10" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Within</a> <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=84"
                                                                                class="list-group-item"><span class="badge" style="background-color: #d9534f;">
                                                                                    <asp:Label ID="Label11" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Beyond</a> <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=55"
                                                                                        class="list-group-item"><span class="badge">
                                                                                            <asp:Label ID="Label6" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Total Queries Responded </a><a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=91"
                                                                                                class="list-group-item"><span class="badge">
                                                                                                    <asp:Label ID="lblAutorejected" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Total Auto Rejected</a> <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Queries Responded/Forwarded to Superintendent</b></a>
                                                            <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=104" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="lblqueryforwardedtojd" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Queries Responded - Forwarded to Superintendent</a> <a href="IncentiveStatusInspectionUploadbyCoiClerk.aspx?Stg=105"
                                                                        class="list-group-item"><span class="badge" style="background-color: #d9534f;">
                                                            ...
                                                            <div class="list-group" style="vertical-align: top">
                                                                ...
                                                                <a href="CheckVerifyCOI.aspx?Type=DIPC"
                                                                    class="list-group-item"><span class="badge" style="background-color: #d9534f;">
                                                    ...
                                                    <%-- <td valign="top" style="width: 395px">
                                                        <div class="list-group">
                                                            <a href="IncentiveWiseSLClistGMADSubPlan.aspx?Stg=4" class="list-group-item"><span class="badge">
                                                                <asp:Label ID="Label4" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Check Procedings by SLC </a>
                                                        </div>
                                                        <div class="list-group" style="display: none">
                                                            <a href="ReleaseProcedingsStep2CompletedListPrint.aspx?Stg=5" class="list-group-item">
                                                                <span class="badge">
                                                                    <asp:Label ID="Label7" runat="server"></asp:Label></span>
                                                                <i class="fa fa-fw fa-calendar"></i>Return Proceding by SLC
                                                            </a>
                                                        </div>
                                                    ...
                                                    <td valign="top" style="width: 395px">
                                                        <div class="list-group" style="display: none">
                                                            <a href="IncentiveWiseDIPClist.aspx?Stg=4" class="list-group-item"><span class="badge">
                                                                <asp:Label ID="Label12" runat="server"></asp:Label></span> <i class="fa fa-fw fa-calendar"></i>Check Procedings by DIPC </a>
                                                        </div>
                                                        <div class="list-group">
                                                            <a href="IncentiveWiseDIPClist.aspx?Stg=2&offlineflag=Y" class="list-group-item"><span
                                                                class="badge">
                                                                <asp:Label ID="Label13" runat="server"></asp:Label>
                                                            </span><i class="fa fa-fw fa-calendar"></i>Return Proceding by DLC </a>
                                                        </div>
