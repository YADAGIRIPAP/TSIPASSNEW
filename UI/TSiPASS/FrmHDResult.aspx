<%@ Page Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="FrmHDResult.aspx.cs" Inherits="FrmUsers" Title=":: TSiPASS TSiPASS ::  Result" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%; position: static; text-align: center;">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Label ID="lblresult" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="11px"
                                ForeColor="Green" Style="position: static"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            </td>
                  ...
                  <%--  <tr>
                     ...
                     <tr>
                        <td colspan="3" style="padding-bottom: 20px; padding-top: 20px" align="center">
                         <a href="../../Index.aspx" target="_self" style="color: blue">Go to Login</a></td>
                    </tr>
                </table>
</div>
</asp:Content>
