<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="frmConstofWomencell_MandalLevel.aspx.cs" Inherits="UI_TSiPASS_frmConstofWomencell_MandalLevel" %>
                    ...
                    <div class="col-lg-11">
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h3 class="panel-title" style="text-align: center;">Constitution of Women Cell-Mandal Level</h3>
                            </div>
                                ...
                                <asp:Label ID="lblmsg0" runat="server"></asp:Label>
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label435" runat="server" Width="171px">1. District<font id="lbl1" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label3" runat="server" Width="171px">2. Mandals-Already Women cells constituted<font id="Font1" runat="server"
                                                                    color="red">*</font> : </asp:Label></td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlmandal" runat="server" class="form-control txtbox"
                                                                    Height="33px" TabIndex="1" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="ddlmandal_SelectedIndexChanged">
                                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label5" runat="server" Width="171px">3.Mandals-Women cells Yet to be constituted <font id="Font2" runat="server"
                                                                    color="red">*</font> : </asp:Label></td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlyettoconstituewomencellmandals" runat="server" class="form-control txtbox"
                                                                    Height="33px" TabIndex="1" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="ddlyettoconstituewomencellmandals_SelectedIndexChanged" >
                                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <%--  <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label2" runat="server" Width="400px">3. Whether Women Cell constituted at Mandal Level : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                                <asp:RadioButtonList ID="RBTMANDALLEVEL" runat="server" AutoPostBack="true" OnSelectedIndexChanged="RBTMANDALLEVEL_SelectedIndexChanged"
                                                                    Height="33px" TabIndex="1" Width="180px" RepeatDirection="Horizontal" Enabled="false">
                                                ...
                                                <td>
                                                    <table>
                                                        <tr id="DayOfOperationDropDown" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label437" runat="server" Width="171px">3. Day of Operation<font id="lb5" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                                <asp:DropDownList ID="ddlDayofoperation" runat="server" class="form-control" Width="180px">
                                                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        ...
                                                        <%--   <tr id="DayOfOperationTextBox" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label5" runat="server" Width="171px">3. Day of Operation<font id="Font2" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="DayOfOperationText" runat="server" class="form-control" Width="180px" />
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                </td>
                                                <td>
                                                    <table>
                                                        <tr id="TimeofOperationDropdown" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label434" runat="server" Width="171px">4. Time of Operation<font id="lbl2" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                        ...
                                                        <%-- <tr id="TimeOfOperationsTextBox" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label6" runat="server" Width="171px">4. Time of Operation<font id="Font3" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="TimeOfOperationsText" runat="server" class="form-control" Width="180px" />
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                </td>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr id="trplaceofoperation" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label2" runat="server" Width="171px">5. Place of Operation<font id="Font4" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                                ...
                                                <td>
                                                    <table>
                                                        <tr id="trwomencellconstituteddate" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label6" runat="server" Width="171px">6. Women Cell Constituted Date<font id="Font3" runat="server" color="red">*</font> : </asp:Label></td>
                                                            <td style="padding-top: 10px;">
                                        ...
                                        <table align="center" cellpadding="12" cellspacing="5" style="width: 100%">
                                            <tr>
                                                <td align="center" colspan="3" style="padding: 5px; padding-top: 10px;">
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="FACILITATOR ID"
                                                                Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="FACILITATORID" runat="server" Text='<%#Eval("FACILITATORID_MANDALCELL") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Width="80px" />
                                                            </asp:TemplateField>

                                                            <asp:BoundField DataField="Manda_lName" HeaderText="Mandal" ItemStyle-HorizontalAlign="Center">
                                                            ...
                                                            <%--<asp:BoundField DataField="Day Of Operation" HeaderText="Day of Operation" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="Time Of Operation" HeaderText="Time of Operation" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>--%>
                                                            <asp:BoundField DataField="FACILITATORNAME" HeaderText="Facilitator Name" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="CONTACTNO" HeaderText="Contact No" ItemStyle-HorizontalAlign="Center"
                                                                Visible="true">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                        ...
                                        <table align="center" cellpadding="10" cellspacing="5" style="width: 96.3%">
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr id="TR1" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label4" runat="server" Width="430px">5a. Would you like to add new facilitators to this Mandal : </asp:Label>
                                                            </td>
                                                            <td style="padding-top: 10px;">
                                                ...
                                                <td>
                                                    <table>
                                                        <tr id="TRNOOFMEMBERS" runat="server" visible="false">
                                                            <td style="padding-top: 10px;">
                                                                <asp:Label ID="Label438" runat="server" Width="430px">7. Please enter no of Women Cell Members(<a style="color:red"> Enter New Members Count</a>) : </asp:Label>
                                                            </td>
                                                            <td style="padding-top: 10px;">
                                                                <table>
                                                        <tr>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-left: 80px; padding-bottom: 5px;">
                                                                        <asp:Label ID="Label1" runat="server" Width="220px">1. Name of the Facilitator : <font id="lbl6" runat="server" color="red">*</font></asp:Label>
                                                                    </td>
                                                                    <td style="padding-right: 40px; padding-bottom: 5px;">
                                                                        <asp:TextBox ID="txtnameoffacilitator" runat="server" autoComplete="off" class="form-control txtbox" MaxLength="200" onkeypress="Names()" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-bottom: 5px;">
                                                                        <asp:Label ID="Label9" runat="server" CssClass="LBLBLACK" Width="220px">2. Designation : <font id="lb3" runat="server" color="red">*</font></asp:Label>
                                                                    </td>
                                                                    <td style="padding-bottom: 5px;">
                                                                        <asp:TextBox ID="txtdesignation" runat="server" autoComplete="off" class="form-control txtbox" onkeypress="Names()" TabIndex="1" ValidationGroup="child" Width="180px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-left: 80px;">
                                                                        <asp:Label ID="Label12" runat="server" CssClass="LBLBLACK" Width="220px">3. Contact No : <font id="lbl7" runat="server" color="red">*</font></asp:Label>
                                                                    </td>
                                                                    <td style="padding-right: 40px;">
                                                                        <asp:TextBox ID="txtcontactno" runat="server" autoComplete="off" class="form-control txtbox" MaxLength="10" onkeypress="NumberOnly()" onkeyup="validatePhoneNumber()" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label13" runat="server" CssClass="LBLBLACK" Width="220px">4. Mail Id : <font color="red" id="lbl4" runat="server">*</font></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtemailid" runat="server" autoComplete="off" class="form-control txtbox" onkeyup="validateEmail(this.value)" TabIndex="1" ValidationGroup="child" Width="180px"></asp:TextBox>
