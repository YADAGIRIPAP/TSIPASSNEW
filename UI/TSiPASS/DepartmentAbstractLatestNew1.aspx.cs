...
public partial class UI_TSiPASS_DepartmentAbstractLatestNew1 : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        {
            vehicleDS = Gen.DeptReportDepartmentWise_New1(Session["DistrictID"].ToString().Trim(), "%", FromdateforDB, TodateforDB);
        }
        else
        {
            vehicleDS = Gen.DeptReportDepartmentWise_New1("%", "%", FromdateforDB, TodateforDB);
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (h1.Text != "0")
            {
                h1.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=4&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
            }
            HyperLink h2 = (HyperLink)e.Row.Cells[3].Controls[0];
            if (h2.Text != "0")
            {
                h2.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
            }
            HyperLink h3 = (HyperLink)e.Row.Cells[4].Controls[0];
            if (h3.Text != "0")
            {
                h3.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Within Three Days";
            }
            HyperLink h4 = (HyperLink)e.Row.Cells[5].Controls[0];
            if (h4.Text != "0")
            {
                h4.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Beyond Three Days";
            }
            HyperLink h5 = (HyperLink)e.Row.Cells[6].Controls[0];
            if (h5.Text != "0")
            {
                h5.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=5&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
            }
            HyperLink h6 = (HyperLink)e.Row.Cells[7].Controls[0];
            if (h6.Text != "0")
            {
                h6.NavigateUrl = "frmDeptstatusbytypeNew.aspx?Id=" + Service_id + "&Status=3&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Total";
            }
            HyperLink h7 = (HyperLink)e.Row.Cells[8].Controls[0];
            if (h7.Text != "0")
            {
                h7.NavigateUrl = "frmDeptstatusbytype1New.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Within time limits";
            }
            HyperLink h8 = (HyperLink)e.Row.Cells[9].Controls[0];
            if (h8.Text != "0")
            {
                h8.NavigateUrl = "frmDeptstatusbytype1New.aspx?Id=" + Service_id + "&Status=2&fromdate=" + txtFromDate.Text.Trim() + "&todate=" + txtTodate.Text + "&Type=Beyond time limits";
            }
            HyperLink h9 = (HyperLink)e.Row.Cells[10].Controls[0];
            if (h9.Text != "0")
            {
                h9.NavigateUrl = "frmDeptstatusbytype1New.aspx?Id=" + Service_id + "&Status=1&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Type=Total";
            }
            HyperLink h10 = (HyperLink)e.Row.Cells[11].Controls[0];
            if (h10.Text != "0")
            {
                h10.NavigateUrl = "frmDeptstatusbytype1New.aspx?Id=" + Service_id + "&Status=3&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text + "&Type=Total";
            }
        }
    ...
    protected void grdDetails_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            tcMergePackage.Text = "Scrutiny-Under Process";
