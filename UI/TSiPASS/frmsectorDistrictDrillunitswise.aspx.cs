...
public partial class UI_TSiPASS_frmsectorDistrictDrillunitswise : System.Web.UI.Page
{
    decimal NumberTotal, InvestmnetTotal, EmploymentTotal;
    string QueryString2; string QueryString3;
    #region Declaration
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["District"].ToString().Trim() != null && Request.QueryString["District"].ToString().Trim() != "")
        {
            district = Request.QueryString["District"].ToString().Trim();
        }
        if (!IsPostBack)
        {
            //getdistricts();
    ...
    public void fillgrid()
    {
        ...
        dsnew = Gen.FetchSectorwiseDistrictDrildownNewNew(Request.QueryString[0].ToString().Trim(), QueryString2, FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue, district);
        // lblMsg.Text = "";
