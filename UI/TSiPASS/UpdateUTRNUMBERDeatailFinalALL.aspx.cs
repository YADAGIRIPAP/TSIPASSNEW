...
public partial class UI_TSiPASS_UpdateUTRNUMBERDeatailFinalALL : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        string Districtid = Request.QueryString[5].ToString();
        ...
        ds = gen.GenericFillDs("USP_GET_UNIT_INCENTIVEWISE_CheckUPdated_new_CHECKNO_UTRNUMBER_ALL", pp);
    ...
    protected void ExportToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                string headerTable = @"<table width='100%' class='TestCssStyle'><tr><td align='center' colspan='5'><h4>" + lblHeading.Text + "</h4></td></td></tr><tr><td align='center' colspan='5'><h4>" + "Madhuri" + "</h4></td></td></tr></table>";
