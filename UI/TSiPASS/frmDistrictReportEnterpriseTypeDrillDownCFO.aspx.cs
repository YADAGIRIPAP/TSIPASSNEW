...
public partial class UI_TSiPASS_frmDistrictReportEnterpriseTypeDrillDownCFO : System.Web.UI.Page
{
    int delete = 0;
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string sector)
    {
       ...
       // Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_ENTERPRISETYPE_DRILLDOWN", pp);
        Dsnew = Gen.GenericFillDs("[USP_GET_DISTRICTREPORT_ENTERPRISETYPE_DRILLDOWN_CFO]", pp);
        return Dsnew;
    }
}