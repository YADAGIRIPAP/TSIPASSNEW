...
public partial class UI_TSiPASS_frmGrantedDashboard : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    ...
    public void fillgrid(string fromDate, string toDate)
    {
        ...
        dsnew = GetReleaseDashboardApplications(ddlDepartment.SelectedValue, ddlapprovalname.SelectedValue, ddlcolor.SelectedValue, "", fromDate, toDate);
        // lblMsg.Text = "";
        ...
        lblHeadingText.Text = "Registration/Renewal Granted Dashboard from " + txtFromDate.Text + " to " + txtTodate.Text + "";
    }
    ...
    public DataSet GetReleaseDashboardApplications(string deptid, string approvalid, string polcategory, string appltype, string fromDate, string toDate)
    {
        DataSet Dsnew = new DataSet();
        ...
        Dsnew = Gen.GenericFillDs("USP_GET_CFE_ABSTRACT_EODB", pp);
        return Dsnew;
