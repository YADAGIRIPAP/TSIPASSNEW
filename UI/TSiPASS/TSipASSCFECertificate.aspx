<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TSipASSCFECertificate.aspx.cs" Inherits="Default2" %>
        ...
        <div align="center" style="border: thin solid #000000; padding:20px; background-position:center; background-repeat:no-repeat; background-image: url(../../images/bg_cert.png); text-align: center; width: 800px;
            ...
            <h3 align="center">
                <table style="background-color:Transparent; width: 100%;">
                    ...
                    <img src="telanganalogo.png" style="height: 87px; width: 91px" /></td>
                    ...
                    <td align="center" style="text-align: center;  background-color:Transparent;">
                        <span style="text-align: center;">
                            <asp:Label ID="lblNameOfCertifiedPerson3" runat="server" Font-Bold="True" ForeColor="Black"
                                Font-Size="15px" Height="38px" Width="280px" Font-Names="Verdana">Commissioner of Industries <br />Govt of 
Telangana</asp:Label>
                        </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <div style="border:1px; border-color:Black;background-position:left; background-repeat:no-repeat; visibility: hidden; display: block;">
                        Signature valid<br />                        
                ...
                <tr>
                    <td align="center" style="background-color:Transparent;" colspan="3">
                            <asp:Image ID="Image2" runat="server" Visible="false" Width="100%" Height="100%" ImageUrl="~/images/ManicSir.jpg" 
                                 />     
                    </td>                    
                </tr>
            </table>
