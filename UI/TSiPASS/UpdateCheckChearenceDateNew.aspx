<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UpdateCheckChearenceDateNew.aspx.cs" Inherits="UI_TSiPASS_UpdateCheckChearenceDateNew" %>
                                                    ...
                                                    <div id="Div1" style="width: 100%" runat="server">
                                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Release Proceeding No">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label1" Text='<%#Eval("ReleaseProceedingNo") %>' runat="server" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="CHEQUE Status">
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="btnCheqClear" CssClass="btn btn-primary" runat="server" Text="CLEAR" Width="140Px" OnClick="btnCheqClear_Click" />
                                                                        <br />
                                                                        <br />

                                                                        <asp:Button ID="btnCheqNOtClear" CssClass="btn-warning" runat="server" Text="NOT CLEAR" Width="150Px" OnClick="btnCheqNOtClear_Click" />
                                                                    </ItemTemplate>
                                            ...
                                            <tr style="height: 30px" runat="server" visible="false">
                                                <td>
                                                    <table style="width: 80%">
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">Cheque Clearence Date
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">:
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                                <asp:TextBox runat="server" ID="txtCheckdate" class="form-control txtbox" Height="28px"
                                                                    MaxLength="80" TabIndex="1" Width="150px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">Name of Employee through whom letter is sent
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">:
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px; margin: 5px; text-align: left;">Designation of Employee
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">:
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
