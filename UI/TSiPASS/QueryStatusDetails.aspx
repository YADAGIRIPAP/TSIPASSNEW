<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="QueryStatusDetails.aspx.cs" Inherits="UI_TSiPASS_QueryStatusDetails" %>
            ...
            th
{
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        ...
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                    ...
                    <li class="active">
                        <i class="fa fa-edit"></i><a href="#">General Query Details</a>
                    </li>
                </ol>
            </div>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: center;" colspan="3"
                                                                ...
                                                                <tr>
                                                                    <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                                                        <asp:GridView ID="grdDetails" HeaderStyle-CssClass="GridHeader" runat="server" AllowPaging="False"
                                                                            ...
                                                                            <FooterStyle ForeColor="#FFFFFF" BackColor="#009688" CssClass="GridviewScrollC1Footer" />
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="IndustryName" HeaderText="Industry Name" />
                                                                                <%--   <asp:BoundField DataField="Dept_Name" HeaderText="Department Name" />--%>
                                                                                <asp:BoundField DataField="District_Name" HeaderText="District Name" />
                                                                                 <asp:BoundField DataField="Email" HeaderText="Email" />
                                                                                <asp:BoundField DataField="MobileNumber" HeaderText="Mobile Number" />
                                                                                <%-- <asp:BoundField DataField="Grivance_Subject" HeaderText="Query Subject" />--%>
                                                                                <asp:BoundField DataField="Grievance_Description"
                                                                                    HeaderText="Query Description" />
                                                                                     <asp:BoundField DataField="Created_dt" HeaderText="Date of Register" />
                                                                                <asp:BoundField DataField="Status" HeaderText="Status" />
                                                                                <asp:TemplateField HeaderText="Action">
                                                                                    <ItemTemplate>
                                                                                        <asp:Button ID="btnprocess" CssClass="btn btn-primary" OnClick="btnprocess_Click" runat="server" Text="Action" Width="100px" />
                                                                                        <%--<a id="lnkChangeStatus"
                                                                                            href='QueryChangeStatus.aspx?intGrievanceid=<%# Eval("intGrievanceid") %>'>Change Status</a>--%>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                ...
                                                                                <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="Sno" HeaderText="Sno"/>
