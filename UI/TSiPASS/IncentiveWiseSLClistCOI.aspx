<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveWiseSLClistCOI.aspx.cs" Inherits="UI_TSiPASS_IncentiveWiseSLClistCOI" %>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 15px; margin: 5px;" colspan="2" align="right">
                                                        <asp:Button ID="btnGetList" CssClass="btn btn-primary" OnClick="btnGetList_Click" runat="server"
                                                    ...
                                                    <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="btnView" Height="25px" CssClass="btn btn-primary" OnClick="btnView_Click" runat="server" Text="View" Width="100px" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
