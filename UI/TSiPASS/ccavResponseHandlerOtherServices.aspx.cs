...
public partial class UI_TSiPASS_ccavResponseHandlerOtherServices : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CCACrypto ccaCrypto = new CCACrypto();
        string encResponse = ccaCrypto.Decrypt(Request.Form["encResp"], workingKey);
      //  string encResponse = "order_id=OTHR02005471057&tracking_id=109865292520&bank_ref_no=746728196&order_status=Success&failure_message=&payment_mode=Net Banking&card_name=Axis Bank&status_code=null&status_message=&currency=INR&amount=13.26&billing_name=&billing_address=&billing_city=&billing_state=&billing_zip=&billing_country=&billing_tel=&billing_email=&delivery_name=&delivery_address=&delivery_city=&delivery_state=&delivery_zip=&delivery_country=&delivery_tel=&merchant_param1=1057&merchant_param2=Kotak20200603153832&merchant_param3=CFE&merchant_param4=NODEPT&merchant_param5=NA&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=5.00&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=03/06/2020 15:38:35&bin_country=&trans_fee=7.0&service_tax=1.26";
        ...
        if (msg != null)
        {
            ...
            if (paymentresponseVOsobj.AdditionalInfo4_19 == "NODEPT")
            {
                ...
                if (paymentresponseVOsobj.AdditionalInfo5_20 == "Y")
                {
                    dspaydtls = objgen.GetEnterprinerpaymentDtls_OtherServices(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, paymentresponseVOsobj.AdditionalInfo5_20);
                    //Departmentdetails (Questionnaire id#Entrepreneur id1#Department id1#TSIPASSUID#amount1#ApprovalId)
                    if (dspaydtls != null && dspaydtls.Tables.Count > 1 && dspaydtls.Tables[1].Rows.Count > 0)
                    {
                        paymentresponseVOsobj.AdditionalInfo4_19 = dspaydtls.Tables[1].Rows[0]["DEPTPAYMENTDTLS"].ToString();
                ...
                {
                    dspaydtls = objgen.GetEnterprinerpaymentDtls_OtherServices(paymentresponseVOsobj.CustomerID_1, paymentresponseVOsobj.AdditionalInfo2_17, "");
                    //Departmentdetails (Questionnaire id#Entrepreneur id1#Department id1#TSIPASSUID#amount1#ApprovalId)
                    if (dspaydtls != null && dspaydtls.Tables.Count > 1 && dspaydtls.Tables[1].Rows.Count > 0)
                    {
                        paymentresponseVOsobj.AdditionalInfo4_19 = dspaydtls.Tables[1].Rows[0]["DEPTPAYMENTDTLS"].ToString();
            ...
            if (paymentresponseVOsobj.AuthStatus_14 == "Success")// sucess payment done.
            {
                ...
                if (valid == 1)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alertMsg", "alert('Payment Done Successfully');" + "window.location='IpassPrintReceiptOtherService.aspx';", true);
                }
            }
            else
            {
    ...
    public int InsertUpdatepaymentdtls(paymentresponseVOs paymentresponseVOsobj, List<paymendepartwisetresponseVOs> paymendepartwisetresponseVOsobj)
    {
        ...
        SqlCommand command = new SqlCommand("USP_UPDATE_Builldesc_PaymentDtls_ForOtherServices", connection);
        ...
        try
        {
            ...
            if (valid == 1)
            {
                ...
                {
                    command1 = new SqlCommand("USP_UPDATE_DEPTWISE_Builldesc_PaymentDtls_OtherServices", connection);
