...
public partial class UI_TSiPASS_frmDistrictWiseFinancialReportDrillDownCFO : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmDistrictWiseFinancialReport.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    void FillDetails()
    {
        ...
        //string typeofaccount = Request.QueryString["type"].ToString().Trim();
        string district = Request.QueryString["district"].ToString().Trim();
        string finayear = Request.QueryString["ddlFinYear"].ToString().Trim();
        //string Bankname = Request.QueryString["bankname"].ToString().Trim();
        ds = GetDistrictWiseFinancialApplicationsDrill(FromdateforDB, TodateforDB, district, finayear);
    ...
    public DataSet GetDistrictWiseFinancialApplicationsDrill(string fromdate, string todate, string district, string financialyear)
    {
        ...
        //Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_FINANCIALYEAR_DRILLDOWN", pp);
        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_FINANCIALYEAR_DRILLDOWN_CFO", pp);
        return Dsnew;
    }
}