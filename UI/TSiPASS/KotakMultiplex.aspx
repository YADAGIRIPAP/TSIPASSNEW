<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakMultiplex.aspx.cs" Inherits="UI_TSiPASS_KotakMultiplex" %>
...
<body>
       <form method="post" name="customerData" action="ccavRequestHandlerMultiplex.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerMultiplex.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentMultiplex.aspx" />
                </td>
            </tr>
            <tr>
                <td>
