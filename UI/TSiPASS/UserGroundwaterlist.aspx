<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="UserGroundwaterlist.aspx.cs" Inherits="UI_TSiPASS_UserGroundwaterlist" %>
                                                            ...
                                                            <asp:TemplateField HeaderText="Application Status">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="anchortaglinkApplicationstatus" runat="server"  Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                            <br />
                                                                      <asp:HyperLink ID="anchortaglinkApplicationqueryraisedbytranscostatus" Visible="false" runat="server"  Font-Bold="true"
                                                                        ForeColor="Green" Target="_blank" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
