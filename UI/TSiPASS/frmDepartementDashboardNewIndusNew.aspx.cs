...
public partial class UI_TSiPASS_frmDepartementDashboardNewIndusNew : System.Web.UI.Page
{
    ...
    void FillDetails()
    {
        ...
        ds = GetDepartmentDashboardDetailsIndus(Session["User_Code"].ToString().Trim());
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            Label14.Text = ds.Tables[0].Rows[0]["No of Applications appeal against Rejection COI"].ToString();
        }
    ...
    public DataSet GetDepartmentDashboardDetailsIndus(string intDeptid)
    {
        ...
        try
        {
            da = new SqlDataAdapter("sp_GetDepartmentDashboardDetailsIndusNewProcessFlag", con.GetConnection);
