<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaSeedCap.aspx.cs" Inherits="UI_TSiPASS_ProformaSeedCap" %>
                    ...
                    <table style="width: 1000px">
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Sub :- Application of 
                                &nbsp;<span style="font-weight: bold"><asp:Label ID="lblEnterpreneurDetails1" runat="server"></asp:Label></span>&nbsp; for Reimbursement of Seed Cap 
