<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSIPASS/CCMaster.master" AutoEventWireup="true" CodeFile="StampDutyTransferdutyAnnex2.aspx.cs" Inherits="UI_TSIPASS_StampDutyTransferdutyAnnex2" %>
                                            ...
                                            <td colspan="4" style="padding: 5px; margin: 5px; text-align: center;">
                                                <table style="width: 80%">
                                                     ...
                                                     <tr runat="server" visible="false" id="trduty2">
                                                        ...
                                                        <td align="center" style="border: solid thin black; background: white; color: black" valign="top">
                                                            <asp:TextBox ID="txtLandConvrChrgAC" runat="server" class="form-control txtbox" Height="28px"
                                                                MaxLength="30"  Text="0" onkeypress="inputOnlyNumbers(evt)" TabIndex="1" ValidationGroup="group"
                                                                Width="150px"></asp:TextBox>
                                                    ...
                                                    <tr runat="server" visible="false" id="trduty3">
                                                        ...
                                                        <td align="center" style="border: solid thin black; background: white; color: black" valign="top">
                                                            <asp:TextBox ID="txtLandCostIeIdaIpAC"  Text="0" runat="server" class="form-control txtbox"
                                                                Height="28px" MaxLength="30" onkeypress="inputOnlyNumbers(evt)" TabIndex="1"
                                                                ValidationGroup="group" Width="150px"></asp:TextBox>
