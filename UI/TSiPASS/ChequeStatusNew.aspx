<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ChequeStatusNew.aspx.cs" Inherits="UI_TSiPASS_ChequeStatusNew" %>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 200px">
                                                                 <asp:TextBox ID="txtcheckno" runat="server" OnTextChanged="txtcheckno_TextChanged" AutoPostBack="true"></asp:TextBox>
