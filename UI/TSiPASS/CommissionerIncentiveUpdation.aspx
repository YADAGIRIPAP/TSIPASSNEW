<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    AutoEventWireup="true" CodeFile="CommissionerIncentiveUpdation.aspx.cs" Inherits="TSTBDCReg1" %>
        ...
        <ContentTemplate>
            ...
            <div align="left">
                                                                    ...
                                                                    <td style="padding: 5px; margin: 5px" colspan="3" align="center">
                                                                        <asp:GridView ID="grdDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="IncentiveName" HeaderText="Incentive Type" />
                                                                                ...
                                                                                <asp:BoundField DataField="EnterperIncentiveID" HeaderText="Enterper Incentive ID" Visible="false" />
               ...
               <tr runat="server" id="tr2" >
                                                                                                        <td>
                                                                                                           <asp:Label ID="Label1" runat="server" Text="SLC Number"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                               
                                                                                                      <tr runat="server" id="tr1" >
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="TxtSLCNumber" runat="server" class="form-control txtbox" 
                                                                                                                Height="28px" MaxLength="20" TabIndex="3" ValidationGroup="Save" Width="180px"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                     ...
                                                                                                     <tr runat="server" id="tr3" >
                                                                                                        <td>
                                                                                                           <asp:Label ID="Label2" runat="server" Text="SLC Date"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                               
                                                                                                      <tr runat="server" id="tr4" >
                                                                                                        <td>
                                                                                                              <asp:TextBox ID="txtSLCDate" runat="server" class="form-control txtbox" Height="28px"
                                                                    MaxLength="13" TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MM-yyyy" PopupButtonID="txtSLCDate"
                                                                    TargetControlID="txtSLCDate">
                                                                                                     ...
                                                                                                     <tr runat="server" id="tr5" >
                                                                                                        <td>
                                                                                                           <asp:Label ID="Label3" runat="server" Text="SLC Amount(Rs.)"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
