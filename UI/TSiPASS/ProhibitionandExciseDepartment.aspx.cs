...
public partial class UI_TSiPASS_ProhibitionandExciseDepartment : System.Web.UI.Page
{
    ...
    public DataSet GetCFECertificatedata(string applicationid)
    {
        ...
        Dsnew = clsGeneral.GenericFillDs("getCertificateDetailsdata_ProhibitionExciseDept", pp);
        return Dsnew;
    }
}