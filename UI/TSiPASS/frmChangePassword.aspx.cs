...
public partial class AddQualiication : System.Web.UI.Page
{
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        if (BtnSave1.Text == "Submit")
        {
            ...
            {
                lblmsg0.Text = "Old Password and New Password should not be same";
                success.Visible = false;
                Failure.Visible = true;
                txtCaptcha.Text = "";
                FillCapctha();
            ...
            if (TxtNpwd.Text.Trim() == lbluserid.Text.Trim())
            {
                lblmsg0.Text = "Username and Password should not be same";
                success.Visible = false;
                Failure.Visible = true;
                txtCaptcha.Text = "";
                FillCapctha();
            ...
            if (!(TxtNpwd.Text.Any(char.IsLower) && TxtNpwd.Text.Any(char.IsUpper) &&
                       TxtNpwd.Text.Any(char.IsDigit) && ValidatePassword(TxtNpwd.Text.Trim())))
            {
