...
public partial class UI_TSiPASS_ReleaseProcedingsStep2CompletedListPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
          ...
          //  ds = gen.GetAmountAllotedGONumbersList(userid);  // modified on 07.12.2017
            ds = gen.GetReleaseProceedingNosList();
    ...
    protected void btnAmtAllotedList_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            DataSet ds = new DataSet();
            ds = gen.GetAmountAllotedListOnGONumber(ddlapplicationto.Text);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("ReleaseProcedingsStep2CompletedListPrintDrill.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&GONO=" + ddlapplicationto.Text + "&SubIncType=" + lblSubIncTypeId);
