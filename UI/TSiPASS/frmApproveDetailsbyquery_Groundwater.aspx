<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmApproveDetailsbyquery_Groundwater.aspx.cs" Inherits="UI_TSiPASS_frmApproveDetailsbyquery_Groundwater" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        ...
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            <li>
                                <i class="fa fa-dashboard"></i><a href="tshome.aspx"></a>
                            </li>
            <li class="">
                    ...
                    <div class="panel-body">
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Label ID="Label58" runat="server" CssClass="LBLBLACK" ForeColor="Red" Font-Bold="True">Download Approval/Reject form,Sign the form and Upload the form in Only PDF Format</asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5" class="nav-justified">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style4" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtremarks" TextMode="MultiLine" runat="server" class="form-control txtbox" AutoPostBack="true" OnTextChanged="txtremarks_TextChanged"
                                                    TabIndex="1" ValidationGroup="group" Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px;" class="auto-style5">&nbsp;
                                            </td>
                                        </tr>
                                           <tr id="Tr_download" visible="false"  runat="server">
                                            <td style="padding: 5px; margin: 5px; text-align: left;" valign="top" class="auto-style2">
                                            </td>
                                              <td style="padding: 5px; margin: 5px; text-align: left;" valign="top" class="auto-style2">
                                            </td>
                                              <td style="padding: 5px; margin: 5px; text-align: left;" valign="top" class="auto-style2">
                                                  <asp:HiddenField ID="hf_formidapprovevalue" runat="server" />
                                                   <asp:HiddenField ID="hf_rejectformvalue" runat="server" />
                                                  <asp:HyperLink ID="hyp_linkdownloadform"   Target="_blank" runat="server"/>
                                            </td>
                                             </tr>
