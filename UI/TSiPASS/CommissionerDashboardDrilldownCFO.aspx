<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/EmptyMaster.master"AutoEventWireup="true" CodeFile="CommissionerDashboardDrilldownCFO.aspx.cs" Inherits="TSTBDCReg1" %>
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:TemplateField Visible="false" HeaderText="Status">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:DropDownList ID="ddlStatus" runat="server" class="form-control txtbox" 
                                                                Height="33px" Width="180px" AutoPostBack="True" Visible="false" 
                                                    ...
                                                    <asp:TemplateField  Visible="false" HeaderText="Submit">
                                                      ...
                                                      <asp:BoundField Visible="false" DataField="ApprovalName" 
                                                        ...
                                                        HeaderText="Last Date of Pre-Scrutiny" />
                                                        <asp:HyperLinkField DataTextField="Pre-Scrutiny Status" 
                                                        HeaderText="Pre-Scrutiny Status" />
