<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="apparaisalnote_isformStampDuty.aspx.cs" Inherits="UI_TSiPASS_apparaisalnote_isformStampDuty" %>
    ...
    <div id="divprint">
        ...
        <table style="width: 100%">
          ...
          <tr>
                ...
                <td colspan="4">
                    <b>2.12. Approved Project Cost As Per Guidelines (Rs. in Lakhs)
                    </b>
            ...
            <tr>
                ...
                <td class="auto-style58">
                    ...
                    <asp:TextBox ID="TextBox61" AutoPostBack="true" runat="server" Text="0" class="form-control txtbox" Height="28px" MaxLength="100" onkeypress="DecimalOnly()" TabIndex="6" Width="150px" OnTextChanged="TextBox61_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="auto-style59">
                    ...
                    <asp:TextBox ID="TextBox8" runat="server" Text="0" class="form-control txtbox" AutoPostBack="true" OnTextChanged="TextBox8_TextChanged" onkeypress="DecimalOnly()" Height="28px" MaxLength="100" TabIndex="6" Width="150px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TextBox12" runat="server" class="form-control txtbox" Height="28px" onkeypress="DecimalOnly()" MaxLength="100" TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="TextBox12_TextChanged"></asp:TextBox>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <tr>
                    <td class="auto-style48">4.1&nbsp;</td>
                    <td class="auto-style48">Land measuring in Sq. Mts.</td>
                    <td class="auto-style48">&nbsp;</td>
                    <td class="auto-style48">

                        <asp:TextBox ID="txtLandsq" runat="server" class="form-control txtbox txtcomn" AutoPostBack="true"  OnTextChanged="txtLandsq_TextChanged1"
                ...
                <tr>
                    ...
                    <td style="padding: 5px; margin: 5px;" class="auto-style57">Stamp duty paid by the unit in Rs.</td>
                    ...
                    <td class="auto-style56">
                        ...
                        <asp:TextBox ID="txtstampdutypaid" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" MaxLength="80"  TabIndex="34" Width="150px" AutoPostBack="true" OnTextChanged="txtstampdutypaid_TextChanged1"></asp:TextBox>
                    </td>
                ...
                <tr runat="server" visible="false">
                    ...
                    <td class="auto-style56">
                        ...
                        <asp:TextBox ID="txtsubtotal" runat="server" class="form-control txtbox txtcomn"
                ...
                <tr>
                    <td class="auto-style55">4.3</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Building plinth area in Sq.Mts.</td>
                ...
                <tr>
                    <td class="auto-style55">4.4</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Proportionate value for the area in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
            ...
            <tr id="tr4232" runat="server" visible="true">
                    <td class="auto-style55">4.5</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">Value Computed in Rs.</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="txtvaluecomputed" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                ...
                <tr id="tr1" runat="server" visible="true">
                    <td class="auto-style55">4.7</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">FINAL ELIGIBLE AMOUNT</td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                    <td class="auto-style55">
                        <asp:TextBox ID="TXTFINALELIGIBLAMOUNT" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                            Height="30px" onkeypress="return inputOnlyNumbers(event)" MaxLength="80" TabIndex="36"
                            Width="150px"></asp:TextBox>
                    </td>
                    <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
