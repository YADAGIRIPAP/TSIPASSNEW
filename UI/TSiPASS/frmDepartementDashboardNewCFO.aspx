<%@ Page Title=":: TSiPASS : Works wise Report " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartementDashboardNewCFO.aspx.cs" Inherits="Dashboard" %>
                                ...
                                <table cellpadding="3" cellspacing="5" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny Stage </b>
                                              ...
                                              <a href="frmCFEDepartmentsViewApplCFO.aspx?Stg=1" class="list-group-item">
                                        <span class="badge">
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> No of Application Received
                                              ...
                                              <a class="list-group-item" href="#"><i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny-Completed</b> </a>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=2"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label12" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i> Within 3 Days</a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=3"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="Label18" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Beyond 3 Days </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=4"><span class="badge">
                                                <asp:Label ID="Label3" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Total </a>
                                                
                                                <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=22"><span class="badge">
                                                <asp:Label ID="lblrejectedatprescrutiny" runat="server"></asp:Label>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=12"><span class="badge" style=" background-color:#87D37C;">
                                             ...
                                             <i class="fa fa-fw fa-check"></i> <b>Pre-Scrutiny-Pending</b> </a>
                                                 ...
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=5"><span class="badge" style=" background-color:#87D37C;">
                                                <asp:Label ID="Label21" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Within 3 Days</a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=6"><span class="badge" style=" background-color:#d9534f;">
                                                <asp:Label ID="Label22" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Beyond 3 Days </a>
                                             
                                               <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=7"><span class="badge" >
                                                <asp:Label ID="Label6" runat="server"></asp:Label>
                                                </span><i class="fa fa-fw fa-calendar"></i>Total </a>
                                                
                                                 <a class="list-group-item" href="frmCFEDepartmentsViewApplCFO.aspx?Stg=8">
