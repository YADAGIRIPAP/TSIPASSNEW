...
public partial class UI_TSiPASS_frmViewADMGattachments : System.Web.UI.Page
{
    DB.DB con = new DB.DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString[0].ToString().Trim() != null)
        {
           ...
           string stageID= Request.QueryString[1].ToString().Trim();
            LblADMGID.Text= Request.QueryString[2].ToString().Trim();
    ...
    void FillDetails()
    {
        ...
        try
        {
            ...
            if (!Directory.Exists("~/ADMandGATTACHMENTS/" + hdfFlagID.Value.ToString() + "/DGPSMAP"))
            {
                HyperLink1.Text = "No Attachment";
            }
            //if (!Directory.Exists("~/ADMandGATTACHMENTS/" + hdfFlagID.Value.ToString() + "/PAN"))
            //{
            //    HyperLink2.Text = "No Attachment";
            //}

            //if (!Directory.Exists("~/ADMandGATTACHMENTS/" + hdfFlagID.Value.ToString() + "/OtherDocuments"))
            //{
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {//D:\TsipassFinal_28-12-2022\ADMandGATTACHMENTS\11\DGPSMAP
                    ...
                    sen1 = sen2.Replace(@"\", @"/");
                    sen = sen1.Replace(@"D:/TsipassFinal_28-12-2022/", "~/");// //D:\TsipassFinal_28-12-2022\ADMandGATTACHMENTS\11\DGPSMAP
    ...
    public DataSet ViewAttachmetsData(string ID)
    {
        ...
        try
        {
            da = new SqlDataAdapter("sp_RetriveAttachmentsByADMGID", con.GetConnection);
