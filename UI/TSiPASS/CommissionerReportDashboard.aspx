<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="CommissionerReportDashboard.aspx.cs" Inherits="UI_TSiPASS_CommissionerReportDashboard" EnableEventValidation="false" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center">
                            ...
                            <h2 id="H1" runat="server" class="panel-title" style="font-weight: bold;">
                                <asp:Label ID="lblHeading" runat="server">R6.10:TGiPASS- Abstract Report(CFE, CFO and Incentives)</asp:Label>
                            ...
                            <table align="center" cellpadding="10" cellspacing="5" style="width: 80%; font-family: 'Trebuchet MS'">
                                ...
                                <tr>
                                 <td colspan="2" class="col-xs-5" style="padding: 5px; text-align: right; margin: 5px">
                                    Report as on date: <asp:Label ID="lbllabel" runat="server" CssClass="LBLBLACK"></asp:Label>
                                 </td>
                                </tr>
<%--                                         <asp:Label ID="lbllabel" runat="server">Report as on date</asp:Label>      --%>
                                        ...
                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="S.No">
                                                 ...
                                                 <asp:BoundField DataField="Distid" HeaderText="Dist" Visible="false">
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="CFE" HeaderText="CFE No of Industries">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                ...
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="Investment" HeaderText="CFE Investment (Rs. in Cr)">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black"
                                                    FooterStyle-CssClass="text-center" DataTextField="Employment" HeaderText="CFE Total Employment">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                   <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="CFO" HeaderText="CFO No of Industries Applied">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                   <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="INC" HeaderText="Incentive No of Industries Applied">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                                 <asp:HyperLinkField ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Blue"
                                                    FooterStyle-CssClass="text-center" DataTextField="Claims" HeaderText="Incentives No of Claims">
                                                    <FooterStyle HorizontalAlign="Center" Font-Underline="false" Font-Bold="true" CssClass="text-center" />
                                                    <ItemStyle HorizontalAlign="Center" CssClass="text-center" />
                                                </asp:HyperLinkField>
                                            </Columns>
