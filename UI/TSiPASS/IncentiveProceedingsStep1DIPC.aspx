<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentiveProceedingsStep1DIPC.aspx.cs" Inherits="UI_TSiPASS_IncentiveProceedingsStep1DIPC" %>
                                                        ...
                                                        <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O Amount Released">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsanctionedamountnew" class="form-control txtbox" Width="150px" Height="28px"
                                                                ...
                                                                <asp:TemplateField HeaderText="Process">
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server" Text="Process" Style="width: 100px; margin: 10px;" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
