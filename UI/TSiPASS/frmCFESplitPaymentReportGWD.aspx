<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" EnableEventValidation="False"  CodeFile="frmCFESplitPaymentReportGWD.aspx.cs" Inherits="UI_TSiPASS_frmCFESplitPaymentReportGWD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        ...
        <ContentTemplate>
            <asp:Panel ID="panel_exc" runat="server">
    <div align="left">
        <ol class="breadcrumb">
            You are here &nbsp;!&nbsp; &nbsp; &nbsp;
                        ...
                        <table align="center" cellpadding="10" cellspacing="5" style="width: 100%">
                                    ...
                                    <table cellpadding="4" cellspacing="5" style="width: 80%">
                                          ...
                                          <tr  runat="server" id="trBank" visible="false">
                                                            ...
                                                            <td style="padding: 5px; margin: 5px" colspan="3">
                                                                <asp:DropDownList ID="ddlBank" runat="server" class="form-control txtbox" 
                                                                    ...
                                                                    <asp:ListItem Value="Kotak">Kotak</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px">
                                                                &nbsp;</td>
                                        ...
                                        <tr>
                                           ...
                                           <td style="padding: 5px; margin: 5px"><asp:DropDownList ID="ddlmodule" runat="server" class="form-control txtbox" Height="28px" TabIndex="1" Width="180px">
                                                            ...
                                                            <asp:ListItem Value="TTA">TRAVEL AGENT</asp:ListItem>        
                            ...
                            <tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                                    ...
                                    <asp:Button ID="BtnExel" runat="server" CssClass="btn btn-primary" Height="32px"
                                        TabIndex="10" Text="Excel" Width="90px" OnClick="BtnExel_Click" visible="false"/>
                                </td>
                            </tr>
                            <div id="div_print">
                            </div>
                            ...
                            <tr>
                                <td align="left" style="padding: 5px; margin: 5px; text-align: left;" valign="top">
                                    &nbsp;
                                    <asp:ImageButton ImageUrl="~/Resource/Images/Excel-icon.png" ID="excel_button" OnClick="BtnSave2_Click1" Width="30px" Height="30px" Style="float: right;" runat="server" visible="false"/>
                                </td>
                            </tr>
                            <tr>
