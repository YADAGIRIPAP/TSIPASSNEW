...
public partial class UI_TSiPASS_FrmDistDrilldownold2New : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        DataSet dsnew = new DataSet();
        if (FromdateforDB != "")
            dsnew = Gen.FetchDistrictwiseDrildownNew(ddlType.SelectedValue, Request.QueryString[2].ToString().Trim(), FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
        else
        {
            dsnew = Gen.FetchDistrictwiseDrildownNew(ddlType.SelectedValue, Request.QueryString[2].ToString().Trim(), FromdateforDB, TodateforDB, ddlEnterPriseType.SelectedValue);
        }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[9].Text = InvestmnetTotal.ToString();
            e.Row.Cells[10].Text = EmploymentTotal.ToString();
