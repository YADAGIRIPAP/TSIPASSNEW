<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ReleaseCompletedUserView.aspx.cs" Inherits="UI_TSiPASS_ReleaseCompletedUserView" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: large" runat="server" id="h1heading">List of cases Released incentives </h1>
                            </div>

                            <div class="panel-body">
                                <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                    <tr id="trno" runat="server">
                                        <td style="padding: 5px; margin: 5px; color: blue; font-weight: bold" valign="top" colspan="12" runat="server" id="tdinvestments">List of cases Released incentives
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Incentiveid" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblIncentivename" Text='<%#Eval("IncentiveType") %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
