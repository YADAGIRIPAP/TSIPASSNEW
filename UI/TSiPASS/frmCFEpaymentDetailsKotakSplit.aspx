<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmCFEpaymentDetailsKotakSplit.aspx.cs" Inherits="UI_TSiPASS_frmCFEpaymentDetailsKotakSplit" %>
                                                    ...
                                                    <td style="padding: 5px; margin: 5px"><asp:DropDownList ID="ddlmodule" runat="server" class="form-control txtbox" Height="28px" TabIndex="1" Width="180px">
                                                            ...
                                                            <asp:ListItem Value="PLOT">PLOT ALLOTMENT</asp:ListItem>   
                                                             <asp:ListItem Value="TTA">TRAVEL AGENCY</asp:ListItem>   
                                                              ...
                                                              <asp:ListItem Value="DRigs">DRIG</asp:ListItem> 
                                                              <asp:ListItem Value="GW">WALTA</asp:ListItem>   
