<%@ Page Title=":: TS-iPASS ::" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmNEFTlPaymentDetails.aspx.cs" Inherits="TSTBDCReg1" %>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; margin: 5px" align="center">
                                            <asp:RadioButtonList ID="rblPaymentMode" runat="server" AutoPostBack="True" Font-Bold="True"
                                                ...
                                                <asp:ListItem Value="D">NEFT / RTGS</asp:ListItem>
                                        ...
                                        <tr id="DD" runat="server">
                                            ...
                                            <td class="style6" style="padding: 5px; margin: 5px; text-align: left;">
                                                <asp:TextBox ID="txtDDNumber" runat="server" class="form-control txtbox" Height="28px"
                                                    MaxLength="6" onkeypress="NumberOnly()" TabIndex="1" ValidationGroup="group"
                                                    Width="180px"></asp:TextBox>
                                            </td>
                                            <td style="padding: 5px; margin: 5px; width: 10px;">
                            ...
                            <tr>
                                <td align="center" style="padding: 5px; margin: 5px; text-align: center;" colspan="3">
                                    <asp:Button ID="BtnSave1" runat="server" CssClass="btn btn-primary" Height="32px"
                                        OnClick="BtnSave_Click" TabIndex="10" Text="Subbmit" ValidationGroup="group" Width="90px"
                                        Visible="False" />
