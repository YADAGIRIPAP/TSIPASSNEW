...
public partial class UI_TSiPASS_ProformaQualityCertification : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["uid"] != null)
        {
            ...
            if (Request.QueryString.Count > 0 && Request.QueryString["incentiveid"] != null)
            {
                ...
                ds2 = Gen.GetBasicUnitDetails_Proforma_lettersPSR(incentiveid, "11");
                binddatanew(ds2);
                DataSet dsname = new DataSet();
                dsname = Gen.GetIncentiveOfficerNamesForAll(incentiveid, "11", userid, "", "RECOMMENDATION");
    ...
    public void binddatanew(DataSet ds)
    {
        if (ds != null && ds.Tables.Count > 1 && ds.Tables[1].Rows.Count > 0)
        {
            ...
            lblLetterNo.Text = "COI/" + ds.Tables[1].Rows[0]["Applicationno"].ToString() + "/GMREC-QC";
            ...
            {
                lblSTAmountPaid.Text = ds.Tables[0].Rows[0]["Amountspentinacquiringthecertification"].ToString();
            }
            lblRemarks.Text = ds.Tables[1].Rows[0]["GMRecommendedRemarks"].ToString();
            if (lblRemarks.Text.Trim() != "")
            {
