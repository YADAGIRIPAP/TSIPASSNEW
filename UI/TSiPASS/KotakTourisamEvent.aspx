<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KotakTourisamEvent.aspx.cs" Inherits="UI_TSIPASS_KotakTourisamEvent" %>
...
<body>
    <form method="post" name="customerData" action="ccavRequestHandlerTourismEvent.aspx">
    <div id="myDIV">
        <center>
        ...
        <table width="50%" height="100" border='1' align="center" runat="server" visible="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="redirect_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/ccavResponseHandlerTourismEvent.aspx" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="cancel_url" value="https://ipass.telangana.gov.in/UI/TSiPASS/frmPaymentTourismEvent.aspx" />
                </td>
            </tr>
            <tr>
                <td>
