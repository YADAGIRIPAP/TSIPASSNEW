<%@ Page Language="C#" AutoEventWireup="true"     MasterPageFile="~/UI/TSiPASS/CCMaster.master"  CodeFile="AppraisalNoteTransportDuty.aspx.cs" Inherits="UI_TSiPASS_AppraisalNoteTransportDuty" %>
    ...
    <div id="divprint">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                        <asp:HiddenField ID="hdndifferentlyabled" runat="server" Visible="false" />
                    <asp:HiddenField ID="hdncastename" runat="server" Visible="false" />
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="margin: 5px;"></td>
                <td style="margin: 5px;">
                    <asp:TextBox ID="txtDCP_unit" placeholder="Please enter date" runat="server" class="form-control txtbox" Height="28px" MaxLength="100" TabIndex="6" Width="150px" AutoPostBack="true" OnTextChanged="txtDCP_unit_TextChanged"></asp:TextBox>
                </td>
                <td>&nbsp;
                </td>
            </tr>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td colspan="4" style="padding: 5px; margin: 5px;">
                    <b>Transport Duty</b></td>

            </tr>
             <tr>
                                                    <td colspan="8">
                                                        <table id="tbl_monthyeardataExpansion" runat="server"  bgcolor="White" width="100%" style="font-family: Verdana;">
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth1" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear1"  runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth1amountpaid" autopostback="true" runat="server" OnTextChanged="txtmonth1amountpaid_TextChanged"  ></asp:TextBox>
                                                                </td>
                                                                
                                                                <td>
                                                          <asp:TextBox ID="txtmonth1eligiblesubsidy"  Enabled="false"   runat="server"></asp:TextBox>
                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth2" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear2"   runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth2maountpaid"  autopostback="true"    runat="server" OnTextChanged="txtmonth2maountpaid_TextChanged"></asp:TextBox>
                                                                </td>
                                                                
                                                                <td>
                                                          <asp:TextBox ID="txtmonth2eligiblesubsidy" Enabled="false"   runat="server"></asp:TextBox>
                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth3" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear3"   runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth3amountpaid"  autopostback="true"  runat="server" OnTextChanged="txtmonth3amountpaid_TextChanged"  ></asp:TextBox>
                                                                </td>
                                                                
                                                                <td>
                                                          <asp:TextBox ID="txtmonth3eligiblesubsidy" Enabled="false"    runat="server"></asp:TextBox>
                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth4" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear4"   runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth4amountpaid"  autopostback="true"  runat="server" OnTextChanged="txtmonth4amountpaid_TextChanged" ></asp:TextBox>
                                                                </td>
                                                              
                                                                <td>
                                                          <asp:TextBox ID="txtmonth4eligiblesubsidy"  Enabled="false"   runat="server"></asp:TextBox>
                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth5" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear5"   runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth5amountpaid"  autopostback="true"  runat="server" OnTextChanged="txtmonth5amountpaid_TextChanged"  ></asp:TextBox>
                                                                </td>
                                                               
                                                                <td>
                                                          <asp:TextBox ID="txtmonth5eligiblesubsidy" Enabled="false"   runat="server"></asp:TextBox>
                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonth6" Enabled="false" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txt_grdmonthyear6"   runat="server"></asp:TextBox>
                                                                </td>
                                                                <td style="padding: 10px; margin: 5px; font-weight: bold;">
                                                                    <asp:TextBox ID="txtmonth6amountpaid"  autopostback="true"   runat="server" OnTextChanged="txtmonth6amountpaid_TextChanged"  ></asp:TextBox>
                                                                </td>
                                                                
                                                                <td>
                                                          <asp:TextBox ID="txtmonth6eligiblesubsidy" Enabled="false"   runat="server"></asp:TextBox>
        ...
        <table>
            ...
            <tr id="trsubmit" runat="server" visible="false">
                <td colspan="3" align="center">
                    ...
                    &nbsp;<asp:Button ID="Button1" runat="server" CssClass="btn btn-xs btn-danger" Height="30px" OnClick="Button1_Click" Text="Cancel" />
            ...
            <tr>
                <td>
                    <asp:HiddenField ID="HDNDCPMONTH" runat="server" />
                    <asp:HiddenField ID="HDNDCPYEAR" runat="server" />
                    <asp:HiddenField ID="HDNDCPDATE" runat="server" />

                    <asp:HiddenField ID="HDNENDMONTH" runat="server" />
                    ...
                    <asp:HiddenField ID="hdnfirstorsecondhalfyear" runat="server" />
                    <asp:HiddenField ID="HiddenFieldjan" runat="server" />
                    <asp:HiddenField ID="HiddenFieldfeb" runat="server" />
                    <asp:HiddenField ID="HiddenFieldmar" runat="server" />
                    <asp:HiddenField ID="HiddenFieldapr" runat="server" />
                    <asp:HiddenField ID="HiddenFieldmay" runat="server" />
                    <asp:HiddenField ID="HiddenFieldjune" runat="server" />
                    <asp:HiddenField ID="HiddenFieldjuly" runat="server" />
                    <asp:HiddenField ID="HiddenFieldaug" runat="server" />
                    <asp:HiddenField ID="HiddenFieldsep" runat="server" />
                    <asp:HiddenField ID="HiddenFieldoct" runat="server" />
                    <asp:HiddenField ID="HiddenFieldnov" runat="server" />
                    <asp:HiddenField ID="HiddenFielddec" runat="server" />
