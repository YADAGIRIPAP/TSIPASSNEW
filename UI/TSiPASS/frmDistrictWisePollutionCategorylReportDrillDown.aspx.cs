...
public partial class UI_TSiPASS_frmDistrictWisePollutionCategorylReportDrillDown : System.Web.UI.Page
{
    int delete = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillDetails();
            HyperLink1.NavigateUrl = "frmDistrictWisePollutionCategorylReport.aspx?status=A&lbl=Application Received&fromdate=" + txtFromDate.Text + "&todate=" + txtTodate.Text;
    ...
    void FillDetails()
    {
        ...
        string polcategory = Request.QueryString["ddlpolcategory"].ToString().Trim();
        string Enttype = Request.QueryString["Enttype"].ToString().Trim();
        ds = GetDistrictWisePollutionApplicationsDrill(FromdateforDB, TodateforDB, district, polcategory, Enttype);
    ...
    public DataSet GetDistrictWisePollutionApplicationsDrill(string fromdate, string todate, string district, string polcategory, string Enttype)
    {
        ...
        SqlParameter[] pp = new SqlParameter[] {
             new SqlParameter("@FromDate",SqlDbType.VarChar),
               ...
               new SqlParameter("@POLCATEGORY",SqlDbType.VarChar),
        ...
        pp[3].Value = polcategory;
        pp[4].Value = Enttype;

        Dsnew = Gen.GenericFillDs("USP_GET_DISTRICTREPORT_POLLUTIONCATEGORY_DRILLDOWN", pp);
        return Dsnew;
    }
}