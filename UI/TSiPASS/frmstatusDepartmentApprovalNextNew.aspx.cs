...
public partial class TSTBDCReg1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtFromDate.Text = Request.QueryString[5].ToString().Trim();
            txtTodate.Text = Request.QueryString[6].ToString().Trim();
            ...
            ds = Gen.RetriveStatusForViewApplicationDepartmentApprovalwiseNew(Request.QueryString[0].ToString().Trim(), ddlCategory.SelectedItem.Text, ddldistrict.SelectedValue, Request.QueryString[1].ToString().Trim(), Request.QueryString[4].ToString().Trim(), FromdateforDB, TodateforDB);
            ...
            HyperLink2.NavigateUrl = "RptAPPROVALSDEPARTMENTWISENew.aspx?Category=" + ddlCategory.SelectedValue + "&Districtid=" + ddldistrict.SelectedValue + "&fromdt=" + txtFromDate.Text.Trim() + "&todt=" + txtTodate.Text.Trim();
    ...
    {
        string status = Request.QueryString[0].ToString().Trim();
        string distrinct = ddldistrict.SelectedValue;
    ...
    protected void ExportToExcel()
    {
        try
        {
            string heading = lblHeading.Text;
            heading = heading.Replace(" ", "");
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=" + heading + DateTime.Now.ToString("M/d/yyyy") + ".xls");
            Response.Charset = "";
        ...
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename= " + heading + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
