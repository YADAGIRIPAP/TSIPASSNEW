<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmISMWCLRenewalForm.aspx.cs" Inherits="UI_TSiPASS_frmISMWCLRenewalForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">Application for Employing Migrant Workmen(Form V, as per rule 7(2))</a>
            </li>
        </ol>
    </div>
    <div align="left">
            ...
            <div class="col-lg-11">
                <div class="panel panel-primary">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title">Application for Employing Migrant Workmen(Form V, as per rule 7(2))</h3>
                    </div>
                    <%-----------------12------------------------------------------------------%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; margin: 5px; width: 192px; text-align: left;">
                                                            <asp:TextBox ID="txtfactregno" runat="server" class="form-control txtbox" Height="28px"
                                                                MaxLength="100" TabIndex="1" ValidationGroup="group" Width="180px" OnTextChanged="txtfactregno_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </td>
                                                            ...
                                                            <table cellpadding="4" cellspacing="5" style="width: 90%" id="trvisibleregno" runat="server"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 5px; margin: 5px; text-align: left;" colspan="3">
                                                                        <span style="color: rgb(51, 51, 51); font-family: &quot; open sans&quot; font-size: 14.3px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Present Details of Principal Employer<span>&nbsp;</span></span><font color="red" size="3" style="box-sizing: border-box; font-family: &quot; open sans&quot; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">*</font></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                        <asp:Label ID="Label424" runat="server" CssClass="LBLBLACK" Width="165px">Name of the Principal Employer<font 
                                                            color="red">*</font></asp:Label>
                                                                    </td>
                                                                    <td style="padding: 5px; margin: 5px">:
                                                                    </td>
