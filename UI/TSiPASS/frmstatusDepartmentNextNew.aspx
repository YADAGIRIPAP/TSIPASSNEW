<%@ Page Title=":: TS-iPASS ::  " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmstatusDepartmentNextNew.aspx.cs"
    Inherits="TSTBDCReg1" %>
    ...
    <div align="left">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-edit"></i><a href="#">
                <asp:Label ID="lblLink" runat="server"></asp:Label></a> </li>
        </ol>
    </div>
    <div align="left">
                    ...
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" style="font-weight: bold;">
                            <asp:Label ID="lblHeading" runat="server"></asp:Label>&nbsp; <a id="A1" href="#"
                                 onserverclick="BtnSave3_Click1" runat="server">
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px; margin: 5px" valign="top">
                                    <table cellpadding="4" cellspacing="5">
                                        <tr>
                                            <td style="padding: 5px; margin: 5px" align="left" colspan="5">
                            ...
                            <%--<tr>
                                <td align="center" colspan="3" style="padding: 5px; margin: 5px; text-align: center;">
                                    ...
                                    <asp:Button ID="BtnSave3" runat="server" CssClass="btn btn-warning" Height="32px"
                                        TabIndex="10" Text="PDF" Width="90px" OnClick="BtnSave3_Click1" />
                                </td>
                            </tr>--%>
