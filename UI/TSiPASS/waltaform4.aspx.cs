...
public partial class UI_TSiPASS_waltaform4 : System.Web.UI.Page
{
    string Applicantid = "";
    string downloadfilename = "Form4";
                        ...
                        if (ds != null)
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    lbl_typeofappl.Text = Convert.ToString(ds.Tables[0].Rows[0]["ApplicationType_IndusorAgriName"]);
                                }
                            }
                        }
                    }
