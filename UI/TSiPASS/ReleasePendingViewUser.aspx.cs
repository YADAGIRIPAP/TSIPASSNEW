...
public partial class UI_TSiPASS_ReleasePendingViewUser : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["uid"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string subIncentiveID = Request.QueryString["MstIncentiveId"].ToString();
                //string Investmentid = Request.QueryString[1].ToString();
                //h1heading.InnerHtml = Cast + " Category";

                DataSet ds = new DataSet();
                ds = gen.getReleaseProceedingsUser(Enterid, subIncentiveID);
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblIncentiveName = (e.Row.FindControl("lblIncentiveName") as Label);
            ...
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantStampDutySubsidy.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&MstIncentiveId=" + Request.QueryString["MstIncentiveId"].ToString() +"&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }

            if (MstIncentiveId.Text == "14")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantStampDutySubsidy.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&MstIncentiveId=14&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }
            if (MstIncentiveId.Text == "15")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantStampDutySubsidy.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&MstIncentiveId=15&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }
            if (MstIncentiveId.Text == "16")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantStampDutySubsidy.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&MstIncentiveId=16&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }
            if (MstIncentiveId.Text == "17")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantStampDutySubsidy.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&MstIncentiveId=17&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }
            ...
            if (MstIncentiveId.Text == "18")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantCoalReimbursement.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&DIPCNumer=" + lblDIPCNumer.Text.Trim() + "&IncentiveName=" + lblIncentiveName.Text.Trim();
            }
            if (MstIncentiveId.Text == "19")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantWoodlReimbursement.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&DIPCNumer=" + lblDIPCNumer.Text.Trim() + "&IncentiveName=" + lblIncentiveName.Text.Trim();
            }
            if (MstIncentiveId.Text == "20")
            {
                (e.Row.FindControl("anchortagGMCertificate") as HyperLink).NavigateUrl = "ProformaApplicantTransportDuty.aspx?incentiveid=" + enterid.Text.Trim() + "&Scheme=" + lblScheme.Text.Trim() + "&DIPCNumer=" + lblDIPCNumer.Text.Trim();
            }
