<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaApplicantSeedCapitalSubsidyNew.aspx.cs" Inherits="UI_TSIPASS_ProformaApplicantSeedCapitalSubsidyNew" %>
        ...
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 14px">
                <span class="floatleft auto-style3">Sub :- &nbsp;&nbsp;<asp:Label ID="lblTIdeaTPrideIIPP1" runat="server" Font-Bold="true"></asp:Label>&nbsp;-
                                                -Sanction of Reimbursement of Seed Capital Assistance for 1st generation Entrepreneur for Micro Enterprise to 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="padding-top: 14px">
                <span class="floatleft auto-style3">Ref :-  
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;Dated:&nbsp;--%>
                                                <%--<asp:Label ID="lblRefLetterDate" runat="server"></asp:Label>:--%>
                    ...
                    3. Minutes of the
                                                ...
                                                <asp:Label ID="lblSLCNo" runat="server" Font-Bold="true"></asp:Label>&nbsp;SLC meeting held on&nbsp;
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the subject cited, we are pleased to inform you that you have been sanctioned the Reimbursement of Seed Capital Assistance for 1st generation Entrepreneur for Micro Enterprise for the year&nbsp;<span style="font-weight: bold"><asp:Label ID="lbl1stOR2ndHalfYearFinYearFromTo" runat="server"></asp:Label></span>&nbsp;   
                                                    of Rs. <asp:Label ID="lblSanctionedAmount" runat="server" Font-Bold="true"></asp:Label>
