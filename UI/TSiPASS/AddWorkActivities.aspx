<%@ Page Title=":: TSiPASS : Add work Activities " Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="AddWorkActivities.aspx.cs" Inherits="AddWorkActivities" %>
...
function OpenPopup() 
 
   {
       ...
       window.open("Lookups/LookupWorkActivities.aspx", "List", "scrollbars=yes,resizable=yes,width=920,height=650;display = block;position=absolute");
...
<div align="left">
    <ol class="breadcrumb">You are here
        &nbsp;!&nbsp; &nbsp; &nbsp; 
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Work Activities
                            </li>
                        </ol>
     </div>
<div align="center">
                    ...
                    <div class="col-lg-11" >
                        <div class="panel panel-primary" style=" width:60%">
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Work Activities</h3>
                            </div>
                                            ...
                                            <table cellpadding="4" cellspacing="5" style="width: 70%">
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label303" runat="server" CssClass="LBLBLACK" Width="165px">Type 
                                                        of Work</asp:Label>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        :</td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:DropDownList ID="ddlareaswork" runat="server" class="form-control txtbox" 
                                                            Height="28px" Width="300px">
                                                            <asp:ListItem>--Select--</asp:ListItem>
                                                            <asp:ListItem>Soil and water conversation </asp:ListItem>
                                                            
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                            ControlToValidate="ddlareaswork" ErrorMessage="Please Select Areas Of Work" 
                                                            ValidationGroup="group" InitialValue="--Select--">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:Label ID="Label298" runat="server" CssClass="LBLBLACK" Width="165px">Work 
                                                    ...
                                                    <td style="padding: 5px; margin: 5px">
                                                        <asp:TextBox ID="txtWork" runat="server" class="form-control txtbox" 
                                                            Height="38px" MaxLength="100" oncopy="return false" oncut="return false" 
                                                            onpaste="return false" TabIndex="1" ValidationGroup="group" Width="300px" 
                                                            TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                    <td style="padding: 5px; margin: 5px">
                                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                            ControlToValidate="txtWork" ErrorMessage="Please Enter Work Activities" 
