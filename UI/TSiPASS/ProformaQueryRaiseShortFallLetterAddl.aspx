<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProformaQueryRaiseShortFallLetterAddl.aspx.cs" Inherits="UI_TSIPASS_ProformaQueryRaiseShortFallLetterAddl" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container" style="border: 3px solid #000000; text-align: center;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 14px">
                <span class="floatleft auto-style3">Your Recommended Date:&nbsp;
