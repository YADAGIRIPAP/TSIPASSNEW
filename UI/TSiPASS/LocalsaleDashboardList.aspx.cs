...
public partial class UI_TSiPASS_LocalsaleDashboardList : System.Web.UI.Page
{
    ...
    public void getdetails()
    {
        try
        {
            ...
            oSqlDataAdapter = new SqlDataAdapter("el_liqourlocalsale_DASHBOARD_HISTORY", osqlConnection);
            ...
            if (Session["uid"] != null)
            {
                ...
                {
                    Response.Redirect("frmexcisedepartmentapplication.aspx?status=B", false);
                }
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                anchortaglinkStatus.NavigateUrl = "RptApplicationWiseDetailedTrakerlocalsaleexcise.aspx?intqnreid=" + intApplicationID.ToString();
            }
            else if (Approval_Status == "2")
            {
                ...
                //anchortaglinkStatus.Text = "Pre-Scrunity Pending";
            }
    ...
    {
        Response.Redirect("frmexcisedepartmentapplication.aspx?status=A");
    }
