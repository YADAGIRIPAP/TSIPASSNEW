<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="ListOfSLCGm.aspx.cs" Inherits="UI_TSiPASS_ListOfSLCGm" %>
                                    ...
                                    <div class="panel-body">
                                        <table align="left" cellpadding="10" cellspacing="5" style="width: 100%">
                                            <tr id="trno" runat="server" visible="false">
                                                <td style="padding: 5px; margin: 5px" valign="top" class="style8">List of cases sanctioned incentives
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px; margin: 5px; width: 100%" valign="top">
                                                    <div style="width: 100%">
                                                        <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                            ...
                                                            PageSize="15" ShowFooter="True" Width="100%" CellSpacing="4" OnRowCommand="grdDetails_RowCommand" OnRowDataBound="grdDetails_RowDataBound">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="SLC Number">
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink ID="hSLCNumber" runat="server" NavigateUrl="IncentiveWiseSLClist.aspx" Text='<%#Eval("SLCNumber") %>'></asp:HyperLink>
                                                                    </ItemTemplate>
