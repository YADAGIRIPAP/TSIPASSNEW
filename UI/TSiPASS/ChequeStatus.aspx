<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/TSiPASS/CCMaster.master" CodeFile="ChequeStatus.aspx.cs" Inherits="UI_TSiPASS_ChequeStatus" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td>
                                    <div class="col-md-12">
                                        <h1 class="page-head-line" align="left" style="font-size: large">Cheque Status</h1>
                                    </div>
                                        ...
                                        <td style="padding: 5px; margin: 5px; width: 900px; font-weight: bold;">A). Pavalla vaddi
                                            ...
                                            <tr>
                                                <td style="padding: 5px; margin: 5px; text-align: left;" colspan="2">
                                                    <table width="100%">
                                                        <tr>
                                                            <td style="padding: 15px; margin: 5px; width:10px"></td>
                                                             
                                                            <td style="vertical-align: middle; width: 250px">Select Release Proceeding No:
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 200px">
                                                                <asp:TextBox ID="txtsvcdate" runat="server" Visible="false"></asp:TextBox>
                                                    ...
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                                ...
                                                                <asp:DropDownList ID="ddlapplicationto" AutoPostBack="true" OnSelectedIndexChanged="ddlapplicationto_SelectedIndexChanged" runat="server" Width="250px" class="form-control txtbox"
                                                                    Height="33px">
                                                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td style="padding: 15px; margin: 5px;">
                                                                <%-- <asp:Button ID="Button2" CssClass="btn btn-primary" runat="server" Text="Get Working List"
                                                            Width="150px" OnClick="Button2_Click" />--%>
                                                            </td>
                                                        </tr>
                                                        <tr id="trCheckblock" runat="server" visible="false">
                                                            <td style="padding: 15px; margin: 5px; width: 20px"></td>
                                                            <td style="vertical-align: middle; width: 250px">Select Check No :
                                                            </td>
                                                            <td style="padding: 5px; margin: 5px; text-align: left; width: 200px">
                                                                <asp:DropDownList ID="ddlCheckList" AutoPostBack="true" OnSelectedIndexChanged="ddlCheckList_SelectedIndexChanged" runat="server" Width="150px" class="form-control txtbox" Height="33px">
                                                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td style="padding: 15px; margin: 5px;">
                                                                <asp:Button ID="Button2" Visible="false" CssClass="btn btn-primary" runat="server" Text="Get Cheque Status List"
                                                        ...
                                                        <asp:GridView ID="grdDetailsPavallavaddiSC" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Process">
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="Button1" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server"
                                                                            Text="Process" Width="130px" style="margin:10px;" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
