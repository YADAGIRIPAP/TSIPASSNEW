...
public partial class UI_TSiPASS_InscentiveView_AttachmentsNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            //{
            Fetch obj = new Fetch();
            DataTable dt = obj.FetchIncentiveDtlsbyIncentiveIDNew(Request.QueryString["EntrpId"].ToString());
