<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="IncentivesTracker.aspx.cs" Inherits="UI_TSiPASS_IncentivesTracker" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <div class="col-md-12">
                                <h1 class="page-head-line" align="left" style="font-size: x-large">Application Tracker</h1>
                            </div>
                                            ...
                                            <tr>
                                                <td style="padding: 5px; margin: 5px" valign="top">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="GmRejectionRemarks" ItemStyle-HorizontalAlign="Center" HeaderText="Gm Rejection Remarks">
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Intimation Letter">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="anchortagGMCertificate" Target="_blank" runat="server"></asp:HyperLink>
                                                                <%--<asp:HyperLink ID="anchortagGMCertificate" Target="_blank" runat="server" Text="Intimation Letter"></asp:HyperLink>--%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Feedback Form">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="anchortagFbkForm" Target="_blank" runat="server" Text="Feedback Form"></asp:HyperLink>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                    </Columns>
