<%@ Page Title="" Language="C#" MasterPageFile="~/UI/TSiPASS/CCMaster.master" AutoEventWireup="true" CodeFile="frmDepartmentsViewAppl_groundwater.aspx.cs" Inherits="UI_TSiPASS_frmDepartmentsViewAppl_groundwater" %>
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        <ContentTemplate>
            <div align="left">
                <ol class="breadcrumb">
                    You are here &nbsp;!&nbsp; &nbsp; &nbsp;
                    <li><i class="fa fa-dashboard"></i><a href="HomeDashboard.aspx"></a></li>
                                                    ...
                                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="5" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"  HeaderText="S No">
                                                                <ItemTemplate>
                                                                    <%# Container.DataItemIndex + 1%>           
                                                                     ...
                                                                     <asp:HiddenField ID="hf_gridstageid" runat="server" Value='<%# Eval("intStageid") %>' />
                                                                    <%--StageId--%>
                                                            ...
                                                            <asp:TemplateField HeaderText="Application No">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lnk_uid_no"  runat="server" Text='<%# Eval("UID_No") %>' foreColor="Black" ></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" class="form-control txtbox"
                                                                        ...
                                                                        <asp:ListItem>--Select--</asp:ListItem>
                                                                          <asp:ListItem Value="5">Query Raise to Applicant</asp:ListItem>
                                                                        <asp:ListItem Value="12">Application Forward to Ground water District/District TRANSCO Department</asp:ListItem>
                                                                        <asp:ListItem Value="16">Application Rejected at Pre-Scrunity Stage</asp:ListItem>
                                                                    </asp:DropDownList>                                                               
                                                                    <br />          
                                                                   
                                                                    <asp:Label ID="lbl_gridstatusdesc" runat="server" CssClass="LBLBLACK" Visible="false" Width="180px"
                                                                        Text="Remarks"></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox ID="txt_remarksarequery" runat="server" class="form-control txtbox" Height="40px"
                                                                        TabIndex="1" TextMode="MultiLine" ValidationGroup="group" Visible="false" Width="180px"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_remarksarequery"
                                                                        ErrorMessage="Please Enter Discription" TabIndex="1" ValidationGroup="group">*</asp:RequiredFieldValidator>
                                                                    <br />    
                                                                     <asp:Label ID="LabelDiscription" Visible="false" runat="server" />
                                                                    <br />
                                                                    <asp:HyperLink ID="hyp_approveapplication"  Target="_blank" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:BoundField DataField="Dateofsubmission" HeaderText="Date of Submission" />                                                           
                                                            <asp:BoundField DataField="LastDateofPreScrunity" HeaderText="LastDateofPreScrunity" />  
                                                             <asp:TemplateField HeaderText="Query View">
                                                              ...
                                                              <asp:BoundField DataField="Dept_Completed_date" HeaderText="Forward to Ground water" />
                                                              <asp:BoundField DataField="DWGOApproveddate" HeaderText="Recommended by Ground water" />
                                                              <asp:BoundField DataField="DWGORejecteddate" HeaderText="Not Recommended by Ground water" />
                                                              <asp:BoundField DataField="DWGOQueryRaisedby" HeaderText="Ground water Query raised Date" />
                                                              <asp:BoundField DataField="DWGOQueryRespondeddate" HeaderText="Ground water Query Responded Date" />

                                                                   <asp:BoundField DataField="GWTRASCOApproveddate" HeaderText="Recommended by TRANSCO" />
                                                              <asp:BoundField DataField="GWTRASCORejecteddate" HeaderText="Not Recommended by TRANSCO" />
                                                              <asp:BoundField DataField="GWTRASCOQueryRaiseddate" HeaderText="TRANSCO Query raised Date" />
                                                              <asp:BoundField DataField="GWTRASCOQueryRespondeddate" HeaderText="TRANSCO Query Responded Date" />


                                                             <asp:BoundField DataField="Approval_Date" HeaderText="Approved Date" />
                                                             <asp:BoundField DataField="Dept_Rejected_date" HeaderText="Rejected Date" />                                                        </Columns>
