<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LandBank.aspx.cs" Inherits="LandBank" %>
                            ...
                            <aside class="widget widget_categories">
                               <%-- <h3 class="widgettitle"><span class="fa fa-download"></span>Downloads</h3>--%>
                                <ul class="dt-sc-fancy-list caret">
                                    <li style="font-size:13pt; color:black;"><a href="docs/TS-iPASS.pdf" target="_blank">Area Under TSIIC </a></li>
                                    <li style="font-size:13pt; color:black;"><a target="_blank" href="docs/TS-iPassupdated.pdf">Area Under HMDA </a></li>
                                    <li style="font-size:13pt; color:black;"><a target="_blank" href="docs/TimeLines.pdf">Timelines / Clearances </a></li>
                                    <li style="font-size:13pt; color:black;"><a target="_blank" href="docs/How to apply for clearances under TS.pdf">Area Under DTCP </a></li>
                                    <li style="font-size:13pt; color:black;"><a target="_blank" href="Checklist.aspx">Area Under KUDA </a></li>
                                </ul>
                            </aside>
                        </section>
