...
public partial class Departmentview : System.Web.UI.Page
{
    ...
    string ccaRequest = "";
    public string strMerchantId = "TSIPASS";
    public string strAccessCode = "AVCZ02FI27BC93ZCCB";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.Count > 0)
        {
            ...
            if (accessCode == "AVCZ02FI27BC93ZCCB" && Request.Form.Count > 0)
            {
                string input1Value = "";
                string input2Value = "";
                string input3Value = "";
                ...
                input1Value = Request.Form["module"];
                input2Value = Request.Form["filepath"];

                input3Value = Request.Form["cfeid"];

                // ccaRequest = ccaRequest + name + "=" + HttpUtility.UrlEncode(Request.Form[name]) + "&";
                DataSet ds = GetDepartmentViewNew("", input1Value, input2Value);
